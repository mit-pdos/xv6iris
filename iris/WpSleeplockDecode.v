(* WpSleeplockDecode.v -- decode templates + [instr] facts for the four
   ...
   kalloc/kfree's 32-byte 4-register frame (ra/s0/s1/s2), so their prologue /
   epilogue / c.mv decodes REUSE the [kdc_*] templates from WpKallocDecode.v;
   holdingsleep uses the 48-byte frame (ra/s0/s1/s2[/s3]) byte-identical to
   freerange's, reusing the [fdc_*] templates from WpFreerangeDecode.v (plus
   [fdc_892e] for initsleeplock's [mv s2,a1]).  Only the sleeplock-unique words
...
(* 0x85ca  c.mv a1,s2 *)
Lemma sldec_mv_a1_s2 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0x4785  c.li a5,1 *)
Lemma sldec_li_a5_1 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0xbfd9  c.j -42  (holdingsleep +0x48 -> +0x1e) *)
Lemma sldec_j s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  exec (ext_decode_compressed (mword_of_int 0xbfd9 : mword 16)) s
  = Some (C_J (mword_of_int 2027 : mword 11), s).
Proof. intro H. rvc_oneshot s H. Qed.
...
Section WpSleeplockDecode.
  ...
  Proof. mk_rvc (ISL + 0x00)%Z (mword_of_int 0x1101 : mword 16)
    (mword_of_int (ISL + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) kdc_1101 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (ISL + 0x02)%Z (mword_of_int 0xec06 : mword 16)
    (mword_of_int (ISL + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) kdc_ec06 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x04)%Z (mword_of_int 0xe822 : mword 16)
    (mword_of_int (ISL + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) kdc_e822 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x06)%Z (mword_of_int 0xe426 : mword 16)
    (mword_of_int (ISL + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) kdc_e426 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x08)%Z (mword_of_int 0xe04a : mword 16)
    (mword_of_int (ISL + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) kdc_e04a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x0a)%Z (mword_of_int 0x1000 : mword 16)
    (mword_of_int (ISL + 0x0a) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) kdc_1000 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (ISL + 0x0c)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (ISL + 0x0c) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) kdc_84aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ISL + 0x0e)%Z (mword_of_int 0x892e : mword 16)
    (mword_of_int (ISL + 0x0e) : mword 64) (RTYPE (Regidx (mword_of_int 11), zreg, Regidx (mword_of_int 18), ADD)) fdc_892e exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ISL + 0x2a)%Z (mword_of_int 0x60e2 : mword 16)
    (mword_of_int (ISL + 0x2a) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) kdc_60e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x2c)%Z (mword_of_int 0x6442 : mword 16)
    (mword_of_int (ISL + 0x2c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) kdc_6442 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x2e)%Z (mword_of_int 0x64a2 : mword 16)
    (mword_of_int (ISL + 0x2e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) kdc_64a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x30)%Z (mword_of_int 0x6902 : mword 16)
    (mword_of_int (ISL + 0x30) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) kdc_6902 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x32)%Z (mword_of_int 0x6105 : mword 16)
    (mword_of_int (ISL + 0x32) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) kdc_6105 exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (ISL + 0x34)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (ISL + 0x34) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) kdc_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_rvc (ASL + 0x00)%Z (mword_of_int 0x1101 : mword 16)
    (mword_of_int (ASL + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) kdc_1101 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (ASL + 0x02)%Z (mword_of_int 0xec06 : mword 16)
    (mword_of_int (ASL + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) kdc_ec06 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x04)%Z (mword_of_int 0xe822 : mword 16)
    (mword_of_int (ASL + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) kdc_e822 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x06)%Z (mword_of_int 0xe426 : mword 16)
    (mword_of_int (ASL + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) kdc_e426 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x08)%Z (mword_of_int 0xe04a : mword 16)
    (mword_of_int (ASL + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) kdc_e04a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x0a)%Z (mword_of_int 0x1000 : mword 16)
    (mword_of_int (ASL + 0x0a) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) kdc_1000 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (ASL + 0x0c)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (ASL + 0x0c) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) kdc_84aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ASL + 0x12)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (ASL + 0x12) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) kdc_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ASL + 0x1c)%Z (mword_of_int 0x85ca : mword 16)
    (mword_of_int (ASL + 0x1c) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 11), ADD)) sldec_mv_a1_s2 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ASL + 0x1e)%Z (mword_of_int 0x8526 : mword 16)
    (mword_of_int (ASL + 0x1e) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kdc_8526 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ASL + 0x28)%Z (mword_of_int 0x4785 : mword 16)
    (mword_of_int (ASL + 0x28) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 1 : mword 6), zreg, Regidx (mword_of_int 15), ADDI)) sldec_li_a5_1 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (ASL + 0x34)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (ASL + 0x34) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) kdc_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (ASL + 0x3a)%Z (mword_of_int 0x60e2 : mword 16)
    (mword_of_int (ASL + 0x3a) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) kdc_60e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x3c)%Z (mword_of_int 0x6442 : mword 16)
    (mword_of_int (ASL + 0x3c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) kdc_6442 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x3e)%Z (mword_of_int 0x64a2 : mword 16)
    (mword_of_int (ASL + 0x3e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) kdc_64a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x40)%Z (mword_of_int 0x6902 : mword 16)
    (mword_of_int (ASL + 0x40) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) kdc_6902 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x42)%Z (mword_of_int 0x6105 : mword 16)
    (mword_of_int (ASL + 0x42) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) kdc_6105 exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (ASL + 0x44)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (ASL + 0x44) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) kdc_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_rvc (RSL + 0x00)%Z (mword_of_int 0x1101 : mword 16)
    (mword_of_int (RSL + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) kdc_1101 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (RSL + 0x02)%Z (mword_of_int 0xec06 : mword 16)
    (mword_of_int (RSL + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) kdc_ec06 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x04)%Z (mword_of_int 0xe822 : mword 16)
    (mword_of_int (RSL + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) kdc_e822 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x06)%Z (mword_of_int 0xe426 : mword 16)
    (mword_of_int (RSL + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) kdc_e426 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x08)%Z (mword_of_int 0xe04a : mword 16)
    (mword_of_int (RSL + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) kdc_e04a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x0a)%Z (mword_of_int 0x1000 : mword 16)
    (mword_of_int (RSL + 0x0a) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) kdc_1000 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (RSL + 0x0c)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (RSL + 0x0c) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) kdc_84aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (RSL + 0x12)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (RSL + 0x12) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) kdc_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (RSL + 0x20)%Z (mword_of_int 0x8526 : mword 16)
    (mword_of_int (RSL + 0x20) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kdc_8526 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (RSL + 0x26)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (RSL + 0x26) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) kdc_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (RSL + 0x2c)%Z (mword_of_int 0x60e2 : mword 16)
    (mword_of_int (RSL + 0x2c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) kdc_60e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x2e)%Z (mword_of_int 0x6442 : mword 16)
    (mword_of_int (RSL + 0x2e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) kdc_6442 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x30)%Z (mword_of_int 0x64a2 : mword 16)
    (mword_of_int (RSL + 0x30) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) kdc_64a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x32)%Z (mword_of_int 0x6902 : mword 16)
    (mword_of_int (RSL + 0x32) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) kdc_6902 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x34)%Z (mword_of_int 0x6105 : mword 16)
    (mword_of_int (RSL + 0x34) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) kdc_6105 exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (RSL + 0x36)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (RSL + 0x36) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) kdc_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_rvc (HSL + 0x00)%Z (mword_of_int 0x7179 : mword 16)
    (mword_of_int (HSL + 0x00) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 61 : mword 6), sp, sp, ADDI)) fdc_7179 exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x02)%Z (mword_of_int 0xf406 : mword 16)
    (mword_of_int (HSL + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 5 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) fdc_f406 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x04)%Z (mword_of_int 0xf022 : mword 16)
    (mword_of_int (HSL + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) fdc_f022 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x06)%Z (mword_of_int 0xec26 : mword 16)
    (mword_of_int (HSL + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) fdc_ec26 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x08)%Z (mword_of_int 0xe84a : mword 16)
    (mword_of_int (HSL + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) fdc_e84a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x0a)%Z (mword_of_int 0x1800 : mword 16)
    (mword_of_int (HSL + 0x0a) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 12 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) fdc_1800 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (HSL + 0x0c)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (HSL + 0x0c) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) kdc_84aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (HSL + 0x12)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (HSL + 0x12) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) kdc_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (HSL + 0x1e)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (HSL + 0x1e) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) kdc_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (HSL + 0x24)%Z (mword_of_int 0x8526 : mword 16)
    (mword_of_int (HSL + 0x24) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kdc_8526 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (HSL + 0x26)%Z (mword_of_int 0x70a2 : mword 16)
    (mword_of_int (HSL + 0x26) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 5 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) fdc_70a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x28)%Z (mword_of_int 0x7402 : mword 16)
    (mword_of_int (HSL + 0x28) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) fdc_7402 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x2a)%Z (mword_of_int 0x64e2 : mword 16)
    (mword_of_int (HSL + 0x2a) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) fdc_64e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x2c)%Z (mword_of_int 0x6942 : mword 16)
    (mword_of_int (HSL + 0x2c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) fdc_6942 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x2e)%Z (mword_of_int 0x6145 : mword 16)
    (mword_of_int (HSL + 0x2e) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 3 : mword 6), sp, sp, ADDI)) fdc_6145 exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x30)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (HSL + 0x30) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) fdc_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_rvc (HSL + 0x32)%Z (mword_of_int 0xe44e : mword 16)
    (mword_of_int (HSL + 0x32) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 19), sp, 8)) fdc_e44e exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x46)%Z (mword_of_int 0x69a2 : mword 16)
    (mword_of_int (HSL + 0x46) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 19), false, 8)) fdc_69a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (HSL + 0x48)%Z (mword_of_int 0xbfd9 : mword 16)
    (mword_of_int (HSL + 0x48) : mword 64) (JAL (sign_extend' 21 (concat_vec (mword_of_int 2027 : mword 11) ('b"0")), zreg)) sldec_j exec_execute_C_J. Qed.

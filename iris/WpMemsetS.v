...
Qed.
  ...
  Lemma wp_memset_loop_r (R : s_regime) (γ : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iApply (wp_sb_s_r R γ Φ pc0 ra1 ra5 (mword_of_int 0) m (olds off) (dq:=dq)
    ...
    iApply (wp_caddi_gpr_s_r R γ Φ pc4 ra5 (mword_of_int 1) m (dq:=dq)
 Hra5
    ...
    - (* last iteration: S off = N, bne falls through to 0xcea *)
      ...
      iApply (wp_bne_fall_s_r R γ Φ pc6 imm_bne ra4 ra5 m' (dq:=dq)
 Hra5 Hra4
    ...
    - (* more iterations: S off < N, bne taken back to the loop head pc0 *)
      assert (HSN : (S off < N)%nat) by lia.
      iApply (wp_bne_taken_s_r R γ Φ pc6 imm_bne ra4 ra5 m' (dq:=dq)
 Hra5 Hra4
  ...
  Lemma wp_memset_loop (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (N : nat) (p e cval : mword 64) (ra1 ra4 ra5 : mword 5) (imm_bne : mword 13)
      (olds : nat -> bv 8) {dq : dfrac} :
    let pc0 := mword_of_int (KernelSyms.memset + 0x14) in
    let pc4 := add_vec_int pc0 4 in
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
    Proof.
    exact (wp_memset_loop_r (kpt_regime root_ppn) γ Φ N p e cval ra1 ra4 ra5 imm_bne olds (dq:=dq)).
  Qed.
  ...
  Lemma wp_memset_suffix_r (R : s_regime) (Φ : mval -> iProp Σ)
 ...
 Hrai Hs0i Hrasp Hs0sp Hs0ra Hsp Hra Hal0.
    iIntros "Hsm Htlbinv
             Hpc Hfile Hi0 Hi2 Hi4 Hi6 Hbra Hbs0 Hcont".
    (* cea: c.ldsp ra,8(sp) : ra := ra0 *)
    iApply (wp_cldsp_gpr_s_scfg_r R γ Φ pcL (mword_of_int 1) ra_idx m ra0
              (dq:=dq)(dqm:=dqm)
 Hrai
             
              with "Hsm Htlbinv Hpc Hfile Hi0 [Hbra]").
    ...
    iApply (wp_cldsp_gpr_s_scfg_r R γ Φ (add_vec_int pcL 2) (mword_of_int 0) s0_idx
              m1 s00
              (dq:=dq)(dqm:=dqm)
 Hs0i
             
              with "Hsm Htlbinv Hpc Hfile Hi2 [Hbs0]").
    ...
    iApply (wp_caddi_gpr_s_config_scfg_r R γ Φ (add_vec_int pcL 4) csp_rs1 imm_dealloc
              m2
              (dq:=dq)
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cret_s_zca_scfg_r R γ Φ (add_vec_int pcL 6) ra_idx
              m3
              (dq:=dq)
  ...
  Lemma wp_memset_suffix (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (sp' : mword 64) (ra0 s00 : mword 64) (ra_idx s0_idx : mword 5) (imm_dealloc : mword 6)
      (m : gmap regidx (mword 64))
      (γ : gname) {dq dqm : dfrac} :
    let pcL := mword_of_int (KernelSyms.memset + 0x1e) in
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
    Proof.
    exact (wp_memset_suffix_r (kpt_regime root_ppn) Φ sp' ra0 s00 ra_idx s0_idx imm_dealloc m γ (dq:=dq) (dqm:=dqm)).
  Qed.
  ...
  Lemma wp_memset_prefix_r (R : s_regime) (Φ : mval -> iProp Σ)
 ...
 Hn0 Hvalue_add.
    ...
    iApply (wp_caddi_gpr_s_config_scfg_r R γ Φ pcE csp_rs1 imm_entry m0
              (dq:=dq)
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_csdsp_gpr_s_scfg_r R γ Φ (add_vec_int pcE 2) (mword_of_int 1) ra_idx m1 vra
              (dq:=dq)
    ...
    iApply (wp_csdsp_gpr_s_scfg_r R γ Φ (add_vec_int pcE 4) (mword_of_int 0) s0_idx m1 vs0
              (dq:=dq)
    ...
    iApply (wp_caddi4spn_gpr_s_config_scfg_r R γ Φ (add_vec_int pcE 6) (Cregidx (mword_of_int 0)) nzimm_s0 s0_idx m1
              (dq:=dq)
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    change (<[Regidx s0_idx := regval_into_reg (add_vec (m1 !!! Regidx csp_rs1) (sign_extend' 64 (caddi4spn_imm nzimm_s0)))]> m1)
      with m2.
    (* cd4: c.beqz a2,cea : n<>0, fall through *)
    iApply (wp_cbeqz_fall_s_config_scfg_r R γ Φ (add_vec_int pcE 8) imm8_beqz (Cregidx (mword_of_int 4)) a2_idx m2
              (dq:=dq)
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cmv_gpr_s_config_scfg_r R γ Φ (add_vec_int pcE 10) a5_idx a0_idx m2
              (dq:=dq)
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cslli_gpr_s_config_scfg_r R γ Φ (add_vec_int pcE 12) (Regidx a2_idx) a2_idx shamt_l m3
              (dq:=dq)
 ltac:(reflexivity) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_csrli_gpr_s_config_scfg_r R γ Φ (add_vec_int pcE 14) (Cregidx (mword_of_int 4)) a2_idx shamt_r m4
              (dq:=dq)
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_add_s_r R γ Φ (add_vec_int pcE 16) a4_idx a2_idx a0_idx wval_add m5
              (dq:=dq)
 ltac:(vm_compute; discriminate) Hvalue_add
  ...
  Lemma wp_memset_prefix (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (m0 : gmap regidx (mword 64))
      (imm_entry shamt_l shamt_r : mword 6) (nzimm_s0 imm8_beqz : mword 8)
      (wval_add : mword 64) (vra vs0 : bv 64)
      (γ : gname) {dq : dfrac} :
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
    Proof.
    exact (wp_memset_prefix_r (kpt_regime root_ppn) Φ m0 imm_entry shamt_l shamt_r nzimm_s0 imm8_beqz wval_add vra vs0 γ (dq:=dq)).
  Qed.
  ...
  (* =================================================================== *)
  Lemma wp_memset_empty_r (R : s_regime) (Φ : mval -> iProp Σ)
      (m0 : gmap regidx (mword 64))
      (imm_entry : mword 6) (nzimm_s0 imm8_beqz : mword 8) (vra vs0 : bv 64)
      (γ : gname) {dq : dfrac} :
    let ra_idx : mword 5 := mword_of_int 1 in
    let s0_idx : mword 5 := mword_of_int 8 in
    let a2_idx : mword 5 := mword_of_int 12 in
    ...
    let m1 := <[Regidx csp_rs1 := regval_into_reg sp']> m0 in
    let m2 := <[Regidx s0_idx := regval_into_reg (add_vec (m1 !!! Regidx csp_rs1) (sign_extend' 64 (caddi4spn_imm nzimm_s0)))]> m1 in
    (* n = 0: the entry c.beqz is taken *)
    eq_vec (m0 !!! Regidx a2_idx) zero_reg = true ->
    (* the taken target is the epilogue at memset+0x1e, 2-aligned *)
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros ra_idx s0_idx a2_idx pcE pcL sp' ea_ra pa_ra ea_s0 pa_s0 m1 m2
 Hn0 Htgt Hal0.
    assert (Hsp1 : m1 !!! Regidx csp_rs1 = sp') by (unfold m1; rewrite lookup_total_insert; reflexivity).
 ...
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cbeqz_taken_s_config_scfg_r R γ Φ (add_vec_int pcE 8) imm8_beqz (Cregidx (mword_of_int 4)) a2_idx m2
              (dq:=dq)
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(unfold m2, m1; rewrite lookup_total_insert_ne; [ rewrite lookup_total_insert_ne; [ exact Hn0 | vm_compute; discriminate ] | vm_compute; discriminate ])
  ...
  Lemma wp_memset_empty (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (m0 : gmap regidx (mword 64))
      (imm_entry : mword 6) (nzimm_s0 imm8_beqz : mword 8) (vra vs0 : bv 64)
      (γ : gname) {dq : dfrac} :
    let ra_idx : mword 5 := mword_of_int 1 in
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
    Proof.
    exact (wp_memset_empty_r (kpt_regime root_ppn) Φ m0 imm_entry nzimm_s0 imm8_beqz vra vs0 γ (dq:=dq)).
  Qed.

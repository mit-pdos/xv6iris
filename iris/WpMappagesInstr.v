...
Section MappagesInstrs.
  ...
  Local Lemma exec_execute_C_J (imm : mword 11) s :
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma mdec_1c s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma mdec_42 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma mdec_4c s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma mdec_54 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x83b1 : mword 16)) s
    = Some (C_SRLI (mword_of_int 12, Cregidx (mword_of_int 7)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma mdec_56 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma mdec_68 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x00)%Z (mword_of_int 0x715d : mword 16) (mword_of_int (KernelSyms.mappages + 0x00) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 59 : mword 6), sp, sp, ADDI)) mdec_00 exec_execute_C_ADDI16SP. Qed.
  Lemma mi_02 : MPP 0x02 true (STORE (csdsp_imm 9, Regidx (mword_of_int 1), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x02)%Z (mword_of_int 0xe486 : mword 16) (mword_of_int (KernelSyms.mappages + 0x02) : mword 64) (STORE (csdsp_imm 9, Regidx (mword_of_int 1), sp, 8)) mdec_02 exec_execute_C_SDSP. Qed.
  Lemma mi_04 : MPP 0x04 true (STORE (csdsp_imm 8, Regidx (mword_of_int 8), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x04)%Z (mword_of_int 0xe0a2 : mword 16) (mword_of_int (KernelSyms.mappages + 0x04) : mword 64) (STORE (csdsp_imm 8, Regidx (mword_of_int 8), sp, 8)) mdec_04 exec_execute_C_SDSP. Qed.
  Lemma mi_06 : MPP 0x06 true (STORE (csdsp_imm 7, Regidx (mword_of_int 9), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x06)%Z (mword_of_int 0xfc26 : mword 16) (mword_of_int (KernelSyms.mappages + 0x06) : mword 64) (STORE (csdsp_imm 7, Regidx (mword_of_int 9), sp, 8)) mdec_06 exec_execute_C_SDSP. Qed.
  Lemma mi_08 : MPP 0x08 true (STORE (csdsp_imm 6, Regidx (mword_of_int 18), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x08)%Z (mword_of_int 0xf84a : mword 16) (mword_of_int (KernelSyms.mappages + 0x08) : mword 64) (STORE (csdsp_imm 6, Regidx (mword_of_int 18), sp, 8)) mdec_08 exec_execute_C_SDSP. Qed.
  Lemma mi_0a : MPP 0x0a true (STORE (csdsp_imm 5, Regidx (mword_of_int 19), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x0a)%Z (mword_of_int 0xf44e : mword 16) (mword_of_int (KernelSyms.mappages + 0x0a) : mword 64) (STORE (csdsp_imm 5, Regidx (mword_of_int 19), sp, 8)) mdec_0a exec_execute_C_SDSP. Qed.
  Lemma mi_0c : MPP 0x0c true (STORE (csdsp_imm 4, Regidx (mword_of_int 20), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x0c)%Z (mword_of_int 0xf052 : mword 16) (mword_of_int (KernelSyms.mappages + 0x0c) : mword 64) (STORE (csdsp_imm 4, Regidx (mword_of_int 20), sp, 8)) mdec_0c exec_execute_C_SDSP. Qed.
  Lemma mi_0e : MPP 0x0e true (STORE (csdsp_imm 3, Regidx (mword_of_int 21), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x0e)%Z (mword_of_int 0xec56 : mword 16) (mword_of_int (KernelSyms.mappages + 0x0e) : mword 64) (STORE (csdsp_imm 3, Regidx (mword_of_int 21), sp, 8)) mdec_0e exec_execute_C_SDSP. Qed.
  Lemma mi_10 : MPP 0x10 true (STORE (csdsp_imm 2, Regidx (mword_of_int 22), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x10)%Z (mword_of_int 0xe85a : mword 16) (mword_of_int (KernelSyms.mappages + 0x10) : mword 64) (STORE (csdsp_imm 2, Regidx (mword_of_int 22), sp, 8)) mdec_10 exec_execute_C_SDSP. Qed.
  Lemma mi_12 : MPP 0x12 true (STORE (csdsp_imm 1, Regidx (mword_of_int 23), sp, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x12)%Z (mword_of_int 0xe45e : mword 16) (mword_of_int (KernelSyms.mappages + 0x12) : mword 64) (STORE (csdsp_imm 1, Regidx (mword_of_int 23), sp, 8)) mdec_12 exec_execute_C_SDSP. Qed.
  Lemma mi_14 : MPP 0x14 true (ITYPE (caddi4spn_imm (mword_of_int 20 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)).
  Proof. mk_rvc (KernelSyms.mappages + 0x14)%Z (mword_of_int 0x0880 : mword 16) (mword_of_int (KernelSyms.mappages + 0x14) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 20 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) mdec_14 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x1c)%Z (mword_of_int 0x8a2a : mword 16) (mword_of_int (KernelSyms.mappages + 0x1c) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 20), ADD)) mdec_1c exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x42)%Z (mword_of_int 0x8552 : mword 16) (mword_of_int (KernelSyms.mappages + 0x42) : mword 64) (RTYPE (Regidx (mword_of_int 20), zreg, Regidx (mword_of_int 10), ADD)) mdec_42 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x4c)%Z (mword_of_int 0x8b85 : mword 16) (mword_of_int (KernelSyms.mappages + 0x4c) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 1 : mword 6), creg2reg_idx (Cregidx (mword_of_int 7)), creg2reg_idx (Cregidx (mword_of_int 7)), ANDI)) mdec_4c exec_execute_C_ANDI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x54)%Z (mword_of_int 0x83b1 : mword 16) (mword_of_int (KernelSyms.mappages + 0x54) : mword 64) (SHIFTIOP (mword_of_int 12 : mword 6, creg2reg_idx (Cregidx (mword_of_int 7)), creg2reg_idx (Cregidx (mword_of_int 7)), SRLI)) mdec_54 exec_execute_C_SRLI. Qed.
  Lemma mi_56 : MPP 0x56 true (SHIFTIOP (mword_of_int 10 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)).
  Proof. mk_rvc (KernelSyms.mappages + 0x56)%Z (mword_of_int 0x07aa : mword 16) (mword_of_int (KernelSyms.mappages + 0x56) : mword 64) (SHIFTIOP (mword_of_int 10 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) mdec_56 exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x68)%Z (mword_of_int 0xbfd9 : mword 16) (mword_of_int (KernelSyms.mappages + 0x68) : mword 64) (JAL (sign_extend' 21 (concat_vec (mword_of_int 2027 : mword 11) ('b"0")), zreg)) mdec_68 exec_execute_C_J. Qed.
  ...
  Proof. mk_rvc (KernelSyms.mappages + 0x9c)%Z (mword_of_int 0x60a6 : mword 16) (mword_of_int (KernelSyms.mappages + 0x9c) : mword 64) (LOAD (csdsp_imm 9, sp, Regidx (mword_of_int 1), false, 8)) mdec_9c exec_execute_C_LDSP. Qed.
  Lemma mi_9e : MPP 0x9e true (LOAD (csdsp_imm 8, sp, Regidx (mword_of_int 8), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0x9e)%Z (mword_of_int 0x6406 : mword 16) (mword_of_int (KernelSyms.mappages + 0x9e) : mword 64) (LOAD (csdsp_imm 8, sp, Regidx (mword_of_int 8), false, 8)) mdec_9e exec_execute_C_LDSP. Qed.
  Lemma mi_a0 : MPP 0xa0 true (LOAD (csdsp_imm 7, sp, Regidx (mword_of_int 9), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xa0)%Z (mword_of_int 0x74e2 : mword 16) (mword_of_int (KernelSyms.mappages + 0xa0) : mword 64) (LOAD (csdsp_imm 7, sp, Regidx (mword_of_int 9), false, 8)) mdec_a0 exec_execute_C_LDSP. Qed.
  Lemma mi_a2 : MPP 0xa2 true (LOAD (csdsp_imm 6, sp, Regidx (mword_of_int 18), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xa2)%Z (mword_of_int 0x7942 : mword 16) (mword_of_int (KernelSyms.mappages + 0xa2) : mword 64) (LOAD (csdsp_imm 6, sp, Regidx (mword_of_int 18), false, 8)) mdec_a2 exec_execute_C_LDSP. Qed.
  Lemma mi_a4 : MPP 0xa4 true (LOAD (csdsp_imm 5, sp, Regidx (mword_of_int 19), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xa4)%Z (mword_of_int 0x79a2 : mword 16) (mword_of_int (KernelSyms.mappages + 0xa4) : mword 64) (LOAD (csdsp_imm 5, sp, Regidx (mword_of_int 19), false, 8)) mdec_a4 exec_execute_C_LDSP. Qed.
  Lemma mi_a6 : MPP 0xa6 true (LOAD (csdsp_imm 4, sp, Regidx (mword_of_int 20), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xa6)%Z (mword_of_int 0x7a02 : mword 16) (mword_of_int (KernelSyms.mappages + 0xa6) : mword 64) (LOAD (csdsp_imm 4, sp, Regidx (mword_of_int 20), false, 8)) mdec_a6 exec_execute_C_LDSP. Qed.
  Lemma mi_a8 : MPP 0xa8 true (LOAD (csdsp_imm 3, sp, Regidx (mword_of_int 21), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xa8)%Z (mword_of_int 0x6ae2 : mword 16) (mword_of_int (KernelSyms.mappages + 0xa8) : mword 64) (LOAD (csdsp_imm 3, sp, Regidx (mword_of_int 21), false, 8)) mdec_a8 exec_execute_C_LDSP. Qed.
  Lemma mi_aa : MPP 0xaa true (LOAD (csdsp_imm 2, sp, Regidx (mword_of_int 22), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xaa)%Z (mword_of_int 0x6b42 : mword 16) (mword_of_int (KernelSyms.mappages + 0xaa) : mword 64) (LOAD (csdsp_imm 2, sp, Regidx (mword_of_int 22), false, 8)) mdec_aa exec_execute_C_LDSP. Qed.
  Lemma mi_ac : MPP 0xac true (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 23), false, 8)).
  Proof. mk_rvc (KernelSyms.mappages + 0xac)%Z (mword_of_int 0x6ba2 : mword 16) (mword_of_int (KernelSyms.mappages + 0xac) : mword 64) (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 23), false, 8)) mdec_ac exec_execute_C_LDSP. Qed.
  Lemma mi_ae : MPP 0xae true (ITYPE (caddi16sp_imm (mword_of_int 5 : mword 6), sp, sp, ADDI)).
  Proof. mk_rvc (KernelSyms.mappages + 0xae)%Z (mword_of_int 0x6161 : mword 16) (mword_of_int (KernelSyms.mappages + 0xae) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 5 : mword 6), sp, sp, ADDI)) mdec_ae exec_execute_C_ADDI16SP. Qed.
  Lemma mi_b0 : MPP 0xb0 true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).
  Proof. mk_rvc (KernelSyms.mappages + 0xb0)%Z (mword_of_int 0x8082 : mword 16) (mword_of_int (KernelSyms.mappages + 0xb0) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) mdec_b0 exec_execute_C_JR. Qed.
  Lemma mi_b2 : MPP 0xb2 true (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)).
  Proof. mk_rvc (KernelSyms.mappages + 0xb2)%Z (mword_of_int 0x4501 : mword 16) (mword_of_int (KernelSyms.mappages + 0xb2) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)) mdec_b2 exec_execute_C_LI. Qed.
  Lemma mi_b4 : MPP 0xb4 true (JAL (sign_extend' 21 (concat_vec (mword_of_int 2036 : mword 11) ('b"0")), zreg)).
  Proof. mk_rvc (KernelSyms.mappages + 0xb4)%Z (mword_of_int 0xb7e5 : mword 16) (mword_of_int (KernelSyms.mappages + 0xb4) : mword 64) (JAL (sign_extend' 21 (concat_vec (mword_of_int 2036 : mword 11) ('b"0")), zreg)) mdec_b4 exec_execute_C_J. Qed.

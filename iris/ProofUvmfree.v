...
Section ProofUvmfree.
  ...
  Proof.
    ...
    { rewrite /spd. unfold sp0, pa_stk, add_vec_int. rewrite pa_stk_off2.
      f_equal; try (apply bv_eq; vm_compute; reflexivity). }
    assert (Hpc02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (UF + 0x02))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc02) in "Hpc".
    (* +0x02 c.sdsp ra,24(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UF + 0x02)) (mword_of_int 3 : mword 6) Rra
              A0 (K - 4)%nat vr24 with "Hcg Hpc Hi02 [Hr24] [-]").
    { iEval (rewrite HA0sp -Hb1). iExact "Hr24". }
    iIntros "Hcg Hpc Hr24".
    assert (Hpc04 : add_vec_int (mword_of_int (UF + 0x02) : mword 64) 2 = mword_of_int (UF + 0x04))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc04) in "Hpc".
    (* +0x04 c.sdsp s0,16(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UF + 0x04)) (mword_of_int 2 : mword 6) Rs0
              A0 (K - 4)%nat vr16 with "Hcg Hpc Hi04 [Hr16] [-]").
    { iEval (rewrite HA0sp -Hb2). iExact "Hr16". }
    iIntros "Hcg Hpc Hr16".
    assert (Hpc06 : add_vec_int (mword_of_int (UF + 0x04) : mword 64) 2 = mword_of_int (UF + 0x06))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc06) in "Hpc".
    (* +0x06 c.sdsp s1,8(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UF + 0x06)) (mword_of_int 1 : mword 6) Rs1
              A0 (K - 4)%nat vr8 with "Hcg Hpc Hi06 [Hr8] [-]").
    { iEval (rewrite HA0sp -Hb3). iExact "Hr8". }
    iIntros "Hcg Hpc Hr8".
    assert (Hpc08 : add_vec_int (mword_of_int (UF + 0x06) : mword 64) 2 = mword_of_int (UF + 0x08))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (UF + 0x08)) (Cregidx (mword_of_int 0))
    ...
    assert (Hpc0a : add_vec_int (mword_of_int (UF + 0x08) : mword 64) 2 = mword_of_int (UF + 0x0a))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UF + 0x0a)) Rs1 Ra0 A1 (K - 4)%nat
    ...
    assert (Hpc0c : add_vec_int (mword_of_int (UF + 0x0a) : mword 64) 2 = mword_of_int (UF + 0x0c))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iAssert JOIN with "[Hcont Hr24 Hr16 Hr8 Hgap]" as "Hjoin".
    { rewrite /JOIN.
      iIntros (mj) "(%Hjsp & %Hjs1 & %Hjtp & %Hjthr) Hcg Hcpu Hpc Hpt".
      (* +0x0e c.mv a0,s1 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UF + 0x0e)) Ra0 Rs1 mj (K - 4)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi0e [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hpc10 : add_vec_int (mword_of_int (UF + 0x0e) : mword 64) 2
                      = mword_of_int (UF + 0x10))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc10) in "Hpc".
      (* +0x10 jal ra,freewalk *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (UF + 0x10)) Rra
                (mword_of_int 2097044 : mword 21) J0 (K - 4)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi10 [-]").
      iIntros "Hcg Hpc".
      set (J1 := <[Regidx Rra := regval_into_reg
          (add_vec_int (mword_of_int (UF + 0x10) : mword 64) 4)]> J0).
      change (<[Regidx Rra := regval_into_reg
          (add_vec_int (mword_of_int (UF + 0x10) : mword 64) 4)]> J0) with J1.
      assert (Hjmp : add_vec (mword_of_int (UF + 0x10) : mword 64)
      ...
      assert (HJ1ra : J1 !!! Regidx Rra
                      = add_vec_int (mword_of_int (UF + 0x10) : mword 64) 4)
      ...
      assert (HJ1tp : J1 !!! Regidx Rtp = cid_word).
      { rewrite /J1 upd_ne; [| reg_neq]. rewrite /J0 upd_ne; [| reg_neq]. exact Hjtp. }
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UF + 0x14)) (mword_of_int 3 : mword 6) Rra
                mr (K - 4)%nat (mm !!! Regidx Rra) (dqm := DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi14 [Hr24] [-]").
      { iEval (rewrite Hmrsp). iExact "Hr24". }
      iIntros "Hcg Hpc Hr24". iEval (rewrite Hmrsp) in "Hr24".
      ...
      assert (Hpc16 : add_vec_int (mword_of_int (UF + 0x14) : mword 64) 2
                      = mword_of_int (UF + 0x16))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc16) in "Hpc".
      (* +0x16 c.ldsp s0,16(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UF + 0x16)) (mword_of_int 2 : mword 6) Rs0
                E0 (K - 4)%nat (mm !!! Regidx Rs0) (dqm := DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi16 [Hr16] [-]").
      { iEval (rewrite HE0sp). iExact "Hr16". }
      iIntros "Hcg Hpc Hr16". iEval (rewrite HE0sp) in "Hr16".
      ...
      assert (Hpc18 : add_vec_int (mword_of_int (UF + 0x16) : mword 64) 2
                      = mword_of_int (UF + 0x18))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc18) in "Hpc".
      (* +0x18 c.ldsp s1,8(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UF + 0x18)) (mword_of_int 1 : mword 6) Rs1
                E1 (K - 4)%nat (mm !!! Regidx Rs1) (dqm := DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi18 [Hr8] [-]").
      { iEval (rewrite HE1sp). iExact "Hr8". }
      iIntros "Hcg Hpc Hr8". iEval (rewrite HE1sp) in "Hr8".
      ...
      assert (Hpc1a : add_vec_int (mword_of_int (UF + 0x18) : mword 64) 2
                      = mword_of_int (UF + 0x1a))
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (UF + 0x1a))
                (mword_of_int 2 : mword 6) E2 (K - 4)%nat 4 Hpop
      ...
      assert (Hpc1c : add_vec_int (mword_of_int (UF + 0x1a) : mword 64) 2
                      = mword_of_int (UF + 0x1c))
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_cret_s_sconf γ Φ (mword_of_int (UF + 0x1c)) Rra E3 K
    ...
    2:{ (* ---- FALLS: sz = 0.  [n = 0], so the premise says [um = ∅]. --- *)
      ...
      iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (UF + 0x0c))
                (mword_of_int 9 : mword 8) (Cregidx (mword_of_int 3)) Ra1
                A2 (K - 4)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate) Hbr'
                with "Hcg Hpc Hi0c [-]").
      iIntros "Hcg Hpc".
      assert (Hpc0e : add_vec_int (mword_of_int (UF + 0x0c) : mword 64) 2
                      = mword_of_int (UF + 0x0e))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc0e) in "Hpc".
      iApply ("Hjoin" $! A2 with "[%] Hcg Hcpu Hpc Hpt").
      split_and!; [exact HA2sp | exact HA2s1 | exact HA2tp | exact HA2thr]. }

    (* ---- TAKEN: sz > 0, so uvmunmap first ---- *)
    assert (Hbr' : neq_vec (A2 !!! Regidx Ra1) (zero_reg : mword 64) = true)
      by (rewrite HA2a1; exact Hbr).
    iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (UF + 0x0c))
              (mword_of_int 9 : mword 8) (Cregidx (mword_of_int 3)) Ra1
              A2 (K - 4)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate) Hbr'
              ltac:(vm_compute; reflexivity)
    ...
    assert (Htgt1e : add_vec (mword_of_int (UF + 0x0c) : mword 64)
                       (sign_extend' 64 (sign_extend' 13
                          (concat_vec (mword_of_int 9 : mword 8) ('b"0"))))
                     = mword_of_int (UF + 0x1e))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_clui_s_sconf γ Φ (mword_of_int (UF + 0x1e)) Ra5
    ...
    assert (Hpc20 : add_vec_int (mword_of_int (UF + 0x1e) : mword 64) 2
                    = mword_of_int (UF + 0x20))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (UF + 0x20)) Ra5 (mword_of_int 63 : mword 6)
              B1 (K - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi20 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hpc22 : add_vec_int (mword_of_int (UF + 0x20) : mword 64) 2
                    = mword_of_int (UF + 0x22))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (UF + 0x22)) Ra1 Ra5 B2 (K - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi22 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hpc24 : add_vec_int (mword_of_int (UF + 0x22) : mword 64) 2
                    = mword_of_int (UF + 0x24))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc24) in "Hpc".
    (* +0x24 c.li a3,1 : do_free = 1 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (UF + 0x24)) Ra3 (mword_of_int 1 : mword 6)
              (mword_of_int 1 : mword 64) B3 (K - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hpc26 : add_vec_int (mword_of_int (UF + 0x24) : mword 64) 2
                    = mword_of_int (UF + 0x26))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_srli4_s_sconf γ Φ (mword_of_int (UF + 0x26)) Ra2 Ra1
              (mword_of_int 12 : mword 6) B4 (K - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi26 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hpc2a : add_vec_int (mword_of_int (UF + 0x26) : mword 64) 4
                    = mword_of_int (UF + 0x2a))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc2a) in "Hpc".
    (* +0x2a c.li a1,0 : va = 0 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (UF + 0x2a)) Ra1 (mword_of_int 0 : mword 6)
              (mword_of_int 0 : mword 64) B5 (K - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi2a [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hpc2c : add_vec_int (mword_of_int (UF + 0x2a) : mword 64) 2
                    = mword_of_int (UF + 0x2c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc2c) in "Hpc".
    (* +0x2c jal ra,uvmunmap *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UF + 0x2c)) Rra
              (mword_of_int 2096640 : mword 21) B6 (K - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi2c [-]").
    iIntros "Hcg Hpc".
    set (B7 := <[Regidx Rra := regval_into_reg
        (add_vec_int (mword_of_int (UF + 0x2c) : mword 64) 4)]> B6).
    change (<[Regidx Rra := regval_into_reg
        (add_vec_int (mword_of_int (UF + 0x2c) : mword 64) 4)]> B6) with B7.
    assert (Hjmpu : add_vec (mword_of_int (UF + 0x2c) : mword 64)
    ...
    assert (HB7ra : B7 !!! Regidx Rra
                    = add_vec_int (mword_of_int (UF + 0x2c) : mword 64) 4)
    ...
    assert (HB7tp : B7 !!! Regidx Rtp = cid_word).
    { rewrite /B7 upd_ne; [| reg_neq]. rewrite /B6 upd_ne; [| reg_neq].
      rewrite /B5 upd_ne; [| reg_neq]. rewrite /B4 upd_ne; [| reg_neq].
      rewrite /B3 upd_ne; [| reg_neq]. rewrite /B2 upd_ne; [| reg_neq].
      rewrite /B1 upd_ne; [| reg_neq]. exact HA2tp. }
    ...
    { rewrite (callee_saved_lookup Hcs Rtp ltac:(vm_compute; reflexivity)).
      exact HB7tp. }
    assert (Hmrthr : forall c : mword 5, is_cs_idx c = true ->
              c <> csp_rs1 -> c <> Rs0 -> c <> Rs1 ->
              mr !!! Regidx c = mm !!! Regidx c).
    ...
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (UF + 0x30))
              (sign_extend' 21 (concat_vec (mword_of_int 2031 : mword 11) ('b"0")))
              mr (K - 4)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi30 [-]").
    iNext. iIntros "Hcg Hpc".
    assert (Htgt0e : add_vec (mword_of_int (UF + 0x30) : mword 64)
    ...
    split_and!; [exact Hmrsp | exact Hmrs1 | exact Hmrtp | exact Hmrthr].
  Qed.

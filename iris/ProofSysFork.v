...
Section ProofSysFork.
 ...
 m lvl av eb p b pid U sts csP Q lks.
  Proof.
    ...
    (* ---- +0x08: jal ra,kfork ---- *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_fork + 0x08)) (mword_of_int 1 : mword 5) (mword_of_int 2093832 : mword 21)
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.sys_fork + 0x08) : mword 64) (sign_extend' 64 (mword_of_int 2093832 : mword 21)) = mword_of_int KernelSyms.kfork)

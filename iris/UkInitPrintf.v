...
Section UkInitPrintf.
  ...
  Lemma wp_kinit_printf_chain (a : Z) (len : nat) (f : nat -> mword 8)
    ...
    (* THE DESCRIPTOR IS FIXED HERE, and that is printf's whole difference
       from vprintf: [c.li a0,1] at 0x7ec.  init's banner goes to fd 1. *)
    □ (∀ j : nat, ⌜(j < len)%nat⌝ -∗
  ...
  Proof using .
    ...
    assert (Ho16 : uoff_sdsp (mword_of_int 2 : mword 6) = 16)
      by (vm_compute; reflexivity).
    (* ---- 0x7c8  c.addi16sp sp,sp,-96 ---- *)
    iApply (wp_uk_caddi16sp_dn N h m (mword_of_int 0x7c8)
              (mword_of_int 58 : mword 6) 12 (12 + (4 + n))
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
    { iApply (uis_init_7c8 with "Hcode"). }
    iIntros "Hframe".
    assert (E7c0 : add_vec_int (mword_of_int 0x7c8 : mword 64) 2
                   = mword_of_int 0x7ca)
    ...
    assert (Hs0q1 : mq1 !!! Regidx s0_idx = m !!! Regidx s0_idx)
      by exact (upd_ne m (Regidx csp_rs1) (Regidx s0_idx) _
                  ltac:(vm_compute; discriminate)).
    iApply (wp_uk_csdsp N h0 mq1 (mword_of_int 0x7ca)
    ...
    assert (E7c2 : add_vec_int (mword_of_int 0x7ca : mword 64) 2
                   = mword_of_int 0x7cc)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7c2.
    iIntros (h1) "Hrun".
    (* ---- 0x7cc  c.sdsp s0,16(sp) ---- *)
    iApply (wp_uk_csdsp N h1 mq1 (mword_of_int 0x7cc)
    ...
    assert (E7c4 : add_vec_int (mword_of_int 0x7cc : mword 64) 2
                   = mword_of_int 0x7ce)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7c4.
    iIntros (h2) "Hrun".
    (* ---- 0x7ce  c.addi4spn s0,sp,32 -- s0 sits at sp0-64 ---- *)
    ...
    iApply (wp_uk_caddi4spn N h2 mq1 (mword_of_int 0x7ce)
    ...
    assert (E7c6 : add_vec_int (mword_of_int 0x7ce : mword 64) 2
                   = mword_of_int 0x7d0)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7c6.
    iIntros (h3) "Hrun".
    ...
    assert (Hoc8 : uoff_c8 (mword_of_int 1 : mword 5) = 8)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd N h3 mq2 (mword_of_int 0x7d0)
    ...
    iIntros "Hu7".
    assert (E7c8 : add_vec_int (mword_of_int 0x7d0 : mword 64) 2
                 = mword_of_int 0x7d2)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7c8.
    iIntros (h4) "Hrun".
    ...
    assert (Hoc16 : uoff_c8 (mword_of_int 2 : mword 5) = 16)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd N h4 mq2 (mword_of_int 0x7d2)
    ...
    iIntros "Hu6".
    assert (E7ca : add_vec_int (mword_of_int 0x7d2 : mword 64) 2
                 = mword_of_int 0x7d4)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7ca.
    iIntros (h5) "Hrun".
    ...
    assert (Hoc24 : uoff_c8 (mword_of_int 3 : mword 5) = 24)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd N h5 mq2 (mword_of_int 0x7d4)
              ...
              ltac:(rewrite Zminus_mod Hal8; reflexivity)
              with "[] Hu5 Hrun").
    { iApply (uis_init_7d4 with "Hcode"). }
    iIntros "Hu5".
    assert (E7cc : add_vec_int (mword_of_int 0x7d4 : mword 64) 2
                 = mword_of_int 0x7d6)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7cc.
    iIntros (h6) "Hrun".
    ...
    assert (Hoc32 : uoff_c8 (mword_of_int 4 : mword 5) = 32)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd N h6 mq2 (mword_of_int 0x7d6)
    ...
    iIntros "Hu4".
    assert (E7ce : add_vec_int (mword_of_int 0x7d6 : mword 64) 2
                 = mword_of_int 0x7d8)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7ce.
    iIntros (h7) "Hrun".
    ...
    assert (Hoc40 : uoff_c8 (mword_of_int 5 : mword 5) = 40)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd N h7 mq2 (mword_of_int 0x7d8)
              ...
              ltac:(rewrite Zminus_mod Hal8; reflexivity)
              with "[] Hu3 Hrun").
    { iApply (uis_init_7d8 with "Hcode"). }
    iIntros "Hu3".
    assert (E7d0 : add_vec_int (mword_of_int 0x7d8 : mword 64) 2
                 = mword_of_int 0x7da)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7d0.
    iIntros (h8) "Hrun".
    ...
    assert (Hoi48 : uoff_i12 (mword_of_int 48 : mword 12) = 48)
      by (vm_compute; reflexivity).
    iApply (wp_uk_sd N h8 mq2 (mword_of_int 0x7da)
    ...
    iIntros "Hu2".
    assert (E7d2 : add_vec_int (mword_of_int 0x7da : mword 64) 4
                 = mword_of_int 0x7de)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7d2.
    iIntros (h9) "Hrun".
    ...
    assert (Hoi56 : uoff_i12 (mword_of_int 56 : mword 12) = 56)
      by (vm_compute; reflexivity).
    iApply (wp_uk_sd N h9 mq2 (mword_of_int 0x7de)
    ...
    iIntros "Hu1".
    assert (E7d6 : add_vec_int (mword_of_int 0x7de : mword 64) 4
                 = mword_of_int 0x7e2)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7d6.
    iIntros (h10) "Hrun".
    (* ---- 0x7e2  addi a2,s0,8 -- the va_list ---- *)
    iApply (wp_uk_addi N h10 mq2 (mword_of_int 0x7e2)
    ...
    assert (E7da : add_vec_int (mword_of_int 0x7e2 : mword 64) 4
                   = mword_of_int 0x7e6)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7da.
    iIntros (h11) "Hrun".
    ...
    { rewrite <- Hs0q2. f_equal;
        exact (upd_ne mq2 (Regidx a2_idx) (Regidx s0_idx) _
                 ltac:(vm_compute; discriminate)). }
    (* ---- 0x7e6  sd a2,-24(s0) -- park it one slot lower ---- *)
    assert (Hoim24 : uoff_i12 (mword_of_int 4072 : mword 12) = -24)
      by (vm_compute; reflexivity).
    iApply (wp_uk_sd N h11 mq3 (mword_of_int 0x7e6)
    ...
    iIntros "Hu11".
    assert (E7de : add_vec_int (mword_of_int 0x7e6 : mword 64) 4
                   = mword_of_int 0x7ea)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7de.
    iIntros (h12) "Hrun".
    (* ---- 0x7ea  c.mv a1,a0 -- the format pointer ---- *)
    ...
    { rewrite <- Ha0r.
      ...
      rewrite /mq1. exact (upd_ne m (Regidx csp_rs1) (Regidx a0_idx) _
                             ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_cmv N h12 mq3 (mword_of_int 0x7ea) a1_idx a0_idx
              (add_vec zero_reg (mq3 !!! Regidx a0_idx)) (12 + (4 + n))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_init_7ea with "Hcode"). }
    assert (E7e2 : add_vec_int (mword_of_int 0x7ea : mword 64) 2
                   = mword_of_int 0x7ec)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7e2.
    iIntros (h13) "Hrun".
    ...
    (* ---- 0x7ec  c.li a0,1 -- fd = stdout ---- *)
    iApply (wp_uk_cli N h13 mq4 (mword_of_int 0x7ec)
              (mword_of_int 1 : mword 6) a0_idx (12 + (4 + n))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "[] Hrun").
    { iApply (uis_init_7ec with "Hcode"). }
    assert (E7e4 : add_vec_int (mword_of_int 0x7ec : mword 64) 2
                   = mword_of_int 0x7ee)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7e4.
    iIntros (h14) "Hrun".
    ...
    { rewrite <- Ha1q4.
      exact (upd_ne mq4 (Regidx a0_idx) (Regidx a1_idx) _
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x7ee  jal ra,0x4de <vprintf> ---- *)
    iApply (wp_uk_jal N h14 mq5 (mword_of_int 0x7ee)
              (mword_of_int 2096368 : mword 21) ra_idx
              (mword_of_int InitSyms.vprintf) (mword_of_int 0x7f2) (12 + (4 + n))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
    ...
    set (mq6 := <[Regidx ra_idx
                  := regval_into_reg (mword_of_int 0x7f2 : mword 64)]> mq5).
    assert (Hraq6 : mq6 !!! Regidx ra_idx = (mword_of_int 0x7f2 : mword 64))
    ...
    { rewrite (Hcs csp_rs1 ltac:(vm_compute; reflexivity)).
      ...
      rewrite /mq3. exact (upd_ne mq2 (Regidx a2_idx) (Regidx csp_rs1) _
                             ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_cldsp N h16 mq7 (mword_of_int 0x7f2)
              ...
              ltac:(vm_compute; discriminate)
              with "[] Hu9 Hrun").
    { iApply (uis_init_7f2 with "Hcode"). }
    iIntros "Hu9".
    assert (E7ea : add_vec_int (mword_of_int 0x7f2 : mword 64) 2
                   = mword_of_int 0x7f4)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7ea.
    iIntros (h17) "Hrun".
    ...
    iApply (wp_uk_cldsp N h17 mq8 (mword_of_int 0x7f4)
              ...
              ltac:(vm_compute; discriminate)
              with "[] Hu10 Hrun").
    { iApply (uis_init_7f4 with "Hcode"). }
    iIntros "Hu10".
    assert (E7ec : add_vec_int (mword_of_int 0x7f4 : mword 64) 2
                   = mword_of_int 0x7f6)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E7ec.
    iIntros (h18) "Hrun".
    ...
    { rewrite <- Hspq8.
      exact (upd_ne mq8 (Regidx s0_idx) (Regidx csp_rs1) _
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x7f6  c.addi16sp sp,sp,96 -- the frame goes back ---- *)
    iApply (wp_uk_caddi16sp_up N h18 mq9 (mword_of_int 0x7f6)
              (mword_of_int 6 : mword 6) 12 (12 + (4 + n))
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "[] [Hu1 Hu2 Hu3 Hu4 Hu5 Hu6 Hu7 Hu8 Hu9 Hu10 Hu11 Hu12] Hrun").
    { iApply (uis_init_7f6 with "Hcode"). }
    { rewrite Hspq9 Hup.
    ...
    assert (E7ee : add_vec_int (mword_of_int 0x7f6 : mword 64) 2
                   = mword_of_int 0x7f8)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* ---- 0x7f8  c.jr ra ---- *)
    iApply (wp_uk_cjr N h19 mq10 (mword_of_int 0x7f8) ra_idx
              (ret_pc (m !!! Regidx ra_idx)) (12 + (12 + (4 + n)))
              ltac:(vm_compute; discriminate)
              ltac:(rewrite Hraq10; reflexivity)
              with "[] Hrun").
    { iApply (uis_init_7f8 with "Hcode"). }
    iIntros (h20) "Hrun".

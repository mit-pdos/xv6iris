  ...
  Proof.
    ...
    - (* ================= SUCCESS: fd names a live file ================= *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_close + 0x1c))
                (mword_of_int 1 : mword 5) (mword_of_int 2083748 : mword 21) A7 (av - 4)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi1c [-]").
      ...
      assert (Hjmp : add_vec (mword_of_int (KernelSyms.sys_close + 0x1c) : mword 64)
                       (sign_extend' 64 (mword_of_int 2083748 : mword 21)) = mword_of_int KernelSyms.myproc)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_close + 0x34))
                (mword_of_int 1 : mword 5) (mword_of_int 2093914 : mword 21) C5 (av - 4)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi34 [-]").
      ...
      assert (Hjfc : add_vec (mword_of_int (KernelSyms.sys_close + 0x34) : mword 64)
                       (sign_extend' 64 (mword_of_int 2093914 : mword 21)) = mword_of_int KernelSyms.fileclose)
        by (apply bv_eq; vm_compute; reflexivity).

(* SpecIget.v -- the public interface of iget(), stated over the REAL inode
   ...
   is the loop [IcacheRefDefs.ientry_step] and [ientry_sentinel] describe: the
   ...
   ADDRESS, and [IcacheRefDefs.ientry_inj] is what makes the two views the same
   ...
   one binder [l : ilic] and one premise [iname fsc_ireg fsc_fs inodestart inum l].  The user's

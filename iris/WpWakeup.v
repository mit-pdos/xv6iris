...
(* ====================================================================== *)
Definition wk_prologue : list vop_s :=
  [ VScaddi16sp (mword_of_int 60);
    VScsdsp (mword_of_int 7) (mword_of_int 1);
    VScsdsp (mword_of_int 6) (mword_of_int 8);
    VScsdsp (mword_of_int 5) (mword_of_int 9);
    VScsdsp (mword_of_int 4) (mword_of_int 18);
    VScsdsp (mword_of_int 3) (mword_of_int 19);
    VScsdsp (mword_of_int 2) (mword_of_int 20);
    VScsdsp (mword_of_int 1) (mword_of_int 21);
    VScaddi4spn (Cregidx (mword_of_int 0)) (mword_of_int 16) (mword_of_int 8) ].
Definition wk_pro_heap0 : list (sval * sval) :=
  [ (SX 2 (wrap64 (-8)),  SX 33 0); (SX 2 (wrap64 (-16)), SX 34 0);
    (SX 2 (wrap64 (-24)), SX 35 0); (SX 2 (wrap64 (-32)), SX 36 0);
    (SX 2 (wrap64 (-40)), SX 37 0); (SX 2 (wrap64 (-48)), SX 38 0);
    (SX 2 (wrap64 (-56)), SX 39 0) ].
Definition wk_pro_heap1 : list (sval * sval) :=
  [ (SX 2 (wrap64 (-8)),  SX 1 0);  (SX 2 (wrap64 (-16)), SX 8 0);
    (SX 2 (wrap64 (-24)), SX 9 0);  (SX 2 (wrap64 (-32)), SX 18 0);
    (SX 2 (wrap64 (-40)), SX 19 0); (SX 2 (wrap64 (-48)), SX 20 0);
    (SX 2 (wrap64 (-56)), SX 21 0) ].
Definition wk_pro_regs1 : gmap regidx sval :=
  <[Regidx (mword_of_int 8 : mword 5) := SX 2 0]>
    (<[Regidx csp_rs1 := SX 2 (wrap64 (-64))]> vregs_init).

Lemma wk_prologue_run :
  vc_block_s (VSt KernelSyms.wakeup vregs_init wk_pro_heap0 []) wk_prologue
  = Some (VSt (KernelSyms.wakeup + 18) wk_pro_regs1 wk_pro_heap1 []).
...
Definition wk_epi : list vop_s :=
  [ VScldsp (mword_of_int 7) (mword_of_int 1);
    VScldsp (mword_of_int 6) (mword_of_int 8);
    VScldsp (mword_of_int 5) (mword_of_int 9);
    VScldsp (mword_of_int 4) (mword_of_int 18);
    VScldsp (mword_of_int 3) (mword_of_int 19);
    VScldsp (mword_of_int 2) (mword_of_int 20);
    VScldsp (mword_of_int 1) (mword_of_int 21);
    VScaddi16sp (mword_of_int 4) ].
Definition wk_epi_heap0 : list (sval * sval) :=
  [ (SX 2 (wrap64 56), SX 33 0); (SX 2 (wrap64 48), SX 34 0);
    (SX 2 (wrap64 40), SX 35 0); (SX 2 (wrap64 32), SX 36 0);
    (SX 2 (wrap64 24), SX 37 0); (SX 2 (wrap64 16), SX 38 0);
    (SX 2 (wrap64 8),  SX 39 0) ].
Definition wk_epi_regs1 : gmap regidx sval :=
  <[Regidx csp_rs1 := SX 2 (wrap64 64)]>
  ...
  (<[Regidx (mword_of_int 1)  := SX 33 0]> vregs_init))))))).

Lemma wk_epi_run :
  vc_block_s (VSt (KernelSyms.wakeup + 0x58) vregs_init wk_epi_heap0 []) wk_epi
  = Some (VSt (KernelSyms.wakeup + 0x68) wk_epi_regs1 wk_epi_heap0 []).
Proof. vm_compute. reflexivity. Qed.
...
Section WkLeaves.
  ...
  Proof. mk_rvc (KernelSyms.wakeup + 0x00)%Z (mword_of_int 0x7139 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x00) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 60 : mword 6), sp, sp, ADDI)) wkd_f44 exec_execute_C_ADDI16SP. Qed.
  Lemma wki_02 : WKI 0x02 true (STORE (csdsp_imm 7, Regidx (mword_of_int 1), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x02)%Z (mword_of_int 0xfc06 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x02) : mword 64) (STORE (csdsp_imm 7, Regidx (mword_of_int 1), sp, 8)) wkd_f46 exec_execute_C_SDSP. Qed.
  Lemma wki_04 : WKI 0x04 true (STORE (csdsp_imm 6, Regidx (mword_of_int 8), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x04)%Z (mword_of_int 0xf822 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x04) : mword 64) (STORE (csdsp_imm 6, Regidx (mword_of_int 8), sp, 8)) wkd_f48 exec_execute_C_SDSP. Qed.
  Lemma wki_06 : WKI 0x06 true (STORE (csdsp_imm 5, Regidx (mword_of_int 9), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x06)%Z (mword_of_int 0xf426 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x06) : mword 64) (STORE (csdsp_imm 5, Regidx (mword_of_int 9), sp, 8)) wkd_f4a exec_execute_C_SDSP. Qed.
  Lemma wki_08 : WKI 0x08 true (STORE (csdsp_imm 4, Regidx (mword_of_int 18), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x08)%Z (mword_of_int 0xf04a : mword 16) (mword_of_int (KernelSyms.wakeup + 0x08) : mword 64) (STORE (csdsp_imm 4, Regidx (mword_of_int 18), sp, 8)) wkd_f4c exec_execute_C_SDSP. Qed.
  Lemma wki_0a : WKI 0x0a true (STORE (csdsp_imm 3, Regidx (mword_of_int 19), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x0a)%Z (mword_of_int 0xec4e : mword 16) (mword_of_int (KernelSyms.wakeup + 0x0a) : mword 64) (STORE (csdsp_imm 3, Regidx (mword_of_int 19), sp, 8)) wkd_f4e exec_execute_C_SDSP. Qed.
  Lemma wki_0c : WKI 0x0c true (STORE (csdsp_imm 2, Regidx (mword_of_int 20), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x0c)%Z (mword_of_int 0xe852 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x0c) : mword 64) (STORE (csdsp_imm 2, Regidx (mword_of_int 20), sp, 8)) wkd_f50 exec_execute_C_SDSP. Qed.
  Lemma wki_0e : WKI 0x0e true (STORE (csdsp_imm 1, Regidx (mword_of_int 21), sp, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x0e)%Z (mword_of_int 0xe456 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x0e) : mword 64) (STORE (csdsp_imm 1, Regidx (mword_of_int 21), sp, 8)) wkd_f52 exec_execute_C_SDSP. Qed.
  Lemma wki_10 : WKI 0x10 true (ITYPE (caddi4spn_imm (mword_of_int 16 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x10)%Z (mword_of_int 0x0080 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x10) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 16 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) wkd_f54 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (KernelSyms.wakeup + 0x2a)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x2a) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) wkd_f6e exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.wakeup + 0x40)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x40) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) wkd_f6e exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.wakeup + 0x46)%Z (mword_of_int 0x4c9c : mword 16) (mword_of_int (KernelSyms.wakeup + 0x46) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 6 : mword 5) ('b"00")), creg2reg_idx (Cregidx (mword_of_int 1)), creg2reg_idx (Cregidx (mword_of_int 7)), false, 4)) wkd_f8a wkx_clw. Qed.
  ...
  Proof. mk_rvc (KernelSyms.wakeup + 0x58)%Z (mword_of_int 0x70e2 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x58) : mword 64) (LOAD (csdsp_imm 7, sp, Regidx (mword_of_int 1), false, 8)) wkd_f9c exec_execute_C_LDSP. Qed.
  Lemma wki_5a : WKI 0x5a true (LOAD (csdsp_imm 6, sp, Regidx (mword_of_int 8), false, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x5a)%Z (mword_of_int 0x7442 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x5a) : mword 64) (LOAD (csdsp_imm 6, sp, Regidx (mword_of_int 8), false, 8)) wkd_f9e exec_execute_C_LDSP. Qed.
  Lemma wki_5c : WKI 0x5c true (LOAD (csdsp_imm 5, sp, Regidx (mword_of_int 9), false, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x5c)%Z (mword_of_int 0x74a2 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x5c) : mword 64) (LOAD (csdsp_imm 5, sp, Regidx (mword_of_int 9), false, 8)) wkd_fa0 exec_execute_C_LDSP. Qed.
  Lemma wki_5e : WKI 0x5e true (LOAD (csdsp_imm 4, sp, Regidx (mword_of_int 18), false, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x5e)%Z (mword_of_int 0x7902 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x5e) : mword 64) (LOAD (csdsp_imm 4, sp, Regidx (mword_of_int 18), false, 8)) wkd_fa2 exec_execute_C_LDSP. Qed.
  Lemma wki_60 : WKI 0x60 true (LOAD (csdsp_imm 3, sp, Regidx (mword_of_int 19), false, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x60)%Z (mword_of_int 0x69e2 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x60) : mword 64) (LOAD (csdsp_imm 3, sp, Regidx (mword_of_int 19), false, 8)) wkd_fa4 exec_execute_C_LDSP. Qed.
  Lemma wki_62 : WKI 0x62 true (LOAD (csdsp_imm 2, sp, Regidx (mword_of_int 20), false, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x62)%Z (mword_of_int 0x6a42 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x62) : mword 64) (LOAD (csdsp_imm 2, sp, Regidx (mword_of_int 20), false, 8)) wkd_fa6 exec_execute_C_LDSP. Qed.
  Lemma wki_64 : WKI 0x64 true (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 21), false, 8)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x64)%Z (mword_of_int 0x6aa2 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x64) : mword 64) (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 21), false, 8)) wkd_fa8 exec_execute_C_LDSP. Qed.
  Lemma wki_66 : WKI 0x66 true (ITYPE (caddi16sp_imm (mword_of_int 4 : mword 6), sp, sp, ADDI)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x66)%Z (mword_of_int 0x6121 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x66) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 4 : mword 6), sp, sp, ADDI)) wkd_faa exec_execute_C_ADDI16SP. Qed.
  Lemma wki_68 : WKI 0x68 true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).
  Proof. mk_rvc (KernelSyms.wakeup + 0x68)%Z (mword_of_int 0x8082 : mword 16) (mword_of_int (KernelSyms.wakeup + 0x68) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) wkd_fac exec_execute_C_JR. Qed.

  (* the prologue block's [instr] facts, assembled from the [wki_*] templates. *)
  Lemma wk_prologue_instrs :
    kernel_text -∗ block_instrs_s KernelSyms.wakeup wk_prologue.
  Proof.
    iIntros "#Ht".
    cbn [block_instrs_s wk_prologue vop_s_ast vop_s_rvc vop_s_w].
    replace (KernelSyms.wakeup + 2 + 2) with (KernelSyms.wakeup + 4) by lia.
    replace (KernelSyms.wakeup + 4 + 2) with (KernelSyms.wakeup + 6) by lia.
    replace (KernelSyms.wakeup + 6 + 2) with (KernelSyms.wakeup + 8) by lia.
    replace (KernelSyms.wakeup + 8 + 2) with (KernelSyms.wakeup + 10) by lia.
    replace (KernelSyms.wakeup + 10 + 2) with (KernelSyms.wakeup + 12) by lia.
    replace (KernelSyms.wakeup + 12 + 2) with (KernelSyms.wakeup + 14) by lia.
    replace (KernelSyms.wakeup + 14 + 2) with (KernelSyms.wakeup + 16) by lia.
    iSplitR; [by iApply wki_00|].
    iSplitR; [by iApply wki_02|].
    iSplitR; [by iApply wki_04|].
    iSplitR; [by iApply wki_06|].
    iSplitR; [by iApply wki_08|].
    iSplitR; [by iApply wki_0a|].
    iSplitR; [by iApply wki_0c|].
    iSplitR; [by iApply wki_0e|].
    iSplitR.
    { assert (Hcreg : creg2reg_idx (Cregidx (mword_of_int 0 : mword 3))
                      = Regidx (mword_of_int 8 : mword 5)) by (vm_compute; reflexivity).
      rewrite -Hcreg. by iApply wki_10. }
    done.
  Qed.

  (* the epilogue block's [instr] facts, assembled from the [wki_*] templates. *)
  Lemma wk_epi_instrs :
    kernel_text -∗ block_instrs_s (KernelSyms.wakeup + 0x58) wk_epi.
  Proof.
    iIntros "#Ht".
    cbn [block_instrs_s wk_epi vop_s_ast vop_s_rvc vop_s_w].
    replace (KernelSyms.wakeup + 0x58 + 2) with (KernelSyms.wakeup + 0x5a) by lia.
    replace (KernelSyms.wakeup + 0x5a + 2) with (KernelSyms.wakeup + 0x5c) by lia.
    replace (KernelSyms.wakeup + 0x5c + 2) with (KernelSyms.wakeup + 0x5e) by lia.
    replace (KernelSyms.wakeup + 0x5e + 2) with (KernelSyms.wakeup + 0x60) by lia.
    replace (KernelSyms.wakeup + 0x60 + 2) with (KernelSyms.wakeup + 0x62) by lia.
    replace (KernelSyms.wakeup + 0x62 + 2) with (KernelSyms.wakeup + 0x64) by lia.
    replace (KernelSyms.wakeup + 0x64 + 2) with (KernelSyms.wakeup + 0x66) by lia.
    iSplitR; [by iApply wki_58|].
    iSplitR; [by iApply wki_5a|].
    iSplitR; [by iApply wki_5c|].
    iSplitR; [by iApply wki_5e|].
    iSplitR; [by iApply wki_60|].
    iSplitR; [by iApply wki_62|].
    iSplitR; [by iApply wki_64|].
    iSplitR; [by iApply wki_66|].
    done.
  Qed.
...
(* SIE ghost half, and [tlb_inv_pt] -- exactly the resources acquire/release     *)
...
Axiom wp_myproc :
  forall {Σ : gFunctors} {HR : riscvGS Σ} {HS : sieG Σ} {CID : CpuId}
    (root_ppn : mword 44) (Phi : mval -> iProp Σ)
    ...
    smode_config γc (DfracOwn 1) -∗ ghost_var γc (1/2) bsie -∗ tlb_inv_pt root_ppn -∗
...
Section WkScfgLeaves.
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
  ...
  Proof.
    ...
    iDestruct "Hmieb" as (mie_v mdv0) "(Hmie & Hmdl & %Hmm)".
    iDestruct "Hmenvb" as (menvcfg0) "(Hmenv & %HPBMTE & %Hpmm & %Hlpe & %Hfiom & %Hmenvval0)".
    iApply (wp_cld_s_pt root_ppn Φ pc rd rs1 imm m v mstatus0 mie_v mdv0 menvcfg0 (dq:=dq) (dqm:=dqm)
...
Section ProcInv.
  ...
  (* the ambient S-mode config a running/resumed kernel thread holds -- the same
     [sconf] (smode_config γc + the SIE ghost half + tlb_inv_pt) that wp_swtch is
  ...
  Local Notation VC :=
    (valid_context (sconf root_ppn γc bsie dq) Phi).
  ...
  Definition wk_regs (M : gmap regidx (mword 64))
      (spF sp0 rra rtp : mword 64) (chan : mword 64)
      (vs6 vs7 vs8 vs9 vs10 vs11 : mword 64) (i : nat) : Prop :=
  ...
  Lemma wp_wakeup_prologue (m : gmap regidx (mword 64))
    ...
    ( ∀ M : gmap regidx (mword 64),
        ⌜ wk_regs M spF (m !!! Regidx (mword_of_int 2 : mword 5))
            ...
            (m !!! Regidx (mword_of_int 26 : mword 5)) (m !!! Regidx (mword_of_int 27 : mword 5)) 0 ⌝ -∗
        smode_config γc (DfracOwn 1) -∗ ghost_var γc (1/2) bsie -∗ tlb_inv_pt root_ppn -∗
  ...
  Proof.
    ...
    (* ------------------------------------------------------------------ *)
    (* Prologue block (0x00..0x10): [c.addi16sp sp,-64], the seven         *)
    (* [c.sdsp] frame saves, and [c.addi4spn s0,sp,64], run as ONE VCgen   *)
    (* straight-line block that lands at 0x12.                             *)
    (* ------------------------------------------------------------------ *)
    ...
    set (rhoA := fun k : nat =>
           ...
           else if Nat.eqb k 33 then (f7 : mword 64)
                else if Nat.eqb k 34 then (f6 : mword 64)
                else if Nat.eqb k 35 then (f5 : mword 64)
                else if Nat.eqb k 36 then (f4 : mword 64)
                else if Nat.eqb k 37 then (f3 : mword 64)
                else if Nat.eqb k 38 then (f2 : mword 64)
                else (f1 : mword 64)).
    assert (HdenA : vregs_den rhoA vregs_init = m).
    { apply (vregs_den_init_agree _ _ Hdom0 Hx00). intros k Hk.
      unfold rhoA. rewrite (proj2 (Nat.ltb_lt k 32) Hk). reflexivity. }
    (* the seven frame cells sit at the block's seven SP-relative slots *)
    assert (Haddr7 : sval_den rhoA (SX 2 (wrap64 (-8)))  = wk_fcell spF 7).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr6 : sval_den rhoA (SX 2 (wrap64 (-16))) = wk_fcell spF 6).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr5 : sval_den rhoA (SX 2 (wrap64 (-24))) = wk_fcell spF 5).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr4 : sval_den rhoA (SX 2 (wrap64 (-32))) = wk_fcell spF 4).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr3 : sval_den rhoA (SX 2 (wrap64 (-40))) = wk_fcell spF 3).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr2 : sval_den rhoA (SX 2 (wrap64 (-48))) = wk_fcell spF 2).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr1 : sval_den rhoA (SX 2 (wrap64 (-56))) = wk_fcell spF 1).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      unfold wk_fcell. subst spF. rewrite add_vec_off2. f_equal; apply bv_eq; vm_compute; reflexivity. }
    (* the block's input cells hold f7..f1 *)
    assert (Hin7 : sval_den rhoA (SX 33 0) = (f7 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hin6 : sval_den rhoA (SX 34 0) = (f6 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hin5 : sval_den rhoA (SX 35 0) = (f5 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hin4 : sval_den rhoA (SX 36 0) = (f4 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hin3 : sval_den rhoA (SX 37 0) = (f3 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hin2 : sval_den rhoA (SX 38 0) = (f2 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hin1 : sval_den rhoA (SX 39 0) = (f1 : mword 64)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    iDestruct (wk_prologue_instrs with "Htext") as "Hbi".
    iEval (rewrite -HdenA) in "Hfile".
    (* unbundle [smode_config] into raw cells for the DEN block engine *)
    iDestruct (smode_config_unbundle with "Hsm") as
      "(#Hhw & #Hinv & Hhs & Hpriv & Hmst & Hmieb & Hmenvb)".
    iDestruct "Hmst" as (mstatus0) "(Hms & Hsie & %HSIE & %HMPRV & %HSXL & %HMXR & %Hleg)".
    iDestruct "Hmieb" as (mie_v mdv0) "(Hmie & Hmdl & %Hmm)".
    iDestruct "Hmenvb" as (menvcfg0) "(Hmenv & %HPBMTE & %Hpmm & %Hlpe & %Hfiom & %Hmenvval0)".
    iApply (wp_vc_block_s_den root_ppn wk_prologue Phi
              (VSt KernelSyms.wakeup vregs_init wk_pro_heap0 [])
              (VSt (KernelSyms.wakeup + 18) wk_pro_regs1 wk_pro_heap1 [])
              rhoA mstatus0 mie_v mdv0 menvcfg0 (dq:=DfracOwn 1)
 HSIE HMPRV HSXL Hmm HMXR Hpmm HPBMTE Hmenvval0 wk_prologue_run
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlb Hpc Hfile Hbi [Hc7 Hc6 Hc5 Hc4 Hc3 Hc2 Hc1] []").
    { rewrite /vheap_own. cbn [vheap]. rewrite /wk_pro_heap0. cbn [big_opL fst snd].
      rewrite Haddr7 Haddr6 Haddr5 Haddr4 Haddr3 Haddr2 Haddr1
              Hin7 Hin6 Hin5 Hin4 Hin3 Hin2 Hin1.
      iFrame "Hc7 Hc6 Hc5 Hc4 Hc3 Hc2 Hc1". }
    { rewrite /vheap4_own. cbn [vheap4]. done. }
    iIntros "Hhs Hpriv Hms Hmie Hmdl Hmenv Htlb Hpc Hfile Hheap _".
    (* denote the post-block register file to a concrete insert tower over m *)
    assert (Hsp_out : sval_den rhoA (SX 2 (wrap64 (-64))) = spF).
    { cbn [sval_den]. replace (rhoA 2%nat) with (m !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoA; reflexivity).
      subst spF. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Hs0_out : sval_den rhoA (SX 2 0) = m !!! Regidx (mword_of_int 2 : mword 5))
      by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hmden : vregs_den rhoA wk_pro_regs1
                    = <[Regidx (mword_of_int 8 : mword 5) := m !!! Regidx (mword_of_int 2 : mword 5)]>
                      (<[Regidx csp_rs1 := spF]> m)).
    { unfold wk_pro_regs1. rewrite -vregs_den_insert -vregs_den_insert HdenA Hsp_out Hs0_out. reflexivity. }
    iEval (rewrite Hmden) in "Hfile".
    (* the post-block frame cells now hold the saved ra/s0/s1..s5 *)
    assert (Hout1  : sval_den rhoA (SX 1 0)  = m !!! Regidx (mword_of_int 1 : mword 5))  by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hout8  : sval_den rhoA (SX 8 0)  = m !!! Regidx (mword_of_int 8 : mword 5))  by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hout9  : sval_den rhoA (SX 9 0)  = m !!! Regidx (mword_of_int 9 : mword 5))  by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hout18 : sval_den rhoA (SX 18 0) = m !!! Regidx (mword_of_int 18 : mword 5)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hout19 : sval_den rhoA (SX 19 0) = m !!! Regidx (mword_of_int 19 : mword 5)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hout20 : sval_den rhoA (SX 20 0) = m !!! Regidx (mword_of_int 20 : mword 5)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    assert (Hout21 : sval_den rhoA (SX 21 0) = m !!! Regidx (mword_of_int 21 : mword 5)) by (rewrite sval_den_SX0; unfold rhoA; reflexivity).
    iEval (rewrite /vheap_own; cbn [vheap]; rewrite /wk_pro_heap1; cbn [big_opL fst snd];
           rewrite Haddr7 Haddr6 Haddr5 Haddr4 Haddr3 Haddr2 Haddr1
                   Hout1 Hout8 Hout9 Hout18 Hout19 Hout20 Hout21) in "Hheap".
    iDestruct "Hheap" as "(Hc7 & Hc6 & Hc5 & Hc4 & Hc3 & Hc2 & Hc1 & _)".
    iEval (cbn [vpc]) in "Hpc".
    (* rebundle the config for the [scfg] downstream leaves *)
    ...
    (* the block landed [pc] at [wakeup+18 = wakeup+0x12] already. *)
    iApply (wp_cmv_gpr_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x12))
              (mword_of_int 20 : mword 5) (mword_of_int 10 : mword 5) _
              (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
              with "Hsm Htlb Hpc Hfile Hi12 [-]").
    ...
    iApply (wp_auipc_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x14))
              (mword_of_int 9 : mword 5) (mword_of_int 0x11 : mword 20) _
              (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
              with "Hsm Htlb Hpc Hfile Hi14 [-]").
    iIntros "Hsm Htlb Hpc Hfile".
    ...
    iApply (wp_addi4_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x18))
 ...
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cli_gpr_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x1c))
              (mword_of_int 19 : mword 5) (mword_of_int 2 : mword 6) _
              (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
              with "Hsm Htlb Hpc Hfile Hi1c [-]").
    iIntros "Hsm Htlb Hpc Hfile".
    (* ---- f62: c.li s5,3 ---- *)
    ...
    iApply (wp_cli_gpr_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x1e))
              (mword_of_int 21 : mword 5) (mword_of_int 3 : mword 6) _
              (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
              with "Hsm Htlb Hpc Hfile Hi1e [-]").
    iIntros "Hsm Htlb Hpc Hfile".
    (* ---- f64: auipc s2,0x16 ---- *)
    ...
    iApply (wp_auipc_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x20))
              (mword_of_int 18 : mword 5) (mword_of_int 0x16 : mword 20) _
              (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
              with "Hsm Htlb Hpc Hfile Hi20 [-]").
    iIntros "Hsm Htlb Hpc Hfile".
    ...
    iApply (wp_addi4_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x24))
 ...
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cj_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x28))
              (sign_extend' 21 (concat_vec (mword_of_int 8 : mword 11) ('b"0"))) _
              (dq:=DfracOwn 1)
 ltac:(rewrite Hjtgt; vm_compute; reflexivity)
              with "Hsm Htlb Hpc Hfile Hi28 [-]").
    iIntros "Hsm Htlb Hpc Hfile".
    ...
    { (* wk_regs *)
      ...
      - (* s5 = 3 *) wk_peel.
        apply bv_eq; vm_compute; reflexivity.
      - (* s6 *) wk_peel. reflexivity.
      - (* s7 *) wk_peel. reflexivity.
      - (* s8 *) wk_peel. reflexivity.
      - (* s9 *) wk_peel. reflexivity.
      - (* s10 *) wk_peel. reflexivity.
      - (* s11 *) wk_peel. reflexivity.
    ...
    { (* wk_frame -- the post-block cells are already in [wk_fcell spF] form *)
  ...
  Lemma wp_wakeup_epilogue (M : gmap regidx (mword 64))
    ...
    WP (Loop : expr riscv_lang) {{ Phi }}.
  Proof.
    intros HspF Hdom rettgt Halign.
    iIntros "Hsm Hgc Htlb #Htext Hpc Hfile Hframe Hcont".
    iDestruct "Hframe" as "(Hc7 & Hc6 & Hc5 & Hc4 & Hc3 & Hc2 & Hc1)".
    (* ------------------------------------------------------------------ *)
    (* Epilogue block (0x58..0x66): the seven [c.ldsp] restores and        *)
    (* [c.addi16sp sp,+64], run as ONE VCgen straight-line block that lands *)
    (* at 0x68 (the [c.ret]).                                              *)
    (* ------------------------------------------------------------------ *)
    ...
    set (rhoE := fun k : nat =>
           if (k <? 32)%nat
           then M !!! Regidx (mword_of_int (Z.of_nat k) : mword 5)
           else if Nat.eqb k 33 then (vra : mword 64)
                else if Nat.eqb k 34 then (vs0 : mword 64)
                else if Nat.eqb k 35 then (vs1 : mword 64)
                else if Nat.eqb k 36 then (vs2 : mword 64)
                else if Nat.eqb k 37 then (vs3 : mword 64)
                else if Nat.eqb k 38 then (vs4 : mword 64)
                else (vs5 : mword 64)).
    assert (HdenE : vregs_den rhoE vregs_init = M).
    { apply (vregs_den_init_agree _ _ Hdom0 Hx00). intros k Hk.
      unfold rhoE. rewrite (proj2 (Nat.ltb_lt k 32) Hk). reflexivity. }
    (* the frame cells sit at the seven positive SP-relative block slots *)
    assert (Haddr7 : sval_den rhoE (SX 2 (wrap64 56)) = wk_fcell spF 7).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr6 : sval_den rhoE (SX 2 (wrap64 48)) = wk_fcell spF 6).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr5 : sval_den rhoE (SX 2 (wrap64 40)) = wk_fcell spF 5).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr4 : sval_den rhoE (SX 2 (wrap64 32)) = wk_fcell spF 4).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr3 : sval_den rhoE (SX 2 (wrap64 24)) = wk_fcell spF 3).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr2 : sval_den rhoE (SX 2 (wrap64 16)) = wk_fcell spF 2).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    assert (Haddr1 : sval_den rhoE (SX 2 (wrap64 8))  = wk_fcell spF 1).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. unfold wk_fcell. f_equal; apply bv_eq; vm_compute; reflexivity. }
    (* the frame cells hold vra/vs0/../vs5 *)
    assert (Hva : sval_den rhoE (SX 33 0) = (vra : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    assert (Hv0 : sval_den rhoE (SX 34 0) = (vs0 : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    assert (Hv1 : sval_den rhoE (SX 35 0) = (vs1 : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    assert (Hv2 : sval_den rhoE (SX 36 0) = (vs2 : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    assert (Hv3 : sval_den rhoE (SX 37 0) = (vs3 : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    assert (Hv4 : sval_den rhoE (SX 38 0) = (vs4 : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    assert (Hv5 : sval_den rhoE (SX 39 0) = (vs5 : mword 64)) by (rewrite sval_den_SX0; unfold rhoE; reflexivity).
    iDestruct (wk_epi_instrs with "Htext") as "Hbi".
    ...
    iDestruct "Hmieb" as (mie_v mdv0) "(Hmie & Hmdl & %Hmm)".
    iDestruct "Hmenvb" as (menvcfg0) "(Hmenv & %HPBMTE & %Hpmm & %Hlpe & %Hfiom & %Hmenvval0)".
    iApply (wp_vc_block_s_den root_ppn wk_epi Phi
              (VSt (KernelSyms.wakeup + 0x58) vregs_init wk_epi_heap0 [])
              (VSt (KernelSyms.wakeup + 0x68) wk_epi_regs1 wk_epi_heap0 [])
              rhoE mstatus0 mie_v mdv0 menvcfg0 (dq:=DfracOwn 1)
 HSIE HMPRV HSXL Hmm HMXR Hpmm HPBMTE Hmenvval0 wk_epi_run
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlb Hpc Hfile Hbi [Hc7 Hc6 Hc5 Hc4 Hc3 Hc2 Hc1] []").
    { rewrite /vheap_own. cbn [vheap]. rewrite /wk_epi_heap0. cbn [big_opL fst snd].
      rewrite Haddr7 Haddr6 Haddr5 Haddr4 Haddr3 Haddr2 Haddr1
              Hva Hv0 Hv1 Hv2 Hv3 Hv4 Hv5.
      iFrame "Hc7 Hc6 Hc5 Hc4 Hc3 Hc2 Hc1". }
    { rewrite /vheap4_own. cbn [vheap4]. done. }
    iIntros "Hhs Hpriv Hms Hmie Hmdl Hmenv Htlb Hpc Hfile Hheap _".
    assert (Hsp_out : sval_den rhoE (SX 2 (wrap64 64))
                      = add_vec spF (sign_extend' 64 (caddi16sp_imm (mword_of_int 4 : mword 6)))).
    { cbn [sval_den]. replace (rhoE 2%nat) with (M !!! Regidx (mword_of_int 2 : mword 5)) by (unfold rhoE; reflexivity).
      rewrite Hcsp2 HspF. f_equal; apply bv_eq; vm_compute; reflexivity. }
    set (Mtgt := <[Regidx csp_rs1 := add_vec spF (sign_extend' 64 (caddi16sp_imm (mword_of_int 4 : mword 6)))]>
                 (<[Regidx (mword_of_int 21 : mword 5) := vs5]>
                 (<[Regidx (mword_of_int 20 : mword 5) := vs4]>
                 (<[Regidx (mword_of_int 19 : mword 5) := vs3]>
                 (<[Regidx (mword_of_int 18 : mword 5) := vs2]>
                 (<[Regidx (mword_of_int 9  : mword 5) := vs1]>
                 (<[Regidx (mword_of_int 8  : mword 5) := vs0]>
                 (<[Regidx (mword_of_int 1  : mword 5) := vra]> M)))))))).
    assert (Hmden : vregs_den rhoE wk_epi_regs1 = Mtgt).
    { unfold wk_epi_regs1, Mtgt.
      rewrite -!vregs_den_insert HdenE Hsp_out Hv5 Hv4 Hv3 Hv2 Hv1 Hv0 Hva. reflexivity. }
    iEval (rewrite Hmden) in "Hfile".
    iEval (rewrite /vheap_own; cbn [vheap]; rewrite /wk_epi_heap0; cbn [big_opL fst snd];
           rewrite Haddr7 Haddr6 Haddr5 Haddr4 Haddr3 Haddr2 Haddr1
                   Hva Hv0 Hv1 Hv2 Hv3 Hv4 Hv5) in "Hheap".
    iDestruct "Hheap" as "(Hc7 & Hc6 & Hc5 & Hc4 & Hc3 & Hc2 & Hc1 & _)".
    iEval (cbn [vpc]) in "Hpc".
    iDestruct (smode_config_rebuild γc (DfracOwn 1) mstatus0 mie_v mdv0 menvcfg0
                 HSIE HMPRV HSXL HMXR Hleg Hmm HPBMTE Hpmm Hlpe Hfiom Hmenvval0
    ...
    assert (HMtgtra : Mtgt !!! Regidx (mword_of_int 1 : mword 5) = vra).
    { rewrite /Mtgt. wk_peel. reflexivity. }
    iApply (wp_cret_s_zca_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x68))
              (mword_of_int 1 : mword 5) Mtgt
              (dq:=DfracOwn 1)

              ltac:(vm_compute; discriminate)
              ltac:(rewrite HMtgtra; exact Halign)
              with "Hsm Htlb Hpc Hfile Hi68 [-]").
    iIntros "Hsm Htlb Hpc Hfile".
    iEval (rewrite HMtgtra) in "Hpc".
    (* rebuild config for the continuation *)
    iApply ("Hcont" $! Mtgt with "[%] Hsm Hgc Htlb Htext Hpc Hfile [Hc7 Hc6 Hc5 Hc4 Hc3 Hc2 Hc1]").
    { (* register facts about the final map Mtgt *)
      rewrite /Mtgt.
      repeat split.
      - (* ra *) wk_peel. reflexivity.
  ...
  Lemma wp_wakeup_loop
    ...
    ∀ (k : nat) (M : gmap regidx (mword 64)),
      ...
      WP (Loop : expr riscv_lang) {{ Phi }}.
  Proof.
    intros Hn Hlen Ha0f Hmycpu_nz Hnf_pos Hnf_rt.
    ...
    iAssert (∀ (fuel k : nat) (M : gmap regidx (mword 64)),
               ⌜(NPROC - k <= fuel)%nat⌝ -∗ ⌜(k < NPROC)%nat⌝ -∗ ⌜wk_loop_regs M spF rtp chan vs6 vs7 vs8 vs9 vs10 vs11 k⌝ -∗
               ( ∀ Mexit : gmap regidx (mword 64),
                   ⌜ Mexit !!! Regidx csp_rs1 = spF
          /\ Mexit !!! Regidx (mword_of_int 4)  = rtp
          /\ Mexit !!! Regidx (mword_of_int 22) = vs6
          ...
          /\ (forall r : regidx, r ∈ dom Mexit) ⌝ -∗
               ...
               kernel_text -∗ pc_is (mword_of_int (KernelSyms.wakeup + 0x38)) -∗ gpr_file M -∗
               wk_res γs spF a0f noffv n -∗ wk_frame spF vra vs0 vs1 vs2 vs3 vs4 vs5 -∗
               WP (Loop : expr riscv_lang) {{ Phi }})%I with "[]" as "Hloop".
    ...
    { iIntros (Mt) "%Hmt Hsm Hgc Htlb Hpc Hfile Hres Hframe".
      ...
      iApply (wp_addi_s_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x30))
 ...
 ltac:(vm_compute; discriminate)
      ...
      + (* TAKEN: p reached &proc[NPROC]; exit to epilogue at wakeup+0x58 *)
        iApply (wp_beq_taken_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x34))
                  (mword_of_int 36 : mword 13) (mword_of_int 18 : mword 5) (mword_of_int 9 : mword 5)
                  Mt30 (dq:=DfracOwn 1)

                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  Hcmp ltac:(vm_compute; reflexivity)
                  with "Hsm Htlb Hpc Hfile Hi34").
        iIntros "Hsm Htlb Hpc Hfile".
      ...
      + (* FALL: p < &proc[NPROC]; recurse into iteration k+1 *)
        iApply (wp_beq_fall_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x34))
                  (mword_of_int 36 : mword 13) (mword_of_int 18 : mword 5) (mword_of_int 9 : mword 5)
                  Mt30 (dq:=DfracOwn 1)
    ...
    iApply (wp_jal_gpr_s_zca_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x38))
 ...
 ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
    ...
    iApply (wp_myproc root_ppn Phi γc bsie Mj
    ...
    - (* TAKEN: a0 = s1 (current proc is myproc): skip to 0x30 (p++) *)
      iApply (wp_beq_taken_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x3c))
                (mword_of_int 8180 : mword 13) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
                mret (dq:=DfracOwn 1)

                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                Hcmp3 ltac:(vm_compute; reflexivity)
                with "Hsm Htlb Hpc Hfile Hi3c").
      iIntros "Hsm Htlb Hpc Hfile".
      ...
      split; [rewrite (Hpres (mword_of_int 22 : mword 5) ltac:(compute_done));
              rewrite /Mj lookup_total_insert_ne; [exact Hs6 | vm_compute; discriminate]|].
      split; [rewrite (Hpres (mword_of_int 23 : mword 5) ltac:(compute_done));
              rewrite /Mj lookup_total_insert_ne; [exact Hs7 | vm_compute; discriminate]|].
      split; [rewrite (Hpres (mword_of_int 24 : mword 5) ltac:(compute_done));
              rewrite /Mj lookup_total_insert_ne; [exact Hs8 | vm_compute; discriminate]|].
      split; [rewrite (Hpres (mword_of_int 25 : mword 5) ltac:(compute_done));
              rewrite /Mj lookup_total_insert_ne; [exact Hs9 | vm_compute; discriminate]|].
      split; [rewrite (Hpres (mword_of_int 26 : mword 5) ltac:(compute_done));
              rewrite /Mj lookup_total_insert_ne; [exact Hs10 | vm_compute; discriminate]|].
      split; [rewrite (Hpres (mword_of_int 27 : mword 5) ltac:(compute_done));
    ...
    - (* FALL: a0 <> s1: acquire proc[k], check state/chan, maybe wake, release *)
      iApply (wp_beq_fall_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x3c))
                (mword_of_int 8180 : mword 13) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
                mret (dq:=DfracOwn 1)
      ...
      iApply (wp_cmv_gpr_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x40))
                (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
                mret (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
                with "Hsm Htlb Hpc Hfile Hi40 [-]").
      iIntros "Hsm Htlb Hpc Hfile".
      ...
      (* 0x42 jal ra,acquire *)
      iApply (wp_jal_gpr_s_zca_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x42))
 ...
 ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
      ...
      iApply (wp_acquire_lock root_ppn Phi γk (proc_lock_res γk (proc_addr k)) M42
                (zero_reg : mword 64) n
 ...
 ltac:(lia)
      ...
      destruct Hpins as (Hfcsp & Hf4 & Hf8 & Hf9 & Hf18 & Hf19 & Hf20 & Hf21 & Hf22 & Hf23 & Hf24 & Hf25 & Hf26 & Hf27).
      ...
      { rewrite Hf22. rewrite /M42 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite /M40 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite (Hpres (mword_of_int 22 : mword 5) ltac:(compute_done)).
        rewrite /Mj lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hs6. }
      assert (HMacq23 : Macq !!! Regidx (mword_of_int 23 : mword 5) = vs7).
      { rewrite Hf23. rewrite /M42 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite /M40 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite (Hpres (mword_of_int 23 : mword 5) ltac:(compute_done)).
        rewrite /Mj lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hs7. }
      assert (HMacq24 : Macq !!! Regidx (mword_of_int 24 : mword 5) = vs8).
      { rewrite Hf24. rewrite /M42 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite /M40 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite (Hpres (mword_of_int 24 : mword 5) ltac:(compute_done)).
        rewrite /Mj lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hs8. }
      assert (HMacq25 : Macq !!! Regidx (mword_of_int 25 : mword 5) = vs9).
      { rewrite Hf25. rewrite /M42 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite /M40 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite (Hpres (mword_of_int 25 : mword 5) ltac:(compute_done)).
        rewrite /Mj lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hs9. }
      assert (HMacq26 : Macq !!! Regidx (mword_of_int 26 : mword 5) = vs10).
      { rewrite Hf26. rewrite /M42 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite /M40 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite (Hpres (mword_of_int 26 : mword 5) ltac:(compute_done)).
        rewrite /Mj lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hs10. }
      assert (HMacq27 : Macq !!! Regidx (mword_of_int 27 : mword 5) = vs11).
      { rewrite Hf27. rewrite /M42 lookup_total_insert_ne; [| vm_compute; discriminate].
        rewrite /M40 lookup_total_insert_ne; [| vm_compute; discriminate].
      ...
      iAssert (∀ (Mr : gmap regidx (mword 64)),
                 ...
                 tlb_inv_pt root_ppn -∗ pc_is (mword_of_int (KernelSyms.wakeup + 0x2a)) -∗
                 gpr_file Mr -∗ locked γk -∗ proc_lock_res γk (proc_addr k) -∗
                 WP (Loop : expr riscv_lang) {{ Phi }})%I
        with "[Hgc Hstk Hnoff2 Hint2 Hcpu2 Hlockback Hframe Htail]"
        as "Hrel".
      { iIntros (Mr) "%Hmr Hsm Htlb Hpc Hfile Htok HR".
        ...
        iApply (wp_cmv_gpr_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x2a))
                  (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
                  Mr (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
                  with "Hsm Htlb Hpc Hfile Hi2a [-]").
        iIntros "Hsm Htlb Hpc Hfile".
        ...
        (* 0x2c jal ra,release *)
        iApply (wp_jal_gpr_s_zca_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x2c))
 ...
 ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
        ...
        iApply (wp_release root_ppn Phi γk γc bsie (proc_addr k) (proc_lock_res γk (proc_addr k)) Mr2c
        ...
        destruct Hpinsr as (Hr'csp & Hr'4 & Hr'8 & Hr'9 & Hr'18 & Hr'19 & Hr'20 & Hr'21 & Hr'22 & Hr'23 & Hr'24 & Hr'25 & Hr'26 & Hr'27).
        ...
        - (* wk_loop_regs mr spF rtp chan k *)
          ...
          split.
          { rewrite Hr'22. rewrite /Mr2c lookup_total_insert_ne; [| vm_compute; discriminate].
            rewrite /Mr2a lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hr22. }
          split.
          { rewrite Hr'23. rewrite /Mr2c lookup_total_insert_ne; [| vm_compute; discriminate].
            rewrite /Mr2a lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hr23. }
          split.
          { rewrite Hr'24. rewrite /Mr2c lookup_total_insert_ne; [| vm_compute; discriminate].
            rewrite /Mr2a lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hr24. }
          split.
          { rewrite Hr'25. rewrite /Mr2c lookup_total_insert_ne; [| vm_compute; discriminate].
            rewrite /Mr2a lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hr25. }
          split.
          { rewrite Hr'26. rewrite /Mr2c lookup_total_insert_ne; [| vm_compute; discriminate].
            rewrite /Mr2a lookup_total_insert_ne; [| vm_compute; discriminate]. exact Hr26. }
          split.
          { rewrite Hr'27. rewrite /Mr2c lookup_total_insert_ne; [| vm_compute; discriminate].
      ...
      { rewrite HMacq9. rewrite /p_state /state_off.
        ...
        reflexivity. }
      iApply (wp_clw_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x46))
                (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
                (zero_extend' 12 (concat_vec (mword_of_int 6 : mword 5) ('b"00")))
                Macq st (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
                with "Hsm Htlb Hpc Hfile Hi46 [Hpst] [-]").
      { iEval (rewrite Hea46). iExact "Hpst". }
      iIntros "Hsm Htlb Hpc Hfile Hpst".
      ...
      + (* TAKEN: state != SLEEPING -> reassemble proc_lock_res, release *)
        iApply (wp_bne_taken_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x48))
                  (mword_of_int 8162 : mword 13) (mword_of_int 19 : mword 5) (mword_of_int 15 : mword 5)
                  M48 (dq:=DfracOwn 1)

                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  Hcmp48 ltac:(vm_compute; reflexivity)
                  with "Hsm Htlb Hpc Hfile Hi48 [-]").
        iIntros "Hsm Htlb Hpc Hfile".
        ...
        iApply ("Hrel" $! M48 with "[%] Hsm Htlb Hpc Hfile Htok HR").
      ...
      + (* FALL: state == SLEEPING -> load chan ---- *)
        iApply (wp_bne_fall_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x48))
                  (mword_of_int 8162 : mword 13) (mword_of_int 19 : mword 5) (mword_of_int 15 : mword 5)
                  M48 (dq:=DfracOwn 1)
        ...
        { rewrite HM48_9. rewrite /p_chan /chan_off.
          replace (sign_extend' 64 (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 5) ('b"000")))) with (mword_of_int 32 : mword 64)
            by (apply bv_eq; vm_compute; reflexivity).
          reflexivity. }
        iApply (wp_cld_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x4c))
                  (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5) (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 5) ('b"000")))
                  M48 ch (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
                  with "Hsm Htlb Hpc Hfile Hi4c [Hpch] [-]").
        { iEval (rewrite Hea4c). iExact "Hpch". }
        iIntros "Hsm Htlb Hpc Hfile Hpch".
        ...
        * (* TAKEN: chan mismatch -> release *)
          iApply (wp_bne_taken_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x4e))
                    (mword_of_int 8156 : mword 13) (mword_of_int 20 : mword 5) (mword_of_int 15 : mword 5)
                    M4e (dq:=DfracOwn 1)

                    ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                    Hcmp4e ltac:(vm_compute; reflexivity)
                    with "Hsm Htlb Hpc Hfile Hi4e [-]").
          iIntros "Hsm Htlb Hpc Hfile".
          ...
          iDestruct (proc_lock_res_intro γk (proc_addr k) st ch with "Hpst Hpch Hctx") as "HR".
          iApply ("Hrel" $! M4e with "[%] Hsm Htlb Hpc Hfile Htok HR").
        ...
        * (* FALL: chan matches -> wake (state := RUNNABLE) *)
          iApply (wp_bne_fall_s_config_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x4e))
                    (mword_of_int 8156 : mword 13) (mword_of_int 20 : mword 5) (mword_of_int 15 : mword 5)
                    M4e (dq:=DfracOwn 1)
          ...
          { rewrite HM4e_9. rewrite /p_state /state_off.
            replace (sign_extend' 64 (mword_of_int 24 : mword 12)) with (mword_of_int 24 : mword 64)
              by (apply bv_eq; vm_compute; reflexivity).
            reflexivity. }
          iApply (wp_sw_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x52))
                    (mword_of_int 21 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 24 : mword 12)
                    M4e st (dq:=DfracOwn 1)

                    with "Hsm Htlb Hpc Hfile Hi52 [Hpst] [-]").
          ...
          assert (H56tgt : add_vec (mword_of_int (KernelSyms.wakeup + 0x56) : mword 64)
                          ...
                          = mword_of_int (KernelSyms.wakeup + 0x2a)) by (apply bv_eq; vm_compute; reflexivity).
          iApply (wp_cj_s_scfg_pt root_ppn γc Phi (mword_of_int (KernelSyms.wakeup + 0x56))
                    (sign_extend' 21 (concat_vec (mword_of_int 2026 : mword 11) ('b"0"))) _
                    (dq:=DfracOwn 1)
 ltac:(rewrite H56tgt; vm_compute; reflexivity)
                    with "Hsm Htlb Hpc Hfile Hi56 [-]").
          iIntros "Hsm Htlb Hpc Hfile".
  ...
  Lemma wk_regs_loop (M : gmap regidx (mword 64)) (spF sp0 rra rtp chan : mword 64)
      (vs6 vs7 vs8 vs9 vs10 vs11 : mword 64) (k : nat) :
    wk_regs M spF sp0 rra rtp chan vs6 vs7 vs8 vs9 vs10 vs11 k ->
    wk_loop_regs M spF rtp chan vs6 vs7 vs8 vs9 vs10 vs11 k.
  Proof.
    intros (Hra & Hsp & H9 & H4 & H18 & H19 & H20 & H21 & H22 & H23 & H24 & H25 & H26 & H27 & Hdom).
    unfold wk_loop_regs.
    repeat split; [exact H9 | exact Hsp | exact H4 | exact H18 | exact H19 | exact H20 | exact H21
      | exact H22 | exact H23 | exact H24 | exact H25 | exact H26 | exact H27 | exact Hdom].
  Qed.
  ...
  Lemma wp_wakeup (m : gmap regidx (mword 64)) (γs : list gname) (a0f : mword 64)
    ...
    WP (Loop : expr riscv_lang) {{ Phi }}.
  Proof.
    intros Hn Hdom Hlen spF Hmycpu Hmycpu_nz Hnf_pos Hnf_rt Halign.
    ...
    iApply (wp_wakeup_prologue m f7 f6 f5 f4 f3 f2 f1 Hdom
    ...
    iPoseProof (wp_wakeup_loop γs spF a0f (m !!! Regidx (mword_of_int 4 : mword 5))
                  ...
                  n
 Hn Hlen Hmycpu Hmycpu_nz Hnf_pos Hnf_rt
                  with "Hpinv") as "Hloop".
    iSpecialize ("Hloop" with "[Hcont]").
    { (* Qexit = epilogue at wakeup+0x58 *)
      iIntros (Mexit) "(%Hcsp & %Htp & %H22 & %H23 & %H24 & %H25 & %H26 & %H27 & %Hedom) Hsm Hgc Htlb Htextx Hpc Hfile Hframe".
 ...
 Hcsp Hedom Halign
      ...
      iIntros (Mf) "%Hepi Hsm Hgc Htlb Htextx Hpc Hfile Hframe".
      iApply ("Hcont" $! Mf with "[%] Hsm Hgc Htlb Htextx Hpc Hfile Hframe").
      destruct Hepi as (Hfra & Hfs0 & Hfs1 & Hfs2 & Hfs3 & Hfs4 & Hfs5 & Hfcsp
                        & Hftp & Hf22 & Hf23 & Hf24 & Hf25 & Hf26 & Hf27 & Hfdom).
      split; [| exact Hfdom].
      unfold callee_saved. repeat split.
      - (* x2 sp *) rewrite Hfcsp. subst spF. apply wakeup_sp_cancel.
      - (* x4 tp *) rewrite Hftp. exact Htp.
      - (* x8 s0 *) exact Hfs0.
      - (* x9 s1 *) exact Hfs1.
      - (* x18 s2 *) exact Hfs2.
      - (* x19 s3 *) exact Hfs3.
      - (* x20 s4 *) exact Hfs4.
      - (* x21 s5 *) exact Hfs5.
      - (* x22 s6 *) rewrite Hf22. exact H22.
      - (* x23 s7 *) rewrite Hf23. exact H23.
      - (* x24 s8 *) rewrite Hf24. exact H24.
      - (* x25 s9 *) rewrite Hf25. exact H25.
      - (* x26 s10 *) rewrite Hf26. exact H26.
      - (* x27 s11 *) rewrite Hf27. exact H27. }

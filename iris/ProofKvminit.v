...
Section KvminitBody.
  ...
  Proof.
    ...
    assert (Haddr : add_vec (A0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 252 : mword 12)) = mword_of_int KernelSyms.kernel_pagetable).
    ...
    iApply (wp_sd_s_sconf (kt := KT0) (ktd := KT0) (mword_of_int (KernelSyms.kvminit + 0x10)) (mword_of_int 10 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 252 : mword 12)

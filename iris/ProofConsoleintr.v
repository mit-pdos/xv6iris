...
Section ProofConsoleintr.
  ...
  Lemma ct_mk_wake (γc : gname) (γs : list gname) (pme : mword 64) (m0 : regfile)
    ...
    ct_wake_prop (CID0 := CID) γc pme m0 K lvl eb C b sp0.
  Proof.
  ...
  Lemma ct_mk_kill (γtx γc : gname) (γu : uart_names) (γv : disk_names)
    ...
    ct_kill_prop (CID0 := CID) γc pme m0 K lvl eb C b sp0.
  Proof.
  ...
  Proof.
    ...
    iApply (Consputc.wp_consputc_sconf γtx γu γv D2
              (trap_res b + (K - 6))%nat [] (S lvl) eb C false pme
              ltac:(unfold consoleintr_stack, consputc_stack in *; lia) ltac:(lia)
              with "Hcg Hcnt Ht Hpc Hpanic Hdev Htxl Hsub").
    iApply wp_next_off_intro. iIntros (mcp cs) "Hcg Hcnt Hpc [%Hcpcs %Hcpra] _". rgall.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0x138)) Ra5 Ra5 (mword_of_int 3776 : mword 12)
              D3 (trap_res b + (K - 6))%nat false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi138").
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (D4 := <[Regidx Ra5 := regval_into_reg
        (add_vec (D3 !!! Regidx Ra5) (sign_extend' 64 (mword_of_int 3776 : mword 12)))]> D3).
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0xf4)) Ra4 Ra4 (mword_of_int 3844 : mword 12)
              B1 (trap_res b + (K - 6))%nat false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi0f4").
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (B2 := <[Regidx Ra4 := regval_into_reg
        (add_vec (B1 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 3844 : mword 12)))]> B1).
    ...
    assert (HB6ea : add_vec (B6 !!! Regidx Ra4)
                      (sign_extend' 64 (mword_of_int 3960 : mword 12)) = a_cons_e).
    ...
    iApply (wp_sw_s_sconf (mword_of_int (CT + 0x120)) Ra5 Ra4 (mword_of_int 3960 : mword 12)
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0x9a)) Ra4 Ra4 (mword_of_int 3934 : mword 12)
              E1 (trap_res b + (K - 6))%nat false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi09a").
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (E2 := <[Regidx Ra4 := regval_into_reg
        (add_vec (E1 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 3934 : mword 12)))]> E1).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0xaa)) Rs1 Rs1 (mword_of_int 3918 : mword 12)
              E5 (trap_res b + (K - 6))%nat false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi0aa").
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (E6 := <[Regidx Rs1 := regval_into_reg
        (add_vec (E5 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 3918 : mword 12)))]> E5).
    ...
    { (* nothing to erase: restore s2/s3 at +0x0e4 and leave *)
      ...
      iApply (ct_restore23 (CIDq := CIDq) γc pme m0 E8 K lvl eb C _ sp0
                ...
                (mword_of_int (CT + 0xe8)) (mword_of_int 14 : mword 11)
                HE8sp HE8top
                ltac:(pcw) ltac:(pcw) ltac:(pcw) ltac:(vm_compute; reflexivity)
                Hchain
  ...
  Lemma ct_store `{CIDq : CpuId}
      (γtx γc : gname) (γu : uart_names) (γv : disk_names)
      (pme : mword 64) (m0 M : regfile) (K lvl : nat) (eb : bool)
      (C : iProp Σ) (b : bool) (sp0 : mword 64) (cv : mword 64) :
    M !!! Regidx csp_rs1 = pa_stk sp0 6%nat ->
    M !!! Regidx Rs1 = cv ->
    ct_cs_hi M m0 ->
    (consoleintr_stack <= K)%nat ->
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros Hsp Hs1 Hcs HK Hlvl Hchain.
    iIntros "#Ht #Hpanic #Hdev #Htxl #Hsub Hcg Hpc Hcnt Hpay Hlocked Hres Hrest WAKE EXIT".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0x58)) Ra4 Ra4 (mword_of_int 4000 : mword 12)
              F3 (trap_res b + (K - 6))%nat false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi058").
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (F4 := <[Regidx Ra4 := regval_into_reg
        (add_vec (F3 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 4000 : mword 12)))]> F3).
    ...
    assert (Hra : add_vec (F12 !!! Regidx Ra4)
                    (sign_extend' 64 (mword_of_int 14 : mword 12)) = a_cons_r).
    { rewrite /F12 upd_eq /a_cons_r /coff_of /a_cons. apply bv_eq; vm_compute; reflexivity. }
    iApply (wp_lw_s_sconf (mword_of_int (CT + 0x82)) Ra4 Ra4 (mword_of_int 14 : mword 12)
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0x32)) Ra4 Ra4 (mword_of_int 4038 : mword 12)
              G1 (trap_res b + (K - 6))%nat false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi032").
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (G2 := <[Regidx Ra4 := regval_into_reg
        (add_vec (G1 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 4038 : mword 12)))]> G1).
    ...
    { iApply (wp_beq_taken_s_sconf (mword_of_int (CT + 0x4a)) (mword_of_int 228 : mword 13)
      ...
      iApply (ct_cr (CIDq := CIDq) γtx γc γu γv pme m0 G7 K lvl eb C b sp0
                HG7sp (ct_cs_hi_thr G7 M m0 HthrG7 Hcs) HK Hlvl Hchain
    ...
    iApply (ct_store (CIDq := CIDq) γtx γc γu γv pme m0 G7 K lvl eb C b sp0 cv
              HG7sp HG7s1 (ct_cs_hi_thr G7 M m0 HthrG7 Hcs) HK Hlvl Hchain
              with "Ht Hpanic Hdev Htxl Hsub Hcg Hpc Hcnt Hpay Hlocked Hres Hrest
                    WAKE EXIT").
  Qed.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CT + 0x10)) Ra0 Ra0 (mword_of_int 4072 : mword 12)
              P3 (K - 6)%nat b ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi010").
    iIntros (CIDp8 Hsp8) "Hcg Hpc". rgall.
    set (P4 := <[Regidx Ra0 := regval_into_reg
        (add_vec (P3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 4072 : mword 12)))]> P3).
    ...
    iAssert (ct_ret (CID0 := CID) pme m K lvl eb C b) with "[Hcont]" as "Hcont".
    { rewrite /ct_ret. iExact "Hcont". }
    iAssert (ct_exit_prop (CID0 := CID) γc pme m K lvl eb C b sp0)
      with "[Hsaved Hcont]" as "EXIT".
    { iApply (ct_mk_exit γc pme m K lvl eb C b sp0 Hspm HK Hbm with "Ht Hlk Hsaved Hcont"). }
    iAssert (ct_wake_prop (CID0 := CID) γc pme m K lvl eb C b sp0) as "WAKE".
    { iApply (ct_mk_wake γc γs pme m K lvl eb C b sp0 HK Hlen Hlvl Hbm
                with "Ht Hpanic Hpinv"). }
    iAssert (ct_kill_prop (CID0 := CID) γc pme m K lvl eb C b sp0) as "KILL".
    { iApply (ct_mk_kill γtx γc γu γv pme m K lvl eb C b sp0 HK Hlvl Hbm
    ...
    iApply (Acquire.wp_acquire_sconf γc "cons"%string cons_res P5 lvl eb pme C
              (K - 6)%nat b ltac:(lia) ltac:(unfold consoleintr_stack in HK; lia)
    ...
    { iApply (wp_beq_taken_s_sconf (mword_of_int (CT + 0x1a)) (mword_of_int 120 : mword 13)
      ...
      iApply (ct_kill_pre (CIDq := CIDaq) γc pme m S1 K lvl eb C b sp0
                HS1sp HS1cs Hchain
    ...
    { iApply (wp_beq_taken_s_sconf (mword_of_int (CT + 0x22)) (mword_of_int 206 : mword 13)
      ...
      iApply (ct_bs (CIDq := CIDaq) γtx γc γu γv pme m S2 K lvl eb C b sp0
                HS2sp HS2cs HK Hlvl Hchain
    ...
    { iApply (wp_beq_taken_s_sconf (mword_of_int (CT + 0x28)) (mword_of_int 200 : mword 13)
      ...
      assert (Hj0f0 : add_vec (mword_of_int (CT + 0x28) : mword 64)
                      ...
                      = mword_of_int (CT + 0xf0)) by pcw.
      iEval (rewrite Hj0f0) in "Hpc".
      iApply (ct_bs (CIDq := CIDaq) γtx γc γu γv pme m S3 K lvl eb C b sp0
    ...
    iApply (ct_dflt (CIDq := CIDaq) γtx γc γu γv pme m S3 K lvl eb C b sp0 cv
              HS3sp HS3s1 HS3cs HK Hlvl Hchain
              with "Ht Hpanic Hdev Htxl Hsub Hcg Hpc Hcnt Hpay Hlocked Hres Hrest
                    WAKE EXIT").
  Qed.

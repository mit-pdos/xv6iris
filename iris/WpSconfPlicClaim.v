(* WpSconfPlicClaim.v: whole-function WP for xv6's plic_claim() in S-mode, over
...
Require Import DevModel PlicPlan PlicHart WpUart WpPlic WpPlicExec SpecCpuid SpecPlicClaim.
...
Section WpSconfPlicClaim.
  ...
  Proof. mk_rvc (PQ + 0x00)%Z (mword_of_int 0x1141 : mword 16)
    (mword_of_int (PQ + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) mdec_ccc exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (PQ + 0x02)%Z (mword_of_int 0xe406 : mword 16)
    (mword_of_int (PQ + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) mdec_cce exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (PQ + 0x04)%Z (mword_of_int 0xe022 : mword 16)
    (mword_of_int (PQ + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) mdec_cd0 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (PQ + 0x06)%Z (mword_of_int 0x0800 : mword 16)
    (mword_of_int (PQ + 0x06) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) mdec_cd2 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (PQ + 0x14)%Z (mword_of_int 0x97aa : mword 16)
    (mword_of_int (PQ + 0x14) : mword 64) (RTYPE (Regidx (mword_of_int 10), Regidx (mword_of_int 15), Regidx (mword_of_int 15), ADD)) mdec_97aa exec_execute_C_ADD. Qed.
  ...
  Proof. mk_rvc (PQ + 0x18)%Z (mword_of_int 0x60a2 : mword 16)
    (mword_of_int (PQ + 0x18) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) mdec_cea exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (PQ + 0x1a)%Z (mword_of_int 0x6402 : mword 16)
    (mword_of_int (PQ + 0x1a) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) mdec_cec exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (PQ + 0x1c)%Z (mword_of_int 0x0141 : mword 16)
    (mword_of_int (PQ + 0x1c) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) mdec_cee exec_execute_C_ADDI. Qed.
  ...
  (* =================================================================== *)
  Lemma wp_plic_claim_sconf (γ : gname) (root_ppn : mword 44) (γd : uart_names)
      (Φ : mval -> iProp Σ) (m0 : regfile) (n : nat)
    : wp_plic_claim_sconf_body γ root_ppn γd Φ m0 n.
  Proof.
    ...
    (* ---- 0x02: c.sdsp ra,8(sp) ---- *)
    iApply (wp_csdsp_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x02)) (mword_of_int 1 : mword 6) ra_idx R1 (n - 2)%nat vr24
    ...
    (* ---- 0x04: c.sdsp s0,0(sp) ---- *)
    iApply (wp_csdsp_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x04)) (mword_of_int 0 : mword 6) s0_idx R1 (n - 2)%nat vs16
    ...
    iApply (wp_caddi4spn_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x06)) (Cregidx (mword_of_int 0)) nzimm_s0 s0_idx R1 (n - 2)%nat
    ...
    (* ---- 0x08: jal ra,cpuid ---- *)
    iApply (Cpuid.wp_call_cpuid_sconf_cs γ root_ppn Φ (mword_of_int (PQ + 0x08))
    ...
    (* ---- 0x0c: slliw a0,a0,13 ---- *)
    iApply (wp_slliw_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x0c)) a0_idx a0_idx
    ...
    (* ---- 0x10: lui a5,0xc201 ---- *)
    iApply (wp_lui_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x10)) a5_idx
    ...
    (* ---- 0x14: c.add a5,a5,a0 ---- *)
    iApply (wp_cadd_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x14)) a5_idx a0_idx N3 (n - 2)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_lw_plic_dev_s_sconf γ root_ppn γd Φ (mword_of_int (PQ + 0x16)) true false
              ...
              ltac:(rewrite HN4a5; intros pq Hpq;
                    ...
                    | pose proof (plic_claim_ret pq (Z.to_nat (bv_unsigned (m0 !!! Regidx tp_idx))) Hpq) as Hk;
                      rewrite Hc in Hk; exact Hk ])
              with "Hsc Hhs Hcg Htlbinv Hpc Hi16 Hdinv [-]").
    iIntros (cv) "%Hcv Hhs Hsc Hcg Htlbinv Hpc".
    ...
    (* ---- 0x18: c.ldsp ra,8(sp) ---- *)
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x18)) (mword_of_int 1 : mword 6) ra_idx N5 (n - 2)%nat ra0
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi18 Hbra [-]").
    iIntros "Hhs Hsc Hcg Htlbinv Hpc Hbra".
    ...
    (* ---- 0x1a: c.ldsp s0,0(sp) ---- *)
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x1a)) (mword_of_int 0 : mword 6) s0_idx N6 (n - 2)%nat s00
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi1a Hbs0 [-]").
    iIntros "Hhs Hsc Hcg Htlbinv Hpc Hbs0".
    ...
    iApply (wp_caddi_sp_pop_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x1c)) imm_dealloc N7
              (n - 2)%nat 2 Hpop
    ...
    iApply (wp_cret_s_sconf γ root_ppn Φ (mword_of_int (PQ + 0x1e)) ra_idx N8 n

...
Section WpUserFull.
  ...
  Local Notation wp_user_split_ld_frame := (WpUserMemStep.wp_user_split_ld_frame U).
  Local Notation wp_user_split_lw_frame := (WpUserMemStep.wp_user_split_lw_frame U).
  Local Notation wp_user_split_lh_frame := (WpUserMemStep.wp_user_split_lh_frame U).
  Local Notation wp_user_split_lb_frame := (WpUserMemStep.wp_user_split_lb_frame U).
  Local Notation wp_user_split_sd_frame := (WpUserMemStep.wp_user_split_sd_frame U).
  Local Notation wp_user_split_sw_frame := (WpUserMemStep.wp_user_split_sw_frame U).
  Local Notation wp_user_split_sh_frame := (WpUserMemStep.wp_user_split_sh_frame U).
  Local Notation wp_user_split_sb_frame := (WpUserMemStep.wp_user_split_sb_frame U).
  Local Notation wp_user_split_amoswap_frame := (WpUserMemStep.wp_user_split_amoswap_frame U).
  ...
  Local Notation ustep_u_split_load_pf_4_u := (WpUserSplitTrap.ustep_u_split_load_pf_4_u U).
  Local Notation ustep_u_split_load_pf_8_u := (WpUserSplitTrap.ustep_u_split_load_pf_8_u U).
  Local Notation ustep_u_split_load_pf_2_u := (WpUserSplitTrap.ustep_u_split_load_pf_2_u U).
  Local Notation ustep_u_split_load_pf_1_u := (WpUserSplitTrap.ustep_u_split_load_pf_1_u U).
  Local Notation ustep_u_split_store_pf_8_u := (WpUserSplitTrap.ustep_u_split_store_pf_8_u U).
  Local Notation ustep_u_split_store_pf_4_u := (WpUserSplitTrap.ustep_u_split_store_pf_4_u U).
  Local Notation ustep_u_split_store_pf_2_u := (WpUserSplitTrap.ustep_u_split_store_pf_2_u U).
  Local Notation ustep_u_split_store_pf_1_u := (WpUserSplitTrap.ustep_u_split_store_pf_1_u U).
  Local Notation ustep_u_split_load_pf_4_noperm_u := (WpUserSplitTrap.ustep_u_split_load_pf_4_noperm_u U).
  Local Notation ustep_u_split_load_pf_8_noperm_u := (WpUserSplitTrap.ustep_u_split_load_pf_8_noperm_u U).
  Local Notation ustep_u_split_load_pf_2_noperm_u := (WpUserSplitTrap.ustep_u_split_load_pf_2_noperm_u U).
  Local Notation ustep_u_split_load_pf_1_noperm_u := (WpUserSplitTrap.ustep_u_split_load_pf_1_noperm_u U).
  Local Notation ustep_u_split_store_pf_8_noperm_u := (WpUserSplitTrap.ustep_u_split_store_pf_8_noperm_u U).
  Local Notation ustep_u_split_store_pf_4_noperm_u := (WpUserSplitTrap.ustep_u_split_store_pf_4_noperm_u U).
  Local Notation ustep_u_split_store_pf_2_noperm_u := (WpUserSplitTrap.ustep_u_split_store_pf_2_noperm_u U).
  Local Notation ustep_u_split_store_pf_1_noperm_u := (WpUserSplitTrap.ustep_u_split_store_pf_1_noperm_u U).
  Local Notation ustep_u_split_lr_fault_u := (WpUserSplitTrap.ustep_u_split_lr_fault_u U).
  Local Notation ustep_u_split_sc_fault_u := (WpUserSplitTrap.ustep_u_split_sc_fault_u U).
  ...
  Definition ustep_mem_case (va ms_v : mword 64) (g : gmap regidx (mword 64))
    ...
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       ...
       (forall j : nat, (j < 4)%nat -> pa_add paD j ∈ data))
    \/
    (* ld/lh/lb/sd/sw/sh/sb/amoswap 2-aligned split-fetch twins *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs1 rd : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       let paD := u_pa (upt_entry vpnD ieD) eaF vpnD in
       spec !! vpn = Some ie /\
  ...
  Definition ustep_fault_case (va ms_v : mword 64) (g : gmap regidx (mword 64))
    ...
    (exists vpn ie (w : mword 32) (rs2 rs1 rd : mword 5) (aq rl : bool),
       ...
       bit_to_bool (access_vec_dec medl_v (uint (exceptionType_bits_forwards (E_SAMO_Access_Fault tt)))) = true)
    \/
    (* 2-aligned split-fetch LOAD page-fault (width 4) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch LOAD page-fault (width 8) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch LOAD page-fault (width 2) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch LOAD page-fault (width 1) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch STORE page-fault (width 8) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch STORE page-fault (width 4) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch STORE page-fault (width 2) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch STORE page-fault (width 1) *)
    (exists vpn ie (w : mword 32) vpnD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch LR access-fault (non-reservable RAM) *)
    (exists vpn ie (w : mword 32) vpnD ieD (rs1 rd : mword 5) (aq rl : bool),
       let eaF := add_vec (g !!! Regidx rs1) (zeros' 64) in
       let paD := u_pa (upt_entry vpnD ieD) eaF vpnD in
    spec !! vpn = Some ie /\
    ...
    bit_to_bool (access_vec_dec medl_v (uint (exceptionType_bits_forwards (E_Load_Access_Fault tt)))) = true)
    \/
    (* 2-aligned split-fetch SC access-fault (non-reservable RAM) *)
    (exists vpn ie (w : mword 32) vpnD ieD (rs2 rs1 rd : mword 5) (aq rl : bool),
       let eaF := add_vec (g !!! Regidx rs1) (zeros' 64) in
       let paD := u_pa (upt_entry vpnD ieD) eaF vpnD in
    spec !! vpn = Some ie /\
    ...
    bit_to_bool (access_vec_dec medl_v (uint (exceptionType_bits_forwards (E_SAMO_Access_Fault tt)))) = true)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM LOAD page-fault (width 4) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM LOAD page-fault (width 8) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM LOAD page-fault (width 2) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM LOAD page-fault (width 1) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM STORE page-fault (width 8) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM STORE page-fault (width 4) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM STORE page-fault (width 2) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
       ...
       autocast (T := mword) (subrange_vec_dec
         (subrange_vec_dec (bits_of_virtaddr (Virtaddr eaF)) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD)
    \/
    (* 2-aligned split-fetch DATA-NO-PERM STORE page-fault (width 1) *)
    (exists vpn ie (w : mword 32) vpnD ieD (imm : mword 12) (rs2 rs1 : mword 5),
       let eaF := add_vec (g !!! Regidx rs1) (sign_extend' 64 imm) in
       spec !! vpn = Some ie /\
       uw_check_ok (InstructionFetch tt) ie /\
  ...
  Proof.
    ...
    - iAssert (▷ (user_frame -∗ WP (Loop : expr riscv_lang) @ E {{ Φ }}))%I
      ...
      destruct Hmem as [Hld | [Hlw | [Hlh | [Hlb | [Hsd | [Hsw | [Hsh | [Hsb | [Hamo | [Hslw | [Hsld | [Hslh | [Hslb | [Hssd | [Hssw | [Hssh | [Hssb | Hsamo]]]]]]]]]]]]]]]]].
      + (* LD width 8 *)
      ...
      + (* LW split-fetch (2-aligned, width 4) *)
        ...
        iApply (wp_user_split_lw_frame va vpn ie w vpnD ieD imm rs1 rd is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  ...
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* LD split-fetch (2-aligned, width 8) *)
        destruct Hsld as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & Hrd & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_ld_frame va vpn ie w vpnD ieD imm rs1 rd ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hrd HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* LH split-fetch (2-aligned, width 2) *)
        destruct Hslh as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & Hrd & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_lh_frame va vpn ie w vpnD ieD imm rs1 rd is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hrd HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* LB split-fetch (2-aligned, width 1) *)
        destruct Hslb as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & Hrd & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_lb_frame va vpn ie w vpnD ieD imm rs1 rd is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hrd HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* SD split-fetch (2-aligned, width 8) *)
        destruct Hssd as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hnowrap & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_sd_frame va vpn ie w vpnD ieD imm rs2 rs1 ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hnowrap Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* SW split-fetch (2-aligned, width 4) *)
        destruct Hssw as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hnowrap & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_sw_frame va vpn ie w vpnD ieD imm rs2 rs1 ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hnowrap Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* SH split-fetch (2-aligned, width 2) *)
        destruct Hssh as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hnowrap & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_sh_frame va vpn ie w vpnD ieD imm rs2 rs1 ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hnowrap Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* SB split-fetch (2-aligned, width 1) *)
        destruct Hssb as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hnowrap & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_sb_frame va vpn ie w vpnD ieD imm rs2 rs1 ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hnowrap Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
      + (* AMOSWAP.W split-fetch (2-aligned, width 4) *)
        destruct Hsamo as (vpn & ie & w & vpnD & ieD & rs2 & rs1 & rd & Hnowrap & Hsome & Hchk0 & HupdN & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & Hrd & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & Hwin).
        iApply (wp_user_split_amoswap_frame va vpn ie w vpnD ieD rs2 rs1 rd ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hnowrap Hok Hsome Hchk0 HupdN HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hrd HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD Hwin
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkP").
    - (* fault branch: the data address is UNMAPPED -> page-fault trap frame *)
      iAssert (▷ (user_trap_frame -∗ WP (Loop : expr riscv_lang) @ E {{ Φ }}))%I
        with "[Hk]" as "HkT".
      { iNext. iDestruct "Hk" as "[_ $]". }
      destruct Hfault as [Hl8 | [Hl4 | [Hl2 | [Hl1 | [Hs8 | [Hs4 | [Hs2 | [Hs1 | [Hlr | [Hsc | [Hln4 | [Hln8 | [Hln2 | [Hln1 | [Hsn8 | [Hsn4 | [Hsn2 | [Hsn1 | [Hlrm | [Hscm | [Hamom | [Hspl4 | [Hspl8 | [Hspl2 | [Hspl1 | [Hsps8 | [Hsps4 | [Hsps2 | [Hsps1 | [Hsplr | [Hspsc | [Hspln4 | [Hspln8 | [Hspln2 | [Hspln1 | [Hspsn8 | [Hspsn4 | [Hspsn2 | Hspsn1]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]].
      + (* LOAD fault (width 8) *)
      ...
      + (* AMOSWAP misaligned access-fault *)
        ...
        iApply (ustep_amoswap_fault_misalign_u va vpn ie w rs2 rs1 rd aq rl ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL HMPRV HMXR Hval Hcanon Hvpn_def Hpaal HnotRVC Hdec HmisD Hdel_samoaf
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD split-fetch page-fault (2-aligned, width 4) *)
        destruct Hspl4 as (vpn & ie & w & vpnD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_4_u va vpn ie w vpnD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD split-fetch page-fault (2-aligned, width 8) *)
        destruct Hspl8 as (vpn & ie & w & vpnD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_8_u va vpn ie w vpnD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD split-fetch page-fault (2-aligned, width 2) *)
        destruct Hspl2 as (vpn & ie & w & vpnD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_2_u va vpn ie w vpnD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD split-fetch page-fault (2-aligned, width 1) *)
        destruct Hspl1 as (vpn & ie & w & vpnD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_1_u va vpn ie w vpnD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE split-fetch page-fault (2-aligned, width 8) *)
        destruct Hsps8 as (vpn & ie & w & vpnD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_8_u va vpn ie w vpnD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE split-fetch page-fault (2-aligned, width 4) *)
        destruct Hsps4 as (vpn & ie & w & vpnD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_4_u va vpn ie w vpnD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE split-fetch page-fault (2-aligned, width 2) *)
        destruct Hsps2 as (vpn & ie & w & vpnD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_2_u va vpn ie w vpnD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE split-fetch page-fault (2-aligned, width 1) *)
        destruct Hsps1 as (vpn & ie & w & vpnD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD_none & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_1_u va vpn ie w vpnD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD_none Hfwf HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LR access fault, 2-aligned split-fetch (non-reservable RAM) *)
        destruct Hsplr as (vpn & ie & w & vpnD & ieD & rs1 & rd & aq & rl & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & HramD & HramD3 & Hresv & Hdel_loadaf).
        iApply (ustep_u_split_lr_fault_u va vpn ie w vpnD ieD rs1 rd aq rl ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD HramD HramD3 Hresv Hdel_loadaf
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* SC access fault, 2-aligned split-fetch (non-reservable RAM) *)
        destruct Hspsc as (vpn & ie & w & vpnD & ieD & rs2 & rs1 & rd & aq & rl & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & HchkD & HupdD & HpbmtD & HalignD & HcanonD & Hvpn_defD & HpaalD & HramD & HramD3 & Hresv & Hmatchrsv & Hdel_samoaf).
        iApply (ustep_u_split_sc_fault_u va vpn ie w vpnD ieD rs2 rs1 rd aq rl ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD HramD HramD3 Hresv Hmatchrsv Hdel_samoaf
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD data-no-perm split-fetch page-fault (2-aligned, width 4) *)
        destruct Hspln4 as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_4_noperm_u va vpn ie w vpnD ieD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD data-no-perm split-fetch page-fault (2-aligned, width 8) *)
        destruct Hspln8 as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_8_noperm_u va vpn ie w vpnD ieD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD data-no-perm split-fetch page-fault (2-aligned, width 2) *)
        destruct Hspln2 as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_2_noperm_u va vpn ie w vpnD ieD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* LOAD data-no-perm split-fetch page-fault (2-aligned, width 1) *)
        destruct Hspln1 as (vpn & ie & w & vpnD & ieD & imm & rs1 & rd & is_unsigned & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_load_pf_1_noperm_u va vpn ie w vpnD ieD rs1 rd imm is_unsigned ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE data-no-perm split-fetch page-fault (2-aligned, width 8) *)
        destruct Hspsn8 as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_8_noperm_u va vpn ie w vpnD ieD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE data-no-perm split-fetch page-fault (2-aligned, width 4) *)
        destruct Hspsn4 as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_4_noperm_u va vpn ie w vpnD ieD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE data-no-perm split-fetch page-fault (2-aligned, width 2) *)
        destruct Hspsn2 as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_2_noperm_u va vpn ie w vpnD ieD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
      + (* STORE data-no-perm split-fetch page-fault (2-aligned, width 1) *)
        destruct Hspsn1 as (vpn & ie & w & vpnD & ieD & imm & rs2 & rs1 & Hsome & Hchk0 & HupdN & Hpbmt0 & HcwL & HcwH & HMPRV & HMXR & Hbit0 & Hbit1 & Hvalign4 & HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC & Hdec & HsomeD & Hden & HalignD & HcanonD & Hvpn_defD).
        iApply (ustep_u_split_store_pf_1_noperm_u va vpn ie w vpnD ieD rs2 rs1 imm ms_v sc_v stval_v sepc_v g tlbvec E Φ
                  HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec HsomeD Hden HalignD HcanonD Hvpn_defD
                  with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt Hcode Hdata Hcfg HkT").
  Qed.

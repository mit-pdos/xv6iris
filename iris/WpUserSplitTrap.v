...
Require Import UptInv UmodeData UmodeDataFault.
...
Section WpUserSplitTrap.
  ...
  (* ================================================================== *)
  (* 2-aligned LOAD/STORE data page-fault arms, riding                   *)
  (* [wp_exec_trapish_u_split].  The callback K body is byte-identical    *)
  (* to the 4-aligned twins in WpUserTrapish.v; only the outer split-     *)
  (* fetch front (two 16-bit halves) differs.                             *)
  (* ================================================================== *)
  Lemma ustep_u_split_load_pf_4_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
    ...
    WP (Loop : expr riscv_lang) @ E {{ Φ }}.
  Proof.
    intros eaF HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR
           Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH
           HnotRVC Hdec
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 4)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 4))
    ...
    assert (Heaeq : add_vec_int (bits_of_virtaddr (Virtaddr eaF)) (0 * 4) = eaF)
      by (cbn [bits_of_virtaddr]; change (0 * 4) with 0; apply avi0).
    pose proof (upt_tlb_ok_fill spec tlbvec vpn ie Hsome Hok) as HokF.
    iAssert (⌜exec (translateAddr (Virtaddr eaF) (Load Data)) s_x
               = Some (Err (E_Load_Page_Fault tt, tt), s_x)⌝)%I as %Htr_data.
    { iApply (upt_translateAddr_load_unmapped root slots spec vpnD eaF satp0 tlbvec_f s_x
                HsomeD_none Hfwf HokF Hprx HSXLX HMPRVX Hsatpx Htlx Hsatpmode Hasid Hroot
                HcanonD Hvpn_defD
    ...
    assert (Hexec : exec (execute (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 4))) s_x = Some (resf, s_x)).
    ...
    iModIntro.
    iExists (E_Load_Page_Fault tt), eaF, s_x, tlbvec_f.
    iSplitR; [iPureIntro; exact Hexec |].
    iSplitR; [iPureIntro; exact Hdel_loadpf |].
    iSplitR; [iPureIntro; exact Hpcx |].
    iSplitR; [iPureIntro; exact Htlx |].
  ...
  Lemma ustep_u_split_load_pf_4_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
  ...
  Proof.
    intros eaF HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR
           Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH
           HnotRVC Hdec
           HsomeD Hden HalignD HcanonD Hvpn_defD.
    iIntros "#Hhw #Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
             #Hcode Hdata Hcfg Hcont".
    iPoseProof "Hhw" as "#Hhwc".
    iDestruct "Hhwc" as (misa0 mseccfg0 pmar0 elp0)
    ...
    iAssert (⌜exec (translateAddr (Virtaddr eaF) (Load Data)) s_x
               = Some (Err (E_Load_Page_Fault tt, tt), s_x)⌝)%I as %Htr_data.
    { iApply (upt_translateAddr_load_noperm root slots spec vpnD ieD eaF satp0 tlbvec_f s_x
                HsomeD Hden HokF Hprx HSXLX HMPRVX Hsatpx Htlx Hsatpmode Hasid Hroot
                HcanonD Hvpn_defD
                ltac:(rewrite Hpmpcx; exact HpmpA)
                ltac:(rewrite Hpmpax; exact Hpmp_ord)
                ltac:(rewrite Hpmpcx; exact HpmpR)
  ...
  Lemma ustep_u_split_load_pf_8_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 8)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 8))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { rewrite Hea_x.
      exact (exec_transform_effective_address_load_u eaF s_x
               Hprx HMPRVX HMXRX HSXLX HESX LsenvX LmenvX HmodeX). }
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_Load_Page_Fault tt) eaF, va)).
    assert (Hexec : exec (execute (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 8))) s_x = Some (resf, s_x)).
  ...
  Lemma ustep_u_split_load_pf_8_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_u_split_load_pf_2_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 2)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 2))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { rewrite Hea_x.
      exact (exec_transform_effective_address_load_u eaF s_x
               Hprx HMPRVX HMXRX HSXLX HESX LsenvX LmenvX HmodeX). }
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_Load_Page_Fault tt) eaF, va)).
    assert (Hexec : exec (execute (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 2))) s_x = Some (resf, s_x)).
  ...
  Lemma ustep_u_split_load_pf_2_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_u_split_load_pf_1_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 1)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 1))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { rewrite Hea_x.
      exact (exec_transform_effective_address_load_u eaF s_x
               Hprx HMPRVX HMXRX HSXLX HESX LsenvX LmenvX HmodeX). }
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_Load_Page_Fault tt) eaF, va)).
    assert (Hexec : exec (execute (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 1))) s_x = Some (resf, s_x)).
  ...
  Lemma ustep_u_split_load_pf_1_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_u_split_store_pf_8_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 8)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 8))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { iApply (upt_translateAddr_store_unmapped root slots spec vpnD eaF satp0 tlbvec_f s_x
                HsomeD_none Hfwf HokF Hprx HSXLX HMPRVX Hsatpx Htlx Hsatpmode Hasid Hroot
                HcanonD Hvpn_defD
                ltac:(rewrite Hpmpcx; exact HpmpA)
                ltac:(rewrite Hpmpax; exact Hpmp_ord)
    ...
    assert (Hexec : exec (execute (STORE (imm, Regidx rs2, Regidx rs1, 8))) s_x = Some (resf, s_x)).
    { pose proof (exec_execute_STORE_fault_8 eaF s_x rs2 rs1 imm HalignD Htr_x Htea_x) as HE0.
      unfold resf. rewrite Hprx Hpcx in HE0. exact HE0. }
    iModIntro.
    iExists (E_SAMO_Page_Fault tt), eaF, s_x, tlbvec_f.
    iSplitR; [iPureIntro; exact Hexec |].
    iSplitR; [iPureIntro; exact Hdel_samopf |].
    iSplitR; [iPureIntro; exact Hpcx |].
    iSplitR; [iPureIntro; exact Htlx |].
    iSplitR; [iPureIntro; exact HokF |].
    iSplitL "Hreg Hmem Hdev".
  ...
  Lemma ustep_u_split_store_pf_8_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    iAssert (⌜exec (translateAddr (Virtaddr eaF) (Store Data)) s_x
               = Some (Err (E_SAMO_Page_Fault tt, tt), s_x)⌝)%I as %Htr_data.
    { iApply (upt_translateAddr_store_noperm root slots spec vpnD ieD eaF satp0 tlbvec_f s_x
                HsomeD Hden HokF Hprx HSXLX HMPRVX Hsatpx Htlx Hsatpmode Hasid Hroot
                HcanonD Hvpn_defD
                ltac:(rewrite Hpmpcx; exact HpmpA)
                ltac:(rewrite Hpmpax; exact Hpmp_ord)
  ...
  Lemma ustep_u_split_store_pf_4_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 4)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 4))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { rewrite Hea_x.
      exact (exec_transform_effective_address_store_u eaF s_x
               Hprx HMPRVX HMXRX HSXLX HESX LsenvX LmenvX HmodeX). }
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_SAMO_Page_Fault tt) eaF, va)).
    assert (Hexec : exec (execute (STORE (imm, Regidx rs2, Regidx rs1, 4))) s_x = Some (resf, s_x)).
  ...
  Lemma ustep_u_split_store_pf_4_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_u_split_store_pf_2_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 2)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 2))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { rewrite Hea_x.
      exact (exec_transform_effective_address_store_u eaF s_x
               Hprx HMPRVX HMXRX HSXLX HESX LsenvX LmenvX HmodeX). }
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_SAMO_Page_Fault tt) eaF, va)).
    assert (Hexec : exec (execute (STORE (imm, Regidx rs2, Regidx rs1, 2))) s_x = Some (resf, s_x)).
  ...
  Lemma ustep_u_split_store_pf_2_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_u_split_store_pf_1_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 1)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 1))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
    ...
    { rewrite Hea_x.
      exact (exec_transform_effective_address_store_u eaF s_x
               Hprx HMPRVX HMXRX HSXLX HESX LsenvX LmenvX HmodeX). }
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_SAMO_Page_Fault tt) eaF, va)).
    assert (Hexec : exec (execute (STORE (imm, Regidx rs2, Regidx rs1, 1))) s_x = Some (resf, s_x)).
  ...
  Lemma ustep_u_split_store_pf_1_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  (* ================================================================== *)
  (* 2-aligned LR/SC ACCESS-FAULT arms riding [wp_exec_trapish_u_split]. *)
  (* The callback K body is byte-identical to the 4-aligned twins in     *)
  (* WpUserTrapish.v (ustep_{lr,sc}_fault_u); only the outer split-fetch  *)
  (* front (two 16-bit halves) differs.                                  *)
  (* ================================================================== *)
  Lemma ustep_u_split_lr_fault_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
    ...
    WP (Loop : expr riscv_lang) @ E {{ Φ }}.
  Proof.
    intros eaF paD HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR
           Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec
    ...
    assert (Hnlpad : is_lpad_instruction (LOADRES (aq, rl, Regidx rs1, 4, Regidx rd)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (LOADRES (aq, rl, Regidx rs1, 4, Regidx rd))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Lemma ustep_u_split_sc_fault_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
  ...
  Proof.
    intros eaF paD HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL HMPRV HMXR
           Hbit0 Hbit1 Hvalign4 HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec
           HsomeD HchkD HupdD HpbmtD HalignD HcanonD Hvpn_defD HpaalD
           HramD HramD3 Hresv Hmatchrsv Hdel_samoaf.
    iIntros "#Hhw #Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
             #Hcode Hdata Hcfg Hcont".
    iPoseProof "Hhw" as "#Hhwc".
    iDestruct "Hhwc" as (misa0 mseccfg0 pmar0 elp0)
    ...
    assert (Hnlpad : is_lpad_instruction (STORECON (aq, rl, Regidx rs2, Regidx rs1, 4, Regidx rd)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u_split va vpn ie w (STORECON (aq, rl, Regidx rs2, Regidx rs1, 4, Regidx rd))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
      ...
      + (* ===== data HIT: stored entry forced = upt_entry vpnD ieD ===== *)
        ...
        assert (HchkD' : forall (mxr do_sum : bool) s0,
          exec (check_PTE_permission (StoreConditional Data) User mxr do_sum
                  ...
                  (ext_bits_of_PTE (tlb_get_pte 8 (upt_entry vpnD ieD))) tt) s0
            = Some (PTE_Check_Success tt, s0)) by (rewrite upt_entry_pte; exact HchkD).
        assert (HupdD' : update_PTE_Bits (tlb_get_pte 8 (upt_entry vpnD ieD)) (StoreConditional Data)
                          = (None : option (mword 64))) by (rewrite upt_entry_pte; exact HupdD).
        assert (HpbmtD' : forall s0, exec (tlb_get_pbmt (upt_entry vpnD ieD)) s0
                                      = Some (PBMT_PMA, s0))
          by (intros s0; exact (upt_entry_pbmt vpnD ieD s0 HpbmtD)).
        assert (Htr_x : exec (translateAddr (Virtaddr (add_vec_int (bits_of_virtaddr (Virtaddr eaF)) (0 * 4))) (StoreConditional Data)) s_x
                        = Some (Ok (Physaddr paD, PBMT_PMA, init_ext_ptw), s_x)).
        { rewrite Heaeq.
          exact (exec_translateAddr_storecon_hit_u (upt_entry vpnD ieD) vpnD eaF satp0 tlbvec_f s_x
                   HchkD' HupdD' HpbmtD' (upt_entry_match vpnD ieD)
                   Hprx HSXLX HMPRVX Hsatpx Hsatpmode Hasid Htlx HvaccD HcanonD Hvpn_defD). }
        assert (Htea_x : exec (transform_effective_address
                  (Virtaddr (add_vec (if Z.eqb (uint rs1) 0 then zero_reg
        ...
        { rewrite Hpmpax.
          exact (ram_fetch_pmp paD (vec_access_dec pmpaddr00 0) 4 3
                   ltac:(lia) ltac:(lia) ltac:(vm_compute; reflexivity) ltac:(reflexivity)
                   HramD HramD3 Hpmp_cov). }
        assert (Hpmp_x : exec (pmpCheck (Physaddr paD) 4 (StoreConditional Data) User) s_x = Some (None, s_x)).
        { exact (exec_pmpCheck_user_grant_storecon paD 4 s_x
                   ltac:(rewrite Hpmpcx; exact HpmpA)
                   ltac:(rewrite Hpmpax; exact Hpmp_ord)
                   HrangeDX
                   ltac:(rewrite Hpmpcx; exact HpmpW)). }
        destruct (Hpma_all paD 4) as (regionD & HpmamD & _ & _ & _ & _).
        assert (HpmamDX : matching_pma_region (register_lookup pma_regions s_x.(sregs)) (Physaddr paD) 4 = Some regionD)
          by (rewrite Lpmax; exact HpmamD).
        assert (HresvX : (override_PMA (PMA_Region_attributes regionD) PBMT_PMA).(PMA_reservability) = RsrvNone)
          by (exact (Hresv regionD s_x HpmamDX)).
        pose proof (exec_rX_bits_gpr rs2 s_x) as Hrs2.
        ...
        { pose proof (exec_execute_STORECON_fault User rs1 rs2 rd eaF regionD s_x paD aq rl _
                        Htea_x HalignD Hprx HMPRVX Htr_x Hpmp_x HpmamDX HpaalD HresvX Hmatchrsv Hrs2) as HE0.
          unfold resf. rewrite Hprx Hpcx in HE0. exact HE0. }
        iModIntro.
    ...
    assert (Htr_x : exec (translateAddr (Virtaddr (add_vec_int (bits_of_virtaddr (Virtaddr eaF)) (0 * 4))) (StoreConditional Data)) s_x
                    = Some (Ok (Physaddr paD, PBMT_PMA, init_ext_ptw), s')).
    { rewrite Heaeq. rewrite <- Hpaw.
      exact (exec_translateAddr_storecon_walk_u_nomatch entD vpnD root (uw_pte2 ieD) (uw_pte1 ieD) (uw_pte0 ieD)
               eaF satp0 MENVCFG_S (register_lookup tlb s_x.(sregs)) s_x
               H2i H2nl H1i H1nl H0i H0nl HchkD H0N LmisaX Hprx HSXLX HMPRVX Hsatpx Hsatpmode Hasid Hroot
               eq_refl ltac:(rewrite Htlx; exact HvaccD) HmatchD HupdD Hrd2 Hrd1 Hrd0 LmenvX
               ltac:(vm_compute; reflexivity) HcanonD Hvpn_defD). }
    ...
    { rewrite LpmpaX'.
      exact (ram_fetch_pmp paD (vec_access_dec pmpaddr00 0) 4 3
               ltac:(lia) ltac:(lia) ltac:(vm_compute; reflexivity) ltac:(reflexivity)
               HramD HramD3 Hpmp_cov). }
    assert (Hpmp_x : exec (pmpCheck (Physaddr paD) 4 (StoreConditional Data) User) s' = Some (None, s')).
    { exact (exec_pmpCheck_user_grant_storecon paD 4 s'
               ltac:(rewrite LpmpcX'; exact HpmpA)
               ltac:(rewrite LpmpaX'; exact Hpmp_ord)
               HrangeDX
               ltac:(rewrite LpmpcX'; exact HpmpW)). }
    destruct (Hpma_all paD 4) as (regionD & HpmamD & _ & _ & _ & _).
    assert (HpmamDX : matching_pma_region (register_lookup pma_regions s'.(sregs)) (Physaddr paD) 4 = Some regionD)
      by (rewrite LpmaX'; exact HpmamD).
    assert (HresvX : (override_PMA (PMA_Region_attributes regionD) PBMT_PMA).(PMA_reservability) = RsrvNone)
    ...
    pose proof (exec_rX_bits_gpr rs2 s_x) as Hrs2.
    set (resf := rv64d_types.Trap (User, make_sync_exception (E_SAMO_Access_Fault tt) eaF, va)).
    assert (Hexec_sc : exec (execute (STORECON (aq, rl, Regidx rs2, Regidx rs1, 4, Regidx rd))) s_x = Some (resf, s')).
    { pose proof (exec_execute_STORECON_fault_walk User rs1 rs2 rd eaF regionD s_x s' paD aq rl _
                    Htea_x HalignD LprivX' HMPRVX' Htr_x Hpmp_x HpmamDX HpaalD HresvX Hmatchrsv Hrs2) as HE0.
      unfold resf. rewrite LprivX' LpcXx' in HE0. exact HE0. }
    iMod (reg_update _ tlb _ tlbvecD with "Hreg Htlbc") as "[Hreg Htlbc]".
    assert (LtlbS : register_lookup tlb s'.(sregs) = tlbvecD)
      by (unfold s'; lk; reflexivity).
    ...
    { unfold tlbvecD.
      exact (upt_tlb_ok_fill spec (register_lookup tlb s_x.(sregs)) vpnD ieD HsomeD
               ltac:(rewrite Htlx; exact (upt_tlb_ok_fill spec tlbvec vpn ie Hsome Hok))). }
    iModIntro.
    iExists (E_SAMO_Access_Fault tt), eaF, s', tlbvecD.
    iSplitR; [iPureIntro; exact Hexec_sc |].
    iSplitR; [iPureIntro; exact Hdel_samoaf |].
    iSplitR; [iPureIntro; exact LpcXx' |].
    iSplitR; [iPureIntro; exact LtlbS |].
    ...
    assert (Htr_x : exec (translateAddr (Virtaddr (add_vec_int (bits_of_virtaddr (Virtaddr eaF)) (0 * 4))) (StoreConditional Data)) s_x
                    = Some (Ok (Physaddr paD, PBMT_PMA, init_ext_ptw), s')).
    { rewrite Heaeq. rewrite <- Hpaw.
      exact (exec_translateAddr_storecon_walk_u vpnD root (uw_pte2 ieD) (uw_pte1 ieD) (uw_pte0 ieD)
               eaF satp0 MENVCFG_S (register_lookup tlb s_x.(sregs)) s_x
               H2i H2nl H1i H1nl H0i H0nl HchkD H0N LmisaX Hprx HSXLX HMPRVX Hsatpx Hsatpmode Hasid Hroot
               eq_refl ltac:(rewrite Htlx; exact HvaccD) HupdD Hrd2 Hrd1 Hrd0 LmenvX
               ltac:(vm_compute; reflexivity) HcanonD Hvpn_defD). }
  ...
  (* ================================================================== *)
  (* 2-aligned ECALL-in-U arm, riding [wp_exec_trapish_u_split].  Decode  *)
  (* is byte-keyed to [ecall_w]; the callback K returns the U-mode        *)
  (* environment-call Trap (cause E_U_EnvCall, xtval None) directly --     *)
  (* execute is state-preserving, so s' = s_x and tlbvecD = the fetch-    *)
  (* fill (no data walk).                                                 *)
  (* ================================================================== *)
  Lemma ustep_u_split_ecall_u
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (ECALL tt) = false) by reflexivity.
    assert (Hdec : forall s0, agree_on D_u s0 dstateU ->
              exec (ext_decode ecall_w) s0 = Some (ECALL tt, s0)).
    { intros s0 Hs0. unfold ecall_w. exact (decode_ecall_u s0 Hs0). }
    iApply (wp_exec_trapish_u_split va vpn ie ecall_w (ECALL tt) ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 HcwL HcwH HSXL Hbit0 Hbit1 Hvalign4
              HcanonL Hvpn_defL HalignL HcanonH Hvpn_defH HalignH HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
                    Hcode Hdata Hcfg [] Hcont").
    (* ==== the trap-body callback: ECALL executes to E_U_EnvCall Trap ==== *)
    iIntros (s_x Hpcx Hnpcx Hprx Hmsx Hsatpx Hpmpcx Hpmpax Hagx Htlx)
            "Htlbc Hupt Hgpr Hsigma".
    iModIntro.
    iExists (E_U_EnvCall tt), va, s_x,
            (vec_update_dec tlbvec (tlb_hash (__id 39) vpn) (Some (upt_entry vpn ie))).
    iSplitR.
    { iPureIntro.
      assert (Hmse : make_sync_exception (E_U_EnvCall tt) va = ecall_u_exc) by reflexivity.
      rewrite Hmse. exact (exec_execute_ECALL_U va s_x Hprx Hpcx). }
    iSplitR; [iPureIntro; exact Hdel_ecall |].
    iSplitR; [iPureIntro; exact Hpcx |].
    iSplitR; [iPureIntro; exact Htlx |].
    iSplitR; [iPureIntro; exact (upt_tlb_ok_fill spec tlbvec vpn ie Hsome Hok) |].
    iFrame "Hsigma Htlbc Hupt Hgpr".
  Qed.

...
(*  [snap_ok]; lane E-boot's two new clauses                                *)
(*  ([FsStateInode.inl_bare_free] and [FsDurSnap.sk_regdom]) are the last   *)
(*  pieces of it that were missing.  WHAT DOES NOT COME OFF IT is the OLD   *)
(*  link ledger: [DirLinks.dir_links] and the inode region's flavoured      *)
(*  columns.                                                               *)
(*                                                                        *)

...
Section WpInstr.
  ...
  Proof.
    ...
    iApply (swp_run_hart_active_instr mm_Drw mm_Dro (mm_Df dq)
              (mm_rs pc pc ms (minstret_inc_flag mc micfg) cy ti ip mst0 pmpcfg0 mc micfg misa0 mseccfg0 pmar0 elp0 senv0) (mm_rs pc npc ms (minstret_inc_flag mc micfg) cy ti ip mst0 pmpcfg0 mc micfg misa0 mseccfg0 pmar0 elp0 senv0) pc is_rvc i pmar0 pmpcfg0 (gpr_file m' ∗ R)%I

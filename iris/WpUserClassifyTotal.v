...
(*   A. Full-word non-compute dispatch: JAL/JALR guard producers        *)
(*      (rd=x0 plain-jump + misaligned-target fault arms are MISSING),  *)
(*      BTYPE taken/fall via decidable branch cond.                     *)

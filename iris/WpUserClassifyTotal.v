...
Section Total.
  ...
  (* ---- 2-aligned MEMORY routers (success), widths 8/2/1 loads +
     stores 8/4/2/1: clones of produce_split_mem_lw4 into ustep_mem_case's
     2-aligned split twins (disjuncts 11-17). ---- *)
  Lemma produce_split_mem_ld8 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info) (imm : mword 12) (rs1 rd : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  Proof.
    ...
    unfold WpUserFull.ustep_mem_case.
    do 10 right; left.
    exists vpn, ie, w, vpnD, ieD, imm, rs1, rd.
    cbv zeta.
    unfold usplit_hit in Hu.
    destruct Hu as (Hsome & Hchk & Hupd & HbL & HbH & Hbit0 & Hbit1 & Hval4 &
                    HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC).
  ...
  Lemma produce_split_mem_lh2 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
  ...
  Lemma produce_split_mem_lb1 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info) (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_mem_sd8 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
    ...
    ustep_mem_case va ms_v g tlbvec.
  Proof.
    intros Hu Hmprv Hmxr Hnowrap Hdec HspecD HchkD HupdD HpbmtD HeaAl HeaCanon HvpnD HpaAl Hres.
    unfold WpUserFull.ustep_mem_case.
    do 13 right; left.
  ...
  Lemma produce_split_mem_sw4 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info) (imm : mword 12) (rs2 rs1 : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_mem_sh2 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info) (imm : mword 12) (rs2 rs1 : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_mem_sb1 (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info) (imm : mword 12) (rs2 rs1 : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  (* ---- 2-aligned FAULT routers (data vpn UNMAPPED, spec!!vpnD=None):
     route into ustep_fault_case's 2-aligned split page-fault disjuncts
     (LOAD 21-24 widths 4/8/2/1, STORE 25-28 widths 8/4/2/1).
     NOTE: there are NO 2-aligned DATA-NO-PERM (uw_check_denied) disjuncts
     in ustep_fault_case, so the _noperm split routers cannot be built. ---- *)
  Lemma produce_split_fault_lw4_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
  ...
  Proof.
    intros Hu Hpbmt Hmprv Hmxr Hdec HspecD HeaAl HeaCanon HvpnD.
    unfold WpUserFull.ustep_fault_case.
    do 21 right; left.
    exists vpn, ie, w, vpnD, imm, rs1, rd, is_unsigned.
    cbv zeta.
    unfold usplit_hit in Hu.
    destruct Hu as (Hsome & Hchk & Hupd & HbL & HbH & Hbit0 & Hbit1 & Hval4 &
                    HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC).
  ...
  Lemma produce_split_fault_ld8_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_fault_lh2_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_fault_lb1_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_fault_sd8_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
  ...
  Proof.
    ...
    unfold WpUserFull.ustep_fault_case.
    do 25 right; left.
    exists vpn, ie, w, vpnD, imm, rs2, rs1.
    cbv zeta.
    unfold usplit_hit in Hu.
    destruct Hu as (Hsome & Hchk & Hupd & HbL & HbH & Hbit0 & Hbit1 & Hval4 &
                    HcanonL & Hvpn_defL & HalignL & HcanonH & Hvpn_defH & HalignH & HnotRVC).
  ...
  Lemma produce_split_fault_sw4_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs2 rs1 : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_fault_sh2_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs2 rs1 : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  Lemma produce_split_fault_sb1_unmapped (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs2 rs1 : mword 5) :
    usplit_hit va vpn ie w ->
  ...
  (* ================================================================ *)
  (* ufetch_hit bridges: consume the bundled fetch-hit premise         *)
  (* (produce_fetch_4aligned's output) directly, so the exhaustiveness  *)
  (* case-split routes a decoded LOAD/STORE from [ufetch_hit] + the     *)
  (* MPRV/MXR facts + the eaF verdict in one call.                      *)
  (* ================================================================ *)
  Lemma dispatch_load_from_ufetch
      (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool) (W : Z) :
    ...
    ustep_mem_case va ms_v g tlbvec \/ ustep_fault_case va ms_v g tlbvec.
  Proof.
    intros Huf Hmprv Hmxr Hdec Hrd Hisu8 HeaAl HeaCanon HvpnD Hverdict.
    destruct Huf as (Hs & Hok & Hupd & Hpbmt & Hres & Hval & Hcanon & Hvpn & Hpaal & Hnrvc).
    exact (dispatch_load_word va ms_v g tlbvec vpn ie w vpnD imm rs1 rd is_unsigned W
      Hs Hok Hupd Hpbmt Hres Hmprv Hmxr Hval Hcanon Hvpn Hpaal Hnrvc Hdec Hrd Hisu8
      HeaAl HeaCanon HvpnD Hverdict).
  Qed.

  Lemma dispatch_store_from_ufetch
      (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (imm : mword 12) (rs2 rs1 : mword 5) (W : Z) :
    ...
    ustep_mem_case va ms_v g tlbvec \/ ustep_fault_case va ms_v g tlbvec.
  Proof.
    intros Huf Hmprv Hmxr Hdec HeaAl HeaCanon HvpnD Hverdict.
    destruct Huf as (Hs & Hok & Hupd & Hpbmt & Hres & Hval & Hcanon & Hvpn & Hpaal & Hnrvc).
    exact (dispatch_store_word va ms_v g tlbvec vpn ie w vpnD imm rs2 rs1 W
      Hs Hok Hupd Hpbmt Hres Hmprv Hmxr Hval Hcanon Hvpn Hpaal Hnrvc Hdec
      HeaAl HeaCanon HvpnD Hverdict).
  Qed.
  ...
  (* dispatch_word_data: [dispatch_word_ctrl] extended to ALSO route the
     data families LOAD / STORE (via [dispatch_load_from_ufetch] /
     [dispatch_store_from_ufetch]), taking their per-word data verdict as a
     decode-conditioned hypothesis (the eaF alignment/canonicity + the
     mapped/denied/unmapped disjunction for the data page).  MPRV/MXR are
     frame facts (top-level).  The residual [Hrest] now covers only the
     atomic/trap remainder: AMO (needs an [ustep_mem_case] AMO disjunct),
     LOADRES/STORECON (route to [ustep_fault_case] via the LR/SC arms),
     ECALL (byte-keyed disjunct 4), and WRS (wait-state gap). *)
  Lemma dispatch_word_data
      (va ms_v : mword 64) (g : gmap regidx (mword 64))
      (tlbvec : vec (option TLB_Entry) (2 ^ 6))
      (vpn : mword 27) (ie : uwalk_info) (w : mword 32) :
    ufetch_hit va vpn ie w tlbvec ->
    ...
    (forall (imm : mword 13) (rs2 rs1 : mword 5) (op : bop),
       ...
       ( (match op with
         ...
         \/ ((match op with
          ...
          /\ eq_vec (access_vec_dec (add_vec va (sign_extend' 64 imm)) 0) ('b"0") = true
          /\ bit_to_bool (access_vec_dec (add_vec va (sign_extend' 64 imm)) 1) = false) )) ->
    (* LOAD guard (decode-conditioned): rd<>x0, W=8 signed-only, eaF aligned
       & canonical, and the data-page verdict for vpnD := extract(eaF). *)
    (forall (imm : mword 12) (rs1 rd : mword 5) (is_unsigned : bool) (W : Z),
       (forall s0, agree_on D_u s0 dstateU ->
          exec (ext_decode w) s0 = Some (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, W), s0)) ->
       uint rd <> 0 /\ (W = 8 -> is_unsigned = false) /\
       is_aligned_vaddr (Virtaddr (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm))) W = true /\
       neq_vec (bits_of_virtaddr (Virtaddr (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm))))
         (sign_extend' 64 (subrange_vec_dec (bits_of_virtaddr (Virtaddr (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm)))) (Z.sub 39 1) 0)) = false /\
       (exists vpnD : mword 27,
          autocast (T := mword) (subrange_vec_dec
            (subrange_vec_dec (bits_of_virtaddr (Virtaddr (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm)))) (Z.sub 39 1) 0) (Z.sub 39 1) pagesize_bits) = vpnD /\
          ( spec !! vpnD = None
            \/ (exists ieD, spec !! vpnD = Some ieD /\ uw_check_denied (Load Data) ieD)
            \/ (exists ieD, spec !! vpnD = Some ieD /\
                  ...
                  (forall j : nat, (j < Z.to_nat W)%nat ->
                     pa_add (u_pa (upt_entry vpnD ieD)
                       (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm)) vpnD) j ∈ data))) )) ->
    (* STORE guard (decode-conditioned). *)
    (forall (imm : mword 12) (rs2 rs1 : mword 5) (W : Z),
       (forall s0, agree_on D_u s0 dstateU ->
          exec (ext_decode w) s0 = Some (STORE (imm, Regidx rs2, Regidx rs1, W), s0)) ->
       is_aligned_vaddr (Virtaddr (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm))) W = true /\
       neq_vec (bits_of_virtaddr (Virtaddr (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm))))
          ...
          ( spec !! vpnD = None
            ...
            \/ (exists ieD, spec !! vpnD = Some ieD /\
                  ...
                  (forall j : nat, (j < Z.to_nat W)%nat ->
                     pa_add (u_pa (upt_entry vpnD ieD)
                       (add_vec (g !!! Regidx rs1) (sign_extend' 64 imm)) vpnD) j ∈ data))) )) ->
    (* residual: AMO / LOADRES / STORECON / ECALL / WRS. *)
    (forall ii, decodable_u ii = true -> classifiable_u ii = false ->
       (forall s0, agree_on D_u s0 dstateU -> exec (ext_decode w) s0 = Some (ii, s0)) ->
       ustep_case va ms_v g tlbvec \/ ustep_mem_case va ms_v g tlbvec
       \/ ustep_fault_case va ms_v g tlbvec) ->
    ...
    \/ ustep_fault_case va ms_v g tlbvec.
  Proof.
    intros Huf Hmprv Hmxr HjalG HjalrG HbtypeG HloadG HstoreG Hrest.
    apply (dispatch_word_ctrl va ms_v g tlbvec vpn ie w Huf HjalG HjalrG HbtypeG).
    intros ii Hdu Hcl Hdec.
    destruct ii;
      lazymatch goal with
      | Hdec : forall _, _ -> exec _ _ = Some (LOAD ?p, _) |- _ =>
          destruct p as [[[[imm r1] r2] isu] W]; destruct r1 as [rs1]; destruct r2 as [rd];
          destruct (HloadG imm rs1 rd isu W Hdec)
            as (Hrd & Hisu8 & HeaAl & HeaCanon & vpnD & HvpnD & Hverdict);
          right; exact (dispatch_load_from_ufetch va ms_v g tlbvec vpn ie w vpnD imm rs1 rd isu W
                          Huf Hmprv Hmxr Hdec Hrd Hisu8 HeaAl HeaCanon HvpnD Hverdict)
      | Hdec : forall _, _ -> exec _ _ = Some (STORE ?p, _) |- _ =>
          destruct p as [[[imm rs2r] r1] W]; destruct rs2r as [rs2]; destruct r1 as [rs1];
          destruct (HstoreG imm rs2 rs1 W Hdec)
            as (HeaAl & HeaCanon & vpnD & HvpnD & Hverdict);
          right; exact (dispatch_store_from_ufetch va ms_v g tlbvec vpn ie w vpnD imm rs2 rs1 W
                          Huf Hmprv Hmxr Hdec HeaAl HeaCanon HvpnD Hverdict)
      | _ => exact (Hrest _ Hdu Hcl Hdec)
      end.
  Qed.
...
(*    fetch-HIT-based).  ustep_case_sound extended; user_step_holds_full *)
(*    needed NO edit (forwards ustep_case wholesale to ustep_case_sound).*)
(*  - SPLIT-FETCH-MISS ENGINE DONE (2026-07, pushed): WpUserSplitFetch   *)
(*    Miss.wp_instr_u_split_miss (non-straddling walk-fill: low half     *)
(*    walks+fills vpn, high half then HITS the filled entry, composed    *)
(*    via the state-abstract exec_fetch_F_Base_2_U_gen) + wp_instr_u_    *)
(*    split_combined (dispatch fetch hit/miss from spec!!vpn, uniform    *)
(*    filled-TLB callback -- the mirror of WpUserComputeMiss.wp_instr_u).*)
(*    So the 2-aligned 32-bit FETCH is now fetch-UNCONDITIONAL.  H2 is    *)
(*    UNBLOCKED: what remains is a GRIND, not novel engine work --        *)
(*    convert/build the 2-aligned 32-bit RETIRE/TRAP/FAULT arms to ride   *)
(*    wp_instr_u_split_combined (spec-based, non-straddling vpnL=vpnH),   *)
(*    each a fetch-swap of its 4-aligned twin + a new spec-based          *)
(*    ustep_case/mem/fault disjunct (batch per cone rebuild):             *)
(*      * COMPUTE: one GENERIC single-register-write retire arm (execute *)
(*        = if rd=0 then s else set_reg s rd (regval_into_reg v)) covers  *)
(*        ITYPE/RTYPE/UTYPE/SHIFTIOP/ADDIW/... -- generalize disjunct 52. *)
(*      * LOAD/STORE/AMOSWAP.W -> 2-aligned mem disjuncts (data side as   *)
(*        the 4-aligned dispatch_*_from_ufetch, fetch swapped to split).  *)
(*      * JAL/JALR/BTYPE -> 2-aligned control disjuncts.                  *)
(*      * ECALL/illegal/ebreak -> 2-aligned trap disjuncts (ride a split  *)
(*        trapish engine, or the existing trapish arms with split fetch). *)
(*      * FAULTS: high-half fetch fault DONE (ustep_split_highfault,      *)
(*        WpUserSplitFault) -- make it spec-based; + data page faults.    *)
(*      * STRADDLING (va at page boundary, va+2 in next page) = the ONE   *)
(*        remaining engine gap, deferred like arm C.                      *)
(*    Then H2 = the 2-aligned analogue of dispatch_word_data, and         *)
(*    user_classify_from_branches H4 H2 -> the total classification.      *)
...
(*                                                                      *)
(* FETCH-SIDE now complete EXCEPT these residual obligations:            *)
(*   - JAL/JALR rd=x0 (plain jump, no link): DONE.  classify_j/classify_ *)
(*     jr (this file) route JAL(imm,zreg)/JALR(imm,rs1,zreg) 4-aligned   *)
(*     into disjuncts 47/48; dispatch_4aligned_jal is TOTAL over rd      *)
(*     (rd<>x0 -> classify_jal disjunct 9; rd=x0 -> classify_j), via the *)
(*     bridge regidx_rd0_zreg.  dispatch_4aligned_jalr covers rd<>x0 and *)
(*     rd=x0/rs1<>x0; [jr x0] (rd=rs1=x0) has no disjunct (documented    *)
(*     gap; programs do not emit it).                                    *)
(*   - JAL/JALR/BTYPE taken to a 2-aligned COMPRESSED target: the        *)
(*     dispatchers require bit1=0 (4-aligned) targets; a 2-aligned taken *)
(*     target needs the RETIRING exec_jump_to_zca generalization (drop   *)
(*     bit1=false).  Odd targets are UNREACHABLE (Zca; imm bit0=0).      *)
(*   - full-word LOAD/STORE/AMO: route to the data side (step 6).        *)
(*                                                                      *)
(* H4 WORD-ROUTING now assembled (all green, 0 admits):                 *)
(*   dispatch_word_total (classifiable majority + Hrest delegation)      *)
(*   -> dispatch_word_ctrl (also routes BTYPE/JAL/JALR via the           *)
(*      dispatch_4aligned_* dispatchers, decode-conditioned guards)      *)
(*   -> dispatch_word_data (also routes LOAD/STORE via dispatch_load/    *)
(*      store_from_ufetch, decode-conditioned data verdict).             *)
(*   The residual Hrest for H4 is now only: LOADRES/STORECON (route to   *)
(*   ustep_fault_case's LR/SC access-fault disjuncts -- verbose data      *)
(*   guard + a mapped-vs-unmapped split), ECALL (disjunct 4, byte-keyed   *)
(*   to ecall_w -- needs w=ecall_w decode-injectivity), and WRS (wait-    *)
(*   state arm gap).  AMO DONE: AMOSWAP.W success is wired into           *)
(*   ustep_mem_case (9th disjunct, task #25) and routable via             *)
(*   dispatch_amoswap_from_ufetch (this file); non-AMOSWAP AMOs / other   *)
(*   aq-rl orderings remain (PMA access-fault / arm gap).                 *)
(*                                                                      *)
(* NEXT (in dependency order):                                          *)
(*   A0. Assemble H4 itself: split va low bits (produce_noncanonical /   *)
(*      produce_unmapped / produce_noexec / produce_adfault for the      *)
(*      fetch-fault legs) then produce_fetch_4aligned -> ufetch_hit ->   *)
(*      dispatch_word_data, with the residual Hrest discharged from the  *)
(*      uctx wf fields for the remaining atomic/trap families.  The      *)
(*      decode-conditioned control/data guards come from a uctx wf field *)
(*      relating spec/g/va to branch-cond + target-align + data-verdict. *)

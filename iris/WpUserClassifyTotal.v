...
(*   The residual Hrest for H4 is now ONLY the atomic/trap families:     *)
(*   AMO (needs an ustep_mem_case AMO disjunct -- def change),           *)
(*   LOADRES/STORECON (route to ustep_fault_case's LR/SC access-fault    *)
(*   disjuncts -- verbose data guard + a mapped-vs-unmapped split),      *)
(*   ECALL (disjunct 4, byte-keyed to ecall_w), WRS (wait-state arm).    *)
(*                                                                      *)

...
Section ProofSleepBody.
  ...
  Proof.
    ...
    (* ------------------------------------------------------------------ *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sleep + 0x0a)) (mword_of_int 1 : mword 5) (mword_of_int 2095468 : mword 21)
              A1 (av - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hpcmp : add_vec (mword_of_int (KernelSyms.sleep + 0x0a) : mword 64) (sign_extend' 64 (mword_of_int 2095468 : mword 21))

...
Section WpKernelvecNew.
  ...
  Lemma wp_kv_epilogue (root_ppn : mword 44) (svpn : mword 27)
    ...
    is_aligned_paddr (Physaddr (((spv)))) 8 = true ->
    (* slot 2: x3 at sp+16 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 2 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 3: x5 at sp+32 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 4 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 4: x6 at sp+40 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 5 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 5: x7 at sp+48 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 6 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 6: x10 at sp+72 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 9 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 7: x11 at sp+80 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 10 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 8: x12 at sp+88 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 11 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 9: x13 at sp+96 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 12 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 10: x14 at sp+104 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 13 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 11: x15 at sp+112 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 14 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 12: x16 at sp+120 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 15 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 13: x17 at sp+128 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 16 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 14: x28 at sp+216 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 27 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 15: x29 at sp+224 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 28 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 16: x30 at sp+232 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 29 : mword 6) ('b"000"))))))) 8 = true ->
    (* slot 17: x31 at sp+240 *)
    ...
    is_aligned_paddr (Physaddr (((add_vec spv (zero_extend' 64 (concat_vec (mword_of_int 30 : mword 6) ('b"000"))))))) 8 = true ->
    hw_config -∗ minstret_inv -∗
    hart_state ↦ᵣ HART_ACTIVE tt -∗
    cur_privilege ↦ᵣ Supervisor -∗
    satp ↦ᵣ satp0 -∗
  ...
  Proof.
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 2 : mword 6) ('b"000"))) 2).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 4 : mword 6) ('b"000"))) 4).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 5 : mword 6) ('b"000"))) 5).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 6 : mword 6) ('b"000"))) 6).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 9 : mword 6) ('b"000"))) 9).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 10 : mword 6) ('b"000"))) 10).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 11 : mword 6) ('b"000"))) 11).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 12 : mword 6) ('b"000"))) 12).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 13 : mword 6) ('b"000"))) 13).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 14 : mword 6) ('b"000"))) 14).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 15 : mword 6) ('b"000"))) 15).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 16 : mword 6) ('b"000"))) 16).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 27 : mword 6) ('b"000"))) 27).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 28 : mword 6) ('b"000"))) 28).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 29 : mword 6) ('b"000"))) 29).
      - vm_compute. reflexivity.
      - exact Halp1. }
    ...
    { apply (align8_paddr_add_offset (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 30 : mword 6) ('b"000"))) 30).
      - vm_compute. reflexivity.
      - exact Halp1. }
    iIntros "#Hhw #Hinv Hhs Hpriv Hsatp Hms Hmie Hmdl Hmenv Hpmpc Hpmpa Htlb Hsepc Hpc Hfile
             #Htext Hpte Hw1 Hw2 Hw3 Hw4 Hw5 Hw6 Hw7 Hw8 Hw9 Hw10 Hw11 Hw12 Hw13 Hw14 Hw15 Hw16 Hw17 Hcont".

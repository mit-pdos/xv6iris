...
End FetchRVC4_S.
  ...
  Lemma wp_smode_addi4 (w : mword 32)
    ...
    WP (Loop : expr riscv_lang) @ E {{ Phi }}.
  Proof.
    iIntros (Hrd Hmd HsatpM HSXL Hvec Hpmaall HA0 Hord0 Hrange0 HX0 Halignf
             HisRVC HmisaC HmisaS Hdec Hcexec1 Hb1 Hmie_mdl HSIE Help)
      "Hpc Hfile Hmisa' Hnpc Hmi Hmst Hpriv Hhs Hmdl Hms Hsatp Htlb Hmie Help' Hmcinh Hmcfg Hpmpc Hpmpaddr Hpma Hhtif Hibytes Hcont".
    ...
    iExists (WpRvc.sFcg s (mword_of_int 0x800053e0) b1 rd (add_vec vd (sign_extend' 64 imm12)) mst0). iSplitR.
    { iPureIntro.
      rewrite <- (WpRvc.sFg_eq s (mword_of_int 0x800053e0) b1 rd (add_vec vd (sign_extend' 64 imm12)) mst0 Lpc Lmst).
    ...
    - iMod (reg_update _ minstret _ (add_vec_int mst0 1) with "Hreg Hmst") as "[Hreg Hmst]".
      ...
      iApply ("Hcont" with "Hpc Hfile Hmisa' Hnpc Hmi Hmst Hpriv Hhs Hmdl Hms Hsatp Htlb Hmie Help' Hmcinh Hmcfg Hpmpc Hpmpaddr Hpma Hhtif Hibytes").
    - iMod "Hclose" as "_". iModIntro. unfold set_reg; cbn [sregs mem]. iFrame "Hreg Hmem".
      iApply ("Hcont" with "Hpc Hfile Hmisa' Hnpc Hmi Hmst Hpriv Hhs Hmdl Hms Hsatp Htlb Hmie Help' Hmcinh Hmcfg Hpmpc Hpmpaddr Hpma Hhtif Hibytes").
  Qed.
  ...
  Lemma wp_kernelvec_caddi16sp (w : mword 32) (imm6 : mword 6)
    ...
    WP (Loop : expr riscv_lang) @ E {{ Phi }}.
  Proof.
    iIntros (Hsp HsatpM HSXL Hvec Hpmaall HA0 Hord0 Hrange0 HX0 Halignf
    ...
    iApply (wp_smode_addi4 w (C_ADDI16SP imm6) (zero_extend' 5 ('b"10")) (caddi16sp_imm imm6)
              m vsp misa0 mdv0 mstatus0 satp0 mie_v b1 npc0 mst0 mc mcfg pmpcfg0 pmpaddr00 pmar0 mi0 elp0 tlbvec E Phi
             ...
             with "Hpc Hfile Hmisa' Hnpc Hmi Hmst Hpriv Hhs Hmdl Hms Hsatp Htlb Hmie Help' Hmcinh Hmcfg Hpmpc Hpmpaddr Hpma Hhtif Hibytes [Hcont]").
    iApply "Hcont".
  Qed.

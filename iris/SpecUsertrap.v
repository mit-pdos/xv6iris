...
Definition usertrap_post `{!riscvGS Σ, !xv6G Σ, !fdslotG Σ, !fileG Σ} `{GEN : GenId} `{CID : CpuId}
...
Definition wp_usertrap_body `{!riscvGS Σ, !xv6G Σ, !fdslotG Σ, !fileG Σ} `{GEN : GenId} `{CID : CpuId}
...
Module Type USERTRAP_RES.
  ...
  Parameter usertrap_res_tlb_close :
    forall `{!riscvGS Σ, !xv6G Σ, !fdslotG Σ, !fileG Σ, !irefslotG Σ, !pavG Σ} `{GEN : GenId} `{CID : CpuId} (pt : uptd) (ksp : mword 64) (kroot : mword 44),
  ...
  Parameter usertrap_res_tlb_open :
    forall `{!riscvGS Σ, !xv6G Σ, !fdslotG Σ, !fileG Σ, !irefslotG Σ, !pavG Σ} `{GEN : GenId} `{CID : CpuId} (pt : uptd) (ksp : mword 64),
      usertrap_res pt ksp -∗

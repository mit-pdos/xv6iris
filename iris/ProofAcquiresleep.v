...
Section AslBodies.
  ...
  Proof.
    ...
    iApply (wp_csw_s_sconf Φ (mword_of_int (ASL + 0x2a)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
    ...
    { rgne. rewrite Hmfma0. rewrite /p_pid.
      ...
      reflexivity. }
    iApply (wp_clw_s_sconf Φ (mword_of_int (ASL + 0x30)) (mword_of_int 15 : mword 5) (mword_of_int 10 : mword 5)
    ...
    { rgne. rewrite HE3s1. rewrite /sl_pid.
      ...
      reflexivity. }
    iApply (wp_csw_s_sconf Φ (mword_of_int (ASL + 0x32)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (ASL + 0x3a)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (ASL + 0x3c)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    (* +0x3e c.ldsp s1,8(sp) *)
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (ASL + 0x3e)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
    ...
    (* +0x40 c.ldsp s2,0(sp) *)
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (ASL + 0x40)) (mword_of_int 0 : mword 6) (mword_of_int 18 : mword 5)
    ...
    iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (ASL + 0x42)) (mword_of_int 2 : mword 6) Q40 (av - 4)%nat 4 true Hpop
    ...
    iApply (wp_cret_s_sconf Φ (mword_of_int (ASL + 0x44)) (mword_of_int 1 : mword 5) Q42 av true
  ...
  Lemma asl_post_sleep_body `{CID : CpuId} (CID0 : CPU)
    ...
    asl_regs m M slk spd ->
    kernel_text -∗
    ▷ asl_loop CID0 Φ γs j γl γsl R m pidv av dq slk spd sp0 eb C -∗
    asl_exit CID0 Φ γs j γl γsl R m pidv av dq slk spd sp0 eb C -∗
    pa_stk sp0 1 ↦₈ (m !!! Regidx (mword_of_int 1 : mword 5)) -∗
    pa_stk sp0 2 ↦₈ (m !!! Regidx (mword_of_int 8 : mword 5)) -∗
    pa_stk sp0 3 ↦₈ (m !!! Regidx (mword_of_int 9 : mword 5)) -∗
  ...
  Proof.
    ...
    iApply (wp_clw_s_sconf Φ (mword_of_int (ASL + 0x24)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
    ...
    - (* FREE: vp = 0 -> bnez falls through to +0x28 -> exit *)
      iApply (wp_cbnez_fall_s_sconf Φ (mword_of_int (ASL + 0x26)) (mword_of_int 251 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
    ...
    - (* HELD: vp <> 0 -> bnez TAKEN, back edge to +0x1c (the Löb IH).  Hand the
      ...
      iApply (wp_cbnez_taken_s_sconf Φ (mword_of_int (ASL + 0x26)) (mword_of_int 251 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
                La5 (av - 4)%nat false ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
...
Section ProofAcquiresleep.
  ...
  Proof.
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (ASL + 0x02)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (ASL + 0x04)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    (* +0x06 c.sdsp s1,8(sp) *)
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (ASL + 0x06)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
    ...
    (* +0x08 c.sdsp s2,0(sp) *)
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (ASL + 0x08)) (mword_of_int 0 : mword 6) (mword_of_int 18 : mword 5)
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (ASL + 0x0a)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) (mword_of_int 8 : mword 5)
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (ASL + 0x0c)) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (ASL + 0x0e)) (mword_of_int 18 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 8 : mword 12)
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (ASL + 0x12)) (mword_of_int 10 : mword 5) (mword_of_int 18 : mword 5)
    ...
    (* +0x14 jal ra,acquire *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (ASL + 0x14)) (mword_of_int 1 : mword 5) (mword_of_int 2084136 : mword 21)
    ...
    (* +0x18 lw a5,0(s1) *)
    iApply (wp_clw_s_sconf Φ (mword_of_int (ASL + 0x18)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
    ...
    - (* FREE at entry: v0 = 0 -> c.beqz TAKEN -> +0x28 (exit) *)
      iApply (wp_cbeqz_taken_s_sconf Φ (mword_of_int (ASL + 0x1a)) (mword_of_int 7 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
    ...
    - (* HELD at entry: v0 <> 0 -> c.beqz falls through -> +0x1c (the loop) *)
      iApply (wp_cbeqz_fall_s_sconf Φ (mword_of_int (ASL + 0x1a)) (mword_of_int 7 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
                Me (av - 4)%nat false ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)

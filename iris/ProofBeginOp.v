...
Lemma bo_reloc_a0_0c :
  add_vec (add_vec (mword_of_int (KernelSyms.begin_op + 0x0c) : mword 64)
          ...
          (sign_extend' 64 (mword_of_int 2172 : mword 12)) = log_addr.
...
Section BoProps.
  ...
  Definition bo_exit `{GEN : GenId} (CID0 : CPU)
      ...
      (K : nat) (eb : bool) (spd sp0 : mword 64) (lks : gset string) (Upr : ustate) : iProp Σ :=
...
Section BoBodies.
  ...
  Lemma bo_exit_body `{GEN : GenId} `{CID : CpuId} (CID0 : CPU)
      ...
      (K : nat) (eb : bool) (spd sp0 : mword 64) (lks : gset string) (Upr : ustate) :
  ...
  Proof using .
    ...
    iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.begin_op + 0x74)) (mword_of_int 10 : mword 5)
              (mword_of_int 31 : mword 20) M (trap_res eb + (K - 4))%nat false
    ...
    set (X1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.begin_op + 0x74) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> M).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.begin_op + 0x74) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> M) with X1.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.begin_op + 0x78)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 2068 : mword 12) X1 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (X2 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X1 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2068 : mword 12)))]> X1).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X1 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2068 : mword 12)))]> X1) with X2.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x7c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084540 : mword 21) X2 (trap_res eb + (K - 4))%nat false
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.begin_op + 0x7c) : mword 64) (sign_extend' 64 (mword_of_int 2084540 : mword 21))
    ...
    iApply (Release.wp_release_sconf KT1 (ln_lk γ) log_addr "log"%string
              (log_res_at γ bn γfs cov logstart) X3 0%nat eb pj (K - 4)%nat
              ({["log"]} ∪ lks)
              Hrel_lka ltac:(lia)
  ...
  Lemma bo_armA_body `{GEN : GenId} `{CID : CpuId} (CID0 : CPU)
    ...
    log_ctx γ bn γfs cov logstart dev -∗
    procs_inv γs -∗
    bo_loop CID0 j γ bn γfs cov logstart m pidv dq K eb spd sp0 lks Upr -∗
    bo_exit CID0 j γ bn γfs cov logstart m pidv dq K eb spd sp0 lks Upr -∗
    pa_stk sp0 1 ↦₈[KT1] (m !!! Regidx (mword_of_int 1 : mword 5)) -∗
    pa_stk sp0 2 ↦₈[KT1] (m !!! Regidx (mword_of_int 8 : mword 5)) -∗
    pa_stk sp0 3 ↦₈[KT1] (m !!! Regidx (mword_of_int 9 : mword 5)) -∗
  ...
  Proof using .
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x26)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089478 : mword 21) A0 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (HAjsp : add_vec (mword_of_int (KernelSyms.begin_op + 0x26) : mword 64) (sign_extend' 64 (mword_of_int 2089478 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x2c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084620 : mword 21) A2 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (HAjrl : add_vec (mword_of_int (KernelSyms.begin_op + 0x2c) : mword 64) (sign_extend' 64 (mword_of_int 2084620 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* -------------------- release(&log.lock) -------------------- *)
    iApply (Release.wp_release_sconf KT1 (ln_lk γ) log_addr "log"%string
              (log_res_at γ bn γfs cov logstart) A3 0%nat eb pj (K - 4)%nat
              ({["log"]} ∪ lks)
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x30)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089528 : mword 21) mfr (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x36)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084474 : mword 21) A5 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (Acquire.wp_acquire_sconf KT1 (ln_lk γ) "log"%string
              (log_res_at γ bn γfs cov logstart) A6 0%nat eb pj (K - 4)%nat eb lks
  ...
  Proof using .
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x56)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089430 : mword 21) B0 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (HBjsp : add_vec (mword_of_int (KernelSyms.begin_op + 0x56) : mword 64) (sign_extend' 64 (mword_of_int 2089430 : mword 21))
                   = mword_of_int KernelSyms.sleep_prepare)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x5c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084572 : mword 21) B2 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (HBjrl : add_vec (mword_of_int (KernelSyms.begin_op + 0x5c) : mword 64) (sign_extend' 64 (mword_of_int 2084572 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* -------------------- release(&log.lock) -------------------- *)
    iApply (Release.wp_release_sconf KT1 (ln_lk γ) log_addr "log"%string
              (log_res_at γ bn γfs cov logstart) B3 0%nat eb pj (K - 4)%nat
              ({["log"]} ∪ lks)
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x60)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089480 : mword 21) mfr (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x66)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084426 : mword 21) B5 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (Acquire.wp_acquire_sconf KT1 (ln_lk γ) "log"%string
              (log_res_at γ bn γfs cov logstart) B6 0%nat eb pj (K - 4)%nat eb lks
              bo_noff1 ltac:(pose proof (bo_K10 K HK); lia) Hbelow
              with "Hcg Hown Htext Hpc []").
    all: try lkbelow.
    ...
    - (* ================= NOT COMMITTING: fall through to +0x30 ============ *)
      ...
      + (* ---- GRANT: the branch is TAKEN, control at +0x50 ---- *)
        ...
        iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.begin_op + 0x6c)) (mword_of_int 15 : mword 5)
                  (mword_of_int 31 : mword 20) E8 (trap_res eb + (K - 4))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc []").
        ...
        set (E9 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg
            (add_vec (mword_of_int (KernelSyms.begin_op + 0x6c) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> E8).
        change (<[Regidx (mword_of_int 15 : mword 5) := regval_into_reg
            (add_vec (mword_of_int (KernelSyms.begin_op + 0x6c) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> E8) with E9.
        ...
        assert (HE9a5 : E9 !!! Regidx (mword_of_int 15 : mword 5)
                        = add_vec (mword_of_int (KernelSyms.begin_op + 0x6c) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))
        ...
        iApply (wp_sw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.begin_op + 0x70)) (mword_of_int 14 : mword 5) (mword_of_int 15 : mword 5)
                  (mword_of_int 2104 : mword 12) E9 (trap_res eb + (K - 4))%nat
      ...
      + (* ---- NO SPACE: the branch FALLS THROUGH, control at +0x46 ---- *)
        ...
        iApply (bo_armB_body (CID := CID) CID0 γs j γl γ bn γfs cov logstart dev m E8 pidv dq K eb spd sp0 lks
                  Upr HK Hj Hjl Hanch HboE8 Hbelow
                  with "Htext Hlog Hpinv IH Hexit Hr24 Hr16 Hr8 Hr0 Htok Hres Hpid Hown Htc Hclm Hcg Hpc").
  Qed.
...
Section ProofBeginOp.
  ...
  Proof using .
    ...
    iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.begin_op + 0x0c)) (mword_of_int 10 : mword 5)
              (mword_of_int 31 : mword 20) R2 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.begin_op + 0x0c) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> R2) with R3.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.begin_op + 0x10)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 2172 : mword 12) R3 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (R3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2172 : mword 12)))]> R3) with R4.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x14)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084508 : mword 21) R4 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjaq : add_vec (mword_of_int (KernelSyms.begin_op + 0x14) : mword 64) (sign_extend' 64 (mword_of_int 2084508 : mword 21))
                   = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iDestruct (cpu_own_transport CID CID9 0 eb pj eb ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Acquire.wp_acquire_sconf KT1 (ln_lk γ) "log"%string (log_res_at γ bn γfs cov logstart) Maq
    ...
    iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.begin_op + 0x18)) (mword_of_int 9 : mword 5)
              (mword_of_int 31 : mword 20) Macq (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (T1 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.begin_op + 0x18) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> Macq).
    change (<[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.begin_op + 0x18) : mword 64) (auipc_off (mword_of_int 31 : mword 20)))]> Macq) with T1.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.begin_op + 0x1c)) (mword_of_int 9 : mword 5)
              (mword_of_int 9 : mword 5) (mword_of_int 2160 : mword 12) T1 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (T2 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (T1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 2160 : mword 12)))]> T1).
    change (<[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (T1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 2160 : mword 12)))]> T1) with T2.

...
Lemma bo_reloc_a0_0c :
  add_vec (add_vec (mword_of_int (KernelSyms.begin_op + 0x0c) : mword 64)
          ...
          (sign_extend' 64 (mword_of_int 1892 : mword 12)) = log_addr.
...
Lemma bo_reloc_s1_18 :
  add_vec (add_vec (mword_of_int (KernelSyms.begin_op + 0x18) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1880 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma bo_reloc_a0_58 :
  add_vec (add_vec (mword_of_int (KernelSyms.begin_op + 0x74) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1788 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.
...
Section BoProps.
  ...
  Definition bo_exit `{GEN : GenId} (CID0 : CPU)
      ...
      (K : nat) (eb : bool) (spd sp0 : mword 64) (lks : gset string) : iProp Σ :=
...
Section BoBodies.
  ...
  Lemma bo_exit_body `{GEN : GenId} `{CID : CpuId} (CID0 : CPU) (j : nat)
      ...
      (K : nat) (eb : bool) (spd sp0 : mword 64) (lks : gset string) :
  ...
  Proof.
    ...
    { rewrite -Hspd. unfold pa_stk, add_vec_int. rewrite add_vec_off2.
      apply f_equal. apply bv_eq; vm_compute; reflexivity. }
    iPoseProof (boi_74 with "Htext") as "Hi58".
    iPoseProof (boi_78 with "Htext") as "Hi5c".
    iPoseProof (boi_7c with "Htext") as "Hi60".
    iPoseProof (boi_80 with "Htext") as "Hi64".
    iPoseProof (boi_82 with "Htext") as "Hi66".
    iPoseProof (boi_84 with "Htext") as "Hi68".
    iPoseProof (boi_86 with "Htext") as "Hi6a".
    iPoseProof (boi_88 with "Htext") as "Hi6c".
    iPoseProof (boi_8a with "Htext") as "Hi6e".
    (* +0x58 auipc a0,0x1e *)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.begin_op + 0x78)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 1788 : mword 12) X1 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi5c").
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    set (X2 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X1 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1788 : mword 12)))]> X1).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X1 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1788 : mword 12)))]> X1) with X2.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x7c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084782 : mword 21) X2 (trap_res eb + (K - 4))%nat false
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.begin_op + 0x7c) : mword 64) (sign_extend' 64 (mword_of_int 2084782 : mword 21))
  ...
  Proof.
    ...
    destruct Hbo as (Hs1 & Hs2 & Hsp & H19 & H20 & H21 & H22 & H23 & H24 & H25 & H26 & H27).
    iPoseProof (boi_24 with "Htext") as "HjA1".
    iPoseProof (boi_26 with "Htext") as "HjA2".
    iPoseProof (boi_2a with "Htext") as "HjA3".
    iPoseProof (boi_2c with "Htext") as "HjA4".
    iPoseProof (boi_30 with "Htext") as "HjA5".
    iPoseProof (boi_34 with "Htext") as "HjA6".
    iPoseProof (boi_36 with "Htext") as "HjA7".
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x26)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089638 : mword 21) A0 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjA2").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    ...
    assert (HAjsp : add_vec (mword_of_int (KernelSyms.begin_op + 0x26) : mword 64) (sign_extend' 64 (mword_of_int 2089638 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x2c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084862 : mword 21) A2 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjA4").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    ...
    assert (HAjrl : add_vec (mword_of_int (KernelSyms.begin_op + 0x2c) : mword 64) (sign_extend' 64 (mword_of_int 2084862 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x30)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089688 : mword 21) mfr (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjA5").
    ...
    assert (HAjsl : add_vec (mword_of_int (KernelSyms.begin_op + 0x30) : mword 64) (sign_extend' 64 (mword_of_int 2089688 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x36)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084716 : mword 21) A5 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjA7").
    ...
    assert (HAjaq : add_vec (mword_of_int (KernelSyms.begin_op + 0x36) : mword 64) (sign_extend' 64 (mword_of_int 2084716 : mword 21))
  ...
  Proof.
    ...
    assert (HboM : bo_regs m M spd) by exact Hbo.
    destruct Hbo as (Hs1 & Hs2 & Hsp & H19 & H20 & H21 & H22 & H23 & H24 & H25 & H26 & H27).
    iPoseProof (boi_54 with "Htext") as "HjB1".
    iPoseProof (boi_56 with "Htext") as "HjB2".
    iPoseProof (boi_5a with "Htext") as "HjB3".
    iPoseProof (boi_5c with "Htext") as "HjB4".
    iPoseProof (boi_60 with "Htext") as "HjB5".
    iPoseProof (boi_64 with "Htext") as "HjB6".
    iPoseProof (boi_66 with "Htext") as "HjB7".
    (* THE SPLIT SLEEP PROTOCOL.  The loop invariant carries [trap_csrs] and
       [cpu_claim pj] index-free; the interior release wants the PAY half of
       that pair and the park wants the COMPLEMENT, so split once here and
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x56)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089590 : mword 21) B0 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjB2").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    ...
    assert (HBjsp : add_vec (mword_of_int (KernelSyms.begin_op + 0x56) : mword 64) (sign_extend' 64 (mword_of_int 2089590 : mword 21))
                   = mword_of_int KernelSyms.sleep_prepare)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    { apply locks_below_union_singleton; [vm_compute; lia |].
      lkbelow. }
    iApply (SleepPrepare.wp_sleep_prepare_sconf kt γs j γl B1
              (trap_res eb + (K - 4))%nat 1%nat eb false
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x5c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084814 : mword 21) B2 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjB4").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    ...
    assert (HBjrl : add_vec (mword_of_int (KernelSyms.begin_op + 0x5c) : mword 64) (sign_extend' 64 (mword_of_int 2084814 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x60)) (mword_of_int 1 : mword 5)
              (mword_of_int 2089640 : mword 21) mfr (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjB5").
    ...
    assert (HBjsl : add_vec (mword_of_int (KernelSyms.begin_op + 0x60) : mword 64) (sign_extend' 64 (mword_of_int 2089640 : mword 21))
                   = mword_of_int KernelSyms.sleep)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    { lkbelow. }
    iApply (Sleep.wp_sleep_sconf kt γs j γl B4 (K - 4)%nat eb lks Hj Hjl
              ltac:(pose proof (bo_K22 K HK); lia)
              HbelowB4
              with "Hcg Hown Htext Hpc Hpinv Htcx Hclmx").
    all: try lkbelow.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x66)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084668 : mword 21) B5 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc HjB7").
    ...
    assert (HBjaq : add_vec (mword_of_int (KernelSyms.begin_op + 0x66) : mword 64) (sign_extend' 64 (mword_of_int 2084668 : mword 21))
                   = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iPoseProof (boi_6a with "Htext") as "HjBj".
  ...
  Proof.
    ...
    assert (Hc7 : creg2reg_idx (Cregidx (mword_of_int 7)) = Regidx (mword_of_int 15 : mword 5))
      by (vm_compute; reflexivity).
    iPoseProof (boi_3a with "Htext") as "Hi2c".
    ...
    iPoseProof (boi_3e with "Htext") as "Hi30".
    iPoseProof (boi_40 with "Htext") as "Hi32".
    iPoseProof (boi_42 with "Htext") as "Hi34".
    iPoseProof (boi_46 with "Htext") as "Hi38".
    iPoseProof (boi_48 with "Htext") as "Hi3a".
    iPoseProof (boi_4c with "Htext") as "Hi3e".
    iPoseProof (boi_4e with "Htext") as "Hi40".
    ...
    - (* ================= NOT COMMITTING: fall through to +0x30 ============ *)
      ...
      + (* ---- GRANT: the branch is TAKEN, control at +0x50 ---- *)
        ...
        iPoseProof (boi_6c with "Htext") as "Hi50".
        iPoseProof (boi_70 with "Htext") as "Hi54".
...
Section ProofBeginOp.
  ...
  Lemma wp_begin_op_sconf 
    ...
    : wp_begin_op_sconf_body kt γs j γl bn γ γfs cov logstart dev pidv dq m K eb b lks.
  Proof.
    ...
    iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.begin_op + 0x08)) (mword_of_int 0 : mword 6) (mword_of_int 18 : mword 5)
              R1 (K - 4)%nat vr0 eb with "Hcg Hpc Hi08 Hr0").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.begin_op + 0x10)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 1892 : mword 12) R3 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi10").
    iIntros (CID8 Hs8) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (R4 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (R3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1892 : mword 12)))]> R3).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (R3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1892 : mword 12)))]> R3) with R4.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.begin_op + 0x14)) (mword_of_int 1 : mword 5)
              (mword_of_int 2084750 : mword 21) R4 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi14").
    ...
    assert (Hjaq : add_vec (mword_of_int (KernelSyms.begin_op + 0x14) : mword 64) (sign_extend' 64 (mword_of_int 2084750 : mword 21))
                   = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iAssert (bo_exit CID j γ bn γfs cov logstart m pidv dq K eb spd sp0 lks) with "[Hcont]" as "Hexit".
    { rewrite /bo_exit.
    ...
    iAssert (bo_loop CID j γ bn γfs cov logstart m pidv dq K eb spd sp0 lks) with "[]" as "Hloop".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.begin_op + 0x1c)) (mword_of_int 9 : mword 5)
              (mword_of_int 9 : mword 5) (mword_of_int 1880 : mword 12) T1 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1c").
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    set (T2 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (T1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1880 : mword 12)))]> T1).
    change (<[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (T1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1880 : mword 12)))]> T1) with T2.

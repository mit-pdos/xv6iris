...
Lemma cni_cap_bounds (K : nat) : (8 <= K)%nat -> (2 <= K)%nat /\ (6 <= K - 2)%nat.
Proof. lia. Qed.
...
Section ConsoleinitBody.
  ...
  Hypothesis wp_uartinit :
    forall `{CID : CpuId} (γ0 γ1 : uart_names) (m : regfile) (K : nat)
  ...
  Proof using wp_initlock wp_uartinit.
    ...
    iIntros "Hcg #Htext #Hkdata Hpc #Huinv Htx #Hlb #Hsent Htok Hdlab
             ...
             Hclock Hcname Hccpu Hraw Hraw1 Hdr Hdw Hrest Hcont".
    ...
    iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x02)) (mword_of_int 1 : mword 6) (mword_of_int 1 : mword 5)
              W1 (K - 2)%nat v1 false with "Hcg Hpc [] [Hc1]").
    ...
    iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x04)) (mword_of_int 0 : mword 6) (mword_of_int 8 : mword 5)
              W1 (K - 2)%nat v2 false with "Hcg Hpc [] [Hc2]").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x0c)) (mword_of_int 11 : mword 5) (mword_of_int 11 : mword 5) (mword_of_int 3012 : mword 12)
              W3 (K - 2)%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cii_0c with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    set (W4 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (add_vec (rget W3 (mword_of_int 11 : mword 5)) (sign_extend' 64 (mword_of_int 3012 : mword 12)))]> W3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x14)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 3900 : mword 12)
              W5 (K - 2)%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cii_14 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    set (W6 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (rget W5 (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 3900 : mword 12)))]> W5).
    ...
    (* +0x18 jal initlock *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x18)) (mword_of_int 1 : mword 5) (mword_of_int 1932 : mword 21)
    ...
    assert (Htgtil : add_vec (mword_of_int (KernelSyms.consoleinit + 0x18) : mword 64) (sign_extend' 64 (mword_of_int 1932 : mword 21)) = mword_of_int KernelSyms.initlock) by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* ===== uartinit() (0x1c) ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x1c)) (mword_of_int 1 : mword 5) (mword_of_int 1174 : mword 21)
    ...
    assert (Htgtua : add_vec (mword_of_int (KernelSyms.consoleinit + 0x1c) : mword 64) (sign_extend' 64 (mword_of_int 1174 : mword 21)) = mword_of_int KernelSyms.uartinit) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x24)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 644 : mword 12)
              D1 (K - 2)%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cii_24 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    set (D2 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg (add_vec (rget D1 (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 644 : mword 12)))]> D1).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x2c)) (mword_of_int 14 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 3358 : mword 12)
              D3 (K - 2)%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cii_2c with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    set (D4 := <[Regidx (mword_of_int 14 : mword 5) := regval_into_reg (add_vec (rget D3 (mword_of_int 14 : mword 5)) (sign_extend' 64 (mword_of_int 3358 : mword 12)))]> D3).
    ...
    iApply (wp_csd_s_sconf (kt := KT0) (ktd := KT0) (mword_of_int (KernelSyms.consoleinit + 0x30)) (mword_of_int 14 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 16 : mword 12)
              D4 (K - 2)%nat dread0 false with "Hcg Hpc [] [Hdr]").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x36)) (mword_of_int 14 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 3184 : mword 12)
              D5 (K - 2)%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cii_36 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    set (D6 := <[Regidx (mword_of_int 14 : mword 5) := regval_into_reg (add_vec (rget D5 (mword_of_int 14 : mword 5)) (sign_extend' 64 (mword_of_int 3184 : mword 12)))]> D5).
    ...
    iApply (wp_csd_s_sconf (kt := KT0) (ktd := KT0) (mword_of_int (KernelSyms.consoleinit + 0x3a)) (mword_of_int 14 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 24 : mword 12)
              D6 (K - 2)%nat dwrite0 false with "Hcg Hpc [] [Hdw]").
    ...
    iApply (wp_caddi_sp_pop_s_sconf (mword_of_int (KernelSyms.consoleinit + 0x40)) (mword_of_int 16 : mword 6)
              E2 (K - 2)%nat 2 false Hpop with "Hcg Hpc [] Hframe").
    ...
    iApply ("Hcont" $! E3 with "Hcg Hpc [%] Htx Hsent Htok Hdoff Hclock Hcnm Hccpu Hfresh Htx1 Hsent1' Htok1 Hdoff1 Hfresh1 Htbl").
...
Module ConsoleinitProof (Initlock : INITLOCK) (Uartinit : UARTINIT) : CONSOLEINIT.
  Definition wp_consoleinit_sconf `{!riscvGS Σ, !xv6G Σ} `{GEN : GenId} `{CID : CpuId} `{XI : CurCtx}
    ...
    wp_consoleinit_sconf_gen
      ...
      (fun `(CID' : CpuId) γ0' γ1' m' K' l0' l1' d0' d1' k0' k1' hl0' hl1' p' =>
         Uartinit.wp_uartinit_sconf (CID:=CID') γ0' γ1' m' K' l0' l1' d0' d1'
           k0' k1' hl0' hl1' p')
      γd m K l b0 k hl γd1 l1 b1 k1 hl1 vclock vcname vccpu dread0 dwrite0 p.

(* ProofSysOpenJoin.v -- THE JOIN AT +0x4a AND ARM D-FAIL, at the ARMED
   ...
   [SysOpenDefs]'s prover list: the [lhu] + [bltu] SINGLE unsigned
...
Module SysOpenJoin (Iunlock : IUNLOCK) (Iunlockput : IUNLOCKPUT)

...
Section ProofKforkB5.
 ...
 ks pid_c).
    ...
    assert (Htgt_rel1 : add_vec (mword_of_int (KF + 0xc4) : mword 64)
                          (sign_extend' 64 (mword_of_int 2092784 : mword 21))
                        = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xc4)) Rra (mword_of_int 2092784 : mword 21)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KF + 0xcc)) Ra0 Ra0 (mword_of_int 1620 : mword 12)
              M3 (K - 8)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (kfk_0cc with "Htext"). }
    iIntros (CID3 Hs3) "Hcg Hpc".
    set (M4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (rget M3 Ra0) (sign_extend' 64 (mword_of_int 1620 : mword 12)))]> M3).
    ...
    assert (Htgt_acq1 : add_vec (mword_of_int (KF + 0xd0) : mword 64)
                          (sign_extend' 64 (mword_of_int 2092636 : mword 21))
                        = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xd0)) Rra (mword_of_int 2092636 : mword 21)
              M4 (K - 8)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KF + 0xdc)) Ra0 Ra0 (mword_of_int 1604 : mword 12)
    ...
    set (M7 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (rget M6 Ra0) (sign_extend' 64 (mword_of_int 1604 : mword 12)))]> M6).
    ...
    assert (Htgt_rel2 : add_vec (mword_of_int (KF + 0xe0) : mword 64)
                        ...
                        = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xe0)) Rra (mword_of_int 2092756 : mword 21)
    ...
    assert (Htgt_acq2 : add_vec (mword_of_int (KF + 0xe6) : mword 64)
                          (sign_extend' 64 (mword_of_int 2092614 : mword 21))
                        = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xe6)) Rra (mword_of_int 2092614 : mword 21)
              M9 (K - 8)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Htgt_rel3 : add_vec (mword_of_int (KF + 0xf2) : mword 64)
                        ...
                        = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xf2)) Rra (mword_of_int 2092738 : mword 21)

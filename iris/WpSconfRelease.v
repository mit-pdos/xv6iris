...
Section WpSconfRelease.
  ...
  Proof.
    ...
    iIntros "Hsc Hhs Hcap Htlbinv #Htext Hpc Hfile #Hlock Htoken HR Hcpu Hnoff Hint Hcnt Hcont".
    ...
    iIntros (mh) "Hhs Hsc Hcap Htlbinv Hpc Hfile %Hmh Htoken Hcpu".

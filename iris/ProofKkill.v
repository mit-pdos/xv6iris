...
Section ProofKkillMain.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.kkill + 0x14)) Rs1 Rs1 (mword_of_int 1800 : mword 12)
    ...
    set (M5 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (M4 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 1800 : mword 12)))]> M4).
    change (<[Regidx Rs1 := regval_into_reg
              (add_vec (M4 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 1800 : mword 12)))]> M4) with M5.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.kkill + 0x1c)) Rs3 Rs3 (mword_of_int 256 : mword 12)
    ...
    set (M7 := <[Regidx Rs3 := regval_into_reg
                  (add_vec (M6 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 256 : mword 12)))]> M6).
    change (<[Regidx Rs3 := regval_into_reg
              (add_vec (M6 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 256 : mword 12)))]> M6) with M7.

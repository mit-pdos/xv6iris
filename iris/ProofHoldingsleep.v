...
Section ProofHoldingsleep.
  ...
  Proof.
    ...
    (* +0x14 jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x14)) (mword_of_int 1 : mword 5) (mword_of_int 2083726 : mword 21)
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.holdingsleep + 0x14) : mword 64) (sign_extend' 64 (mword_of_int 2083726 : mword 21)) = mword_of_int KernelSyms.acquire)
    ...
    { rewrite HAs1.
      ...
      apply addv_sext0. }
    iApply (wp_clw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.holdingsleep + 0x18)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
              (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 5) ('b"00"))) A (trap_res b + (av - 6))%nat v false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [Hslk]").
    { iApply (hsl_18 with "Htext"). }
    ...
    iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x32)) (mword_of_int 1 : mword 6) (mword_of_int 19 : mword 5)
              B18 (trap_res b + (av - 6))%nat vs30 false with "Hcg Hpc [] [Hslot5pre]").
    { iApply (hsl_32 with "Htext"). }
    ...
    iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.holdingsleep + 0x34)) (mword_of_int 19 : mword 5) (mword_of_int 9 : mword 5)
              (mword_of_int 0x28 : mword 12) B18 (trap_res b + (av - 6))%nat pidv false (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [Hpidfield]").
    { iApply (hsl_34 with "Htext"). }
    ...
    (* +0x38 jal ra,myproc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x38)) (mword_of_int 1 : mword 5) (mword_of_int 2087050 : mword 21)
              B34 (trap_res b + (av - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    { iApply (hsl_38 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.holdingsleep + 0x38) : mword 64) (sign_extend' 64 (mword_of_int 2087050 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x46)) (mword_of_int 1 : mword 6) (mword_of_int 19 : mword 5)
              ...
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [Hslot_s3]").
    { iApply (hsl_46 with "Htext"). }
    ...
    (* +0x20 jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x20)) (mword_of_int 1 : mword 5) (mword_of_int 2083850 : mword 21)
              D1e (trap_res b + (av - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    { iApply (hsl_20 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.holdingsleep + 0x20) : mword 64) (sign_extend' 64 (mword_of_int 2083850 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iAssert (stack_own (KTR := KT1) sp0 6) with "[Hslot_ra Hslot_s0 Hslot_s1 Hslot_s2 Hslot_s3 S6]" as "Hframe6".

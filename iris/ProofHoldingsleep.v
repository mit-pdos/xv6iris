...
Section ProofHoldingsleep.
  ...
  Proof.
    ...
    (* +0x14 jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x14)) (mword_of_int 1 : mword 5) (mword_of_int 2083642 : mword 21)
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.holdingsleep + 0x14) : mword 64) (sign_extend' 64 (mword_of_int 2083642 : mword 21)) = mword_of_int KernelSyms.acquire)
    ...
    (* +0x38 jal ra,myproc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x38)) (mword_of_int 1 : mword 5) (mword_of_int 2086982 : mword 21)
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.holdingsleep + 0x38) : mword 64) (sign_extend' 64 (mword_of_int 2086982 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* +0x20 jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.holdingsleep + 0x20)) (mword_of_int 1 : mword 5) (mword_of_int 2083766 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.holdingsleep + 0x20) : mword 64) (sign_extend' 64 (mword_of_int 2083766 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).

(* UCodeInit.v -- the CODE CATALOG of the user program [init].
   ...
   regenerates and then FAILS if anything moved.  This file alone is
     ...
     tools/gen_ucode.py --module Init --spec tools/ucode_init.txt --out \
         iris/UCodeInit.v
   ...
   Two premises carry every [uinstr] lemma:
     ...
     [init_text_layout pt]
                       -- the pure page-table fact: each of the 1 page(s) of
                          ...
                          (UInit*.v / UkInit*.v), which is also where a predicate
...
(* [UserHeap.uinstr_is] is the SEPARATION-LOGIC instruction resource: the
   ...
   each byte of the window is a concrete [init_bytes] lookup transported by
   [init_text_sub]; and the X-and-not-W verdict for the window's addresses
...
Section UCodeInit.
  ...
  Proof using . rewrite /init_code. iIntros "#H". iExact "H". Qed.

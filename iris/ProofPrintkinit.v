...
Section CodePrintkinitBundle.
  ...
  Lemma pkni_code :
    kernel_text -∗ ilw_code KernelSyms.printkinit (mword_of_int 6) (mword_of_int 18)
                            (mword_of_int 2002) (mword_of_int 2826) (mword_of_int 724).
  Proof.
...
Section ProofPrintkinit.
  ...
  Lemma wp_printkinit_sconf
    ...
    : wp_printkinit_sconf_body kt m K vlock vname vcpu b p.
  Proof.
    ...
    iPoseProof (kernel_data_string pr_name_str "pr"%string name eq_refl ltac:(unfold text_end, pr_name_str; lia) Hpr
                  with "Hkdata") as "#Hstr".
    iApply (ILW.wp_initlock_wrapper_sconf kt m K KernelSyms.printkinit
              (mword_of_int 6) (mword_of_int 18) (mword_of_int 2002) (mword_of_int 2826)

...
Section ProofPipealloc.
  ...
  Proof.
    ...
    (* +0x2c jal ra,kalloc *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.pipealloc + 0x2c)) Rra (mword_of_int 0x1fc78a : mword 21)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.pipealloc + 0x4c)) Ra1 Ra1 (mword_of_int 0x1d8 : mword 12)
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.pipealloc + 0x50)) Rra (mword_of_int 0x1fc7c0 : mword 21)

...
Section ProofPipealloc.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.pipealloc + 0x4c)) Ra1 Ra1 (mword_of_int 0x18c : mword 12)
    ...
    set (G4 := <[Regidx Ra1 := regval_into_reg
                  (add_vec (G3 !!! Regidx Ra1) (sign_extend' 64 (mword_of_int 396 : mword 12)))]> G3).

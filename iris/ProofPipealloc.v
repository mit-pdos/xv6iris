...
Section ProofPipealloc.
  ...
  Proof.
    ...
    assert (Hpipestr : forall j b, cstring_bytes "pipe"%string !! j = Some b ->
                         KernelData.kernel_data !! (pipe_name_str + Z.of_nat j)%Z = Some b).
    { intros j b Hj.
    ...
    iApply (wp_caddi16sp_push_s_sconf γ Φ pcE (mword_of_int 61 : mword 6) m K 6
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PA + 0x02)) (mword_of_int 5 : mword 6) Rra
              R1 (K - 6)%nat u40 with "Hcg Hpc Hi02 Hr40 [-]").
    iIntros "Hcg Hpc Hr40".
    assert (Hpp04 : add_vec_int (mword_of_int (PA + 0x02) : mword 64) 2 = mword_of_int (PA + 0x04))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp04) in "Hpc".
    (* +0x04 c.sdsp s0,32(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PA + 0x04)) (mword_of_int 4 : mword 6) Rs0
              R1 (K - 6)%nat u32 with "Hcg Hpc Hi04 Hr32 [-]").
    iIntros "Hcg Hpc Hr32".
    assert (Hpp06 : add_vec_int (mword_of_int (PA + 0x04) : mword 64) 2 = mword_of_int (PA + 0x06))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp06) in "Hpc".
    (* +0x06 c.sdsp s1,24(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PA + 0x06)) (mword_of_int 3 : mword 6) Rs1
              R1 (K - 6)%nat u24 with "Hcg Hpc Hi06 Hr24 [-]").
    iIntros "Hcg Hpc Hr24".
    assert (Hpp08 : add_vec_int (mword_of_int (PA + 0x06) : mword 64) 2 = mword_of_int (PA + 0x08))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp08) in "Hpc".
    (* +0x08 c.sdsp s4,0(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PA + 0x08)) (mword_of_int 0 : mword 6) Rs4
              R1 (K - 6)%nat u0 with "Hcg Hpc Hi08 Hr0 [-]").
    iIntros "Hcg Hpc Hr0".
    assert (Hpp0a : add_vec_int (mword_of_int (PA + 0x08) : mword 64) 2 = mword_of_int (PA + 0x0a))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp0a) in "Hpc".
    (* +0x0a c.addi4spn s0,sp,48 *)
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (PA + 0x0a)) (Cregidx (mword_of_int 0))
              (mword_of_int 12 : mword 8) Rs0 R1 (K - 6)%nat
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PA + 0x0c)) Rs1 Ra0
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PA + 0x0e)) Rs4 Ra1
    ...
    iEval (rewrite -(addv_sext0 pf1) -HR4a1) in "Hc1".
    iApply (wp_sd_zero_s_sconf γ Φ (mword_of_int (PA + 0x10)) Ra1 (mword_of_int 0 : mword 12)
              R4 (K - 6)%nat v1 with "Hcg Hpc Hi10 Hc1 [-]").
    iIntros "Hcg Hpc Hc1".
    ...
    iEval (rewrite -(addv_sext0 pf0) -HR4a0) in "Hc0".
    iApply (wp_sd_zero_s_sconf γ Φ (mword_of_int (PA + 0x14)) Ra0 (mword_of_int 0 : mword 12)
              R4 (K - 6)%nat v0 with "Hcg Hpc Hi14 Hc0 [-]").
    iIntros "Hcg Hpc Hc0".
    ...
    { rewrite /EPI.
      iIntros (mj res) "(%Hjsp & %Hja0 & %Hjthr) Hcg Hpc Hcnt Hslots Hpost".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0xb8)) (mword_of_int 5 : mword 6) Rra
                mj (K - 6)%nat (R1 !!! Regidx Rra)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hib8 [Hr40] [-]").
      { iEval (rewrite Hjsp). iExact "Hr40". }
      iIntros "Hcg Hpc Hr40". iEval (rewrite Hjsp) in "Hr40".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0xba)) (mword_of_int 4 : mword 6) Rs0
                P1 (K - 6)%nat (R1 !!! Regidx Rs0)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hiba [Hr32] [-]").
      { iEval (rewrite HP1sp). iExact "Hr32". }
      iIntros "Hcg Hpc Hr32". iEval (rewrite HP1sp) in "Hr32".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0xbc)) (mword_of_int 3 : mword 6) Rs1
                P2 (K - 6)%nat (R1 !!! Regidx Rs1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hibc [Hr24] [-]").
      { iEval (rewrite HP2sp). iExact "Hr24". }
      iIntros "Hcg Hpc Hr24". iEval (rewrite HP2sp) in "Hr24".
      ...
      (* +0xbe c.ldsp s4,0(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0xbe)) (mword_of_int 0 : mword 6) Rs4
                P3 (K - 6)%nat (R1 !!! Regidx Rs4)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hibe [Hr0] [-]").
      { iEval (rewrite HP3sp). iExact "Hr0". }
      iIntros "Hcg Hpc Hr0". iEval (rewrite HP3sp) in "Hr0".
      ...
      iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (PA + 0xc0)) (mword_of_int 3 : mword 6)
                P4 (K - 6)%nat 6 Hpop with "Hcg Hpc Hic0 Hframe6 [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cret_s_sconf γ Φ (mword_of_int (PA + 0xc2)) Rra P5 K
      ...
      { assert (Hthread : forall c : mword 5, is_cs_idx c = true ->
        ...
        { rewrite /P5 upd_ne; [| vm_compute; discriminate].
          rewrite /P4 upd_eq.
          rewrite /R1 upd_ne; [reflexivity | vm_compute; discriminate]. }
        assert (Hc4 : P5 !!! Regidx Rtp = m !!! Regidx Rtp)
          by (apply Hthread; vm_compute; first [reflexivity | discriminate]).
        repeat split;
          first [ exact Hc2 | exact Hc4 | exact Hc8 | exact Hc9 | exact Hc20
    ...
    set (T8 := (∀ (Mt : regfile),
        ...
        kalloc_avail γk on -∗
        WP (Loop : expr riscv_lang) {{ Φ }})%I).
    set (T4C := (∀ (Mt : regfile) (k0 : nat) (Cf0 : fcontent),
        ⌜ Mt !!! Regidx csp_rs1 = spr
          /\ Mt !!! Regidx Rs4 = pf1
    ...
    { iSplit; [iExact "Hepi"|]. rewrite /T8.
      ...
      iApply (wp_ld_s_sconf γ Φ (mword_of_int (PA + 0xa8)) Ra5 Rs4 (mword_of_int 0 : mword 12)
                Mt (K - 6)%nat x
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hia8 Hcell1 [-]").
      iIntros "Hcg Hpc Hcell1".
      iEval (rewrite -Ha8ad) in "Hcell1".
      ...
      (* +0xac c.li a0,-1 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (PA + 0xac)) Ra0 (mword_of_int 63 : mword 6)
                (mword_of_int (-1) : mword 64) U1 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      - (* *f1 holds 0: nothing else to close, straight to the epilogue *)
        iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (PA + 0xae)) (mword_of_int 5 : mword 8)
                  ...
                  ltac:(rewrite HU2a5 Hx0; apply eq_vec_true_iff; reflexivity)
      ...
      - (* *f1 holds a live file: close it too *)
        ...
        iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PA + 0xae)) (mword_of_int 5 : mword 8)
                  (Cregidx (mword_of_int 7)) Ra5 U2 (K - 6)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HU2a5 Hxf; apply fnode_nonzero; exact Hk1)
                  with "Hcg Hpc Hiae [-]").
        iIntros "Hcg Hpc".
        ...
        (* +0xb0 c.mv a0,a5 *)
        iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PA + 0xb0)) Ra0 Ra5
                  U2 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hib0 [-]").
        iIntros "Hcg Hpc".
        ...
        iApply (wp_jal_s_sconf γ Φ (mword_of_int (PA + 0xb2)) Rra (mword_of_int 0x1ffc32 : mword 21)
                  U3 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
        ...
        assert (HU4tp : U4 !!! Regidx Rtp = cid_word).
        { rewrite (HU4thr Rtp ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                     ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
        ...
        (* +0xb6 c.li a0,-1 *)
        iApply (wp_cli_s_sconf γ Φ (mword_of_int (PA + 0xb6)) Ra0 (mword_of_int 63 : mword 6)
                  (mword_of_int (-1) : mword 64) mr (K - 6)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(apply bv_eq; vm_compute; reflexivity)
                  with "Hcg Hpc Hib6 [-]").
        iIntros "Hcg Hpc".
    ...
    { iSplit; [iDestruct "HK1" as "[$ _]"|].
      ...
      iIntros (Mt k0 Cf0) "(%Htsp & %Hts4 & %Hta0 & %Htthr) Hcg Hpc Hcnt Href0 Hslots Hcell0 Hcell1 Hav".
      (* +0xa4 jal ra,fileclose *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (PA + 0xa4)) Rra (mword_of_int 0x1ffc40 : mword 21)
                Mt (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      { rewrite (HV1thr Rtp ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                   ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                   ltac:(vm_compute; discriminate)). exact Htp. }
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PA + 0x18)) Rra (mword_of_int 0x1ffc28 : mword 21)
    ...
    { rewrite (HmAthr Rtp ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                 ltac:(vm_compute; discriminate)). exact Htp. }
    ...
    iApply (wp_csd_s_sconf γ Φ (mword_of_int (PA + 0x1c)) Ra0 Rs1 (mword_of_int 0 : mword 12)
              mB (K - 6)%nat (zero_reg : mword 64) with "Hcg Hpc Hi1c Hc0 [-]").
    iIntros "Hcg Hpc Hc0".
    iEval (rewrite -H1cad) in "Hc0".
    ...
    { (* PATH A: no file at all.  Both cells hold 0; jump to +0xa8. *)
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (PA + 0x1e)) (mword_of_int 69 : mword 8)
                ...
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hz0; apply eq_vec_true_iff; reflexivity)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi1e [-]").
      iApply bi.later_intro. iIntros "Hcg Hpc".
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PA + 0x1e)) (mword_of_int 69 : mword 8)
              (Cregidx (mword_of_int 2)) Ra0 mB (K - 6)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hk0eq; apply fnode_nonzero; exact Hk0lt)
              with "Hcg Hpc Hi1e [-]").
    iIntros "Hcg Hpc".
    ...
    (* ================================================================= *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PA + 0x20)) Rra (mword_of_int 0x1ffc20 : mword 21)
              mB (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (HmCtp : mC !!! Regidx Rtp = cid_word).
    { rewrite (HmCthr Rtp ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                 ltac:(vm_compute; discriminate)). exact Htp. }
    ...
    iApply (wp_sd_s_sconf γ Φ (mword_of_int (PA + 0x24)) Ra0 Rs4 (mword_of_int 0 : mword 12)
              mD (K - 6)%nat (zero_reg : mword 64) with "Hcg Hpc Hi24 Hc1 [-]").
    iIntros "Hcg Hpc Hc1".
    iEval (rewrite -H24ad) in "Hc1".
    ...
    { (* PATH B: only the first file was taken.  Close it: jump to +0xa0. *)
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (PA + 0x28)) (mword_of_int 60 : mword 8)
                ...
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hz1; apply eq_vec_true_iff; reflexivity)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi28 [-]").
      iApply bi.later_intro. iIntros "Hcg Hpc".
      ...
      iApply (wp_cld_s_sconf γ Φ (mword_of_int (PA + 0xa0)) Ra0 Rs1 (mword_of_int 0 : mword 12)
                mD (K - 6)%nat (fnode k0)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PA + 0xa2)) (mword_of_int 17 : mword 8)
                (Cregidx (mword_of_int 2)) Ra0 B1 (K - 6)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HB1a0; apply fnode_nonzero; exact Hk0lt)
                with "Hcg Hpc Hia2 [-]").
      iIntros "Hcg Hpc".
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PA + 0x28)) (mword_of_int 60 : mword 8)
              (Cregidx (mword_of_int 2)) Ra0 mD (K - 6)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hk1eq; apply fnode_nonzero; exact Hk1lt)
              with "Hcg Hpc Hi28 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PA + 0x2a)) (mword_of_int 2 : mword 6) Rs2
              mD (K - 6)%nat u16 with "Hcg Hpc Hi2a [Hr16] [-]").
    ...
    (* +0x2c jal ra,kalloc *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PA + 0x2c)) Rra (mword_of_int 0x1fc78a : mword 21)
              mD (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (HmEtp : mE !!! Regidx Rtp = cid_word).
    { rewrite (HmEthr Rtp ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                 ltac:(vm_compute; discriminate)). exact Htp. }
    ...
    iApply (Kalloc.wp_kalloc_sconf γ Φ γkl γk fl mE on n eb p C (K - 6)%nat
              ltac:(lia) HmEtp Hfl Hnoffpos
              with "Hcg Hcnt Htext Hpc Hkmem Hav Hpanic [-]").
    iIntros (mF) "Hcg Hcnt Hpc %HcsF Hkp".
    ...
    (* +0x30 c.mv s2,a0 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PA + 0x30)) Rs2 Ra0
              mF (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi30 [-]").
    iIntros "Hcg Hpc".
    ...
    { (* PATH C: no page.  Reload *f0, restore s2, and close both files. *)
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (PA + 0x32)) (mword_of_int 49 : mword 8)
                (Cregidx (mword_of_int 2)) Ra0 G1 (K - 6)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HG1a0 Hnull; apply eq_vec_true_iff; apply bv_eq; vm_compute; reflexivity)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi32 [-]").
      iApply bi.later_intro. iIntros "Hcg Hpc".
      ...
      iApply (wp_cld_s_sconf γ Φ (mword_of_int (PA + 0x94)) Ra0 Rs1 (mword_of_int 0 : mword 12)
                G1 (K - 6)%nat (fnode k0)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      (* +0x96 c.beqz a0 -- DEAD *)
      iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PA + 0x96)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 2)) Ra0 C1 (K - 6)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HC1a0; apply fnode_nonzero; exact Hk0lt)
                with "Hcg Hpc Hi96 [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0x98)) (mword_of_int 2 : mword 6) Rs2
                C1 (K - 6)%nat (mD !!! Regidx Rs2)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      (* +0x9a c.j +0xa4 *)
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (PA + 0x9a))
                (sign_extend' 21 (concat_vec (mword_of_int 5 : mword 11) ('b"0")))
                C2 (K - 6)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi9a [-]").
      iApply bi.later_intro. iIntros "Hcg Hpc".
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PA + 0x32)) (mword_of_int 49 : mword 8)
              (Cregidx (mword_of_int 2)) Ra0 G1 (K - 6)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite HG1a0; apply eq_vec_false_iff; intro Hc;
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PA + 0x34)) (mword_of_int 1 : mword 6) Rs3
              G1 (K - 6)%nat u8 with "Hcg Hpc Hi34 [Hr8] [-]").
    ...
    (* +0x36 c.li s3,1 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (PA + 0x36)) Rs3 (mword_of_int 1 : mword 6)
              (mword_of_int 1 : mword 64) G1 (K - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi36 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_sw_s_sconf γ Φ (mword_of_int (PA + 0x38)) Rs3 Ra0 (mword_of_int 544 : mword 12)
              G2 (K - 6)%nat vro with "Hcg Hpc Hi38 Hro [-]").
    iIntros "Hcg Hpc Hro".
    ...
    iApply (wp_sw_s_sconf γ Φ (mword_of_int (PA + 0x3c)) Rs3 Ra0 (mword_of_int 548 : mword 12)
              G2 (K - 6)%nat vwo with "Hcg Hpc Hi3c Hwo [-]").
    iIntros "Hcg Hpc Hwo".
    ...
    iApply (wp_sw_zero_s_sconf γ Φ (mword_of_int (PA + 0x40)) Ra0 (mword_of_int 540 : mword 12)
              G2 (K - 6)%nat vnw with "Hcg Hpc Hi40 Hnw [-]").
    iIntros "Hcg Hpc Hnw".
    iEval (rewrite -Hnwad) in "Hnw".
    ...
    iApply (wp_sw_zero_s_sconf γ Φ (mword_of_int (PA + 0x44)) Ra0 (mword_of_int 536 : mword 12)
              G2 (K - 6)%nat vnr with "Hcg Hpc Hi44 Hnr [-]").
    iIntros "Hcg Hpc Hnr".
    iEval (rewrite -Hnrad) in "Hnr".
    iEval (rewrite Hpp48) in "Hpc".
    (* +0x48 auipc a1,0x3 ; +0x4c addi a1,a1,472 -- a1 := "pipe" *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (PA + 0x48)) Ra1 (mword_of_int 3 : mword 20)
              G2 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi48 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PA + 0x4c)) Ra1 Ra1 (mword_of_int 0x1d8 : mword 12)
              G3 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi4c [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PA + 0x50)) Rra (mword_of_int 0x1fc7c0 : mword 21)
              G4 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (Initlock.wp_initlock_sconf γ Φ G5 vlock vname vcpu "pipe"%string (K - 6)%nat
    ...
    iIntros (mH) "Hcg Hpc %HcsH Hlkw Hlkn Hlkc".
    ...
    iDestruct (sie_cap_gpr_x0 γ mH (K - 6)%nat Rz ltac:(vm_compute; reflexivity) with "Hcg")
      as "[%HHx0 Hcg]".
    ...
    iApply (wp_cld_s_sconf γ Φ (mword_of_int (PA + 0x54)) Ra5 Rs1 (mword_of_int 0 : mword 12)
              mH (K - 6)%nat (fnode k0)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sw_s_sconf γ Φ (mword_of_int (PA + 0x56)) Rs3 Ra5 (mword_of_int 0 : mword 12)
              N1 (K - 6)%nat (fc_type Cf0) with "Hcg Hpc Hi56 Hty0 [-]").
    iIntros "Hcg Hpc Hty0".
    ...
    iApply (wp_cld_s_sconf γ Φ (mword_of_int (PA + 0x5a)) Ra5 Rs1 (mword_of_int 0 : mword 12)
              N1 (K - 6)%nat (fnode k0)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sb_s_sconf γ Φ (mword_of_int (PA + 0x5c)) Rs3 Ra5 (mword_of_int 8 : mword 12)
              N2 (K - 6)%nat _ with "Hcg Hpc Hi5c Hrd0 [-]").
    iIntros "Hcg Hpc Hrd0".
    ...
    iApply (wp_cld_s_sconf γ Φ (mword_of_int (PA + 0x60)) Ra5 Rs1 (mword_of_int 0 : mword 12)
              N2 (K - 6)%nat (fnode k0)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sb_s_sconf γ Φ (mword_of_int (PA + 0x62)) Rz Ra5 (mword_of_int 9 : mword 12)
              N3 (K - 6)%nat _ with "Hcg Hpc Hi62 Hwr0 [-]").
    iIntros "Hcg Hpc Hwr0".
    ...
    iApply (wp_cld_s_sconf γ Φ (mword_of_int (PA + 0x66)) Ra5 Rs1 (mword_of_int 0 : mword 12)
              N3 (K - 6)%nat (fnode k0)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sd_s_sconf γ Φ (mword_of_int (PA + 0x68)) Rs2 Ra5 (mword_of_int 16 : mword 12)
              N4 (K - 6)%nat (fc_pipe Cf0) with "Hcg Hpc Hi68 Hpp0 [-]").
    iIntros "Hcg Hpc Hpp0".
    ...
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (PA + 0x6c)) Ra5 Rs4 (mword_of_int 0 : mword 12)
              N4 (K - 6)%nat (fnode k1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sw_s_sconf γ Φ (mword_of_int (PA + 0x70)) Rs3 Ra5 (mword_of_int 0 : mword 12)
              N5 (K - 6)%nat (fc_type Cf1) with "Hcg Hpc Hi70 Hty1 [-]").
    iIntros "Hcg Hpc Hty1".
    ...
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (PA + 0x74)) Ra5 Rs4 (mword_of_int 0 : mword 12)
              N5 (K - 6)%nat (fnode k1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sb_s_sconf γ Φ (mword_of_int (PA + 0x78)) Rz Ra5 (mword_of_int 8 : mword 12)
              N6 (K - 6)%nat _ with "Hcg Hpc Hi78 Hrd1 [-]").
    iIntros "Hcg Hpc Hrd1".
    ...
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (PA + 0x7c)) Ra5 Rs4 (mword_of_int 0 : mword 12)
              N6 (K - 6)%nat (fnode k1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sb_s_sconf γ Φ (mword_of_int (PA + 0x80)) Rs3 Ra5 (mword_of_int 9 : mword 12)
              N7 (K - 6)%nat _ with "Hcg Hpc Hi80 Hwr1 [-]").
    iIntros "Hcg Hpc Hwr1".
    ...
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (PA + 0x84)) Ra5 Rs4 (mword_of_int 0 : mword 12)
              N7 (K - 6)%nat (fnode k1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_sd_s_sconf γ Φ (mword_of_int (PA + 0x88)) Rs2 Ra5 (mword_of_int 16 : mword 12)
              N8 (K - 6)%nat (fc_pipe Cf1) with "Hcg Hpc Hi88 Hpp1 [-]").
    iIntros "Hcg Hpc Hpp1".
    ...
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (PA + 0x8c)) Ra0 (mword_of_int 0 : mword 6)
              (zero_reg : mword 64) N8 (K - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi8c [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0x8e)) (mword_of_int 2 : mword 6) Rs2
              O1 (K - 6)%nat (mD !!! Regidx Rs2)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    (* +0x90 c.ldsp s3,8(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PA + 0x90)) (mword_of_int 1 : mword 6) Rs3
              O2 (K - 6)%nat (m !!! Regidx Rs3)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    (* +0x92 c.j +0xb8 *)
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (PA + 0x92))
              (sign_extend' 21 (concat_vec (mword_of_int 19 : mword 11) ('b"0")))
              O3 (K - 6)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi92 [-]").
    iApply bi.later_intro. iIntros "Hcg Hpc".

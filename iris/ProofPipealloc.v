...
Section ProofPipealloc.
  ...
  Proof.
    ...
    (* +0x2c jal ra,kalloc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipealloc + 0x2c)) Rra (mword_of_int 0x1fc602 : mword 21)
    ...
    assert (Htgtka : add_vec (mword_of_int (KernelSyms.pipealloc + 0x2c) : mword 64)
                       (sign_extend' 64 (mword_of_int 0x1fc602 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.pipealloc + 0x4c)) Ra1 Ra1 (mword_of_int 0x28 : mword 12)
    ...
    set (G4 := <[Regidx Ra1 := regval_into_reg
                  (add_vec (G3 !!! Regidx Ra1) (sign_extend' 64 (mword_of_int 40 : mword 12)))]> G3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipealloc + 0x50)) Rra (mword_of_int 0x1fc638 : mword 21)
    ...
    assert (Htgtil : add_vec (mword_of_int (KernelSyms.pipealloc + 0x50) : mword 64)
                       (sign_extend' 64 (mword_of_int 0x1fc638 : mword 21))

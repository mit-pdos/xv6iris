...
Section ProofPipealloc.
  ...
  Proof using .
    ...
    iMod (fpay_tok_update γf k0 pn0
            (MkFPNames γpl γp 1%positive 1%Qp 1%positive (fp_inum pn0) (fp_obox pn0) (fp_ooff pn0) OffParked)
            with "Hpn0") as "Hpn0".
    iMod (fpay_tok_update γf k1 pn1
            (MkFPNames γpl γp 1%positive 1%Qp 1%positive (fp_inum pn1) (fp_obox pn1) (fp_ooff pn1) OffParked)
            with "Hpn1") as "Hpn1".
    ...
    { iExists (MkFPNames γpl γp 1%positive 1%Qp 1%positive (fp_inum pn0) (fp_obox pn0) (fp_ooff pn0) OffParked).
    ...
    { iExists (MkFPNames γpl γp 1%positive 1%Qp 1%positive (fp_inum pn1) (fp_obox pn1) (fp_ooff pn1) OffParked).
      (* NOT [by split]: the goal is three [eq_refl]s between concrete
         mwords, but [done] ends in a no-argument [discriminate], which
         head-normalises every hypothesis type in a whole-function
         context with delta.  Name the term instead -- optimization.md's

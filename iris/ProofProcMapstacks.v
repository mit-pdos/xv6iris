...
Require Import RiscvPtsto RiscvLang RiscvExtras RiscvExec.
...
Section ProofPMS.
  ...
  Notation PM := KernelSyms.proc_mapstacks.
  ...
  (* ================================================================= *)
  Lemma wp_proc_mapstacks_epilogue_sconf (γ : gname) (γa : gname)
      (Φ : mval -> iProp Σ)
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros sp0 spr ret_tgt Hlvl HK Hsp Htp Hx25 Hx26 Hx27 Hbase Hrep Hnodes Hpasok Hmiss.
    ...
    assert (Hp88 : add_vec_int (mword_of_int (PM + 0x86) : mword 64) 2 = mword_of_int (PM + 0x88)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp88) in "Hpc".
    assert (HspE4 : E4 !!! Regidx csp_rs1 = spr) by (rewrite /E4; rewrite upd_ne; [| reg_neq]; exact HspE3).
    (* +0x88 ld s3,40(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PM + 0x88)) (mword_of_int 5 : mword 6) (mword_of_int 19 : mword 5)
              E4 (K - 10)%nat (mm !!! Regidx (mword_of_int 19 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi88 [Hc40] [-]").
    { iEval (rewrite HspE4 Hb5). iExact "Hc40". }
    iIntros "Hcg Hpc Hc40".
    ...
    assert (Hp8a : add_vec_int (mword_of_int (PM + 0x88) : mword 64) 2 = mword_of_int (PM + 0x8a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp8a) in "Hpc".
    assert (HspE5 : E5 !!! Regidx csp_rs1 = spr) by (rewrite /E5; rewrite upd_ne; [| reg_neq]; exact HspE4).
    (* +0x8a ld s4,32(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PM + 0x8a)) (mword_of_int 4 : mword 6) (mword_of_int 20 : mword 5)
              E5 (K - 10)%nat (mm !!! Regidx (mword_of_int 20 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi8a [Hc32] [-]").
    { iEval (rewrite HspE5 Hb6). iExact "Hc32". }
    iIntros "Hcg Hpc Hc32".
    ...
    assert (Hp8c : add_vec_int (mword_of_int (PM + 0x8a) : mword 64) 2 = mword_of_int (PM + 0x8c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp8c) in "Hpc".
    assert (HspE6 : E6 !!! Regidx csp_rs1 = spr) by (rewrite /E6; rewrite upd_ne; [| reg_neq]; exact HspE5).
    (* +0x8c ld s5,24(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PM + 0x8c)) (mword_of_int 3 : mword 6) (mword_of_int 21 : mword 5)
              E6 (K - 10)%nat (mm !!! Regidx (mword_of_int 21 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi8c [Hc24] [-]").
    { iEval (rewrite HspE6 Hb7). iExact "Hc24". }
    iIntros "Hcg Hpc Hc24".
    ...
    assert (Hp8e : add_vec_int (mword_of_int (PM + 0x8c) : mword 64) 2 = mword_of_int (PM + 0x8e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp8e) in "Hpc".
    assert (HspE7 : E7 !!! Regidx csp_rs1 = spr) by (rewrite /E7; rewrite upd_ne; [| reg_neq]; exact HspE6).
    (* +0x8e ld s6,16(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PM + 0x8e)) (mword_of_int 2 : mword 6) (mword_of_int 22 : mword 5)
              E7 (K - 10)%nat (mm !!! Regidx (mword_of_int 22 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi8e [Hc16] [-]").
    { iEval (rewrite HspE7 Hb8). iExact "Hc16". }
    iIntros "Hcg Hpc Hc16".
    ...
    assert (Hp90 : add_vec_int (mword_of_int (PM + 0x8e) : mword 64) 2 = mword_of_int (PM + 0x90)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp90) in "Hpc".
    assert (HspE8 : E8 !!! Regidx csp_rs1 = spr) by (rewrite /E8; rewrite upd_ne; [| reg_neq]; exact HspE7).
    (* +0x90 ld s7,8(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PM + 0x90)) (mword_of_int 1 : mword 6) (mword_of_int 23 : mword 5)
              E8 (K - 10)%nat (mm !!! Regidx (mword_of_int 23 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi90 [Hc08] [-]").
    { iEval (rewrite HspE8 Hb9). iExact "Hc08". }
    iIntros "Hcg Hpc Hc08".
    ...
    assert (Hp92 : add_vec_int (mword_of_int (PM + 0x90) : mword 64) 2 = mword_of_int (PM + 0x92)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp92) in "Hpc".
    assert (HspE9 : E9 !!! Regidx csp_rs1 = spr) by (rewrite /E9; rewrite upd_ne; [| reg_neq]; exact HspE8).
    (* +0x92 ld s8,0(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PM + 0x92)) (mword_of_int 0 : mword 6) (mword_of_int 24 : mword 5)
              E9 (K - 10)%nat (mm !!! Regidx (mword_of_int 24 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi92 [Hc00] [-]").
    { iEval (rewrite HspE9 Hb10). iExact "Hc00". }
    iIntros "Hcg Hpc Hc00".
    ...
    assert (Hp94 : add_vec_int (mword_of_int (PM + 0x92) : mword 64) 2 = mword_of_int (PM + 0x94)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (PM + 0x94)) (mword_of_int 5 : mword 6)
              E10 (K - 10)%nat 10 Hpop
    ...
    assert (Hp96 : add_vec_int (mword_of_int (PM + 0x94) : mword 64) 2 = mword_of_int (PM + 0x96)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (PM + 0x96)) (mword_of_int 1 : mword 5) E11 K
  ...
  (* ================================================================= *)
  Lemma wp_proc_mapstacks_loop_sconf (γ : gname) (γa : gname)
      (Φ : mval -> iProp Σ)
      (mm : regfile) (t : ptree)
      (m0 : gmap (mword 27) (mword 64)) (K lvl : nat)
      (eb : bool) (p : mword 64) (C : iProp Σ) (nb : nat) (rem : nat) :
    ...
    Mk !!! Regidx (mword_of_int 9 : mword 5) = mword_of_int (0x80012778 + 360 * Z.of_nat i) ->
    Mk !!! Regidx (mword_of_int 24 : mword 5) = mword_of_int 0x80012778 ->
    ...
    Mk !!! Regidx (mword_of_int 21 : mword 5) = mword_of_int 0x80018178 ->
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    induction rem as [| rem' IH]; intros i Mk tk gk pas sp0 spr ret_tgt
      Hlvl HK Hirem Hrem Hnbig Hroot Hres Hcid
      Hsp Hs1 Hs8 Hs2m Hs3 Hs5 Hs6 Hs7 Hs4 Htp Hx25 Hx26 Hx27
    ...
    (* +0x52 jal kalloc *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PM + 0x52)) (mword_of_int 1 : mword 5) (mword_of_int 2093926 : mword 21)
              Mk (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi52 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hmr0_9 : mr0 !!! Regidx (mword_of_int 9 : mword 5) = mword_of_int (0x80012778 + 360 * Z.of_nat i)).
    ...
    assert (Hmr0_24 : mr0 !!! Regidx (mword_of_int 24 : mword 5) = mword_of_int 0x80012778).
    ...
    assert (Hmr0_21 : mr0 !!! Regidx (mword_of_int 21 : mword 5) = mword_of_int 0x80018178).
    ...
    (* +0x56 mv a2,a0 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PM + 0x56)) (mword_of_int 12 : mword 5) (mword_of_int 10 : mword 5)
              mr0 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi56 [-]").
    iIntros "Hcg Hpc".
    set (W2 := <[Regidx (mword_of_int 12 : mword 5) := regval_into_reg (add_vec zero_reg (mr0 !!! Regidx (mword_of_int 10 : mword 5)))]> mr0).
    assert (Hp58 : add_vec_int (mword_of_int (PM + 0x56) : mword 64) 2 = mword_of_int (PM + 0x58)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PM + 0x58)) (mword_of_int 32 : mword 8) (Cregidx (mword_of_int 2)) (mword_of_int 10 : mword 5)
              W2 (K - 10)%nat ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite HW2a0; apply eq_vec_false_iff; intro Heq; apply Hpanz; rewrite Heq; apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi58 [-]").
    iIntros "Hcg Hpc".
    assert (Hp5a : add_vec_int (mword_of_int (PM + 0x58) : mword 64) 2 = mword_of_int (PM + 0x5a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp5a) in "Hpc".
    (* +0x5a sub a1,s1,s8 => 360*i *)
    assert (HW2s1 : W2 !!! Regidx (mword_of_int 9 : mword 5) = mword_of_int (0x80012778 + 360 * Z.of_nat i)).
    { rewrite /W2. rewrite upd_ne; [| reg_neq]. exact Hmr0_9. }
    assert (HW2s8 : W2 !!! Regidx (mword_of_int 24 : mword 5) = mword_of_int 0x80012778).
    { rewrite /W2. rewrite upd_ne; [| reg_neq]. exact Hmr0_24. }
    iApply (wp_sub_s_sconf γ Φ (mword_of_int (PM + 0x5a)) (mword_of_int 11 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 24 : mword 5)
              (mword_of_int (360 * Z.of_nat i))
              W2 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HW2s1 HW2s8;
                    ...
                    rewrite (subvec_moi (0x80012778 + 360 * Z.of_nat i) 0x80012778 ltac:(lia) ltac:(lia) ltac:(lia));
                    f_equal; lia)
              with "Hcg Hpc Hi5a [-]").
    iIntros "Hcg Hpc".
    set (W3 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (mword_of_int (360 * Z.of_nat i))]> W2).
    assert (Hp5e : add_vec_int (mword_of_int (PM + 0x5a) : mword 64) 4 = mword_of_int (PM + 0x5e)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_srai_s_sconf γ Φ (mword_of_int (PM + 0x5e)) (mword_of_int 11 : mword 5) (mword_of_int 3 : mword 6)
              W3 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi5e [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp60 : add_vec_int (mword_of_int (PM + 0x5e) : mword 64) 2 = mword_of_int (PM + 0x60)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_mul_s_sconf γ Φ (mword_of_int (PM + 0x60)) (mword_of_int 11 : mword 5) (mword_of_int 11 : mword 5) (mword_of_int 18 : mword 5)
              ...
              ltac:(rewrite HW4a1 HW4s2; exact (kstack_mul_step i Hilt))
              with "Hcg Hpc Hi60 [-]").
    iIntros "Hcg Hpc".
    set (W5 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (mword_of_int (Z.of_nat i))]> W4).
    assert (Hp64 : add_vec_int (mword_of_int (PM + 0x60) : mword 64) 4 = mword_of_int (PM + 0x64)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (PM + 0x64)) (Regidx (mword_of_int 11)) (mword_of_int 11 : mword 5) (mword_of_int 13 : mword 6)
              W5 (K - 10)%nat ltac:(reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi64 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp66 : add_vec_int (mword_of_int (PM + 0x64) : mword 64) 2 = mword_of_int (PM + 0x66)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp66) in "Hpc".
    (* +0x66 lui a5,0x2 => 8192 *)
    iApply (wp_clui_s_sconf γ Φ (mword_of_int (PM + 0x66)) (mword_of_int 15 : mword 5) (sign_extend' 20 (mword_of_int 2 : mword 6)) (mword_of_int 8192 : mword 64)
              W6 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi66 [-]").
    iIntros "Hcg Hpc".
    set (W7 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg (mword_of_int 8192 : mword 64)]> W6).
    assert (Hp68 : add_vec_int (mword_of_int (PM + 0x66) : mword 64) 2 = mword_of_int (PM + 0x68)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_addw_s_sconf γ Φ (mword_of_int (PM + 0x68)) (mword_of_int 11 : mword 5) (mword_of_int 15 : mword 5)
              W7 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi68 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp6a : add_vec_int (mword_of_int (PM + 0x68) : mword 64) 2 = mword_of_int (PM + 0x6a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp6a) in "Hpc".
    (* +0x6a mv a4,s7 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PM + 0x6a)) (mword_of_int 14 : mword 5) (mword_of_int 23 : mword 5)
              W8 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi6a [-]").
    iIntros "Hcg Hpc".
    set (W9 := <[Regidx (mword_of_int 14 : mword 5) := regval_into_reg (add_vec zero_reg (W8 !!! Regidx (mword_of_int 23 : mword 5)))]> W8).
    assert (Hp6c : add_vec_int (mword_of_int (PM + 0x6a) : mword 64) 2 = mword_of_int (PM + 0x6c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp6c) in "Hpc".
    (* +0x6c mv a3,s6 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PM + 0x6c)) (mword_of_int 13 : mword 5) (mword_of_int 22 : mword 5)
              W9 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi6c [-]").
    iIntros "Hcg Hpc".
    set (W10 := <[Regidx (mword_of_int 13 : mword 5) := regval_into_reg (add_vec zero_reg (W9 !!! Regidx (mword_of_int 22 : mword 5)))]> W9).
    assert (Hp6e : add_vec_int (mword_of_int (PM + 0x6c) : mword 64) 2 = mword_of_int (PM + 0x6e)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_sub_s_sconf γ Φ (mword_of_int (PM + 0x6e)) (mword_of_int 11 : mword 5) (mword_of_int 19 : mword 5) (mword_of_int 11 : mword 5)
              VA
              W10 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HW10s3 HW10a1; unfold VA, va_i; apply subvec_moi; [assert (0 <= 8192 * (Z.of_nat i + 1)) by (apply Z.mul_nonneg_nonneg; lia); lia | assert (8192 * (Z.of_nat i + 1) <= 8192 * 64) by (apply Z.mul_le_mono_nonneg_l; lia); lia | lia])
              with "Hcg Hpc Hi6e [-]").
    iIntros "Hcg Hpc".
    set (W11 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg VA]> W10).
    assert (Hp72 : add_vec_int (mword_of_int (PM + 0x6e) : mword 64) 4 = mword_of_int (PM + 0x72)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp72) in "Hpc".
    (* +0x72 mv a0,s4 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PM + 0x72)) (mword_of_int 10 : mword 5) (mword_of_int 20 : mword 5)
              W11 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi72 [-]").
    iIntros "Hcg Hpc".
    set (W12 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec zero_reg (W11 !!! Regidx (mword_of_int 20 : mword 5)))]> W11).
    assert (Hp74 : add_vec_int (mword_of_int (PM + 0x72) : mword 64) 2 = mword_of_int (PM + 0x74)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp74) in "Hpc".
    (* +0x74 jal kvmmap *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PM + 0x74)) (mword_of_int 1 : mword 5) (mword_of_int 2095356 : mword 21)
              W12 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi74 [-]").
    iIntros "Hcg Hpc".
    set (Wk := <[Regidx (mword_of_int 1 : mword 5) := regval_into_reg (add_vec_int (mword_of_int (PM + 0x74) : mword 64) 4)]> W12).
    assert (Htgtm : add_vec (mword_of_int (PM + 0x74) : mword 64) (sign_extend' 64 (mword_of_int 2095356 : mword 21)) = mword_of_int KernelSyms.kvmmap) by (apply bv_eq; vm_compute; reflexivity).
    ...
    { rewrite (va_i_svpn i Hilt).
      pose proof Hbud as HB. rewrite (pms_seq_peel i Hilt) in HB. cbn [sum_list_with] in HB. lia. }
    iApply (KM.wp_kvmmap_sconf γ γa Φ Wk tk (kvm_stacks pas i m0) 1 6 lvl (K - 10)%nat eb p C (Some ((nb - (i + gk + 1))%nat))
              Hlvl ltac:(lia)
              HWka0
              ...
              ltac:(rewrite HWktp; exact Hcid)
              with "[] Hcg Hcnt Htext Hpc Hptree [Henv] [-]").
    { iPureIntro. rewrite HWka1. exact Hkbud. }
    { iEval (rewrite HWktp). rewrite avail_sub_Some. iExact "Henv". }
    iIntros (mr1 t' g') "Hcg Hcnt Hpc Hptree %Hnodes' Henv %Hkcs1 %Hbase' %Hrep' %Hpres %Hg'miss".
    iEval (rewrite HWktp) in "Henv".
    ...
    (* pc back at +0x78 *)
    assert (HWk1 : Wk !!! Regidx (mword_of_int 1 : mword 5) = add_vec_int (mword_of_int (PM + 0x74) : mword 64) 4) by (rewrite /Wk upd_eq; reflexivity).
    assert (Hret78 : ret_pc (Wk !!! Regidx (mword_of_int 1 : mword 5)) = mword_of_int (PM + 0x78)).
    ...
    { rewrite (callee_saved_lookup Hkcs1 (mword_of_int 4) ltac:(vm_compute; reflexivity)). exact HWktp. }
    ...
    (* +0x78 addi s1,s1,360 *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PM + 0x78)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 360 : mword 12)
              mr1 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi78 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (HF1s1 : F1 !!! Regidx (mword_of_int 9 : mword 5) = mword_of_int (0x80012778 + 360 * Z.of_nat (S i))).
    { rewrite /F1 upd_eq. rewrite Hmr1_9.
      ...
      assert (Bi : (0 <= 0x80012778 + 360 * Z.of_nat i < 18446744073709551616)%Z).
      { split; [apply Z.add_nonneg_nonneg; [apply Z.leb_le; vm_compute; reflexivity | exact (proj1 Hii)]
               | apply (Z.le_lt_trans _ (0x80012778 + 360 * 64)); [apply Z.add_le_mono_l; exact (proj2 Hii) | apply Z.ltb_lt; vm_compute; reflexivity]]. }
    ...
    assert (HF1s5 : F1 !!! Regidx (mword_of_int 21 : mword 5) = mword_of_int 0x80018178).
    ...
    { (* LAST iteration: S i = 64, bne s1,s5 FALLS *)
      ...
      iApply (wp_bne_fall_s_sconf γ Φ (mword_of_int (PM + 0x7c)) (mword_of_int 8150 : mword 13) (mword_of_int 21 : mword 5) (mword_of_int 9 : mword 5)
                F1 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HF1s1 HF1s5; unfold neq_vec; apply negb_false_iff; apply eq_vec_true_iff; rewrite Hlast; apply bv_eq; vm_compute; reflexivity)
                with "Hcg Hpc Hi7c [-]").
      iIntros "Hcg Hpc".
      assert (Hp80 : add_vec_int (mword_of_int (PM + 0x7c) : mword 64) 4 = mword_of_int (PM + 0x80)) by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_proc_mapstacks_epilogue_sconf γ γa Φ mm F1 t t' m0 K lvl eb p C (Some nb) (gk + g')%nat pas'
                Hlvl HK
                ltac:(rewrite /F1; rewrite upd_ne; [| reg_neq]; exact Hmr1sp)
                ltac:(rewrite /F1; rewrite upd_ne; [| reg_neq]; exact Hmr1tp)
    ...
    iApply (wp_bne_taken_s_sconf γ Φ (mword_of_int (PM + 0x7c)) (mword_of_int 8150 : mword 13) (mword_of_int 21 : mword 5) (mword_of_int 9 : mword 5)
              F1 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HF1s1 HF1s5; unfold neq_vec; apply negb_true_iff; apply eq_vec_false_iff;
    ...
    (* recurse via IH at i+1 *)
    iApply (IH (S i) F1 t' (gk + g')%nat pas' Hlvl HK ltac:(lia) ltac:(lia) Hnbig Hroot Hres Hcid
              ltac:(rewrite /F1; rewrite upd_ne; [| reg_neq]; exact Hmr1sp)
              HF1s1
  ...
  Lemma wp_proc_mapstacks_sconf
      (γ : gname) (γa : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    intros ret_tgt Hlvl HK Hroot Hrep Hres Hnb Hcid.
    ...
    iApply (wp_caddi16sp_push_s_sconf γ Φ (mword_of_int PM) (mword_of_int 59 : mword 6) mm K 10 ltac:(lia) Hpush
              with "Hcg Hpc Hi00 [-]").
    ...
    assert (Hp02 : add_vec_int (mword_of_int PM : mword 64) 2 = mword_of_int (PM + 0x02)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp02) in "Hpc".
    (* +0x02 sd ra,72(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x02)) (mword_of_int 9 : mword 6) (mword_of_int 1 : mword 5)
              W1 (K - 10)%nat v72 with "Hcg Hpc Hi02 [Hc72] [-]").
    { iEval (rewrite HspW1 Hb1). iExact "Hc72". }
    iIntros "Hcg Hpc Hc72". iEval (rewrite HspW1 Hb1) in "Hc72".
    ...
    assert (Hp04 : add_vec_int (mword_of_int (PM + 0x02) : mword 64) 2 = mword_of_int (PM + 0x04)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp04) in "Hpc".
    (* +0x04 sd s0,64(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x04)) (mword_of_int 8 : mword 6) (mword_of_int 8 : mword 5)
              W1 (K - 10)%nat v64 with "Hcg Hpc Hi04 [Hc64] [-]").
    { iEval (rewrite HspW1 Hb2). iExact "Hc64". }
    iIntros "Hcg Hpc Hc64". iEval (rewrite HspW1 Hb2) in "Hc64".
    ...
    assert (Hp06 : add_vec_int (mword_of_int (PM + 0x04) : mword 64) 2 = mword_of_int (PM + 0x06)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp06) in "Hpc".
    (* +0x06 sd s1,56(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x06)) (mword_of_int 7 : mword 6) (mword_of_int 9 : mword 5)
              W1 (K - 10)%nat v56 with "Hcg Hpc Hi06 [Hc56] [-]").
    { iEval (rewrite HspW1 Hb3). iExact "Hc56". }
    iIntros "Hcg Hpc Hc56". iEval (rewrite HspW1 Hb3) in "Hc56".
    ...
    assert (Hp08 : add_vec_int (mword_of_int (PM + 0x06) : mword 64) 2 = mword_of_int (PM + 0x08)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp08) in "Hpc".
    (* +0x08 sd s2,48(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x08)) (mword_of_int 6 : mword 6) (mword_of_int 18 : mword 5)
              W1 (K - 10)%nat v48 with "Hcg Hpc Hi08 [Hc48] [-]").
    { iEval (rewrite HspW1 Hb4). iExact "Hc48". }
    iIntros "Hcg Hpc Hc48". iEval (rewrite HspW1 Hb4) in "Hc48".
    ...
    assert (Hp0a : add_vec_int (mword_of_int (PM + 0x08) : mword 64) 2 = mword_of_int (PM + 0x0a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0a) in "Hpc".
    (* +0x0a sd s3,40(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x0a)) (mword_of_int 5 : mword 6) (mword_of_int 19 : mword 5)
              W1 (K - 10)%nat v40 with "Hcg Hpc Hi0a [Hc40] [-]").
    { iEval (rewrite HspW1 Hb5). iExact "Hc40". }
    iIntros "Hcg Hpc Hc40". iEval (rewrite HspW1 Hb5) in "Hc40".
    ...
    assert (Hp0c : add_vec_int (mword_of_int (PM + 0x0a) : mword 64) 2 = mword_of_int (PM + 0x0c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0c) in "Hpc".
    (* +0x0c sd s4,32(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x0c)) (mword_of_int 4 : mword 6) (mword_of_int 20 : mword 5)
              W1 (K - 10)%nat v32 with "Hcg Hpc Hi0c [Hc32] [-]").
    { iEval (rewrite HspW1 Hb6). iExact "Hc32". }
    iIntros "Hcg Hpc Hc32". iEval (rewrite HspW1 Hb6) in "Hc32".
    ...
    assert (Hp0e : add_vec_int (mword_of_int (PM + 0x0c) : mword 64) 2 = mword_of_int (PM + 0x0e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0e) in "Hpc".
    (* +0x0e sd s5,24(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x0e)) (mword_of_int 3 : mword 6) (mword_of_int 21 : mword 5)
              W1 (K - 10)%nat v24 with "Hcg Hpc Hi0e [Hc24] [-]").
    { iEval (rewrite HspW1 Hb7). iExact "Hc24". }
    iIntros "Hcg Hpc Hc24". iEval (rewrite HspW1 Hb7) in "Hc24".
    ...
    assert (Hp10 : add_vec_int (mword_of_int (PM + 0x0e) : mword 64) 2 = mword_of_int (PM + 0x10)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp10) in "Hpc".
    (* +0x10 sd s6,16(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x10)) (mword_of_int 2 : mword 6) (mword_of_int 22 : mword 5)
              W1 (K - 10)%nat v16 with "Hcg Hpc Hi10 [Hc16] [-]").
    { iEval (rewrite HspW1 Hb8). iExact "Hc16". }
    iIntros "Hcg Hpc Hc16". iEval (rewrite HspW1 Hb8) in "Hc16".
    ...
    assert (Hp12 : add_vec_int (mword_of_int (PM + 0x10) : mword 64) 2 = mword_of_int (PM + 0x12)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp12) in "Hpc".
    (* +0x12 sd s7,8(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x12)) (mword_of_int 1 : mword 6) (mword_of_int 23 : mword 5)
              W1 (K - 10)%nat v8 with "Hcg Hpc Hi12 [Hc08] [-]").
    { iEval (rewrite HspW1 Hb9). iExact "Hc08". }
    iIntros "Hcg Hpc Hc08". iEval (rewrite HspW1 Hb9) in "Hc08".
    ...
    assert (Hp14 : add_vec_int (mword_of_int (PM + 0x12) : mword 64) 2 = mword_of_int (PM + 0x14)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp14) in "Hpc".
    (* +0x14 sd s8,0(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PM + 0x14)) (mword_of_int 0 : mword 6) (mword_of_int 24 : mword 5)
              W1 (K - 10)%nat v0 with "Hcg Hpc Hi14 [Hc00] [-]").
    { iEval (rewrite HspW1 Hb10). iExact "Hc00". }
    iIntros "Hcg Hpc Hc00". iEval (rewrite HspW1 Hb10) in "Hc00".
    ...
    assert (Hp16 : add_vec_int (mword_of_int (PM + 0x14) : mword 64) 2 = mword_of_int (PM + 0x16)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp16) in "Hpc".
    (* ---- constant materialization +0x16..+0x4e ---- *)
    (* +0x16 c.addi4spn s0,sp,80 *)
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (PM + 0x16)) (Cregidx (mword_of_int 0)) (mword_of_int 20 : mword 8) (mword_of_int 8 : mword 5)
              W1 (K - 10)%nat ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi16 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp18 : add_vec_int (mword_of_int (PM + 0x16) : mword 64) 2 = mword_of_int (PM + 0x18)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp18) in "Hpc".
    (* +0x18 mv s4,a0 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PM + 0x18)) (mword_of_int 20 : mword 5) (mword_of_int 10 : mword 5)
              P2 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi18 [-]").
    iIntros "Hcg Hpc".
    set (P3 := <[Regidx (mword_of_int 20 : mword 5) := regval_into_reg (add_vec zero_reg (P2 !!! Regidx (mword_of_int 10 : mword 5)))]> P2).
    assert (Hp1a : add_vec_int (mword_of_int (PM + 0x18) : mword 64) 2 = mword_of_int (PM + 0x1a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp1a) in "Hpc".
    (* +0x1a auipc s1,0x11 *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (PM + 0x1a)) (mword_of_int 9 : mword 5) (mword_of_int 17 : mword 20)
              P3 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi1a [-]").
    iIntros "Hcg Hpc".
    set (P4 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg (add_vec (mword_of_int (PM + 0x1a) : mword 64) (auipc_off (mword_of_int 17 : mword 20)))]> P3).
    assert (Hp1e : add_vec_int (mword_of_int (PM + 0x1a) : mword 64) 4 = mword_of_int (PM + 0x1e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp1e) in "Hpc".
    (* +0x1e addi s1,s1,-24 *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PM + 0x1e)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 4072 : mword 12)
              P4 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi1e [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp22 : add_vec_int (mword_of_int (PM + 0x1e) : mword 64) 4 = mword_of_int (PM + 0x22)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp22) in "Hpc".
    (* +0x22 mv s8,s1 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PM + 0x22)) (mword_of_int 24 : mword 5) (mword_of_int 9 : mword 5)
              P5 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi22 [-]").
    iIntros "Hcg Hpc".
    set (P6 := <[Regidx (mword_of_int 24 : mword 5) := regval_into_reg (add_vec zero_reg (P5 !!! Regidx (mword_of_int 9 : mword 5)))]> P5).
    assert (Hp24 : add_vec_int (mword_of_int (PM + 0x22) : mword 64) 2 = mword_of_int (PM + 0x24)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp24) in "Hpc".
    (* +0x24 lui a5,0xa5 *)
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (PM + 0x24)) (mword_of_int 15 : mword 5) (mword_of_int 165 : mword 20) (luival (mword_of_int 165 : mword 20))
              P6 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(reflexivity) with "Hcg Hpc Hi24 [-]").
    iIntros "Hcg Hpc".
    set (P7 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg (luival (mword_of_int 165 : mword 20))]> P6).
    assert (Hp28 : add_vec_int (mword_of_int (PM + 0x24) : mword 64) 4 = mword_of_int (PM + 0x28)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp28) in "Hpc".
    (* +0x28 addi a5,a5,-91 *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PM + 0x28)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 4005 : mword 12)
              P7 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi28 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp2c : add_vec_int (mword_of_int (PM + 0x28) : mword 64) 4 = mword_of_int (PM + 0x2c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp2c) in "Hpc".
    (* +0x2c slli a5,a5,0xc *)
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (PM + 0x2c)) (Regidx (mword_of_int 15)) (mword_of_int 15 : mword 5) (mword_of_int 12 : mword 6)
              P8 (K - 10)%nat ltac:(reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi2c [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp2e : add_vec_int (mword_of_int (PM + 0x2c) : mword 64) 2 = mword_of_int (PM + 0x2e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp2e) in "Hpc".
    (* +0x2e addi a5,a5,-91 *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PM + 0x2e)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 4005 : mword 12)
              P9 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi2e [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp32 : add_vec_int (mword_of_int (PM + 0x2e) : mword 64) 4 = mword_of_int (PM + 0x32)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp32) in "Hpc".
    (* +0x32 lui s2,0x4fa50 *)
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (PM + 0x32)) (mword_of_int 18 : mword 5) (mword_of_int 326224 : mword 20) (luival (mword_of_int 326224 : mword 20))
              P10 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(reflexivity) with "Hcg Hpc Hi32 [-]").
    iIntros "Hcg Hpc".
    set (P11 := <[Regidx (mword_of_int 18 : mword 5) := regval_into_reg (luival (mword_of_int 326224 : mword 20))]> P10).
    assert (Hp36 : add_vec_int (mword_of_int (PM + 0x32) : mword 64) 4 = mword_of_int (PM + 0x36)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp36) in "Hpc".
    (* +0x36 addi s2,s2,-1457 *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PM + 0x36)) (mword_of_int 18 : mword 5) (mword_of_int 18 : mword 5) (mword_of_int 2639 : mword 12)
              P11 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi36 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp3a : add_vec_int (mword_of_int (PM + 0x36) : mword 64) 4 = mword_of_int (PM + 0x3a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp3a) in "Hpc".
    (* +0x3a slli s2,s2,0x20 *)
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (PM + 0x3a)) (Regidx (mword_of_int 18)) (mword_of_int 18 : mword 5) (mword_of_int 32 : mword 6)
              P12 (K - 10)%nat ltac:(reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi3a [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp3c : add_vec_int (mword_of_int (PM + 0x3a) : mword 64) 2 = mword_of_int (PM + 0x3c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp3c) in "Hpc".
    (* +0x3c add s2,s2,a5 *)
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (PM + 0x3c)) (mword_of_int 18 : mword 5) (mword_of_int 15 : mword 5)
              P13 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi3c [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp3e : add_vec_int (mword_of_int (PM + 0x3c) : mword 64) 2 = mword_of_int (PM + 0x3e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp3e) in "Hpc".
    (* +0x3e lui s3,0x4000 *)
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (PM + 0x3e)) (mword_of_int 19 : mword 5) (mword_of_int 16384 : mword 20) (luival (mword_of_int 16384 : mword 20))
              P14 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(reflexivity) with "Hcg Hpc Hi3e [-]").
    iIntros "Hcg Hpc".
    set (P15 := <[Regidx (mword_of_int 19 : mword 5) := regval_into_reg (luival (mword_of_int 16384 : mword 20))]> P14).
    assert (Hp42 : add_vec_int (mword_of_int (PM + 0x3e) : mword 64) 4 = mword_of_int (PM + 0x42)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp42) in "Hpc".
    (* +0x42 addi s3,s3,-1 *)
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (PM + 0x42)) (mword_of_int 19 : mword 5) (mword_of_int 63 : mword 6)
              P15 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi42 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp44 : add_vec_int (mword_of_int (PM + 0x42) : mword 64) 2 = mword_of_int (PM + 0x44)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp44) in "Hpc".
    (* +0x44 slli s3,s3,0xc *)
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (PM + 0x44)) (Regidx (mword_of_int 19)) (mword_of_int 19 : mword 5) (mword_of_int 12 : mword 6)
              P16 (K - 10)%nat ltac:(reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi44 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp46 : add_vec_int (mword_of_int (PM + 0x44) : mword 64) 2 = mword_of_int (PM + 0x46)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp46) in "Hpc".
    (* +0x46 li s7,6 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (PM + 0x46)) (mword_of_int 23 : mword 5) (mword_of_int 6 : mword 6) (add_vec zero_reg (sign_extend' 64 (sign_extend' 12 (mword_of_int 6 : mword 6))))
              P17 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(reflexivity) with "Hcg Hpc Hi46 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp48 : add_vec_int (mword_of_int (PM + 0x46) : mword 64) 2 = mword_of_int (PM + 0x48)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp48) in "Hpc".
    (* +0x48 lui s6,0x1 *)
    iApply (wp_clui_s_sconf γ Φ (mword_of_int (PM + 0x48)) (mword_of_int 22 : mword 5) (sign_extend' 20 (mword_of_int 1 : mword 6)) (luival (sign_extend' 20 (mword_of_int 1 : mword 6)))
              P18 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(reflexivity) with "Hcg Hpc Hi48 [-]").
    iIntros "Hcg Hpc".
    set (P19 := <[Regidx (mword_of_int 22 : mword 5) := regval_into_reg (luival (sign_extend' 20 (mword_of_int 1 : mword 6)))]> P18).
    assert (Hp4a : add_vec_int (mword_of_int (PM + 0x48) : mword 64) 2 = mword_of_int (PM + 0x4a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp4a) in "Hpc".
    (* +0x4a auipc s5,0x17 *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (PM + 0x4a)) (mword_of_int 21 : mword 5) (mword_of_int 23 : mword 20)
              P19 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi4a [-]").
    iIntros "Hcg Hpc".
    set (P20 := <[Regidx (mword_of_int 21 : mword 5) := regval_into_reg (add_vec (mword_of_int (PM + 0x4a) : mword 64) (auipc_off (mword_of_int 23 : mword 20)))]> P19).
    assert (Hp4e : add_vec_int (mword_of_int (PM + 0x4a) : mword 64) 4 = mword_of_int (PM + 0x4e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp4e) in "Hpc".
    (* +0x4e addi s5,s5,-1608 *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PM + 0x4e)) (mword_of_int 21 : mword 5) (mword_of_int 21 : mword 5) (mword_of_int 2488 : mword 12)
              P20 (K - 10)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) with "Hcg Hpc Hi4e [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp52 : add_vec_int (mword_of_int (PM + 0x4e) : mword 64) 4 = mword_of_int (PM + 0x52)) by (apply bv_eq; vm_compute; reflexivity).

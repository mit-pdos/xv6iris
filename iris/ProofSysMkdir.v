(* ProofSysMkdir.v -- sys_mkdir over the SIE-agnostic sconf world.
   ...
   [ProcInv.proc_priv_bare_acc] lends and takes straight back.  create takes the
...
Section ProofSysMkdirM1Tail.
  ...
  Lemma md_m1_tail `{GEN : GenId} `{CID0 : CpuId}
      ...
      (pd pav pu : mword 64)
      (bn : bio_names) (gfs : fs_names)
      (u : nat) (pidv : mword 32) (dq : dfrac)
      (m M : regfile) (sp0 : mword 64) (K : nat) (eb : bool)
      (b : bool) (lks : gset string) (bf : nat -> bv 8) (Vpr : pprivate) :
    ...
    (forall i, (i < 16)%nat ->
       is_aligned_paddr (Physaddr (pa_stk sp0 (18 - i)%nat)) 8 = true) ->
    sie_cap_gpr KT1 M (K - 18) b (proc_addr jx) -∗
    cpu_own 0 eb (proc_addr jx) b lks -∗
    trap_csrs_ext KT1 eb -∗
    cpu_claim_ext eb (proc_addr jx) -∗
    kernel_text -∗ kernel_data -∗ pc_is (mword_of_int (MD + 0x40)) -∗
    panic_env -∗
    bio_ctx bn (fs_view gfs gd icfg_dev fsc_cov) -∗
    log_ctx icfg_log bn gfs fsc_cov fsc_logst icfg_dev -∗
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID0) (mword_of_int (MD + 0x40)) Rra
              (mword_of_int 2091596 : mword 21) M (K - 18)%nat b
    ...
    assert (Hjeo : add_vec (mword_of_int (MD + 0x40) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091596 : mword 21))
    ...
    iApply (EndOp.wp_end_op_sconf (CID := CID1) gs jx gl gu gd gk pd pav pu bn
              icfg_log gfs fsc_cov fsc_logst icfg_dev u pidv dq M1 (K - 18)%nat eb b lks
...
Section ProofSysMkdirBody.
  ...
  Lemma wp_sys_mkdir_sconf `{GEN : GenId} `{CID0 : CpuId}
    ...
    wp_sys_mkdir_sconf_body gf ga gpr gs j gl gu gd gk pd pav pu bn
                            bmapstart
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID4) (mword_of_int (MD + 0x08)) Rra
              (mword_of_int 2091512 : mword 21) M2 (K - 18)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjbo : add_vec (mword_of_int (MD + 0x08) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091512 : mword 21))
    ...
    iDestruct (cpu_own_transport CID0 CID5 0 eb pj b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (BeginOp.wp_begin_op_sconf (CID := CID5) gs j gl bn icfg_log fsc_fs fsc_cov fsc_logst
              icfg_dev pid (DfracOwn (1/4)) M3 (K - 18)%nat eb b lks
    ...
    - (* ---- the string fetched: the [bltz] FALLS THROUGH ---- *)
      ...
      iApply (wp_jal_s_sconf (CID := CID16) (mword_of_int (MD + 0x28)) Rra
                (mword_of_int 2095392 : mword 21) N3 (K - 18)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      assert (Hjcr : add_vec (mword_of_int (MD + 0x28) : mword 64)
                       (sign_extend' 64 (mword_of_int 2095392 : mword 21))
 ...
 ninodes size pk bf
      ...
      + (* ---------- create SUCCEEDED: the LOCKED inode ---------- *)
        ...
        iApply (wp_jal_s_sconf (CID := CID19) (mword_of_int (MD + 0x2e)) Rra
                  (mword_of_int 2089404 : mword 21) mcr (K - 18)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjiu : add_vec (mword_of_int (MD + 0x2e) : mword 64)
                         (sign_extend' 64 (mword_of_int 2089404 : mword 21))
 ...
 size kk qi ss gy inum dn bm un1
        ...
        iApply (wp_jal_s_sconf (CID := CID21) (mword_of_int (MD + 0x32)) Rra
                  (mword_of_int 2091610 : mword 21) miu (K - 18)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjeo : add_vec (mword_of_int (MD + 0x32) : mword 64)
                         (sign_extend' 64 (mword_of_int 2091610 : mword 21))
                       = mword_of_int KernelSyms.end_op) by pcw.
        iEval (rewrite Hjeo) in "Hpc".
        ...
        iApply (EndOp.wp_end_op_sconf (CID := CID22) gs j gl gu gd gk pd pav pu
                  bn icfg_log fsc_fs fsc_cov fsc_logst icfg_dev n2 pid (DfracOwn (1/4))
      ...
      + (* ---------- ARM B: create returned 0 ---------- *)
        ...
        iDestruct (cpu_own_transport CID18 CID19 0 eb pj b
                     ltac:(wp_next_chain) with "Hown") as "Hown".
        iApply (md_m1_tail (CID0 := CID19) gs j gl gu gd gk pd pav pu bn fsc_fs
 un1 pid (DfracOwn (1/4))
    ...
    - (* ================= ARM A: argstr returned -1 =================
      ...
      iDestruct (cpu_own_transport CID11 CID12 0 eb pj b
                   ltac:(wp_next_chain) with "Hown") as "Hown".
      iApply (md_m1_tail (CID0 := CID12) gs j gl gu gd gk pd pav pu bn fsc_fs

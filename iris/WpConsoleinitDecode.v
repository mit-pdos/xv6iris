(* WpConsoleinitDecode.v -- the instruction-DECODE layer for xv6's consoleinit().
   ...
   As in WpBinitDecode.v, the two compressed [c.sd]s are the only ASTs needing

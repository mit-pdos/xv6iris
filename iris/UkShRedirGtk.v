(* ===================================================================== *)
(* UkShRedirGtk.v -- gettoken AT THE REDIRECT TIER: a one-line instance    *)
(* (design/user-once.md SS2, worklist A2a).                                *)
(*                                                                        *)
(* [wp_kshp_gettoken_sym] is gettoken end to end at                        *)
(* [UkShParseSym.ushs_gt_ok] -- every symbol byte in the line is a '>'    *)
(* that is neither last nor doubled -- with its answer spelled            *)
(* [ushs_gettok_res] / [_end] / [_fin].  It used to be a 1400-line walk    *)
(* of its own over the '>' arm (UkShRedirTok) and a non-symbol dispatch;   *)
(* both moved into UkShGettoken.v, where the ONE gettoken walk is stated   *)
(* at the reference parser under [RefParse.ref_sym_scope], and this        *)
(* statement is kept for its consumers (UkShRedirPr, UkShRedirEx,          *)
(* UkShPipeEx2) as that walk's instance: [ushs_gt_ok] is the scope's       *)
(* right disjunct ([RefParseSym.ushs_gt_ok_scope]).                        *)
(* ===================================================================== *)
...
Section UkShRedirGtk.
  ...
  Lemma wp_kshp_gettoken_sym (h : CpuId) (m : regfile) (dq dw dv : dfrac)

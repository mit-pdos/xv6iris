...
Section WpLogicRTypeGpr.
  ...
  Proof.
    ...
    iApply (wp_instr E Φ pc false (RTYPE (Regidx rs2, Regidx rs1, Regidx rd, OR)) pmpcfg0
    ...
    assert (Hmv : gpr_or_val rs2 rs1 (set_reg σ nextPC (add_vec_int pc 4))
    ...
    { iPureIntro. rewrite Hpceq.
      rewrite (exec_execute_RTYPE_OR_gpr rs2 rs1 rd (set_reg σ nextPC (add_vec_int pc 4)) Hrd).
  ...
  Proof.
    iIntros (HN Hpmp Hrd) "Hmm Hpmpc [Hpc Hnpc] [%Hdom Hfmap] Hinstr Hcont".
    iApply (wp_instr E Φ pc false (RTYPE (Regidx rs2, Regidx rs1, Regidx rd, AND)) pmpcfg0
              HN Hpmp with "Hmm Hpmpc Hpc Hinstr").
    iIntros (σ ns κs nt Hpceq) "Hsi".
    iDestruct "Hsi" as "[Hreg Hmem]".
    assert (Hm1 : m !! Regidx rs1 = Some (m !!! Regidx rs1))
    ...
    iDestruct (gpr_pt_value rs2 (m !!! Regidx rs2)
                 (set_reg σ nextPC (add_vec_int pc 4)) with "Hreg Hr2c") as %Hrv2.
    iDestruct ("Hfb2" with "Hr2c") as "Hfmap".
    assert (Hmv : gpr_and_val rs2 rs1 (set_reg σ nextPC (add_vec_int pc 4))
    ...
    iSplitR.
    { iPureIntro. rewrite Hpceq.
      rewrite (exec_execute_RTYPE_AND_gpr rs2 rs1 rd (set_reg σ nextPC (add_vec_int pc 4)) Hrd).
      rewrite Hmv. reflexivity. }
    iSplitL "Hreg Hmem".
    { unfold set_reg; cbn [sregs mem]. iFrame "Hreg Hmem". }
    iIntros "Hmm' Hpmpc' Hpc'".
...
(* ====================================================================== *)
(* Demonstration: each ONE lemma serves many register (triples/pairs).     *)
(* ====================================================================== *)
Section WpLogicGprDemo.
  ...
  Definition wp_or_x5_x6_x7 (E : coPset) (Φ : mval -> iProp Σ) (pc : mword 64) :=
    wp_or_gpr E Φ pc (mword_of_int 7) (mword_of_int 6) (mword_of_int 5).
  (* `and x28, x1, x2` : SAME lemma, different regs. *)
  Definition wp_and_x28_x1_x2 (E : coPset) (Φ : mval -> iProp Σ) (pc : mword 64) :=
    wp_and_gpr E Φ pc (mword_of_int 2) (mword_of_int 1) (mword_of_int 28).
  (* `xor x5, x6, x6` : rs1 = rs2 = x6.  SAME lemma. *)
  Definition wp_xor_x5_x6_x6 (E : coPset) (Φ : mval -> iProp Σ) (pc : mword 64) :=
    wp_xor_gpr E Φ pc (mword_of_int 6) (mword_of_int 6) (mword_of_int 5).
  (* `ori x5, x6, imm`, `andi x5, x6, imm`, `xori x28, x1, imm`. *)
  Definition wp_ori_x5_x6 (E : coPset) (Φ : mval -> iProp Σ) (pc : mword 64) (imm : mword 12) :=
    wp_ori_gpr E Φ pc (mword_of_int 6) (mword_of_int 5) imm.
  Definition wp_andi_x5_x6 (E : coPset) (Φ : mval -> iProp Σ) (pc : mword 64) (imm : mword 12) :=
    wp_andi_gpr E Φ pc (mword_of_int 6) (mword_of_int 5) imm.
  Definition wp_xori_x28_x1 (E : coPset) (Φ : mval -> iProp Σ) (pc : mword 64) (imm : mword 12) :=
    wp_xori_gpr E Φ pc (mword_of_int 1) (mword_of_int 28) imm.

...
Section CodeTrapinit.
  ...
  Lemma tri_0c : kernel_text -∗ instr (mword_of_int (KernelSyms.trapinit + 0xc) : mword 64) false (ITYPE (mword_of_int 3658 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)).
  Proof. mk_base (KernelSyms.trapinit + 0xc) (mword_of_int 0xe4a58593 : mword 32)
    (mword_of_int (KernelSyms.trapinit + 0xc) : mword 64) (ITYPE (mword_of_int 3658 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)) kd_e4a58593. Qed.

...
Section CodeTrapinit.
  ...
  Lemma tri_0c : kernel_text -∗ instr (mword_of_int (KernelSyms.trapinit + 0xc) : mword 64) false (ITYPE (mword_of_int 3424 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)).
  Proof. mk_base (KernelSyms.trapinit + 0xc) (mword_of_int 0xd6058593 : mword 32)
    (mword_of_int (KernelSyms.trapinit + 0xc) : mword 64) (ITYPE (mword_of_int 3424 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)) kd_d6058593. Qed.
  ...
  Lemma tri_14 : kernel_text -∗ instr (mword_of_int (KernelSyms.trapinit + 0x14) : mword 64) false (ITYPE (mword_of_int 3400 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.trapinit + 0x14) (mword_of_int 0xd4850513 : mword 32)
    (mword_of_int (KernelSyms.trapinit + 0x14) : mword 64) (ITYPE (mword_of_int 3400 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_d4850513. Qed.

  Lemma tri_18 : kernel_text -∗ instr (mword_of_int (KernelSyms.trapinit + 0x18) : mword 64) false (JAL (mword_of_int 2090680 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.trapinit + 0x18) (mword_of_int 0xeb8fe0ef : mword 32)
    (mword_of_int (KernelSyms.trapinit + 0x18) : mword 64) (JAL (mword_of_int 2090680 : mword 21, Regidx (mword_of_int 1))) kd_eb8fe0ef. Qed.

...
Section CodeTrapinit.
  ...
  Lemma tri_0c : kernel_text -∗ instr (mword_of_int (KernelSyms.trapinit + 0xc) : mword 64) false (ITYPE (mword_of_int 3624 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)).
  Proof. mk_base (KernelSyms.trapinit + 0xc) (mword_of_int 0xe2858593 : mword 32)
    (mword_of_int (KernelSyms.trapinit + 0xc) : mword 64) (ITYPE (mword_of_int 3624 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)) kd_e2858593. Qed.
  ...
  Lemma tri_14 : kernel_text -∗ instr (mword_of_int (KernelSyms.trapinit + 0x14) : mword 64) false (ITYPE (mword_of_int 3520 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.trapinit + 0x14) (mword_of_int 0xdc050513 : mword 32)
    (mword_of_int (KernelSyms.trapinit + 0x14) : mword 64) (ITYPE (mword_of_int 3520 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_dc050513. Qed.

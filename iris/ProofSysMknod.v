...
Section ProofSysMknodM1Tail.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID0) (mword_of_int (MN + 0x58)) Rra
              (mword_of_int 2091528 : mword 21) M (K - 20)%nat b
...
Section ProofSysMknodBody.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID4) (mword_of_int (MN + 0x08)) Rra
              (mword_of_int 2091468 : mword 21) M2 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi08").
    ...
    assert (Hjbo : add_vec (mword_of_int (MN + 0x08) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091468 : mword 21))
    ...
    iDestruct (cpu_own_transport CID0 CID5 0 eb pj C b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (BeginOp.wp_begin_op_sconf (CID := CID5) gs j gl bn g gfs cov logstart
              dev pid (DfracOwn (1/4)) M3 (K - 20)%nat eb C b lks
    ...
    iApply (wp_jal_s_sconf (CID := CID8) (mword_of_int (MN + 0x12)) Rra
              (mword_of_int 2086342 : mword 21) M5 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi12").
    ...
    assert (Hjai1 : add_vec (mword_of_int (MN + 0x12) : mword 64)
                      (sign_extend' 64 (mword_of_int 2086342 : mword 21))
    ...
    iApply (wp_jal_s_sconf (CID := CID12) (mword_of_int (MN + 0x1c)) Rra
              (mword_of_int 2086332 : mword 21) M8 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi1c").
    ...
    assert (Hjai2 : add_vec (mword_of_int (MN + 0x1c) : mword 64)
                      (sign_extend' 64 (mword_of_int 2086332 : mword 21))
                    = mword_of_int KernelSyms.argint) by pcw.
    ...
    iDestruct (cpu_own_transport CID10 CID13 0 eb pj C b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    ...
    iApply (wp_jal_s_sconf (CID := CID17) (mword_of_int (MN + 0x2a)) Rra
              (mword_of_int 2086374 : mword 21) M12 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi2a").
    ...
    assert (Hjas : add_vec (mword_of_int (MN + 0x2a) : mword 64)
                     (sign_extend' 64 (mword_of_int 2086374 : mword 21))
    ...
    iDestruct (cpu_own_transport CID14 CID18 0 eb pj C b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Argstr.wp_argstr_sconf (CID := CID18) ga gf M13 (K - 20)%nat 0%nat eb pj C
    ...
    - (* ---- the string fetched: the [bltz] FALLS THROUGH ---- *)
      ...
      iApply (wp_jal_s_sconf (CID := CID24) (mword_of_int (MN + 0x40)) Rra
                (mword_of_int 2095310 : mword 21) N3 (K - 20)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi40").
      ...
      assert (Hjcr : add_vec (mword_of_int (MN + 0x40) : mword 64)
                       (sign_extend' 64 (mword_of_int 2095310 : mword 21))
      ...
      iDestruct (cpu_own_transport CID19 CID25 0 eb pj C b
                   ltac:(wp_next_chain) with "Hown") as "Hown".
      ...
      + (* ---------- create SUCCEEDED: the LOCKED inode ---------- *)
        ...
        iApply (wp_jal_s_sconf (CID := CID27) (mword_of_int (MN + 0x46)) Rra
                  (mword_of_int 2089336 : mword 21) mcr (K - 20)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi46").
        ...
        iDestruct (proc_priv_pid gf pj pid (upd_upt V P') with "Hpriv")
          as "[Hpidq Hpback]".
        iDestruct (cpu_own_transport CID26 CID28 0 eb pj C b
                     ltac:(wp_next_chain) with "Hown") as "Hown".
        iApply (Iunlockput.wp_iunlockput_sconf (CID := CID28) gs j gl gu gd gk
                  ...
                  pid (DfracOwn (1/4)) dqb dqs P0 (K - 20)%nat eb C b lks
        ...
        iApply (wp_jal_s_sconf (CID := CID29) (mword_of_int (MN + 0x4a)) Rra
                  (mword_of_int 2091542 : mword 21) miu (K - 20)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi4a").
        ...
        iDestruct (cpu_own_transport CID31 CID32 0 eb pj C b
                     ltac:(wp_next_chain) with "Hown") as "Hown".
        ...
        iDestruct (cpu_own_transport CID32 CIDz 0 eb pj C b
                     ltac:(wp_next_chain) with "Hown") as "Hown".

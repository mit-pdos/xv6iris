...
Section IallocMain.
  ...
  Proof.
    ...
    (* ===== +0x0c lw a4,2106(a4) : a4 := sb.ninodes ===== *)
    assert (Hnadr : add_vec (rget R3 Ra4)
                      (sign_extend' 64 (mword_of_int 2106 : mword 12))
                    = sb_ninodes).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.ialloc + 0xc)) Ra4 Ra4
              (mword_of_int 2106 : mword 12) R3 (K - 8)%nat
              (mword_of_int ninodes : mword 32) b

  ...
  Definition acq_frame (m : gmap regidx (mword 64))
    ...
    (hart_state ↦ᵣ HART_ACTIVE tt ∗
     ...
     (∃ w1 w2 w3 w4 w5 w6 w7 w8 w9 w10 w11 w12 w13 w14 w15 w16 w17 : bv 64,
        ...
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 6 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w5 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 9 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w6 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 10 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w7 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 11 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w8 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 12 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w9 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 13 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w10 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 14 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w11 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 15 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w12 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 16 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w13 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 27 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w14 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 28 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w15 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 29 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w16 j) ∗
        ([∗ list] j ∈ seq 0 8, (pa_add (add_vec_int ((add_vec (kv_sp1 m) (zero_extend' 64 (concat_vec (mword_of_int 30 : mword 6) ('b"000"))))) (0 * 8)) j) ↦ₘ nth_byte w17 j)))%I.

(* ProofVirtioDiskRwF.v -- virtio_disk_rw, phase P6 (+0x1b0 .. +0x212), the
   whole-function composition, and the sealed functor.

     0x1b0 lw   s2,-96(s0)      s2 = idx[0] = the chain head
     0x1b4 slli a4,s2,4 ; 0x1b8 addi a4,a4,32
     0x1bc auipc/addi a5,&disk ; 0x1c4 c.add a5,a4
     0x1c6 sd   x0,8(a5)        disk.info[head].b = 0
     0x1ca auipc/addi s3,&disk  -- s3 (which held b) is CLOBBERED here
     -- free_chain, three iterations, head at +0x1d2 --
     0x1d2 slli a4,s2,4 ; 0x1d6 ld a5,0(s3) ; 0x1da c.add a5,a4
     0x1dc lhu  s1,12(a5)       s1 = desc[i].flags
     0x1e0 c.mv a0,s2 ; 0x1e2 lhu s2,14(a5)
     0x1e6 jal  free_desc
     0x1ea c.andi s1,s1,1 ; 0x1ec c.bnez s1,-26
     0x1ee auipc/addi a0,&disk.vdisk_lock ; 0x1f6 jal release
     0x1fa..0x20c c.ldsp ra,s0..s8 ; 0x20e c.addi16sp sp,96 ; 0x210 c.jr ra
...
Lemma vdrwf_disk_val :
  bv_unsigned (disk_base : SailStdpp.Values.mword 64) = 2147628056%Z.
Proof. vm_compute. reflexivity. Qed.

Lemma vdrwf_rem_disk (k d : Z) :
  0 <= k -> k < 4096 -> 0 < d -> 8 mod d = 0 -> k mod d = 0 ->
  Z.rem ((2147628056 + k) mod 18446744073709551616) d = 0.
Proof.
  intros H0 H1 Hd Hd8 Hkd.
  rewrite (Z.mod_small (2147628056 + k) 18446744073709551616); [| lia].
  ...
  apply (Z.divide_trans d 8 2147628056 Hd8). exists 268453507%Z. reflexivity.
Qed.
...
Lemma vdrwf_a5disk :
  add_vec (add_vec (mword_of_int (VRW + 0x1bc) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 2828 : mword 12))
  = (disk_base : SailStdpp.Values.mword 64).
Proof. unfold disk_base. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma vdrwf_s3disk :
  add_vec (add_vec (mword_of_int (VRW + 0x1ca) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 2814 : mword 12))
  = (disk_base : SailStdpp.Values.mword 64).
Proof. unfold disk_base. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma vdrwf_a0lock :
  add_vec (add_vec (mword_of_int (VRW + 0x1ee) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 3074 : mword 12))
  = (d_lock : SailStdpp.Values.mword 64).
Proof. unfold d_lock, disk_base. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma vdrwf_jfree :
  add_vec (mword_of_int (VRW + 0x1e6) : mword 64)
          (sign_extend' 64 (mword_of_int 2096092 : mword 21))
  = (mword_of_int KernelSyms.free_desc : mword 64).
Proof. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma vdrwf_jrel :
  add_vec (mword_of_int (VRW + 0x1f6) : mword 64)
          (sign_extend' 64 (mword_of_int 2077514 : mword 21))
...
(* [info[i].b], as +0x1b4..+0x1c6 computes it *)
...
Module VirtioDiskRwProof (Acquire : ACQUIRE) (Release : RELEASE)
                         (Sleep : SLEEP) (FreeDesc : FREEDESC) : VIRTIODISKRW.

Module P5 := VirtioDiskRwRestE Acquire Release Sleep FreeDesc.
Module P4 := P5.P4.
Module P3 := P5.P4.P3.
...
Section ProofVirtioDiskRwF.
  ...
  Lemma wp_vdrwf_iter (γ : gname) (Φ : mval -> iProp Σ) (γs : list gname)
    ...
    kernel_text -∗ pc_is (mword_of_int (VRW + 0x1d2) : mword 64) -∗
    ...
    ( ∀ Mf : regfile,
        ...
        sie_cap_gpr γ Mf av -∗
        cpu_own γ 1 eb pme C -∗
        pc_is (mword_of_int (VRW + 0x1ea) : mword 64) -∗
        free_bundles pd (fr_upd fr i true) -∗
        WP (Loop : expr riscv_lang) {{ Φ }}) -∗
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros Hav Hi8 Hfri Hlen Htp Hs2 Hs3.
    iIntros "Hcg Hown #Htext Hpc #Hpanic #Hpinv #Hdp Hd0 Hd8 Hd12 Hd14 Hbun Hrest Hcont".
    iPoseProof (rwi_1d2 with "Htext") as "Hi1d2".
    iPoseProof (rwi_1d6 with "Htext") as "Hi1d6".
    iPoseProof (rwi_1da with "Htext") as "Hi1da".
    iPoseProof (rwi_1dc with "Htext") as "Hi1dc".
    iPoseProof (rwi_1e0 with "Htext") as "Hi1e0".
    iPoseProof (rwi_1e2 with "Htext") as "Hi1e2".
    iPoseProof (rwi_1e6 with "Htext") as "Hi1e6".
    (* ---- +0x1d2  slli a4,s2,4 ---- *)
    iApply (wp_slli_s_sconf γ Φ (mword_of_int (VRW + 0x1d2) : mword 64) Ra4 Rs2
              (mword_of_int 4 : mword 6)
              (mword_of_int (16 * Z.of_nat i) : SailStdpp.Values.mword 64) M av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs2; exact (vdrwc_slli4' i Hi8))
              with "Hcg Hpc Hi1d2 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp1d6 : add_vec_int (mword_of_int (VRW + 0x1d2) : mword 64) 4
                    = mword_of_int (VRW + 0x1d6)) by pcstep.
    ...
    (* ---- +0x1d6  ld a5,0(s3) : a5 = disk.desc ---- *)
    assert (Hdptr : add_vec (N1 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 0 : mword 12))
                    = (d_desc_ptr : SailStdpp.Values.mword 64))
      by (rewrite HN1s3; apply vdrwf_dptr_addr).
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (VRW + 0x1d6) : mword 64) Ra5 Rs3
              (mword_of_int 0 : mword 12) N1 av pd (dqm := DfracDiscarded)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1d6 [] [-]").
    { iEval (rewrite Hdptr). iExact "Hdp". }
    iIntros "Hcg Hpc _".
    set (N2 := <[Regidx Ra5 := regval_into_reg pd]> N1).
    change (<[Regidx Ra5 := regval_into_reg pd]> N1) with N2.
    assert (Hp1da : add_vec_int (mword_of_int (VRW + 0x1d6) : mword 64) 4
                    = mword_of_int (VRW + 0x1da)) by pcstep.
    ...
    (* ---- +0x1da  c.add a5,a4 : a5 = &desc[i] ---- *)
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (VRW + 0x1da) : mword 64) Ra5 Ra4 N2 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1da [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp1dc : add_vec_int (mword_of_int (VRW + 0x1da) : mword 64) 2
                    = mword_of_int (VRW + 0x1dc)) by pcstep.
    iEval (rewrite Hp1dc) in "Hpc".
    (* ---- +0x1dc  lhu s1,12(a5) : the flags ---- *)
    ...
    iApply (wp_lhu_s_sconf γ Φ (mword_of_int (VRW + 0x1dc) : mword 64) Rs1 Ra5
              (mword_of_int 12 : mword 12) N3 av vf (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1dc [Hd12] [-]").
    { iEval (rewrite Hfaddr). iExact "Hd12". }
    iIntros "Hcg Hpc Hd12".
    ...
    assert (Hp1e0 : add_vec_int (mword_of_int (VRW + 0x1dc) : mword 64) 4
                    = mword_of_int (VRW + 0x1e0)) by pcstep.
    ...
    (* ---- +0x1e0  c.mv a0,s2 : the argument ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VRW + 0x1e0) : mword 64) Ra0 Rs2 N4 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1e0 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp1e2 : add_vec_int (mword_of_int (VRW + 0x1e0) : mword 64) 2
                    = mword_of_int (VRW + 0x1e2)) by pcstep.
    ...
    (* ---- +0x1e2  lhu s2,14(a5) : the next index ---- *)
    ...
    iApply (wp_lhu_s_sconf γ Φ (mword_of_int (VRW + 0x1e2) : mword 64) Rs2 Ra5
              (mword_of_int 14 : mword 12) N5 av vn (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1e2 [Hd14] [-]").
    { iEval (rewrite Hnaddr). iExact "Hd14". }
    iIntros "Hcg Hpc Hd14".
    ...
    assert (Hp1e6 : add_vec_int (mword_of_int (VRW + 0x1e2) : mword 64) 4
                    = mword_of_int (VRW + 0x1e6)) by pcstep.
    iEval (rewrite Hp1e6) in "Hpc".
    (* ---- +0x1e6  jal ra,free_desc ---- *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (VRW + 0x1e6) : mword 64) Rra
              (mword_of_int 2096092 : mword 21) N6 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi1e6 [-]").
    iIntros "Hcg Hpc".
    set (N7 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (VRW + 0x1e6) : mword 64) 4)]> N6).
    change (<[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (VRW + 0x1e6) : mword 64) 4)]> N6) with N7.
    ...
    iApply (FreeDesc.wp_free_desc_sconf γ Φ γs pd i N7 av 1%nat eb pme C va vl vf vn
              Hav Hi8 HN7a0 ltac:(intro r; apply rf_to_gmap_dom) Hlen HN7tp vdrwb_lvl1
    ...
    assert (Hret : ret_pc (N7 !!! Regidx Rra) = mword_of_int (VRW + 0x1ea))
  ...
  (* ------------------------------------------------------------------- *)
  (* P6 (+0x1b0 .. +0x212), packaged as the wand P5 consumes.              *)
  (* ------------------------------------------------------------------- *)
  Lemma wp_vdrw_p6_seam (γ γk : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iDestruct "Hpayoff" as (bs)
      "(%Hlink & %Hbslen & %Hbsdata & Hbdisk & Hinfob & Hpinm & Hstat & Hdbytes & Hbufp)".
    assert (Hdcb : dc_buf (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin) = b) by reflexivity.
    assert (Hdcs : dc_slot (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin) = (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk))) by reflexivity.
    assert (Hvsts : vr_status (vs_req (dc_slot (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin))) = d_info_status h)
      by reflexivity.
    assert (Hvsout : vs_is_out (dc_slot (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin)) = vdrwd_out wr) by reflexivity.
    assert (Hvsbuf : vr_buf (vs_req (dc_slot (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin))) = b_data b) by reflexivity.
    assert (Hslen : vs_len (dc_slot (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin)) = 1024%nat) by exact vdrwd_len1024.
    assert (Hsloff : vs_sector_off (dc_slot (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin)) = (1024 * uint bno)%Z).
    { transitivity (bv_unsigned sector * 512)%Z; [| exact Hsec].
      exact (vdrwd_slot_off b h wr sector (vdrwd_sldata wr bs_buf bs_disk)
    ...
    iEval (rewrite (vdrwd_slot_head b h wr sector
    ...
    assert (Hpinreq : dc_pinr pav q (DClaim b (vdrwd_slot b h wr sector (vdrwd_sldata wr bs_buf bs_disk)) (h, m2, t) pin)
    ...
    iPoseProof (rwi_1b8 with "Htext") as "Hi1b8".
    ...
    iPoseProof (rwi_1ca with "Htext") as "Hi1ca".
    iPoseProof (rwi_1ce with "Htext") as "Hi1ce".
    ...
    iApply (wp_lw_s_sconf γ Φ (mword_of_int (VRW + 0x1b0) : mword 64) Rs2 Rs0
              (mword_of_int 4000 : mword 12) M (K - 12)%nat
              (mword_of_int (Z.of_nat h) : SailStdpp.Values.mword 32) (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1b0 [Hx0] [-]").
    { iEval (rewrite Hidxa). iExact "Hx0". }
    iIntros "Hcg Hpc Hx0".
    ...
    assert (Hp1b4 : add_vec_int (mword_of_int (VRW + 0x1b0) : mword 64) 4
                    = mword_of_int (VRW + 0x1b4)) by pcstep.
    iEval (rewrite Hp1b4) in "Hpc".
    iApply (wp_slli_s_sconf γ Φ (mword_of_int (VRW + 0x1b4) : mword 64) Ra4 Rs2
              (mword_of_int 4 : mword 6)
              (mword_of_int (16 * Z.of_nat h) : SailStdpp.Values.mword 64) E1 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HE1s2; exact (vdrwc_slli4' h Hh8))
              with "Hcg Hpc Hi1b4 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp1b8 : add_vec_int (mword_of_int (VRW + 0x1b4) : mword 64) 4
                    = mword_of_int (VRW + 0x1b8)) by pcstep.
    iEval (rewrite Hp1b8) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x1b8) : mword 64) Ra4 Ra4
              (mword_of_int 32 : mword 12) E2 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1b8 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp1bc : add_vec_int (mword_of_int (VRW + 0x1b8) : mword 64) 4
                    = mword_of_int (VRW + 0x1bc)) by pcstep.
    iEval (rewrite Hp1bc) in "Hpc".
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (VRW + 0x1bc) : mword 64) Ra5
              (mword_of_int 30 : mword 20) E3 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1bc [-]").
    iIntros "Hcg Hpc".
    set (E4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x1bc) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> E3).
    change (<[Regidx Ra5 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x1bc) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> E3) with E4.
    assert (Hp1c0 : add_vec_int (mword_of_int (VRW + 0x1bc) : mword 64) 4
                    = mword_of_int (VRW + 0x1c0)) by pcstep.
    iEval (rewrite Hp1c0) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x1c0) : mword 64) Ra5 Ra5
              (mword_of_int 2828 : mword 12) E4 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1c0 [-]").
    iIntros "Hcg Hpc".
    set (E5 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (E4 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2828 : mword 12)))]> E4).
    change (<[Regidx Ra5 := regval_into_reg
                  (add_vec (E4 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2828 : mword 12)))]> E4) with E5.
    ...
    assert (Hp1c4 : add_vec_int (mword_of_int (VRW + 0x1c0) : mword 64) 4
                    = mword_of_int (VRW + 0x1c4)) by pcstep.
    iEval (rewrite Hp1c4) in "Hpc".
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (VRW + 0x1c4) : mword 64) Ra5 Ra4 E5
              (K - 12)%nat ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hi1c4 [-]").
    iIntros "Hcg Hpc".
    set (E6 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (E5 !!! Regidx Ra5) (E5 !!! Regidx Ra4))]> E5).
    change (<[Regidx Ra5 := regval_into_reg
                  (add_vec (E5 !!! Regidx Ra5) (E5 !!! Regidx Ra4))]> E5) with E6.
    assert (Hp1c6 : add_vec_int (mword_of_int (VRW + 0x1c4) : mword 64) 2
                    = mword_of_int (VRW + 0x1c6)) by pcstep.
    ...
    iApply (wp_sd_zero_s_sconf γ Φ (mword_of_int (VRW + 0x1c6) : mword 64) Ra5
              (mword_of_int 8 : mword 12) E6 (K - 12)%nat
              (b : SailStdpp.Values.mword 64)
              with "Hcg Hpc Hi1c6 [Hinfob] [-]").
    { iEval (rewrite Hiba). iExact "Hinfob". }
    iIntros "Hcg Hpc Hinfob".
    iEval (rewrite Hiba) in "Hinfob".
    assert (Hp1ca : add_vec_int (mword_of_int (VRW + 0x1c6) : mword 64) 4
                    = mword_of_int (VRW + 0x1ca)) by pcstep.
    iEval (rewrite Hp1ca) in "Hpc".
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (VRW + 0x1ca) : mword 64) Rs3
              (mword_of_int 30 : mword 20) E6 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1ca [-]").
    iIntros "Hcg Hpc".
    set (E7 := <[Regidx Rs3 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x1ca) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> E6).
    change (<[Regidx Rs3 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x1ca) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> E6) with E7.
    assert (Hp1ce : add_vec_int (mword_of_int (VRW + 0x1ca) : mword 64) 4
                    = mword_of_int (VRW + 0x1ce)) by pcstep.
    iEval (rewrite Hp1ce) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x1ce) : mword 64) Rs3 Rs3
              (mword_of_int 2814 : mword 12) E7 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1ce [-]").
    iIntros "Hcg Hpc".
    set (E8 := <[Regidx Rs3 := regval_into_reg
                  (add_vec (E7 !!! Regidx Rs3)
                     (sign_extend' 64 (mword_of_int 2814 : mword 12)))]> E7).
    change (<[Regidx Rs3 := regval_into_reg
                  (add_vec (E7 !!! Regidx Rs3)
                     (sign_extend' 64 (mword_of_int 2814 : mword 12)))]> E7) with E8.
    ...
    assert (HE8tp : E8 !!! Regidx Rtp = cid_word).
    { rewrite /E8 upd_ne; [| reg_neq]. rewrite /E7 upd_ne; [| reg_neq].
      rewrite /E6 upd_ne; [| reg_neq]. rewrite /E5 upd_ne; [| reg_neq].
      rewrite /E4 upd_ne; [| reg_neq]. rewrite /E3 upd_ne; [| reg_neq].
      rewrite /E2 upd_ne; [| reg_neq]. rewrite /E1 upd_ne; [| reg_neq]. exact Htp. }
    ...
    assert (Hp1d2 : add_vec_int (mword_of_int (VRW + 0x1ce) : mword 64) 4
                    = mword_of_int (VRW + 0x1d2)) by pcstep.
    ...
    iPoseProof (rwi_1ea with "Htext") as "Hi1ea".
    iPoseProof (rwi_1ec with "Htext") as "Hi1ec".
    assert (Hbrk : add_vec (mword_of_int (VRW + 0x1ec) : mword 64)
                     (sign_extend' 64 (sign_extend' 13
                        (concat_vec (mword_of_int 243 : mword 8) ('b"0"))))
                   = mword_of_int (VRW + 0x1d2)) by pcstep.
    assert (Hp1ec1 : add_vec_int (mword_of_int (VRW + 0x1ea) : mword 64) 2
                     = mword_of_int (VRW + 0x1ec)) by pcstep.
    iApply (wp_vdrwf_iter γ Φ γs pd h fr (d_ops h : SailStdpp.Values.mword 64)
              (Z_to_bv 32 16) (Z_to_bv 16 1) (Z_to_bv 16 (Z.of_nat m2))
              E8 (K - 12)%nat eb (proc_addr j) C
              (vdrwb_K20 K HK) Hh8 Hfrh Hglen HE8tp HE8s2 HE8s3
    ...
    iApply (wp_candi_s_sconf γ Φ (mword_of_int (VRW + 0x1ea) : mword 64) Rs1
              (mword_of_int 1 : mword 6) F1 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1ea [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (VRW + 0x1ec) : mword 64)
              (mword_of_int 243 : mword 8) (Cregidx (mword_of_int 1)) Rs1 G1 (K - 12)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite /G1 upd_eq HF1s1; exact vdrwf_bit0_1)
    ...
    { rewrite /G1 upd_ne; [| reg_neq].
      rewrite (HF1thr Rtp ltac:(vm_compute; reflexivity) ltac:(reg_neq) ltac:(reg_neq)).
      exact HE8tp. }
    ...
    iApply (wp_vdrwf_iter γ Φ γs pd m2 (fr_upd fr h true)
              (b_data b : SailStdpp.Values.mword 64)
              (Z_to_bv 32 1024) (vdrw_flags wr) (Z_to_bv 16 (Z.of_nat t))
              G1 (K - 12)%nat eb (proc_addr j) C
              (vdrwb_K20 K HK) Hm8 Hfr1m Hglen HG1tp HG1s2 HG1s3
    ...
    iApply (wp_candi_s_sconf γ Φ (mword_of_int (VRW + 0x1ea) : mword 64) Rs1
              (mword_of_int 1 : mword 6) F2 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1ea [-]").
    iIntros "Hcg Hpc".
    ...
    iEval (rewrite Hp1ec1) in "Hpc".
    iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (VRW + 0x1ec) : mword 64)
              (mword_of_int 243 : mword 8) (Cregidx (mword_of_int 1)) Rs1 G2 (K - 12)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite /G2 upd_eq HF2s1; exact (vdrwf_bit0_flags wr))
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi1ec [-]").
    iNext. iIntros "Hcg Hpc".
    iEval (rewrite Hbrk) in "Hpc".
    ...
    { rewrite /G2 upd_ne; [| reg_neq].
      ...
      exact HG1s3. }
    assert (HG2tp : G2 !!! Regidx Rtp = cid_word).
    { rewrite /G2 upd_ne; [| reg_neq].
      rewrite (HF2thr Rtp ltac:(vm_compute; reflexivity) ltac:(reg_neq) ltac:(reg_neq)).
      exact HG1tp. }
    ...
    iApply (wp_vdrwf_iter γ Φ γs pd t (fr_upd (fr_upd fr h true) m2 true)
              (d_info_status h : SailStdpp.Values.mword 64)
              (Z_to_bv 32 1) (Z_to_bv 16 2) (Z_to_bv 16 0)
              G2 (K - 12)%nat eb (proc_addr j) C
              (vdrwb_K20 K HK) Ht8 Hfr2t Hglen HG2tp HG2s2 HG2s3
    ...
    iApply (wp_candi_s_sconf γ Φ (mword_of_int (VRW + 0x1ea) : mword 64) Rs1
              (mword_of_int 1 : mword 6) F3 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1ea [-]").
    iIntros "Hcg Hpc".
    ...
    change (<[Regidx Rs1 := regval_into_reg
      ...
      with G3.
    iEval (rewrite Hp1ec1) in "Hpc".
    iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (VRW + 0x1ec) : mword 64)
              (mword_of_int 243 : mword 8) (Cregidx (mword_of_int 1)) Rs1 G3 (K - 12)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite /G3 upd_eq HF3s1; exact vdrwf_bit0_2)
              with "Hcg Hpc Hi1ec [-]").
    iIntros "Hcg Hpc".
    assert (Hp1ee : add_vec_int (mword_of_int (VRW + 0x1ec) : mword 64) 2
                    = mword_of_int (VRW + 0x1ee)) by pcstep.
    iEval (rewrite Hp1ee) in "Hpc".
    assert (HG3tp : G3 !!! Regidx Rtp = cid_word).
    { rewrite /G3 upd_ne; [| reg_neq].
      rewrite (HF3thr Rtp ltac:(vm_compute; reflexivity) ltac:(reg_neq) ltac:(reg_neq)).
      exact HG2tp. }
    ...
    (* ================= +0x1ee .. +0x1f6: release ====================== *)
    iPoseProof (rwi_1ee with "Htext") as "Hi1ee".
    iPoseProof (rwi_1f2 with "Htext") as "Hi1f2".
    iPoseProof (rwi_1f6 with "Htext") as "Hi1f6".
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (VRW + 0x1ee) : mword 64) Ra0
              (mword_of_int 30 : mword 20) G3 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1ee [-]").
    iIntros "Hcg Hpc".
    set (H1 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x1ee) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> G3).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x1ee) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> G3) with H1.
    assert (Hp1f2 : add_vec_int (mword_of_int (VRW + 0x1ee) : mword 64) 4
                    = mword_of_int (VRW + 0x1f2)) by pcstep.
    iEval (rewrite Hp1f2) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x1f2) : mword 64) Ra0 Ra0
              (mword_of_int 3074 : mword 12) H1 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1f2 [-]").
    iIntros "Hcg Hpc".
    set (H2 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (H1 !!! Regidx Ra0)
                     (sign_extend' 64 (mword_of_int 3074 : mword 12)))]> H1).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (H1 !!! Regidx Ra0)
                     (sign_extend' 64 (mword_of_int 3074 : mword 12)))]> H1) with H2.
    assert (HH2a0 : H2 !!! Regidx Ra0 = (d_lock : SailStdpp.Values.mword 64)).
    { rewrite /H2 upd_eq /H1 upd_eq. exact vdrwf_a0lock. }
    assert (Hp1f6 : add_vec_int (mword_of_int (VRW + 0x1f2) : mword 64) 4
                    = mword_of_int (VRW + 0x1f6)) by pcstep.
    iEval (rewrite Hp1f6) in "Hpc".
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (VRW + 0x1f6) : mword 64) Rra
              (mword_of_int 2077514 : mword 21) H2 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi1f6 [-]").
    iIntros "Hcg Hpc".
    set (H3 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (VRW + 0x1f6) : mword 64) 4)]> H2).
    change (<[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (VRW + 0x1f6) : mword 64) 4)]> H2) with H3.
    ...
    assert (HH3tp : H3 !!! Regidx Rtp = cid_word).
    { rewrite /H3 upd_ne; [| reg_neq]. rewrite /H2 upd_ne; [| reg_neq].
      rewrite /H1 upd_ne; [| reg_neq]. exact HG3tp. }
    assert (HH3ra : H3 !!! Regidx Rra
                    = add_vec_int (mword_of_int (VRW + 0x1f6) : mword 64) 4)
    ...
    iApply (Release.wp_release_sconf γ Φ γk d_lock "virtio_disk"%string
              (disk_res γd pd pav pu) H3 0%nat eb (proc_addr j) C (K - 12)%nat
              HH3a0 HH3tp (vdrw_K10 K HK)
              with "Hcg Htext Hpc Hlk Htok HR Hown Hpay [-]").
    iIntros (MR) "Hcg Hpc %HcsR Hown".
    assert (Hp1fa : ret_pc (H3 !!! Regidx Rra) = mword_of_int (VRW + 0x1fa))
    ...
    { unfold pa_stk, add_vec_int. rewrite add_vec_off2.
      apply f_equal. apply bv_eq; vm_compute; reflexivity. }
    iPoseProof (rwi_1fa with "Htext") as "Hj1".
    iPoseProof (rwi_1fc with "Htext") as "Hj2".
    iPoseProof (rwi_1fe with "Htext") as "Hj3".
    iPoseProof (rwi_200 with "Htext") as "Hj4".
    iPoseProof (rwi_202 with "Htext") as "Hj5".
    iPoseProof (rwi_204 with "Htext") as "Hj6".
    iPoseProof (rwi_206 with "Htext") as "Hj7".
    iPoseProof (rwi_208 with "Htext") as "Hj8".
    iPoseProof (rwi_20a with "Htext") as "Hj9".
    iPoseProof (rwi_20c with "Htext") as "Hj10".
    iPoseProof (rwi_20e with "Htext") as "Hj11".
    iPoseProof (rwi_210 with "Htext") as "Hj12".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x1fa) : mword 64)
              (mword_of_int 11 : mword 6) Rra MR (K - 12)%nat (m !!! Regidx Rra)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj1 [Hk1] [-]").
    { iEval (rewrite HMRsp Hb1). iExact "Hk1". }
    iIntros "Hcg Hpc Hk1". iEval (rewrite HMRsp Hb1) in "Hk1".
    ...
    assert (Hq2 : add_vec_int (mword_of_int (VRW + 0x1fa) : mword 64) 2
                  = mword_of_int (VRW + 0x1fc)) by pcstep.
    iEval (rewrite Hq2) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x1fc) : mword 64)
              (mword_of_int 10 : mword 6) Rs0 R1 (K - 12)%nat (m !!! Regidx Rs0)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj2 [Hk2] [-]").
    { iEval (rewrite HR1sp Hb2). iExact "Hk2". }
    iIntros "Hcg Hpc Hk2". iEval (rewrite HR1sp Hb2) in "Hk2".
    ...
    assert (Hq3 : add_vec_int (mword_of_int (VRW + 0x1fc) : mword 64) 2
                  = mword_of_int (VRW + 0x1fe)) by pcstep.
    iEval (rewrite Hq3) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x1fe) : mword 64)
              (mword_of_int 9 : mword 6) Rs1 R2 (K - 12)%nat (m !!! Regidx Rs1)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj3 [Hk3] [-]").
    { iEval (rewrite HR2sp Hb3). iExact "Hk3". }
    iIntros "Hcg Hpc Hk3". iEval (rewrite HR2sp Hb3) in "Hk3".
    ...
    assert (Hq4 : add_vec_int (mword_of_int (VRW + 0x1fe) : mword 64) 2
                  = mword_of_int (VRW + 0x200)) by pcstep.
    iEval (rewrite Hq4) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x200) : mword 64)
              (mword_of_int 8 : mword 6) Rs2 R3 (K - 12)%nat (m !!! Regidx Rs2)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj4 [Hk4] [-]").
    { iEval (rewrite HR3sp Hb4). iExact "Hk4". }
    iIntros "Hcg Hpc Hk4". iEval (rewrite HR3sp Hb4) in "Hk4".
    ...
    assert (Hq5 : add_vec_int (mword_of_int (VRW + 0x200) : mword 64) 2
                  = mword_of_int (VRW + 0x202)) by pcstep.
    iEval (rewrite Hq5) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x202) : mword 64)
              (mword_of_int 7 : mword 6) Rs3 R4 (K - 12)%nat (m !!! Regidx Rs3)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj5 [Hk5] [-]").
    { iEval (rewrite HR4sp Hb5). iExact "Hk5". }
    iIntros "Hcg Hpc Hk5". iEval (rewrite HR4sp Hb5) in "Hk5".
    ...
    assert (Hq6 : add_vec_int (mword_of_int (VRW + 0x202) : mword 64) 2
                  = mword_of_int (VRW + 0x204)) by pcstep.
    iEval (rewrite Hq6) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x204) : mword 64)
              (mword_of_int 6 : mword 6) Rs4 R5 (K - 12)%nat (m !!! Regidx Rs4)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj6 [Hk6] [-]").
    { iEval (rewrite HR5sp Hb6). iExact "Hk6". }
    iIntros "Hcg Hpc Hk6". iEval (rewrite HR5sp Hb6) in "Hk6".
    ...
    assert (Hq7 : add_vec_int (mword_of_int (VRW + 0x204) : mword 64) 2
                  = mword_of_int (VRW + 0x206)) by pcstep.
    iEval (rewrite Hq7) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x206) : mword 64)
              (mword_of_int 5 : mword 6) Rs5 R6 (K - 12)%nat (m !!! Regidx Rs5)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj7 [Hk7] [-]").
    { iEval (rewrite HR6sp Hb7). iExact "Hk7". }
    iIntros "Hcg Hpc Hk7". iEval (rewrite HR6sp Hb7) in "Hk7".
    ...
    assert (Hq8 : add_vec_int (mword_of_int (VRW + 0x206) : mword 64) 2
                  = mword_of_int (VRW + 0x208)) by pcstep.
    iEval (rewrite Hq8) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x208) : mword 64)
              (mword_of_int 4 : mword 6) Rs6 R7 (K - 12)%nat (m !!! Regidx Rs6)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj8 [Hk8] [-]").
    { iEval (rewrite HR7sp Hb8). iExact "Hk8". }
    iIntros "Hcg Hpc Hk8". iEval (rewrite HR7sp Hb8) in "Hk8".
    ...
    assert (Hq9 : add_vec_int (mword_of_int (VRW + 0x208) : mword 64) 2
                  = mword_of_int (VRW + 0x20a)) by pcstep.
    iEval (rewrite Hq9) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x20a) : mword 64)
              (mword_of_int 3 : mword 6) Rs7 R8 (K - 12)%nat (m !!! Regidx Rs7)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj9 [Hk9] [-]").
    { iEval (rewrite HR8sp Hb9). iExact "Hk9". }
    iIntros "Hcg Hpc Hk9". iEval (rewrite HR8sp Hb9) in "Hk9".
    ...
    assert (Hq10 : add_vec_int (mword_of_int (VRW + 0x20a) : mword 64) 2
                   = mword_of_int (VRW + 0x20c)) by pcstep.
    iEval (rewrite Hq10) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VRW + 0x20c) : mword 64)
              (mword_of_int 2 : mword 6) Rs8 R9 (K - 12)%nat (m !!! Regidx Rs8)
              (dqm := DfracOwn 1) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "Hcg Hpc Hj10 [Hk10] [-]").
    { iEval (rewrite HR9sp Hb10). iExact "Hk10". }
    iIntros "Hcg Hpc Hk10". iEval (rewrite HR9sp Hb10) in "Hk10".
    ...
    assert (Hq11 : add_vec_int (mword_of_int (VRW + 0x20c) : mword 64) 2
                   = mword_of_int (VRW + 0x20e)) by pcstep.
    iEval (rewrite Hq11) in "Hpc".
    (* ---- +0x20e  c.addi16sp sp,96 : the frame pop ---- *)
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (VRW + 0x20e) : mword 64)
              (mword_of_int 6 : mword 6) R10 (K - 12)%nat 12 Hpop
    ...
    assert (Hq12 : add_vec_int (mword_of_int (VRW + 0x20e) : mword 64) 2
                   = mword_of_int (VRW + 0x210)) by pcstep.
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (VRW + 0x210) : mword 64) Rra R11 K
  ...
  Proof.
    ...
    assert (Hpc0 : (mword_of_int KernelSyms.virtio_disk_rw
                     : SailStdpp.Values.mword 64)
                   = (mword_of_int (VRW + 0x000) : mword 64))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply ("Hcont" $! mf with
              "[%] Hcg Hown Hpay Hpc Hctx Hsched Hbufo Hdisko").
    exact Hcsf.
  Qed.

...
Section ProofArgfd.
  ...
  (* =================================================================== *)
  Lemma af_tail (γ : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x46))
              (mword_of_int 5 : mword 6) (mword_of_int 1 : mword 5) Mt (av - 6)%nat ra0
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x48))
              (mword_of_int 4 : mword 6) (mword_of_int 8 : mword 5) T1 (av - 6)%nat s00
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x4a))
              (mword_of_int 3 : mword 6) (mword_of_int 9 : mword 5) T2 (av - 6)%nat s10
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x4c))
              (mword_of_int 2 : mword 6) (mword_of_int 18 : mword 5) T3 (av - 6)%nat s20
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x4e))
              (mword_of_int 3 : mword 6) T4 (av - 6)%nat 6 Hpop
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x50))
              (mword_of_int 1 : mword 5) T5 av
  ...
  (*  THE CAPSTONE.                                                       *)
  (* =================================================================== *)
  Lemma wp_argfd_sconf (γ : gname) (Φ : mval -> iProp Σ) (γf : gname)
  ...
  Proof.
    ...
    intros pcE pfd pf ret_tgt Htp Hi Ha0 Harg Hnzfd Hnzf Hn Hav.
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x02))
              (mword_of_int 5 : mword 6) (mword_of_int 1 : mword 5) M1 (av - 6)%nat u1
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x04))
              (mword_of_int 4 : mword 6) (mword_of_int 8 : mword 5) M1 (av - 6)%nat u2
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x06))
              (mword_of_int 3 : mword 6) (mword_of_int 9 : mword 5) M1 (av - 6)%nat u3
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x08))
              (mword_of_int 2 : mword 6) (mword_of_int 18 : mword 5) M1 (av - 6)%nat u4
    ...
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x0a))
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x0c))
              (mword_of_int 18 : mword 5) (mword_of_int 11 : mword 5) M2 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi0c [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x0e))
              (mword_of_int 9 : mword 5) (mword_of_int 12 : mword 5) M3 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi0e [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x10))
    ...
    (* ---- +0x14: jal ra,argint ---- *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x14))
              (mword_of_int 1 : mword 5) (mword_of_int 2088428 : mword 21) M5 (av - 6)%nat
    ...
    (* ---- argint(n, &fd) ---- *)
    iApply (Argint.wp_argint_sconf γ Φ M6 (av - 6)%nat n eb p C i
              (ud_tfp (pv_upt V)) (pv_tf V) v (word_hi w5) (DfracOwn (1/4))
              HM6tp Hi HM6a0 Harg Hn ltac:(lia)
              with "Hcg Hcpu Htext Hdata Hpc Htfp Hpage Hs5hi [-]").
    iIntros (A) "%HcsA Hcg Hcpu Hpc Htfp Hpage Hs5hi".
    ...
    assert (HAtp : A !!! Regidx (mword_of_int 4 : mword 5) = cid_word)
      by (rewrite (callee_saved_lookup HcsA (mword_of_int 4) ltac:(vm_compute; reflexivity)); exact HM6tp).
    ...
    iApply (wp_lw_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x18))
              (mword_of_int 14 : mword 5) (mword_of_int 8 : mword 5) (mword_of_int 0xfdc : mword 12)
              A (av - 6)%nat (trunc32 v)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x1c))
              (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 6)
              (mword_of_int 15 : mword 64) A1 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    { rewrite /A2 upd_ne; [| vm_compute; discriminate].
      rewrite /A1 upd_ne; [| vm_compute; discriminate]. exact HAtp. }
    ...
    - (* ============ IN RANGE ============ *)
      iApply (wp_bltu_fall_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x1e))
      ...
      (* ---- +0x22: jal ra,myproc ---- *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x22))
                (mword_of_int 1 : mword 5) (mword_of_int 2084574 : mword 21) A2 (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi22 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (HBtp : B !!! Regidx (mword_of_int 4 : mword 5) = cid_word)
        by (rewrite /B upd_ne; [exact HA2tp | vm_compute; discriminate]).
      iApply (Myproc.wp_myproc_sconf γ Φ B (av - 6)%nat n eb p C
                HBtp Hn ltac:(lia)
      ...
      iApply (wp_lw_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x26))
                (mword_of_int 14 : mword 5) (mword_of_int 8 : mword 5) (mword_of_int 0xfdc : mword 12)
                P (av - 6)%nat (trunc32 v)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      iApply (wp_slli_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x2a))
                (mword_of_int 15 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 3 : mword 6)
                (mword_of_int (Z.of_nat fd * 8) : mword 64) C1 (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      (* ---- +0x2e: addi a5,a5,208 ---- *)
      iApply (wp_addi4_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x2e))
      ...
      iApply (wp_cadd_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x32))
                (mword_of_int 10 : mword 5) (mword_of_int 15 : mword 5) C3 (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi32 [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cld_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x34))
      ...
      + (* ------- free: return -1 ------- *)
        iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x36))
        ...
        (* +0x56 c.li a0,-1 *)
        iApply (wp_cli_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x56))
                  (mword_of_int 10 : mword 5) (mword_of_int 63 : mword 6)
                  (mword_of_int (-1) : mword 64) C5 (av - 6)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(apply bv_eq; vm_compute; reflexivity)
                  with "Hcg Hpc Hi56 [-]").
        iIntros "Hcg Hpc".
        ...
        (* +0x58 c.j -0x12 *)
        iApply (wp_cj_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x58))
                  (sign_extend' 21 (concat_vec (mword_of_int 2039 : mword 11) ('b"0"))) D (av - 6)%nat
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi58 [-]").
        iNext. iIntros "Hcg Hpc".
        ...
        iApply (af_tail γ Φ m D av (mword_of_int (-1) : mword 64) sp0 ra0 s00 s10 s20 _ w6
      ...
      + (* ------- a live file: the success path ------- *)
        iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x36))
                  (mword_of_int 16 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
                  C5 (av - 6)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
        ...
        iApply (wp_beqz_x0_fall_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x38))
                  (mword_of_int 8 : mword 13) (mword_of_int 18 : mword 5) C5 (av - 6)%nat
                  ltac:(vm_compute; discriminate)
        ...
        iApply (wp_sw_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x3c))
        ...
        (* ---- +0x40: c.li a0,0 ---- *)
        iApply (wp_cli_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x40))
                  (mword_of_int 10 : mword 5) (mword_of_int 0 : mword 6)
                  (zero_reg : mword 64) C5 (av - 6)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(apply bv_eq; vm_compute; reflexivity)
                  with "Hcg Hpc Hi40 [-]").
        iIntros "Hcg Hpc".
        ...
        iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x42))
        ...
        iApply (wp_csd_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x44))
        ...
        iApply (af_tail γ Φ m E1 av (zero_reg : mword 64) sp0 ra0 s00 s10 s20 _ w6
    ...
    - (* ============ OUT OF RANGE: return -1 without calling myproc ============ *)
      iApply (wp_bltu_taken_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x1e))
                (mword_of_int 52 : mword 13) (mword_of_int 14 : mword 5) (mword_of_int 15 : mword 5)
                A2 (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      (* +0x52 c.li a0,-1 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x52))
                (mword_of_int 10 : mword 5) (mword_of_int 63 : mword 6)
                (mword_of_int (-1) : mword 64) A2 (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(apply bv_eq; vm_compute; reflexivity)
                with "Hcg Hpc Hi52 [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x54 c.j -0x0e *)
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (KernelSyms.argfd + 0x54))
                (sign_extend' 21 (concat_vec (mword_of_int 2041 : mword 11) ('b"0"))) F (av - 6)%nat
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi54 [-]").
      iNext. iIntros "Hcg Hpc".
      ...
      iApply (af_tail γ Φ m F av (mword_of_int (-1) : mword 64) sp0 ra0 s00 s10 s20 _ w6

...
Section ProofArgfd.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.argfd + 0x14))
              (mword_of_int 1 : mword 5) (mword_of_int 2088286 : mword 21) M5 (av - 6)%nat b
    ...
    assert (Hjai : add_vec (mword_of_int (KernelSyms.argfd + 0x14) : mword 64)
                     (sign_extend' 64 (mword_of_int 2088286 : mword 21)) = mword_of_int KernelSyms.argint)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* ============ IN RANGE ============ *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.argfd + 0x22))
                (mword_of_int 1 : mword 5) (mword_of_int 2084366 : mword 21) A2 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi22 [-]").
      ...
      assert (Hjmp : add_vec (mword_of_int (KernelSyms.argfd + 0x22) : mword 64)
                       (sign_extend' 64 (mword_of_int 2084366 : mword 21)) = mword_of_int KernelSyms.myproc)
        by (apply bv_eq; vm_compute; reflexivity).

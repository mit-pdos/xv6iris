...
Section UkRunLeaf.
  ...
  Proof.
    ...
    iApply (UkLeaf.wp_uk_cli C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_caddi C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd wval
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_caddi4spn C pt Rfd Rut pm sz Hlo Hpm M m pc fdv cr nzimm rd wval
              Hui H1 H2 H3
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_jal C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd tgt wval
              Hui H1 H2 H3 H4
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_cjr C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 tgt
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap Hstk Hcont").
  Qed.
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_cmv C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rd rs2 wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_caddiw C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd wval
              Hui H1 ltac:(rewrite (sext6_12_64 imm); exact H2)
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_cj C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm tgt
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap Hstk Hcont").
  Qed.
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_addi C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_add C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_slli C pt Rfd Rut pm sz Hlo Hpm M m pc fdv shamt rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_srli C pt Rfd Rut pm sz Hlo Hpm M m pc fdv shamt rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_subw C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_auipc C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_sub C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_and C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_sltu C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_addw C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_sltiu C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_andi C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_xori C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_addiw C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_slliw C pt Rfd Rut pm sz Hlo Hpm M m pc fdv shamt rs1 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_lui C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_divu C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_remu C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rs1 rs2 rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_jalr C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd wr tgt
              Hui H1 H2 H3
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_jr C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd tgt
              Hui H1 H2 H3
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap Hstk Hcont").
  Qed.
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_cadd C pt Rfd Rut pm sz Hlo Hpm M m pc fdv rd rs2 wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_cand C pt Rfd Rut pm sz Hlo Hpm M m pc fdv crd crs2 rd rs2 wval
              Hui H1 H2 H3 H4
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_caddw C pt Rfd Rut pm sz Hlo Hpm M m pc fdv crd crs2 rd rs2 wval
              Hui H1 H2 H3 H4
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_clui C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_cslli C pt Rfd Rut pm sz Hlo Hpm M m pc fdv shamt rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_csrli C pt Rfd Rut pm sz Hlo Hpm M m pc fdv shamt crd rd wval
              Hui H1 H2 H3
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkLeaf.wp_uk_li C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rd wval
              Hui H1 H2
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap [Hstk] Hcont").
    rewrite (unot_sp_upd rd _ m Hns). iExact "Hstk".
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkBranch.wp_uk_btype C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs2 rs1 op taken tgt
              Hui H1 H2 H3
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap Hstk Hcont").
  Qed.
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkBranch.wp_uk_btype_later C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm rs2 rs1
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkBranch.wp_uk_cbeqz C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm cr rs taken tgt
              Hui H1 H2 H3 H4
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap Hstk Hcont").
  Qed.
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv) "(%Hlo & %Hpm & Hheap & Hstk & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkBranch.wp_uk_cbnez C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm cr rs taken tgt
              Hui H1 H2 H3 H4
              with "Hb [Hheap Hstk Hcont]").
    iApply (urun_close with "Hheap Hstk Hcont").
  Qed.
  ...
  Proof.
    ...
    iApply (UkLeaf.wp_uk_caddi C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm csp_rs1
  ...
  Proof.
    ...
    rewrite (ustack_app γd (m !!! Regidx csp_rs1)
               (add_vec_int (m !!! Regidx csp_rs1) (- (8 * Z.of_nat k))) k n Hu).
    iDestruct "Hstk" as "(Hframe & Hstk)".
    iApply (UkLeaf.wp_uk_caddi16sp C pt Rfd Rut pm sz Hlo Hpm M m pc fdv imm
              (add_vec_int (m !!! Regidx csp_rs1) (- (8 * Z.of_nat k)))

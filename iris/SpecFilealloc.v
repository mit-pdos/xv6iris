...
Definition wp_filealloc_sconf_body `{!riscvGS Σ, !lockG Σ, !sieG Σ, !fileG Σ, !fdslotG Σ, !irefNameG Σ} `{GEN : GenId} `{CID : CpuId} (γl γf : gname) (m : regfile)
...
Module Type FILEALLOC.
  Parameter wp_filealloc_sconf :
    forall `{!riscvGS Σ, !lockG Σ, !sieG Σ, !fileG Σ, !fdslotG Σ, !irefNameG Σ} `{GEN : GenId} `{CID : CpuId} (γl γf : gname) (m : regfile)
      (n : nat) (eb : bool) (p : mword 64) (C : iProp Σ) (K : nat) (b : bool),

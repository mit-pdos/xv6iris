...
Section ProofSysUnlinkBody.
  ...
  Proof.
    ...
    iIntros "Hcg Hown #Htext #Hdata Hpc #Hpanic #Hpenv2 #Hbio #Hlog Hseam Hgen
    ...
    - (* ---------------- the path fetched: fall through ---------------- *)
      ...
      iApply (Nameiparent.wp_nameiparent_gen (CID := CID16) gs jx gl gu gd gk
                ...
                with "Hcg Hown Htext Hdata Hpc Hpanic Hpenv2 Hbio Hlog Hkenv Hitab Hitinv
      ...
      + (* ---------- ARM B: nameiparent returned 0 ---------- *)
        ...
        iApply (Tails.su_tail_b (CID0 := CID19) gs jx gl gu gd gk pd pav pu bn
                  ...
                  with "Hcg Hown [] [] Htext Hdata Hpc Hpanic Hpenv2 Hbio Hlog Hseam Hgen
  ...
  Proof.
    intros HKup HKeo HK30 Kpop Hkk Hgeom Hsize Hbm0 Hbmcov Hbmlog Hist0 Hiblk
           ...
           HMs3 Hal Heb Hupt1.
    iIntros "Hcg Hown #Htext #Hkd Hpc #Hpanic #Hpenv #Hbio #Hlog Hseam Hgen #Hitab #Hitinv
    ...
    iApply (Tails.su_tail_bad (CID0 := CID0) gs jx gl gu gd gk pd pav pu bn g
              ...
              HMs1 HMs2 HMs3 Hal
              with "Hcg Hown [] [] Htext Hkd Hpc Hpanic Hpenv Hbio Hlog Hseam Hgen Hitab
  ...
  Proof.
    ...
    iApply (Ilock.wp_ilock_sconf (CID := CID1) gs jx gl gu gd gk pd pav pu bn
              ...
              (Hlb "bcache"%string)
              with "Hcg Hown [] [] Htext Hdata Hpc Hpanic Hpenv2 Hbio Hitinv Hescd Hireg
    ...
    - (* ---------------- ARM C: the name IS "." ---------------- *)
      ...
      iApply (su_w2_bad (CID0 := CID8) gf gs jx gl gu gd gk pd pav pu bn g gfs
                ...
                with "Hcg Hown Htext Hdata Hpc Hpanic Hpenv2 Hbio Hlog Hseam Hgen Hitab
    ...
    - (* ---------------- the name is not "." : fall through ---------------- *)
      ...
      + (* -------- the name is neither dot: on to dirlookup -------- *)
        ...
        iApply (Dirlookup.wp_dirlookup_sconf (CID := CID19) gs jx gl gu gd gk
                  ...
                  with "Hcg Hown Htext Hdata Hpc Hpanic Hpenv2 Hbio Hkenv Hidev Hmeta
  ...
  Proof.
    ...
    iApply (Readi.wp_readi_sconf (CID := CID6) gs jx gl gu gd gk pd pav pu bn
              ...
              (Hlb "bcache"%string)
              with "Hcg Hown [] [] Htext Hkd Hpc Hpanic Hpe Hbio Hkenv Hidev Hmeta
  ...
  Proof.
    ...
    iApply (Ilock.wp_ilock_sconf (CID := CID2) gs jx gl gu gd gk pd pav pu bn
              ...
              (Hlb "bcache"%string)
              with "Hcg Hown [] [] Htext Hkd Hpc Hpanic Hpe Hbio Hitinv Hesci Hireg
    ...
    - (* ---------------- T_DIR: the inlined isdirempty ---------------- *)
      ...
      { (* ---- ARM E: a live non-dot record -- [Tails.su_tail_e] ---- *)
        ...
        iApply (Tails.su_tail_e (CID0 := CIDx) gs jx gl gu gd gk pd pav pu bn
                  ...
                  with "Hcg Hown [] [] Htext Hkd Hpc Hpanic Hpe Hbio Hlog Hseam Hgen
  ...
  Proof.
    ...
    iApply (Memset.wp_memset_sconf (CID := D5) A5 (K - 30)%nat 16
    ...
    iApply (wp_jal_s_sconf (CID := D11) (mword_of_int (SU + 0xa4)) Rra
              (mword_of_int 2090658 : mword 21) B5 (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hia4").
    ...
    assert (Hjwi : add_vec (mword_of_int (SU + 0xa4) : mword 64)
                     (sign_extend' 64 (mword_of_int 2090658 : mword 21))
    ...
    iDestruct (cpu_own_transport CID0 D12 0 eb (proc_addr jx) b
                 ltac:(wp_next_chain) with "Hown") as "Hown".
    iApply (Writei.wp_writei_gen (CID := D12) gs jx gl gu gd gk pd pav pu bn
              ...
              Ha1t Ha3t Ha4t
              (Hlb "log"%string)
              with "Hcg Hown [] [] Htext Hpc Hpanic Hdata Hprenv Hbio Hlog
    ...
    iApply (wp_jal_s_sconf (CID := D19) (mword_of_int (SU + 0xba)) Rra
              (mword_of_int 2090004 : mword 21) C4 (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hiba").
    ...
    assert (Hjup : add_vec (mword_of_int (SU + 0xba) : mword 64)
                     (sign_extend' 64 (mword_of_int 2090004 : mword 21))
    ...
    iApply (Iunlockput.wp_iunlockput_gen (CID := D20) gs jx gl gu gd gk pd pav
              ...
              with "Hcg Hown [] [] Htext Hdata Hpc Hpanic Hpanenv Hbio Hlog Hitab Hitinv
    ...
    iApply (Iupdate.wp_iupdate_unlink (CID := D26) gs jx gl gu gd gk pd pav pu
              ...
              with "Hcg Hown Htext Hdata Hpc Hpanic Hpanenv Hbio Hlog Hidevi Hiinumi Hmetai
    ...
    iApply (wp_jal_s_sconf (CID := D28) (mword_of_int (SU + 0xd0)) Rra
              (mword_of_int 2089982 : mword 21) E1 (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hid0").
    ...
    assert (Hjup2 : add_vec (mword_of_int (SU + 0xd0) : mword 64)
                      (sign_extend' 64 (mword_of_int 2089982 : mword 21))
                    = mword_of_int KernelSyms.iunlockput) by pcw.
    ...
    iApply (wp_jal_s_sconf (CID := D30) (mword_of_int (SU + 0xd4)) Rra
              (mword_of_int 2092188 : mword 21) mip (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hid4").
    ...
    assert (Hjeo : add_vec (mword_of_int (SU + 0xd4) : mword 64)
                     (sign_extend' 64 (mword_of_int 2092188 : mword 21))
    ...
    iApply (EndOp.wp_end_op_sconf (CID := D31) gs jx gl gu gd gk pd pav pu bn
              ...
              eb b lks Keo Hgeom Hj Hgl
              ltac:(rewrite Hlkempty; apply locks_below_empty)
              with "Hcg Hown Htce Hcce Htext Hdata Hpc Hpanic Hpanenv Hbio Hlog Hseam Hgen
  ...
  Proof.
    ...
    iApply (Iupdate.wp_iupdate_unlink (CID := T6) gs jx gl gu gd gk pd pav pu
              ...
              ltac:(exact Kiupd) ltac:(intros _; exact Hibd16) Hgeom Hist0
              ...
              with "Hcg Hown Htext Hdata Hpc Hpanic Hpanenv Hbio Hlog Hidevd Hiinumd Hmetad
  ...
  Proof.
    ...
    iApply (su_w1 gf ga gs jx gl gu gd gk pd pav pu bn g gfs gi cn gtl cov
              ...
              Harg0
              with "Hcg Hown Htext Hdata Hpc Hpanic Hpenv Hbio Hlog Hseam Hgen
                    Hdev Hgeo Hdlk Hbsl Hitab Hitinv Hescrows Hslks Hireg

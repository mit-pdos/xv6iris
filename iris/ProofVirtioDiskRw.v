(* ProofVirtioDiskRw.v -- virtio_disk_rw(b, write) over the sconf world.
   ...
   virtio_disk_rw @ 0x80005750 is the driver's request path: it allocates a
   ...
   or written -- without disturbing its neighbours:
     ...
     P2  the alloc3 machinery: the eight-way free-cell scan, the middle
         three-iteration loop, the outer sleep-retry iLöb       +0x036..+0x0b0
     P3  descriptor / header / status / info.b formatting       +0x0b0..+0x162
     P4  ring write, fence, and THE PUBLISH                     +0x162..+0x186
     P5  QUEUE_NOTIFY + the completion-wait iLöb                +0x186..+0x1b0
     P6  payoff withdrawal, free_chain, release, epilogue       +0x1b0..+0x210
...
Section VdrwDefs.
  ...
  Proof.
    intros Hcs (Hsp & Hs0 & Hs3 & Hs6 & Hs7 & Htp).
    unfold vdrw_regs.
    rewrite (proj1 Hcs).
    split_and!;
      [ exact Hsp
      ...
      | rewrite (callee_saved_lookup Hcs Rtp ltac:(vm_compute; reflexivity)); exact Htp ].
  Qed.
...
Section ProofVirtioDiskRw.
  ...
  (* =================================================================== *)
  Lemma wp_vdrw_p1 (γ : gname) (Φ : mval -> iProp Σ)
    ...
    ( ∀ M : regfile,
        ...
        cpu_own γ 1 eb pj C -∗
        trap_csrs_pay 0 eb -∗
        pc_is (mword_of_int (VRW + 0x036) : mword 64) -∗
        locked γk cpu_id -∗
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros sp0 b wr HK Htp.
    iIntros "Hcg Hown #Htext Hpc #Hpanic #Hlk Hbno Hcont".
    ...
    iApply (wp_caddi16sp_push_s_sconf γ Φ (mword_of_int (VRW + 0x000) : mword 64)
              (mword_of_int 58 : mword 6) m K 12 (vdrw_K12 K HK) Hpush
              with "Hcg Hpc Hi000 [-]").
    ...
    assert (Hp002 : add_vec_int (mword_of_int (VRW + 0x000) : mword 64) 2
                    = mword_of_int (VRW + 0x002)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp002) in "Hpc".
    (* ---- the ten saves ---- *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x002) : mword 64)
              (mword_of_int 11 : mword 6) Rra R1 (K - 12)%nat u1
              with "Hcg Hpc Hi002 Hk1 [-]").
    iIntros "Hcg Hpc Hk1".
    assert (Hp004 : add_vec_int (mword_of_int (VRW + 0x002) : mword 64) 2
                    = mword_of_int (VRW + 0x004)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp004) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x004) : mword 64)
              (mword_of_int 10 : mword 6) Rs0 R1 (K - 12)%nat u2
              with "Hcg Hpc Hi004 Hk2 [-]").
    iIntros "Hcg Hpc Hk2".
    assert (Hp006 : add_vec_int (mword_of_int (VRW + 0x004) : mword 64) 2
                    = mword_of_int (VRW + 0x006)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp006) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x006) : mword 64)
              (mword_of_int 9 : mword 6) Rs1 R1 (K - 12)%nat u3
              with "Hcg Hpc Hi006 Hk3 [-]").
    iIntros "Hcg Hpc Hk3".
    assert (Hp008 : add_vec_int (mword_of_int (VRW + 0x006) : mword 64) 2
                    = mword_of_int (VRW + 0x008)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp008) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x008) : mword 64)
              (mword_of_int 8 : mword 6) Rs2 R1 (K - 12)%nat u4
              with "Hcg Hpc Hi008 Hk4 [-]").
    iIntros "Hcg Hpc Hk4".
    assert (Hp00a : add_vec_int (mword_of_int (VRW + 0x008) : mword 64) 2
                    = mword_of_int (VRW + 0x00a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp00a) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x00a) : mword 64)
              (mword_of_int 7 : mword 6) Rs3 R1 (K - 12)%nat u5
              with "Hcg Hpc Hi00a Hk5 [-]").
    iIntros "Hcg Hpc Hk5".
    assert (Hp00c : add_vec_int (mword_of_int (VRW + 0x00a) : mword 64) 2
                    = mword_of_int (VRW + 0x00c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp00c) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x00c) : mword 64)
              (mword_of_int 6 : mword 6) Rs4 R1 (K - 12)%nat u6
              with "Hcg Hpc Hi00c Hk6 [-]").
    iIntros "Hcg Hpc Hk6".
    assert (Hp00e : add_vec_int (mword_of_int (VRW + 0x00c) : mword 64) 2
                    = mword_of_int (VRW + 0x00e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp00e) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x00e) : mword 64)
              (mword_of_int 5 : mword 6) Rs5 R1 (K - 12)%nat u7
              with "Hcg Hpc Hi00e Hk7 [-]").
    iIntros "Hcg Hpc Hk7".
    assert (Hp010 : add_vec_int (mword_of_int (VRW + 0x00e) : mword 64) 2
                    = mword_of_int (VRW + 0x010)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp010) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x010) : mword 64)
              (mword_of_int 4 : mword 6) Rs6 R1 (K - 12)%nat u8
              with "Hcg Hpc Hi010 Hk8 [-]").
    iIntros "Hcg Hpc Hk8".
    assert (Hp012 : add_vec_int (mword_of_int (VRW + 0x010) : mword 64) 2
                    = mword_of_int (VRW + 0x012)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp012) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x012) : mword 64)
              (mword_of_int 3 : mword 6) Rs7 R1 (K - 12)%nat u9
              with "Hcg Hpc Hi012 Hk9 [-]").
    iIntros "Hcg Hpc Hk9".
    assert (Hp014 : add_vec_int (mword_of_int (VRW + 0x012) : mword 64) 2
                    = mword_of_int (VRW + 0x014)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp014) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VRW + 0x014) : mword 64)
              (mword_of_int 2 : mword 6) Rs8 R1 (K - 12)%nat u10
              with "Hcg Hpc Hi014 Hk10 [-]").
    iIntros "Hcg Hpc Hk10".
    assert (Hp016 : add_vec_int (mword_of_int (VRW + 0x014) : mword 64) 2
                    = mword_of_int (VRW + 0x016)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp016) in "Hpc".
    (* ---- +0x016  c.addi4spn s0,sp,96 : the frame pointer ---- *)
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (VRW + 0x016) : mword 64)
              (Cregidx (mword_of_int 0)) (mword_of_int 24 : mword 8) Rs0 R1 (K - 12)%nat
    ...
    assert (Hp018 : add_vec_int (mword_of_int (VRW + 0x016) : mword 64) 2
                    = mword_of_int (VRW + 0x018)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp018) in "Hpc".
    (* ---- +0x018  c.mv s3,a0 ; +0x01a  c.mv s6,a1 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VRW + 0x018) : mword 64) Rs3 Ra0
              R2 (K - 12)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi018 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (HR2a0 : R2 !!! Regidx Ra0 = (b : mword 64)).
    { rewrite /R2 upd_ne; [| reg_neq]. rewrite /R1 upd_ne; [| reg_neq]. reflexivity. }
    assert (HR3s3 : R3 !!! Regidx Rs3 = (b : mword 64))
      by (rewrite /R3 upd_eq HR2a0; apply add_vec_zero_l).
    assert (Hp01a : add_vec_int (mword_of_int (VRW + 0x018) : mword 64) 2
                    = mword_of_int (VRW + 0x01a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp01a) in "Hpc".
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VRW + 0x01a) : mword 64) Rs6 Ra1
              R3 (K - 12)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi01a [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp01c : add_vec_int (mword_of_int (VRW + 0x01a) : mword 64) 2
                    = mword_of_int (VRW + 0x01c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp01c) in "Hpc".
    (* ---- +0x01c  lw s7,12(a0) : b->blockno ---- *)
    assert (HR4a0 : R4 !!! Regidx Ra0 = (b : mword 64)).
    ...
    assert (Hp020 : add_vec_int (mword_of_int (VRW + 0x01c) : mword 64) 4
                    = mword_of_int (VRW + 0x020)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp020) in "Hpc".
    (* ---- +0x020  slliw s7,s7,1 ---- *)
    iApply (wp_slliw_s_sconf γ Φ (mword_of_int (VRW + 0x020) : mword 64) Rs7 Rs7
              (mword_of_int 1 : mword 5)
    ...
    assert (Hp024 : add_vec_int (mword_of_int (VRW + 0x020) : mword 64) 4
                    = mword_of_int (VRW + 0x024)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp024) in "Hpc".
    (* ---- +0x024  c.slli s7,s7,0x20 ---- *)
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (VRW + 0x024) : mword 64) (Regidx Rs7) Rs7
              vdrw_sh32 R6 (K - 12)%nat
    ...
    assert (Hp026 : add_vec_int (mword_of_int (VRW + 0x024) : mword 64) 2
                    = mword_of_int (VRW + 0x026)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp026) in "Hpc".
    (* ---- +0x026  srli s7,s7,0x20 ---- *)
    iApply (wp_srli4_s_sconf γ Φ (mword_of_int (VRW + 0x026) : mword 64) Rs7 Rs7
              vdrw_sh32 R7 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi026 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp02a : add_vec_int (mword_of_int (VRW + 0x026) : mword 64) 4
                    = mword_of_int (VRW + 0x02a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp02a) in "Hpc".
    (* ---- +0x02a/+0x02e  a0 := &disk.vdisk_lock ---- *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (VRW + 0x02a) : mword 64) Ra0
              (mword_of_int 30 : mword 20) R8 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi02a [-]").
    iIntros "Hcg Hpc".
    set (R9 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x02a) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> R8).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x02a) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> R8) with R9.
    assert (Hp02e : add_vec_int (mword_of_int (VRW + 0x02a) : mword 64) 4
                    = mword_of_int (VRW + 0x02e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp02e) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x02e) : mword 64) Ra0 Ra0
              (mword_of_int 3526 : mword 12) R9 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi02e [-]").
    iIntros "Hcg Hpc".
    set (R10 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R9 !!! Regidx Ra0)
                     (sign_extend' 64 (mword_of_int 3526 : mword 12)))]> R9).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (R9 !!! Regidx Ra0)
                     (sign_extend' 64 (mword_of_int 3526 : mword 12)))]> R9) with R10.
    assert (HR10a0 : R10 !!! Regidx Ra0 = (d_lock : mword 64)).
    { rewrite /R10 upd_eq /R9 upd_eq.
      unfold d_lock, disk_base, pa_add, add_vec_int.
      apply bv_eq; vm_compute; reflexivity. }
    assert (Hp032 : add_vec_int (mword_of_int (VRW + 0x02e) : mword 64) 4
                    = mword_of_int (VRW + 0x032)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp032) in "Hpc".
    (* ---- +0x032  jal acquire ---- *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (VRW + 0x032) : mword 64) Rra
              (mword_of_int 2077830 : mword 21) R10 (K - 12)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi032 [-]").
    iIntros "Hcg Hpc".
    set (R11 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (VRW + 0x032) : mword 64) 4)]> R10).
    change (<[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (VRW + 0x032) : mword 64) 4)]> R10) with R11.
    assert (Hjacq : add_vec (mword_of_int (VRW + 0x032) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077830 : mword 21))
    ...
    assert (HR11tp : R11 !!! Regidx Rtp = cid_word).
    ...
    assert (HR11ra : R11 !!! Regidx Rra
                     = add_vec_int (mword_of_int (VRW + 0x032) : mword 64) 4)
      by (rewrite /R11; apply upd_eq).
    iApply (Acquire.wp_acquire_sconf γ Φ γk "virtio_disk"%string
              (disk_res γd pd pav pu) R11 0%nat eb pj C (K - 12)%nat
              HR11tp vdrw_noff0 (vdrw_K10 K HK)
              with "Hcg Hown Htext Hpc [] Hpanic [-]").
    { iEval (rewrite HR11a0). iExact "Hlk". }
    iIntros (ms M) "_ Hcg Hpc %HcsM Htok HR Hown Hpay".
    assert (Hret : ret_pc (R11 !!! Regidx Rra) = mword_of_int (VRW + 0x036))
    ...
    assert (HR11 : vdrw_regs R11 sp0 b wr (vdrw_sector_raw bno)).
  ...
  Definition vdrw_scan_out (fr : nat -> bool) (k : nat) (M' : regfile) : iProp Σ :=
    ((∃ j : nat,
        ...
        pc_is (mword_of_int (VRW + 0x046) : mword 64))
     ∨ (⌜forall i, (k <= i < 8)%nat -> fr i = false⌝ ∗
        pc_is (mword_of_int (VRW + 0x076) : mword 64)))%I.

  Lemma wp_vdrw_scan (γ : gname) (Φ : mval -> iProp Σ)
    ...
    sie_cap_gpr γ M av -∗
    kernel_text -∗ pc_is (mword_of_int (VRW + 0x068) : mword 64) -∗
  ...
  Proof.
    ...
    all: iApply (wp_lbu_s_sconf γ Φ (mword_of_int (VRW + 0x068) : mword 64) Ra3 Ra4
                   (mword_of_int 24 : mword 12) M av
                   (if fr k then Z_to_bv 8 1 else byte_zero)
                   ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                   with "Hcg Hpc Hi068 [Hcell] [-]").
    1,3: iEval (rewrite Hlbu); iExact "Hcell".
    all: iIntros "Hcg Hpc Hcell".
    ...
    all: assert (Hp06c : add_vec_int (mword_of_int (VRW + 0x068) : mword 64) 4
                         = mword_of_int (VRW + 0x06c))
           by (apply bv_eq; vm_compute; reflexivity).
    all: iEval (rewrite Hp06c) in "Hpc".
    all: destruct (fr k) eqn:Hfrk.
    (* ---------- FOUND at k (both induction cases are identical) ---------- *)
    1,3: iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (VRW + 0x06c) : mword 64)
                   (mword_of_int 237 : mword 8) (Cregidx (mword_of_int 5)) Ra3 N1 av
                   ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                   ltac:(rewrite HN1a3; exact vdrw_bnez_set)
                   ltac:(vm_compute; reflexivity)
                   with "Hcg Hpc Hi06c [Hcell Hbun Hrest Hcont]");
         [ iNext; iIntros "Hcg Hpc";
           assert (Hbk : add_vec (mword_of_int (VRW + 0x06c) : mword 64)
                           (sign_extend' 64 (sign_extend' 13
                              (concat_vec (mword_of_int 237 : mword 8) ('b"0"))))
                         = mword_of_int (VRW + 0x046))
             by (apply bv_eq; vm_compute; reflexivity);
    ...
    (* ---------- clear at k: advance ---------- *)
    all: iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (VRW + 0x06c) : mword 64)
                   (mword_of_int 237 : mword 8) (Cregidx (mword_of_int 5)) Ra3 N1 av
                   ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                   ltac:(rewrite HN1a3; exact vdrw_bnez_clear)
                   with "Hcg Hpc Hi06c [-]").
    all: iIntros "Hcg Hpc".
    all: assert (Hp06e : add_vec_int (mword_of_int (VRW + 0x06c) : mword 64) 2
                         = mword_of_int (VRW + 0x06e))
           by (apply bv_eq; vm_compute; reflexivity).
    all: iEval (rewrite Hp06e) in "Hpc".
    all: iApply (wp_caddiw_s_sconf γ Φ (mword_of_int (VRW + 0x06e) : mword 64) Ra5
                   (mword_of_int 1 : mword 6) N1 av
                   ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                   with "Hcg Hpc Hi06e [-]").
    all: iIntros "Hcg Hpc".
    ...
    all: assert (Hp070 : add_vec_int (mword_of_int (VRW + 0x06e) : mword 64) 2
                         = mword_of_int (VRW + 0x070))
           by (apply bv_eq; vm_compute; reflexivity).
    all: iEval (rewrite Hp070) in "Hpc".
    all: iApply (wp_caddi_s_sconf γ Φ (mword_of_int (VRW + 0x070) : mword 64) Ra4
                   (mword_of_int 1 : mword 6) N2 av
                   ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                   with "Hcg Hpc Hi070 [-]").
    all: iIntros "Hcg Hpc".
    ...
    all: assert (Hp072 : add_vec_int (mword_of_int (VRW + 0x070) : mword 64) 2
                         = mword_of_int (VRW + 0x072))
           by (apply bv_eq; vm_compute; reflexivity).
    all: iEval (rewrite Hp072) in "Hpc".
    (* ---------- base case: k + 2 = 8, the [bne] falls through ---------- *)
    - assert (Hk7 : k = 7%nat) by (clear -Hkn; lia).
      iApply (wp_bne_fall_s_sconf γ Φ (mword_of_int (VRW + 0x072) : mword 64)
                (mword_of_int 8182 : mword 13) Rs1 Ra5 N3 av
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HN3a5 HN3s1 Hk7; exact vdrw_neq8_eq)
                with "Hcg Hpc Hi072 [-]").
      iIntros "Hcg Hpc".
      assert (Hp076 : add_vec_int (mword_of_int (VRW + 0x072) : mword 64) 4
                      = mword_of_int (VRW + 0x076))
        by (apply bv_eq; vm_compute; reflexivity).
    ...
    - assert (HSk8 : (S k < 8)%nat) by (clear -Hkn; lia).
      iApply (wp_bne_taken_s_sconf γ Φ (mword_of_int (VRW + 0x072) : mword 64)
                (mword_of_int 8182 : mword 13) Rs1 Ra5 N3 av
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HN3a5 HN3s1; exact (vdrw_neq8_lt (S k) HSk8))
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi072 [Hcell Hbun Hrest Hcont]").
      iNext. iIntros "Hcg Hpc".
      assert (Hbk2 : add_vec (mword_of_int (VRW + 0x072) : mword 64)
                       (sign_extend' 64 (mword_of_int 8182 : mword 13))
                     = mword_of_int (VRW + 0x068))
        by (apply bv_eq; vm_compute; reflexivity).
  ...
  Definition vdrw_iter_out (pd : Arch.pa) (fr : nat -> bool) (idxa : Arch.pa)
    ...
    ((∃ j : nat,
        ...
        pc_is (mword_of_int (VRW + 0x058) : mword 64) ∗
     ...
     ∨ (⌜(forall k, (k < 8)%nat -> fr k = false)
        ...
        pc_is (mword_of_int (VRW + 0x07a) : mword 64) ∗
        (∃ v : mword 32, idxa ↦₄ v) ∗
        free_bundles pd fr))%I.

  Lemma wp_vdrw_iter (γ : gname) (Φ : mval -> iProp Σ)
      (pd : Arch.pa) (fr : nat -> bool) (av : nat)
    ...
    sie_cap_gpr γ M av -∗
    kernel_text -∗ pc_is (mword_of_int (VRW + 0x05c) : mword 64) -∗
    free_bundles pd fr -∗
    (∃ v : mword 32, idxa ↦₄ v) -∗
    ( ∀ M' : regfile,
        ⌜vdrw_iter_ag M M'⌝ -∗
  ...
  Proof.
    ...
    (* ---- +0x05c  c.mv a1,a2 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VRW + 0x05c) : mword 64) Ra1 Ra2
              M av ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi05c [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp05e : add_vec_int (mword_of_int (VRW + 0x05c) : mword 64) 2
                    = mword_of_int (VRW + 0x05e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp05e) in "Hpc".
    (* ---- +0x05e / +0x062  a4 := &disk ---- *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (VRW + 0x05e) : mword 64) Ra4
              (mword_of_int 30 : mword 20) Q1 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi05e [-]").
    iIntros "Hcg Hpc".
    set (Q2 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x05e) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> Q1).
    change (<[Regidx Ra4 := regval_into_reg
                  (add_vec (mword_of_int (VRW + 0x05e) : mword 64)
                           (auipc_off (mword_of_int 30 : mword 20)))]> Q1) with Q2.
    assert (Hp062 : add_vec_int (mword_of_int (VRW + 0x05e) : mword 64) 4
                    = mword_of_int (VRW + 0x062)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp062) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x062) : mword 64) Ra4 Ra4
              (mword_of_int 3178 : mword 12) Q2 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi062 [-]").
    iIntros "Hcg Hpc".
    set (Q3 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (Q2 !!! Regidx Ra4)
                     (sign_extend' 64 (mword_of_int 3178 : mword 12)))]> Q2).
    change (<[Regidx Ra4 := regval_into_reg
                  (add_vec (Q2 !!! Regidx Ra4)
                     (sign_extend' 64 (mword_of_int 3178 : mword 12)))]> Q2) with Q3.
    ...
    assert (Hp066 : add_vec_int (mword_of_int (VRW + 0x062) : mword 64) 4
                    = mword_of_int (VRW + 0x066)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp066) in "Hpc".
    (* ---- +0x066  c.li a5,0 ---- *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (VRW + 0x066) : mword 64) Ra5
              (mword_of_int 0 : mword 6) (mword_of_int (Z.of_nat 0) : mword 64) Q3 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hp068 : add_vec_int (mword_of_int (VRW + 0x066) : mword 64) 2
                    = mword_of_int (VRW + 0x068)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp068) in "Hpc".
    (* ---- +0x068 .. +0x072  THE SCAN ---- *)
    iApply (wp_vdrw_scan γ Φ pd fr av 7 0 Q4 ltac:(reflexivity) HQ4a5 HQ4a4 HQ4s1
    ...
    - (* ============ FOUND: clear the cell, record the index ============ *)
      ...
      (* +0x046  add a4,s5,a5 *)
      iApply (wp_add_s_sconf γ Φ (mword_of_int (VRW + 0x046) : mword 64) Ra4 Rs5 Ra5
                (add_vec (disk_base : mword 64) (mword_of_int (Z.of_nat j))) Q5 av
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HQ5s5 HQ5a5; reflexivity)
                with "Hcg Hpc Hi046 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hp04a : add_vec_int (mword_of_int (VRW + 0x046) : mword 64) 4
                      = mword_of_int (VRW + 0x04a)) by (apply bv_eq; vm_compute; reflexivity).
      ...
      (* +0x04a  sb zero,24(a4) *)
      iDestruct (sie_cap_gpr_x0 γ Q6 av (mword_of_int 0 : mword 5)
      ...
      iApply (wp_sb_s_sconf γ Φ (mword_of_int (VRW + 0x04a) : mword 64)
                (mword_of_int 0 : mword 5) Ra4 (mword_of_int 24 : mword 12) Q6 av
                (Z_to_bv 8 1) with "Hcg Hpc Hi04a [Hcell] [-]").
      { iEval (rewrite Hsba). iExact "Hcell". }
      iIntros "Hcg Hpc Hcell".
      iEval (rewrite Hsba Hz8) in "Hcell".
      assert (Hp04e : add_vec_int (mword_of_int (VRW + 0x04a) : mword 64) 4
                      = mword_of_int (VRW + 0x04e)) by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_csw_s_sconf γ Φ (mword_of_int (VRW + 0x04e) : mword 64) Ra5 Ra1
                (mword_of_int 0 : mword 12) Q6 av v0 with "Hcg Hpc Hi04e [Hidx] [-]").
      { iEval (rewrite Hswa). iExact "Hidx". }
      iIntros "Hcg Hpc Hidx".
      iEval (rewrite Hswa HQ6a5 (vdrw_trunc32_small j Hj8)) in "Hidx".
      assert (Hp050 : add_vec_int (mword_of_int (VRW + 0x04e) : mword 64) 2
                      = mword_of_int (VRW + 0x050)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hp050) in "Hpc".
      (* +0x050  blt a5,x0 : DEAD, j >= 0 *)
      iApply (wp_blt_x0_fall_s_sconf γ Φ (mword_of_int (VRW + 0x050) : mword 64)
                (mword_of_int 42 : mword 13) Ra5 Q6 av
                ltac:(vm_compute; discriminate)
                ltac:(rewrite HQ6a5; exact (vdrw_notneg j Hj8))
                with "Hcg Hpc Hi050 [-]").
      iIntros "Hcg Hpc".
      assert (Hp054 : add_vec_int (mword_of_int (VRW + 0x050) : mword 64) 4
                      = mword_of_int (VRW + 0x054)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hp054) in "Hpc".
      (* +0x054  c.addiw s2,s2,1 *)
      iApply (wp_caddiw_s_sconf γ Φ (mword_of_int (VRW + 0x054) : mword 64) Rs2
                (mword_of_int 1 : mword 6) Q6 av
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi054 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hp056 : add_vec_int (mword_of_int (VRW + 0x054) : mword 64) 2
                      = mword_of_int (VRW + 0x056)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hp056) in "Hpc".
      (* +0x056  c.addi a2,a2,4 *)
      iApply (wp_caddi_s_sconf γ Φ (mword_of_int (VRW + 0x056) : mword 64) Ra2
                (mword_of_int 4 : mword 6) Q7 av
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi056 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hp058 : add_vec_int (mword_of_int (VRW + 0x056) : mword 64) 2
                      = mword_of_int (VRW + 0x058)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* ============ NOT FOUND: idx[i] = -1, on to the failure path ==== *)
      ...
      iApply (wp_sw_s_sconf γ Φ (mword_of_int (VRW + 0x076) : mword 64) Rs8 Ra1
                (mword_of_int 0 : mword 12) Q5 av v0 with "Hcg Hpc Hi076 [Hidx] [-]").
      { iEval (rewrite Hswa). iExact "Hidx". }
      iIntros "Hcg Hpc Hidx".
      iEval (rewrite Hswa) in "Hidx".
      assert (Hp07a : add_vec_int (mword_of_int (VRW + 0x076) : mword 64) 4
                      = mword_of_int (VRW + 0x07a)) by (apply bv_eq; vm_compute; reflexivity).
  ...
  (* =================================================================== *)
  (* P2.2b: the middle three-times loop, +0x0a8 .. (+0x0b0 | +0x07a).     *)
  (*                                                                     *)
  (*     0x0a8  addi  a2,s0,-96      -- a2 = &idx[0]                      *)
  (*     0x0ac  c.li  s2,0                                               *)
  (*     0x0ae  c.j   -> +0x05c                                          *)
  (*   then three times: [wp_vdrw_iter] and                              *)
  (*     0x058  beq   s2,s4,+88      -- i = 3 -> +0x0b0 (all three won)   *)
  (*                                                                     *)
  ...
  Lemma wp_vdrw_alloc3 (γ : gname) (Φ : mval -> iProp Σ)
    ...
    sie_cap_gpr γ M av -∗
    kernel_text -∗ pc_is (mword_of_int (VRW + 0x0a8) : mword 64) -∗
    free_bundles pd fr -∗
    vdrw_scratch sp0 -∗
    (* the continuation is UNDER A LATER: the driver's outer sleep-retry
       ...
       +0x0ae -- the first instruction this lemma runs after the loop head --
  ...
  Proof.
    ...
    iPoseProof (rwi_0ae with "Htext") as "Hi0ae".
    ...
    (* ---- +0x0a8  addi a2,s0,-96 ---- *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (VRW + 0x0a8) : mword 64) Ra2 Rs0
    ...
    assert (Hp0ac : add_vec_int (mword_of_int (VRW + 0x0a8) : mword 64) 4
                    = mword_of_int (VRW + 0x0ac)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0ac) in "Hpc".
    (* ---- +0x0ac  c.li s2,0 ---- *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (VRW + 0x0ac) : mword 64) Rs2
              (mword_of_int 0 : mword 6) (mword_of_int (Z.of_nat 0) : mword 64) D1 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi0ac [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp0ae : add_vec_int (mword_of_int (VRW + 0x0ac) : mword 64) 2
                    = mword_of_int (VRW + 0x0ae)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0ae) in "Hpc".
    (* ---- +0x0ae  c.j -> +0x05c ---- *)
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (VRW + 0x0ae) : mword 64)
              (sign_extend' 21 (concat_vec (mword_of_int 2007 : mword 11) ('b"0")))
              D2 av ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi0ae [-]").
    iNext. iIntros "Hcg Hpc".
    assert (Hj05c : add_vec (mword_of_int (VRW + 0x0ae) : mword 64)
                      (sign_extend' 64 (sign_extend' 21
                         (concat_vec (mword_of_int 2007 : mword 11) ('b"0"))))
                    = mword_of_int (VRW + 0x05c))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* ============================ ITERATION 0 ======================== *)
    iApply (wp_vdrw_iter γ Φ pd fr av 0 (pa_stk sp0 12) D2
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (VRW + 0x058) : mword 64)
              (mword_of_int 88 : mword 13) Rs4 Rs2 E0 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HE0s2 HE0s4; vm_compute; reflexivity)
              with "Hcg Hpc Hi058 [-]").
    iIntros "Hcg Hpc".
    assert (Hp05c : add_vec_int (mword_of_int (VRW + 0x058) : mword 64) 4
                    = mword_of_int (VRW + 0x05c)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    { intros r Hcs Hne. rewrite (Hag0 r ltac:(regne) ltac:(regne) ltac:(regne)
        ltac:(regne) ltac:(regne) Hne). exact (HD2cs r Hcs Hne). }
    (* ============================ ITERATION 1 ======================== *)
    iApply (wp_vdrw_iter γ Φ pd (fr_upd fr h false) av 1
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (VRW + 0x058) : mword 64)
              (mword_of_int 88 : mword 13) Rs4 Rs2 E1 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HE1s2 HE1s4; vm_compute; reflexivity)
              with "Hcg Hpc Hi058 [-]").
    iIntros "Hcg Hpc".
    iEval (rewrite Hp05c) in "Hpc".
    ...
    { intros r Hcs Hne. rewrite (Hag1 r ltac:(regne) ltac:(regne) ltac:(regne)
        ltac:(regne) ltac:(regne) Hne). exact (HE0cs r Hcs Hne). }
    (* ============================ ITERATION 2 ======================== *)
    iApply (wp_vdrw_iter γ Φ pd (fr_upd (fr_upd fr h false) m2 false) av 2
              (pa_stk sp0 11) E1
    ...
    iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (VRW + 0x058) : mword 64)
              (mword_of_int 88 : mword 13) Rs4 Rs2 E2 av
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HE2s2 HE2s4; vm_compute; reflexivity)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi058 [Hcells Hbh Hbm Hbt Hx0 Hx1 Hx2 Hxp Hcont]").
    iNext. iIntros "Hcg Hpc".
    assert (Hj0b0 : add_vec (mword_of_int (VRW + 0x058) : mword 64)
                      (sign_extend' 64 (mword_of_int 88 : mword 13))
                    = mword_of_int (VRW + 0x0b0))
      by (apply bv_eq; vm_compute; reflexivity).

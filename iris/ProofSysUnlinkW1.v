(* ProofSysUnlinkW1.v -- the unlink AU walk's BLOCK W1: the prologue,
   argstr, begin_op and NAMEIPARENT AT THE ERA CONTRACT.

     W1  +0x00 .. +0x2e   (ARM A at +0x16, ARM B at +0x2e)

   [ProofSysUnlinkPure.su_w1]'s copy-adapt, at [SysUnlinkDefs]'s contract.
...
Module SysUnlinkW1 (Argstr : ARGSTR) (BeginOp : BEGIN_OP)
  ...
  Proof.
    ...
    - (* ---------------- the path fetched: fall through ---------------- *)
      ...
      (* THE ONE-SHOT, FIRED AT THE FETCHED STRING (the statement's item 5).
         [npar_walk_pre_era] is nameiparent-generic -- it is

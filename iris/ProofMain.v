...
Section ProofMain.
  ...
  Proof.
    intros Hn.
    iIntros "Hcg #Htext #Hkdata #Hpanic #Hdev Hpc Hfree Hcpu Hlcons Hltx Hlpr".
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.main + 0x86)) (mword_of_int 1 : mword 5)
              (mword_of_int 18120 : mword 21) mth n false
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Htgtpl : add_vec (mword_of_int (KernelSyms.main + 0x86) : mword 64)
              (sign_extend' 64 (mword_of_int 18120 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.main + 0x8a)) (mword_of_int 1 : mword 5)
              (mword_of_int 18142 : mword 21) mpl n false
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Htgtph : add_vec (mword_of_int (KernelSyms.main + 0x8a) : mword 64)
              (sign_extend' 64 (mword_of_int 18142 : mword 21))
  ...
  Proof.
    ...
    iIntros "Hcg #Htext #Hkdata #Hpanic #Hdev Hpc Hfree Hcpu #Hpinv Hkenv".
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.main + 0x9a)) (mword_of_int 1 : mword 5)
              (mword_of_int 18366 : mword 21) mfi n false
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Htgtvd : add_vec (mword_of_int (KernelSyms.main + 0x9a) : mword 64)
              (sign_extend' 64 (mword_of_int 18366 : mword 21))
  ...
  Proof.
    intros Hn Hp0.
    iIntros "Hcg #Htext #Hpanic Hpc Hfree Hcpu Htcsr #Hsinv #Hwand".
  ...
  Proof.
    ...
    iApply (mn_grp_printk γd γv m1 (K - 2)%nat p0 l0 b0 Hn50
              with "Hcg Htext Hkdata Hpanic Hdev Hpc Hfree Hcpu Hlcons Hltx Hlpr
    ...
    iApply (mn_grp_fs γa γs γv γd m4 (K - 2)%nat p0 ps c0 free0
              Hn50 Hlen Hlive
              with "Hcg Htext Hkdata Hpany Hdev Hpc Hfree Hcpu Hpinv Hkenv Hlbc Hbufl
    ...
    iApply (mn_grp_started γpr γk γa γs γd γv m5 (K - 2)%nat p0 pd pav pu
              ...
              with "Hcg Htext Hpany Hpc Hfree Hcpu [Htcsr Hintr Hkpt] Hsinv Hwand Hpenv

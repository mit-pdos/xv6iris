...
Section SpBodies.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0x84)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 0x73a : mword 12) X0 (trap_res true + (av - 8))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (X1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1850 : mword 12)))]> X0).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1850 : mword 12)))]> X0) with X1.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0xa0)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 0x71e : mword 12) K0 (trap_res true + (av - 8))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (K1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (K0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1822 : mword 12)))]> K0).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (K0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1822 : mword 12)))]> K0) with K1.
  ...
  Proof.
    ...
    - (* n <> 0: spill s1/s2/s3 and enter the wait loop *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0x3e)) (mword_of_int 18 : mword 5)
                (mword_of_int 18 : mword 5) (mword_of_int 0x850 : mword 12) P2 (trap_res true + (av - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      ...
      set (P3 := <[Regidx (mword_of_int 18 : mword 5) := regval_into_reg
          (add_vec (P2 !!! Regidx (mword_of_int 18 : mword 5)) (sign_extend' 64 (mword_of_int 2128 : mword 12)))]> P2).
      change (<[Regidx (mword_of_int 18 : mword 5) := regval_into_reg
          (add_vec (P2 !!! Regidx (mword_of_int 18 : mword 5)) (sign_extend' 64 (mword_of_int 2128 : mword 12)))]> P2) with P3.
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0x46)) (mword_of_int 9 : mword 5)
                (mword_of_int 9 : mword 5) (mword_of_int 0x778 : mword 12) P4 (trap_res true + (av - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      ...
      set (P5 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
          (add_vec (P4 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1912 : mword 12)))]> P4).
      change (<[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
          (add_vec (P4 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1912 : mword 12)))]> P4) with P5.

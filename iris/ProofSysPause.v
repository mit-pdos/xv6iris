...
Section SpBodies.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0x84)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 0x77a : mword 12) X0 (trap_res true + (av - 8))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi74 [-]").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (X1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1914 : mword 12)))]> X0).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (X0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1914 : mword 12)))]> X0) with X1.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0xa0)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 0x75e : mword 12) K0 (trap_res true + (av - 8))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi90 [-]").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (K1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (K0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1886 : mword 12)))]> K0).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (K0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1886 : mword 12)))]> K0) with K1.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0x1e)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 0x7e0 : mword 12) Q0 (av - 8)%nat true
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1e [-]").
    iIntros (CIDq2 Hsq2) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (Q1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (Q0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2016 : mword 12)))]> Q0).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (Q0 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2016 : mword 12)))]> Q0) with Q1.
    ...
    - (* n <> 0: spill s1/s2/s3 and enter the wait loop *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_pause + 0x46)) (mword_of_int 9 : mword 5)
                (mword_of_int 9 : mword 5) (mword_of_int 0x7b8 : mword 12) P4 (trap_res true + (av - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi46 [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      iEval (rgne) in "Hcg".
      set (P5 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
          (add_vec (P4 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1976 : mword 12)))]> P4).
      change (<[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
          (add_vec (P4 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1976 : mword 12)))]> P4) with P5.

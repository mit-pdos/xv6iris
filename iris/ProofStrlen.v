...
Section ProofStrlen.
  ...
  (* ================================================================== *)
  Local Lemma sl_tail (γ : gname) (Φ : mval -> iProp Σ)
      (mm Mt : regfile) (K : nat) (rv sp0 ra0 s00 : mword 64) :
    (2 <= K)%nat ->
  ...
  Proof.
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x20))
              (mword_of_int 1 : mword 6) Rra Mt (K - 2)%nat ra0
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x22))
              (mword_of_int 0 : mword 6) Rs0 T1 (K - 2)%nat s00
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_caddi_sp_pop_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x24))
              (mword_of_int 16 : mword 6) T2 (K - 2)%nat 2 Hpop
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x26)) Rra T3 K
  ...
  (* ================================================================== *)
  Local Lemma sl_probe (γ : gname) (Φ : mval -> iProp Σ)
      (M : regfile) (Kv : nat) (dq : dfrac) (s : mword 64) (t : nat) (b : mword 8) :
    M !!! Regidx Ra5 = pa_add s (S t) ->
    sie_cap_gpr γ M Kv -∗
    kernel_text -∗
    pc_is (mword_of_int (KernelSyms.strlen + 0x12) : mword 64) -∗
    (pa_add s (S t)) ↦ₘ{dq} b -∗
    ( ∀ Mp : regfile,
        ⌜Mp !!! Regidx Ra3 = pa_add s (S t)⌝ -∗
        ⌜Mp !!! Regidx Ra5 = pa_add s (S (S t))⌝ -∗
        ⌜Mp !!! Regidx Ra4 = zero_extend' 64 b⌝ -∗
  ...
  Proof.
    ...
    (* ---- +0x12: c.mv a3,a5 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x12)) Ra3 Ra5 M Kv
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi12 [-]").
    iIntros "Hcg Hpc".
    set (P1 := <[Regidx Ra3 := regval_into_reg (add_vec zero_reg (M !!! Regidx Ra5))]> M).
    change (<[Regidx Ra3 := regval_into_reg (add_vec zero_reg (M !!! Regidx Ra5))]> M) with P1.
    assert (HP1a3 : P1 !!! Regidx Ra3 = pa_add s (S t)).
    { rewrite /P1 upd_eq add_vec_zero_l. exact Ha5. }
    ...
    (* ---- +0x14: c.addi a5,a5,1 ---- *)
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x14)) Ra5
              (mword_of_int 1 : mword 6) P1 Kv
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi14 [-]").
    iIntros "Hcg Hpc".
    set (P2 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (P1 !!! Regidx Ra5)
    ...
    (* ---- +0x16: lbu a4,-1(a5) ---- *)
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x16)) Ra4 Ra5
              (mword_of_int 4095 : mword 12) P2 Kv b (dqm:=dq)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi16 [Hbyte] [-]").
    { iEval (rewrite HP2a5 (sl_back s (S t))). iExact "Hbyte". }
    iIntros "Hcg Hpc Hbyte".
    iEval (rewrite HP2a5 (sl_back s (S t))) in "Hbyte".
    set (P3 := <[Regidx Ra4 := regval_into_reg (zero_extend' 64 b)]> P2).
    change (<[Regidx Ra4 := regval_into_reg (zero_extend' 64 b)]> P2) with P3.
  ...
  Proof.
    ...
    induction rem as [| rem IH]; intros t M Hsum Hnn Hsp Ha0 Ha5 Hthr;
    ...
    - (* ---- rem = 0: [S t = k], so the byte read IS the terminator ---- *)
      ...
      iApply (sl_probe γ Φ M (K - 2)%nat dq s t (f (S t)) Ha5
                with "Hcg Htext Hpc Hbyte [-]").
      iIntros (Mp) "%Hpa3 %Hpa5 %Hpa4 %Hpthr Hcg Hpc Hbyte".
      ...
      assert (Hcmp : neq_vec (Mp !!! Regidx Ra4) zero_reg = false).
      { unfold neq_vec. rewrite Hpa4 Hzero bc_zext8_iszero. reflexivity. }
      iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x1a))
                (mword_of_int 252 : mword 8) (Cregidx (mword_of_int 6)) Ra4 Mp (K - 2)%nat
      ...
      iApply (wp_subw_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x1c)) Ra0 Ra3 Ra0
                Mp (K - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi1c [-]").
      iIntros "Hcg Hpc".
      set (Q1 := <[Regidx Ra0 := regval_into_reg
                    (sign_extend' 64
                       (sub_vec (subrange_vec_dec (Mp !!! Regidx Ra3) 31 0 : mword 32)
                                (subrange_vec_dec (Mp !!! Regidx Ra0) 31 0 : mword 32)))]> Mp).
    ...
    - (* ---- rem = S rem: [S t < k], so the byte is not the terminator ---- *)
      ...
      assert (Hcmp : neq_vec (Mp !!! Regidx Ra4) zero_reg = true).
      { unfold neq_vec. rewrite Hpa4 (bc_zext8_nonzero _ Hnz). reflexivity. }
      iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x1a))
                (mword_of_int 252 : mword 8) (Cregidx (mword_of_int 6)) Ra4 Mp (K - 2)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate) Hcmp
      ...
      { intros r Hr Ncsp Ns0.
        ...
        assert (N5 : r <> Ra5) by (intro He; rewrite He in Hr; vm_compute in Hr; discriminate).
        rewrite (Hpthr r N3 N4 N5). apply Hthr; assumption. }
      iApply (IH (S t) Mp HS1 HS2 HS3 HS4 Hpa5 HS5 with "Hcg Htext Hpc Hbuf Hcont").
  Qed.
  ...
  Proof.
    ...
    iApply (wp_caddi_sp_push_s_sconf γ Φ pcE (mword_of_int 48 : mword 6) mm K 2
    ...
    { rewrite HR1sp. unfold pa_stk, add_vec_int. rewrite !pa_stk_off2.
      f_equal; try (apply bv_eq; vm_compute; reflexivity). }
    (* ---- +0x02: c.sdsp ra,8(sp) ---- *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x02))
              (mword_of_int 1 : mword 6) Rra R1 (K - 2)%nat u1
    ...
    (* ---- +0x04: c.sdsp s0,0(sp) ---- *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x04))
              (mword_of_int 0 : mword 6) Rs0 R1 (K - 2)%nat u2
    ...
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x06))
              (Cregidx (mword_of_int 0)) (mword_of_int 4 : mword 8) Rs0 R1 (K - 2)%nat
    ...
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x08)) Ra5 Ra0
              (mword_of_int 0 : mword 12) R2 (K - 2)%nat (f 0%nat : mword 8) (dqm:=dq)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    { (* --- s[0] is the NUL: k = 0, take the branch to +0x28 --- *)
      ...
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x0c))
                (mword_of_int 14 : mword 8) (Cregidx (mword_of_int 7)) Ra5 R3 (K - 2)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
      ...
      (* ---- +0x28: c.li a0,0 ---- *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x28)) Ra0
      ...
      (* ---- +0x2a: c.j -0x0a -> +0x20 ---- *)
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x2a))
                (sign_extend' 21 (concat_vec (mword_of_int 2043 : mword 11) ('b"0")))
                Z1 (K - 2)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi2a [-]").
      iNext. iIntros "Hcg Hpc".
      ...
      iApply (sl_tail γ Φ mm Z1 K (mword_of_int (Z.of_nat k)) sp0
                (mm !!! Regidx Rra) (mm !!! Regidx Rs0)
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x0c))
              (mword_of_int 14 : mword 8) (Cregidx (mword_of_int 7)) Ra5 R3 (K - 2)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    (* ---- +0x0e: addi a5,a0,1 ---- *)
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (KernelSyms.strlen + 0x0e)) Ra5 Ra0
              (mword_of_int 1 : mword 12) R3 (K - 2)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi0e [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (sl_loop γ Φ mm n k f K dq s sp0 Hkn Hcstr Hk31
              (k - 1)%nat 0%nat R4 ltac:(lia)
    ...
    iIntros (Mt) "%Htsp %Hta0 %Htthr Hcg Hpc Hbuf".
    iApply (sl_tail γ Φ mm Mt K (mword_of_int (Z.of_nat k)) sp0
              (mm !!! Regidx Rra) (mm !!! Regidx Rs0)
              HK ltac:(reflexivity) ltac:(reflexivity) ltac:(reflexivity)
              Htsp Hta0 Htthr
              with "Hcg Htext Hpc Hb1 Hb2 [-]").

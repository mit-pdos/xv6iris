...
Section WpSmodePtMemLeaves.
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0
  ...
  Proof.
    ...
    iApply (wp_instr_s_config_tlbinv_pt root_ppn Φ pc false (LOAD (imm, Regidx rs1, Regidx rd, false, 8))
              mstatus0 mie_v mdv0 menvcfg0
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hinstr").
    iIntros (σ Hpceq)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0
  ...
  Proof.
    ...
    iApply (wp_instr_s_config_tlbinv_pt root_ppn Φ pc false (STORE (imm, Regidx rs2, Regidx rs1, 8))
              mstatus0 mie_v mdv0 menvcfg0
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hinstr").
    iIntros (σ Hpceq)

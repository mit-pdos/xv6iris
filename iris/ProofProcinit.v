...
Section ProofProcinit.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.procinit + 0x7c)) rai (mword_of_int 0x1ff2be : mword 21)
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.procinit + 0x18)) a1i a1i (mword_of_int 0x8b6 : mword 12)
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.procinit + 0x24)) rai (mword_of_int 0x1ff316 : mword 21)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.procinit + 0x2c)) a1i a1i (mword_of_int 0x8aa : mword 12)
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.procinit + 0x38)) rai (mword_of_int 0x1ff302 : mword 21)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.procinit + 0x48)) s6i s6i (mword_of_int 0x89e : mword 12)

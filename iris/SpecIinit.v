...
Definition itable_name_str : Z := 0x80007448.
Definition inode_name_str : Z := 0x80007450.

(* ------------------------------------------------------------------ *)

Definition wp_iinit_sconf_body `{!riscvGS Σ, !xv6G Σ} `{GEN : GenId} `{CID : CpuId} `{XI : CurCtx} (m : regfile) (K : nat)

...
Section ProofFreeDesc.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.free_desc + 0x26)) a5_idx a5_idx
              (mword_of_int 0xd94 : mword 12) V2 n b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (fdi_26 with "Htext"). }
    iIntros (CIDc3 Hc3) "Hcg Hpc".
    set (V3 := <[Regidx a5_idx := regval_into_reg
        (add_vec (rget V2 a5_idx) (sign_extend' 64 (mword_of_int 3476 : mword 12)))]> V2).
    change (<[Regidx a5_idx := regval_into_reg
        (add_vec (rget V2 a5_idx) (sign_extend' 64 (mword_of_int 3476 : mword 12)))]> V2) with V3.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.free_desc + 0x12)) a5_idx a5_idx
              (mword_of_int 0xda8 : mword 12) A3 (K - 2)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (fdi_12 with "Htext"). }
    iIntros (CIDd8 Hd8) "Hcg Hpc".
    set (A4 := <[Regidx a5_idx := regval_into_reg
        (add_vec (rget A3 a5_idx) (sign_extend' 64 (mword_of_int 3496 : mword 12)))]> A3).
    change (<[Regidx a5_idx := regval_into_reg
        (add_vec (rget A3 a5_idx) (sign_extend' 64 (mword_of_int 3496 : mword 12)))]> A3) with A4.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.free_desc + 0x4e)) a0_idx a0_idx
              (mword_of_int 0xd84 : mword 12) E0 (K - 2)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (fdi_4e with "Htext"). }
    iIntros (CIDd14 Hd14) "Hcg Hpc".
    set (E1 := <[Regidx a0_idx := regval_into_reg
        (add_vec (rget E0 a0_idx) (sign_extend' 64 (mword_of_int 3460 : mword 12)))]> E0).
    change (<[Regidx a0_idx := regval_into_reg
        (add_vec (rget E0 a0_idx) (sign_extend' 64 (mword_of_int 3460 : mword 12)))]> E0) with E1.
    ...
    (* ---- +0x52: jal ra,wakeup ---- *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.free_desc + 0x52)) ra_idx (mword_of_int 2082962 : mword 21)
              E1 (K - 2)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Hjwk : add_vec (mword_of_int (KernelSyms.free_desc + 0x52) : mword 64)
                     (sign_extend' 64 (mword_of_int 2082962 : mword 21))

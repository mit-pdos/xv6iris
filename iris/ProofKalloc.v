...
Section ProofKalloc.
  ...
  Proof using .
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.kalloc + 0x0e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x8b8 : mword 12)
    ...
    assert (Hldaddr : add_vec (R6 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 0x8c4 : mword 12)) = fl).
    { rewrite Hs1R6 Hfl. apply bv_eq; vm_compute; reflexivity. }
    iApply (wp_ld_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.kalloc + 0x1a)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 0x8c4 : mword 12)
    ...
    - (* ===== EMPTY: head=nullp, taken to +0x4c ===== *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.kalloc + 0x50)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x876 : mword 12)
                E1 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      { iApply (kai_50 with "Htext"). }
      iApply wp_next_off_intro.
      iIntros "Hcg Hpc".
      set (E2 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (E1 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2166 : mword 12)))]> E1).
    ...
    - (* ===== NONEMPTY: head=pg, pop + release + memset(p,5,4096) ===== *)
      ...
      assert (Hstaddr : add_vec (R9 !!! Regidx (mword_of_int 14 : mword 5)) (sign_extend' 64 (mword_of_int 0x8b8 : mword 12)) = fl).
      { rewrite Ha4R9 Hfl. apply bv_eq; vm_compute; reflexivity. }
      iApply (wp_sd_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.kalloc + 0x26)) (mword_of_int 15 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 0x8b8 : mword 12)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.kalloc + 0x2e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x898 : mword 12)
      ...
      iIntros "Hcg Hpc".
      iEval (rgne) in "Hcg".
      set (R11 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (R10 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2200 : mword 12)))]> R10).

...
Section ProofReleasesleep.
  ...
  Proof.
    ...
    (* +0x14 jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.releasesleep + 0x14)) (mword_of_int 1 : mword 5) (mword_of_int 2083870 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.releasesleep + 0x14) : mword 64) (sign_extend' 64 (mword_of_int 2083870 : mword 21)) = mword_of_int KernelSyms.acquire)
    ...
    iDestruct (cpu_own_transport CID CID10 0%nat b pme b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Acquire.wp_acquire_sconf kt γl "sleep lock"%string (sl_res_gen γsl slk R H) Kacq
    ...
    iApply (wp_sw_zero_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.releasesleep + 0x18)) (mword_of_int 9 : mword 5) (mword_of_int 0 : mword 12) Macq (trap_res b + (av - 4))%nat v false
    ...
    iApply (wp_sw_zero_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.releasesleep + 0x1c)) (mword_of_int 9 : mword 5) (mword_of_int 0x28 : mword 12) Macq (trap_res b + (av - 4))%nat pd false
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.releasesleep + 0x22)) (mword_of_int 1 : mword 5) (mword_of_int 2088870 : mword 21)
    ...
    assert (Htgtwk : add_vec (mword_of_int (KernelSyms.releasesleep + 0x22) : mword 64) (sign_extend' 64 (mword_of_int 2088870 : mword 21)) = mword_of_int KernelSyms.wakeup)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (Wakeup.wp_wakeup_sconf kt (CID := CIDacq)  Cwk γs pme 1%nat (trap_res b + (av - 4))%nat b false
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.releasesleep + 0x28)) (mword_of_int 1 : mword 5) (mword_of_int 2083986 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.releasesleep + 0x28) : mword 64) (sign_extend' 64 (mword_of_int 2083986 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (Release.wp_release_sconf kt γl (sl_lk slk) "sleep lock"%string (sl_res_gen γsl slk R H) Krel

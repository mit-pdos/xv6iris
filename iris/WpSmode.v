...
End FetchRVC2_S.
  ...
  Lemma fetch_from_pts_minstret_RVC2_S
      ...
      (pmar0 : list PMA_Region) (b : bool) (misa0 : mword 64) (s : mstate) {dq : dfrac} :
    ...
    PC ↦ᵣ pc -∗ cur_privilege ↦ᵣ Supervisor -∗ misa ↦ᵣ misa0 -∗
  ...
  Lemma wp_kernel_smode1
      ...
      ▷ ( (∃ (mf' : gmap register_bitvector_64 (mword 64)) (mstf' : mword 64),
            ...
            elp ↦ᵣ celpv lpe mstatus1 ∗ mcountinhibit ↦ᵣ mc ∗ minstretcfg ↦ᵣ mcfg ∗
  ...
  Proof.
    ...
    iDestruct 1 as (mf mstf)
      "(Hpc & Hnpc & Hfile & %Hsp & Hmisa & Hmh & Hmi & Hmst & Hpriv & %Hnpriv & Hhs & Hmdl & Hms & Hmepc &
        Hsatp & Help & Hsec & Hmcinh & Hmcfg & Hpmpc & Hpmpaddr & Hmie & Hpma & Hhtif & H)".
    ...
    iApply (wp_smode_caddi (mword_of_int 0x80000e82) (mword_of_int 0x1141 : mword 16) rd imm6
              ...
              pmar0 bb (celpv lpe mstatus1) E (dq := DfracDiscarded) Φ

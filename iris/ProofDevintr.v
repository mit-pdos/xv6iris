...
Section ProofDevintr.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.devintr + 0x64)) ra_idx (mword_of_int 12248 : mword 21)
              T0 k false
    ...
    assert (Hjpc : add_vec (mword_of_int (KernelSyms.devintr + 0x64) : mword 64)
                     (sign_extend' 64 (mword_of_int 12248 : mword 21))
  ...
  Proof.
    ...
    - (* ------------------- scause == 0x...9: the PLIC arm ---------------- *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.devintr + 0x2c)) ra_idx (mword_of_int 12272 : mword 21)
                A5 (av - 4)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi2c [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      ...
      assert (Hjclaim : add_vec (mword_of_int (KernelSyms.devintr + 0x2c) : mword 64)
                          (sign_extend' 64 (mword_of_int 12272 : mword 21))
      ...
      + (* ---------------- irq = uart_irq_id = 10 ---------------- *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.devintr + 0x48)) ra_idx (mword_of_int 2090082 : mword 21)
                  B3 (av - 4)%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi48 [-]").
        iApply wp_next_off_intro. iIntros "Hcg Hpc".
        ...
        assert (Hjui : add_vec (mword_of_int (KernelSyms.devintr + 0x48) : mword 64)
                         (sign_extend' 64 (mword_of_int 2090082 : mword 21))
      ...
      + (* ---------------- irq = virtio_irq_id = 1 ---------------- *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.devintr + 0x4e)) ra_idx (mword_of_int 13446 : mword 21)
                  V0 (av - 4)%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi4e [-]").
        iApply wp_next_off_intro. iIntros "Hcg Hpc".
        ...
        assert (Hjvi : add_vec (mword_of_int (KernelSyms.devintr + 0x4e) : mword 64)
                         (sign_extend' 64 (mword_of_int 13446 : mword 21))

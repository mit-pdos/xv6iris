(* UCodeEcho.v -- the CODE CATALOG of the user program [echo].
   ...
   regenerates and then FAILS if anything moved.  This file alone is
     ...
     tools/gen_ucode.py --module Echo --spec tools/ucode_echo.txt --out \
         iris/UCodeEcho.v
   ...
   Two premises carry every [uinstr] lemma:
     ...
     [echo_text_layout pt]
                       -- the pure page-table fact: each of the 1 page(s) of
                          ...
                          (UEcho*.v / UkEcho*.v), which is also where a predicate
...
(* [UserHeap.uinstr_is] is the SEPARATION-LOGIC instruction resource: the
   ...
   each byte of the window is a concrete [echo_bytes] lookup transported by
   [echo_text_sub]; and the X-and-not-W verdict for the window's addresses

...
Section WpCallMycpu.
  ...
  Lemma wp_call_mycpu_r (R : s_regime) (γ : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iApply (wp_jal_gpr_s_zca_r R γ Φ P (mword_of_int 1) jimm m (1/2)%Qp
  ...
  Lemma wp_call_mycpu_scfg_cs_r (R : s_regime) (γ : gname) (Φ : mval -> iProp Σ)
      (P : mword 64) (jimm : mword 21)
      (m : gmap regidx (mword 64))
      :
    let ra_idx : mword 5 := mword_of_int 1 in
  ...
  Proof.
    ...
    iApply (wp_call_mycpu_r R γ Φ P jimm m

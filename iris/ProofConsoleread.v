...
Section ProofConsoleread.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CR + 0x100)) Ra0 Ra0 (mword_of_int 28 : mword 12)
              X1 (trap_res true + (av - 12))%nat false ltac:(nz) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cnri_100 with "Ht"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (X2 := <[Regidx Ra0 := regval_into_reg
        (add_vec (X1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 28 : mword 12)))]> X1).
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CR + 0x7a)) Ra4 Ra4 (mword_of_int 162 : mword 12)
              H1 (trap_res true + (av - 12))%nat false ltac:(nz) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cnri_07a with "Ht"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (H2 := <[Regidx Ra4 := regval_into_reg
        (add_vec (H1 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 162 : mword 12)))]> H1).
    ...
    first [ intros Hc; exfalso; lia | intros _; reflexivity ].
      ...
      assert (HE1ra : add_vec (E1 !!! Regidx Ra4)
                        (sign_extend' 64 (mword_of_int 202 : mword 12)) = a_cons_r).
      ...
      iApply (wp_sw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (CR + 0xea)) Ra5 Ra4 (mword_of_int 202 : mword 12)
    ...
    iApply (wp_jal_s_sconf (mword_of_int (CR + 0xa8)) Rra (mword_of_int 8340 : mword 21)
    ...
    assert (Hjeco : add_vec (mword_of_int (CR + 0xa8) : mword 64)
                      (sign_extend' 64 (mword_of_int 8340 : mword 21))
  ...
  Proof.
    ...
    (* ---- +0x4c jal ra,killed ---- *)
    iApply (wp_jal_s_sconf (mword_of_int (CR + 0x4c)) Rra (mword_of_int 8124 : mword 21)
    ...
    assert (Hjkl : add_vec (mword_of_int (CR + 0x4c) : mword 64)
                     (sign_extend' 64 (mword_of_int 8124 : mword 21))
    ...
    { (* ======= KILLED: release and return -1 at +0xc0 ======= *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (CR + 0xc4)) Ra0 Ra0 (mword_of_int 88 : mword 12)
                K1 (trap_res true + (av - 12))%nat false ltac:(nz) ltac:(rdok)
                with "Hcg Hpc []").
      { iApply (cnri_0c4 with "Ht"). }
      iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
      set (K2 := <[Regidx Ra0 := regval_into_reg
          (add_vec (K1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 88 : mword 12)))]> K1).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (CR + 0x54)) Rra (mword_of_int 7516 : mword 21)
    ...
    assert (Hjsp : add_vec (mword_of_int (CR + 0x54) : mword 64)
                     (sign_extend' 64 (mword_of_int 7516 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (CR + 0x5e)) Rra (mword_of_int 7566 : mword 21)
    ...
    assert (Hjsl : add_vec (mword_of_int (CR + 0x5e) : mword 64)
                     (sign_extend' 64 (mword_of_int 7566 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CR + 0x20)) Ra0 Ra0 (mword_of_int 252 : mword 12)
    ...
    set (P7 := <[Regidx Ra0 := regval_into_reg
        (add_vec (P6 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 252 : mword 12)))]> P6).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CR + 0x2c)) Rs1 Rs1 (mword_of_int 240 : mword 12)
              A1 (trap_res true + (av - 12))%nat false ltac:(nz) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cnri_02c with "Ht"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (A2 := <[Regidx Rs1 := regval_into_reg
        (add_vec (A1 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 240 : mword 12)))]> A1).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CR + 0x34)) Rs2 Rs2 (mword_of_int 384 : mword 12)
              A3 (trap_res true + (av - 12))%nat false ltac:(nz) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (cnri_034 with "Ht"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (A4 := <[Regidx Rs2 := regval_into_reg
        (add_vec (A3 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 384 : mword 12)))]> A3).

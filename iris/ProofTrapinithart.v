...
Section TrapinithartBody.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.trapinithart + 0x0c)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 0x13e : mword 12)
              A0 (K - 2)%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (tii_0c with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (A1 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg (add_vec (A0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 318 : mword 12)))]> A0).
    ...
    iAssert (stack_own (KTR := KT1) (mm !!! Regidx csp_rs1) 2) with "[Hc1 Hc2]" as "Hframe".
    ...
    iApply (wp_caddi_sp_pop_s_sconf (mword_of_int (KernelSyms.trapinithart + 0x18)) (mword_of_int 16 : mword 6)
              L2 (K - 2)%nat 2 false Hpop with "Hcg Hpc [] Hframe").
    { iApply (tii_18 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".

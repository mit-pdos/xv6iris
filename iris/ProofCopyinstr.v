...
Section ProofCopyinstr.
  ...
  (* peel a register lookup through the insert tower, one layer at a time,
     then close against the base map's own fact (copyin's [lkp]). *)
  Ltac lkp :=
    repeat first
      [ rewrite upd_eq
  ...
  (* ================================================================== *)
  Local Lemma cs_epilogue (γ : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    intros Hav Hsp0 Hra0 Hs00 Hs10 Hs20 Hs30 Hs40 Hs50 Hs60 Hs70
           Hmtsp Hmta0 Hmttp Hmt8 Hmt9 Hmt10 Hmt11.
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x34))
              (mword_of_int 9 : mword 6) Rra Mt (av - 10)%nat ra0
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x36))
              (mword_of_int 8 : mword 6) Rs0 T1 (av - 10)%nat s00
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x38))
              (mword_of_int 7 : mword 6) Rs1 T2 (av - 10)%nat s10
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x3a))
              (mword_of_int 6 : mword 6) Rs2 T3 (av - 10)%nat s20
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3a Hb4 [-]").
    iIntros "Hcg Hpc Hb4". iEval (rewrite Hpa4) in "Hb4".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x3c))
              (mword_of_int 5 : mword 6) Rs3 T4 (av - 10)%nat s30
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3c Hb5 [-]").
    iIntros "Hcg Hpc Hb5". iEval (rewrite Hpa5) in "Hb5".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x3e))
              (mword_of_int 4 : mword 6) Rs4 T5 (av - 10)%nat s40
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3e Hb6 [-]").
    iIntros "Hcg Hpc Hb6". iEval (rewrite Hpa6) in "Hb6".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x40))
              (mword_of_int 3 : mword 6) Rs5 T6 (av - 10)%nat s50
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi40 Hb7 [-]").
    iIntros "Hcg Hpc Hb7". iEval (rewrite Hpa7) in "Hb7".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x42))
              (mword_of_int 2 : mword 6) Rs6 T7 (av - 10)%nat s60
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi42 Hb8 [-]").
    iIntros "Hcg Hpc Hb8". iEval (rewrite Hpa8) in "Hb8".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CIS + 0x44))
              (mword_of_int 1 : mword 6) Rs7 T8 (av - 10)%nat s70
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi44 Hb9 [-]").
    iIntros "Hcg Hpc Hb9". iEval (rewrite Hpa9) in "Hb9".
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (CIS + 0x46))
              (mword_of_int 5 : mword 6) T9 (av - 10)%nat 10 Hpop
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (CIS + 0x48)) Rra TA av
    ...
    assert (HTAs7 : TA !!! Regidx Rs7 = m !!! Regidx Rs7)
      by (rewrite Hs70; lkp).
    assert (HTAtp : TA !!! Regidx Rtp = m !!! Regidx Rtp) by lkp.
    ...
    unfold callee_saved. split_and!;
      first [ exact HTAsp | exact HTAtp | exact HTAs0 | exact HTAs1 | exact HTAs2
  ...
  (* ================================================================== *)
  Local Lemma cs_ret2c (γ : gname) (Φ : mval -> iProp Σ)
      (M : regfile) (Kv : nat) (a5v resv : mword 64) :
    M !!! Regidx Ra5 = a5v ->
  ...
  Proof.
    ...
    (* ---- +0x2c: xori a5,a5,1 ---- *)
    iApply (wp_xori_s_sconf γ Φ (mword_of_int (CIS + 0x2c)) Ra5 Ra5
              (mword_of_int 1 : mword 12) fl M Kv
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite /fl Ha5; reflexivity)
              with "Hcg Hpc Hi2c [-]").
    iIntros "Hcg Hpc".
    ...
    iDestruct (sie_cap_gpr_x0 γ N1 Kv Rx0 ltac:(vm_compute; reflexivity) with "Hcg")
      as "[%Hz0 Hcg]".
    iApply (wp_subw_s_sconf γ Φ (mword_of_int (CIS + 0x30)) Ra0 Rx0 Ra5 N1 Kv
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi30 [-]").
    iIntros "Hcg Hpc".
    set (N2 := <[Regidx Ra0 := regval_into_reg
                  (sign_extend' 64 (sub_vec (subrange_vec_dec (N1 !!! Regidx Rx0) 31 0 : mword 32)
                                            (subrange_vec_dec (N1 !!! Regidx Ra5) 31 0 : mword 32)))]> N1).
    ...
    { rewrite /N2 upd_eq HN1x0 HN1a5 /fl.
  ...
  Proof.
    ...
    induction rest as [| rest IH];
      intros i M f Hsum Hin Hnul Ha5 Ha3 Ha2 Hthr; [ exfalso; lia |].
    ...
    (* ---- +0x88: c.mv a1,a5 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x88)) Ra1 Ra5 M Kv
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi88 [-]").
    iIntros "Hcg Hpc".
    set (I1 := <[Regidx Ra1 := regval_into_reg (add_vec zero_reg (M !!! Regidx Ra5))]> M).
    ...
    iApply (wp_add_s_sconf γ Φ (mword_of_int (CIS + 0x8a)) Ra4 Ra2 Ra5
              (pa_add srcp i) I1 Kv
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HI1a2 HI1a5; apply pa_add_delta)
              with "Hcg Hpc Hi8a [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (CIS + 0x8e)) Ra4 Ra4
              (mword_of_int 0 : mword 12) I2 Kv (fsrc i : mword 8) (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi8e [Hsb] [-]").
    { iEval (rewrite HI2a4 addv_sext0). iExact "Hsb". }
    iIntros "Hcg Hpc Hsb".
    iEval (rewrite HI2a4 addv_sext0) in "Hsb".
    ...
    - (* ============ the NUL: branch to +0x26 ============ *)
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (CIS + 0x92))
                (mword_of_int 202 : mword 8) (Cregidx (mword_of_int 6)) Ra4 I3 Kv
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HI3a4 Hz; exact bc_zext8_iszero)
    ...
    - (* ============ a real byte: copy it and go on ============ *)
      iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (CIS + 0x92))
                (mword_of_int 202 : mword 8) (Cregidx (mword_of_int 6)) Ra4 I3 Kv
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HI3a4; exact (bc_zext8_nonzero _ Hnz))
                with "Hcg Hpc Hi92 [-]").
      iIntros "Hcg Hpc".
      ...
      iDestruct (bb_byte_acc dst maxn (done + i) f (DfracOwn 1) Hdi with "Hdst")
        as "[Hdb Hdback]".
      iApply (wp_sb_s_sconf γ Φ (mword_of_int (CIS + 0x94)) Ra4 Ra5
                (mword_of_int 0 : mword 12) I3 Kv (f (done + i)%nat)
                with "Hcg Hpc Hi94 [Hdb] [-]").
      { iEval (rewrite HI3a5 addv_sext0 Hcur). iExact "Hdb". }
      iIntros "Hcg Hpc Hdb".
      iEval (rewrite HI3a5 addv_sext0 Hcur HI3a4 trunc8_zext8) in "Hdb".
      ...
      (* ---- +0x98: c.addi a5,a5,1 ---- *)
      iApply (wp_caddi_s_sconf γ Φ (mword_of_int (CIS + 0x98)) Ra5
                (mword_of_int 1 : mword 6) I3 Kv
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi98 [-]").
      iIntros "Hcg Hpc".
      set (I4 := <[Regidx Ra5 := regval_into_reg
                    (add_vec (I3 !!! Regidx Ra5)
      ...
      + (* ------- the chunk is done: fall through to +0x9e ------- *)
        iApply (wp_bne_fall_s_sconf γ Φ (mword_of_int (CIS + 0x9a))
                  (mword_of_int 8174 : mword 13) Ra3 Ra5 I4 Kv
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HI4a5 HI4a3; unfold neq_vec;
        ...
        (* ---- +0x9e: c.j -0x54 -> +0x4a ---- *)
        iApply (wp_cj_s_sconf γ Φ (mword_of_int (CIS + 0x9e))
                  (sign_extend' 21 (concat_vec (mword_of_int 2006 : mword 11) ('b"0")))
                  I4 Kv ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi9e [-]").
        iNext. iIntros "Hcg Hpc".
      ...
      + (* ------- more bytes in this chunk: take the back edge ------- *)
        iApply (wp_bne_taken_s_sconf γ Φ (mword_of_int (CIS + 0x9a))
                  (mword_of_int 8174 : mword 13) Ra3 Ra5 I4 Kv
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HI4a5 HI4a3; unfold neq_vec;
                        rewrite (pa_add_eqb _ (S i) n HSi64 Hn64);
        ...
        iApply (IH (S i) I4 (bb_upd f (done + i)%nat (fsrc i))
  ...
  Local Lemma cs_loop (γ : gname) (Φ : mval -> iProp Σ)
      (P : uptd) (K : nat) (dst spr : mword 64) (maxn : nat)
      (vtp v8 v9 v10 v11 : mword 64) :
    (20 <= K)%nat ->
    (Z.of_nat maxn < 18446744073709551616)%Z ->
    forall (fuel done rem : nat) (m : regfile) (f : nat -> bv 8),
  ...
  Proof.
    ...
    induction fuel as [| fuel IH];
      intros done rem m f Hfuel Hrem Hsum Hnul Hsp Htp Hs1 Hs3 Hs4 Hs5 Hs6 Hs8 Hs9 Hs10 Hs11;
      [ exfalso; lia |].
    ...
    iApply (wp_and_s_sconf γ Φ (mword_of_int (CIS + 0x5e)) Rs2 Rs7 Rs6 va0 m (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs6; reflexivity)
              with "Hcg Hpc Hi5e [-]").
    iIntros "Hcg Hpc".
    ...
    (* ---- +0x62: c.mv a1,s2 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x62)) Ra1 Rs2 W1 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi62 [-]").
    iIntros "Hcg Hpc".
    set (W2 := <[Regidx Ra1 := regval_into_reg (add_vec zero_reg (W1 !!! Regidx Rs2))]> W1).
    ...
    (* ---- +0x64: c.mv a0,s5 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x64)) Ra0 Rs5 W2 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi64 [-]").
    iIntros "Hcg Hpc".
    set (W3 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (W2 !!! Regidx Rs5))]> W2).
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (CIS + 0x66)) Rra
              (mword_of_int 2095816 : mword 21) W3 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi66 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (Walkaddr.wp_walkaddr_sconf γ Φ W4 t m_ad (K - 10)%nat (DfracOwn 1)
              ltac:(lia) HW4root Hrep with "Hcg Htext Hpc Hptree [-]").
    iIntros (mw) "Hcg Hpc Hptree %Hwcs %Hwv".
    ...
    assert (Hmwtp : mw !!! Regidx Rtp = vtp).
    { rewrite (callee_saved_lookup Hwcs Rtp ltac:(vm_compute; reflexivity)). lkp. }
    ...
    - (* =============== UNMAPPED: return -1 =============== *)
      ...
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (CIS + 0x6a))
                (mword_of_int 29 : mword 8) (Cregidx (mword_of_int 2)) Ra0 mw (K - 10)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite Ha0z; exact bc_moi_iszero)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi6a [-]").
      iNext. iIntros "Hcg Hpc".
      ...
      (* ---- +0xa4: c.li a0,-1 ---- *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (CIS + 0xa4)) Ra0
                (mword_of_int 63 : mword 6) (mword_of_int (-1) : mword 64) mw (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      (* ---- +0xa6: c.j -0x72 -> +0x34 ---- *)
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (CIS + 0xa6))
                (sign_extend' 21 (concat_vec (mword_of_int 1991 : mword 11) ('b"0")))
                U1 (K - 10)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hia6 [-]").
      iNext. iIntros "Hcg Hpc".
    ...
    - (* =============== MAPPED: borrow the page =============== *)
      ...
      iAssert (∀ (mb : regfile) (n : nat),
          ...
          ⌜mb !!! Regidx Rs10 = v10⌝ -∗
          ⌜mb !!! Regidx Rs11 = v11⌝ -∗
          sie_cap_gpr γ mb (K - 10)%nat -∗
          pc_is (mword_of_int (CIS + 0x78) : mword 64) -∗
          WP (Loop : expr riscv_lang) {{ Φ }})%I
        with "[Hdst Hpg Hback Hcont]" as "BODY".
      { iIntros (mb n) "%Hn1 %Hnrem %Hnoff %Hba3 %Hba0 %Hbsp %Hbtp %Hbs1 %Hbs2 %Hbs3
        ...
        iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (CIS + 0x78))
                  (mword_of_int 24 : mword 8) (Cregidx (mword_of_int 5)) Ra3 mb (K - 10)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite Hba3; exact (bc_moi_nonzero n Hn64 ltac:(lia)))
                  with "Hcg Hpc Hi78 [-]").
        iIntros "Hcg Hpc".
        ...
        (* ---- +0x7a: add a2,a0,s7 ---- *)
        iApply (wp_add_s_sconf γ Φ (mword_of_int (CIS + 0x7a)) Ra2 Ra0 Rs7
                  (add_vec (page_base (pte_ppn w)) cur) mb (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(rewrite Hba0 Hbs7; reflexivity)
                  with "Hcg Hpc Hi7a [-]").
        iIntros "Hcg Hpc".
        ...
        iApply (wp_sub_s_sconf γ Φ (mword_of_int (CIS + 0x7e)) Ra2 Ra2 Rs2
                  (pa_add (page_base (pte_ppn w)) off) C1 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(assert (HC1a2 : C1 !!! Regidx Ra2
        ...
        (* ---- +0x82: c.mv a5,s1 ---- *)
        iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x82)) Ra5 Rs1 C2 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi82 [-]").
        iIntros "Hcg Hpc".
        set (C3 := <[Regidx Ra5 := regval_into_reg (add_vec zero_reg (C2 !!! Regidx Rs1))]> C2).
        ...
        iApply (wp_csub_s_sconf γ Φ (mword_of_int (CIS + 0x84)) Ra2 Rs1 C3 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi84 [-]").
        iIntros "Hcg Hpc".
        set (C4 := <[Regidx Ra2 := regval_into_reg
                      (sub_vec (C3 !!! Regidx Ra2) (C3 !!! Regidx Rs1))]> C3).
        ...
        iApply (wp_cadd_s_sconf γ Φ (mword_of_int (CIS + 0x86)) Ra3 Rs1 C4 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi86 [-]").
        iIntros "Hcg Hpc".
        set (C5 := <[Regidx Ra3 := regval_into_reg
                      (add_vec (C4 !!! Regidx Ra3) (C4 !!! Regidx Rs1))]> C4).
        ...
        { rewrite /C5 upd_ne; [| reg_neq]. rewrite /C4 upd_eq.
        ...
        (* ---- the inner loop ---- *)
        iApply (cs_inner γ Φ dst (pa_add (page_base (pte_ppn w)) off) maxn done n
                  (fun j => fpg (off + j)%nat) (K - 10)%nat C5
                  Hdn Hmax64 n 0%nat C5 f
        ...
        { (* ---------- the NUL exit, at +0x26 ---------- *)
          ...
          assert (Hcur : pa_add (pa_add dst done) i' = pa_add dst (done + i'))
            by apply pa_add_assoc.
          iDestruct (sie_cap_gpr_x0 γ Mn (K - 10)%nat Rx0 ltac:(vm_compute; reflexivity)
                       with "Hcg") as "[%Hz0 Hcg]".
          iDestruct (bb_byte_acc dst maxn (done + i') g (DfracOwn 1) Hdi with "Hdst")
            as "[Hdb Hdback]".
          iApply (wp_sb_s_sconf γ Φ (mword_of_int (CIS + 0x26)) Rx0 Ra5
                    (mword_of_int 0 : mword 12) Mn (K - 10)%nat (g (done + i')%nat)
                    with "Hcg Hpc Hi26 [Hdb] [-]").
          { iEval (rewrite Hna5 addv_sext0 Hcur). iExact "Hdb". }
          iIntros "Hcg Hpc Hdb".
          iEval (rewrite Hna5 addv_sext0 Hcur Hz0 trunc8_zero) in "Hdb".
          ...
          (* ---- +0x2a: c.li a5,1 ---- *)
          iApply (wp_cli_s_sconf γ Φ (mword_of_int (CIS + 0x2a)) Ra5
                    (mword_of_int 1 : mword 6) (mword_of_int 1 : mword 64) Mn (K - 10)%nat
                    ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                    ltac:(apply bv_eq; vm_compute; reflexivity)
                    with "Hcg Hpc Hi2a [-]").
          iIntros "Hcg Hpc".
          ...
          (* ---- +0x2c .. +0x30 ---- *)
          iApply (cs_ret2c γ Φ G1 (K - 10)%nat (mword_of_int 1 : mword 64)
                    (mword_of_int 0 : mword 64)
                    ltac:(rewrite /G1 upd_eq; reflexivity)
                    ltac:(left; split; [exact cs_xor_1 | reflexivity])
                    with "Hcg Htext Hpc [-]").
          iIntros (Mo) "%Hoa0 %Hothr Hcg Hpc".
          ...
          { rewrite (Hothr Rtp ltac:(reg_neq) ltac:(reg_neq)).
            rewrite /G1 upd_ne; [| reg_neq].
            rewrite (Hnthr Rtp ltac:(reg_neq) ltac:(reg_neq) ltac:(reg_neq)). lkp. }
        ...
        { (* ---------- the chunk-done exit, at +0x4a ---------- *)
          ...
          assert (Hctp : Mc !!! Regidx Rtp = vtp)
            by (rewrite (Hcthr Rtp ltac:(reg_neq) ltac:(reg_neq) ltac:(reg_neq)); lkp).
          ...
          (* ---- +0x4a: addi a4,s3,-1 ---- *)
          iApply (wp_addi4_s_sconf γ Φ (mword_of_int (CIS + 0x4a)) Ra4 Rs3
                    (mword_of_int 4095 : mword 12) Mc (K - 10)%nat
                    ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                    with "Hcg Hpc Hi4a [-]").
          iIntros "Hcg Hpc".
          set (D1 := <[Regidx Ra4 := regval_into_reg
                        (add_vec (Mc !!! Regidx Rs3)
          ...
          { rewrite /D1 upd_eq Hcs3.
            exact (bc_add_m1_nat rem _ Hm1 ltac:(lia) Hrem64). }
          assert (HD1s1 : D1 !!! Regidx Rs1 = pa_add dst done) by lkp.
          (* ---- +0x4e: c.add a4,a4,s1 ---- *)
          iApply (wp_cadd_s_sconf γ Φ (mword_of_int (CIS + 0x4e)) Ra4 Rs1 D1 (K - 10)%nat
                    ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                    with "Hcg Hpc Hi4e [-]").
          iIntros "Hcg Hpc".
          set (D2 := <[Regidx Ra4 := regval_into_reg
                        (add_vec (D1 !!! Regidx Ra4) (D1 !!! Regidx Rs1))]> D1).
          ...
          { rewrite /D2 upd_eq HD1a4 HD1s1. apply pa_add_comm. }
          ...
          { apply (Z.le_lt_trans _ (Z.of_nat rem)); [apply Nat2Z.inj_le; lia | exact Hrem64]. }
          iApply (wp_sub_s_sconf γ Φ (mword_of_int (CIS + 0x50)) Rs3 Ra4 Ra1
                    (mword_of_int (Z.of_nat (rem - n)) : mword 64) D2 (K - 10)%nat
                    ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                    ltac:(rewrite HD2a4 HD2a1;
          ...
          iApply (wp_add_s_sconf γ Φ (mword_of_int (CIS + 0x54)) Rs7 Rs2 Rs4
                    (add_vec va0 (mword_of_int 4096)) D3 (K - 10)%nat
                    ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                    ltac:(assert (E1 : D3 !!! Regidx Rs2 = va0) by lkp;
          ...
          - (* ------- max exhausted with no NUL: return -1 ------- *)
            ...
            iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (CIS + 0x58))
                      (mword_of_int 72 : mword 13) Ra4 Ra1 D4 (K - 10)%nat
                      ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                      ltac:(rewrite HD4a1 HD4a4;
            ...
            (* ---- +0xa0: c.li a5,0 ---- *)
            iApply (wp_cli_s_sconf γ Φ (mword_of_int (CIS + 0xa0)) Ra5
                      (mword_of_int 0 : mword 6) (mword_of_int 0 : mword 64) D4 (K - 10)%nat
                      ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                      ltac:(apply bv_eq; vm_compute; reflexivity)
                      with "Hcg Hpc Hia0 [-]").
            iIntros "Hcg Hpc".
            ...
            (* ---- +0xa2: c.j -0x76 -> +0x2c ---- *)
            iApply (wp_cj_s_sconf γ Φ (mword_of_int (CIS + 0xa2))
                      (sign_extend' 21 (concat_vec (mword_of_int 1989 : mword 11) ('b"0")))
                      E1 (K - 10)%nat ltac:(vm_compute; reflexivity)
                      with "Hcg Hpc Hia2 [-]").
            iNext. iIntros "Hcg Hpc".
            ...
            iApply (cs_ret2c γ Φ E1 (K - 10)%nat (mword_of_int 0 : mword 64)
                      (mword_of_int (-1) : mword 64)
            ...
            { rewrite (Hothr Rtp ltac:(reg_neq) ltac:(reg_neq)). lkp. }
          ...
          - (* ------- more room: bump [dst] and go round again ------- *)
            iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (CIS + 0x58))
                      (mword_of_int 72 : mword 13) Ra4 Ra1 D4 (K - 10)%nat
                      ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                      ltac:(rewrite HD4a1 HD4a4;
                            rewrite (pa_add_eqb _ (n - 1) (rem - 1) Hn164 Hrm164);
            ...
            iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x5c)) Rs1 Ra5 D4 (K - 10)%nat
                      ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                      with "Hcg Hpc Hi5c [-]").
            iIntros "Hcg Hpc".
            set (D5 := <[Regidx Rs1 := regval_into_reg
                          (add_vec zero_reg (D4 !!! Regidx Ra5))]> D4).
            ...
            iApply (IH (done + n)%nat (rem - n)%nat D5 g
                      Hf1 Hf2 Hf3 Hnulg
                      HD5sp HD5tp HD5s1 HD5s3 HD5s4 HD5s5 HD5s6
                      HD5s8 HD5s9 HD5s10 HD5s11
                      with "Hcg Htext Hpc Hpt Hdst Hcont"). } }
      (* ---- +0x6a falls through: the page is mapped ---- *)
      iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (CIS + 0x6a))
                (mword_of_int 29 : mword 8) (Cregidx (mword_of_int 2)) Ra0 mw (K - 10)%nat
      ...
      (* ---- +0x6c: sub a3,s2,s7 ---- *)
      iApply (wp_sub_s_sconf γ Φ (mword_of_int (CIS + 0x6c)) Ra3 Rs2 Rs7
                (sub_vec va0 cur) mw (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hmws2 Hmws7; reflexivity)
                with "Hcg Hpc Hi6c [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cadd_s_sconf γ Φ (mword_of_int (CIS + 0x70)) Ra3 Rs4 V1 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi70 [-]").
      iIntros "Hcg Hpc".
      set (V2 := <[Regidx Ra3 := regval_into_reg
                    (add_vec (V1 !!! Regidx Ra3) (V1 !!! Regidx Rs4))]> V1).
      ...
      + (* n = 4096 - off *)
        iApply (wp_bgeu_taken_s_sconf γ Φ (mword_of_int (CIS + 0x72))
                  (mword_of_int 6 : mword 13) Ra3 Rs3 V2 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HV2s3 HV2a3;
        ...
        iApply ("BODY" $! V2 (4096 - off)%nat
                  with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] Hcg Hpc").
        { lia. } { lia. } { lia. } { exact HV2a3. }
        { lkp. } { lkp. } { lkp. } { lkp. } { lkp. } { lkp. } { lkp. }
        { lkp. } { lkp. } { lkp. } { lkp. } { lkp. } { lkp. } { lkp. }
      + (* n = rem *)
        iApply (wp_bgeu_fall_s_sconf γ Φ (mword_of_int (CIS + 0x72))
                  (mword_of_int 6 : mword 13) Ra3 Rs3 V2 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HV2s3 HV2a3;
                        rewrite (bc_ge_moi rem (4096 - off) Hrem64 Hpg64);
        ...
        (* ---- +0x76: c.mv a3,s3 ---- *)
        iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x76)) Ra3 Rs3 V2 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi76 [-]").
        iIntros "Hcg Hpc".
        set (V3 := <[Regidx Ra3 := regval_into_reg (add_vec zero_reg (V2 !!! Regidx Rs3))]> V2).
        ...
        assert (HV3a3 : V3 !!! Regidx Ra3 = (mword_of_int (Z.of_nat rem) : mword 64))
          by (rewrite /V3 upd_eq add_vec_zero_l; exact HV2s3).
        iApply ("BODY" $! V3 rem
                  with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] Hcg Hpc").
  ...
  (*  THE CAPSTONE.                                                      *)
  (* ================================================================== *)
  Lemma wp_copyinstr_sconf (γ : gname) (Φ : mval -> iProp Σ) (mm : regfile)
  ...
  Proof.
    ...
    - (* ============ max == 0: return -1 with no frame ============ *)
      ...
      iApply (wp_cbeqz_taken_s_sconf γ Φ pcE
                (mword_of_int 88 : mword 8) (Cregidx (mword_of_int 5)) Ra3 mm K
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hmaxr; rewrite (bc_eqz_moi maxn Hmax64);
      ...
      (* ---- +0xb0: c.li a5,0 ---- *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (CIS + 0xb0)) Ra5
      ...
      (* ---- +0xb2: xori a5,a5,1 ---- *)
      iApply (wp_xori_s_sconf γ Φ (mword_of_int (CIS + 0xb2)) Ra5 Ra5
                (mword_of_int 1 : mword 12) (mword_of_int 1 : mword 64) Z1 K
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(assert (E : Z1 !!! Regidx Ra5 = (mword_of_int 0 : mword 64)) by lkp;
      ...
      (* ---- +0xb6: negw a0,a5 ---- *)
      iDestruct (sie_cap_gpr_x0 γ Z2 K Rx0 ltac:(vm_compute; reflexivity) with "Hcg")
        as "[%Hz0 Hcg]".
      iApply (wp_subw_s_sconf γ Φ (mword_of_int (CIS + 0xb6)) Ra0 Rx0 Ra5 Z2 K
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hib6 [-]").
      iIntros "Hcg Hpc".
      set (Z3 := <[Regidx Ra0 := regval_into_reg
                    (sign_extend' 64 (sub_vec (subrange_vec_dec (Z2 !!! Regidx Rx0) 31 0 : mword 32)
                                              (subrange_vec_dec (Z2 !!! Regidx Ra5) 31 0 : mword 32)))]> Z2).
      ...
      iApply (wp_cret_s_sconf γ Φ (mword_of_int (CIS + 0xba)) Rra Z3 K
    ...
    - (* ============ max >= 1: push the frame and loop ============ *)
      ...
      iApply (wp_caddi16sp_push_s_sconf γ Φ (mword_of_int (CIS + 0x02))
                (mword_of_int 59 : mword 6) mm K 10
      ...
      iEval (rewrite -Hpa1) in "Hb1".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x04))
                (mword_of_int 9 : mword 6) Rra M1 (K - 10)%nat u1
      ...
      iEval (rewrite -Hpa2) in "Hb2".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x06))
                (mword_of_int 8 : mword 6) Rs0 M1 (K - 10)%nat u2
      ...
      iEval (rewrite -Hpa3) in "Hb3".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x08))
                (mword_of_int 7 : mword 6) Rs1 M1 (K - 10)%nat u3
      ...
      iEval (rewrite -Hpa4) in "Hb4".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x0a))
                (mword_of_int 6 : mword 6) Rs2 M1 (K - 10)%nat u4
      ...
      iEval (rewrite -Hpa5) in "Hb5".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x0c))
                (mword_of_int 5 : mword 6) Rs3 M1 (K - 10)%nat u5
      ...
      iEval (rewrite -Hpa6) in "Hb6".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x0e))
                (mword_of_int 4 : mword 6) Rs4 M1 (K - 10)%nat u6
      ...
      iEval (rewrite -Hpa7) in "Hb7".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x10))
                (mword_of_int 3 : mword 6) Rs5 M1 (K - 10)%nat u7
      ...
      iEval (rewrite -Hpa8) in "Hb8".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x12))
                (mword_of_int 2 : mword 6) Rs6 M1 (K - 10)%nat u8
      ...
      iEval (rewrite -Hpa9) in "Hb9".
      iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CIS + 0x14))
                (mword_of_int 1 : mword 6) Rs7 M1 (K - 10)%nat u9
      ...
      iEval (rewrite Hpa1 HM1ra) in "Hb1".
      iEval (rewrite Hpa2 HM1s0) in "Hb2".
      iEval (rewrite Hpa3 HM1s1) in "Hb3".
      iEval (rewrite Hpa4 HM1s2) in "Hb4".
      iEval (rewrite Hpa5 HM1s3) in "Hb5".
      iEval (rewrite Hpa6 HM1s4) in "Hb6".
      iEval (rewrite Hpa7 HM1s5) in "Hb7".
      iEval (rewrite Hpa8 HM1s6) in "Hb8".
      iEval (rewrite Hpa9 HM1s7) in "Hb9".
      (* ---- +0x16: c.addi4spn s0,sp,80 (s0's VALUE is never read) ---- *)
      iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (CIS + 0x16))
                (Cregidx (mword_of_int 0)) (mword_of_int 20 : mword 8) Rs0 M1 (K - 10)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
      ...
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x18)) Rs5 Ra0 M2 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi18 [-]").
      iIntros "Hcg Hpc".
      set (M3 := <[Regidx Rs5 := regval_into_reg (add_vec zero_reg (M2 !!! Regidx Ra0))]> M2).
      ...
      (* ---- +0x1a: c.mv s1,a1 -- dst ---- *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x1a)) Rs1 Ra1 M3 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi1a [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x1c)) Rs7 Ra2 M4 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi1c [-]").
      iIntros "Hcg Hpc".
      set (M5 := <[Regidx Rs7 := regval_into_reg (add_vec zero_reg (M4 !!! Regidx Ra2))]> M4).
      ...
      (* ---- +0x1e: c.mv s3,a3 -- max ---- *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CIS + 0x1e)) Rs3 Ra3 M5 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi1e [-]").
      iIntros "Hcg Hpc".
      set (M6 := <[Regidx Rs3 := regval_into_reg (add_vec zero_reg (M5 !!! Regidx Ra3))]> M5).
      ...
      iApply (wp_clui_s_sconf γ Φ (mword_of_int (CIS + 0x20)) Rs6
                (sign_extend' 20 (mword_of_int 63 : mword 6))
                (mword_of_int (-4096) : mword 64) M6 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      iApply (wp_clui_s_sconf γ Φ (mword_of_int (CIS + 0x22)) Rs4
                (sign_extend' 20 (mword_of_int 1 : mword 6))
                (mword_of_int 4096 : mword 64) M7 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (CIS + 0x24))
                (sign_extend' 21 (concat_vec (mword_of_int 29 : mword 11) ('b"0")))
                M8 (K - 10)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi24 [-]").
      iNext. iIntros "Hcg Hpc".
      ...
      { assert (E : M5 !!! Regidx Ra3 = (mword_of_int (Z.of_nat maxn) : mword 64)) by lkp.
        ...
        rewrite /M6 upd_eq add_vec_zero_l. exact E. }
      ...
      { assert (E : M2 !!! Regidx Ra0 = page_base P.(ud_root)) by lkp.
        ...
        rewrite /M4 upd_ne; [| reg_neq]. rewrite /M3 upd_eq add_vec_zero_l. exact E. }
      assert (HM8sp : M8 !!! Regidx csp_rs1 = pa_stk sp0 10) by lkp.
      (* ---- the loop ---- *)
      assert (HM8tp : M8 !!! Regidx Rtp = mm !!! Regidx Rtp) by lkp.
      ...
      iApply (cs_loop γ Φ P K dst (pa_stk sp0 10) maxn
                (mm !!! Regidx Rtp) (mm !!! Regidx Rs8) (mm !!! Regidx Rs9)
                (mm !!! Regidx Rs10) (mm !!! Regidx Rs11)
                HK Hmax64 maxn 0%nat maxn M8 dst_olds
                Hg1 Hmax1 Hg3 (bb_nonul_0 dst_olds)
                HM8sp HM8tp HM8s1 HM8s3 HM8s4 HM8s5 HM8s6
                HM8s8 HM8s9 HM8s10 HM8s11
                with "Hcg Htext Hpc Hpt Hdst [-]").
      iIntros (mj res g) "%Hjsp %Hjtp %Hj8 %Hj9 %Hj10 %Hj11 %Hja0 %Hjret Hcg Hpc Hpt Hdst".
      (* ---- the epilogue ---- *)
      iApply (cs_epilogue γ Φ mm mj K res sp0 ra0 s00 s10 s20 s30 s40 s50 s60 s70 u10
                ltac:(lia) eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl
                eq_refl eq_refl eq_refl
                Hjsp Hja0 Hjtp Hj8 Hj9 Hj10 Hj11

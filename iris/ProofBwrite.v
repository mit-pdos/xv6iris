...
Section ProofBwrite.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bwrite + 0x0e)) Rra (mword_of_int 0x13c6 : mword 21)
    ...
    assert (Htgthsl : add_vec (mword_of_int (KernelSyms.bwrite + 0x0e) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x13c6 : mword 21))
    ...
    iDestruct "Hstok" as "(Hstok & Hbown & Hbr0 & Hhold)".
    ...
    { rewrite /bstok. iFrame "Hstok Hbown Hbr0 Hhold". }
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bwrite + 0x18)) Rra (mword_of_int 0x2c60 : mword 21)
    ...
    assert (Htgtrw : add_vec (mword_of_int (KernelSyms.bwrite + 0x18) : mword 64)
                       (sign_extend' 64 (mword_of_int 0x2c60 : mword 21))

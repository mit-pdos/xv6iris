...
Section ProofCreateMain.
  ...
  Proof.
    ...
    - (* ============================================================== *)
      ...
      assert (Htgil : add_vec (mword_of_int (CK + 0x26) : mword 64)
                (sign_extend' 64 (mword_of_int 2090530 : mword 21))
                = mword_of_int KernelSyms.ilock) by pcw.
      iApply (wp_jal_s_sconf (mword_of_int (CK + 0x26)) Rra
                (mword_of_int 2090530 : mword 21) Q1 (K - 10)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi026").
      ...
      + (* ========== ARM G: the guard FIRES -- nlink == 0 ============= *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (CK + 0x86)) Rra
                  (mword_of_int 2091030 : mword 21) G1 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi086").
      ...
      + (* ====== THE GUARD FALLS THROUGH: dp->nlink <> 0 ============== *)
        ...
        assert (Htgdl : add_vec (mword_of_int (CK + 0x46) : mword 64)
                  (sign_extend' 64 (mword_of_int 2092010 : mword 21))
                  = mword_of_int KernelSyms.dirlookup) by pcw.
        iApply (wp_jal_s_sconf (mword_of_int (CK + 0x46)) Rra
                  (mword_of_int 2092010 : mword 21) D3 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi046").
        ...
        * (* ========================================================== *)
          ...
          assert (Htgup1 : add_vec (mword_of_int (CK + 0x50) : mword 64)
                    (sign_extend' 64 (mword_of_int 2091084 : mword 21))
                    = mword_of_int KernelSyms.iunlockput) by pcw.
          iApply (wp_jal_s_sconf (mword_of_int (CK + 0x50)) Rra
                    (mword_of_int 2091084 : mword 21) F2 (K - 10)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi050").
          ...
          assert (Htgil2 : add_vec (mword_of_int (CK + 0x56) : mword 64)
                    (sign_extend' 64 (mword_of_int 2090482 : mword 21))
                    = mword_of_int KernelSyms.ilock) by pcw.
          iApply (wp_jal_s_sconf (mword_of_int (CK + 0x56)) Rra
                    (mword_of_int 2090482 : mword 21) F4 (K - 10)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi056").
          ...
          { iModIntro.
            ...
            assert (Htgup2 : add_vec (mword_of_int (CK + 0x9a) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091010 : mword 21))
                      = mword_of_int KernelSyms.iunlockput) by pcw.
            iApply (wp_jal_s_sconf (mword_of_int (CK + 0x9a)) Rra
                      (mword_of_int 2091010 : mword 21) B1 (K - 10)%nat b
                      ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                      with "Hcg Hpc Hi09a").
      ...
      iDestruct "Hcmeta" as "(Hcity & Hcimaj & Hcimin & Hcinl & Hcisz)".
             ...
             iDestruct (ic_mk_loaded γfs γi cov logstart kslot cinum dnc bmc
                          datc Hciok Hcdok Hcddix Hcdoc Hcduq
             ...
             ++ (* ===== ARM F-BAD (second entry): the type is out of
                ...
                iApply ("Hfb" $! FB with
                          "[%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8
                           ...
                           Hsbb
                           Hppid Hppback Hpath Hbsl Hisl Hislr Hop Hcont").
                { exact HFBregs. }
        ...
        * (* ========================================================== *)
          ...
          iApply ("Ha" $! A1 u5 kd qd gd gild gisld dind dnl bml datl nfp nf0
                    ...
                    with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%]
                          ...
                          Hivalid Hdlnk Hdiat Hmeta Hmap Hblocks Hdview Hshotl Hfrzl Hkeep Hrud
        ...
        iApply (wp_jal_s_sconf (mword_of_int (CK + 0x90)) Rra
                  (mword_of_int 2091020 : mword 21) J1 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi090").
        iIntros (CID21 Hq21) "Hcg Hpc".
  ...
  Proof.
    ...
    iDestruct (cr_tail_half j m sp0 ret_tgt K b lks HKsum Hal10 Hal9 Hspm Hrt
                 with "Htext") as "#Htail".
    iIntros (CIDa Hsa).
    iIntros (Ma w5 kd qd gd γil γisl dind dn bm data nf nsl n1 Sb1 w).
    ...
    iIntros "Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8 Hnb14 Hnb2
             ...
             Hmeta Hmap Hblocks Hdview #Hshotl Hfrzl Hkeep Hrud
    ...
    - (* ============================================================== *)
      ...
      assert (Htgiu : add_vec (mword_of_int (CK + 0xc4) : mword 64)
                (sign_extend' 64 (mword_of_int 2090192 : mword 21))
                = mword_of_int KernelSyms.iupdate) by pcw.
      iApply (wp_jal_s_sconf (mword_of_int (CK + 0xc4)) Rra
                (mword_of_int 2090192 : mword 21) W2 (K - 10)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi0c4").
      ...
      + (* ============================================================ *)
        ...
        iApply ("Hm" $! W4 kslot q g gil gisl cinum dnc bmc datc
                  ...
                  with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%]
                        ...
                        Hcdlnk Hcdiat Hcmeta Hcmap Hcblocks Hcdview Hcshot Hcfrz
      ...
      + (* ============================================================ *)
        ...
        assert (Htgdlk : add_vec (mword_of_int (CK + 0xd8) : mword 64)
                  (sign_extend' 64 (mword_of_int 2092370 : mword 21))
                  = mword_of_int KernelSyms.dirlink) by pcw.
        iApply (wp_jal_s_sconf (mword_of_int (CK + 0xd8)) Rra
                  (mword_of_int 2092370 : mword 21) X3 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi0d8").
        ...
        * destruct Harm as (_ & Hwf' & Hholes' & Haddr' & Hsz31' &
          ...
          -- (* ======================================================== *)
             ...
             (* the PARENT'S RE-PARK: the [ilink] the mint made goes into
                the record the append just wrote.  THE FLAVOUR IS PLAIN ON
             ...
             assert (Htgu2 : add_vec (mword_of_int (CK + 0xe2) : mword 64)
                       (sign_extend' 64 (mword_of_int 2090938 : mword 21))
                       = mword_of_int KernelSyms.iunlockput) by pcw.
             iApply (wp_jal_s_sconf (mword_of_int (CK + 0xe2)) Rra
                       (mword_of_int 2090938 : mword 21) Y1 (K - 10)%nat b
                       ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                       with "Hcg Hpc Hi0e2").
             ...
             iApply ("Hcont" $! mf true true kslot (q/2)%Qp (q/2)%Qp g cinum
                       ...
                       with "[%] Hcg Hcnt Hpc Hsbn Hsbi Hsbs Hsbb Hpriv
                             ...
                             Hcmap Hcblocks Hcdview Hcfrz Hckeep Hruc]").
             { exact Hcsf. }
             ...
             iDestruct (ic_mk_loaded γfs γi cov logstart kslot cinum
                          ...
                          (dir_uniq_not_dir
                             (cr_setf dnc major minor (mword_of_int 1 : mword 16))
                             datc ltac:(rewrite cr_setf_type; exact Htdirz))
                          with "Hcdlnk1 Hcdiat Hcmeta Hca Hci Hcblocks Hcdview")
               as "Hcload".
          ...
          -- (* ======================================================== *)
             ...
             iApply ("Hf" $! mdl kslot q g gil gisl cinum dnc bmc datc
                       ...
                       with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%]
                             ...
                             Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8
                             Hnb14 Hnb2 Hslkd Hslkdd Hdep Hidev Hiinum
                             Hivalid Hdlnk Hdiat Hmeta Hmap Hblocks Hdview Hshotl
                             Hfrzl Hkeep Hrud Hslkc Hcslkd Hcdep Hcidev
                             Hciinum Hcivalid Hcdlnk Hcdiat Hcmeta Hcmap
                             Hcblocks Hcdview Hcshot Hcfrz Hckeep Hruc Hilink Hsbn Hsbi Hsbs Hsbb Hbmr
    ...
    - (* ============================================================== *)
      ...
      assert (Htgu : add_vec (mword_of_int (CK + 0xee) : mword 64)
                (sign_extend' 64 (mword_of_int 2090926 : mword 21))
                = mword_of_int KernelSyms.iunlockput) by pcw.
      iApply (wp_jal_s_sconf (mword_of_int (CK + 0xee)) Rra
                (mword_of_int 2090926 : mword 21) Z1 (K - 10)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi0ee").
  ...
  Proof.
    ...
    iIntros (Mx kslot q g gil gisl cinum dnc bmc datc bm' data' dn' dn0'
             tot n4 Sb4).
    iIntros "%HXregs %Htdir %Hkdlt %Hdib %Htydir %Hnl0 %Hiok %Hdok %Hddix %Hduq %Hkslt
    ...
    iIntros "Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8 Hnb14 Hnb2
             ...
             Hcdiat Hcmeta Hcmap Hcblocks Hcdview #Hcshot Hcfrz Hckeep Hruc Hilink
    ...
    assert (Htgiu : add_vec (mword_of_int (CK + 0x14c) : mword 64)
              (sign_extend' 64 (mword_of_int 2090056 : mword 21))
              = mword_of_int KernelSyms.iupdate) by pcw.
    iApply (wp_jal_s_sconf (mword_of_int (CK + 0x14c)) Rra
              (mword_of_int 2090056 : mword 21) G1 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi14c").
    ...
    iApply (wp_jal_s_sconf (mword_of_int (CK + 0x152)) Rra
              (mword_of_int 2090826 : mword 21) G3 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi152").
    ...
    assert (Htgu2 : add_vec (mword_of_int (CK + 0x158) : mword 64)
              (sign_extend' 64 (mword_of_int 2090820 : mword 21))
              = mword_of_int KernelSyms.iunlockput) by pcw.
    iApply (wp_jal_s_sconf (mword_of_int (CK + 0x158)) Rra
              (mword_of_int 2090820 : mword 21) G5 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi158").
  ...
  (*  child IS a directory, so the child's own [dir_links] is a real       *)
  (*  big-op rather than [emp], and the dot-dot record it may already have *)
  (*  written names the PARENT -- for which no [ilink] exists, because the *)
  (*  mint that would have paid for it is the [dp->nlink++] at +0x134 that *)
  (*  this trace never reached.                                           *)
  (*                                                                      *)
  (*  So the sibling takes the child WITHOUT its [dir_links] and builds    *)
  (*  the payload itself, out of the [sh zero,74(s3)] at +0x146: with the  *)
  (*  home's count at zero every live record takes [dir_link_at]'s GREY    *)
  (*  disjunct, whose [igrey] is minted from [ireg_inv] with nothing to    *)
  (*  give back.  That is design C1's free mint, and this is its first     *)
  (*  consumer.                                                           *)
  (* =================================================================== *)

  (* ---- (a) THE BUILDER.  One [ireg_link_grey] per live, non-self        *)
  (*      record; [dir_ok]'s [dir_inums_ok] is what bounds each target.    *)
  Lemma cr_grey_links (γi : gname) (γfs : fs_names)
      (inodestart : Z) (nib : nat) (self : Z) (dz : dinode)
      (data : nat -> list (bv 8)) (L : nat) :
    bv_unsigned (di_nlink dz) = 0 ->
    (forall k : nat, (k < L)%nat -> dir_live data k ->
       bv_unsigned (dir_inum data k) < 16 * Z.of_nat nib) ->
    ireg_inv γi γfs inodestart nib ={⊤}=∗
      ([∗ list] k ∈ seq 0 L, dir_link_at self dz data k).
  Proof.
    intro Hz. induction L as [| L IH]; intro Hin.
    - iIntros "_". iModIntro. cbn [seq]. done.
    - iIntros "#Hinv".
      iMod (IH ltac:(intros k Hk Hlv; exact (Hin k ltac:(lia) Hlv))
              with "Hinv") as "Hpre".
      iAssert (|={⊤}=> dir_link_at self dz data L)%I as ">Hlast".
      { rewrite /dir_link_at.
        destruct (dir_liveb data L
                  && negb (bool_decide (bv_unsigned (dir_inum data L) = self)))
          eqn:Hg; [| iModIntro; done].
        apply andb_prop in Hg. destruct Hg as [Hlvb _].
        assert (Hlt : bv_unsigned (dir_inum data L) < 16 * Z.of_nat nib)
          by exact (Hin L ltac:(lia) (proj1 (dir_liveb_true data L) Hlvb)).
        iMod (ireg_link_grey ⊤ γi γfs inodestart nib
                (bv_zero_extend 32 (dir_inum data L))
                ltac:(solve_ndisj)
                ltac:(rewrite cr_bzext32_16; exact Hlt)
               with "Hinv") as "Hgr".
        rewrite cr_bzext32_16.
        iModIntro. iRight. iFrame "Hgr". iPureIntro. exact Hz. }
      iModIntro. rewrite seq_S big_sepL_app.
      iSplitL "Hpre"; [iExact "Hpre" |].
      rewrite big_sepL_singleton. iExact "Hlast".
  Qed.

  (* ...and the payload-level form the re-park wants. *)
  Lemma cr_grey_dir_links (γi : gname) (γfs : fs_names)
      (inodestart : Z) (nib : nat) (self : Z) (dz : dinode)
      (data : nat -> list (bv 8)) :
    bv_unsigned (di_nlink dz) = 0 ->
    dir_ok nib dz data ->
    ireg_inv γi γfs inodestart nib ={⊤}=∗ dir_links self dz data.
  Proof.
    intros Hz Hdok. iIntros "#Hinv".
    destruct (decide (bv_unsigned (di_type dz) = T_DIR_z)) as [Hd | Hd].
    - iMod (cr_grey_links γi γfs inodestart nib self dz data _ Hz
              ltac:(exact (Hdok Hd)) with "Hinv") as "Hlinks".
      (* V2: at [nlink = 0] the count clause reads [0 <= 1 + _], so the
         orphan's payload is stocked ALL-PLAIN and the bound is free --
  ...
  Definition cr_fail_mkdir_body
    ...
    (∀ (Mx : regfile) (kslot : nat) (q : Qp) (g gil gisl : gname)
       ...
       ⌜inode_ok cov logstart dp bmp datap⌝ -∗
       ⌜dir_ok nib dp datap⌝ -∗
  ...
  Lemma cr_fail_mkdir_half
    ...
    is_lock γk d_lock "virtio_disk"%string (disk_res γd pd pav pu) -∗
    wp_next (CID0 := CID) true (proc_addr j) (fun CIDf : CpuId =>
      cr_fail_mkdir_body γs j γl γu γd γk pd pav pu bn γ γfs γi cn gtl γa γf γpr
                   cov logstart bmapstart inodestart nib ninodes size dev
                   plen pfun pv ty major minor V u Sb ns pidv
                   dqb dqs dqbs dqn m sp0 ret_tgt K eb b lks
                   kd qd gd γil γisl dind nf nsl CIDf).
  Proof.
    intros HK Hglog Hist Hnib Hnib16 Hlg Hsize Hbms0 Hbmsc Hbmsl Hist0 Hcovb
           Hiregb Hns Hj Hgs Hspm Hrt Hal10 Hal9 Heb.
    destruct (cr_kb K HK)
    ...
    (* THE GREY RE-PARK.  The store above is the home condition, and the
       tickets come out of [ireg_inv] for nothing -- design C1's free mint,
       first consumer.  It is done HERE, while the [i_nlink] cell's new
       value is still the reason, rather than at the [ic_loaded] below. *)
    iApply fupd_wp.
    iMod (cr_grey_dir_links γi γfs inodestart nib (bv_unsigned cinum)
            (cr_setf dc major minor (mword_of_int 0 : mword 16)) datc Hznl
    ...
    iAssert (ic_loaded γfs γi cov logstart kslot cinum
      ...
      with "[Hcdlnk Hcdiat Hcmeta Hcmap Hcblocks Hcdview]" as "Hcload".
  ...
  Proof.
    ...
    iIntros "Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8 Hnb14 Hnb2
             ...
             Hmeta Hmap Hblocks Hdview #Hshotl Hfrzl Hkeep Hrud
             #Hslkc Hcslkd Hcdep Hcidev Hciinum Hcivalid
             Hcdlnk Hcdiat Hcmeta Hcmap Hcblocks Hcdview #Hcshot Hcfrz Hckeep Hruc Hilink
             Hsbn Hsbi Hsbs Hsbb #Hbmr Hppid Hppback Hpath Hbsl Hislr Hop
             Hcont".
    iDestruct (cpu_own_eb_agree with "Hcg Hcnt") as %Hbm.
    assert (Hb : b = true) by (rewrite -Hbm; exact Heb). clear Hbm.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (CK + 0x100)) Ra1 Ra1
              (mword_of_int 2358 : mword 12) Z2 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi100").
    iIntros (CIDm3 Hqm3) "Hcg Hpc".
    pose (Z3 := <[Regidx Ra1 := regval_into_reg
                  (add_vec (rget Z2 Ra1)
                     (sign_extend' 64 (mword_of_int 2358 : mword 12)))]> Z2).
    change (<[Regidx Ra1 := regval_into_reg
                  (add_vec (rget Z2 Ra1)
                     (sign_extend' 64 (mword_of_int 2358 : mword 12)))]> Z2) with Z3.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (CK + 0x106)) Rra
              (mword_of_int 2092324 : mword 21) Z4 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi106").
    ...
    - (* =============================================================== *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (CK + 0x114)) Ra1 Ra1
                (mword_of_int 2346 : mword 12) Y2 (K - 10)%nat b
                ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi114").
      iIntros (CIDe4 Hqe4) "Hcg Hpc".
      pose (Y3 := <[Regidx Ra1 := regval_into_reg
                    (add_vec (rget Y2 Ra1)
                       (sign_extend' 64 (mword_of_int 2346 : mword 12)))]> Y2).
      change (<[Regidx Ra1 := regval_into_reg
                    (add_vec (rget Y2 Ra1)
                       (sign_extend' 64 (mword_of_int 2346 : mword 12)))]> Y2) with Y3.
      ...
      assert (Htgd2 : add_vec (mword_of_int (CK + 0x11a) : mword 64)
                (sign_extend' 64 (mword_of_int 2092304 : mword 21))
                = mword_of_int KernelSyms.dirlink) by pcw.
      iApply (wp_jal_s_sconf (mword_of_int (CK + 0x11a)) Rra
                (mword_of_int 2092304 : mword 21) Y4 (K - 10)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi11a").
      ...
      + (* ============================================================= *)
        ...
        assert (Htgd3 : add_vec (mword_of_int (CK + 0x12c) : mword 64)
                  (sign_extend' 64 (mword_of_int 2092286 : mword 21))
                  = mword_of_int KernelSyms.dirlink) by pcw.
        iApply (wp_jal_s_sconf (mword_of_int (CK + 0x12c)) Rra
                  (mword_of_int 2092286 : mword 21) W3 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi12c").
        ...
        * (* =========================================================== *)
          ...
          (* THE PARENT'S RE-PARK IS DEFERRED TO THE [++] (V2).  The
             [ilinkd cinum] the +0xc4 mint made goes into the record just
             written, and that record is what pays for the [dp->nlink++]
             four instructions below -- so the deposit and the count move
          ...
          assert (Htgiu2 : add_vec (mword_of_int (CK + 0x140) : mword 64)
                    (sign_extend' 64 (mword_of_int 2090068 : mword 21))
                    = mword_of_int KernelSyms.iupdate) by pcw.
          iApply (wp_jal_s_sconf (mword_of_int (CK + 0x140)) Rra
                    (mword_of_int 2090068 : mword 21) V3 (K - 10)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi140").
          ...
          iDestruct (dir_links_dirlink_d (bv_unsigned dind) dn
                       (cr_setf dp3 (di_major dp3) (di_minor dp3)
                          (add_vec (di_nlink dp3 : mword 16) (mword_of_int 1 : mword 16)))
                       data dat3 (cr_low16 cinum) (bname 14 nf)
                       (dir_nrec (bv_unsigned (di_size dn)))
                       (dir_slot data (dir_nrec (bv_unsigned (di_size dn))))
          ...
          (* THE CHILD'S DEFERRED RE-PARK COMPLETES: the [".."] record's
             ...
             (d-flavoured since V4's flip -- [dp] IS a directory), and the
          ...
          iDestruct (ic_mk_loaded γfs γi cov logstart kd dind
                       ...
                       with "Hdlnk Hdiat Hmeta Hpaddrs Hpind Hblocks Hdview")
            as "Hload".
          (* ===== +0xe0 c.mv a0,s1 ==================================== *)
          ...
          assert (Htgu2 : add_vec (mword_of_int (CK + 0xe2) : mword 64)
                    ...
                    = mword_of_int KernelSyms.iunlockput) by pcw.
          iApply (wp_jal_s_sconf (mword_of_int (CK + 0xe2)) Rra
                    (mword_of_int 2090938 : mword 21) T1 (K - 10)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi0e2").
        ...
        * (* =========================================================== *)
          ...
          iApply ("Hf" $! md3 kslot q g gil gisl cinum dp3 bm3 dat3
                    ...
                    with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%]
                          ...
                          Hdlnk Hdiat Hmeta Hmap Hblocks Hdview Hshotp3 Hfrzl Hkeep Hrud
                          Hslkc Hcslkd Hcdep Hcidev Hciinum Hcivalid
                          Hcdiat Hcmeta Hcmap Hcblocks Hcdview Hcshot2 Hcfrz Hckeep Hruc
                          Hilink
      ...
      + (* ============================================================= *)
        ...
        iApply ("Hf" $! md2 kslot q g gil gisl cinum dn bm data dc2 bm2 dat2
                  ...
                  with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%]
                        ...
                        Hdiat Hmeta Hmap Hblocks Hdview Hshotl Hfrzl Hkeep Hrud
                        Hslkc Hcslkd Hcdep Hcidev Hciinum Hcivalid
                        Hcdiat Hcmeta Hcmap Hcblocks Hcdview Hcshot2 Hcfrz Hckeep Hruc Hilink
                        Hsbn Hsbi Hsbs Hsbb Hbmr Hppid Hppback Hpath Hbsl
                        Hislr Hop Hcont").
        { exact Hmd2regs. }
        { exact Htdir. }
    ...
    - (* =============================================================== *)
      ...
      iApply ("Hf" $! md1 kslot q g gil gisl cinum dn bm data dc1 bm1 dat1
                ...
                with "[%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%] [%]
                      ...
                      Hdiat Hmeta Hmap Hblocks Hdview Hshotl Hfrzl Hkeep Hrud
                      Hslkc Hcslkd Hcdep Hcidev Hciinum Hcivalid
                      Hcdiat Hcmeta Hcmap Hcblocks Hcdview Hcshot1 Hcfrz Hckeep Hruc Hilink
                      Hsbn Hsbi Hsbs Hsbb Hbmr Hppid Hppback Hpath Hbsl
                      Hislr Hop Hcont").
      { exact Hmd1regs. }
      { exact Htdir. }

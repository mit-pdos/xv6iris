(* WpCopyoutDecode.v -- the instruction-DECODE layer for xv6's copyout().
   ...
   [cdec_<word>] (only 0x611c / 0x4501 / 0x8082 / 0x557d / 0xbff9 -- copyout's
   twelve-slot frame and its s5..s10 traffic are its own); copyout's own words
   are local, named [codc_<word>] (compressed) / [codb_<word>] (base).
...
(* 0x1c  addi  s0,sp,96 *)
Lemma codc_1080 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0x3a  mv    a1,s6 *)
Lemma codc_85da s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0x58 / 0x66 / 0x74  mv    a1,s1 *)
Lemma codc_85a6 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  exec (ext_decode_compressed (mword_of_int 0x85a6 : mword 16)) s
  = Some (C_MV (Regidx (mword_of_int 11), Regidx (mword_of_int 9)), s).
Proof. intro H. rvc_oneshot s H. Qed.

(* 0x5a / 0x68 / 0x76  mv    a0,s7 *)
Lemma codc_855e s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  exec (ext_decode_compressed (mword_of_int 0x855e : mword 16)) s
  = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 23)), s).
Proof. intro H. rvc_oneshot s H. Qed.

(* 0x60 / 0x6e  mv    s3,a0 *)
Lemma codc_89aa s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0x64 / 0x72  li    a2,0 *)
Lemma codc_4601 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0xb2  addi  sp,sp,96 *)
Lemma codc_6125 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
Section CopyoutInstrs.
  ...
  Local Notation COP off rvc ast :=
    (kernel_text -∗ instr (mword_of_int (CO + off) : mword 64) rvc ast).
  ...
  Proof. mk_rvc (CO + 0x00)%Z (mword_of_int 0xcad1 : mword 16)
    (mword_of_int (CO + 0x00) : mword 64) (BTYPE (sign_extend' 13 (concat_vec (mword_of_int 74 : mword 8) ('b"0")), zreg, creg2reg_idx (Cregidx (mword_of_int 5)), BEQ)) codc_cad1 exec_execute_C_BEQZ. Qed.
  ...
  Proof. mk_rvc (CO + 0x02)%Z (mword_of_int 0x711d : mword 16)
    (mword_of_int (CO + 0x02) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 58 : mword 6), sp, sp, ADDI)) codc_711d exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (CO + 0x04)%Z (mword_of_int 0xec86 : mword 16)
    (mword_of_int (CO + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 11 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) codc_ec86 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x06)%Z (mword_of_int 0xe8a2 : mword 16)
    (mword_of_int (CO + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 10 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) codc_e8a2 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x08)%Z (mword_of_int 0xe4a6 : mword 16)
    (mword_of_int (CO + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 9 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) codc_e4a6 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x0a)%Z (mword_of_int 0xe0ca : mword 16)
    (mword_of_int (CO + 0x0a) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 8 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) codc_e0ca exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x0c)%Z (mword_of_int 0xfc4e : mword 16)
    (mword_of_int (CO + 0x0c) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 7 : mword 6) ('b"000")), Regidx (mword_of_int 19), sp, 8)) codc_fc4e exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x0e)%Z (mword_of_int 0xf852 : mword 16)
    (mword_of_int (CO + 0x0e) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 6 : mword 6) ('b"000")), Regidx (mword_of_int 20), sp, 8)) codc_f852 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x10)%Z (mword_of_int 0xf456 : mword 16)
    (mword_of_int (CO + 0x10) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 5 : mword 6) ('b"000")), Regidx (mword_of_int 21), sp, 8)) codc_f456 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x12)%Z (mword_of_int 0xf05a : mword 16)
    (mword_of_int (CO + 0x12) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 6) ('b"000")), Regidx (mword_of_int 22), sp, 8)) codc_f05a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x14)%Z (mword_of_int 0xec5e : mword 16)
    (mword_of_int (CO + 0x14) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 23), sp, 8)) codc_ec5e exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x16)%Z (mword_of_int 0xe862 : mword 16)
    (mword_of_int (CO + 0x16) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 24), sp, 8)) codc_e862 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x18)%Z (mword_of_int 0xe466 : mword 16)
    (mword_of_int (CO + 0x18) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 25), sp, 8)) codc_e466 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x1a)%Z (mword_of_int 0xe06a : mword 16)
    (mword_of_int (CO + 0x1a) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 26), sp, 8)) codc_e06a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x1c)%Z (mword_of_int 0x1080 : mword 16)
    (mword_of_int (CO + 0x1c) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 24 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) codc_1080 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (CO + 0x1e)%Z (mword_of_int 0x8baa : mword 16)
    (mword_of_int (CO + 0x1e) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 23), ADD)) codc_8baa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (CO + 0x20)%Z (mword_of_int 0x8a2e : mword 16)
    (mword_of_int (CO + 0x20) : mword 64) (RTYPE (Regidx (mword_of_int 11), zreg, Regidx (mword_of_int 20), ADD)) codc_8a2e exec_execute_C_MV. Qed.

  Lemma coi_22 : COP 0x22 true (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 22), ADD)).  (* mv    s6,a2 -- s6 := src *)
  Proof. mk_rvc (CO + 0x22)%Z (mword_of_int 0x8b32 : mword 16)
    (mword_of_int (CO + 0x22) : mword 64) (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 22), ADD)) codc_8b32 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (CO + 0x26)%Z (mword_of_int 0x7d7d : mword 16)
    (mword_of_int (CO + 0x26) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 63 : mword 6), Regidx (mword_of_int 26), LUI)) codc_7d7d exec_execute_C_LUI. Qed.

  Lemma coi_28 : COP 0x28 true (ITYPE (sign_extend' 12 (mword_of_int 63 : mword 6), zreg, Regidx (mword_of_int 25), ADDI)).  (* li    s9,-1 -- s9 := -1 ... *)
  Proof. mk_rvc (CO + 0x28)%Z (mword_of_int 0x5cfd : mword 16)
    (mword_of_int (CO + 0x28) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 63 : mword 6), zreg, Regidx (mword_of_int 25), ADDI)) codc_5cfd exec_execute_C_LI. Qed.
  ...
  Proof. mk_base (CO + 0x2a)%Z (mword_of_int 0x01acdc93 : mword 32)
    (mword_of_int (CO + 0x2a) : mword 64) (SHIFTIOP (mword_of_int 26 : mword 6, Regidx (mword_of_int 25), Regidx (mword_of_int 25), SRLI)) codb_01acdc93. Qed.

  Lemma coi_2e : COP 0x2e true (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 24), LUI)).  (* lui   s8,0x1 -- s8 := PGSIZE *)
  Proof. mk_rvc (CO + 0x2e)%Z (mword_of_int 0x6c05 : mword 16)
    (mword_of_int (CO + 0x2e) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 24), LUI)) codc_6c05 exec_execute_C_LUI. Qed.
  ...
  Proof. mk_base (CO + 0x32)%Z (mword_of_int 0x409a0533 : mword 32)
    (mword_of_int (CO + 0x32) : mword 64) (RTYPE (Regidx (mword_of_int 9), Regidx (mword_of_int 20), Regidx (mword_of_int 10), SUB)) codb_409a0533. Qed.
  ...
  Proof. mk_rvc (CO + 0x3a)%Z (mword_of_int 0x85da : mword 16)
    (mword_of_int (CO + 0x3a) : mword 64) (RTYPE (Regidx (mword_of_int 22), zreg, Regidx (mword_of_int 11), ADD)) codc_85da exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (CO + 0x3c)%Z (mword_of_int 0x954e : mword 16)
    (mword_of_int (CO + 0x3c) : mword 64) (RTYPE (Regidx (mword_of_int 19), Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADD)) codc_954e exec_execute_C_ADD. Qed.

  Lemma coi_3e : COP 0x3e false (JAL (mword_of_int 2094790 : mword 21, Regidx (mword_of_int 1))).  (* jal   memmove -- memmove(pa0+off, src, n) *)
  Proof. mk_base (CO + 0x3e)%Z (mword_of_int 0xec6ff0ef : mword 32)
    (mword_of_int (CO + 0x3e) : mword 64) (JAL (mword_of_int 2094790 : mword 21, Regidx (mword_of_int 1))) codb_ec6ff0ef. Qed.
  ...
  Proof. mk_base (CO + 0x42)%Z (mword_of_int 0x412a8ab3 : mword 32)
    (mword_of_int (CO + 0x42) : mword 64) (RTYPE (Regidx (mword_of_int 18), Regidx (mword_of_int 21), Regidx (mword_of_int 21), SUB)) codb_412a8ab3. Qed.
  ...
  Proof. mk_rvc (CO + 0x46)%Z (mword_of_int 0x9b4a : mword 16)
    (mword_of_int (CO + 0x46) : mword 64) (RTYPE (Regidx (mword_of_int 18), Regidx (mword_of_int 22), Regidx (mword_of_int 22), ADD)) codc_9b4a exec_execute_C_ADD. Qed.
  ...
  Proof. mk_base (CO + 0x48)%Z (mword_of_int 0x01848a33 : mword 32)
    (mword_of_int (CO + 0x48) : mword 64) (RTYPE (Regidx (mword_of_int 24), Regidx (mword_of_int 9), Regidx (mword_of_int 20), ADD)) codb_01848a33. Qed.
  ...
  Proof. mk_base (CO + 0x4c)%Z (mword_of_int 0x040a8263 : mword 32)
    (mword_of_int (CO + 0x4c) : mword 64) (BTYPE (mword_of_int 68 : mword 13, Regidx (mword_of_int 0), Regidx (mword_of_int 21), BEQ)) codb_040a8263. Qed.
  ...
  Proof. mk_base (CO + 0x50)%Z (mword_of_int 0x01aa74b3 : mword 32)
    (mword_of_int (CO + 0x50) : mword 64) (RTYPE (Regidx (mword_of_int 26), Regidx (mword_of_int 20), Regidx (mword_of_int 9), AND)) codb_01aa74b3. Qed.
  ...
  Proof. mk_base (CO + 0x54)%Z (mword_of_int 0x049ce263 : mword 32)
    (mword_of_int (CO + 0x54) : mword 64) (BTYPE (mword_of_int 68 : mword 13, Regidx (mword_of_int 9), Regidx (mword_of_int 25), BLTU)) codb_049ce263. Qed.

  Lemma coi_58 : COP 0x58 true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 11), ADD)).  (* mv    a1,s1 *)
  Proof. mk_rvc (CO + 0x58)%Z (mword_of_int 0x85a6 : mword 16)
    (mword_of_int (CO + 0x58) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 11), ADD)) codc_85a6 exec_execute_C_MV. Qed.

  Lemma coi_5a : COP 0x5a true (RTYPE (Regidx (mword_of_int 23), zreg, Regidx (mword_of_int 10), ADD)).  (* mv    a0,s7 *)
  Proof. mk_rvc (CO + 0x5a)%Z (mword_of_int 0x855e : mword 16)
    (mword_of_int (CO + 0x5a) : mword 64) (RTYPE (Regidx (mword_of_int 23), zreg, Regidx (mword_of_int 10), ADD)) codc_855e exec_execute_C_MV. Qed.
  ...
  Proof. mk_base (CO + 0x5c)%Z (mword_of_int 0x977ff0ef : mword 32)
    (mword_of_int (CO + 0x5c) : mword 64) (JAL (mword_of_int 2095478 : mword 21, Regidx (mword_of_int 1))) codb_977ff0ef. Qed.

  Lemma coi_60 : COP 0x60 true (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 19), ADD)).  (* mv    s3,a0 -- s3 := pa0 *)
  Proof. mk_rvc (CO + 0x60)%Z (mword_of_int 0x89aa : mword 16)
    (mword_of_int (CO + 0x60) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 19), ADD)) codc_89aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (CO + 0x62)%Z (mword_of_int 0xe901 : mword 16)
    (mword_of_int (CO + 0x62) : mword 64) (BTYPE (sign_extend' 13 (concat_vec (mword_of_int 8 : mword 8) ('b"0")), zreg, creg2reg_idx (Cregidx (mword_of_int 2)), BNE)) codc_e901 exec_execute_C_BNEZ. Qed.
  ...
  Proof. mk_rvc (CO + 0x64)%Z (mword_of_int 0x4601 : mword 16)
    (mword_of_int (CO + 0x64) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 12), ADDI)) codc_4601 exec_execute_C_LI. Qed.

  Lemma coi_66 : COP 0x66 true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 11), ADD)).  (* mv    a1,s1 *)
  Proof. mk_rvc (CO + 0x66)%Z (mword_of_int 0x85a6 : mword 16)
    (mword_of_int (CO + 0x66) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 11), ADD)) codc_85a6 exec_execute_C_MV. Qed.

  Lemma coi_68 : COP 0x68 true (RTYPE (Regidx (mword_of_int 23), zreg, Regidx (mword_of_int 10), ADD)).  (* mv    a0,s7 *)
  Proof. mk_rvc (CO + 0x68)%Z (mword_of_int 0x855e : mword 16)
    (mword_of_int (CO + 0x68) : mword 64) (RTYPE (Regidx (mword_of_int 23), zreg, Regidx (mword_of_int 10), ADD)) codc_855e exec_execute_C_MV. Qed.
  ...
  Proof. mk_base (CO + 0x6a)%Z (mword_of_int 0xf13ff0ef : mword 32)
    (mword_of_int (CO + 0x6a) : mword 64) (JAL (mword_of_int 2096914 : mword 21, Regidx (mword_of_int 1))) codb_f13ff0ef. Qed.

  Lemma coi_6e : COP 0x6e true (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 19), ADD)).  (* mv    s3,a0 -- s3 := pa0 *)
  Proof. mk_rvc (CO + 0x6e)%Z (mword_of_int 0x89aa : mword 16)
    (mword_of_int (CO + 0x6e) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 19), ADD)) codc_89aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (CO + 0x70)%Z (mword_of_int 0xc139 : mword 16)
    (mword_of_int (CO + 0x70) : mword 64) (BTYPE (sign_extend' 13 (concat_vec (mword_of_int 35 : mword 8) ('b"0")), zreg, creg2reg_idx (Cregidx (mword_of_int 2)), BEQ)) codc_c139 exec_execute_C_BEQZ. Qed.
  ...
  Proof. mk_rvc (CO + 0x72)%Z (mword_of_int 0x4601 : mword 16)
    (mword_of_int (CO + 0x72) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 12), ADDI)) codc_4601 exec_execute_C_LI. Qed.

  Lemma coi_74 : COP 0x74 true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 11), ADD)).  (* mv    a1,s1 *)
  Proof. mk_rvc (CO + 0x74)%Z (mword_of_int 0x85a6 : mword 16)
    (mword_of_int (CO + 0x74) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 11), ADD)) codc_85a6 exec_execute_C_MV. Qed.

  Lemma coi_76 : COP 0x76 true (RTYPE (Regidx (mword_of_int 23), zreg, Regidx (mword_of_int 10), ADD)).  (* mv    a0,s7 *)
  Proof. mk_rvc (CO + 0x76)%Z (mword_of_int 0x855e : mword 16)
    (mword_of_int (CO + 0x76) : mword 64) (RTYPE (Regidx (mword_of_int 23), zreg, Regidx (mword_of_int 10), ADD)) codc_855e exec_execute_C_MV. Qed.

  Lemma coi_78 : COP 0x78 false (JAL (mword_of_int 2095296 : mword 21, Regidx (mword_of_int 1))).  (* jal   walk -- pte := walk(pagetable, va0, 0) *)
  Proof. mk_base (CO + 0x78)%Z (mword_of_int 0x8c1ff0ef : mword 32)
    (mword_of_int (CO + 0x78) : mword 64) (JAL (mword_of_int 2095296 : mword 21, Regidx (mword_of_int 1))) codb_8c1ff0ef. Qed.
  ...
  Proof. mk_rvc (CO + 0x7c)%Z (mword_of_int 0x611c : mword 16)
    (mword_of_int (CO + 0x7c) : mword 64) (LOAD (mword_of_int 0 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 15), false, 8)) cdec_611c cexec_611c. Qed.
  ...
  Proof. mk_rvc (CO + 0x7e)%Z (mword_of_int 0x8b91 : mword 16)
    (mword_of_int (CO + 0x7e) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 4 : mword 6), Regidx (mword_of_int 15), Regidx (mword_of_int 15), ANDI)) codc_8b91 coexec_8b91. Qed.
  ...
  Proof. mk_rvc (CO + 0x80)%Z (mword_of_int 0xcf8d : mword 16)
    (mword_of_int (CO + 0x80) : mword 64) (BTYPE (sign_extend' 13 (concat_vec (mword_of_int 29 : mword 8) ('b"0")), zreg, creg2reg_idx (Cregidx (mword_of_int 7)), BEQ)) codc_cf8d exec_execute_C_BEQZ. Qed.
  ...
  Proof. mk_base (CO + 0x82)%Z (mword_of_int 0x41448933 : mword 32)
    (mword_of_int (CO + 0x82) : mword 64) (RTYPE (Regidx (mword_of_int 20), Regidx (mword_of_int 9), Regidx (mword_of_int 18), SUB)) codb_41448933. Qed.
  ...
  Proof. mk_rvc (CO + 0x86)%Z (mword_of_int 0x9962 : mword 16)
    (mword_of_int (CO + 0x86) : mword 64) (RTYPE (Regidx (mword_of_int 24), Regidx (mword_of_int 18), Regidx (mword_of_int 18), ADD)) codc_9962 exec_execute_C_ADD. Qed.
  ...
  Proof. mk_base (CO + 0x88)%Z (mword_of_int 0xfb2af5e3 : mword 32)
    (mword_of_int (CO + 0x88) : mword 64) (BTYPE (mword_of_int 8106 : mword 13, Regidx (mword_of_int 18), Regidx (mword_of_int 21), BGEU)) codb_fb2af5e3. Qed.

  Lemma coi_8c : COP 0x8c true (RTYPE (Regidx (mword_of_int 21), zreg, Regidx (mword_of_int 18), ADD)).  (* mv    s2,s5 -- else clamp n := len *)
  Proof. mk_rvc (CO + 0x8c)%Z (mword_of_int 0x8956 : mword 16)
    (mword_of_int (CO + 0x8c) : mword 64) (RTYPE (Regidx (mword_of_int 21), zreg, Regidx (mword_of_int 18), ADD)) codc_8956 exec_execute_C_MV. Qed.

  Lemma coi_8e : COP 0x8e true (JAL (sign_extend' 21 (concat_vec (mword_of_int 2002 : mword 11) ('b"0")), zreg)).  (* j     +0x32 -- -> +0x32 *)
  Proof. mk_rvc (CO + 0x8e)%Z (mword_of_int 0xb755 : mword 16)
    (mword_of_int (CO + 0x8e) : mword 64) (JAL (sign_extend' 21 (concat_vec (mword_of_int 2002 : mword 11) ('b"0")), zreg)) codc_b755 exec_execute_C_J. Qed.
  ...
  Proof. mk_rvc (CO + 0x90)%Z (mword_of_int 0x4501 : mword 16)
    (mword_of_int (CO + 0x90) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)) cdec_4501 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (CO + 0x94)%Z (mword_of_int 0x4501 : mword 16)
    (mword_of_int (CO + 0x94) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)) cdec_4501 exec_execute_C_LI. Qed.

  Lemma coi_96 : COP 0x96 true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).  (* ret *)
  Proof. mk_rvc (CO + 0x96)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (CO + 0x96) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_rvc (CO + 0x98)%Z (mword_of_int 0x557d : mword 16)
    (mword_of_int (CO + 0x98) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 63 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)) cdec_557d exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (CO + 0x9a)%Z (mword_of_int 0x60e6 : mword 16)
    (mword_of_int (CO + 0x9a) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 11 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) codc_60e6 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x9c)%Z (mword_of_int 0x6446 : mword 16)
    (mword_of_int (CO + 0x9c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 10 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) codc_6446 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0x9e)%Z (mword_of_int 0x64a6 : mword 16)
    (mword_of_int (CO + 0x9e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 9 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) codc_64a6 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xa0)%Z (mword_of_int 0x6906 : mword 16)
    (mword_of_int (CO + 0xa0) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 8 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) codc_6906 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xa2)%Z (mword_of_int 0x79e2 : mword 16)
    (mword_of_int (CO + 0xa2) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 7 : mword 6) ('b"000")), sp, Regidx (mword_of_int 19), false, 8)) codc_79e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xa4)%Z (mword_of_int 0x7a42 : mword 16)
    (mword_of_int (CO + 0xa4) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 6 : mword 6) ('b"000")), sp, Regidx (mword_of_int 20), false, 8)) codc_7a42 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xa6)%Z (mword_of_int 0x7aa2 : mword 16)
    (mword_of_int (CO + 0xa6) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 5 : mword 6) ('b"000")), sp, Regidx (mword_of_int 21), false, 8)) codc_7aa2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xa8)%Z (mword_of_int 0x7b02 : mword 16)
    (mword_of_int (CO + 0xa8) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 6) ('b"000")), sp, Regidx (mword_of_int 22), false, 8)) codc_7b02 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xaa)%Z (mword_of_int 0x6be2 : mword 16)
    (mword_of_int (CO + 0xaa) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 23), false, 8)) codc_6be2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xac)%Z (mword_of_int 0x6c42 : mword 16)
    (mword_of_int (CO + 0xac) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 24), false, 8)) codc_6c42 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xae)%Z (mword_of_int 0x6ca2 : mword 16)
    (mword_of_int (CO + 0xae) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 25), false, 8)) codc_6ca2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (CO + 0xb0)%Z (mword_of_int 0x6d02 : mword 16)
    (mword_of_int (CO + 0xb0) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 26), false, 8)) codc_6d02 exec_execute_C_LDSP. Qed.

  Lemma coi_b2 : COP 0xb2 true (ITYPE (caddi16sp_imm (mword_of_int 6 : mword 6), sp, sp, ADDI)).  (* addi  sp,sp,96 *)
  Proof. mk_rvc (CO + 0xb2)%Z (mword_of_int 0x6125 : mword 16)
    (mword_of_int (CO + 0xb2) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 6 : mword 6), sp, sp, ADDI)) codc_6125 exec_execute_C_ADDI16SP. Qed.

  Lemma coi_b4 : COP 0xb4 true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).  (* ret *)
  Proof. mk_rvc (CO + 0xb4)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (CO + 0xb4) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_rvc (CO + 0xb6)%Z (mword_of_int 0x557d : mword 16)
    (mword_of_int (CO + 0xb6) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 63 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)) cdec_557d exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (CO + 0xba)%Z (mword_of_int 0x557d : mword 16)
    (mword_of_int (CO + 0xba) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 63 : mword 6), zreg, Regidx (mword_of_int 10), ADDI)) cdec_557d exec_execute_C_LI. Qed.

  Lemma coi_bc : COP 0xbc true (JAL (sign_extend' 21 (concat_vec (mword_of_int 2031 : mword 11) ('b"0")), zreg)).  (* j     +0x9a -- -> +0x9a *)
  Proof. mk_rvc (CO + 0xbc)%Z (mword_of_int 0xbff9 : mword 16)
    (mword_of_int (CO + 0xbc) : mword 64) (JAL (sign_extend' 21 (concat_vec (mword_of_int 2031 : mword 11) ('b"0")), zreg)) cdec_bff9 exec_execute_C_J. Qed.

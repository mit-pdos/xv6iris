...
Proof. apply ByteCursor.add_vec_comm. Qed.
...
Proof.
  rewrite (ByteCursor.add_vec_comm (mword_of_int (16 * Z.of_nat i) : mword 64) pd).
...
Section ProofVirtioDiskRwCSeam.
  ...
  Lemma wp_vdrw_p3_seam (γ γk : gname) (Φ : mval -> iProp Σ)
      (γs : list gname) (j : nat) (γd : disk_names)
      (pd pav pu : SailStdpp.Values.mword 64) (K : nat) (eb : bool) (C : iProp Σ)
      (sp0 b : Arch.pa) (wr sector : SailStdpp.Values.mword 64)
  ...
  Proof.
    ...
    iApply (wp_vdrw_p3 γ Φ M (K - 12)%nat pd sp0 b wr sector h m2 t dsk0
              Hh8 Hm8 Ht8 Hregs
    ...
    - split; [| exact (vdrw_hi_frame M M1 m0 Hcs Hhi)].
      ...
      + rewrite (Hcs (mword_of_int 23 : mword 5) ltac:(vm_compute; reflexivity)).
        exact Hs7.
      + rewrite (Hcs (mword_of_int 4 : mword 5) ltac:(vm_compute; reflexivity)).
        exact Htp.

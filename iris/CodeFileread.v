...
Section CodeFileread.
  ...
  Lemma fri_8e : kernel_text -∗ instr (mword_of_int (KernelSyms.fileread + 0x8e) : mword 64) false (ITYPE (mword_of_int 340 : mword 12, Regidx (mword_of_int 14), Regidx (mword_of_int 14), ADDI)).
  Proof. mk_base (KernelSyms.fileread + 0x8e) (mword_of_int 0x15470713 : mword 32)
    (mword_of_int (KernelSyms.fileread + 0x8e) : mword 64) (ITYPE (mword_of_int 340 : mword 12, Regidx (mword_of_int 14), Regidx (mword_of_int 14), ADDI)) kd_15470713. Qed.
  ...
  Lemma fri_a8 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileread + 0xa8) : mword 64) false (ITYPE (mword_of_int 674 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.fileread + 0xa8) (mword_of_int 0x2a250513 : mword 32)
    (mword_of_int (KernelSyms.fileread + 0xa8) : mword 64) (ITYPE (mword_of_int 674 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_2a250513. Qed.

  Lemma fri_ac : kernel_text -∗ instr (mword_of_int (KernelSyms.fileread + 0xac) : mword 64) false (JAL (mword_of_int 2082070 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.fileread + 0xac) (mword_of_int 0xd16fc0ef : mword 32)
    (mword_of_int (KernelSyms.fileread + 0xac) : mword 64) (JAL (mword_of_int 2082070 : mword 21, Regidx (mword_of_int 1))) kd_d16fc0ef. Qed.

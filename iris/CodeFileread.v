...
Section CodeFileread.
  ...
  Lemma fri_8e : kernel_text -∗ instr (mword_of_int (KernelSyms.fileread + 0x8e) : mword 64) false (ITYPE (mword_of_int 240 : mword 12, Regidx (mword_of_int 14), Regidx (mword_of_int 14), ADDI)).
  Proof. mk_base (KernelSyms.fileread + 0x8e) (mword_of_int 0x0f070713 : mword 32)
    (mword_of_int (KernelSyms.fileread + 0x8e) : mword 64) (ITYPE (mword_of_int 240 : mword 12, Regidx (mword_of_int 14), Regidx (mword_of_int 14), ADDI)) kd_0f070713. Qed.
  ...
  Lemma fri_a8 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileread + 0xa8) : mword 64) false (ITYPE (mword_of_int 622 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.fileread + 0xa8) (mword_of_int 0x26e50513 : mword 32)
    (mword_of_int (KernelSyms.fileread + 0xa8) : mword 64) (ITYPE (mword_of_int 622 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_26e50513. Qed.

  Lemma fri_ac : kernel_text -∗ instr (mword_of_int (KernelSyms.fileread + 0xac) : mword 64) false (JAL (mword_of_int 2082018 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.fileread + 0xac) (mword_of_int 0xce2fc0ef : mword 32)
    (mword_of_int (KernelSyms.fileread + 0xac) : mword 64) (JAL (mword_of_int 2082018 : mword 21, Regidx (mword_of_int 1))) kd_ce2fc0ef. Qed.

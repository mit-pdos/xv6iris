(* ProofSysOpenBits.v -- ITEM (5) OF [SysOpenDefs]'s prover list, and
   ...
   [SysOpenDefs.om_arg vom] -- the sign extension does not disturb any
...
(* ===================================================================== *)
(*  2.  THE FOUR TESTS, AGAINST [SysOpenDefs]'s READINGS                *)
(* ===================================================================== *)

...
Section ProofSysUptime.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x0e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x752 : mword 12)
              A2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi0e").
    iIntros (CID7 Hs7) "Hcg Hpc".
    set (A3 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1874 : mword 12)))]> A2).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1874 : mword 12)))]> A2) with A3.
    ...
    set (B0 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.sys_uptime + 0x16) : mword 64) (auipc_off (mword_of_int 0x8 : mword 20)))]> MA).
    change (<[Regidx (mword_of_int 15 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.sys_uptime + 0x16) : mword 64) (auipc_off (mword_of_int 0x8 : mword 20)))]> MA) with B0.
    ...
    assert (Haddrt : add_vec (B0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x816 : mword 12)) = a_ticks).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x1a)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5)
              (mword_of_int 0x816 : mword 12) B0 (trap_res b + (av - 4))%nat t false (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x24)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x73c : mword 12)
    ...
    set (B4 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1852 : mword 12)))]> B3).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1852 : mword 12)))]> B3) with B4.

...
Section ProofSysUptime.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x0e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x74e : mword 12)
              A2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi0e [-]").
    iIntros (CID7 Hs7) "Hcg Hpc".
    set (A3 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1870 : mword 12)))]> A2).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1870 : mword 12)))]> A2) with A3.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x12)) (mword_of_int 1 : mword 5) (mword_of_int 2089274 : mword 21)
              A3 (av - 4)%nat b
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.sys_uptime + 0x12) : mword 64) (sign_extend' 64 (mword_of_int 2089274 : mword 21)) = mword_of_int KernelSyms.acquire)
    ...
    (* +0x1a: lw a5,2034(a5) -- the read, under the lock *)
    assert (Haddrt : add_vec (B0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x7f2 : mword 12)) = a_ticks).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x1a)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5)
              (mword_of_int 0x7f2 : mword 12) B0 (trap_res b + (av - 4))%nat t false (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x24)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x738 : mword 12)
    ...
    set (B4 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1848 : mword 12)))]> B3).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1848 : mword 12)))]> B3) with B4.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x28)) (mword_of_int 1 : mword 5) (mword_of_int 2089388 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.sys_uptime + 0x28) : mword 64) (sign_extend' 64 (mword_of_int 2089388 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).

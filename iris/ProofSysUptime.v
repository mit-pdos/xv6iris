...
Section ProofSysUptime.
  ...
  Proof using .
    ...
    (* ===================== a0 := &tickslock ===================== *)
    (* +0x0a: auipc a0,0x15 *)
    iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x0a)) (mword_of_int 10 : mword 5) (mword_of_int 0x16 : mword 20)
              A1 (av - 4)%nat b
    ...
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.sys_uptime + 0x0a) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> A1) with A2.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x0e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x8d0 : mword 12)
              A2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2256 : mword 12)))]> A2) with A3.
    ...
    (* +0x12: jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x12)) (mword_of_int 1 : mword 5) (mword_of_int 2089104 : mword 21)
              A3 (av - 4)%nat b
    ...
    assert (Haddrt : add_vec (B0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x7ac : mword 12)) = a_ticks).
    ...
    iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.sys_uptime + 0x1a)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5)
              (mword_of_int 0x7ac : mword 12) B0 (trap_res b + (av - 4))%nat t false (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [Hticks]").
    ...
    (* ===================== a0 := &tickslock (again) ===================== *)
    (* +0x20: auipc a0,0x15 *)
    iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x20)) (mword_of_int 10 : mword 5) (mword_of_int 0x16 : mword 20)
    ...
    set (B3 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.sys_uptime + 0x20) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> B2).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (mword_of_int (KernelSyms.sys_uptime + 0x20) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> B2) with B3.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x24)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x8ba : mword 12)
    ...
    set (B4 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2234 : mword 12)))]> B3).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2234 : mword 12)))]> B3) with B4.
    ...
    (* +0x28: jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x28)) (mword_of_int 1 : mword 5) (mword_of_int 2089218 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.sys_uptime + 0x28) : mword 64) (sign_extend' 64 (mword_of_int 2089218 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).

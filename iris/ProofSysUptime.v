(* ProofSysUptime.v -- sys_uptime() over the SIE-agnostic sconf world.
   ...
   sys_uptime() @ 0x80002a88 is the whole of xv6's tick syscall:
...
Section ProofSysUptime.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x0e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x732 : mword 12)
              A2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (A3 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1842 : mword 12)))]> A2).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (A2 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1842 : mword 12)))]> A2) with A3.
    ...
    (* +0x12: jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x12)) (mword_of_int 1 : mword 5) (mword_of_int 2089212 : mword 21)
              A3 (av - 4)%nat b
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.sys_uptime + 0x12) : mword 64) (sign_extend' 64 (mword_of_int 2089212 : mword 21)) = mword_of_int KernelSyms.acquire)
    ...
    iApply (Acquire.wp_acquire_sconf KT1 γl "time"%string ticks_res_at A4
    ...
    assert (Haddrt : add_vec (B0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x7f6 : mword 12)) = a_ticks).
    ...
    iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.sys_uptime + 0x1a)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5)
              (mword_of_int 0x7f6 : mword 12) B0 (trap_res b + (av - 4))%nat t false (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [Hticks]").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x24)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x71c : mword 12)
    ...
    set (B4 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1820 : mword 12)))]> B3).
    change (<[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (B3 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1820 : mword 12)))]> B3) with B4.
    ...
    (* +0x28: jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_uptime + 0x28)) (mword_of_int 1 : mword 5) (mword_of_int 2089326 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.sys_uptime + 0x28) : mword 64) (sign_extend' 64 (mword_of_int 2089326 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (Release.wp_release_sconf KT1 γl a_tickslock "time"%string ticks_res_at B5
              n eb p (av - 4)%nat
              ({["time"]} ∪ lks)

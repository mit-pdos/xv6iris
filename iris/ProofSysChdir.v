...
Section ProofSysChdirBody.
  ...
  Proof.
    ...
    iIntros "Hcg Hown _ _ #Htext #Hdata Hpc #Hpanic #Hbio #Hlog Hseam
    ...
    iApply (wp_jal_s_sconf (CID := CID5) (mword_of_int (SC + 0x0a)) Rra
              (mword_of_int 2082348 : mword 21) M2 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi0a").
    ...
    assert (Hjmp : add_vec (mword_of_int (SC + 0x0a) : mword 64)
                     (sign_extend' 64 (mword_of_int 2082348 : mword 21))
    ...
    { intros c Hc N2 N8 N9 N18. rewrite /M3 upd_ne; [| regne].
      exact (HM2thr c Hc N2 N8 N9 N18). }
    iDestruct (cpu_own_transport CID0 CID6 0 eb pj C b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Myproc.wp_myproc_sconf (CID := CID6) M3 (K - 20)%nat 0%nat eb pj C b lks
    ...
    iApply (wp_jal_s_sconf (CID := CID8) (mword_of_int (SC + 0x10)) Rra
              (mword_of_int 2091364 : mword 21) M4 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi10").
    ...
    assert (Hjbo : add_vec (mword_of_int (SC + 0x10) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091364 : mword 21))
    ...
    iDestruct (cpu_own_transport CID7 CID9 0 eb pj C b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (BeginOp.wp_begin_op_sconf (CID := CID9) gs j gl bn g gfs cov logstart
              dev pid (DfracOwn (1/4)) M5 (K - 20)%nat eb C b lks
    ...
    iApply (wp_jal_s_sconf (CID := CID13) (mword_of_int (SC + 0x1e)) Rra
              (mword_of_int 2086290 : mword 21) M8 (K - 20)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi1e").
    ...
    assert (Hjas : add_vec (mword_of_int (SC + 0x1e) : mword 64)
                     (sign_extend' 64 (mword_of_int 2086290 : mword 21))
    ...
    iDestruct (cpu_own_transport CID10 CID14 0 eb pj C b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Argstr.wp_argstr_sconf (CID := CID14) ga gf M9 (K - 20)%nat 0%nat eb pj C
    ...
    - (* ---- the string fetched: the [bltz] FALLS THROUGH ---- *)
      ...
      iApply (wp_jal_s_sconf (CID := CID18) (mword_of_int (SC + 0x2c)) Rra
                (mword_of_int 2090858 : mword 21) N0 (K - 20)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi2c").
      ...
      assert (Hjna : add_vec (mword_of_int (SC + 0x2c) : mword 64)
                       (sign_extend' 64 (mword_of_int 2090858 : mword 21))
      ...
      iDestruct (cpu_own_transport CID15 CID19 0 eb pj C b
                   ltac:(wp_next_chain) with "Hown") as "Hown".
      ...
      + (* ---- the path RESOLVED ---- *)
        ...
        iApply (wp_jal_s_sconf (CID := CID22) (mword_of_int (SC + 0x34)) Rra
                  (mword_of_int 2088734 : mword 21) N2 (K - 20)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi34").
        ...
        assert (Hjil : add_vec (mword_of_int (SC + 0x34) : mword 64)
                         (sign_extend' 64 (mword_of_int 2088734 : mword 21))
        ...
        iDestruct (cpu_own_transport CID20 CID23 0 eb pj C b
                     ltac:(wp_next_chain) with "Hown") as "Hown".
        ...
        * (* ======== IT IS A DIRECTORY: the success tail ======== *)
          ...
          iApply (wp_jal_s_sconf (CID := CID28) (mword_of_int (SC + 0x44)) Rra
                    (mword_of_int 2088892 : mword 21) P3 (K - 20)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi44").
          ...
          assert (Hjiu : add_vec (mword_of_int (SC + 0x44) : mword 64)
                           (sign_extend' 64 (mword_of_int 2088892 : mword 21))
          ...
          iApply (wp_jal_s_sconf (CID := CID31) (mword_of_int (SC + 0x4c)) Rra
                    (mword_of_int 2089096 : mword 21) P5 (K - 20)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi4c").
          ...
          assert (Hjip : add_vec (mword_of_int (SC + 0x4c) : mword 64)
                           (sign_extend' 64 (mword_of_int 2089096 : mword 21))
          ...
          iDestruct (cpu_own_transport CID30 CID32 0 eb pj C b
                       ltac:(wp_next_chain) with "Hown") as "Hown".
          ...
          iApply (wp_jal_s_sconf (CID := CID33) (mword_of_int (SC + 0x50)) Rra
                    (mword_of_int 2091440 : mword 21) mip (K - 20)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi50").
          ...
          iDestruct (cpu_own_transport CID35 CIDz 0 eb pj C b
                       ltac:(wp_next_chain) with "Hown") as "Hown".
        ...
        * (* ======== ARM C: NOT a directory ======== *)
          ...
          iApply (wp_jal_s_sconf (CID := CID28) (mword_of_int (SC + 0x72)) Rra
                    (mword_of_int 2089196 : mword 21) Q0 (K - 20)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi72").
          iIntros (CID29 Hq29) "Hcg Hpc".
          ...
          assert (Hjiup : add_vec (mword_of_int (SC + 0x72) : mword 64)
                            (sign_extend' 64 (mword_of_int 2089196 : mword 21))
          ...
          iApply (wp_jal_s_sconf (CID := CID30) (mword_of_int (SC + 0x76)) Rra
                    (mword_of_int 2091402 : mword 21) mup (K - 20)%nat b
                    ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc Hi76").
          ...
          iDestruct (cpu_own_transport CID30 CID31 0 eb pj C b
                       ltac:(wp_next_chain) with "Hown") as "Hown".
          iApply (EndOp.wp_end_op_sconf (CID := CID31) gs j gl gu gd gk pd pav pu
                    bn g gfs cov logstart dev n2 pid (DfracOwn (1/4))
                    Q2 (K - 20)%nat eb C b lks
                    ltac:(lia) Hgeom Hj Hgl (Hlb "log"%string)
                    with "Hcg Hown [] [] Htext Hpc Hpanic Hbio Hlog Hseam Hgen
                          Hpidq Hprocs Hdev Hgeo Hdlk Hop").
          { rewrite Heb /trap_csrs_ext. done. }
          ...
          iDestruct (sc_buf_join (pa_stk sp0 20) bf pk Hpk with "Hbufk Hbufrest")
            as "Hbytes2".
          iDestruct (sc_bytes_name (pa_stk sp0 20) 128 with "Hbytes2") as (bf1) "Hbuf".
          iDestruct (cpu_own_transport CID32 CID35 0 eb pj C b
                       ltac:(wp_next_chain) with "Hown") as "Hown".
      ...
      + (* ================= ARM B: namei returned 0 =================
        ...
        iApply (sc_m1_tail (CID0 := CID23) gs j gl gu gd gk pd pav pu bn g gfs
                  ...
                  m N3 sp0 K eb C b lks (m !!! Regidx Rs1 : mword 64) bf1

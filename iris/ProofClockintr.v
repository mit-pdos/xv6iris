...
Section ProofClockintr.
  ...
  Proof.
    ...
    - (* ---------------- THIS HART KEEPS TIME: the tick block ------------- *)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.clockintr + 0x2c)) a0_idx a0_idx (mword_of_int 0xc9a : mword 12)
                B0 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi2c [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.clockintr + 0x30)) ra_idx (mword_of_int 2090786 : mword 21)
                B1 (av - 2)%nat false
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.clockintr + 0x38)) a4_idx a4_idx (mword_of_int 0xd5e : mword 12)
                D0 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi38 [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.clockintr + 0x44)) ra_idx (mword_of_int 2095704 : mword 21)
                D4 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi44 [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.clockintr + 0x4c)) a0_idx a0_idx (mword_of_int 0xc7a : mword 12)
                E0 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi4c [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.clockintr + 0x50)) ra_idx (mword_of_int 2090890 : mword 21)
                E1 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi50 [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".

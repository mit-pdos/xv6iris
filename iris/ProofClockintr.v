...
Section ProofClockintr.
  ...
  Proof using .
    ...
    iApply (Cpuid.wp_call_cpuid_sconf_cs KT1 (mword_of_int (KernelSyms.clockintr + 0x08))
              (mword_of_int 2093964 : mword 21) A1 (av - 2)%nat p
    ...
    - (* ---------------- THIS HART KEEPS TIME: the tick block ------------- *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.clockintr + 0x2c)) a0_idx a0_idx (mword_of_int 0xea8 : mword 12)
                B0 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      ...
      set (B1 := <[Regidx a0_idx := regval_into_reg
          (add_vec (rget B0 a0_idx) (sign_extend' 64 (mword_of_int 3752 : mword 12)))]> B0).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec (rget B0 a0_idx) (sign_extend' 64 (mword_of_int 3752 : mword 12)))]> B0) with B1.
      ...
      (* ---- +0x30: jal ra,acquire ---- *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.clockintr + 0x30)) ra_idx (mword_of_int 2090600 : mword 21)
                B1 (av - 2)%nat false
      ...
      assert (Hjacq : add_vec (mword_of_int (KernelSyms.clockintr + 0x30) : mword 64)
                        (sign_extend' 64 (mword_of_int 2090600 : mword 21))
      ...
      (* ===================== acquire(&tickslock) ===================== *)
      iApply (Acquire.wp_acquire_sconf KT1 γl "time"%string ticks_res_at B2
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.clockintr + 0x38)) a4_idx a4_idx (mword_of_int 0xd84 : mword 12)
                D0 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      { iApply (cii_38 with "Htext"). }
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      set (D1 := <[Regidx a4_idx := regval_into_reg
          (add_vec (rget D0 a4_idx) (sign_extend' 64 (mword_of_int 3460 : mword 12)))]> D0).
      change (<[Regidx a4_idx := regval_into_reg
          (add_vec (rget D0 a4_idx) (sign_extend' 64 (mword_of_int 3460 : mword 12)))]> D0) with D1.
      ...
      (* ---- +0x44: jal ra,wakeup ---- *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.clockintr + 0x44)) ra_idx (mword_of_int 2095676 : mword 21)
                D4 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      assert (Hjwk : add_vec (mword_of_int (KernelSyms.clockintr + 0x44) : mword 64)
                       (sign_extend' 64 (mword_of_int 2095676 : mword 21))
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.clockintr + 0x4c)) a0_idx a0_idx (mword_of_int 0xe88 : mword 12)
                E0 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      ...
      set (E1 := <[Regidx a0_idx := regval_into_reg
          (add_vec (rget E0 a0_idx) (sign_extend' 64 (mword_of_int 3720 : mword 12)))]> E0).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec (rget E0 a0_idx) (sign_extend' 64 (mword_of_int 3720 : mword 12)))]> E0) with E1.
      ...
      (* ---- +0x50: jal ra,release ---- *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.clockintr + 0x50)) ra_idx (mword_of_int 2090704 : mword 21)
                E1 (av - 2)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      assert (Hjrel : add_vec (mword_of_int (KernelSyms.clockintr + 0x50) : mword 64)
                        (sign_extend' 64 (mword_of_int 2090704 : mword 21))
      ...
      iApply (Release.wp_release_sconf KT1 γl a_tickslock "time"%string ticks_res_at E2
                n eb p (av - 2)%nat
                ({["time"]} ∪ lks)

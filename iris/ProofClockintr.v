(* ProofClockintr.v -- clockintr() over the SIE-agnostic sconf world.
   ...
   clockintr() @ 0x800024b6 is xv6's timer-interrupt handler body:
   ...
   A functor over CPUID / ACQUIRE / RELEASE / WAKEUP. *)
...
Section ProofClockintr.
  ...
  (* ================================================================== *)
  (* THE TIMER TAIL (CI+0x0e .. CI+0x26): ask for the next timer         *)
  ...
  (* ================================================================== *)
  Lemma wp_ci_tail (γ : gname) (Φ : mval -> iProp Σ)
      (M : regfile) (sp0 ra0 s00 : mword 64) (k : nat) :
    M !!! Regidx csp_rs1 = pa_stk sp0 2 ->
    timer_cap -∗
    sie_cap_gpr γ M k -∗
    kernel_text -∗ pc_is (mword_of_int (CI + 0x0e) : mword 64) -∗
  ...
  Proof.
    ...
    iApply (wp_csrr_time_s_sconf γ Φ (mword_of_int (CI + 0x0e)) a5_idx M k
    ...
    assert (Hpc12 : add_vec_int (mword_of_int (CI + 0x0e) : mword 64) 4 = mword_of_int (CI + 0x12))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc12) in "Hpc".
    (* ---- +0x12: lui a4,0xf4 ---- *)
    iPoseProof (cii_12 with "Htext") as "Hi12".
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (CI + 0x12)) a4_idx (mword_of_int 0xf4 : mword 20)
              (luival (mword_of_int 0xf4 : mword 20)) T0 k
    ...
    assert (Hpc16 : add_vec_int (mword_of_int (CI + 0x12) : mword 64) 4 = mword_of_int (CI + 0x16))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc16) in "Hpc".
    (* ---- +0x16: addi a4,a4,576 ---- *)
    iPoseProof (cii_16 with "Htext") as "Hi16".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (CI + 0x16)) a4_idx a4_idx (mword_of_int 0x240 : mword 12)
              T1 k
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi16 [-]").
    iIntros "Hcg Hpc".
    set (T2 := <[Regidx a4_idx := regval_into_reg
        (add_vec (T1 !!! Regidx a4_idx) (sign_extend' 64 (mword_of_int 0x240 : mword 12)))]> T1).
    change (<[Regidx a4_idx := regval_into_reg
        (add_vec (T1 !!! Regidx a4_idx) (sign_extend' 64 (mword_of_int 0x240 : mword 12)))]> T1) with T2.
    assert (Hpc1a : add_vec_int (mword_of_int (CI + 0x16) : mword 64) 4 = mword_of_int (CI + 0x1a))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc1a) in "Hpc".
    (* ---- +0x1a: c.add a5,a5,a4 ---- *)
    iPoseProof (cii_1a with "Htext") as "Hi1a".
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (CI + 0x1a)) a5_idx a4_idx T2 k
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1a [-]").
    iIntros "Hcg Hpc".
    set (T3 := <[Regidx a5_idx := regval_into_reg
        (add_vec (T2 !!! Regidx a5_idx) (T2 !!! Regidx a4_idx))]> T2).
    change (<[Regidx a5_idx := regval_into_reg
        (add_vec (T2 !!! Regidx a5_idx) (T2 !!! Regidx a4_idx))]> T2) with T3.
    assert (Hpc1c : add_vec_int (mword_of_int (CI + 0x1a) : mword 64) 2 = mword_of_int (CI + 0x1c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc1c) in "Hpc".
    (* ---- +0x1c: csrw stimecmp,a5 -- the new deadline ---- *)
    iPoseProof (cii_1c with "Htext") as "Hi1c".
    iApply (wp_csrw_stimecmp_s_sconf γ Φ (mword_of_int (CI + 0x1c)) a5_idx T3 k
              ltac:(vm_compute; discriminate)
              with "Htcap Hcg Hpc Hi1c [-]").
    iIntros "Hcg Hpc".
    assert (Hpc20 : add_vec_int (mword_of_int (CI + 0x1c) : mword 64) 4 = mword_of_int (CI + 0x20))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CI + 0x20)) (mword_of_int 1 : mword 6) ra_idx
              T3 k ra0 (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hpc22 : add_vec_int (mword_of_int (CI + 0x20) : mword 64) 2 = mword_of_int (CI + 0x22))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (CI + 0x22)) (mword_of_int 0 : mword 6) s0_idx
              T4 k s00 (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hpc24 : add_vec_int (mword_of_int (CI + 0x22) : mword 64) 2 = mword_of_int (CI + 0x24))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi_sp_pop_s_sconf γ Φ (mword_of_int (CI + 0x24)) (mword_of_int 16 : mword 6)
              T5 k 2 Hpop
    ...
    assert (Hpc26 : add_vec_int (mword_of_int (CI + 0x24) : mword 64) 2 = mword_of_int (CI + 0x26))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (CI + 0x26)) ra_idx T6 (k + 2)%nat
              ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi26 [-]").
    iIntros "Hcg Hpc".
  ...
  (* THE WHOLE FUNCTION.                                                 *)
  (* ================================================================== *)
  Lemma wp_clockintr_sconf (γ : gname) (Φ : mval -> iProp Σ) (γl : gname) (γs : list gname)
  ...
  Proof.
    ...
    iApply (wp_caddi_sp_push_s_sconf γ Φ pcE (mword_of_int 48 : mword 6) m av 2
              ltac:(lia) Hpush
              with "Hcg Hpc Hi00 [-]").
    ...
    assert (Hpc02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (CI + 0x02))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CI + 0x02)) (mword_of_int 1 : mword 6) ra_idx
              A0 (av - 2)%nat vra
              with "Hcg Hpc Hi02 Hbra [-]").
    iIntros "Hcg Hpc Hbra".
    assert (Hpc04 : add_vec_int (mword_of_int (CI + 0x02) : mword 64) 2 = mword_of_int (CI + 0x04))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc04) in "Hpc".
    (* ---- +0x04: c.sdsp s0,0(sp) ---- *)
    iPoseProof (cii_04 with "Htext") as "Hi04".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (CI + 0x04)) (mword_of_int 0 : mword 6) s0_idx
              A0 (av - 2)%nat vs0
              with "Hcg Hpc Hi04 Hbs0 [-]").
    iIntros "Hcg Hpc Hbs0".
    assert (Hpc06 : add_vec_int (mword_of_int (CI + 0x04) : mword 64) 2 = mword_of_int (CI + 0x06))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc06) in "Hpc".
    (* the saved values are the entry ra/s0 *)
    ...
    assert (HA0s0 : A0 !!! Regidx s0_idx = s00)
      by (rewrite /A0 upd_ne; [reflexivity | vm_compute; discriminate]).
    iEval (rewrite Hpa1 HA0ra) in "Hbra".
    iEval (rewrite Hpa2 HA0s0) in "Hbs0".
    (* ---- +0x06: c.addi4spn s0,sp,16 ---- *)
    iPoseProof (cii_06 with "Htext") as "Hi06".
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (CI + 0x06)) (Cregidx (mword_of_int 0))
              (mword_of_int 4 : mword 8) s0_idx A0 (av - 2)%nat
    ...
    assert (Hpc08 : add_vec_int (mword_of_int (CI + 0x06) : mword 64) 2 = mword_of_int (CI + 0x08))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc08) in "Hpc".
    assert (HA1sp : A1 !!! Regidx csp_rs1 = pa_stk sp0 2)
      by (rewrite /A1 upd_ne; [exact HA0sp | vm_compute; discriminate]).
    assert (HA1tp : A1 !!! Regidx tp_idx = cid_word).
    ...
    iApply (Cpuid.wp_call_cpuid_sconf_cs γ Φ (mword_of_int (CI + 0x08))
              (mword_of_int 2094098 : mword 21) A1 (av - 2)%nat
    ...
    assert (Hpc0c : ret_pc (<[Regidx ra_idx := regval_into_reg
                (add_vec_int (mword_of_int (CI + 0x08) : mword 64) 4)]> A1 !!! Regidx ra_idx)
                    = mword_of_int (CI + 0x0c)).
    { rewrite upd_eq. apply bv_eq; vm_compute; reflexivity. }
    iEval (rewrite Hpc0c) in "Hpc".
    (* a0 is this hart's id *)
    assert (Hmoa0 : mo !!! Regidx a0_idx = cid_word)
      by (rewrite Ha0 HA1tp; apply cpuid_ret_cid).
    assert (Hmosp : mo !!! Regidx csp_rs1 = pa_stk sp0 2).
    { rewrite (callee_saved_lookup HcsA1 csp_rs1 ltac:(vm_compute; reflexivity)).
      exact HA1sp. }
    assert (Hmotp : mo !!! Regidx tp_idx = cid_word).
    { rewrite (callee_saved_lookup HcsA1 tp_idx ltac:(vm_compute; reflexivity)).
      exact HA1tp. }
    ...
    - (* ---------------- THIS HART KEEPS TIME: the tick block ------------- *)
      ...
      assert (Hzero : eq_vec (mo !!! Regidx a0_idx) (zero_reg : mword 64) = true)
        by (rewrite Hmoa0; exact Hth).
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (CI + 0x0c)) (mword_of_int 14 : mword 8)
                (Cregidx (mword_of_int 2)) a0_idx mo (av - 2)%nat
                ci_cr2 ltac:(vm_compute; discriminate) Hzero
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi0c [-]").
      iNext. iIntros "Hcg Hpc".
      assert (Hpc28 : add_vec (mword_of_int (CI + 0x0c) : mword 64)
                        (sign_extend' 64 (sign_extend' 13 (concat_vec (mword_of_int 14 : mword 8) ('b"0"))))
                      = mword_of_int (CI + 0x28))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc28) in "Hpc".
      (* ---- +0x28/+0x2c: a0 := &tickslock ---- *)
      iPoseProof (cii_28 with "Htext") as "Hi28".
      iApply (wp_auipc_s_sconf γ Φ (mword_of_int (CI + 0x28)) a0_idx (mword_of_int 0x16 : mword 20)
                mo (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi28 [-]").
      iIntros "Hcg Hpc".
      set (B0 := <[Regidx a0_idx := regval_into_reg
          (add_vec (mword_of_int (CI + 0x28) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> mo).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec (mword_of_int (CI + 0x28) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> mo) with B0.
      assert (Hpc2c : add_vec_int (mword_of_int (CI + 0x28) : mword 64) 4 = mword_of_int (CI + 0x2c))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc2c) in "Hpc".
      iPoseProof (cii_2c with "Htext") as "Hi2c".
      iApply (wp_addi4_s_sconf γ Φ (mword_of_int (CI + 0x2c)) a0_idx a0_idx (mword_of_int 0xc9a : mword 12)
                B0 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi2c [-]").
      iIntros "Hcg Hpc".
      set (B1 := <[Regidx a0_idx := regval_into_reg
          (add_vec (B0 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 0xc9a : mword 12)))]> B0).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec (B0 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 0xc9a : mword 12)))]> B0) with B1.
      assert (Hpc30 : add_vec_int (mword_of_int (CI + 0x2c) : mword 64) 4 = mword_of_int (CI + 0x30))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc30) in "Hpc".
      (* ---- +0x30: jal ra,acquire ---- *)
      iPoseProof (cii_30 with "Htext") as "Hi30".
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (CI + 0x30)) ra_idx (mword_of_int 2090786 : mword 21)
                B1 (av - 2)%nat
      ...
      set (B2 := <[Regidx ra_idx := regval_into_reg
          (add_vec_int (mword_of_int (CI + 0x30) : mword 64) 4)]> B1).
      change (<[Regidx ra_idx := regval_into_reg
          (add_vec_int (mword_of_int (CI + 0x30) : mword 64) 4)]> B1) with B2.
      assert (Hjacq : add_vec (mword_of_int (CI + 0x30) : mword 64)
                        (sign_extend' 64 (mword_of_int 2090786 : mword 21))
                      = mword_of_int KernelSyms.acquire)
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hjacq) in "Hpc".
      assert (HB2ra : B2 !!! Regidx ra_idx
                      = add_vec_int (mword_of_int (CI + 0x30) : mword 64) 4)
        by (rewrite /B2 upd_eq; reflexivity).
      assert (HB2a0 : B2 !!! Regidx a0_idx = a_tickslock).
      { rewrite /B2 upd_ne; [| vm_compute; discriminate].
        rewrite /B1 upd_eq. rewrite /B0 upd_eq.
        rewrite /a_tickslock. apply bv_eq; vm_compute; reflexivity. }
      assert (HB2tp : B2 !!! Regidx tp_idx = cid_word).
      { rewrite /B2 upd_ne; [| vm_compute; discriminate].
        rewrite /B1 upd_ne; [| vm_compute; discriminate].
        rewrite /B0 upd_ne; [| vm_compute; discriminate]. exact Hmotp. }
      ...
      iApply (wp_auipc_s_sconf γ Φ (mword_of_int (CI + 0x34)) a4_idx (mword_of_int 0x8 : mword 20)
                MA (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi34 [-]").
      iIntros "Hcg Hpc".
      set (D0 := <[Regidx a4_idx := regval_into_reg
          (add_vec (mword_of_int (CI + 0x34) : mword 64) (auipc_off (mword_of_int 0x8 : mword 20)))]> MA).
      change (<[Regidx a4_idx := regval_into_reg
          (add_vec (mword_of_int (CI + 0x34) : mword 64) (auipc_off (mword_of_int 0x8 : mword 20)))]> MA) with D0.
      assert (Hpc38 : add_vec_int (mword_of_int (CI + 0x34) : mword 64) 4 = mword_of_int (CI + 0x38))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc38) in "Hpc".
      iPoseProof (cii_38 with "Htext") as "Hi38".
      iApply (wp_addi4_s_sconf γ Φ (mword_of_int (CI + 0x38)) a4_idx a4_idx (mword_of_int 0xd5e : mword 12)
                D0 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi38 [-]").
      iIntros "Hcg Hpc".
      set (D1 := <[Regidx a4_idx := regval_into_reg
          (add_vec (D0 !!! Regidx a4_idx) (sign_extend' 64 (mword_of_int 0xd5e : mword 12)))]> D0).
      change (<[Regidx a4_idx := regval_into_reg
          (add_vec (D0 !!! Regidx a4_idx) (sign_extend' 64 (mword_of_int 0xd5e : mword 12)))]> D0) with D1.
      assert (Hpc3c : add_vec_int (mword_of_int (CI + 0x38) : mword 64) 4 = mword_of_int (CI + 0x3c))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc3c) in "Hpc".
      assert (HD1a4 : D1 !!! Regidx a4_idx = a_ticks).
      { rewrite /D1 upd_eq. rewrite /D0 upd_eq.
        rewrite /a_ticks. apply bv_eq; vm_compute; reflexivity. }
      assert (Haddrt : add_vec (D1 !!! Regidx a4_idx) (sign_extend' 64 (mword_of_int 0 : mword 12))
                       = a_ticks)
        by (rewrite HD1a4; apply ci_add_vec_0).
      (* ---- +0x3c: c.lw a5,0(a4) -- read ticks, under the lock ---- *)
      iPoseProof (cii_3c with "Htext") as "Hi3c".
      iApply (wp_clw_s_sconf γ Φ (mword_of_int (CI + 0x3c)) a5_idx a4_idx
                (mword_of_int 0 : mword 12) D1 (av - 2)%nat t (dqm := DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      assert (Hpc3e : add_vec_int (mword_of_int (CI + 0x3c) : mword 64) 2 = mword_of_int (CI + 0x3e))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc3e) in "Hpc".
      (* ---- +0x3e: c.addiw a5,1 -- ticks + 1 as an int ---- *)
      iPoseProof (cii_3e with "Htext") as "Hi3e".
      iApply (wp_caddiw_s_sconf γ Φ (mword_of_int (CI + 0x3e)) a5_idx (mword_of_int 1 : mword 6)
                D2 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi3e [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hpc40 : add_vec_int (mword_of_int (CI + 0x3e) : mword 64) 2 = mword_of_int (CI + 0x40))
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      assert (Haddrt3 : add_vec (D3 !!! Regidx a4_idx) (sign_extend' 64 (mword_of_int 0 : mword 12))
                        = a_ticks)
        by (rewrite HD3a4; apply ci_add_vec_0).
      iPoseProof (cii_40 with "Htext") as "Hi40".
      iApply (wp_csw_s_sconf γ Φ (mword_of_int (CI + 0x40)) a5_idx a4_idx
                (mword_of_int 0 : mword 12) D3 (av - 2)%nat t
                with "Hcg Hpc Hi40 [Hticks] [-]").
      { iEval (rewrite Haddrt3). iExact "Hticks". }
      iIntros "Hcg Hpc Hticks".
      iEval (rewrite Haddrt3) in "Hticks".
      assert (Hpc42 : add_vec_int (mword_of_int (CI + 0x40) : mword 64) 2 = mword_of_int (CI + 0x42))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc42) in "Hpc".
      (* ---- +0x42: c.mv a0,a4 -- the wakeup channel ---- *)
      iPoseProof (cii_42 with "Htext") as "Hi42".
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (CI + 0x42)) a0_idx a4_idx D3 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi42 [-]").
      iIntros "Hcg Hpc".
      set (D4 := <[Regidx a0_idx := regval_into_reg
          (add_vec zero_reg (D3 !!! Regidx a4_idx))]> D3).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec zero_reg (D3 !!! Regidx a4_idx))]> D3) with D4.
      assert (Hpc44 : add_vec_int (mword_of_int (CI + 0x42) : mword 64) 2 = mword_of_int (CI + 0x44))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc44) in "Hpc".
      (* ---- +0x44: jal ra,wakeup ---- *)
      iPoseProof (cii_44 with "Htext") as "Hi44".
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (CI + 0x44)) ra_idx (mword_of_int 2095704 : mword 21)
                D4 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi44 [-]").
      iIntros "Hcg Hpc".
      set (D5 := <[Regidx ra_idx := regval_into_reg
          (add_vec_int (mword_of_int (CI + 0x44) : mword 64) 4)]> D4).
      change (<[Regidx ra_idx := regval_into_reg
          (add_vec_int (mword_of_int (CI + 0x44) : mword 64) 4)]> D4) with D5.
      assert (Hjwk : add_vec (mword_of_int (CI + 0x44) : mword 64)
                       (sign_extend' 64 (mword_of_int 2095704 : mword 21))
                     = mword_of_int KernelSyms.wakeup)
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hjwk) in "Hpc".
      assert (HD5ra : D5 !!! Regidx ra_idx
                      = add_vec_int (mword_of_int (CI + 0x44) : mword 64) 4)
        by (rewrite /D5 upd_eq; reflexivity).
      assert (HD5tp : D5 !!! Regidx tp_idx = cid_word).
      { rewrite /D5 upd_ne; [| vm_compute; discriminate].
        ...
        rewrite (callee_saved_lookup HcsA tp_idx ltac:(vm_compute; reflexivity)).
        exact HB2tp. }
      ...
      { rewrite /D5 upd_ne; [| vm_compute; discriminate].
        ...
        exact HB2sp. }
      (* ===================== wakeup(&ticks) ===================== *)
      iApply (Wakeup.wp_wakeup_sconf γ Φ D5 γs (mycpu_ret cid_word) p (S n) (av - 2)%nat eb C
                ltac:(lia)
      ...
      iApply (wp_auipc_s_sconf γ Φ (mword_of_int (CI + 0x48)) a0_idx (mword_of_int 0x16 : mword 20)
                MW (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi48 [-]").
      iIntros "Hcg Hpc".
      set (E0 := <[Regidx a0_idx := regval_into_reg
          (add_vec (mword_of_int (CI + 0x48) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> MW).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec (mword_of_int (CI + 0x48) : mword 64) (auipc_off (mword_of_int 0x16 : mword 20)))]> MW) with E0.
      assert (Hpc4c : add_vec_int (mword_of_int (CI + 0x48) : mword 64) 4 = mword_of_int (CI + 0x4c))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc4c) in "Hpc".
      iPoseProof (cii_4c with "Htext") as "Hi4c".
      iApply (wp_addi4_s_sconf γ Φ (mword_of_int (CI + 0x4c)) a0_idx a0_idx (mword_of_int 0xc7a : mword 12)
                E0 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi4c [-]").
      iIntros "Hcg Hpc".
      set (E1 := <[Regidx a0_idx := regval_into_reg
          (add_vec (E0 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 0xc7a : mword 12)))]> E0).
      change (<[Regidx a0_idx := regval_into_reg
          (add_vec (E0 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 0xc7a : mword 12)))]> E0) with E1.
      assert (Hpc50 : add_vec_int (mword_of_int (CI + 0x4c) : mword 64) 4 = mword_of_int (CI + 0x50))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpc50) in "Hpc".
      (* ---- +0x50: jal ra,release ---- *)
      iPoseProof (cii_50 with "Htext") as "Hi50".
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (CI + 0x50)) ra_idx (mword_of_int 2090890 : mword 21)
                E1 (av - 2)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi50 [-]").
      iIntros "Hcg Hpc".
      set (E2 := <[Regidx ra_idx := regval_into_reg
          (add_vec_int (mword_of_int (CI + 0x50) : mword 64) 4)]> E1).
      change (<[Regidx ra_idx := regval_into_reg
          (add_vec_int (mword_of_int (CI + 0x50) : mword 64) 4)]> E1) with E2.
      assert (Hjrel : add_vec (mword_of_int (CI + 0x50) : mword 64)
                        (sign_extend' 64 (mword_of_int 2090890 : mword 21))
                      = mword_of_int KernelSyms.release)
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hjrel) in "Hpc".
      assert (HE2ra : E2 !!! Regidx ra_idx
                      = add_vec_int (mword_of_int (CI + 0x50) : mword 64) 4)
        by (rewrite /E2 upd_eq; reflexivity).
      assert (HE2a0 : E2 !!! Regidx a0_idx = a_tickslock).
      { rewrite /E2 upd_ne; [| vm_compute; discriminate].
        rewrite /E1 upd_eq. rewrite /E0 upd_eq.
        rewrite /a_tickslock. apply bv_eq; vm_compute; reflexivity. }
      assert (HE2tp : E2 !!! Regidx tp_idx = cid_word).
      { rewrite /E2 upd_ne; [| vm_compute; discriminate].
        rewrite /E1 upd_ne; [| vm_compute; discriminate].
        rewrite /E0 upd_ne; [| vm_compute; discriminate].
        rewrite (callee_saved_lookup HcsW tp_idx ltac:(vm_compute; reflexivity)).
        exact HD5tp. }
    ...
    - (* ---------------- ANOTHER HART: straight to the timer tail -------- *)
      assert (Hnzero : eq_vec (mo !!! Regidx a0_idx) (zero_reg : mword 64) = false)
        by (rewrite Hmoa0; exact Hth).
      iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (CI + 0x0c)) (mword_of_int 14 : mword 8)
                (Cregidx (mword_of_int 2)) a0_idx mo (av - 2)%nat
      ...
      iApply (wp_ci_tail γ Φ mo sp0 ra0 s00 (av - 2)%nat Hmosp
                with "Htcap Hcg Htext Hpc Hbra Hbs0 [-]").
      iIntros (Mf) "[%Hfsp [%Hfs0 %Hfthr]] Hcg Hpc".
      assert (Hnk : ((av - 2) + 2)%nat = av) by lia.
      iEval (rewrite Hnk) in "Hcg".

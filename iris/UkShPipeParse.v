...
(*              break;                        (user/sh.c:481)             *)
(*                                                                        *)
(* FIVE INSTRUCTIONS -- 0x84a c.ld a0,8(a0); 0x84c jal nulterminate;      *)
(* 0x850 c.ld a0,16(s1); 0x852 jal nulterminate; 0x856 c.j 83e -- and     *)
(* then the same 0x83e tail the EXEC and REDIR arms fall into, so          *)
...
(* so the row is indexed at 0x13cc instead of 0x13c8 and the table sends   *)
(* control to 0x84a instead of 0x832.  [ushp_jrow_pipe] is those four      *)
(* .rodata bytes (0xFFFFF49A, and 0x13c0 + it IS 0x84a), read off the      *)
...
(*ALIASES-BEGIN*)
  ...
  Proof using .
    ...
    (* ---- 0x800  bltu a5,a4 -- NOT taken: PIPE is in range ---- *)
    ...
    iApply (wp_uk_cadd N h12 m9 (mword_of_int 0x812) a5_idx
              a4_idx (mword_of_int 0x13cc) (4 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
    ...
    set (m10 := <[Regidx a5_idx
                  := regval_into_reg (mword_of_int 0x13cc : mword 64)]> m9).
    ...
    assert (Ha5_10 : m10 !!! Regidx a5_idx = mword_of_int 0x13cc)
      by exact (upd_eq m9 (Regidx a5_idx)
                  (regval_into_reg (mword_of_int 0x13cc : mword 64))).
    ...
    iApply (wp_uk_clw_text N h13 m10 (mword_of_int 0x814)
              ...
              (mword_of_int 7 : mword 3) a5_idx a5_idx 0x13cc
              (mword_of_int 4294964362 : mword 32) (4 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              ltac:(vm_compute; reflexivity)
              ltac:(rewrite Ha5_10;
                    rewrite (uint_moi 0x13cc ltac:(unfold Z64; lia));
                    vm_compute uoff_c4; lia)
              ltac:(vm_compute; reflexivity)
              ltac:(vm_compute; discriminate)
              with "[] [] Hrun").
    ...
    set (m11 := <[Regidx a5_idx
                  := regval_into_reg
                       (sign_extend' 64
                          (mword_of_int 4294964362 : mword 32)
                        : mword 64)]> m10).
    ...
    iApply (wp_uk_cadd N h14 m11 (mword_of_int 0x816) a5_idx
              a4_idx (mword_of_int 0x84a) (4 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(rewrite Ha4_11
    ...
    set (m12 := <[Regidx a5_idx
                  := regval_into_reg (mword_of_int 0x84a : mword 64)]> m11).
    ...
    iApply (wp_uk_cjr N h15 m12 (mword_of_int 0x818) a5_idx
              (mword_of_int 0x84a) (4 + nn)
              ltac:(vm_compute; discriminate)
              ltac:(rewrite (upd_eq m11 (Regidx a5_idx)
                               (regval_into_reg
                                  (mword_of_int 0x84a : mword 64)));
                    apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
    ...
    iApply (wp_uk_jal N h17 n1 (mword_of_int 0x84c)
              ...
              (mword_of_int 0x7ee) (mword_of_int 0x850) (4 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_jal N h20 n3 (mword_of_int 0x852)
              ...
              (mword_of_int 0x7ee) (mword_of_int 0x856) (4 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_cj N h22 mr2 (mword_of_int 0x856)
              (mword_of_int 2036 : mword 11) (mword_of_int 0x83e) (4 + nn)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(vm_compute; reflexivity)
              with "[] Hrun").
    { iApply (uis_shp_856 with "Hcode"). }
    iIntros (h23) "Hrun".
    (* ---- 0x83e..0x848  the common tail, the EXEC arm's own ---- *)

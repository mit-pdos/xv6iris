...
Section ProofProcdumpParts.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x1a)) Ra0 Ra0 (mword_of_int 3436 : mword 12)
              P2 (K - 10)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1a").
    iIntros (CID13 Hs13) "Hcg Hpc".
    iEval (rewrite Hrg1a) in "Hcg".
    set (P3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (P2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 3436 : mword 12)))]> P2).
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x26)) Rs1 Rs1 (mword_of_int 1528 : mword 12)
    ...
    set (Q2 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (Q1 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 1528 : mword 12)))]> Q1).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x2e)) Rs2 Rs2 (mword_of_int 4080 : mword 12)
    ...
    set (Q4 := <[Regidx Rs2 := regval_into_reg
                  (add_vec (Q3 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 4080 : mword 12)))]> Q3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x38)) Rs3 Rs3 (mword_of_int 3830 : mword 12)
    ...
    set (Q7 := <[Regidx Rs3 := regval_into_reg
                  (add_vec (Q6 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 3830 : mword 12)))]> Q6).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x40)) Rs5 Rs5 (mword_of_int 3830 : mword 12)
    ...
    set (Q9 := <[Regidx Rs5 := regval_into_reg
                  (add_vec (Q8 !!! Regidx Rs5) (sign_extend' 64 (mword_of_int 3830 : mword 12)))]> Q8).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x48)) Rs4 Rs4 (mword_of_int 3390 : mword 12)
    ...
    set (Q11 := <[Regidx Rs4 := regval_into_reg
                   (add_vec (Q10 !!! Regidx Rs4) (sign_extend' 64 (mword_of_int 3390 : mword 12)))]> Q10).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (PD + 0x50)) Rs7 Rs7 (mword_of_int 1030 : mword 12)
    ...
    set (Q13 := <[Regidx Rs7 := regval_into_reg
                   (add_vec (Q12 !!! Regidx Rs7) (sign_extend' 64 (mword_of_int 1030 : mword 12)))]> Q12).

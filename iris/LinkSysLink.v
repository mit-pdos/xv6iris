(* LinkSysLink.v -- instantiates the sys_link proof against its eleven
   ...
   five plus funext, plus the transient
   [ProofIput.iput_acquiresleep_order_ADMITTED] that iunlockput and iput
   carry in from upstream -- and NOT [create_fresh_ty]: sys_link allocates
   no inode and never reaches create.

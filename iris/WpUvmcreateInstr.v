(* WpUvmcreateInstr.v -- decode catalog for xv6's uvmcreate() (kernel/vm.c),
   ...
   epilogue.  Same architecture as WpKvmmakeInstr.v: per-instruction decode
...
Section UvmcreateInstrs.
  ...
  (* ExecuteAs redirect not in WpMmodeLeafBase (a Local copy, as in
     WpMappagesInstr / WpWalkInstr / WpKvmmakeInstr) *)

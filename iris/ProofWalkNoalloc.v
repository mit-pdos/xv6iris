...
Require Import RiscvLang RiscvPtsto RiscvModelBytes RiscvExec RiscvFetchExec.
...
Section ProofWalkNoalloc.
  ...
  (* ================================================================= *)
  Lemma wp_wkn_epilogue (γ : gname) (Φ : mval -> iProp Σ)
  ...
  (* ================================================================= *)
  Lemma wp_wkn_fail (γ : gname) (Φ : mval -> iProp Σ)
      (mm Mf : regfile) (t : ptree) (m : gmap (mword 27) (mword 64))
      (K : nat) (dq : dfrac) :
    let va := mm !!! Regidx (mword_of_int 11) in
    let vpn := svpn_of va in
  ...
  Proof.
    ...
    iApply (wp_beqz_x0_taken_s_sconf γ Φ (mword_of_int (WK + 0x72)) (mword_of_int 36 : mword 13) (mword_of_int 22 : mword 5)
              Mf (K - 8)%nat ltac:(vm_compute; discriminate) Hs6
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi72 [-]").
    iNext. iIntros "Hcg Hpc".
    assert (Htgt96 : add_vec (mword_of_int (WK + 0x72) : mword 64)
                       (sign_extend' 64 (mword_of_int 36 : mword 13))
                     = mword_of_int (WK + 0x96)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgt96) in "Hpc".
    (* +0x96 c.li a0,0 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (WK + 0x96)) (mword_of_int 10 : mword 5) (mword_of_int 0 : mword 6)
    ...
    assert (Hpp98 : add_vec_int (mword_of_int (WK + 0x96) : mword 64) 2 = mword_of_int (WK + 0x98)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp98) in "Hpc".
    (* +0x98 c.j -> +0x52 *)
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (WK + 0x98))
              (sign_extend' 21 (concat_vec (mword_of_int 2013 : mword 11) ('b"0")))
              F1 (K - 8)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi98 [-]").
    iNext. iIntros "Hcg Hpc".
    assert (Htgt52 : add_vec (mword_of_int (WK + 0x98) : mword 64)
    ...
    iApply (wp_wkn_epilogue γ Φ mm F1 t m K dq HK HspF1 HF1x4
  ...
  (* ================================================================= *)
  Lemma wp_wkn_tail (γ : gname) (Φ : mval -> iProp Σ)
      (mm Mf : regfile) (t : ptree) (m : gmap (mword 27) (mword 64))
      (b0 : mword 44) (K : nat) (dq : dfrac) :
    let va := mm !!! Regidx (mword_of_int 11) in
    let vpn := svpn_of va in
    let sp0 := mm !!! Regidx csp_rs1 in
    let spr := add_vec sp0 (sign_extend' 64 (caddi16sp_imm (mword_of_int 60 : mword 6))) in
  ...
  Proof.
    ...
    iApply (wp_wkn_epilogue γ Φ mm T4 t m K dq HK HspT4 HT4x4
  ...
  (* ================================================================= *)
  Lemma wp_wkn_probe (γ : gname) (Φ : mval -> iProp Σ)
  ...
  (* ================================================================= *)
  Lemma wp_walk_noalloc_sconf (γ : gname) (Φ : mval -> iProp Σ)
      (mm : regfile) (t : ptree)
  ...
  Proof.
    ...
    assert (HpcE : pcE = (mword_of_int WK : mword 64)) by reflexivity.
    ...
    iApply (wp_wkn_probe γ Φ W9 (K - 8)%nat va (mword_of_int 30 : mword 64)
              (u_pte_addr (pt_base t) (vpn_idx 2 vpn)) (pt_ents t (vpn_idx 2 vpn))
              (dqm:=dq) HW9s3 HW9s4
    ...
    { (* ===== V=0 at level 2: beqz taken -> the alloc=0 arm ===== *)
      ...
      iApply (wp_wkn_fail γ Φ mm M6 t m K dq HK HspM6 HM6s6 HM6x4
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (WK + 0x3a)) (mword_of_int 28 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
              M6 (K - 8)%nat ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite HM6a5 walk_vbit_eq Hvbit2; reflexivity)
              with "Hcg Hpc Hi3a [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_wkn_probe γ Φ M9 (K - 8)%nat va (mword_of_int 21 : mword 64)
    ...
    { (* ===== V=0 at level 1: beqz taken -> the alloc=0 arm ===== *)
      ...
      { rewrite /pte1 Hz1.
        ...
        apply Z.bits_0. }
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (WK + 0x3a)) (mword_of_int 28 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
                N6 (K - 8)%nat ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HN6a5 walk_vbit_eq Hvbit0; reflexivity)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi3a [-]").
      iNext. iIntros "Hcg Hpc".
      assert (Htgt72 : add_vec (mword_of_int (WK + 0x3a) : mword 64) (sign_extend' 64 (sign_extend' 13 (concat_vec (mword_of_int 28 : mword 8) ('b"0")))) = mword_of_int (WK + 0x72)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Htgt72) in "Hpc".
      iApply (wp_wkn_fail γ Φ mm N6 t m K dq HK HspN6 HN6s6 HN6x4
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (WK + 0x3a)) (mword_of_int 28 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
              N6 (K - 8)%nat ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite HN6a5 walk_vbit_eq Hvbit1; reflexivity)
              with "Hcg Hpc Hi3a [-]").
    iIntros "Hcg Hpc".
    assert (Hpp3c' : add_vec_int (mword_of_int (WK + 0x3a) : mword 64) 2 = mword_of_int (WK + 0x3c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp3c') in "Hpc".
    (* +0x3c c.srli s1,10 *)
    iApply (wp_csrli_s_sconf γ Φ (mword_of_int (WK + 0x3c)) (Cregidx (mword_of_int 1)) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 6)
              N6 (K - 8)%nat ltac:(reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3c [-]").
    iIntros "Hcg Hpc".
    ...
    (* +0x3e c.slli s1,12 *)
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (WK + 0x3e)) (Regidx (mword_of_int 9 : mword 5)) (mword_of_int 9 : mword 5) (mword_of_int 12 : mword 6)
              N7 (K - 8)%nat ltac:(reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3e [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_bne_fall_s_sconf γ Φ (mword_of_int (WK + 0x42)) (mword_of_int 8164 : mword 13) (mword_of_int 21 : mword 5) (mword_of_int 20 : mword 5)
              N9 (K - 8)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HN9s4 HN9s5; vm_compute; reflexivity)
              with "Hcg Hpc Hi42 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_wkn_tail γ Φ mm N9 t m (pt_base c0) K dq HK Hva'

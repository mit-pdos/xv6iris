...
(* ===================================================================== *)
(* §3c  The UART legal-entry set [P_uart4k] and its discrimination.  The    *)
(*     UART data translate INSTANTIATES TrampTlb's generic 4KB three-way    *)
(*     translate ([exec_translateAddr_tramp], hit/nonmatch/walk, generic in *)
(*     the access), which installs a [tlb4k_entry].  So the invariant's     *)
(*     legal-entry set [P_uart4k] is phrased on [tlb4k_entry]; its          *)
(*     discrimination ([P_uart4k_disc]) proves the UART entry never matches *)
(*     a RAM svpn (the tag [sign_extend' 45 0x10000] vs the 0x80000         *)
(*     gigapage), so a colliding RAM access re-walks rather than mis-hits.  *)
(* ===================================================================== *)

...
Global Instance fread_names_inhabited : Inhabited fread_names :=
  populate (MkFReadNames
    ...
    (DiskNames 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive 1%positive)
...
Section SpecFileread.
  ...
  Definition fileread_fs_env (γf : gname) (fn : fread_names) : iProp Σ :=
    (⌜log_geom_ok (frn_cov fn) (frn_logstart fn)⌝ ∗
     ...
     is_lock (frn_dlock fn) d_lock "virtio_disk"%string (disk_res_at (frn_disk fn) (frn_pd fn) (frn_pav fn) (frn_pu fn)) ∗
  ...
  Proof.
    ...
    iExists ik, inum, (q * fp_iq pn)%Qp, (fp_ig pn), ty, (fp_ocv pn), lo, tl.

(* LinkBread.v -- bread()'s contract, TEMPORARILY ASSUMED.
   ...
   register postcondition weakens to [callee_saved_notp] + the tp pin.  bread()'s
   restated contract (SpecBread.v) is CORRECT AND INTENDED; its proof tower has to

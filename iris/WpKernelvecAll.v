...
Section KVALL.
  ...
  Lemma wp_kernelvec (w1 : mword 32) (imm6 : mword 6) (w2 : mword 16) (w3 : mword 32) (w4 : mword 16) (w5 : mword 32) (w6 : mword 16) (w7 : mword 32) (w8 : mword 16) (w9 : mword 32) (w10 : mword 16) (w11 : mword 32) (w12 : mword 16) (w13 : mword 32) (w14 : mword 16) (w15 : mword 32) (w16 : mword 16) (w17 : mword 32) (w18 : mword 16) (vpn : mword 27)
    ...
    ▷ ( ∀ (m' : gmap register_bitvector_64 (mword 64)) (npc' : mword 64),
        ...
        PC ↦ᵣ sret_tgt sepc0 -∗
        gpr_file (<[gpr_of_Z 2 := regval_into_reg (add_vec (regval_into_reg spnew) (sign_extend' 64 (caddi16sp_imm immA)))]> (<[gpr_of_Z 31 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR18))]> (<[gpr_of_Z 30 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR17))]> (<[gpr_of_Z 29 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR16))]> (<[gpr_of_Z 28 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR15))]> (<[gpr_of_Z 17 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR14))]> (<[gpr_of_Z 16 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR13))]> (<[gpr_of_Z 15 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR12))]> (<[gpr_of_Z 14 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR11))]> (<[gpr_of_Z 13 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR10))]> (<[gpr_of_Z 12 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR9))]> (<[gpr_of_Z 11 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR8))]> (<[gpr_of_Z 10 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR7))]> (<[gpr_of_Z 7 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR6))]> (<[gpr_of_Z 6 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vR5))]> (<[gpr_of_Z 5 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vt0))]> (<[gpr_of_Z 3 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vgp))]> (<[gpr_of_Z 1 := regval_into_reg (extend_value false (update_subrange_vec_dec (zeros' (8*1*8)) (8*(0+1)*8-1) (8*0*8) vra))]> m')))))))))))))))))) -∗

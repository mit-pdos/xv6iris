...
Definition wp_free_desc_sconf_body
    `{!riscvGS Σ, !sieG Σ, !lockG Σ, !fdslotG Σ, !irefNameG Σ, !irefslotG Σ, !diskGhostG Σ} `{GEN : GenId} `{CID : CpuId}
     (γs : list gname)
    (pd : mword 64) (i : nat)
...
Module Type FREEDESC.
  Parameter wp_free_desc_sconf :
    forall `{!riscvGS Σ, !sieG Σ, !lockG Σ, !fdslotG Σ, !irefNameG Σ, !irefslotG Σ, !diskGhostG Σ} `{GEN : GenId} `{CID : CpuId}
       (γs : list gname)
      (pd : mword 64) (i : nat)
      (m : regfile) (K lvl : nat) (eb : bool) (pme : mword 64) (C : iProp Σ)
      (va : mword 64) (vl : mword 32) (vf vn : mword 16) (b : bool),

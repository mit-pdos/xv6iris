(* ProofSysUnlinkPure.v -- sys_unlink's PURE LAYER: the name, register, ledger
   ...
   THE WALK is [ProofSysUnlinkW1/W2/W3/W5F/W5D] over
   [ProofSysUnlinkShared.v], sealed by [ProofSysUnlink.v], decomposed
   exactly as projects/fs-sysfile.md's S7-unlink entry decomposes it:
   ...
   ProofSysUnlinkPure case study has the full ranking and the two negative
...
Definition su_dummyV : pprivate :=
  MkPPriv (mword_of_int 0)
          ...
          [] [] 1%positive (mword_of_int 0) [] 0 1%positive 1%positive.

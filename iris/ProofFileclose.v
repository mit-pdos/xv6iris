...
Section ProofFileclose.
  ...
  Proof using .
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (FC + 0x10)) Ra0 Ra0 (mword_of_int 1290 : mword 12)
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (FC + 0x14)) Rra (mword_of_int 2083298 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (FC + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 2083298 : mword 21))
    ...
    - (* ===============================================================
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (FC + 0x86)) Ra0 Ra0
                (mword_of_int 1172 : mword 12) E1 (trap_res b + (K - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      ...
      set (E2 := <[Regidx Ra0 := regval_into_reg
                    (add_vec (E1 !!! Regidx Ra0)
                       (sign_extend' 64 (mword_of_int 1172 : mword 12)))]> E1).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (FC + 0x8a)) Rra
                (mword_of_int 2083316 : mword 21) E2 (trap_res b + (K - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
      ...
      assert (Htgtrel : add_vec (mword_of_int (FC + 0x8a) : mword 64)
                          (sign_extend' 64 (mword_of_int 2083316 : mword 21))
    ...
    - (* ===============================================================
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (FC + 0x4c)) Ra0 Ra0
                (mword_of_int 1230 : mword 12) G1 (trap_res b + (K - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      ...
      set (G2 := <[Regidx Ra0 := regval_into_reg
                    (add_vec (G1 !!! Regidx Ra0)
                       (sign_extend' 64 (mword_of_int 1230 : mword 12)))]> G1).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (FC + 0x50)) Rra
                (mword_of_int 2083374 : mword 21) G2 (trap_res b + (K - 8))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
      ...
      assert (Htgtrel2 : add_vec (mword_of_int (FC + 0x50) : mword 64)
                           (sign_extend' 64 (mword_of_int 2083374 : mword 21))
                         = mword_of_int KernelSyms.release)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      + (* ============ FD_PIPE: pipeclose(ff.pipe, ff.writable) ======= *)
        ...
        destruct (fdstate_ok_pipe _ _ _ _ _ _ Hokpn Hpipe) as (bdr & bdw & Hstp).
      ...
      + (* ============ not a pipe: the inode test at +0x5a ============ *)
        ...
        iDestruct (fileclose_cpost_nonpipe _ _ _ _ Cf st q Φc Hokpn Hnpipe
        ...
        * (* ======== FD_INODE / FD_DEVICE: begin_op(); iput(); end_op() === *)
          ...
          { rewrite /fileclose_env.
            destruct Hinode as [Ht | Ht];
              ...
              | destruct (fdstate_ok_device _ _ _ _ _ _ Hok Ht) as (? & ? & ->) ]; iExact "Henv". }

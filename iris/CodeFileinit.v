(* CodeFileinit.v -- the instruction-DECODE layer for xv6's fileinit().
...
Section CodeFileinit.
  ...
  Lemma fii_00 : kernel_text -∗ instr (mword_of_int KernelSyms.fileinit : mword 64) true (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)).
  Proof. mk_rvc KernelSyms.fileinit (mword_of_int 0x1141 : mword 16)
    (mword_of_int KernelSyms.fileinit : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_1141 exec_execute_C_ADDI. Qed.

  Lemma fii_02 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileinit + 0x02) : mword 64) true (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)).
  Proof. mk_rvc (KernelSyms.fileinit + 0x02)%Z (mword_of_int 0xe406 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) cdec_e406 exec_execute_C_SDSP. Qed.

  Lemma fii_04 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileinit + 0x04) : mword 64) true (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)).
  Proof. mk_rvc (KernelSyms.fileinit + 0x04)%Z (mword_of_int 0xe022 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) cdec_e022 exec_execute_C_SDSP. Qed.

  Lemma fii_06 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileinit + 0x06) : mword 64) true (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)).
  Proof. mk_rvc (KernelSyms.fileinit + 0x06)%Z (mword_of_int 0x0800 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x06) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_0800 exec_execute_C_ADDI4SPN. Qed.

  Lemma fii_08 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileinit + 0x08) : mword 64) false (UTYPE (mword_of_int 3 : mword 20, Regidx (mword_of_int 11), AUIPC)).
  ...
  Proof. mk_rvc (KernelSyms.fileinit + 0x1c)%Z (mword_of_int 0x60a2 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x1c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_60a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KernelSyms.fileinit + 0x1e)%Z (mword_of_int 0x6402 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x1e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_6402 exec_execute_C_LDSP. Qed.

  Lemma fii_20 : kernel_text -∗ instr (mword_of_int (KernelSyms.fileinit + 0x20) : mword 64) true (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)).
  Proof. mk_rvc (KernelSyms.fileinit + 0x20)%Z (mword_of_int 0x0141 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x20) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_0141 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.fileinit + 0x22)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (KernelSyms.fileinit + 0x22) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.

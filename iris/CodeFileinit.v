...
Section CodeFileinit.
  ...
  Proof. mk_rvc FI (mword_of_int 0x1141 : mword 16)
    (mword_of_int FI : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_1141 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (FI + 0x02)%Z (mword_of_int 0xe406 : mword 16)
    (mword_of_int (FI + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) cdec_e406 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (FI + 0x04)%Z (mword_of_int 0xe022 : mword 16)
    (mword_of_int (FI + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) cdec_e022 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (FI + 0x06)%Z (mword_of_int 0x0800 : mword 16)
    (mword_of_int (FI + 0x06) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_0800 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_base (FI + 0x10)%Z (mword_of_int 0x0001e517 : mword 32)
    (mword_of_int (FI + 0x10) : mword 64) (UTYPE (mword_of_int 30 : mword 20, Regidx (mword_of_int 10), AUIPC)) bdec_0001e517. Qed.
  ...
  Proof. mk_rvc (FI + 0x1c)%Z (mword_of_int 0x60a2 : mword 16)
    (mword_of_int (FI + 0x1c) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_60a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (FI + 0x1e)%Z (mword_of_int 0x6402 : mword 16)
    (mword_of_int (FI + 0x1e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_6402 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (FI + 0x20)%Z (mword_of_int 0x0141 : mword 16)
    (mword_of_int (FI + 0x20) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_0141 exec_execute_C_ADDI. Qed.

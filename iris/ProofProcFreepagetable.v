...
Section ProofProcFreepagetable.
  ...
  Lemma wp_proc_freepagetable_sconf
    ...
    : wp_proc_freepagetable_sconf_body γa Φ mm P K eb p C ilvl b.
  Proof.
    ...
    iApply (wp_caddi_sp_push_s_sconf Φ pcE (mword_of_int 32 : mword 6) mm K 4 b
    ...
    { rewrite /spd. unfold sp0, pa_stk, add_vec_int. rewrite pa_stk_off2.
      f_equal; try (apply bv_eq; vm_compute; reflexivity). }
    assert (Hpc02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (PF + 0x02))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc02) in "Hpc".
    (* +0x02 c.sdsp ra,24(sp) *)
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PF + 0x02)) (mword_of_int 3 : mword 6) Rra
              A0 (K - 4)%nat vr24 b with "Hcg Hpc Hi02 [Hr24] [-]").
    { iEval (rewrite HA0sp -Hb1). iExact "Hr24". }
    iIntros (CID2 Hs2) "Hcg Hpc Hr24".
    iEval (rgne) in "Hr24".
    assert (Hpc04 : add_vec_int (mword_of_int (PF + 0x02) : mword 64) 2 = mword_of_int (PF + 0x04))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc04) in "Hpc".
    (* +0x04 c.sdsp s0,16(sp) *)
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PF + 0x04)) (mword_of_int 2 : mword 6) Rs0
              A0 (K - 4)%nat vr16 b with "Hcg Hpc Hi04 [Hr16] [-]").
    { iEval (rewrite HA0sp -Hb2). iExact "Hr16". }
    iIntros (CID3 Hs3) "Hcg Hpc Hr16".
    iEval (rgne) in "Hr16".
    assert (Hpc06 : add_vec_int (mword_of_int (PF + 0x04) : mword 64) 2 = mword_of_int (PF + 0x06))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc06) in "Hpc".
    (* +0x06 c.sdsp s1,8(sp) *)
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PF + 0x06)) (mword_of_int 1 : mword 6) Rs1
              A0 (K - 4)%nat vr8 b with "Hcg Hpc Hi06 [Hr8] [-]").
    { iEval (rewrite HA0sp -Hb3). iExact "Hr8". }
    iIntros (CID4 Hs4) "Hcg Hpc Hr8".
    iEval (rgne) in "Hr8".
    assert (Hpc08 : add_vec_int (mword_of_int (PF + 0x06) : mword 64) 2 = mword_of_int (PF + 0x08))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc08) in "Hpc".
    (* +0x08 c.sdsp s2,0(sp) *)
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PF + 0x08)) (mword_of_int 0 : mword 6) Rs2
              A0 (K - 4)%nat vr0 b with "Hcg Hpc Hi08 [Hr0] [-]").
    { iEval (rewrite HA0sp -Hb4). iExact "Hr0". }
    iIntros (CID5 Hs5) "Hcg Hpc Hr0".
    iEval (rgne) in "Hr0".
    assert (Hpc0a : add_vec_int (mword_of_int (PF + 0x08) : mword 64) 2 = mword_of_int (PF + 0x0a))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (PF + 0x0a)) (Cregidx (mword_of_int 0))
    ...
    assert (Hpc0c : add_vec_int (mword_of_int (PF + 0x0a) : mword 64) 2 = mword_of_int (PF + 0x0c))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PF + 0x0c)) Rs1 Ra0 A1 (K - 4)%nat b
    ...
    assert (Hpc0e : add_vec_int (mword_of_int (PF + 0x0c) : mword 64) 2 = mword_of_int (PF + 0x0e))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PF + 0x0e)) Rs2 Ra1 A2 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi0e [-]").
    ...
    assert (Hpc10 : add_vec_int (mword_of_int (PF + 0x0e) : mword 64) 2 = mword_of_int (PF + 0x10))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cli_s_sconf Φ (mword_of_int (PF + 0x10)) Ra3
    ...
    assert (Hpc12 : add_vec_int (mword_of_int (PF + 0x10) : mword 64) 2 = mword_of_int (PF + 0x12))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc12) in "Hpc".
    (* +0x12 c.li a2,1 : npages = 1 *)
    iApply (wp_cli_s_sconf Φ (mword_of_int (PF + 0x12)) Ra2
    ...
    assert (Hpc14 : add_vec_int (mword_of_int (PF + 0x12) : mword 64) 2 = mword_of_int (PF + 0x14))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc14) in "Hpc".
    (* +0x14 lui a1,0x4000 *)
    iApply (wp_lui_s_sconf Φ (mword_of_int (PF + 0x14)) Ra1
    ...
    assert (Hpc18 : add_vec_int (mword_of_int (PF + 0x14) : mword 64) 4 = mword_of_int (PF + 0x18))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc18) in "Hpc".
    (* +0x18 c.addi a1,a1,-1 *)
    iApply (wp_caddi_s_sconf Φ (mword_of_int (PF + 0x18)) Ra1 (mword_of_int 63 : mword 6)
    ...
    assert (Hpc1a : add_vec_int (mword_of_int (PF + 0x18) : mword 64) 2 = mword_of_int (PF + 0x1a))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc1a) in "Hpc".
    (* +0x1a c.slli a1,a1,0xc -> a1 = TRAMPOLINE *)
    iApply (wp_cslli_s_sconf Φ (mword_of_int (PF + 0x1a)) (Regidx Ra1) Ra1
    ...
    assert (Hpc1c : add_vec_int (mword_of_int (PF + 0x1a) : mword 64) 2 = mword_of_int (PF + 0x1c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc1c) in "Hpc".
    (* +0x1c jal ra,uvmunmap *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (PF + 0x1c)) Rra
              (mword_of_int 2094928 : mword 21) B4 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi1c [-]").
    iIntros (CID14 Hs14) "Hcg Hpc".
    set (B5 := <[Regidx Rra := regval_into_reg
        (add_vec_int (mword_of_int (PF + 0x1c) : mword 64) 4)]> B4).
    assert (Htgt1 : add_vec (mword_of_int (PF + 0x1c) : mword 64)
    ...
    assert (HB5ra : B5 !!! Regidx Rra
                    = add_vec_int (mword_of_int (PF + 0x1c) : mword 64) 4)
    ...
    iDestruct (cpu_own_transport CID CID14 ilvl eb p C b ltac:(wp_next_chain)
                 with "Hcpu") as "Hcpu".
    iApply (UvmunmapFixed.wp_uvmunmap_fixed_sconf γa Φ B5
    ...
    assert (Hret20 : ret_pc (B5 !!! Regidx Rra) = mword_of_int (PF + 0x20)).
    ...
    (* +0x20 c.li a3,0 *)
    iApply (wp_cli_s_sconf Φ (mword_of_int (PF + 0x20)) Ra3
    ...
    assert (Hpc22 : add_vec_int (mword_of_int (PF + 0x20) : mword 64) 2 = mword_of_int (PF + 0x22))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc22) in "Hpc".
    (* +0x22 c.li a2,1 *)
    iApply (wp_cli_s_sconf Φ (mword_of_int (PF + 0x22)) Ra2
    ...
    assert (Hpc24 : add_vec_int (mword_of_int (PF + 0x22) : mword 64) 2 = mword_of_int (PF + 0x24))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc24) in "Hpc".
    (* +0x24 lui a1,0x2000 *)
    iApply (wp_lui_s_sconf Φ (mword_of_int (PF + 0x24)) Ra1
    ...
    assert (Hpc28 : add_vec_int (mword_of_int (PF + 0x24) : mword 64) 4 = mword_of_int (PF + 0x28))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc28) in "Hpc".
    (* +0x28 c.addi a1,a1,-1 *)
    iApply (wp_caddi_s_sconf Φ (mword_of_int (PF + 0x28)) Ra1 (mword_of_int 63 : mword 6)
    ...
    assert (Hpc2a : add_vec_int (mword_of_int (PF + 0x28) : mword 64) 2 = mword_of_int (PF + 0x2a))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc2a) in "Hpc".
    (* +0x2a c.slli a1,a1,0xd -> a1 = TRAPFRAME *)
    iApply (wp_cslli_s_sconf Φ (mword_of_int (PF + 0x2a)) (Regidx Ra1) Ra1
    ...
    assert (Hpc2c : add_vec_int (mword_of_int (PF + 0x2a) : mword 64) 2 = mword_of_int (PF + 0x2c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc2c) in "Hpc".
    assert (HC4s1 : C4 !!! Regidx Rs1 = page_base P.(ud_root)).
    { rewrite /C4 /C3 /C2 /C1 /C0. repeat (rewrite upd_ne; [| reg_neq]). exact Hm1s1. }
    (* +0x2c c.mv a0,s1 *)
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PF + 0x2c)) Ra0 Rs1 C4 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi2c [-]").
    ...
    assert (Hpc2e : add_vec_int (mword_of_int (PF + 0x2c) : mword 64) 2 = mword_of_int (PF + 0x2e))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc2e) in "Hpc".
    (* +0x2e jal ra,uvmunmap *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (PF + 0x2e)) Rra
              (mword_of_int 2094910 : mword 21) C5 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi2e [-]").
    iIntros (CID22 Hs22) "Hcg Hpc".
    set (C6 := <[Regidx Rra := regval_into_reg
        (add_vec_int (mword_of_int (PF + 0x2e) : mword 64) 4)]> C5).
    assert (Htgt2 : add_vec (mword_of_int (PF + 0x2e) : mword 64)
    ...
    iEval (rewrite (upt_fixed_tf_del_tf P.(ud_tfp)) -/(bare_pt P.(ud_root) P.(ud_um)))
      in "Hpt".
    assert (Hret32 : ret_pc (C6 !!! Regidx Rra) = mword_of_int (PF + 0x32)).
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PF + 0x32)) Ra1 Rs2 mr2 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi32 [-]").
    ...
    assert (Hpc34 : add_vec_int (mword_of_int (PF + 0x32) : mword 64) 2 = mword_of_int (PF + 0x34))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc34) in "Hpc".
    assert (HD0s1 : D0 !!! Regidx Rs1 = page_base P.(ud_root))
      by (rewrite /D0 upd_ne; [exact Hm2s1 | reg_neq]).
    (* +0x34 c.mv a0,s1 *)
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PF + 0x34)) Ra0 Rs1 D0 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi34 [-]").
    ...
    assert (Hpc36 : add_vec_int (mword_of_int (PF + 0x34) : mword 64) 2 = mword_of_int (PF + 0x36))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc36) in "Hpc".
    (* +0x36 jal ra,uvmfree *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (PF + 0x36)) Rra
              (mword_of_int 2095370 : mword 21) D1 (K - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi36 [-]").
    iIntros (CID26 Hs26) "Hcg Hpc".
    set (D2 := <[Regidx Rra := regval_into_reg
        (add_vec_int (mword_of_int (PF + 0x36) : mword 64) 4)]> D1).
    assert (Htgt3 : add_vec (mword_of_int (PF + 0x36) : mword 64)
                      (sign_extend' 64 (mword_of_int 2095370 : mword 21))
    ...
    assert (Hret3a : ret_pc (D2 !!! Regidx Rra) = mword_of_int (PF + 0x3a)).
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (PF + 0x3a)) (mword_of_int 3 : mword 6) Rra
    ...
    assert (Hpc3c : add_vec_int (mword_of_int (PF + 0x3a) : mword 64) 2
                    = mword_of_int (PF + 0x3c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc3c) in "Hpc".
    (* +0x3c c.ldsp s0,16(sp) *)
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (PF + 0x3c)) (mword_of_int 2 : mword 6) Rs0
    ...
    assert (Hpc3e : add_vec_int (mword_of_int (PF + 0x3c) : mword 64) 2
                    = mword_of_int (PF + 0x3e))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc3e) in "Hpc".
    (* +0x3e c.ldsp s1,8(sp) *)
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (PF + 0x3e)) (mword_of_int 1 : mword 6) Rs1
    ...
    assert (Hpc40 : add_vec_int (mword_of_int (PF + 0x3e) : mword 64) 2
                    = mword_of_int (PF + 0x40))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpc40) in "Hpc".
    (* +0x40 c.ldsp s2,0(sp) *)
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (PF + 0x40)) (mword_of_int 0 : mword 6) Rs2
    ...
    assert (Hpc42 : add_vec_int (mword_of_int (PF + 0x40) : mword 64) 2
                    = mword_of_int (PF + 0x42))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (PF + 0x42))
    ...
    assert (Hpc44 : add_vec_int (mword_of_int (PF + 0x42) : mword 64) 2
                    = mword_of_int (PF + 0x44))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cret_s_sconf Φ (mword_of_int (PF + 0x44)) Rra E4 K b

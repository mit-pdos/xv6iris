...
Section ProofVirtioDiskInit.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x010)) (mword_of_int 11 : mword 5)
              (mword_of_int 11 : mword 5) (mword_of_int 4028 : mword 12) W3 (K - 4)%nat false
              ltac:(nzd) ltac:(rdok) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    pose (W4 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg
        (add_vec (W3 !!! Regidx (mword_of_int 11 : mword 5)) (sign_extend' 64 (mword_of_int 4028 : mword 12)))]> W3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x018)) (mword_of_int 10 : mword 5)
              (mword_of_int 10 : mword 5) (mword_of_int 3860 : mword 12) W5 (K - 4)%nat false
              ltac:(nzd) ltac:(rdok) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    pose (W6 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
        (add_vec (W5 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 3860 : mword 12)))]> W5).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x01c)) (mword_of_int 1 : mword 5)
              (mword_of_int 2077846 : mword 21) W6 (K - 4)%nat false ltac:(nzd) ltac:(rdok)
    ...
    assert (Htgtil : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x01c) : mword 64)
                       (sign_extend' 64 (mword_of_int 2077846 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0be)) (mword_of_int 1 : mword 5)
              (mword_of_int 2077594 : mword 21) B38 (K - 4)%nat false ltac:(nzd) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    ...
    assert (Htgk1 : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x0be) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077594 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0c6)) (mword_of_int 9 : mword 5)
              (mword_of_int 9 : mword 5) (mword_of_int 3390 : mword 12) C1 (K - 4)%nat false
              ltac:(nzd) ltac:(rdok) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    pose (C2 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg
        (add_vec (C1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 3390 : mword 12)))]> C1).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0cc)) (mword_of_int 1 : mword 5)
              (mword_of_int 2077580 : mword 21) C2 (K - 4)%nat false ltac:(nzd) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    ...
    assert (Htgk2 : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x0cc) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077580 : mword 21))
                    = mword_of_int KernelSyms.kalloc) by bvc.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0d2)) (mword_of_int 1 : mword 5)
              (mword_of_int 2077574 : mword 21) mk2 (K - 4)%nat false ltac:(nzd) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    ...
    assert (Htgk3 : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x0d2) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077574 : mword 21))
                    = mword_of_int KernelSyms.kalloc) by bvc.
    ...
    assert (Havail2 : add_vec (E3 !!! Regidx (mword_of_int 14 : mword 5))
                        (sign_extend' 64 (mword_of_int 3368 : mword 12)) = disk_avail).
    ...
    iApply (wp_ld_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0e4)) (mword_of_int 14 : mword 5)
              (mword_of_int 14 : mword 5) (mword_of_int 3368 : mword 12) E3 (K - 4)%nat pav false
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0f0)) (mword_of_int 1 : mword 5) (mword_of_int 2077954 : mword 21) E6 (K - 4)%nat false
    ...
    assert (Htgm1 : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x0f0) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077954 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x0f8)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 3340 : mword 12) F1 (K - 4)%nat false
              ltac:(nzd) ltac:(rdok) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    pose (F2 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg (add_vec (F1 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 3340 : mword 12)))]> F1).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x102)) (mword_of_int 1 : mword 5) (mword_of_int 2077936 : mword 21) F5 (K - 4)%nat false
              ltac:(nzd) ltac:(rdok) ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    ...
    assert (Htgm2 : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x102) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077936 : mword 21))
                    = mword_of_int KernelSyms.memset) by bvc.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_init + 0x10c)) (mword_of_int 1 : mword 5) (mword_of_int 2077926 : mword 21) G3 (K - 4)%nat false
              ltac:(nzd) ltac:(rdok) ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi").
              iApply wp_next_off_intro.
    iIntros "Hcg Hpc". iClear "Hi".
    ...
    assert (Htgm3 : add_vec (mword_of_int (KernelSyms.virtio_disk_init + 0x10c) : mword 64)
                      (sign_extend' 64 (mword_of_int 2077926 : mword 21))
                    = mword_of_int KernelSyms.memset) by bvc.

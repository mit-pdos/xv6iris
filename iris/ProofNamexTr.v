...
"[%] [%] Hcg Hcnt Hextc Hclmc Hpc
            ...
            -- iIntros (CIDe Hse e Me) "%E1 %E2 %E3 %E4 %E5 %E6
               ...
               { iIntros (CIDt Hst Mt nf') "%Hregt %Hviewt Hcg Hcnt Hextc Hclmc Hpc
                 ...
                 - iIntros (CIDr Hsr o2 Mr) "%J1 %J2 %J3 %J4 %J5 %J6
                   ...
                   iDestruct (nx_esc_acc gi logstart ik Hik
                                with "Hesc") as "#Hesck".
                   ...
                   iApply (IL.wp_ilock_tx_sconf gs j gl gu gd gk pd pav pu bn
                             gi gilk gislk logstart inodestart nib
                   ...
                   + (* ============ IT IS A DIRECTORY ============ *)
                     ...
                     iAssert (ic_loaded fsc_fs gi fsc_cov logstart ik iinum dnl bml)
                     ...
                     iApply (IUP.wp_iunlockput_tx_gen gs j gl gu gd gk pd pav pu
                               bn g gi gtl gilk gislk logstart
                     ...
                     * iIntros (CIDf Hsf mf) "%Hcsf %Hfa0 Hcg Hcnt Hextc Hclmc Hpc".
                     ...
                     iApply fupd_wp.
                     iMod (InodeRegion.ireg_obs_mint ⊤ gi fsc_fs inodestart nib
                     ...
                     (* ---- everything else reaches dirlookup at +0xde ---- *)
                       ...
                       assert (Hbwf : blkmap_wf fsc_cov logstart bml)
                       ...
                       { iIntros (CIDz Hsz Mz) "%Hregz Hcg Hcnt Hextc Hclmc Hpc Hpath".
                         ...
                         - (* ============ FOUND: recurse on the child ==== *)
                           ...
                           iAssert (ic_loaded fsc_fs gi fsc_cov logstart ik iinum dnl
                                      bml)
                           ...
                           iApply (IUP.wp_iunlockput_tx_gen gs j gl gu gd gk
                                     pd pav pu bn g gi gtl gilk gislk
                                     logstart bmapstart inodestart nib
                                     ...
                                     Hiu Hj Hgs HGB3a0 Hbelow Htlog
                         ...
                         - (* ============ MISS: iunlockput and return 0 === *)
                           ...
                           iApply (IUP.wp_iunlockput_tx_gen gs j gl gu gd gk
                                     ...
                                     Hlg Hsize Hbmap0 Hbmapcov
                                     Hbmaplog Hinos0 Hibc Hibl Hib' Hcovb
                                     Hiu Hj Hgs HGC3a0 Hbelow Htlog
                                     with "Hcg Hcnt Hextc Hclmc Htext Hkd Hpc Hpenv Hbio
                                           Hlogc Hitb2 Hitbl Hesck Hireg []
                                           Hslkk Hslkd Hdep Hidev
                                           Hiinum Hivalid Hload Hshot Hfrz [$Hkeep2 $Hru] Hbmap
    ...
    + (* ---------------- THE ABSOLUTE ARM: iget(ROOTDEV, ROOTINO) ------- *)
      ...
      iAssert (iname gi fsc_fs inodestart ROOTINO RootL) as "Hlicr";

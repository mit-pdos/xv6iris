...
Section ProofFilereadAU.
 ...
 inm
             ...
             (* ---- CHECK OUT the offset cell (r25 item 24): the row out of
                    the inode's rows (its floor is [Kp]), the share's floor
                    from the acquire ([Kt]), the cell resident at the running
                    context ---- *)
             iApply fupd_wp.

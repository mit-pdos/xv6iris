...
Section WpSconfPrintkinit.
  ...
  Proof.
    ...
    iPoseProof (pki_18 with "Htext") as "Hi18".
    iPoseProof (pki_1c with "Htext") as "Hi1c".
    iPoseProof (pki_1e with "Htext") as "Hi1e".
    iPoseProof (pki_20 with "Htext") as "Hi20".
    ...
    assert (Hpp02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (PK + 0x02)) by (unfold pcE; apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp02) in "Hpc".
    (* +0x02 c.sdsp ra,8(sp) *)
    iApply (wp_csdsp_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x02)) (mword_of_int 1 : mword 6) (mword_of_int 1 : mword 5)
    ...
    assert (Hpp04 : add_vec_int (mword_of_int (PK + 0x02) : mword 64) 2 = mword_of_int (PK + 0x04)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp04) in "Hpc".
    (* +0x04 c.sdsp s0,0(sp) *)
    iApply (wp_csdsp_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x04)) (mword_of_int 0 : mword 6) (mword_of_int 8 : mword 5)
    ...
    assert (Hpp06 : add_vec_int (mword_of_int (PK + 0x04) : mword 64) 2 = mword_of_int (PK + 0x06)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp06) in "Hpc".
    (* +0x06 c.addi4spn s0,sp,16 *)
    iApply (wp_caddi4spn_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x06)) (Cregidx (mword_of_int 0)) (mword_of_int 4 : mword 8) (mword_of_int 8 : mword 5)
    ...
    assert (Hpp08 : add_vec_int (mword_of_int (PK + 0x06) : mword 64) 2 = mword_of_int (PK + 0x08)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp08) in "Hpc".
    (* ===== compute a1 = &"pr", a0 = &pr (0x08..0x14) ===== *)
    (* +0x08 auipc a1,0x6 *)
    iApply (wp_auipc_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x08)) (mword_of_int 11 : mword 5) (mword_of_int 6 : mword 20)
              R2 (K - 2)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi08 [-]").
    iIntros "Hhs Hsc Hcg Htlbinv Hpc".
    set (R3 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (add_vec (mword_of_int (PK + 0x08) : mword 64) (auipc_off (mword_of_int 6 : mword 20)))]> R2).
    assert (Hpp0c : add_vec_int (mword_of_int (PK + 0x08) : mword 64) 4 = mword_of_int (PK + 0x0c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp0c) in "Hpc".
    (* +0x0c addi a1,a1,1982 *)
    iApply (wp_addi4_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x0c)) (mword_of_int 11 : mword 5) (mword_of_int 11 : mword 5) (mword_of_int 1982 : mword 12)
              R3 (K - 2)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi0c [-]").
    iIntros "Hhs Hsc Hcg Htlbinv Hpc".
    set (R4 := <[Regidx (mword_of_int 11 : mword 5) := regval_into_reg (add_vec (R3 !!! Regidx (mword_of_int 11 : mword 5)) (sign_extend' 64 (mword_of_int 1982 : mword 12)))]> R3).
    assert (Hpp10 : add_vec_int (mword_of_int (PK + 0x0c) : mword 64) 4 = mword_of_int (PK + 0x10)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp10) in "Hpc".
    assert (HR4a1 : R4 !!! Regidx (mword_of_int 11 : mword 5) = name).
    { rewrite /R4 upd_eq. rewrite /R3 upd_eq.
      unfold name, pr_name_str. apply bv_eq; vm_compute; reflexivity. }
    (* +0x10 auipc a0,0x12 *)
    iApply (wp_auipc_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x10)) (mword_of_int 10 : mword 5) (mword_of_int 18 : mword 20)
              R4 (K - 2)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi10 [-]").
    iIntros "Hhs Hsc Hcg Htlbinv Hpc".
    set (R5 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (mword_of_int (PK + 0x10) : mword 64) (auipc_off (mword_of_int 18 : mword 20)))]> R4).
    assert (Hpp14 : add_vec_int (mword_of_int (PK + 0x10) : mword 64) 4 = mword_of_int (PK + 0x14)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp14) in "Hpc".
    (* +0x14 addi a0,a0,-1402  (a0 := &pr = lk) *)
    iApply (wp_addi4_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x14)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 2694 : mword 12)
              R5 (K - 2)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi14 [-]").
    iIntros "Hhs Hsc Hcg Htlbinv Hpc".
    set (R6 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (R5 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2694 : mword 12)))]> R5).
    assert (Hpp18 : add_vec_int (mword_of_int (PK + 0x14) : mword 64) 4 = mword_of_int (PK + 0x18)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x18)) (mword_of_int 1 : mword 5) (mword_of_int 782 : mword 21)
    ...
    iIntros "Hhs Hsc Hcg Htlbinv Hpc".
    set (R7 := <[Regidx (mword_of_int 1 : mword 5) := regval_into_reg (add_vec_int (mword_of_int (PK + 0x18) : mword 64) 4)]> R6).
    assert (Htgtil : add_vec (mword_of_int (PK + 0x18) : mword 64) (sign_extend' 64 (mword_of_int 782 : mword 21)) = mword_of_int KernelSyms.initlock) by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* +0x1c c.ldsp ra,8(sp) *)
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x1c)) (mword_of_int 1 : mword 6) (mword_of_int 1 : mword 5)
    ...
    assert (Hpp1e : add_vec_int (mword_of_int (PK + 0x1c) : mword 64) 2 = mword_of_int (PK + 0x1e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp1e) in "Hpc".
    (* +0x1e c.ldsp s0,0(sp) *)
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x1e)) (mword_of_int 0 : mword 6) (mword_of_int 8 : mword 5)
    ...
    assert (Hpp20 : add_vec_int (mword_of_int (PK + 0x1e) : mword 64) 2 = mword_of_int (PK + 0x20)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi_sp_pop_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x20)) (mword_of_int 16 : mword 6) E2 (K - 2)%nat 2 Hpop
    ...
    assert (Hpp22 : add_vec_int (mword_of_int (PK + 0x20) : mword 64) 2 = mword_of_int (PK + 0x22)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cret_s_sconf γ root_ppn Φ (mword_of_int (PK + 0x22)) (mword_of_int 1 : mword 5) E3 K

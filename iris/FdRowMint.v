...
(*        the [park_token] FIXPOINT.  Parking an enriched                  *)
...
(*        package captures it in its resume closer ([ParkCap.park_pkg]),   *)
(*        and                                                              *)
...
(*  SpecAllocproc.v:195), both parkers ([ParkCap.park_token_park] and      *)
(*  [ParkCap.park_token_park_steady]) take a NAMED table, and              *)
(*  [ProofUserinit] parks at [fdt0].  A fresh process's descriptor table is *)

...
Section ProofHolding.
  ...
  Proof.
    ...
    iApply (Mycpu.wp_call_mycpu_sconf_cs Φ (mword_of_int (HD + 0x16)) (mword_of_int 0xd2c : mword 21) S4 (n - 4)%nat p
    ...
    iApply (wp_sub_s_sconf Φ (mword_of_int (HD + 0x1a)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
    ...
    iApply (wp_sltiu_s_sconf Φ (mword_of_int (HD + 0x1e)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (HD + 0x22)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (HD + 0x24)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (HD + 0x26)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
  ...
  Proof.
    ...
    assert (Hacpu : add_vec (S2 !!! Regidx (mword_of_int 10 : mword 5))
                      (sign_extend' 64 (mword_of_int 16 : mword 12)) = lock_cpu lka)
      by (rewrite Ha0S2 Hlkeq; reflexivity).
    iApply (wp_cld_lkcpu_lockopen_locked_s_sconf Φ γl lka R Dc (mword_of_int (HD + 0x12))
              (mword_of_int 15 : mword 5) (mword_of_int 10 : mword 5)
              (mword_of_int 16 : mword 12) S2 (n - 4)%nat false
              Hacpu ltac:(vm_compute; discriminate) ltac:(rdok) Href

...
Section ProofScheduler.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x24)) Ra4 Ra4 (mword_of_int 1578 : mword 12)
    ...
    set (A6 := <[Regidx Ra4 := regval_into_reg
        (add_vec (A5 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1578 : mword 12)))]> A5).
    change (<[Regidx Ra4 := regval_into_reg
        (add_vec (A5 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1578 : mword 12)))]> A5) with A6.
    ...
    assert (HA6a4 : A6 !!! Regidx Ra4
                    = add_vec (add_vec (mword_of_int (KernelSyms.scheduler + 0x20) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20)))
                              (sign_extend' 64 (mword_of_int 1578 : mword 12)))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x32)) Ra4 Ra4 (mword_of_int 1620 : mword 12)
    ...
    set (A9 := <[Regidx Ra4 := regval_into_reg
        (add_vec (A8 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1620 : mword 12)))]> A8).
    change (<[Regidx Ra4 := regval_into_reg
        (add_vec (A8 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1620 : mword 12)))]> A8) with A9.
    ...
    assert (HA9a4 : A9 !!! Regidx Ra4
                    = add_vec (add_vec (mword_of_int (KernelSyms.scheduler + 0x2e) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20)))
                              (sign_extend' 64 (mword_of_int 1620 : mword 12)))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x40)) Rs4 Rs4 (mword_of_int 1550 : mword 12)
    ...
    set (A14 := <[Regidx Rs4 := regval_into_reg
        (add_vec (A13 !!! Regidx Rs4) (sign_extend' 64 (mword_of_int 1550 : mword 12)))]> A13).
    change (<[Regidx Rs4 := regval_into_reg
        (add_vec (A13 !!! Regidx Rs4) (sign_extend' 64 (mword_of_int 1550 : mword 12)))]> A13) with A14.
    ...
    assert (HA14s4 : A14 !!! Regidx Rs4
                     = add_vec (add_vec (mword_of_int (KernelSyms.scheduler + 0x3c) : mword 64) (auipc_off (mword_of_int 0x10 : mword 20)))
                               (sign_extend' 64 (mword_of_int 1550 : mword 12)))
    ...
    { iModIntro. iLöb as "IHo".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x94)) Rs1 Rs1 (mword_of_int 2538 : mword 12)
      ...
      set (B2 := <[Regidx Rs1 := regval_into_reg
          (add_vec (B1 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 2538 : mword 12)))]> B1).
      change (<[Regidx Rs1 := regval_into_reg
          (add_vec (B1 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 2538 : mword 12)))]> B1) with B2.
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x9e)) Rs2 Rs2 (mword_of_int 992 : mword 12)
      ...
      set (B5 := <[Regidx Rs2 := regval_into_reg
          (add_vec (B4 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 992 : mword 12)))]> B4).
      change (<[Regidx Rs2 := regval_into_reg
          (add_vec (B4 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 992 : mword 12)))]> B4) with B5.

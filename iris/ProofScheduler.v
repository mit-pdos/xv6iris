...
Section ProofScheduler.
  ...
  Lemma wp_scheduler_sconf (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iApply (wp_caddi16sp_push_s_sconf Φ pcE (mword_of_int 59 : mword 6) m av 10 false
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x02)) (mword_of_int 9 : mword 6) Rra
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x04)) (mword_of_int 8 : mword 6) Rs0
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x06)) (mword_of_int 7 : mword 6) Rs1
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x08)) (mword_of_int 6 : mword 6) Rs2
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x0a)) (mword_of_int 5 : mword 6) Rs3
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x0c)) (mword_of_int 4 : mword 6) Rs4
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x0e)) (mword_of_int 3 : mword 6) Rs5
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x10)) (mword_of_int 2 : mword 6) Rs6
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x12)) (mword_of_int 1 : mword 6) Rs7
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SC + 0x14)) (mword_of_int 0 : mword 6) Rs8
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (SC + 0x16)) (Cregidx (mword_of_int 0))
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (SC + 0x18)) Ra5 Rtp A1 (av - 10)%nat false
    ...
    iApply (wp_caddiw_s_sconf Φ (mword_of_int (SC + 0x1a)) Ra5 (mword_of_int 0 : mword 6)
    ...
    assert (HA3a5r : rget A3 Ra5
                    = sign_extend' 64 (subrange_vec_dec
                        (add_vec (add_vec zero_reg cid_word)
                                 (sign_extend' 64 (sign_extend' 12 (mword_of_int 0 : mword 6)))) 31 0))
      by (rgne; exact HA3a5).
    iApply (wp_slli_s_sconf Φ (mword_of_int (SC + 0x1c)) Rs6 Ra5 (mword_of_int 7 : mword 6)
    ...
    iApply (wp_auipc_s_sconf Φ (mword_of_int (SC + 0x20)) Ra4 (mword_of_int 0x10 : mword 20)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x24)) Ra4 Ra4 (mword_of_int 1454 : mword 12)
    ...
    iApply (wp_cadd_s_sconf Φ (mword_of_int (SC + 0x28)) Ra4 Rs6 A6 (av - 10)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi28 [-]").
    first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
    iIntros "Hcg Hpc".
    ...
    iApply (wp_sd_zero_s_sconf Φ (mword_of_int (SC + 0x2a)) Ra4 (mword_of_int 48 : mword 12)
              A7 (av - 10)%nat p0 false with "Hcg Hpc Hi2a [Hproc] [-]").
    ...
    iApply (wp_auipc_s_sconf Φ (mword_of_int (SC + 0x2e)) Ra4 (mword_of_int 0x10 : mword 20)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x32)) Ra4 Ra4 (mword_of_int 1496 : mword 12)
    ...
    iApply (wp_cadd_s_sconf Φ (mword_of_int (SC + 0x36)) Rs6 Ra4 A9 (av - 10)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi36 [-]").
    first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cli_s_sconf Φ (mword_of_int (SC + 0x38)) Rs8 (mword_of_int 4 : mword 6)
    ...
    iApply (wp_cslli_s_sconf Φ (mword_of_int (SC + 0x3a)) (Regidx Ra5) Ra5 (mword_of_int 7 : mword 6)
    ...
    iApply (wp_auipc_s_sconf Φ (mword_of_int (SC + 0x3c)) Rs4 (mword_of_int 0x10 : mword 20)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x40)) Rs4 Rs4 (mword_of_int 1426 : mword 12)
    ...
    iApply (wp_cadd_s_sconf Φ (mword_of_int (SC + 0x44)) Rs4 Ra5 A14 (av - 10)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi44 [-]").
    first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cli_s_sconf Φ (mword_of_int (SC + 0x46)) Rs7 (mword_of_int 1 : mword 6)
    ...
    { iModIntro.
      ...
      (* +0x4a c.mv a0,s1 *)
      iApply (wp_cmv_s_sconf Φ (mword_of_int (SC + 0x4a)) Ra0 Rs1 Mt (av - 10)%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi4a [-]").
      first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
      iIntros "Hcg Hpc".
      ...
      (* +0x4c jal release *)
      iApply (wp_jal_s_sconf Φ (mword_of_int (SC + 0x4c)) Rra (mword_of_int 2092746 : mword 21)
      ...
      (* +0x50 addi s1,s1,360 *)
      iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x50)) Rs1 Rs1 (mword_of_int 360 : mword 12)
      ...
      - (* scan finished: branch TAKEN to +0x7e *)
        iApply (wp_beq_taken_s_sconf Φ (mword_of_int (SC + 0x54)) (mword_of_int 42 : mword 13)
      ...
      - (* keep scanning: branch FALLS to +0x58 *)
        ...
        iApply (wp_beq_fall_s_sconf Φ (mword_of_int (SC + 0x54)) (mword_of_int 42 : mword 13)
                  Rs2 Rs1 T2 (av - 10)%nat ebx
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    { iModIntro. iIntros (fuel). iInduction fuel as [|fuel IH] "IH";
      ...
      (* +0x58 c.mv a0,s1 *)
      iApply (wp_cmv_s_sconf Φ (mword_of_int (SC + 0x58)) Ra0 Rs1 M (av - 10)%nat ebc
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi58 [-]").
      first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
      iIntros "Hcg Hpc".
      ...
      (* +0x5a jal acquire *)
      iApply (wp_jal_s_sconf Φ (mword_of_int (SC + 0x5a)) Rra (mword_of_int 2092596 : mword 21)
      ...
      iApply (Acquire.wp_acquire_sconf Φ γl "proc"%string
                (proc_lock_res Φ γs γl (proc_addr jj)) M1 0 ebc zero_reg emp (av - 10)%nat ebc
                ltac:(lia) ltac:(lia)
      ...
      iApply (wp_clw_s_sconf Φ (mword_of_int (SC + 0x5e)) Ra5 Rs1 (mword_of_int 24 : mword 12)
      ...
      - (* not RUNNABLE: skip straight to the release tail at +0x4a *)
        iApply (wp_bne_taken_s_sconf Φ (mword_of_int (SC + 0x60)) (mword_of_int 8170 : mword 13)
      ...
      - (* RUNNABLE: dispatch it *)
        ...
        subst st.
        iApply (wp_bne_fall_s_sconf Φ (mword_of_int (SC + 0x60)) (mword_of_int 8170 : mword 13)
                  Rs3 Ra5 M2 (av - 10)%nat false
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  ltac:(repeat rgne; rewrite HM2a5 HM2s3; exact Hcmp)
                  with "Hcg Hpc Hi60 [-]").
        ...
        iApply (wp_sw_s_sconf Φ (mword_of_int (SC + 0x64)) Rs8 Rs1 (mword_of_int 24 : mword 12)
        ...
        iApply (wp_sd_s_sconf Φ (mword_of_int (SC + 0x68)) Rs1 Rs4 (mword_of_int 48 : mword 12)
                  M2 (av - 10)%nat zero_reg false with "Hcg Hpc Hi68 [Hproc] [-]").
        { iEval (rewrite HM2s4r). iExact "Hproc". }
        first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
        iIntros "Hcg Hpc Hproc".
        iEval (rewrite HM2s4r HM2s1r) in "Hproc".
        ...
        iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x6c)) Ra1 Rs1 (mword_of_int 96 : mword 12)
        ...
        iApply (wp_cmv_s_sconf Φ (mword_of_int (SC + 0x70)) Ra0 Rs6 M3 (av - 10)%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc Hi70 [-]").
        first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
        iIntros "Hcg Hpc".
        ...
        (* +0x72 jal swtch *)
        iApply (wp_jal_s_sconf Φ (mword_of_int (SC + 0x72)) Rra (mword_of_int 1452 : mword 21)
        ...
        iApply (Swtch.wp_swtch_sconf Φ (p_sched γs) None (Some cpu_id)
        ...
        iApply (wp_sd_zero_s_sconf Φ (mword_of_int (SC + 0x76)) Rs4 (mword_of_int 48 : mword 12)
                  m' (av - 10)%nat (proc_addr jj) false with "Hcg Hpc Hi76 [Hproc] [-]").
        ...
        iApply (wp_cmv_s_sconf Φ (mword_of_int (SC + 0x7a)) Rs5 Rs7 m' (av - 10)%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc Hi7a [-]").
        first [ rewrite wp_next_off | rewrite (wp_next_idle _ _ _ eq_refl) ].
        iIntros "Hcg Hpc".
        ...
        iApply (wp_cj_s_sconf Φ (mword_of_int (SC + 0x7c))
    ...
    { iModIntro. iLöb as "IHo".
      ...
      iApply (wp_csrsi_sstatus_x0_enable_s_sconf Φ (mword_of_int (SC + 0x86)) eb M (av - 10)%nat
      ...
      iApply (wp_cli_s_sconf Φ (mword_of_int (SC + 0x8e)) Rs5 (mword_of_int 0 : mword 6)
      ...
      (* +0x90 auipc s1,0x11 *)
      iApply (wp_auipc_s_sconf Φ (mword_of_int (SC + 0x90)) Rs1 (mword_of_int 0x11 : mword 20)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x94)) Rs1 Rs1 (mword_of_int 2414 : mword 12)
      ...
      iApply (wp_cli_s_sconf Φ (mword_of_int (SC + 0x98)) Rs3 (mword_of_int 3 : mword 6)
      ...
      (* +0x9a auipc s2,0x16 *)
      iApply (wp_auipc_s_sconf Φ (mword_of_int (SC + 0x9a)) Rs2 (mword_of_int 0x16 : mword 20)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (SC + 0x9e)) Rs2 Rs2 (mword_of_int 868 : mword 12)
      ...
      iApply (wp_cj_s_sconf Φ (mword_of_int (SC + 0xa2))
      ...
      + (* a proc ran: straight back to the loop head *)
        iApply (wp_bnez_x0_taken_s_sconf Φ (mword_of_int (SC + 0x7e)) (mword_of_int 8 : mword 13)
      ...
      + (* nothing runnable: SIE is provably off, so wfi is legal *)
        ...
        subst eb2.
        iApply (wp_bnez_x0_fall_s_sconf Φ (mword_of_int (SC + 0x7e)) (mword_of_int 8 : mword 13)
        ...
        iApply (wp_wfi_s_sconf Φ (mword_of_int (SC + 0x82)) Me (av - 10)%nat false
    ...
    iApply (wp_cj_s_sconf Φ (mword_of_int (SC + 0x48))
    ...
    (* the entry bundle was tagged at the caller's [p0]; c->proc is 0 now. *)
    iEval (rewrite (sc_retag_p A16 (av - 10)%nat p0 zero_reg)) in "Hcg".

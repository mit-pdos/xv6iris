...
Section ProofScheduler.
  ...
  Proof.
    ...
    { iModIntro.
      ...
      (* +0x4c jal release *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.scheduler + 0x4c)) Rra (mword_of_int 2092736 : mword 21)
    ...
    { iModIntro. iIntros (fuel). iInduction fuel as [|fuel IH] "IH";
      ...
      - (* RUNNABLE: dispatch it *)
        ...
        (* +0x72 jal swtch *)
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.scheduler + 0x72)) Rra (mword_of_int 1498 : mword 21)
        ...
        assert (Hrsw : add_vec (mword_of_int (KernelSyms.scheduler + 0x72) : mword 64) (sign_extend' 64 (mword_of_int 1498 : mword 21))

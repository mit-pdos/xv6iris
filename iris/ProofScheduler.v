...
Section ProofScheduler.
  ...
  Proof using .
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x26)) Ra4 Ra4 (mword_of_int 1542 : mword 12)
    ...
    change (<[Regidx Ra4 := regval_into_reg
        (add_vec (A5 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1542 : mword 12)))]> A5) with A6.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x34)) Ra4 Ra4 (mword_of_int 1584 : mword 12)
    ...
    change (<[Regidx Ra4 := regval_into_reg
        (add_vec (A8 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1584 : mword 12)))]> A8) with A9.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x40)) Rs6 Rs6 (mword_of_int 1516 : mword 12)
    ...
    change (<[Regidx Rs6 := regval_into_reg
        (add_vec (A12 !!! Regidx Rs6) (sign_extend' 64 (mword_of_int 1516 : mword 12)))]> A12) with A13.
    ...
    { iModIntro.
      ...
      (* +0x4c jal release *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.scheduler + 0x50)) Rra (mword_of_int 2092632 : mword 21)
      ...
      (* +0x50 addi s1,s1,360 *)
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0x54)) Rs1 Rs1 (mword_of_int 368 : mword 12)
      ...
      change (<[Regidx Rs1 := regval_into_reg
          (add_vec (mr !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 368 : mword 12)))]> mr) with T2.
      ...
      assert (Hsucc : add_vec (proc_addr jj) (sign_extend' 64 (mword_of_int 368 : mword 12)) = proc_addr (S jj))
    ...
    { iModIntro. iIntros (fuel). iInduction fuel as [|fuel IH] "IH";
      ...
      (* +0x5a jal acquire *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.scheduler + 0x5e)) Rra (mword_of_int 2092482 : mword 21)
    ...
    { iModIntro. iLöb as "IHo".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0xa4)) Rs1 Rs1 (mword_of_int 2488 : mword 12)
      ...
      change (<[Regidx Rs1 := regval_into_reg
          (add_vec (B1 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 2488 : mword 12)))]> B1) with B2.
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.scheduler + 0xae)) Rs2 Rs2 (mword_of_int 1454 : mword 12)
      ...
      change (<[Regidx Rs2 := regval_into_reg
          (add_vec (B4 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 1454 : mword 12)))]> B4) with B5.

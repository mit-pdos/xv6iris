...
Section WpKernelvecVc.
  ...
  Proof.
    ...
    iApply (wp_vc_block_s root_ppn kv_store_prog E Φ
              ...
              ρ m mstatus0 mie_v mdv0 menvcfg0 pmpcfg0 pmpaddr00 region_pte
              (dq:=dq)
              HN HSIE HMPRV HSXL Hmm HMXR Hpmm HPBMTE HX Hcov Hpmpp Hpteregion HW HR kv_store_run HmS
    ...
    iIntros (mf) "%Hmf Hhs Hpriv Hms Hmie Hmdl Hmenv Hpmpc Hpmpa Htlbinv Hpc Hfile Hheap _".
    ...
    { assert (Hl : kv_store_regs0 !! Regidx (mword_of_int 31 : mword 5) = Some (SX 31 0))
        by (vm_compute; reflexivity).
      rewrite (Hmf _ _ Hl) sval_den_SX0. reflexivity. }
    iApply ("Hcont" $! mf with "[%] Hhs Hpriv Hms Hmie Hmdl Hmenv Hpmpc Hpmpa Htlbinv Hpc Hfile Hw1 Hw2 Hw3 Hw4 Hw5 Hw6 Hw7 Hw8 Hw9 Hw10 Hw11 Hw12 Hw13 Hw14 Hw15 Hw16 Hw17").
  ...
  Proof.
    ...
    iApply (wp_vc_block_s root_ppn kv_load_prog E Φ
              ...
              ρ m mstatus0 mie_v mdv0 menvcfg0 pmpcfg0 pmpaddr00 region_pte
              (dq:=dq)
              HN HSIE HMPRV HSXL Hmm HMXR Hpmm HPBMTE HX Hcov Hpmpp Hpteregion HW HR kv_load_run HmL
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Hpmpc Hpmpa Htlbinv
                    Hpc Hfile Hbi [Hw1 Hw2 Hw3 Hw4 Hw5 Hw6 Hw7 Hw8 Hw9 Hw10 Hw11 Hw12 Hw13 Hw14 Hw15 Hw16 Hw17] []").
    { rewrite /vheap_own. cbn [vheap]. rewrite /kv_store_heap0.
      cbn [big_opL fst snd].

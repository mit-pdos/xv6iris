...
Section ProofVmfault.
  ...
  Proof.
    ...
    iApply (wp_caddi16sp_push_s_sconf γ Φ pcE (mword_of_int 61 : mword 6) mm K 6
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VF + 0x02)) (mword_of_int 5 : mword 6) Rra
              R1 (K - 6)%nat u40 with "Hcg Hpc Hi02 [Hk1] [-]").
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VF + 0x04)) (mword_of_int 4 : mword 6) Rs0
              R1 (K - 6)%nat u32 with "Hcg Hpc Hi04 [Hk2] [-]").
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VF + 0x06)) (mword_of_int 2 : mword 6) Rs2
              R1 (K - 6)%nat u16 with "Hcg Hpc Hi06 [Hk4] [-]").
    ...
    (* +0x08 c.sdsp s3,8(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VF + 0x08)) (mword_of_int 1 : mword 6) Rs3
              R1 (K - 6)%nat u8 with "Hcg Hpc Hi08 [Hk5] [-]").
    ...
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (VF + 0x0a)) (Cregidx (mword_of_int 0))
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x0c)) Rs3 Ra0
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x0e)) Rs2 Ra1
    ...
    assert (HR4tp : R4 !!! Regidx Rtp = cid_word).
    { rewrite /R4 /R3 /R2 /R1.
    ...
    (* +0x10 jal ra,myproc *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (VF + 0x10)) Rra (mword_of_int 852 : mword 21)
    ...
    assert (HR5tp : R5 !!! Regidx Rtp = cid_word)
      by (rewrite /R5; rewrite upd_ne; [exact HR4tp | reg_neq]).
    ...
    { rewrite (callee_saved_lookup Hmpcs Rs3 ltac:(vm_compute; reflexivity)).
      exact HR5s3. }
    assert (Hmftp : mf !!! Regidx Rtp = cid_word).
    { rewrite (callee_saved_lookup Hmpcs Rtp ltac:(vm_compute; reflexivity)).
      exact HR5tp. }
    ...
    { iEval (rewrite Hmpa0 Hpsza). iExact "Hszc". }
    iIntros "Hcg Hpc Hszc".
    iEval (rewrite Hmpa0 Hpsza) in "Hszc".
    ...
    assert (HM1tp : M1 !!! Regidx Rtp = cid_word)
      by (rewrite /M1; rewrite upd_ne; [exact Hmftp | reg_neq]).
    ...
    { rewrite /EPI.
      iIntros (mj res) "(%Hjsp & %Hjs3 & %Hjthr) Hcg Hcnt Hpc Hjunk Hptc Hpost".
      iDestruct "Hjunk" as (w3 w6) "[Hk3 Hk6]".
      (* +0x1c c.mv a0,s3 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x1c)) Ra0 Rs3
                mj (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi1c [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x1e)) (mword_of_int 5 : mword 6) Rra
                E0 (K - 6)%nat (mm !!! Regidx Rra) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi1e [Hk1] [-]").
      { iEval (rewrite HE0sp Hb1). iExact "Hk1". }
      iIntros "Hcg Hpc Hk1". iEval (rewrite HE0sp Hb1) in "Hk1".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x20)) (mword_of_int 4 : mword 6) Rs0
                E1 (K - 6)%nat (mm !!! Regidx Rs0) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x22)) (mword_of_int 2 : mword 6) Rs2
                E2 (K - 6)%nat (mm !!! Regidx Rs2) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi22 [Hk4] [-]").
      { iEval (rewrite HE2sp Hb4). iExact "Hk4". }
      iIntros "Hcg Hpc Hk4". iEval (rewrite HE2sp Hb4) in "Hk4".
      ...
      (* +0x24 c.ldsp s3,8(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x24)) (mword_of_int 1 : mword 6) Rs3
                E3 (K - 6)%nat (mm !!! Regidx Rs3) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi24 [Hk5] [-]").
      { iEval (rewrite HE3sp Hb5). iExact "Hk5". }
      iIntros "Hcg Hpc Hk5". iEval (rewrite HE3sp Hb5) in "Hk5".
      ...
      iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (VF + 0x26))
                (mword_of_int 3 : mword 6) E4 (K - 6)%nat 6 Hpop
      ...
      iApply (wp_cret_s_sconf γ Φ (mword_of_int (VF + 0x28)) Rra E5 K
    ...
    (* ================================================================= *)
    destruct (zopz0zI_u (M1 !!! Regidx Rs2) (M1 !!! Regidx Ra5)) eqn:Hcmp.
    2:{ (* ---- va >= p->sz: fall to +0x1a, return 0 ---- *)
      iPoseProof (vfi_1a with "Htext") as "Hi1a".
      iApply (wp_bltu_fall_s_sconf γ Φ (mword_of_int (VF + 0x16))
                (mword_of_int 20 : mword 13) Ra5 Rs2 M1 (K - 6)%nat
      ...
      (* +0x1a c.li s3,0 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (VF + 0x1a)) Rs3 (mword_of_int 0 : mword 6)
                (mword_of_int 0 : mword 64) M1 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    { rewrite -HM1s2 -HM1a5. unfold zopz0zI_u in Hcmp. apply Z.ltb_lt. exact Hcmp. }
    ...
    iApply (wp_bltu_taken_s_sconf γ Φ (mword_of_int (VF + 0x16))
              (mword_of_int 20 : mword 13) Ra5 Rs2 M1 (K - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hcmp
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi16 [-]").
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VF + 0x2a)) (mword_of_int 3 : mword 6) Rs1
              M1 (K - 6)%nat u24 with "Hcg Hpc Hi2a [Hk3] [-]").
    ...
    (* +0x2c c.sdsp s4,0(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (VF + 0x2c)) (mword_of_int 0 : mword 6) Rs4
              M1 (K - 6)%nat u0 with "Hcg Hpc Hi2c [Hk6] [-]").
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x2e)) Rs1 Ra0
    ...
    assert (HL2and : and_vec (L2 !!! Regidx Rs2) (L2 !!! Regidx Ra5) = va0).
    { rewrite /L2 upd_eq. rewrite upd_ne; [| reg_neq].
      rewrite /L1. rewrite upd_ne; [| reg_neq]. rewrite HM1s2. reflexivity. }
    iApply (wp_and_s_sconf γ Φ (mword_of_int (VF + 0x32)) Rs4 Rs2 Ra5 va0
              L2 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    (* +0x36 c.mv a1,s4 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x36)) Ra1 Rs4
              L3 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi36 [-]").
    iIntros "Hcg Hpc".
    ...
    (* +0x38 c.mv a0,s3 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x38)) Ra0 Rs3
              L4 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi38 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (VF + 0x3a)) Rra
              (mword_of_int 2097066 : mword 21) L5 (K - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi3a [-]").
    iIntros "Hcg Hpc".
    ...
    { rewrite /L6 /L5 /L4 /L3 /L2 /L1.
      repeat (rewrite upd_ne; [| reg_neq]). exact HM1tp. }
    ...
    iApply (Ismapped.wp_ismapped_sconf γ Φ L6 t m_ad (K - 6)%nat (DfracOwn 1)
              ltac:(lia) HL6root ltac:(rewrite HL6a1; exact Hva0b) Hrep
              with "Hcg Htext Hpc Hptree [-]").
    iIntros (mi) "Hcg Hpc Hptree %Hics %Hiv".
    ...
    assert (Hmitp : mi !!! Regidx Rtp = cid_word).
    { rewrite (callee_saved_lookup Hics Rtp ltac:(vm_compute; reflexivity)). exact HL6tp. }
    ...
    (* +0x3e c.li s3,0 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (VF + 0x3e)) Rs3 (mword_of_int 0 : mword 6)
              (mword_of_int 0 : mword 64) mi (K - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi3e [-]").
    iIntros "Hcg Hpc".
    ...
    assert (HN1tp : N1 !!! Regidx Rtp = cid_word)
      by (rewrite /N1; rewrite upd_ne; [exact Hmitp | reg_neq]).
    ...
    { (* ================= UNMAPPED: allocate ========================= *)
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (VF + 0x40))
                (mword_of_int 4 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                N1 (K - 6)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HN1a0 Ha0z; vm_compute; reflexivity)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi40 [-]").
      iNext. iIntros "Hcg Hpc".
      ...
      (* +0x48 jal ra,kalloc *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (VF + 0x48)) Rra
                (mword_of_int 2094406 : mword 21) N1 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi48 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (HA1tp : A1 !!! Regidx Rtp = cid_word)
        by (rewrite /A1; rewrite upd_ne; [exact HN1tp | reg_neq]).
      ...
      { rewrite (callee_saved_lookup Hkcs Rtp ltac:(vm_compute; reflexivity)). exact HA1tp. }
      ...
      (* +0x4c c.mv s2,a0 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x4c)) Rs2 Ra0
                mk (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi4c [-]").
      iIntros "Hcg Hpc".
      ...
      assert (HA2tp : A2 !!! Regidx Rtp = cid_word)
        by (rewrite /A2; rewrite upd_ne; [exact Hmktp | reg_neq]).
      ...
      { (* ---- kalloc returned 0: +0x7e, return 0 ---- *)
        ...
        iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (VF + 0x4e))
                  (mword_of_int 24 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                  A2 (K - 6)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HA2a0 Hnull; vm_compute; reflexivity)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi4e [-]").
        iNext. iIntros "Hcg Hpc".
        ...
        iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x7e)) (mword_of_int 3 : mword 6) Rs1
                  A2 (K - 6)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi7e [Hk3] [-]").
        { iEval (rewrite HA2sp Hb3). iExact "Hk3". }
        iIntros "Hcg Hpc Hk3". iEval (rewrite HA2sp Hb3) in "Hk3".
        ...
        (* +0x80 c.ldsp s4,0(sp) *)
        iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x80)) (mword_of_int 0 : mword 6) Rs4
                  B1 (K - 6)%nat (mm !!! Regidx Rs4) (dqm:=DfracOwn 1)
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi80 [Hk6] [-]").
        { iEval (rewrite HB1sp Hb6). iExact "Hk6". }
        iIntros "Hcg Hpc Hk6". iEval (rewrite HB1sp Hb6) in "Hk6".
        ...
        (* +0x82 c.j -0x66 *)
        iApply (wp_cj_s_sconf γ Φ (mword_of_int (VF + 0x82))
                  (sign_extend' 21 (concat_vec (mword_of_int 1997 : mword 11) ('b"0")))
                  B2 (K - 6)%nat ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi82 [-]").
        iNext. iIntros "Hcg Hpc".
      ...
      iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (VF + 0x4e))
                (mword_of_int 24 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                A2 (K - 6)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite HA2a0; apply eq_vec_false_iff; rewrite Hnz;
      ...
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x50)) Rs3 Ra0
                A2 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi50 [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x52 c.lui a2,1 *)
      iApply (wp_clui_s_sconf γ Φ (mword_of_int (VF + 0x52)) Ra2
                (sign_extend' 20 (mword_of_int 1 : mword 6)) (mword_of_int 4096 : mword 64)
                A3 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(apply bv_eq; vm_compute; reflexivity)
                with "Hcg Hpc Hi52 [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x54 c.li a1,0 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (VF + 0x54)) Ra1 (mword_of_int 0 : mword 6)
                (mword_of_int 0 : mword 64) A4 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(apply bv_eq; vm_compute; reflexivity)
                with "Hcg Hpc Hi54 [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x56 jal ra,memset *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (VF + 0x56)) Rra
                (mword_of_int 2094802 : mword 21) A5 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi56 [-]").
      iIntros "Hcg Hpc".
      ...
      { rewrite /A6 /A5 /A4 /A3.
        repeat (rewrite upd_ne; [| reg_neq]). exact HA2tp. }
      ...
      { intros c Hc H2 H8 H9 H18 H19 H20.
        ...
        apply HA2thr; assumption. }
      (* ---- memset(mem, 0, PGSIZE) ---- *)
      iApply (MemsetPage.wp_memset_page_sconf γ Φ A6 (K - 6)%nat (mword_of_int 0 : mword 64)
                ltac:(lia) ltac:(rewrite HA6a0; exact Hpv) HA6a1 HA6a2
                with "Hcg Htext Hpc [Hpage] [-]").
      { iEval (rewrite HA6a0). iExact "Hpage". }
      iIntros (ms) "Hcg Hpc Hpage %Hmscs".
      ...
      assert (Hmstp : ms !!! Regidx Rtp = cid_word).
      { rewrite (callee_saved_lookup Hmscs Rtp ltac:(vm_compute; reflexivity)). exact HA6tp. }
      ...
      (* +0x5a c.li a4,22 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (VF + 0x5a)) Ra4 (mword_of_int 22 : mword 6)
                (mword_of_int 22 : mword 64) ms (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(apply bv_eq; vm_compute; reflexivity)
                with "Hcg Hpc Hi5a [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x5c c.mv a3,s2 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x5c)) Ra3 Rs2
                G1 (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi5c [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x5e c.lui a2,1 *)
      iApply (wp_clui_s_sconf γ Φ (mword_of_int (VF + 0x5e)) Ra2
                (sign_extend' 20 (mword_of_int 1 : mword 6)) (mword_of_int 4096 : mword 64)
      ...
      (* +0x60 c.mv a1,s4 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x60)) Ra1 Rs4
      ...
      { iEval (rewrite HG4s1 Hppta). iExact "Hptc". }
      iIntros "Hcg Hpc Hptc".
      iEval (rewrite HG4s1 Hppta) in "Hptc".
      ...
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (VF + 0x64)) Rra
                (mword_of_int 2095660 : mword 21) G5 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi64 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (HG6tp : G6 !!! Regidx Rtp = cid_word).
      { rewrite /G6 /G5 /G4 /G3 /G2 /G1.
        repeat (rewrite upd_ne; [| reg_neq]). exact Hmstp. }
      ...
      { rewrite (callee_saved_lookup Hgcs Rtp ltac:(vm_compute; reflexivity)). exact HG6tp. }
      ...
      { (* ============ mappages SUCCEEDED: return mem ================ *)
        ...
        iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (VF + 0x68))
                  (mword_of_int 4 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                  mg (K - 6)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite Hga0; vm_compute; reflexivity)
                  with "Hcg Hpc Hi68 [-]").
        iIntros "Hcg Hpc".
        ...
        iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x6a)) (mword_of_int 3 : mword 6) Rs1
                  mg (K - 6)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi6a [Hk3] [-]").
        { iEval (rewrite Hmgsp Hb3). iExact "Hk3". }
        iIntros "Hcg Hpc Hk3". iEval (rewrite Hmgsp Hb3) in "Hk3".
        ...
        (* +0x6c c.ldsp s4,0(sp) *)
        iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x6c)) (mword_of_int 0 : mword 6) Rs4
                  S1 (K - 6)%nat (mm !!! Regidx Rs4) (dqm:=DfracOwn 1)
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                  with "Hcg Hpc Hi6c [Hk6] [-]").
        { iEval (rewrite HS1sp Hb6). iExact "Hk6". }
        iIntros "Hcg Hpc Hk6". iEval (rewrite HS1sp Hb6) in "Hk6".
        ...
        (* +0x6e c.j -0x52 *)
        iApply (wp_cj_s_sconf γ Φ (mword_of_int (VF + 0x6e))
                  (sign_extend' 21 (concat_vec (mword_of_int 2007 : mword 11) ('b"0")))
                  S2 (K - 6)%nat ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi6e [-]").
        iNext. iIntros "Hcg Hpc".
      ...
      iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (VF + 0x68))
                (mword_of_int 4 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                mg (K - 6)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hga0; vm_compute; reflexivity)
      ...
      (* +0x70 c.mv a0,s2 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (VF + 0x70)) Ra0 Rs2
                mg (K - 6)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi70 [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x72 jal ra,kfree *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (VF + 0x72)) Rra
                (mword_of_int 2094132 : mword 21) F1 (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi72 [-]").
      iIntros "Hcg Hpc".
      ...
      { rewrite /F2. rewrite upd_ne; [| reg_neq].
        rewrite /F1. rewrite upd_ne; [| reg_neq]. exact Hmgtp. }
      ...
      iIntros (mfk) "Hcg Hcnt Hpc %Hfcs _".
      ...
      (* +0x76 c.li s3,0 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (VF + 0x76)) Rs3 (mword_of_int 0 : mword 6)
                (mword_of_int 0 : mword 64) mfk (K - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(apply bv_eq; vm_compute; reflexivity)
                with "Hcg Hpc Hi76 [-]").
      iIntros "Hcg Hpc".
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x78)) (mword_of_int 3 : mword 6) Rs1
                F3 (K - 6)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi78 [Hk3] [-]").
      { iEval (rewrite HF3sp Hb3). iExact "Hk3". }
      iIntros "Hcg Hpc Hk3". iEval (rewrite HF3sp Hb3) in "Hk3".
      ...
      (* +0x7a c.ldsp s4,0(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x7a)) (mword_of_int 0 : mword 6) Rs4
                F4 (K - 6)%nat (mm !!! Regidx Rs4) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi7a [Hk6] [-]").
      { iEval (rewrite HF4sp Hb6). iExact "Hk6". }
      iIntros "Hcg Hpc Hk6". iEval (rewrite HF4sp Hb6) in "Hk6".
      ...
      (* +0x7c c.j -0x60 *)
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (VF + 0x7c))
                (sign_extend' 21 (concat_vec (mword_of_int 2000 : mword 11) ('b"0")))
                F5 (K - 6)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi7c [-]").
      iNext. iIntros "Hcg Hpc".
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (VF + 0x40))
              (mword_of_int 4 : mword 8) (Cregidx (mword_of_int 2)) Ra0
              N1 (K - 6)%nat
              ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
              ltac:(rewrite HN1a0 Ha0one; vm_compute; reflexivity)
              with "Hcg Hpc Hi40 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x42)) (mword_of_int 3 : mword 6) Rs1
              N1 (K - 6)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi42 [Hk3] [-]").
    { iEval (rewrite HN1sp Hb3). iExact "Hk3". }
    iIntros "Hcg Hpc Hk3". iEval (rewrite HN1sp Hb3) in "Hk3".
    ...
    (* +0x44 c.ldsp s4,0(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (VF + 0x44)) (mword_of_int 0 : mword 6) Rs4
              D1 (K - 6)%nat (mm !!! Regidx Rs4) (dqm:=DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi44 [Hk6] [-]").
    { iEval (rewrite HD1sp Hb6). iExact "Hk6". }
    iIntros "Hcg Hpc Hk6". iEval (rewrite HD1sp Hb6) in "Hk6".
    ...
    (* +0x46 c.j -0x2a *)
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (VF + 0x46))
              (sign_extend' 21 (concat_vec (mword_of_int 2027 : mword 11) ('b"0")))
              D2 (K - 6)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi46 [-]").
    iNext. iIntros "Hcg Hpc".

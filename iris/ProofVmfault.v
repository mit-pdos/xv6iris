...
Section ProofVmfault.
  ...
  Proof.
    ...
    { rewrite /EPI.
      ...
      iAssert (stack_own (KTR := kt) sp0 6) with "[Hk1 Hk2 Hk3 Hk4 Hk5 Hk6]" as "Hframe6".
    ...
    iApply (Ismapped.wp_ismapped_sconf kt L5 t m_ad (K - 6)%nat (DfracOwn 1) b p
    ...
    { (* ================= UNMAPPED: allocate ========================= *)
      ...
      { intros c Hc H2 H8 H9 H18 H19 H20.
        ...
        apply HA2thr; assumption. }
      (* ---- memset(mem, 0, PGSIZE) ---- *)
      iApply (MemsetPage.wp_memset_page_sconf kt A6 (K - 6)%nat (mword_of_int 0 : mword 64) b p
      ...
      iDestruct (cpu_own_transport Ckr Cmg lvl eb p b ltac:(wp_next_chain)
                   with "Hcnt") as "Hcnt".
      iApply (Mappages.wp_mappages_sconf kt γa G6 t m_ad 1%nat 22 lvl (K - 6)%nat
                eb p None b _

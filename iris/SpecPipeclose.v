...
Definition wp_pipeclose_sconf_body `{!riscvGS Σ, !sieG Σ, !lockG Σ, !fdslotG Σ, !irefNameG Σ, !irefslotG Σ, !pipeG Σ, !kallocG Σ} `{GEN : GenId} `{CID : CpuId}
    (γs : list gname)
...
Module Type PIPECLOSE.
  Parameter wp_pipeclose_sconf :
    forall `{!riscvGS Σ, !sieG Σ, !lockG Σ, !fdslotG Σ, !irefNameG Σ, !irefslotG Σ, !pipeG Σ, !kallocG Σ} `{GEN : GenId} `{CID : CpuId}
      (γs : list gname)
      (γl : gname) (γp : pipe_names) (w : bool)
      (γkl : gname) (γk : gname * gname) (klk kfl : mword 64) (on : option nat)
      (m : regfile) (n : nat) (eb : bool) (pme : mword 64) (C : iProp Σ) (av : nat)

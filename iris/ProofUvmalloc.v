...
Section UvmallocDefs.
  ...
  (* what every long arm hands the epilogue at +0x78 *)
  Definition ua_exit (γ : gname) (Φ : mval -> iProp Σ) (mm : regfile)
      (P : uptd) (vpn0 : mword 27) (n K : nat) (eb : bool) (p : mword 64)
      (C : iProp Σ) (sp0 spr oldsz newsz : mword 64) : iProp Σ :=
...
Section ProofUvmalloc.
  ...
  (* ------------------------------------------------------------------ *)
  Local Lemma ua_loop (γ γa : gname) (Φ : mval -> iProp Σ) (mm : regfile)
      (P : uptd) (xperm : Z) (K : nat) (eb : bool) (p : mword 64) (C : iProp Σ)
      (sp0 spr oldsz newsz : mword 64) (pu nz : Z) (n : nat) :
    (42 <= K)%nat ->
    (0 <= xperm < 512)%Z ->
    ...
    forall (rem i : nat) (Pi : uptd) (M : regfile) (av : mword 64),
    ...
    ua_exit γ Φ mm P (svpn_of (pgroundup oldsz)) n K eb p C sp0 spr oldsz newsz -∗
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros HK Hxrng Hperm Hb3 Hb5 Hb8 Hpu Hnz Hpumod Hpu0 Hnb Hoin Hnchar Hfresh Hmmtp.
    ...
    induction rem as [| rem IH];
      intros i Pi M av Hsum Hrem Hav Hext Hdom Hsp Htp Hs2 Hs3 Hs4 Hs5 Hs6 Hs7 Hthr;
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UA + 0x36)) Rra
              (mword_of_int 2095148 : mword 21) M (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi36 [-]").
    iIntros "Hcg Hpc".
    set (B1 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (UA + 0x36) : mword 64) 4)]> M).
    assert (Htgtka : add_vec (mword_of_int (UA + 0x36) : mword 64)
    ...
    assert (HB1ra : B1 !!! Regidx Rra
                    = add_vec_int (mword_of_int (UA + 0x36) : mword 64) 4)
    ...
    assert (HB1tp : B1 !!! Regidx Rtp = cid_word)
      by (rewrite /B1; rewrite upd_ne; [exact Htp | reg_neq]).
    ...
    iApply (Kalloc.wp_kalloc_sconf γ Φ γa γk (mword_of_int (KernelSyms.kmem + 24))
              B1 None 0%nat eb p C (K - 10)%nat
              HKka HB1tp ltac:(reflexivity) ltac:(vm_compute; reflexivity)
              with "Hcg Hcnt Htext Hpc Hlock Havail Hpanic [-]").
    iIntros (mk) "Hcg Hcnt Hpc %Hkcs Hkpost".
    assert (Hret3a : ret_pc (B1 !!! Regidx Rra) = mword_of_int (UA + 0x3a)).
    ...
    { rewrite (callee_saved_lookup Hkcs Rtp ltac:(vm_compute; reflexivity)). exact HB1tp. }
    ...
    (* ---- +0x3a c.mv s1,a0 ---- *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x3a)) Rs1 Ra0 mk (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3a [-]").
    iIntros "Hcg Hpc".
    ...
    assert (HB2tp : B2 !!! Regidx Rtp = cid_word)
      by (rewrite /B2; rewrite upd_ne; [exact Hmktp | reg_neq]).
    ...
    assert (Hp3c : add_vec_int (mword_of_int (UA + 0x3a) : mword 64) 2
                   = mword_of_int (UA + 0x3c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp3c) in "Hpc".
    iDestruct "Hkpost" as "[(%Hnull & _ & _) | (%Hpv & Hpage & _)]".
    { (* ================= kalloc failed: roll back, return 0 ============ *)
      iPoseProof (uai_66 with "Htext") as "Hi66".
      iPoseProof (uai_68 with "Htext") as "Hi68".
      iPoseProof (uai_6a with "Htext") as "Hi6a".
      iPoseProof (uai_6c with "Htext") as "Hi6c".
      iPoseProof (uai_70 with "Htext") as "Hi70".
      iPoseProof (uai_72 with "Htext") as "Hi72".
      iPoseProof (uai_74 with "Htext") as "Hi74".
      iPoseProof (uai_76 with "Htext") as "Hi76".
      assert (Htgt66 : add_vec (mword_of_int (UA + 0x3c) : mword 64)
                (sign_extend' 64
                   (sign_extend' 13 (concat_vec (mword_of_int 21 : mword 8) ('b"0"))))
              = mword_of_int (UA + 0x66)) by (apply bv_eq; vm_compute; reflexivity).
      assert (Hzt : eq_vec (B2 !!! Regidx Ra0) zero_reg = true)
        by (rewrite HB2a0 Hnull; vm_compute; reflexivity).
      iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (UA + 0x3c))
                (mword_of_int 21 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                B2 (K - 10)%nat ltac:(vm_compute; reflexivity)
                ltac:(vm_compute; discriminate) Hzt
                ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi3c [-]").
      iNext. iIntros "Hcg Hpc".
      iEval (rewrite Htgt66) in "Hpc".
      (* +0x66 c.mv a2,s7 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x66)) Ra2 Rs7 B2 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi66 [-]").
      iIntros "Hcg Hpc".
      set (N1 := <[Regidx Ra2 := regval_into_reg (add_vec zero_reg (B2 !!! Regidx Rs7))]> B2).
      assert (Hq68 : add_vec_int (mword_of_int (UA + 0x66) : mword 64) 2
                     = mword_of_int (UA + 0x68)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq68) in "Hpc".
      (* +0x68 c.mv a1,s2 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x68)) Ra1 Rs2 N1 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi68 [-]").
      iIntros "Hcg Hpc".
      set (N2 := <[Regidx Ra1 := regval_into_reg (add_vec zero_reg (N1 !!! Regidx Rs2))]> N1).
      assert (Hq6a : add_vec_int (mword_of_int (UA + 0x68) : mword 64) 2
                     = mword_of_int (UA + 0x6a)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq6a) in "Hpc".
      (* +0x6a c.mv a0,s5 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x6a)) Ra0 Rs5 N2 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi6a [-]").
      iIntros "Hcg Hpc".
      set (N3 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (N2 !!! Regidx Rs5))]> N2).
      assert (Hq6c : add_vec_int (mword_of_int (UA + 0x6a) : mword 64) 2
                     = mword_of_int (UA + 0x6c)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq6c) in "Hpc".
      (* +0x6c jal ra,uvmdealloc *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (UA + 0x6c)) Rra
                (mword_of_int 2096976 : mword 21) N3 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi6c [-]").
      iIntros "Hcg Hpc".
      set (N4 := <[Regidx Rra := regval_into_reg
                    (add_vec_int (mword_of_int (UA + 0x6c) : mword 64) 4)]> N3).
      assert (Htgtud : add_vec (mword_of_int (UA + 0x6c) : mword 64)
      ...
      assert (HN4ra : N4 !!! Regidx Rra
                      = add_vec_int (mword_of_int (UA + 0x6c) : mword 64) 4)
      ...
      assert (HN4tp : N4 !!! Regidx Rtp = cid_word).
      { rewrite /N4 /N3 /N2 /N1. repeat (rewrite upd_ne; [| reg_neq]). exact HB2tp. }
      ...
      { rewrite (callee_saved_lookup Hdcs csp_rs1 ltac:(vm_compute; reflexivity)). exact HN4sp. }
      assert (Hmdthr : forall c : mword 5, is_cs_idx c = true ->
                c <> csp_rs1 -> c <> Rs0 -> c <> Rs1 -> c <> Rs2 -> c <> Rs3 ->
                c <> Rs4 -> c <> Rs5 -> c <> Rs6 -> c <> Rs7 ->
                md !!! Regidx c = mm !!! Regidx c).
      { intros c Hc H2 H8 H9 H18 H19 H20 H21 H22 H23.
        rewrite (callee_saved_lookup Hdcs c Hc). apply HN4thr; assumption. }
      (* +0x70 c.li a0,0 *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (UA + 0x70)) Ra0 (mword_of_int 0 : mword 6)
                (mword_of_int 0 : mword 64) md (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      assert (Hq72 : add_vec_int (mword_of_int (UA + 0x70) : mword 64) 2
                     = mword_of_int (UA + 0x72)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq72) in "Hpc".
      (* +0x72 c.ldsp s1,56(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x72)) (mword_of_int 7 : mword 6) Rs1
                N5 (K - 10)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi72 [Hk3] [-]").
      { iEval (rewrite HN5sp Hb3). iExact "Hk3". }
      iIntros "Hcg Hpc Hk3". iEval (rewrite HN5sp Hb3) in "Hk3".
      ...
      assert (Hq74 : add_vec_int (mword_of_int (UA + 0x72) : mword 64) 2
                     = mword_of_int (UA + 0x74)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq74) in "Hpc".
      (* +0x74 c.ldsp s3,40(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x74)) (mword_of_int 5 : mword 6) Rs3
                N6 (K - 10)%nat (mm !!! Regidx Rs3) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi74 [Hk5] [-]").
      { iEval (rewrite HN6sp Hb5). iExact "Hk5". }
      iIntros "Hcg Hpc Hk5". iEval (rewrite HN6sp Hb5) in "Hk5".
      ...
      assert (Hq76 : add_vec_int (mword_of_int (UA + 0x74) : mword 64) 2
                     = mword_of_int (UA + 0x76)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq76) in "Hpc".
      (* +0x76 c.ldsp s6,16(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x76)) (mword_of_int 2 : mword 6) Rs6
                N7 (K - 10)%nat (mm !!! Regidx Rs6) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi76 [Hk8] [-]").
      { iEval (rewrite HN7sp Hb8). iExact "Hk8". }
      iIntros "Hcg Hpc Hk8". iEval (rewrite HN7sp Hb8) in "Hk8".
      set (N8 := <[Regidx Rs6 := regval_into_reg (mm !!! Regidx Rs6)]> N7).
      assert (Hq78 : add_vec_int (mword_of_int (UA + 0x76) : mword 64) 2
                     = mword_of_int (UA + 0x78)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iPoseProof (uai_3e with "Htext") as "Hi3e".
    iPoseProof (uai_40 with "Htext") as "Hi40".
    iPoseProof (uai_42 with "Htext") as "Hi42".
    iPoseProof (uai_46 with "Htext") as "Hi46".
    iPoseProof (uai_48 with "Htext") as "Hi48".
    iPoseProof (uai_4a with "Htext") as "Hi4a".
    iPoseProof (uai_4c with "Htext") as "Hi4c".
    iPoseProof (uai_4e with "Htext") as "Hi4e".
    iPoseProof (uai_50 with "Htext") as "Hi50".
    iPoseProof (uai_54 with "Htext") as "Hi54".
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (UA + 0x3c))
              (mword_of_int 21 : mword 8) (Cregidx (mword_of_int 2)) Ra0
              B2 (K - 10)%nat ltac:(vm_compute; reflexivity)
              ltac:(vm_compute; discriminate) Hnn with "Hcg Hpc Hi3c [-]").
    iIntros "Hcg Hpc".
    assert (Hq3e : add_vec_int (mword_of_int (UA + 0x3c) : mword 64) 2
                   = mword_of_int (UA + 0x3e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq3e) in "Hpc".
    (* +0x3e c.mv a2,s3 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x3e)) Ra2 Rs3 B2 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3e [-]").
    iIntros "Hcg Hpc".
    set (B3 := <[Regidx Ra2 := regval_into_reg (add_vec zero_reg (B2 !!! Regidx Rs3))]> B2).
    assert (Hq40 : add_vec_int (mword_of_int (UA + 0x3e) : mword 64) 2
                   = mword_of_int (UA + 0x40)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq40) in "Hpc".
    (* +0x40 c.li a1,0 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (UA + 0x40)) Ra1 (mword_of_int 0 : mword 6)
              (mword_of_int 0 : mword 64) B3 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity) with "Hcg Hpc Hi40 [-]").
    iIntros "Hcg Hpc".
    set (B4 := <[Regidx Ra1 := regval_into_reg (mword_of_int 0 : mword 64)]> B3).
    assert (Hq42 : add_vec_int (mword_of_int (UA + 0x40) : mword 64) 2
                   = mword_of_int (UA + 0x42)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq42) in "Hpc".
    (* +0x42 jal ra,memset *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UA + 0x42)) Rra
              (mword_of_int 2095546 : mword 21) B4 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi42 [-]").
    iIntros "Hcg Hpc".
    set (B5 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (UA + 0x42) : mword 64) 4)]> B4).
    assert (Htgtms : add_vec (mword_of_int (UA + 0x42) : mword 64)
    ...
    assert (HB5ra : B5 !!! Regidx Rra
                    = add_vec_int (mword_of_int (UA + 0x42) : mword 64) 4)
    ...
    { rewrite /B5 /B4 /B3. repeat (rewrite upd_ne; [| reg_neq]). exact HB2tp. }
    ...
    iApply (MemsetPage.wp_memset_page_sconf γ Φ B5 (K - 10)%nat (mword_of_int 0 : mword 64)
    ...
    assert (Hret46 : ret_pc (B5 !!! Regidx Rra) = mword_of_int (UA + 0x46)).
    ...
    { rewrite (callee_saved_lookup Hmscs Rtp ltac:(vm_compute; reflexivity)). exact HB5tp. }
    ...
    (* +0x46 c.mv a4,s6 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x46)) Ra4 Rs6 ms (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi46 [-]").
    iIntros "Hcg Hpc".
    set (B6 := <[Regidx Ra4 := regval_into_reg (add_vec zero_reg (ms !!! Regidx Rs6))]> ms).
    assert (Hq48 : add_vec_int (mword_of_int (UA + 0x46) : mword 64) 2
                   = mword_of_int (UA + 0x48)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq48) in "Hpc".
    (* +0x48 c.mv a3,s1 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x48)) Ra3 Rs1 B6 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi48 [-]").
    iIntros "Hcg Hpc".
    set (B7 := <[Regidx Ra3 := regval_into_reg (add_vec zero_reg (B6 !!! Regidx Rs1))]> B6).
    assert (Hq4a : add_vec_int (mword_of_int (UA + 0x48) : mword 64) 2
                   = mword_of_int (UA + 0x4a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq4a) in "Hpc".
    (* +0x4a c.mv a2,s3 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x4a)) Ra2 Rs3 B7 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi4a [-]").
    iIntros "Hcg Hpc".
    set (B8 := <[Regidx Ra2 := regval_into_reg (add_vec zero_reg (B7 !!! Regidx Rs3))]> B7).
    assert (Hq4c : add_vec_int (mword_of_int (UA + 0x4a) : mword 64) 2
                   = mword_of_int (UA + 0x4c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq4c) in "Hpc".
    (* +0x4c c.mv a1,s2 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x4c)) Ra1 Rs2 B8 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi4c [-]").
    iIntros "Hcg Hpc".
    set (B9 := <[Regidx Ra1 := regval_into_reg (add_vec zero_reg (B8 !!! Regidx Rs2))]> B8).
    assert (Hq4e : add_vec_int (mword_of_int (UA + 0x4c) : mword 64) 2
                   = mword_of_int (UA + 0x4e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq4e) in "Hpc".
    (* +0x4e c.mv a0,s5 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x4e)) Ra0 Rs5 B9 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi4e [-]").
    iIntros "Hcg Hpc".
    set (B10 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (B9 !!! Regidx Rs5))]> B9).
    assert (Hq50 : add_vec_int (mword_of_int (UA + 0x4e) : mword 64) 2
                   = mword_of_int (UA + 0x50)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq50) in "Hpc".
    (* +0x50 jal ra,mappages *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UA + 0x50)) Rra
              (mword_of_int 2096404 : mword 21) B10 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi50 [-]").
    iIntros "Hcg Hpc".
    set (B11 := <[Regidx Rra := regval_into_reg
                   (add_vec_int (mword_of_int (UA + 0x50) : mword 64) 4)]> B10).
    assert (Htgtmp : add_vec (mword_of_int (UA + 0x50) : mword 64)
    ...
    assert (HB11ra : B11 !!! Regidx Rra
                     = add_vec_int (mword_of_int (UA + 0x50) : mword 64) 4)
    ...
    assert (HB11tp : B11 !!! Regidx Rtp = cid_word).
    { rewrite /B11 /B10 /B9 /B8 /B7 /B6.
    ...
    iApply (Mappages.wp_mappages_sconf γ γa Φ B11 t m_ad 1%nat (Z.lor xperm 18) 0%nat
              ...
              HB11a4 (proj1 Hperm) Hmpvab Hmppab Hrep Hmpfresh HB11tp
              with "Hcg Hcnt Htext Hpc Hptree HenvM [-]").
    ...
    assert (Hret54 : ret_pc (B11 !!! Regidx Rra) = mword_of_int (UA + 0x54)).
    ...
    { rewrite (callee_saved_lookup Hgcs Rtp ltac:(vm_compute; reflexivity)). exact HB11tp. }
    ...
    { (* =========== mappages SUCCEEDED: one more page mapped =========== *)
      ...
      iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (UA + 0x54))
                (mword_of_int 26 : mword 8) (Cregidx (mword_of_int 2)) Ra0
                mg (K - 10)%nat ltac:(vm_compute; reflexivity)
                ltac:(vm_compute; discriminate) Hbnf with "Hcg Hpc Hi54 [-]").
      iIntros "Hcg Hpc".
      assert (Hq56 : add_vec_int (mword_of_int (UA + 0x54) : mword 64) 2
                     = mword_of_int (UA + 0x56)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq56) in "Hpc".
      (* +0x56 c.add s2,s2,s3  --  a += PGSIZE *)
      iApply (wp_cadd_s_sconf γ Φ (mword_of_int (UA + 0x56)) Rs2 Rs3 mg (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi56 [-]").
      iIntros "Hcg Hpc".
      ...
      assert (HB12tp : B12 !!! Regidx Rtp = cid_word)
        by (rewrite /B12; rewrite upd_ne; [exact Hmgtp | reg_neq]).
      ...
      assert (Hq58 : add_vec_int (mword_of_int (UA + 0x56) : mword 64) 2
                     = mword_of_int (UA + 0x58)) by (apply bv_eq; vm_compute; reflexivity).
      ...
      { (* another iteration *)
        ...
        assert (Htgt36 : add_vec (mword_of_int (UA + 0x58) : mword 64)
                  (sign_extend' 64 (mword_of_int 8158 : mword 13))
                = mword_of_int (UA + 0x36)) by (apply bv_eq; vm_compute; reflexivity).
        iApply (wp_bltu_taken_s_sconf γ Φ (mword_of_int (UA + 0x58))
                  (mword_of_int 8158 : mword 13) Rs4 Rs2 B12 (K - 10)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hbk
                  ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi58 [-]").
        iNext. iIntros "Hcg Hpc".
        iEval (rewrite Htgt36) in "Hpc".
        iApply (IH (S i) Pj B12 (add_vec av (mword_of_int 4096)) Hsum' Hrem' Havs
                  Hextj Hdomj HB12sp HB12tp HB12s2 HB12s3 HB12s4 HB12s5 HB12s6 HB12s7
      ...
      { assert (Hb := Hbk). rewrite HB12s2 HB12s4 in Hb. unfold zopz0zI_u in Hb.
        ...
        clear -Hsum Hnn2. lia. }
      iPoseProof (uai_5c with "Htext") as "Hi5c".
      iPoseProof (uai_5e with "Htext") as "Hi5e".
      iPoseProof (uai_60 with "Htext") as "Hi60".
      iPoseProof (uai_62 with "Htext") as "Hi62".
      iPoseProof (uai_64 with "Htext") as "Hi64".
      iApply (wp_bltu_fall_s_sconf γ Φ (mword_of_int (UA + 0x58))
                (mword_of_int 8158 : mword 13) Rs4 Rs2 B12 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hbk
                with "Hcg Hpc Hi58 [-]").
      iIntros "Hcg Hpc".
      assert (Hq5c : add_vec_int (mword_of_int (UA + 0x58) : mword 64) 4
                     = mword_of_int (UA + 0x5c)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq5c) in "Hpc".
      (* +0x5c c.mv a0,s4 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x5c)) Ra0 Rs4 B12 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi5c [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hq5e : add_vec_int (mword_of_int (UA + 0x5c) : mword 64) 2
                     = mword_of_int (UA + 0x5e)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq5e) in "Hpc".
      (* +0x5e c.ldsp s1,56(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x5e)) (mword_of_int 7 : mword 6) Rs1
                X1 (K - 10)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi5e [Hk3] [-]").
      { iEval (rewrite HX1sp Hb3). iExact "Hk3". }
      iIntros "Hcg Hpc Hk3". iEval (rewrite HX1sp Hb3) in "Hk3".
      ...
      assert (Hq60 : add_vec_int (mword_of_int (UA + 0x5e) : mword 64) 2
                     = mword_of_int (UA + 0x60)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq60) in "Hpc".
      (* +0x60 c.ldsp s3,40(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x60)) (mword_of_int 5 : mword 6) Rs3
                X2 (K - 10)%nat (mm !!! Regidx Rs3) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi60 [Hk5] [-]").
      { iEval (rewrite HX2sp Hb5). iExact "Hk5". }
      iIntros "Hcg Hpc Hk5". iEval (rewrite HX2sp Hb5) in "Hk5".
      ...
      assert (Hq62 : add_vec_int (mword_of_int (UA + 0x60) : mword 64) 2
                     = mword_of_int (UA + 0x62)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq62) in "Hpc".
      (* +0x62 c.ldsp s6,16(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x62)) (mword_of_int 2 : mword 6) Rs6
                X3 (K - 10)%nat (mm !!! Regidx Rs6) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi62 [Hk8] [-]").
      { iEval (rewrite HX3sp Hb8). iExact "Hk8". }
      iIntros "Hcg Hpc Hk8". iEval (rewrite HX3sp Hb8) in "Hk8".
      set (X4 := <[Regidx Rs6 := regval_into_reg (mm !!! Regidx Rs6)]> X3).
      assert (Hq64 : add_vec_int (mword_of_int (UA + 0x62) : mword 64) 2
                     = mword_of_int (UA + 0x64)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq64) in "Hpc".
      (* +0x64 c.j +0x14 *)
      assert (Hjt64 : add_vec (mword_of_int (UA + 0x64) : mword 64)
                (sign_extend' 64
                   (sign_extend' 21 (concat_vec (mword_of_int 10 : mword 11) ('b"0"))))
              = mword_of_int (UA + 0x78)) by (apply bv_eq; vm_compute; reflexivity).
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (UA + 0x64))
                (sign_extend' 21 (concat_vec (mword_of_int 10 : mword 11) ('b"0")))
                X4 (K - 10)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi64 [-]").
      iNext. iIntros "Hcg Hpc".
    ...
    iPoseProof (uai_88 with "Htext") as "Hi88".
    iPoseProof (uai_8a with "Htext") as "Hi8a".
    iPoseProof (uai_8e with "Htext") as "Hi8e".
    iPoseProof (uai_90 with "Htext") as "Hi90".
    iPoseProof (uai_92 with "Htext") as "Hi92".
    iPoseProof (uai_94 with "Htext") as "Hi94".
    iPoseProof (uai_98 with "Htext") as "Hi98".
    iPoseProof (uai_9a with "Htext") as "Hi9a".
    ...
    assert (Hbnt : neq_vec (mg !!! Regidx Ra0) zero_reg = true)
      by (rewrite Hga0; vm_compute; reflexivity).
    assert (Htgt88 : add_vec (mword_of_int (UA + 0x54) : mword 64)
              (sign_extend' 64
                 (sign_extend' 13 (concat_vec (mword_of_int 26 : mword 8) ('b"0"))))
            = mword_of_int (UA + 0x88)) by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (UA + 0x54))
              (mword_of_int 26 : mword 8) (Cregidx (mword_of_int 2)) Ra0
              mg (K - 10)%nat ltac:(vm_compute; reflexivity)
              ltac:(vm_compute; discriminate) Hbnt ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi54 [-]").
    iNext. iIntros "Hcg Hpc".
    iEval (rewrite Htgt88) in "Hpc".
    (* +0x88 c.mv a0,s1 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x88)) Ra0 Rs1 mg (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi88 [-]").
    iIntros "Hcg Hpc".
    set (F1 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (mg !!! Regidx Rs1))]> mg).
    assert (Hq8a : add_vec_int (mword_of_int (UA + 0x88) : mword 64) 2
                   = mword_of_int (UA + 0x8a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq8a) in "Hpc".
    (* +0x8a jal ra,kfree *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UA + 0x8a)) Rra
              (mword_of_int 2094832 : mword 21) F1 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi8a [-]").
    iIntros "Hcg Hpc".
    set (F2 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (UA + 0x8a) : mword 64) 4)]> F1).
    assert (Htgtkf : add_vec (mword_of_int (UA + 0x8a) : mword 64)
    ...
    assert (HF2ra : F2 !!! Regidx Rra
                    = add_vec_int (mword_of_int (UA + 0x8a) : mword 64) 4)
    ...
    assert (Hret8e : ret_pc (F2 !!! Regidx Rra) = mword_of_int (UA + 0x8e)).
    ...
    assert (Hftp : mfk !!! Regidx Rtp = cid_word).
    ...
    (* +0x8e c.mv a2,s7 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x8e)) Ra2 Rs7 mfk (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi8e [-]").
    iIntros "Hcg Hpc".
    set (G1 := <[Regidx Ra2 := regval_into_reg (add_vec zero_reg (mfk !!! Regidx Rs7))]> mfk).
    assert (Hq90 : add_vec_int (mword_of_int (UA + 0x8e) : mword 64) 2
                   = mword_of_int (UA + 0x90)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq90) in "Hpc".
    (* +0x90 c.mv a1,s2 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x90)) Ra1 Rs2 G1 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi90 [-]").
    iIntros "Hcg Hpc".
    set (G2 := <[Regidx Ra1 := regval_into_reg (add_vec zero_reg (G1 !!! Regidx Rs2))]> G1).
    assert (Hq92 : add_vec_int (mword_of_int (UA + 0x90) : mword 64) 2
                   = mword_of_int (UA + 0x92)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq92) in "Hpc".
    (* +0x92 c.mv a0,s5 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x92)) Ra0 Rs5 G2 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi92 [-]").
    iIntros "Hcg Hpc".
    set (G3 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (G2 !!! Regidx Rs5))]> G2).
    assert (Hq94 : add_vec_int (mword_of_int (UA + 0x92) : mword 64) 2
                   = mword_of_int (UA + 0x94)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq94) in "Hpc".
    (* +0x94 jal ra,uvmdealloc *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UA + 0x94)) Rra
              (mword_of_int 2096936 : mword 21) G3 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi94 [-]").
    iIntros "Hcg Hpc".
    set (G4 := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (UA + 0x94) : mword 64) 4)]> G3).
    assert (Htgtud2 : add_vec (mword_of_int (UA + 0x94) : mword 64)
                        (sign_extend' 64 (mword_of_int 2096936 : mword 21))
                      = mword_of_int KernelSyms.uvmdealloc)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtud2) in "Hpc".
    assert (HG4ra : G4 !!! Regidx Rra
                    = add_vec_int (mword_of_int (UA + 0x94) : mword 64) 4)
    ...
    assert (HG4tp : G4 !!! Regidx Rtp = cid_word).
    { rewrite /G4 /G3 /G2 /G1. repeat (rewrite upd_ne; [| reg_neq]). exact Hftp. }
    ...
    { rewrite (callee_saved_lookup Hd2cs csp_rs1 ltac:(vm_compute; reflexivity)). exact HG4sp. }
    assert (Hd2thr : forall c : mword 5, is_cs_idx c = true ->
              c <> csp_rs1 -> c <> Rs0 -> c <> Rs1 -> c <> Rs2 -> c <> Rs3 ->
              c <> Rs4 -> c <> Rs5 -> c <> Rs6 -> c <> Rs7 ->
              md2 !!! Regidx c = mm !!! Regidx c).
    { intros c Hc H2 H8 H9 H18 H19 H20 H21 H22 H23.
      rewrite (callee_saved_lookup Hd2cs c Hc). apply HG4thr; assumption. }
    (* +0x98 c.li a0,0 *)
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (UA + 0x98)) Ra0 (mword_of_int 0 : mword 6)
              (mword_of_int 0 : mword 64) md2 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hq9a : add_vec_int (mword_of_int (UA + 0x98) : mword 64) 2
                   = mword_of_int (UA + 0x9a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq9a) in "Hpc".
    (* +0x9a c.ldsp s1,56(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x9a)) (mword_of_int 7 : mword 6) Rs1
              G5 (K - 10)%nat (mm !!! Regidx Rs1) (dqm:=DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi9a [Hk3] [-]").
    { iEval (rewrite HG5sp Hb3). iExact "Hk3". }
    iIntros "Hcg Hpc Hk3". iEval (rewrite HG5sp Hb3) in "Hk3".
    ...
    assert (Hq9c : add_vec_int (mword_of_int (UA + 0x9a) : mword 64) 2
                   = mword_of_int (UA + 0x9c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq9c) in "Hpc".
    (* +0x9c c.ldsp s3,40(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x9c)) (mword_of_int 5 : mword 6) Rs3
              G6 (K - 10)%nat (mm !!! Regidx Rs3) (dqm:=DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi9c [Hk5] [-]").
    { iEval (rewrite HG6sp Hb5). iExact "Hk5". }
    iIntros "Hcg Hpc Hk5". iEval (rewrite HG6sp Hb5) in "Hk5".
    ...
    assert (Hq9e : add_vec_int (mword_of_int (UA + 0x9c) : mword 64) 2
                   = mword_of_int (UA + 0x9e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hq9e) in "Hpc".
    (* +0x9e c.ldsp s6,16(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x9e)) (mword_of_int 2 : mword 6) Rs6
              G7 (K - 10)%nat (mm !!! Regidx Rs6) (dqm:=DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi9e [Hk8] [-]").
    { iEval (rewrite HG7sp Hb8). iExact "Hk8". }
    iIntros "Hcg Hpc Hk8". iEval (rewrite HG7sp Hb8) in "Hk8".
    set (G8 := <[Regidx Rs6 := regval_into_reg (mm !!! Regidx Rs6)]> G7).
    assert (Hqa0 : add_vec_int (mword_of_int (UA + 0x9e) : mword 64) 2
                   = mword_of_int (UA + 0xa0)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hqa0) in "Hpc".
    (* +0xa0 c.j -0x28 *)
    assert (Hjta0 : add_vec (mword_of_int (UA + 0xa0) : mword 64)
              (sign_extend' 64
                 (sign_extend' 21 (concat_vec (mword_of_int 2028 : mword 11) ('b"0"))))
            = mword_of_int (UA + 0x78)) by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (UA + 0xa0))
              (sign_extend' 21 (concat_vec (mword_of_int 2028 : mword 11) ('b"0")))
              G8 (K - 10)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hia0 [-]").
    iNext. iIntros "Hcg Hpc".
  ...
  Proof.
    ...
    iPoseProof (uai_00 with "Htext") as "Hi00".
    destruct (zopz0zI_u (mm !!! Regidx Ra2) (mm !!! Regidx Ra1)) eqn:Hcmp0.
    { (* ============ newsz < oldsz: return oldsz, NO FRAME ============= *)
      iPoseProof (uai_a2 with "Htext") as "Hia2".
      iPoseProof (uai_a4 with "Htext") as "Hia4".
      ...
      assert (Htgta2 : add_vec (pcE : mword 64)
                       ...
                       = mword_of_int (UA + 0xa2))
        by (apply bv_eq; vm_compute; reflexivity).
      iApply (wp_bltu_taken_s_sconf γ Φ pcE (mword_of_int 162 : mword 13) Ra1 Ra2 mm K
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hcmp0
                Hala2 with "Hcg Hpc Hi00 [-]").
      iNext. iIntros "Hcg Hpc".
      iEval (rewrite Htgta2) in "Hpc".
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0xa2)) Ra0 Ra1 mm K
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hia2 [-]").
      iIntros "Hcg Hpc".
      set (Y1 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (mm !!! Regidx Ra1))]> mm).
      assert (Hppa4 : add_vec_int (mword_of_int (UA + 0xa2) : mword 64) 2
                      = mword_of_int (UA + 0xa4))
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hppa4) in "Hpc".
      iApply (wp_cret_s_sconf γ Φ (mword_of_int (UA + 0xa4)) Rra Y1 K
    ...
    iPoseProof (uai_04 with "Htext") as "Hi04".
    iPoseProof (uai_06 with "Htext") as "Hi06".
    iPoseProof (uai_08 with "Htext") as "Hi08".
    iPoseProof (uai_0a with "Htext") as "Hi0a".
    iPoseProof (uai_0c with "Htext") as "Hi0c".
    iPoseProof (uai_0e with "Htext") as "Hi0e".
    iPoseProof (uai_10 with "Htext") as "Hi10".
    iPoseProof (uai_12 with "Htext") as "Hi12".
    iPoseProof (uai_14 with "Htext") as "Hi14".
    iPoseProof (uai_16 with "Htext") as "Hi16".
    iPoseProof (uai_18 with "Htext") as "Hi18".
    iPoseProof (uai_1a with "Htext") as "Hi1a".
    iPoseProof (uai_1c with "Htext") as "Hi1c".
    iPoseProof (uai_1e with "Htext") as "Hi1e".
    iPoseProof (uai_20 with "Htext") as "Hi20".
    iPoseProof (uai_24 with "Htext") as "Hi24".
    iPoseProof (uai_26 with "Htext") as "Hi26".
    ...
    assert (Hp04 : add_vec_int (pcE : mword 64) 4 = mword_of_int (UA + 0x04))
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_bltu_fall_s_sconf γ Φ pcE (mword_of_int 162 : mword 13) Ra1 Ra2 mm K
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hcmp0
              with "Hcg Hpc Hi00 [-]").
    iIntros "Hcg Hpc".
    iEval (rewrite Hp04) in "Hpc".
    iApply (wp_caddi16sp_push_s_sconf γ Φ (mword_of_int (UA + 0x04))
    ...
    assert (Hp06 : add_vec_int (mword_of_int (UA + 0x04) : mword 64) 2
                   = mword_of_int (UA + 0x06)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp06) in "Hpc".
    (* +0x06 c.sdsp ra,72(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x06)) (mword_of_int 9 : mword 6) Rra
              R1 (K - 10)%nat u72 with "Hcg Hpc Hi06 [Hk1] [-]").
    ...
    assert (Hp08 : add_vec_int (mword_of_int (UA + 0x06) : mword 64) 2
                   = mword_of_int (UA + 0x08)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp08) in "Hpc".
    (* +0x08 c.sdsp s0,64(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x08)) (mword_of_int 8 : mword 6) Rs0
              R1 (K - 10)%nat u64 with "Hcg Hpc Hi08 [Hk2] [-]").
    ...
    assert (Hp0a : add_vec_int (mword_of_int (UA + 0x08) : mword 64) 2
                   = mword_of_int (UA + 0x0a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0a) in "Hpc".
    (* +0x0a c.sdsp s2,48(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x0a)) (mword_of_int 6 : mword 6) Rs2
    ...
    assert (Hp0c : add_vec_int (mword_of_int (UA + 0x0a) : mword 64) 2
                   = mword_of_int (UA + 0x0c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0c) in "Hpc".
    (* +0x0c c.sdsp s4,32(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x0c)) (mword_of_int 4 : mword 6) Rs4
              R1 (K - 10)%nat u32 with "Hcg Hpc Hi0c [Hk6] [-]").
    ...
    assert (Hp0e : add_vec_int (mword_of_int (UA + 0x0c) : mword 64) 2
                   = mword_of_int (UA + 0x0e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0e) in "Hpc".
    (* +0x0e c.sdsp s5,24(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x0e)) (mword_of_int 3 : mword 6) Rs5
              R1 (K - 10)%nat u24 with "Hcg Hpc Hi0e [Hk7] [-]").
    ...
    assert (Hp10 : add_vec_int (mword_of_int (UA + 0x0e) : mword 64) 2
                   = mword_of_int (UA + 0x10)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp10) in "Hpc".
    (* +0x10 c.sdsp s7,8(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x10)) (mword_of_int 1 : mword 6) Rs7
              R1 (K - 10)%nat u8 with "Hcg Hpc Hi10 [Hk9] [-]").
    ...
    assert (Hp12 : add_vec_int (mword_of_int (UA + 0x10) : mword 64) 2
                   = mword_of_int (UA + 0x12)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp12) in "Hpc".
    (* +0x12 c.addi4spn s0,sp,80 *)
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (UA + 0x12)) (Cregidx (mword_of_int 0))
    ...
    assert (Hp14 : add_vec_int (mword_of_int (UA + 0x12) : mword 64) 2
                   = mword_of_int (UA + 0x14)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp14) in "Hpc".
    (* +0x14 c.mv s5,a0 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x14)) Rs5 Ra0 R2 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi14 [-]").
    iIntros "Hcg Hpc".
    set (R3 := <[Regidx Rs5 := regval_into_reg (add_vec zero_reg (R2 !!! Regidx Ra0))]> R2).
    assert (Hp16 : add_vec_int (mword_of_int (UA + 0x14) : mword 64) 2
                   = mword_of_int (UA + 0x16)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp16) in "Hpc".
    (* +0x16 c.mv s4,a2 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x16)) Rs4 Ra2 R3 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi16 [-]").
    iIntros "Hcg Hpc".
    set (R4 := <[Regidx Rs4 := regval_into_reg (add_vec zero_reg (R3 !!! Regidx Ra2))]> R3).
    assert (Hp18 : add_vec_int (mword_of_int (UA + 0x16) : mword 64) 2
                   = mword_of_int (UA + 0x18)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp18) in "Hpc".
    (* +0x18 c.lui a5,0x1 *)
    iApply (wp_clui_s_sconf γ Φ (mword_of_int (UA + 0x18)) Ra5
              (sign_extend' 20 (mword_of_int 1 : mword 6)) (mword_of_int 4096 : mword 64)
              R4 (K - 10)%nat ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) lui_4096 with "Hcg Hpc Hi18 [-]").
    iIntros "Hcg Hpc".
    set (R5 := <[Regidx Ra5 := regval_into_reg (mword_of_int 4096 : mword 64)]> R4).
    assert (Hp1a : add_vec_int (mword_of_int (UA + 0x18) : mword 64) 2
                   = mword_of_int (UA + 0x1a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp1a) in "Hpc".
    (* +0x1a c.addi a5,a5,-1 *)
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (UA + 0x1a)) Ra5 (mword_of_int 63 : mword 6)
              R5 (K - 10)%nat ltac:(vm_compute; discriminate)
    ...
    assert (Hp1c : add_vec_int (mword_of_int (UA + 0x1a) : mword 64) 2
                   = mword_of_int (UA + 0x1c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp1c) in "Hpc".
    (* +0x1c c.add a1,a1,a5 *)
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (UA + 0x1c)) Ra1 Ra5 R6 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1c [-]").
    iIntros "Hcg Hpc".
    set (R7 := <[Regidx Ra1 := regval_into_reg
                  (add_vec (R6 !!! Regidx Ra1) (R6 !!! Regidx Ra5))]> R6).
    assert (Hp1e : add_vec_int (mword_of_int (UA + 0x1c) : mword 64) 2
                   = mword_of_int (UA + 0x1e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp1e) in "Hpc".
    (* +0x1e c.lui a5,0xfffff *)
    iApply (wp_clui_s_sconf γ Φ (mword_of_int (UA + 0x1e)) Ra5
              (sign_extend' 20 (mword_of_int 63 : mword 6)) (mword_of_int (-4096) : mword 64)
              R7 (K - 10)%nat ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) lui_m4096 with "Hcg Hpc Hi1e [-]").
    iIntros "Hcg Hpc".
    set (R8 := <[Regidx Ra5 := regval_into_reg (mword_of_int (-4096) : mword 64)]> R7).
    assert (Hp20 : add_vec_int (mword_of_int (UA + 0x1e) : mword 64) 2
                   = mword_of_int (UA + 0x20)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_and_s_sconf γ Φ (mword_of_int (UA + 0x20)) Rs2 Ra1 Ra5 (pgroundup oldsz)
              R8 (K - 10)%nat ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) HR8and with "Hcg Hpc Hi20 [-]").
    iIntros "Hcg Hpc".
    set (R9 := <[Regidx Rs2 := regval_into_reg (pgroundup oldsz)]> R8).
    assert (Hp24 : add_vec_int (mword_of_int (UA + 0x20) : mword 64) 4
                   = mword_of_int (UA + 0x24)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp24) in "Hpc".
    (* +0x24 c.mv s7,s2 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0x24)) Rs7 Rs2 R9 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi24 [-]").
    iIntros "Hcg Hpc".
    set (R10 := <[Regidx Rs7 := regval_into_reg (add_vec zero_reg (R9 !!! Regidx Rs2))]> R9).
    assert (Hp26 : add_vec_int (mword_of_int (UA + 0x24) : mword 64) 2
                   = mword_of_int (UA + 0x26)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    assert (HR10tp : R10 !!! Regidx Rtp = cid_word).
    { rewrite /R10 /R9 /R8 /R7 /R6 /R5 /R4 /R3 /R2 /R1.
    ...
    (* ================================================================= *)
    iPoseProof (uai_78 with "Htext") as "Hi78".
    iPoseProof (uai_7a with "Htext") as "Hi7a".
    iPoseProof (uai_7c with "Htext") as "Hi7c".
    iPoseProof (uai_7e with "Htext") as "Hi7e".
    iPoseProof (uai_80 with "Htext") as "Hi80".
    iPoseProof (uai_82 with "Htext") as "Hi82".
    iPoseProof (uai_84 with "Htext") as "Hi84".
    iPoseProof (uai_86 with "Htext") as "Hi86".
    iAssert (ua_exit γ Φ mm P vpn0 n K eb p C sp0 spr oldsz newsz)
    ...
    { rewrite /ua_exit.
      ...
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x78)) (mword_of_int 9 : mword 6) Rra
      ...
      assert (Hq7a : add_vec_int (mword_of_int (UA + 0x78) : mword 64) 2
                     = mword_of_int (UA + 0x7a)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq7a) in "Hpc".
      (* +0x7a c.ldsp s0,64(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x7a)) (mword_of_int 8 : mword 6) Rs0
      ...
      assert (Hq7c : add_vec_int (mword_of_int (UA + 0x7a) : mword 64) 2
                     = mword_of_int (UA + 0x7c)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq7c) in "Hpc".
      (* +0x7c c.ldsp s2,48(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x7c)) (mword_of_int 6 : mword 6) Rs2
                E2 (K - 10)%nat (mm !!! Regidx Rs2) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      assert (Hq7e : add_vec_int (mword_of_int (UA + 0x7c) : mword 64) 2
                     = mword_of_int (UA + 0x7e)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq7e) in "Hpc".
      (* +0x7e c.ldsp s4,32(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x7e)) (mword_of_int 4 : mword 6) Rs4
                E3 (K - 10)%nat (mm !!! Regidx Rs4) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi7e [Hk6] [-]").
      { iEval (rewrite HE3sp Hb6). iExact "Hk6". }
      iIntros "Hcg Hpc Hk6". iEval (rewrite HE3sp Hb6) in "Hk6".
      ...
      assert (Hq80 : add_vec_int (mword_of_int (UA + 0x7e) : mword 64) 2
                     = mword_of_int (UA + 0x80)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq80) in "Hpc".
      (* +0x80 c.ldsp s5,24(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x80)) (mword_of_int 3 : mword 6) Rs5
                E4 (K - 10)%nat (mm !!! Regidx Rs5) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi80 [Hk7] [-]").
      { iEval (rewrite HE4sp Hb7). iExact "Hk7". }
      iIntros "Hcg Hpc Hk7". iEval (rewrite HE4sp Hb7) in "Hk7".
      ...
      assert (Hq82 : add_vec_int (mword_of_int (UA + 0x80) : mword 64) 2
                     = mword_of_int (UA + 0x82)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hq82) in "Hpc".
      (* +0x82 c.ldsp s7,8(sp) *)
      iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UA + 0x82)) (mword_of_int 1 : mword 6) Rs7
                E5 (K - 10)%nat (mm !!! Regidx Rs7) (dqm:=DfracOwn 1)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi82 [Hk9] [-]").
      { iEval (rewrite HE5sp Hb9). iExact "Hk9". }
      iIntros "Hcg Hpc Hk9". iEval (rewrite HE5sp Hb9) in "Hk9".
      ...
      assert (Hq84 : add_vec_int (mword_of_int (UA + 0x82) : mword 64) 2
                     = mword_of_int (UA + 0x84)) by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (UA + 0x84))
                (mword_of_int 5 : mword 6) E6 (K - 10)%nat 10 Hpop
      ...
      assert (Hq86 : add_vec_int (mword_of_int (UA + 0x84) : mword 64) 2
                     = mword_of_int (UA + 0x86)) by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_cret_s_sconf γ Φ (mword_of_int (UA + 0x86)) Rra E7 K
    ...
    { (* ---- PGROUNDUP(oldsz) >= newsz: nothing to do, return newsz ---- *)
      iPoseProof (uai_a6 with "Htext") as "Hia6".
      iPoseProof (uai_a8 with "Htext") as "Hia8".
      ...
      assert (Halta6 : eq_vec (access_vec_dec (add_vec (mword_of_int (UA + 0x26) : mword 64)
                 (sign_extend' 64 (mword_of_int 128 : mword 13))) 0) ('b"0") = true)
        by (vm_compute; reflexivity).
      assert (Htgta6 : add_vec (mword_of_int (UA + 0x26) : mword 64)
                         (sign_extend' 64 (mword_of_int 128 : mword 13))
                       = mword_of_int (UA + 0xa6))
        by (apply bv_eq; vm_compute; reflexivity).
      iApply (wp_bgeu_taken_s_sconf γ Φ (mword_of_int (UA + 0x26))
                (mword_of_int 128 : mword 13) Ra2 Rs2 R10 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hbg
                Halta6 with "Hcg Hpc Hi26 [-]").
      iNext. iIntros "Hcg Hpc".
      iEval (rewrite Htgta6) in "Hpc".
      (* +0xa6 c.mv a0,a2 *)
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UA + 0xa6)) Ra0 Ra2 R10 (K - 10)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hia6 [-]").
      iIntros "Hcg Hpc".
      set (Z1 := <[Regidx Ra0 := regval_into_reg (add_vec zero_reg (R10 !!! Regidx Ra2))]> R10).
      assert (Hpa8 : add_vec_int (mword_of_int (UA + 0xa6) : mword 64) 2
                     = mword_of_int (UA + 0xa8)) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpa8) in "Hpc".
      assert (Hjta8 : add_vec (mword_of_int (UA + 0xa8) : mword 64)
                (sign_extend' 64
                   (sign_extend' 21 (concat_vec (mword_of_int 2024 : mword 11) ('b"0"))))
              = mword_of_int (UA + 0x78)) by (apply bv_eq; vm_compute; reflexivity).
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (UA + 0xa8))
                (sign_extend' 21 (concat_vec (mword_of_int 2024 : mword 11) ('b"0")))
                Z1 (K - 10)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hia8 [-]").
      iNext. iIntros "Hcg Hpc".
    ...
    iPoseProof (uai_2a with "Htext") as "Hi2a".
    iPoseProof (uai_2c with "Htext") as "Hi2c".
    iPoseProof (uai_2e with "Htext") as "Hi2e".
    iPoseProof (uai_30 with "Htext") as "Hi30".
    iPoseProof (uai_32 with "Htext") as "Hi32".
    iApply (wp_bgeu_fall_s_sconf γ Φ (mword_of_int (UA + 0x26))
              (mword_of_int 128 : mword 13) Ra2 Rs2 R10 (K - 10)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hbg
              with "Hcg Hpc Hi26 [-]").
    iIntros "Hcg Hpc".
    assert (Hp2a : add_vec_int (mword_of_int (UA + 0x26) : mword 64) 4
                   = mword_of_int (UA + 0x2a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp2a) in "Hpc".
    (* +0x2a c.sdsp s1,56(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x2a)) (mword_of_int 7 : mword 6) Rs1
              R10 (K - 10)%nat u56 with "Hcg Hpc Hi2a [Hk3] [-]").
    { iEval (rewrite HR10sp Hb3). iExact "Hk3". }
    iIntros "Hcg Hpc Hk3". iEval (rewrite HR10sp Hb3) in "Hk3".
    assert (HR10s1 : R10 !!! Regidx Rs1 = mm !!! Regidx Rs1)
      by (apply HR10thr; vm_compute; first [reflexivity | discriminate]).
    iEval (rewrite HR10s1) in "Hk3".
    assert (Hp2c : add_vec_int (mword_of_int (UA + 0x2a) : mword 64) 2
                   = mword_of_int (UA + 0x2c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp2c) in "Hpc".
    (* +0x2c c.sdsp s3,40(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x2c)) (mword_of_int 5 : mword 6) Rs3
              R10 (K - 10)%nat u40 with "Hcg Hpc Hi2c [Hk5] [-]").
    { iEval (rewrite HR10sp Hb5). iExact "Hk5". }
    iIntros "Hcg Hpc Hk5". iEval (rewrite HR10sp Hb5) in "Hk5".
    assert (HR10s3 : R10 !!! Regidx Rs3 = mm !!! Regidx Rs3)
      by (apply HR10thr; vm_compute; first [reflexivity | discriminate]).
    iEval (rewrite HR10s3) in "Hk5".
    assert (Hp2e : add_vec_int (mword_of_int (UA + 0x2c) : mword 64) 2
                   = mword_of_int (UA + 0x2e)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp2e) in "Hpc".
    (* +0x2e c.sdsp s6,16(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UA + 0x2e)) (mword_of_int 2 : mword 6) Rs6
              R10 (K - 10)%nat u16 with "Hcg Hpc Hi2e [Hk8] [-]").
    { iEval (rewrite HR10sp Hb8). iExact "Hk8". }
    iIntros "Hcg Hpc Hk8". iEval (rewrite HR10sp Hb8) in "Hk8".
    assert (HR10s6 : R10 !!! Regidx Rs6 = mm !!! Regidx Rs6)
      by (apply HR10thr; vm_compute; first [reflexivity | discriminate]).
    iEval (rewrite HR10s6) in "Hk8".
    assert (Hp30 : add_vec_int (mword_of_int (UA + 0x2e) : mword 64) 2
                   = mword_of_int (UA + 0x30)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp30) in "Hpc".
    (* +0x30 c.lui s3,0x1 *)
    iApply (wp_clui_s_sconf γ Φ (mword_of_int (UA + 0x30)) Rs3
              (sign_extend' 20 (mword_of_int 1 : mword 6)) (mword_of_int 4096 : mword 64)
              R10 (K - 10)%nat ltac:(vm_compute; discriminate)
              ltac:(vm_compute; discriminate) lui_4096 with "Hcg Hpc Hi30 [-]").
    iIntros "Hcg Hpc".
    set (R11 := <[Regidx Rs3 := regval_into_reg (mword_of_int 4096 : mword 64)]> R10).
    assert (Hp32 : add_vec_int (mword_of_int (UA + 0x30) : mword 64) 2
                   = mword_of_int (UA + 0x32)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_ori_s_sconf γ Φ (mword_of_int (UA + 0x32)) Rs6 Ra3
              ...
              ltac:(vm_compute; discriminate) HR11ori with "Hcg Hpc Hi32 [-]").
    iIntros "Hcg Hpc".
    set (R12 := <[Regidx Rs6 := regval_into_reg
                   (mword_of_int (Z.lor xperm 18) : mword 64)]> R11).
    assert (Hp36 : add_vec_int (mword_of_int (UA + 0x32) : mword 64) 4
                   = mword_of_int (UA + 0x36)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    assert (HR12tp : R12 !!! Regidx Rtp = cid_word).
    { rewrite /R12 /R11. repeat (rewrite upd_ne; [| reg_neq]). exact HR10tp. }
    ...
    iApply (ua_loop γ γa Φ mm P xperm K eb p C sp0 spr oldsz newsz pu nz n

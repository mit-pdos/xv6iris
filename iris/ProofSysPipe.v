...
Section ProofSysPipe.
  ...
  Proof.
    ...
    iDestruct (fileclose_env_frame fn on us 0%nat eb p Cf0 with "Hpenv Hfenv")
      as "[Hfcenv0 Hfcback0]".
    iApply (Fileclose.wp_fileclose_sconf kt γfl γf k0 q0 Cf0 fn on us D2 0%nat eb p nav b lks
              Hnav sp_noff0 HD2a0 Hbelow
              with "Hcg Hcpu Hextc Hextm Htext Hkd Hpc Hftab Hpe Href0 Hfcenv0").
    all: try lkbelow.
    ...
    iDestruct (fileclose_env_frame fn on1 us1 0%nat eb p Cf1 with "Hpenv Hfenv")
      as "[Hfcenv1 Hfcback1]".
    iApply (Fileclose.wp_fileclose_sconf kt γfl γf k1 q1 Cf1 fn on1 us1 F2 0%nat eb p nav b lks
              Hnav sp_noff0 HF2a0 Hbelow
              with "Hcg Hcpu Hextc Hextm Htext Hkd Hpc Hftab Hpe Href1 Hfcenv1").
    all: try lkbelow.
  ...
  Proof.
    ...
    pose (EPI := (wp_next true p (fun (CIDe : CpuId) =>
      ∀ (mj : regfile) (P' : uptd) (res : mword 64),
        ...
        ⌜ uptd_ext (pv_upt V) P' ⌝ -∗
        sie_cap_gpr kt mj (av - 8)%nat b p -∗
        cpu_own 0%nat eb p b lks -∗
        trap_csrs_ext kt eb -∗
        cpu_claim_ext eb p -∗
        pc_is (mword_of_int (KernelSyms.sys_pipe + 0xda) : mword 64) -∗
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_pipe + 0xa)) Rra
              (mword_of_int 2081938 : mword 21) R2 (av - 8)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iDestruct (cpu_own_transport CID CID24 0%nat eb p b ltac:(wp_next_chain)
                 with "Hcpu") as "Hcpu".
    iApply (Myproc.wp_myproc_sconf kt R3 (av - 8)%nat 0%nat eb p b lks
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_pipe + 0x16)) Rra
              (mword_of_int 2085860 : mword 21) P3 (av - 8)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Hjaa : add_vec (mword_of_int (KernelSyms.sys_pipe + 0x16) : mword 64)
                     (sign_extend' 64 (mword_of_int 2085860 : mword 21))
    ...
    iDestruct (cpu_own_transport CID25 CID29 0%nat eb p b ltac:(wp_next_chain)
                 with "Hcpu") as "Hcpu".
    iApply (Argaddr.wp_argaddr_sconf kt P4 (av - 8)%nat 0%nat eb p 0%nat
    ...
    iDestruct (cpu_claim_ext_transport CID CID33 eb p
                 ltac:(rewrite Hb; wp_next_chain) with "Hextm") as "Hextm".
    iApply (Pipealloc.wp_pipealloc_sconf kt γfl γf γa γk
              (mword_of_int (KernelSyms.kmem + 24)) Q3 u6 u7 None 0%nat eb p (av - 8)%nat b lks
              Hav24 eq_refl sp_noff0
              with "Hcg Hcpu Hextc Hextm Htext Hdata Hpc Hftab Hkmem Hkav Hpe Hua Hub Hb6 Hb7").
    all: try lkbelow.
    ...
    assert (Hcc4f : add_vec (mword_of_int (KernelSyms.sys_pipe + 0xcc) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091976 : mword 21))
                    = mword_of_int KernelSyms.fileclose)
      by (apply bv_eq; vm_compute; reflexivity).
    assert (Hcc4g : add_vec (mword_of_int (KernelSyms.sys_pipe + 0xd4) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091968 : mword 21))
                    = mword_of_int KernelSyms.fileclose)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (Fdalloc.wp_fdalloc_sconf kt γf k0 ∅ X1 (av - 8)%nat 0%nat eb p pid V b lks
    ...
    iApply (Fdalloc.wp_fdalloc_sconf kt γf k1 ∅ Z1 (av - 8)%nat 0%nat eb p pid
    ...
    assert (Hc9cg : add_vec (mword_of_int (KernelSyms.sys_pipe + 0xac) : mword 64)
                      (sign_extend' 64 (mword_of_int 2092008 : mword 21))
                    = mword_of_int KernelSyms.fileclose)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_pipe + 0x5e)) Rra
              (mword_of_int 2080888 : mword 21) A5 (av - 8)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Hjco1 : add_vec (mword_of_int (KernelSyms.sys_pipe + 0x5e) : mword 64)
                      (sign_extend' 64 (mword_of_int 2080888 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_pipe + 0x76)) Rra
              (mword_of_int 2080864 : mword 21) C6 (av - 8)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Hjco2 : add_vec (mword_of_int (KernelSyms.sys_pipe + 0x76) : mword 64)
                      (sign_extend' 64 (mword_of_int 2080864 : mword 21))
                    = mword_of_int KernelSyms.copyout)
      by (apply bv_eq; vm_compute; reflexivity).

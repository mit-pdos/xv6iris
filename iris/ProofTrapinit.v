...
Section CodeTrapinitBundle.
  ...
  Lemma tri_code :
    kernel_text -∗ ilw_code KernelSyms.trapinit (mword_of_int 5) (mword_of_int 22)
                            (mword_of_int 3666) (mword_of_int 3530) (mword_of_int 2090806).
  Proof.
...
Section ProofTrapinit.
  ...
  Proof.
    ...
    iApply (ILW.wp_initlock_wrapper_sconf m K KernelSyms.trapinit
              (mword_of_int 5) (mword_of_int 22) (mword_of_int 3666) (mword_of_int 3530)
              (mword_of_int 2090806) lk name "time"%string vlock vname vcpu b p HK

...
Section CodeVirtioDiskIntr.
  ...
  (* ---- virtio_disk_intr @ KernelSyms.virtio_disk_intr, 1244 bytes ---- *)
  ...
  Lemma vti_0e : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0xe) : mword 64) false (ITYPE (mword_of_int 2346 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0xe) (mword_of_int 0x92a48493 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0xe) : mword 64) (ITYPE (mword_of_int 2346 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), ADDI)) kd_92a48493. Qed.
  ...
  Lemma vti_16 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x16) : mword 64) false (ITYPE (mword_of_int 2634 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x16) (mword_of_int 0xa4a50513 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x16) : mword 64) (ITYPE (mword_of_int 2634 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_a4a50513. Qed.

  Lemma vti_1a : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x1a) : mword 64) false (JAL (mword_of_int 2076796 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x1a) (mword_of_int 0x87cfb0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x1a) : mword 64) (JAL (mword_of_int 2076796 : mword 21, Regidx (mword_of_int 1))) kd_87cfb0ef. Qed.
  ...
  Lemma vti_6e : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x6e) : mword 64) false (JAL (mword_of_int 2081794 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x6e) (mword_of_int 0xc02fc0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x6e) : mword 64) (JAL (mword_of_int 2081794 : mword 21, Regidx (mword_of_int 1))) kd_c02fc0ef. Qed.
  ...
  Lemma vti_8e : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x8e) : mword 64) false (ITYPE (mword_of_int 2514 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x8e) (mword_of_int 0x9d250513 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x8e) : mword 64) (ITYPE (mword_of_int 2514 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_9d250513. Qed.

  Lemma vti_92 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x92) : mword 64) false (JAL (mword_of_int 2076812 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x92) (mword_of_int 0x88cfb0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x92) : mword 64) (JAL (mword_of_int 2076812 : mword 21, Regidx (mword_of_int 1))) kd_88cfb0ef. Qed.
  ...
  Lemma vti_a4 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0xa4) : mword 64) false (ITYPE (mword_of_int 2900 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0xa4) (mword_of_int 0xb5450513 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0xa4) : mword 64) (ITYPE (mword_of_int 2900 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_b5450513. Qed.

  Lemma vti_a8 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0xa8) : mword 64) false (JAL (mword_of_int 2075760 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0xa8) (mword_of_int 0xc71fa0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0xa8) : mword 64) (JAL (mword_of_int 2075760 : mword 21, Regidx (mword_of_int 1))) kd_c71fa0ef. Qed.

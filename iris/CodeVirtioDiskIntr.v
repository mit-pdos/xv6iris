...
Section CodeVirtioDiskIntr.
  ...
  Lemma vti_0e : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0xe) : mword 64) false (ITYPE (mword_of_int 2658 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0xe) (mword_of_int 0xa6248493 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0xe) : mword 64) (ITYPE (mword_of_int 2658 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), ADDI)) kd_a6248493. Qed.
  ...
  Lemma vti_16 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x16) : mword 64) false (ITYPE (mword_of_int 2946 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x16) (mword_of_int 0xb8250513 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x16) : mword 64) (ITYPE (mword_of_int 2946 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_b8250513. Qed.

  Lemma vti_1a : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x1a) : mword 64) false (JAL (mword_of_int 2077062 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x1a) (mword_of_int 0x986fb0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x1a) : mword 64) (JAL (mword_of_int 2077062 : mword 21, Regidx (mword_of_int 1))) kd_986fb0ef. Qed.
  ...
  Lemma vti_6e : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x6e) : mword 64) false (JAL (mword_of_int 2081992 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x6e) (mword_of_int 0xcc8fc0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x6e) : mword 64) (JAL (mword_of_int 2081992 : mword 21, Regidx (mword_of_int 1))) kd_cc8fc0ef. Qed.
  ...
  Lemma vti_8e : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x8e) : mword 64) false (ITYPE (mword_of_int 2826 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x8e) (mword_of_int 0xb0a50513 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x8e) : mword 64) (ITYPE (mword_of_int 2826 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_b0a50513. Qed.

  Lemma vti_92 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0x92) : mword 64) false (JAL (mword_of_int 2077078 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0x92) (mword_of_int 0x996fb0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0x92) : mword 64) (JAL (mword_of_int 2077078 : mword 21, Regidx (mword_of_int 1))) kd_996fb0ef. Qed.
  ...
  Lemma vti_a4 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0xa4) : mword 64) false (ITYPE (mword_of_int 3132 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0xa4) (mword_of_int 0xc3c50513 : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0xa4) : mword 64) (ITYPE (mword_of_int 3132 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_c3c50513. Qed.

  Lemma vti_a8 : kernel_text -∗ instr (mword_of_int (KernelSyms.virtio_disk_intr + 0xa8) : mword 64) false (JAL (mword_of_int 2075992 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.virtio_disk_intr + 0xa8) (mword_of_int 0xd59fa0ef : mword 32)
    (mword_of_int (KernelSyms.virtio_disk_intr + 0xa8) : mword 64) (JAL (mword_of_int 2075992 : mword 21, Regidx (mword_of_int 1))) kd_d59fa0ef. Qed.

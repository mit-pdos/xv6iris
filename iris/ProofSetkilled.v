...
Section ProofSetkilled.
  ...
  Proof.
    ...
    assert (Hp02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (SK + 0x02)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SK + 0x02)) (mword_of_int 3 : mword 6) sk_ra M1 (av - 4)%nat v1 b
              with "Hcg Hpc Hi02 [Hb1] [-]").
    { iEval (rewrite HcspM1 -Hb1a). iExact "Hb1". }
    iIntros (CID2 Hs2) "Hcg Hpc Hb1".
    assert (Hp04 : add_vec_int (mword_of_int (SK + 0x02) : mword 64) 2 = mword_of_int (SK + 0x04)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp04) in "Hpc".
    iPoseProof (ski_04 with "Htext") as "Hi04".
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SK + 0x04)) (mword_of_int 2 : mword 6) sk_s0 M1 (av - 4)%nat v2 b
              with "Hcg Hpc Hi04 [Hb2] [-]").
    { iEval (rewrite HcspM1 -Hb2a). iExact "Hb2". }
    iIntros (CID3 Hs3) "Hcg Hpc Hb2".
    assert (Hp06 : add_vec_int (mword_of_int (SK + 0x04) : mword 64) 2 = mword_of_int (SK + 0x06)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp06) in "Hpc".
    iPoseProof (ski_06 with "Htext") as "Hi06".
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (SK + 0x06)) (mword_of_int 1 : mword 6) sk_s1 M1 (av - 4)%nat v3 b
              with "Hcg Hpc Hi06 [Hb3] [-]").
    { iEval (rewrite HcspM1 -Hb3a). iExact "Hb3". }
    iIntros (CID4 Hs4) "Hcg Hpc Hb3".
    assert (Hp08 : add_vec_int (mword_of_int (SK + 0x06) : mword 64) 2 = mword_of_int (SK + 0x08)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (SK + 0x08)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) sk_s0
              M1 (av - 4)%nat b
    ...
    assert (Hp0a : add_vec_int (mword_of_int (SK + 0x08) : mword 64) 2 = mword_of_int (SK + 0x0a)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0a) in "Hpc".
    (* +0x0a: c.mv s1,a0 -- park [p] in a callee-saved register *)
    iPoseProof (ski_0a with "Htext") as "Hi0a".
    iApply (wp_cmv_s_sconf Φ (mword_of_int (SK + 0x0a)) sk_s1 sk_a0 A1 (av - 4)%nat b
    ...
    assert (Hp0c : add_vec_int (mword_of_int (SK + 0x0a) : mword 64) 2 = mword_of_int (SK + 0x0c)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (SK + 0x0c)) sk_ra (mword_of_int 2091742 : mword 21)
              A2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi0c [-]").
    iIntros (CID7 Hs7) "Hcg Hpc".
    set (B1 := <[Regidx sk_ra := regval_into_reg (add_vec_int (mword_of_int (SK + 0x0c) : mword 64) 4)]> A2).
    change (<[Regidx sk_ra := regval_into_reg (add_vec_int (mword_of_int (SK + 0x0c) : mword 64) 4)]> A2) with B1.
    assert (Hjacq : add_vec (mword_of_int (SK + 0x0c) : mword 64) (sign_extend' 64 (mword_of_int 2091742 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjacq) in "Hpc".
    assert (HB1ra : B1 !!! Regidx sk_ra = add_vec_int (mword_of_int (SK + 0x0c) : mword 64) 4) by (rewrite /B1 upd_eq; reflexivity).
    ...
    assert (Hp10 : ret_pc (B1 !!! Regidx sk_ra) = mword_of_int (SK + 0x10))
    ...
    iApply (wp_cli_s_sconf Φ (mword_of_int (SK + 0x10)) sk_a5 (mword_of_int 1 : mword 6)
    ...
    assert (Hp12 : add_vec_int (mword_of_int (SK + 0x10) : mword 64) 2 = mword_of_int (SK + 0x12)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_csw_s_sconf Φ (mword_of_int (SK + 0x12)) sk_a5 sk_s1
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (SK + 0x14)) sk_a0 sk_s1 C1 (av - 4)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi14 [-]").
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Hp16 : add_vec_int (mword_of_int (SK + 0x14) : mword 64) 2 = mword_of_int (SK + 0x16)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (SK + 0x16)) sk_ra (mword_of_int 2091868 : mword 21)
              C2 (av - 4)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi16 [-]").
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    set (C3 := <[Regidx sk_ra := regval_into_reg (add_vec_int (mword_of_int (SK + 0x16) : mword 64) 4)]> C2).
    change (<[Regidx sk_ra := regval_into_reg (add_vec_int (mword_of_int (SK + 0x16) : mword 64) 4)]> C2) with C3.
    assert (Hjrel : add_vec (mword_of_int (SK + 0x16) : mword 64) (sign_extend' 64 (mword_of_int 2091868 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjrel) in "Hpc".
    assert (HC3ra : C3 !!! Regidx sk_ra = add_vec_int (mword_of_int (SK + 0x16) : mword 64) 4) by (rewrite /C3 upd_eq; reflexivity).
    ...
    assert (Hp1a : ret_pc (C3 !!! Regidx sk_ra) = mword_of_int (SK + 0x1a))
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (SK + 0x1a)) (mword_of_int 3 : mword 6) sk_ra
    ...
    assert (Hp1c : add_vec_int (mword_of_int (SK + 0x1a) : mword 64) 2 = mword_of_int (SK + 0x1c)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (SK + 0x1c)) (mword_of_int 2 : mword 6) sk_s0
    ...
    assert (Hp1e : add_vec_int (mword_of_int (SK + 0x1c) : mword 64) 2 = mword_of_int (SK + 0x1e)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (SK + 0x1e)) (mword_of_int 1 : mword 6) sk_s1
    ...
    assert (Hp20 : add_vec_int (mword_of_int (SK + 0x1e) : mword 64) 2 = mword_of_int (SK + 0x20)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (SK + 0x20)) (mword_of_int 2 : mword 6) E2 (av - 4)%nat 4 b Hpop
    ...
    assert (Hp22 : add_vec_int (mword_of_int (SK + 0x20) : mword 64) 2 = mword_of_int (SK + 0x22)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cret_s_sconf Φ (mword_of_int (SK + 0x22)) sk_ra E3 av b

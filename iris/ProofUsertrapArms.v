...
Section Ut56.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (UT + 0x60)) Ra0 Ra0
              (mword_of_int 3194 : mword 12) M3 nx false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [-]").
    ...
    set (M4 := <[Regidx Ra0 := regval_into_reg
                   (add_vec (rget M3 Ra0)
                      (sign_extend' 64 (mword_of_int 3194 : mword 12)))]> M3).
    change (<[Regidx Ra0 := regval_into_reg
               (add_vec (rget M3 Ra0)
                  (sign_extend' 64 (mword_of_int 3194 : mword 12)))]> M3) with M4.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (UT + 0x64)) Rra
              (mword_of_int 2088644 : mword 21) M4 nx false
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    assert (Hpk1 : add_vec (mword_of_int (UT + 0x64) : mword 64)
                     (sign_extend' 64 (mword_of_int 2088644 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (UT + 0x74)) Ra0 Ra0
              (mword_of_int 3222 : mword 12) M8 nx false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [-]").
    ...
    set (M9 := <[Regidx Ra0 := regval_into_reg
                   (add_vec (rget M8 Ra0)
                      (sign_extend' 64 (mword_of_int 3222 : mword 12)))]> M8).
    change (<[Regidx Ra0 := regval_into_reg
               (add_vec (rget M8 Ra0)
                  (sign_extend' 64 (mword_of_int 3222 : mword 12)))]> M8) with M9.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (UT + 0x78)) Rra
              (mword_of_int 2088624 : mword 21) M9 nx false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc [] [-]").
    ...
    assert (Hpk2 : add_vec (mword_of_int (UT + 0x78) : mword 64)
                     (sign_extend' 64 (mword_of_int 2088624 : mword 21))
                   = mword_of_int KernelSyms.printk) by pcw.

...
Require Import WpLock CpuOwn UartTxInv SpecPanic.
...
Section ProofPrintk.
  ...
  Lemma wp_printk_epi `{CID0 : CpuId}
      ...
      (n : nat) (eb : bool) (C R : iProp Σ) (b : bool) (pcur : mword 64) :
    let sp0 := m !!! Regidx csp_rs1 in
    let spd := add_vec sp0 (sign_extend' 64 (caddi16sp_imm (mword_of_int 52 : mword 6))) in
    (34 <= K)%nat ->
  ...
  Proof.
    ...
    iPoseProof (pki_254 with "Htext") as "Hi254".
    iPoseProof (pki_258 with "Htext") as "Hi258".
    iPoseProof (pki_25c with "Htext") as "Hi25c".
    iPoseProof (pki_260 with "Htext") as "Hi26a".
    iPoseProof (pki_262 with "Htext") as "Hi26c".
    iPoseProof (pki_264 with "Htext") as "Hi26e".
    iPoseProof (pki_266 with "Htext") as "Hi270".
    iPoseProof (pki_268 with "Htext") as "Hi272".
    iPoseProof (pki_26a with "Htext") as "Hi274".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.printk + 0x258)) a0_idx a0_idx (mword_of_int 3034 : mword 12)
              L1 AV false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi258 [-]").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (L2 := <[Regidx a0_idx := regval_into_reg (add_vec (L1 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 3034 : mword 12)))]> L1).
    ...
    (* +0x25c jal release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x25c)) ra_idx (mword_of_int 1234 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.printk + 0x25c) : mword 64) (sign_extend' 64 (mword_of_int 1234 : mword 21)) = mword_of_int KernelSyms.release) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iDestruct (cpu_own_transport CID3 CID9 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Proof.
    ...
    iDestruct (cpu_own_transport CID0 CIDr (S n) eb pcur C false Hsr with "Hcnt") as "Hcnt".
    ...
    { unfold pk_cs_kept. repeat split.
      ...
      - exact E26.
      - exact E27. }
    iApply (wp_printk_epi (CID0 := CIDr) γpr h m mf K AV n eb C R b pcur
  ...
  Proof.
    ...
    iPoseProof (pk_restore_at_2fe with "Htext") as "Hinstrs".
    iPoseProof (pki_310 with "Htext") as "Hi288".
    iApply (wp_printk_restore mc AV 0x2fe sp0 (m !!! Regidx (mword_of_int 9 : mword 5)) (m !!! Regidx (mword_of_int 19 : mword 5)) (m !!! Regidx (mword_of_int 20 : mword 5)) (m !!! Regidx (mword_of_int 21 : mword 5)) (m !!! Regidx (mword_of_int 22 : mword 5)) (m !!! Regidx (mword_of_int 23 : mword 5)) (m !!! Regidx (mword_of_int 24 : mword 5)) (m !!! Regidx (mword_of_int 26 : mword 5)) (m !!! Regidx (mword_of_int 27 : mword 5)) false pcur Hsp
              with "Hcg Hinstrs Hpc Hsv [-]").
    iIntros (CIDr Hsr mf) "%Hpost Hcg Hpc Hsv".
    assert (Hhr : (CIDr : CPU) = h)
  ...
  Proof.
    ...
    iPoseProof (pki_2a with "Htext") as "Hi28".
    iPoseProof (pki_2e with "Htext") as "Hi2c".
    iPoseProof (pki_32 with "Htext") as "Hi30".
    iPoseProof (pki_36 with "Htext") as "Hi34".
    iPoseProof (pki_3a with "Htext") as "Hi38".
    iPoseProof (pki_3c with "Htext") as "Hi3a".
    iPoseProof (pki_3e with "Htext") as "Hi3c".
    iPoseProof (pki_40 with "Htext") as "Hi3e".
    iPoseProof (pki_42 with "Htext") as "Hi40".
    iPoseProof (pki_44 with "Htext") as "Hi42".
    iPoseProof (pki_46 with "Htext") as "Hi44".
    iPoseProof (pki_48 with "Htext") as "Hi46".
    iPoseProof (pki_4a with "Htext") as "Hi48".
    iPoseProof (pki_4c with "Htext") as "Hi4a".
    iPoseProof (pki_4e with "Htext") as "Hi4c".
    iPoseProof (pki_52 with "Htext") as "Hi50".
    iPoseProof (pki_56 with "Htext") as "Hi54".
    iPoseProof (pki_5a with "Htext") as "Hi58".
    iPoseProof (pki_5e with "Htext") as "Hi5c".
    iPoseProof (pki_60 with "Htext") as "Hi5e".
    iPoseProof (pki_64 with "Htext") as "Hi62".
    ...
    iApply (wp_sd_s_sconf (mword_of_int (KernelSyms.printk + 0x2e)) a5_idx s0_idx (mword_of_int 3976 : mword 12)
              Q3 K w23 false with "Hcg Hpc Hi2c [Hap] [-]").
    ...
    { rgne. rewrite HQ3s2 pa_add_0.
      replace (sign_extend' 64 (mword_of_int 0 : mword 12)) with (mword_of_int 0 : mword 64)
        by (apply bv_eq; vm_compute; reflexivity).
      apply kv_addv_zero. }
    iApply (wp_lbu_s_sconf (mword_of_int (KernelSyms.printk + 0x32)) a0_idx s2_idx (mword_of_int 0 : mword 12)
    ...
    - (* ---- f = "" : straight to the epilogue ---- *)
      ...
      iDestruct (cpu_own_transport CID0 CID7 (S n) eb pcur C false Hcc7 with "Hcnt") as "Hcnt".
      iDestruct (wp_next_retarget CID0 CID7 b pcur _ ltac:(intros _; exact (Hcc7 (or_introl eq_refl))) with "Kend") as "Kend".
      iApply (wp_printk_epi (CID0 := CID7) γpr h m Q4 KE K n eb C (fmt ↦ₛ{ dqf } f ∗ R)%I b pcur
    ...
    - (* ---- f nonempty : the lazy saves, the constants, and into the loop ---- *)
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x3a)) (mword_of_int 13 : mword 6) (mword_of_int 9 : mword 5)
                Q4 K w11 false with "Hcg Hpc Hi38 [S9] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x3c)) (mword_of_int 11 : mword 6) (mword_of_int 19 : mword 5)
                Q4 K w13 false with "Hcg Hpc Hi3a [S19] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x3e)) (mword_of_int 10 : mword 6) (mword_of_int 20 : mword 5)
                Q4 K w14 false with "Hcg Hpc Hi3c [S20] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x40)) (mword_of_int 9 : mword 6) (mword_of_int 21 : mword 5)
                Q4 K w15 false with "Hcg Hpc Hi3e [S21] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x42)) (mword_of_int 8 : mword 6) (mword_of_int 22 : mword 5)
                Q4 K w16 false with "Hcg Hpc Hi40 [S22] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x44)) (mword_of_int 7 : mword 6) (mword_of_int 23 : mword 5)
                Q4 K w17 false with "Hcg Hpc Hi42 [S23] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x46)) (mword_of_int 6 : mword 6) (mword_of_int 24 : mword 5)
                Q4 K w18 false with "Hcg Hpc Hi44 [S24] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x48)) (mword_of_int 4 : mword 6) (mword_of_int 26 : mword 5)
                Q4 K w20 false with "Hcg Hpc Hi46 [S26] [-]").
      ...
      iApply (wp_csdsp_s_sconf (mword_of_int (KernelSyms.printk + 0x4a)) (mword_of_int 3 : mword 6) (mword_of_int 27 : mword 5)
                Q4 K w21 false with "Hcg Hpc Hi48 [S27] [-]").
      ...
      iDestruct (cpu_own_transport CID0 CID23 (S n) eb pcur C false Hcc23 with "Hcnt") as "Hcnt".
  ...
  Proof.
    ...
    iPoseProof (pki_6c with "Htext") as "Hi78".
    iPoseProof (pki_6e with "Htext") as "Hi7a".
    iPoseProof (pki_70 with "Htext") as "Hi7c".
    iPoseProof (pki_72 with "Htext") as "Hi7e".
    iPoseProof (pki_76 with "Htext") as "Hi82".
    ...
    { rgne. rewrite HA3s1.
      replace (sign_extend' 64 (mword_of_int 0 : mword 12)) with (mword_of_int 0 : mword 64)
        by (apply bv_eq; vm_compute; reflexivity).
      apply kv_addv_zero. }
    iApply (wp_lbu_s_sconf (mword_of_int (KernelSyms.printk + 0x72)) a0_idx (mword_of_int 9 : mword 5) (mword_of_int 0 : mword 12)
  ...
  Hypothesis wp_consputc :
    forall `{CID0 : CpuId} (γl : gname) (γd : uart_names) (γv : disk_names) (m0 : regfile) (K : nat)
      (l : list (bv 8)) (n : nat) (eb : bool) (C : iProp Σ) (b : bool) (pcur : mword 64),
      wp_consputc_sconf_body γl γd γv m0 K l n eb C b pcur.

  Lemma wp_printk_char `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
      (mc : regfile) (K : nat) (l : list (bv 8)) (n : nat) (eb : bool)
      (C : iProp Σ) (γl : gname) (Rest : iProp Σ) (b : bool) (pcur : mword 64) :
    (16 <= K)%nat ->
    (Z.of_nat n + 1 < 2 ^ 31)%Z ->
  ...
  Proof.
    ...
    (* +0x72 jal consputc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x66)) ra_idx (mword_of_int 2096410 : mword 21)
              mc K b ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi72 [-]").
    iIntros (CID2 Hst2) "Hcg Hpc".
    set (P1 := <[Regidx ra_idx := regval_into_reg (add_vec_int (mword_of_int (KernelSyms.printk + 0x66) : mword 64) 4)]> mc).
    assert (Htgtc : add_vec (mword_of_int (KernelSyms.printk + 0x66) : mword 64) (sign_extend' 64 (mword_of_int 2096410 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID2 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID2) γl γd γv P1 K l n eb C b pcur HK6 Hn31
  ...
  Hypothesis wp_printint :
    forall `{CID0 : CpuId} (γl : gname) (γd : uart_names) (γv : disk_names) (m0 : regfile) (K : nat)
      (l : list (bv 8)) (n : nat) (eb : bool) (C : iProp Σ) (b : bool) (pcur : mword 64),
      wp_printint_sconf_body γl γd γv m0 K l n eb C b pcur.
  ...
  Lemma wp_printk_arm_d `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 s0v HK Hk Hn31 Hs0 Hs6.
    ...
    iPoseProof (pki_d4 with "Htext") as "Hie0".
    iPoseProof (pki_d6 with "Htext") as "Hie2".
    iPoseProof (pki_d8 with "Htext") as "Hie4".
    iPoseProof (pki_da with "Htext") as "Hie6".
    iPoseProof (pki_de with "Htext") as "Hiea".
    assert (Hap23 : add_vec (rget mc s0_idx) (sign_extend' 64 (mword_of_int 3976 : mword 12)) = pa_stk sp0 23).
    ...
    iApply (wp_printint (CID0 := CID7) γl γd γv D6 K l n eb C b pcur HK14 HD6a1 Hn31
    ...
    iDestruct (cpu_own_transport CID0 CID9 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iSpecialize ("Hcont" $! CID9 with "[%]"); [wp_next_chain|].
  ...
  Lemma wp_printk_arm_ld `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 s0v HK Hk Hi31 Hn31 Hs0 Hs6 Hs4.
    assert (HK14 : (24 <= K)%nat) by lia.
    iIntros "Hcg #Htext #Hkdata Hpc Hap Hva Hcnt #Hpan #Hdev #Hsub #Htxl HR Hcont".
    ...
    { rewrite /S3 upd_ne; [| reg_neq]. rewrite HS2a1.
      rewrite (uint_moi_small 10 ltac:(change (2^64) with 18446744073709551616; lia)). lia. }
    iDestruct (cpu_own_transport CID0 CID4 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_printint (CID0 := CID4) γl γd γv S3 K l n eb C b pcur HK14 HS3a1 Hn31
              with "Hcg Hcnt Htext Hkdata Hpc Hpan Hdev Htxl Hsub [-]").
  ...
  Proof.
    ...
    iApply (wp_printint (CID0 := CID3) γl γd γv S3 K l n eb C b pcur HK14 HS3a1 Hn31
              with "Hcg Hcnt Htext Hkdata Hpc Hpan Hdev Htxl Hsub [-]").
    ...
    iEval (rewrite Htgt78) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID6 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Proof.
    ...
    iDestruct (cpu_own_transport CID0 CID3 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_printint (CID0 := CID3) γl γd γv S2 K l n eb C b pcur HK14 HS2a1 Hn31
              with "Hcg Hcnt Htext Hkdata Hpc Hpan Hdev Htxl Hsub [-]").
    iIntros (CID4 Hst4 mf bs) "Hcg Hcnt Hpc %Hcs #Hsent".
    iDestruct (cpu_own_transport CID4 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    destruct Hcs as [Hcs Hra].
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x1fc)) ra_idx (mword_of_int 2096004 : mword 21)
    ...
    assert (Htgtc : add_vec (mword_of_int (KernelSyms.printk + 0x1fc) : mword 64) (sign_extend' 64 (mword_of_int 2096004 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID2 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID2) γl γd γv C2 K l n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsub [-]").
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x23c)) ra_idx (mword_of_int 2095940 : mword 21)
    ...
    assert (Htgtc : add_vec (mword_of_int (KernelSyms.printk + 0x23c) : mword 64) (sign_extend' 64 (mword_of_int 2095940 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID2 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID2) γl γd γv P2 K l n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsub [-]").
    iIntros (CID3 Hst3 mf bs) "Hcg Hcnt Hpc %Hcs #Hsent".
    iDestruct (cpu_own_transport CID3 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    destruct Hcs as [Hcs Hra].
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x2f2)) ra_idx (mword_of_int 2095758 : mword 21)
    ...
    assert (Htgtc1 : add_vec (mword_of_int (KernelSyms.printk + 0x2f2) : mword 64) (sign_extend' 64 (mword_of_int 2095758 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc1) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID2 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID2) γl γd γv U2 K l n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsub [-]").
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x2f8)) ra_idx (mword_of_int 2095752 : mword 21)
    ...
    assert (Htgtc2 : add_vec (mword_of_int (KernelSyms.printk + 0x2f8) : mword 64) (sign_extend' 64 (mword_of_int 2095752 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc2) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID5 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID5) γl γd γv U4 K (l ++ bs1)%list n eb C b pcur HK6 Hn31
  ...
  Lemma wp_printk_str_loop (γd : uart_names) (γv : disk_names)
      ...
      (s : string) (sv : mword 64) (b : bool) (pcur : mword 64) :
    (16 <= K)%nat ->
    (Z.of_nat n + 1 < 2 ^ 31)%Z ->
    nonul s = true ->
  ...
  Proof.
    ...
    (* +0x22a jal consputc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x21e)) ra_idx (mword_of_int 2095970 : mword 21)
              mc K b ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    assert (Htgtc : add_vec (mword_of_int (KernelSyms.printk + 0x21e) : mword 64) (sign_extend' 64 (mword_of_int 2095970 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID1 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID1) γl γd γv L1 K l n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsub [-]").
    ...
    - (* the terminator: fall through to the [j] at 0x236 *)
      ...
      iEval (rewrite Htgt78) in "Hpc".
      iDestruct (cpu_own_transport CID0 CID6b n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Lemma wp_printk_arm_s `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 s0v HK Hk Hn31 Hnonul Hnn Hs0.
    ...
    - assert (Hne : eq_vec (S2 !!! Regidx a0_idx) zero_reg = false).
      ...
      iDestruct (cpu_own_transport CID0 CID4 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iApply (wp_printk_str_loop γd γv K n eb C γl dq s (pk_vararg m k) b pcur
    ...
    - (* s = "" : straight back to the loop head at 0x78 *)
      ...
      iDestruct (cpu_own_transport CID0 CID4b n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Lemma wp_printk_arm_s_null `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 s0v HK Hk Hn31 Hnull Hs0.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.printk + 0x230)) (mword_of_int 20 : mword 5)
              (mword_of_int 20 : mword 5) (mword_of_int 2258 : mword 12) N2 K b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [-]").
    ...
    set (N3 := <[Regidx (mword_of_int 20 : mword 5) := regval_into_reg
                   (add_vec (N2 !!! Regidx (mword_of_int 20 : mword 5))
                      (sign_extend' 64 (mword_of_int 2258 : mword 12)))]> N2).
    ...
    iEval (rewrite Htgth) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID6 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_printk_str_loop γd γv K n eb C γl DfracDiscarded "(null)"%string
    ...
    iDestruct (cpu_own_transport CID7 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iDestruct (cpu_own_transport CID0 CID7 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iSpecialize ("Hcont" $! CID7 with "[%]"); [wp_next_chain|].
    iApply ("Hcont" $! mf bs with "[%] Hcg Hpc Hap Hva Hcnt Hpan Hsent HR").
    intros c Hc N20. rewrite (Hkept2 c Hc N20). exact (Hkept c Hc N20).
  ...
  Lemma wp_printk_hex_loop (γd : uart_names) (γv : disk_names)
      (K : nat) (n : nat) (eb : bool) (C : iProp Σ) (γl : gname) (dg : mword 64) (b : bool) (pcur : mword 64) :
    (16 <= K)%nat ->
    (Z.of_nat n + 1 < 2 ^ 31)%Z ->
  ...
  Proof.
    intros HK Hn31.
    assert (HK6 : (16 <= K)%nat) by lia.
    induction q as [|q IH]; intros CID0 mc l Rest Hn Hs4 Hs9; [lia | ].
    ...
    (* +0x1ea jal consputc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x1de)) ra_idx (mword_of_int 2096034 : mword 21)
    ...
    assert (Htgtc : add_vec (mword_of_int (KernelSyms.printk + 0x1de) : mword 64) (sign_extend' 64 (mword_of_int 2096034 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID4 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID4) γl γd γv P4 K l n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsub [-]").
    ...
    - (* the sixteenth: fall through to the s9 restore *)
      ...
      iDestruct (cpu_own_transport CID0 CID8 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    - (* another nibble: back to 0x1e0 with the counter one lower *)
      ...
      iDestruct (wp_next_shift Hshift with "Hcont") as "Hcont".
      iDestruct (cpu_own_transport CID0 CID8b n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      ...
      iDestruct (cpu_own_transport CID9 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iEval (rewrite -app_assoc) in "Hsent2".
      iDestruct (cpu_own_transport CID0 CID9 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iSpecialize ("Hcont" $! CID9 with "[%]"); [wp_next_chain|].
  ...
  Lemma wp_printk_arm_p `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 spd s0v HK Hk Hn31 Hsp Hs0.
    assert (HK6 : (16 <= K)%nat) by lia.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x1be)) ra_idx (mword_of_int 2096066 : mword 21)
    ...
    assert (Htgtc1 : add_vec (mword_of_int (KernelSyms.printk + 0x1be) : mword 64) (sign_extend' 64 (mword_of_int 2096066 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc1) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID4 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID4) γl γd γv Q3 K l n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsub [-]").
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x1c6)) ra_idx (mword_of_int 2096058 : mword 21)
    ...
    assert (Htgtc2 : add_vec (mword_of_int (KernelSyms.printk + 0x1c6) : mword 64) (sign_extend' 64 (mword_of_int 2096058 : mword 21)) = mword_of_int KernelSyms.consputc) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtc2) in "Hpc".
    iDestruct (cpu_own_transport CID0 CID7 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_consputc (CID0 := CID7) γl γd γv Q5 K (l ++ bs1)%list n eb C b pcur HK6 Hn31
              with "Hcg Hcnt Htext Hpc Hpan Hdev Htxl Hsent1 [-]").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.printk + 0x1d0)) (mword_of_int 25 : mword 5)
              (mword_of_int 25 : mword 5) (mword_of_int 90 : mword 12) Q7 K b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] [-]").
    ...
    set (Q8 := <[Regidx (mword_of_int 25 : mword 5) := regval_into_reg
                   (add_vec (Q7 !!! Regidx (mword_of_int 25 : mword 5))
                      (sign_extend' 64 (mword_of_int 90 : mword 12)))]> Q7).
    ...
    (* the sixteen nibbles *)
    iDestruct (cpu_own_transport CID0 CID11 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (wp_printk_hex_loop γd γv K n eb C γl (mword_of_int pk_digits_addr : mword 64) b pcur
    ...
    iDestruct (cpu_own_transport CID12 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    iDestruct (cpu_own_transport CID0 CID14 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Lemma wp_printk_arm_num `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
      (m mc : regfile) (K : nat) (k i : nat) (l : list (bv 8)) (n : nat) (eb : bool)
      (C : iProp Σ) (γl : gname) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) (b : bool) (pcur : mword 64) :
    let sp0 := m !!! Regidx csp_rs1 in
    let spd := add_vec sp0 (sign_extend' 64 (caddi16sp_imm (mword_of_int 52 : mword 6))) in
    let s0v := add_vec sp0 (sign_extend' 64 (mword_of_int (-64) : mword 12)) in
    (24 <= K)%nat ->
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 spd s0v HK Hk Hi31 Hn31 Hnum Hsp Hs0 Hs6 Hs4 Hs1.
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0xc8) by (unfold pk_entry; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      ...
      iApply (wp_printk_arm_d γd γv m mc K k l n eb C γl
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur HK Hk Hn31 Hs0 Hs6
      ...
      iDestruct (cpu_own_transport CIDn1 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDn1 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    { (* the long forms: one more character, maybe two.  [pk_dir] tests c0
      ...
      { assert (Hent : pk_entry c0 c1 c2 = 0xac)
        ...
        iEval (rewrite Hent) in "Hpc".
        iApply (wp_printk_arm_ld γd γv m mc K k i l n eb C γl
                  ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                  HK Hk ltac:(lia) Hn31 Hs0 Hs6 Hs4
                  with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
        iIntros (CIDn2 Hstn2 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
        iDestruct (cpu_own_transport CIDn2 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        iDestruct (cpu_own_transport CID0 CIDn2 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      ...
      { assert (Hu1 : Ascii.eqb c1 "u"%char = false)
        ...
        { assert (Hent : pk_entry c0 c1 c2 = 0xea)
          ...
          assert (Hsnd : snd (pk_dir c0 c1 c2) = 2%nat)
            by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
          iEval (rewrite Hent) in "Hpc".
          iApply (wp_printk_arm_lld γd γv m mc K k i l n eb C γl
                    ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                    HK Hk ltac:(lia) Hn31 Hs0 Hs6 Hs4
                    with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
          iIntros (CIDn3 Hstn3 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
          iDestruct (cpu_own_transport CIDn3 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
          iDestruct (cpu_own_transport CID0 CIDn3 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        ...
        { assert (Hent : pk_entry c0 c1 c2 = 0x13c)
          ...
          assert (Hsnd : snd (pk_dir c0 c1 c2) = 2%nat)
            by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
          iEval (rewrite Hent) in "Hpc".
          iApply (wp_printk_arm_llu γd γv m mc K k i l n eb C γl
                    ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                    HK Hk ltac:(lia) Hn31 Hs0 Hs6 Hs4
                    with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
          iIntros (CIDn4 Hstn4 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
          iDestruct (cpu_own_transport CIDn4 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
          iDestruct (cpu_own_transport CID0 CIDn4 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        ...
        { assert (Hent : pk_entry c0 c1 c2 = 0x18c)
          ...
          assert (Hsnd : snd (pk_dir c0 c1 c2) = 2%nat)
            by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
          iEval (rewrite Hent) in "Hpc".
          iApply (wp_printk_arm_llx γd γv m mc K k i l n eb C γl
                    ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                    HK Hk ltac:(lia) Hn31 Hs0 Hs6 Hs4
                    with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
          iIntros (CIDn5 Hstn5 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
          iDestruct (cpu_own_transport CIDn5 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
          iDestruct (cpu_own_transport CID0 CIDn5 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      ...
      { assert (Hent : pk_entry c0 c1 c2 = 0x120)
        ...
        assert (Hsnd : snd (pk_dir c0 c1 c2) = 1%nat)
          by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
        iEval (rewrite Hent) in "Hpc".
        iApply (wp_printk_arm_lu γd γv m mc K k i l n eb C γl
                  ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                  HK Hk ltac:(lia) Hn31 Hs0 Hs6 Hs4
                  with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
        iIntros (CIDn6 Hstn6 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
        iDestruct (cpu_own_transport CIDn6 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        iDestruct (cpu_own_transport CID0 CIDn6 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      ...
      { assert (Hent : pk_entry c0 c1 c2 = 0x172)
        ...
        assert (Hsnd : snd (pk_dir c0 c1 c2) = 1%nat)
          by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
        iEval (rewrite Hent) in "Hpc".
        iApply (wp_printk_arm_lx γd γv m mc K k i l n eb C γl
                  ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                  HK Hk ltac:(lia) Hn31 Hs0 Hs6 Hs4
                  with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
        iIntros (CIDn7 Hstn7 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
        iDestruct (cpu_own_transport CIDn7 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        iDestruct (cpu_own_transport CID0 CIDn7 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x106)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_u γd γv m mc K k l n eb C γl
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur HK Hk Hn31 Hs0 Hs6
                with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
      iIntros (CIDn8 Hstn8 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
      iDestruct (cpu_own_transport CIDn8 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDn8 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x158)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_x γd γv m mc K k l n eb C γl
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur HK Hk Hn31 Hs0 Hs6
                with "Hcg Htext Hkdata Hpc Hap Hva Hcnt Hpan Hdev Hsub Htxl [$S19 $HR] [-]").
      iIntros (CIDn9 Hstn9 mf bs) "%Hcs Hcg Hpc Hap Hva Hcnt _ #Hsent (S19 & HR)".
      iDestruct (cpu_own_transport CIDn9 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDn9 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x1a8)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_p γd γv m mc K k l n eb C γl Rest b pcur
                HK16 Hk Hn31 Hsp Hs0
      ...
      iDestruct (cpu_own_transport CIDn10 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDn10 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x1ee)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_c γd γv m mc K k l n eb C γl
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur HK16 Hk Hn31 Hs0
      ...
      iDestruct (cpu_own_transport CIDn11 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDn11 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Lemma wp_printk_arm_str `{CID0 : CpuId} (γd : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang).
  Proof.
    intros sp0 s0v HK Hk Hn31 Hstr Hkind Hs0 Hs1.
    ...
    - (* PkANull: the "(null)" literal *)
      ...
      iApply (wp_printk_arm_s_null γd γv m mc K k l n eb C γl
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                HK Hk Hn31 Hnull Hs0
      ...
      iDestruct (cpu_own_transport CIDs1 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDs1 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    - (* PkAStr: a real string *)
      ...
      iApply (wp_printk_arm_s γd γv m mc K k l n eb C γl dq str
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I b pcur
                HK Hk Hn31 Hnn Hnz Hs0
      ...
      iDestruct (cpu_own_transport CIDs2 CID0 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      iDestruct (cpu_own_transport CID0 CIDs2 n eb pcur C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Proof.
    ...
    - assert (Hent : pk_entry c0 c1 c2 = 0x23a)
      ...
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_pct γd γv mc K l n eb C γl Rest b pcur HK Hn31
    ...
    - assert (Hent : pk_entry c0 c1 c2 = 0x2ee)
      ...
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_unknown γd γv mc K l n eb C γl Rest b pcur HK Hn31
                with "Hcg Htext Hpc Hcnt Hpan Hdev Hsub Htxl HR [-]").
  ...
  Section PrintkLoop.
    ...
    Proof using All.
      ...
      - (* '%': the bne falls through into the dispatch *)
        ...
        iDestruct (cpu_own_transport CID0 CIDbne (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        iApply (wp_printk_dispatch (CID0 := CIDbne) mq K fmtv dqf f i
                  (([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   cpu_own (S n) eb pcur C false ∗ pk_held γpr hh n eb pcur ∗ pk_loop_frame k ∗
        ...
        iDestruct (cpu_own_transport CIDbne CID0 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        ...
        + (* c0 = NUL: the format string is over -- leave through 0x276 *)
          ...
          iDestruct (cpu_own_transport CID0 CIDdisp (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
          ...
          iApply (wp_printk_exit2fe (CID0 := CIDdisp) γpr hh m mf KE K n eb C
                    (fmtv ↦ₛ{ dqf } f ∗
                     ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d))%I bo pcur
        ...
        + (* a real directive *)
          ...
          * (* a NUMBER directive *)
            rewrite Hfst in Hstep. cbn [pk_cons] in Hstep.
               ...
               iDestruct (cpu_own_transport CID0 CIDdisp (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
               iApply (wp_printk_arm_num (CID0 := CIDdisp) γd γv m mf K k i l (S n) eb C γl c0 c1 c2
                         (fmtv ↦ₛ{ dqf } f ∗
                          ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                          (pa_stk sp0 9) ↦₈ (m !!! Regidx ra_idx) ∗
                          (pa_stk sp0 10) ↦₈ (m !!! Regidx s0_idx) ∗
                          ...
                          (∃ w : mword 64, (pa_stk sp0 22) ↦₈ w) ∗
                          (∃ w : mword 64, (pa_stk sp0 24) ↦₈ w) ∗
                          pk_loop_head (CID0 := CID0) i l)%I false pcur
                         HK Hk7 Hi33 Hn31Sn Hfst Hfsp Hfs0 Hf22 Hf20 Hs1f
               ...
               iDestruct (cpu_own_transport CIDarm CID0 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
               ...
               iDestruct (cpu_own_transport CID0 CIDarm (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
          ...
          * (* the STRING directive *)
            rewrite Hfst in Hstep. cbn [pk_cons] in Hstep.
               ...
               iDestruct (cpu_own_transport CID0 CIDdisp (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
               iApply (wp_printk_arm_str (CID0 := CIDdisp) γd γv m mf K k i l (S n) eb C γl c0 c1 c2 d0
                         (fmtv ↦ₛ{ dqf } f ∗
                          ...
                          (∃ w : mword 64, (pa_stk sp0 24) ↦₈ w) ∗
                          pk_loop_head (CID0 := CID0) i l)%I false pcur
                         HK16 Hk7 Hn31Sn Hfst Hkd0 Hfs0 Hs1f
               ...
               iDestruct (cpu_own_transport CIDarm2 CID0 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
               destruct Hcs2 as [Hcs2 Hs1g].
               iDestruct ("Hdcl" with "Hdk0") as "Hdescs".
               pose proof (pk_head_regs mf mg Hcs2 Hfsp Hfs0 Hfs2 Hfs9 Hfconsts)
                 as (Hgsp & Hgs0 & Hgs2 & Hgs9 & Hgconsts).
               iEval (rewrite /pk_loop_head) in "Hhead".
               iDestruct (cpu_own_transport CID0 CIDarm2 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
          ...
          * (* '%%' or an unknown directive: no vararg *)
            ...
            iDestruct "Hcont" as "[Hhead _]".
            iDestruct (cpu_own_transport CID0 CIDdisp (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
            iApply (wp_printk_arm_none (CID0 := CIDdisp) γd γv mf K i l (S n) eb C γl c0 c1 c2
                      (fmtv ↦ₛ{ dqf } f ∗
                       ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                       pk_loop_frame k ∗ pk_loop_head (CID0 := CID0) i l)%I false pcur
                      HK16 Hn31Sn Hfst Hc0f Hs1f
            ...
            iDestruct (cpu_own_transport CIDarm3 CID0 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
            destruct Hcs2 as [Hcs2 Hs1g].
            pose proof (pk_head_regs mf mg Hcs2 Hfsp Hfs0 Hfs2 Hfs9 Hfconsts)
              as (Hgsp & Hgs0 & Hgs2 & Hgs9 & Hgconsts).
            iEval (rewrite /pk_loop_head) in "Hhead".
            iDestruct (cpu_own_transport CID0 CIDarm3 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
      ...
      - (* an ordinary character: print it and continue at i *)
        ...
        { rewrite Ha0 Hc19 Hfch. unfold neq_vec.
          ...
          rewrite Hpct. reflexivity. }
        iDestruct "Hcont" as "[Hhead _]".
        iApply (wp_printk_char γd γv mq K l (S n) eb C γl
                  (fmtv ↦ₛ{ dqf } f ∗
                   ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   pk_loop_frame k ∗ pk_loop_head (CID0 := CID0) i l)%I false pcur
                  HK16 Hn31Sn Hne
        ...
        iEval (rewrite /pk_loop_head) in "Hhead".
        iDestruct (cpu_own_transport CID0 CIDchar (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    Proof using All.
      ...
      - (* the string ends here: 0x24e, restore, epilogue *)
        iApply (wp_printk_advance (CID0 := CID0) mq K fmtv dqf f p
                  (([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   cpu_own (S n) eb pcur C false ∗ pk_held γpr hh n eb pcur ∗ pk_loop_frame k ∗ pk_loop_post (CID0 := CID0) l)%I false pcur
                  Hlen1 Hp31 Hs1 Hs2
        ...
        iDestruct "Hfr" as "(H9 & H10 & H12 & Hva & Hsv & S8 & S19 & S22 & Hap & S24)".
        iDestruct (pk_slots_rest_of (pk_ap s0v k) with "Hva S8 S19 S22 Hap S24") as "Hrest".
        iPoseProof (pk_restore_at_242 with "Htext") as "Hres".
        assert (Hnext : mword_of_int (KernelSyms.printk + 0x242 + 18) = (mword_of_int (KernelSyms.printk + 0x254) : mword 64))
          by (apply bv_eq; vm_compute; reflexivity).
        iDestruct (cpu_own_transport CID0 CIDe1 (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
        ...
        iApply (wp_printk_exit (CID0 := CIDe1) γpr hh m mfe KE K 0x242 n eb C
                  (fmtv ↦ₛ{ dqf } f ∗
                   ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d))%I bo pcur
                  HKE HAV Houtb Hhe Hesp Hes9 Hnext
                  with "Hcg Htext Hres Hpc H9 H10 H12 Hsv Hrest Hlk Hheld Hcnt [$Hfmt $Hdescs] [-]").
      ...
      - (* another character: one turn of the body, then round again by IH *)
        ...
        pose proof (pk_head_regs mq mfg (pk_adv_regs mq mfg Hkept) Hsp Hs0 Hs2 Hs9r Hconsts)
          as (Hgsp & Hgs0 & Hgs2 & Hgs9 & Hgconsts).
        iDestruct (cpu_own_transport CID0 CIDadv (S n) eb pcur C false ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
  ...
  Proof using All.
    ...
    intros rai a0i pcE0 ra00 rtgt fmtv0 HK Hflen Hnn Hkinds Hdlen Hn2.
    unfold printk_stack in HK.
    assert (HK24 : (24 <= K)%nat) by lia.
    iIntros "Hcg Hcnt #Htext #Hkdata Hpc #Hpan Hfmt Hdescs #Hlk #Hdev #Htxl #Hsub Hcont".
    iDestruct (cpu_own_eb_agree m0 K n eb p C b with "Hcg Hcnt") as %Houtb.
    ...
    iDestruct (cpu_own_transport CID CIDpro n eb p C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.printk + 0x22)) a0_idx a0_idx (mword_of_int 3600 : mword 12)
              A1 (K - 24)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi22 [-]").
    iIntros (CIDa2 Hsta2) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (A2 := <[Regidx a0_idx := regval_into_reg (add_vec (A1 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 3600 : mword 12)))]> A1).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.printk + 0x26)) ra_idx (mword_of_int 1664 : mword 21)
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.printk + 0x26) : mword 64) (sign_extend' 64 (mword_of_int 1664 : mword 21)) = mword_of_int KernelSyms.acquire) by (apply bv_eq; vm_compute; reflexivity).
    ...
    { rewrite /A3 upd_ne; [| reg_neq]. rewrite /A2 upd_ne; [| reg_neq].
      rewrite /A1 upd_ne; [reflexivity | reg_neq]. }
    iDestruct (cpu_own_transport CIDpro CIDa3 n eb p C b ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    iApply (Acquire.wp_acquire_sconf (CID := CIDa3) γpr "pr"%string (emp : iProp Σ) A3
              n eb p C (K - 24)%nat b ltac:(lia) ltac:(lia)
    ...
    - (* the empty format string: no loop at all, and nothing was printed *)
      iApply (wp_printk_setup (CID0 := CIDacq) γpr ((CIDacq : CPU)) m0 mfin
                ...
                (([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m0 j) d))%I b p
    ...
    - (* a nonempty one: setup, then the loop with the string length as fuel *)
      ...
      iApply (wp_printk_body7a γd γv γpr ((CIDacq : CPU)) γl m0
                (trap_res b + (K - 24))%nat K n eb C dqf f descs b p
                ltac:(lia) eq_refl Houtb ltac:(lia) Hn2 Hflen Hnn Hdlen
...
(* ===================================================================== *)
  Definition wp_printk_sconf `{!riscvGS Σ, !sieG Σ, !lockG Σ} `{!uartGhostG Σ, !diskGhostG Σ} `{GEN : GenId} `{CID : CpuId}
      ...
      : wp_printk_sconf_body γpr γl γd γv m0 K bs n eb C dqf f descs b p :=
    wp_printk_sconf_gen
      (fun `{CID0 : CpuId} γl' γd' γv' m' K' bs' n' eb' C' b' pcur' =>
         Consputc.wp_consputc_sconf (CID:=CID0) γl' γd' γv' m' K' bs' n' eb' C' b' pcur')
      (fun `{CID0 : CpuId} γl' γd' γv' m' K' bs' n' eb' C' b' pcur' =>
         Printint.wp_printint_sconf (CID:=CID0) γl' γd' γv' m' K' bs' n' eb' C' b' pcur')
      γpr γl γd γv m0 K bs n eb C dqf f descs b p.

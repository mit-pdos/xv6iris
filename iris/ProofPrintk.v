...
Section ProofPrintk.
  ...
  Lemma wp_printk_exit (γ : gname) (Φ : mval -> iProp Σ)
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros sp0 spd HK Hpv Hsp Htp Hs9 Hnext.
  ...
  Lemma wp_printk_exit276 (γ : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    (* +0x288 c.j 0x260 *)
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (PK + 0x288))
  ...
  Lemma wp_printk_str_loop (γ : gname) (γd : uart_names) (γv : disk_names) (Φ : mval -> iProp Σ)
    ...
    neq_vec (sign_extend' 64 pkv) zero_reg = false ->
    nonul s = true ->
    forall (fuel i : nat) (mc : regfile) (l : list (bv 8)) (Rest : iProp Σ),
  ...
  Proof.
    ...
    assert (HK6 : (6 <= K - 24)%nat) by lia.
    intro fuel. induction fuel as [|fuel IH]; intros i mc l Rest Hf Hi Hs4; [lia | ].
    iIntros "Hcg #Htext Hpc Hstr Hpanicking Hpanicked #Hdev Htx #Hdlab HR Hcont".
    (* +0x22a jal consputc *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PK + 0x22a)) ra_idx (mword_of_int 2095958 : mword 21)
              mc (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (PK + 0x22e)) (mword_of_int 20 : mword 5) (mword_of_int 1 : mword 6)
              m1 (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    assert (Hlba : add_vec (L2 !!! Regidx (mword_of_int 20 : mword 5))
    ...
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (PK + 0x230)) a0_idx (mword_of_int 20 : mword 5)
              (mword_of_int 0 : mword 12) L2 (K - 24)%nat (pk_fbyte s (S i))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] Hb [-]").
    { iApply (pki_230 with "Htext"). }
    iIntros "Hcg Hpc Hb". iEval (rewrite Hlba) in "Hb".
    ...
    - (* another character: back to the head with the index bumped *)
      ...
      iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (PK + 0x234)) (mword_of_int 251 : mword 8)
                (Cregidx (mword_of_int 2)) a0_idx L3 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate) Hne
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      iApply (IH (S i) L3 (l ++ bs)%list Rest ltac:(lia) Hlt HL3s4
                with "Hcg Htext Hpc Hstr Hpanicking Hpanicked Hdev Htx Hdlab HR [-]").
      iIntros (mf bs2) "%Hkept2 Hcg Hpc Hstr Hpanicking Hpanicked Htx Hsent2 HR".
      iEval (rewrite -app_assoc) in "Htx".
      iEval (rewrite -app_assoc) in "Hsent2".
    ...
    - (* the terminator: fall through to the [j] at 0x236 *)
      ...
      iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0x234)) (mword_of_int 251 : mword 8)
                (Cregidx (mword_of_int 2)) a0_idx L3 (K - 24)%nat
      ...
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (PK + 0x236)) (sign_extend' 21 (concat_vec (mword_of_int 1825 : mword 11) ('b"0")))
                L3 (K - 24)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc [] [-]").
  ...
  Proof.
    ...
    iApply (wp_printk_vaarg γ Φ mc K 0x20e sp0 s0v k Hs0 eq_refl
              with "Hcg [] Hpc Hap [-]").
    { rewrite /pk_vaarg_instrs.
    ...
    iDestruct (pk_va_acc sp0 m k Hk with "Hva") as "[Hslot Hvacl]".
    assert (Hlda : add_vec (V !!! Regidx a5_idx) (sign_extend' 64 (mword_of_int 0 : mword 12)) = pa_stk sp0 (7 - k)).
    { rewrite Hva5.
      replace (sign_extend' 64 (mword_of_int 0 : mword 12)) with (mword_of_int 0 : mword 64)
        by (apply bv_eq; vm_compute; reflexivity).
      rewrite kv_addv_zero. apply pk_ap_slot. exact Hk. }
    iEval (rewrite -Hlda) in "Hslot".
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (PK + 0x21a)) (mword_of_int 20 : mword 5) a5_idx
              (mword_of_int 0 : mword 12) V (K - 24)%nat (pk_vararg m k)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] Hslot [-]").
    ...
    iApply (wp_beqz_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x21e)) (mword_of_int 26 : mword 13)
              (mword_of_int 20 : mword 5) S1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(rewrite HS1s4; exact Hnn)
              with "Hcg Hpc [] [-]").
    ...
    assert (Hlba : add_vec (S1 !!! Regidx (mword_of_int 20 : mword 5))
                     (sign_extend' 64 (mword_of_int 0 : mword 12)) = pa_add (pk_vararg m k) 0).
    { rewrite HS1s4 pa_add_0.
      replace (sign_extend' 64 (mword_of_int 0 : mword 12)) with (mword_of_int 0 : mword 64)
        by (apply bv_eq; vm_compute; reflexivity).
      apply kv_addv_zero. }
    iEval (rewrite -Hlba) in "Hb".
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (PK + 0x222)) a0_idx (mword_of_int 20 : mword 5)
              (mword_of_int 0 : mword 12) S1 (K - 24)%nat (pk_fbyte s 0)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] Hb [-]").
    ...
    - assert (Hne : eq_vec (S2 !!! Regidx a0_idx) zero_reg = false).
      ...
      iApply (wp_beqz_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x226)) (mword_of_int 7762 : mword 13)
                a0_idx S2 (K - 24)%nat ltac:(vm_compute; discriminate) Hne
                with "Hcg Hpc [] [-]").
      ...
      iIntros (mf bs) "%Hkept2 Hcg Hpc Hstr Hpanicking Hpanicked Htx Hsent (Hap & Hva & HR)".
    ...
    - (* s = "" : straight back to the loop head at 0x78 *)
      ...
      iApply (wp_beqz_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x226)) (mword_of_int 7762 : mword 13)
                a0_idx S2 (K - 24)%nat ltac:(vm_compute; discriminate) Hz
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc [] [-]").
      { iApply (pki_226 with "Htext"). }
      iNext. iIntros "Hcg Hpc".
  ...
  Proof.
    ...
    iApply (wp_beqz_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x21e)) (mword_of_int 26 : mword 13)
              (mword_of_int 20 : mword 5) N1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(rewrite HN1s4; vm_compute; reflexivity)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    { iApply (pki_21e with "Htext"). }
    iNext. iIntros "Hcg Hpc".
    ...
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (PK + 0x238)) (mword_of_int 20 : mword 5)
              (mword_of_int 7 : mword 20) N1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x23c)) (mword_of_int 20 : mword 5)
              (mword_of_int 20 : mword 5) (mword_of_int 2260 : mword 12) N2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_li4_s_sconf γ Φ (mword_of_int (PK + 0x240)) a0_idx (mword_of_int 40 : mword 12)
              (mword_of_int 40 : mword 64) N3 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (PK + 0x244)) (sign_extend' 21 (concat_vec (mword_of_int 2035 : mword 11) ('b"0")))
              N4 (K - 24)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iIntros (mf bs) "%Hkept2 Hcg Hpc _ Hpanicking Hpanicked Htx Hsent (Hap & Hva & HR)".
    iApply ("Hcont" $! mf bs with "[%] Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent HR").
    intros c Hc N20. rewrite (Hkept2 c Hc N20). exact (Hkept c Hc N20).
  Qed.
  ...
  Lemma wp_printk_hex_loop (γ : gname) (γd : uart_names) (γv : disk_names) (Φ : mval -> iProp Σ)
    ...
    eq_vec (sign_extend' 64 pv) zero_reg = false ->
    neq_vec (sign_extend' 64 pkv) zero_reg = false ->
    forall (n : nat) (mc : regfile) (l : list (bv 8)) (Rest : iProp Σ),
    (1 <= n <= 16)%nat ->
  ...
  Proof.
    intros HK Hpv Hpkv.
    assert (HK6 : (6 <= K - 24)%nat) by lia.
    induction n as [|n IH]; intros mc l Rest Hn Hs4 Hs9; [lia | ].
    iIntros "Hcg #Htext #Hdig Hpc Hpanicking Hpanicked #Hdev Htx #Hdlab HR Hcont".
    (* +0x1e0 srli a5,s5,0x3c : the top nibble *)
    iApply (wp_srli4_s_sconf γ Φ (mword_of_int (PK + 0x1e0)) a5_idx (mword_of_int 21 : mword 5)
              (mword_of_int 60 : mword 6) mc (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (PK + 0x1e4)) a5_idx (mword_of_int 25 : mword 5)
              P1 (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    assert (Hlba : add_vec (P2 !!! Regidx a5_idx) (sign_extend' 64 (mword_of_int 0 : mword 12))
    ...
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (PK + 0x1e6)) a0_idx a5_idx
              (mword_of_int 0 : mword 12) P2 (K - 24)%nat (dbyte : mword 8)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] Hdb [-]").
    ...
    (* +0x1ea jal consputc *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PK + 0x1ea)) ra_idx (mword_of_int 2096022 : mword 21)
              P3 (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cslli_s_sconf γ Φ (mword_of_int (PK + 0x1ee)) (Regidx (mword_of_int 21 : mword 5))
              (mword_of_int 21 : mword 5) (mword_of_int 4 : mword 6) m1 (K - 24)%nat
    ...
    iApply (wp_caddiw_s_sconf γ Φ (mword_of_int (PK + 0x1f0)) (mword_of_int 20 : mword 5)
              (mword_of_int 63 : mword 6) P5 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - (* the sixteenth: fall through to the s9 restore *)
      ...
      iApply (wp_bnez_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x1f2)) (mword_of_int 8174 : mword 13)
                (mword_of_int 20 : mword 5) P6 (K - 24)%nat
    ...
    - (* another nibble: back to 0x1e0 with the counter one lower *)
      ...
      iApply (wp_bnez_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x1f2)) (mword_of_int 8174 : mword 13)
                (mword_of_int 20 : mword 5) P6 (K - 24)%nat
                ltac:(vm_compute; discriminate) Hne
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc [] [-]").
      { iApply (pki_1f2 with "Htext"). }
      iNext. iIntros "Hcg Hpc".
      ...
      iEval (rewrite Htgth) in "Hpc".
      iApply (IH P6 (l ++ bs)%list Rest ltac:(lia) HP6s4 HP6s9
                with "Hcg Htext Hdig Hpc Hpanicking Hpanicked Hdev Htx Hdlab HR [-]").
      iIntros (mf bs2) "%Hkept2 Hcg Hpc Hpanicking Hpanicked Htx Hsent2 HR".
      iEval (rewrite -app_assoc) in "Htx".
      iEval (rewrite -app_assoc) in "Hsent2".
  ...
  Proof.
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (PK + 0x1b4)) (mword_of_int 5 : mword 6)
              (mword_of_int 25 : mword 5) mc (K - 24)%nat w19
              with "Hcg Hpc [] S19 [-]").
    { iApply (pki_1b4 with "Htext"). }
    iIntros "Hcg Hpc S19". iEval (rewrite Hsp Hb19) in "S19".
    ...
    iApply (wp_printk_vaarg γ Φ mc K 0x1b6 sp0 s0v k Hs0 eq_refl
              with "Hcg [] Hpc Hap [-]").
    { rewrite /pk_vaarg_instrs.
    ...
    { rewrite Hva5.
      ...
      rewrite kv_addv_zero. apply pk_ap_slot. exact Hk. }
    iEval (rewrite -Hlda) in "Hslot".
    iApply (wp_ld_s_sconf γ Φ (mword_of_int (PK + 0x1c2)) (mword_of_int 21 : mword 5) a5_idx
              (mword_of_int 0 : mword 12) V (K - 24)%nat (pk_vararg m k)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] Hslot [-]").
    ...
    iApply (wp_li4_s_sconf γ Φ (mword_of_int (PK + 0x1c6)) a0_idx (mword_of_int 48 : mword 12)
              (mword_of_int 48 : mword 64) Q1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PK + 0x1ca)) ra_idx (mword_of_int 2096054 : mword 21)
              Q2 (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_li4_s_sconf γ Φ (mword_of_int (PK + 0x1ce)) a0_idx (mword_of_int 120 : mword 12)
              (mword_of_int 120 : mword 64) m1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (PK + 0x1d2)) ra_idx (mword_of_int 2096046 : mword 21)
              Q4 (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (PK + 0x1d6)) (mword_of_int 20 : mword 5)
              (mword_of_int 16 : mword 6) (mword_of_int 16 : mword 64) m2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (PK + 0x1d8)) (mword_of_int 25 : mword 5)
              (mword_of_int 7 : mword 20) Q6 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x1dc)) (mword_of_int 25 : mword 5)
              (mword_of_int 25 : mword 5) (mword_of_int 60 : mword 12) Q7 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iIntros (m3 bs3) "%Hkept3 Hcg Hpc Hpanicking Hpanicked Htx #Hsent3 (S19 & Hap & Hva & HR)".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (PK + 0x1f6)) (mword_of_int 5 : mword 6)
              (mword_of_int 25 : mword 5) m3 (K - 24)%nat
              (mc !!! Regidx (mword_of_int 25 : mword 5))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] S19 [-]").
    { iApply (pki_1f6 with "Htext"). }
    iIntros "Hcg Hpc S19". iEval (rewrite Hm3sp Hb19) in "S19".
    ...
    (* +0x1f8 j 0x78 *)
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (PK + 0x1f8)) (sign_extend' 21 (concat_vec (mword_of_int 1856 : mword 11) ('b"0")))
              Q9 (K - 24)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
  ...
  Lemma wp_printk_chain_2fa (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
  ...
  Proof.
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x2fa)) (mword_of_int 7866 : mword 13)
                (mword_of_int 27 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hs5 Hs11 (pk_eq_ascii c0 "p"%char (mword_of_int 112)
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x2fa)) (mword_of_int 7866 : mword 13)
              (mword_of_int 27 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs5 Hs11 (pk_eq_ascii c0 "p"%char (mword_of_int 112)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hp0)
    ...
    iApply (wp_li4_s_sconf γ Φ (mword_of_int (PK + 0x2fe)) a5_idx (mword_of_int 99 : mword 12)
              (mword_of_int 99 : mword 64) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x302)) (mword_of_int 7928 : mword 13)
                a5_idx (mword_of_int 21 : mword 5) C1 (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HC1s5 HC1a5 (pk_eq_ascii c0 "c"%char (mword_of_int 99)
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x302)) (mword_of_int 7928 : mword 13)
              a5_idx (mword_of_int 21 : mword 5) C1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HC1s5 HC1a5 (pk_eq_ascii c0 "c"%char (mword_of_int 99)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hc0)
    ...
    iApply (wp_li4_s_sconf γ Φ (mword_of_int (PK + 0x306)) a5_idx (mword_of_int 115 : mword 12)
              (mword_of_int 115 : mword 64) C1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x30a)) (mword_of_int 7940 : mword 13)
                a5_idx (mword_of_int 21 : mword 5) C2 (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HC2s5 HC2a5 (pk_eq_ascii c0 "s"%char (mword_of_int 115)
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x30a)) (mword_of_int 7940 : mword 13)
              a5_idx (mword_of_int 21 : mword 5) C2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HC2s5 HC2a5 (pk_eq_ascii c0 "s"%char (mword_of_int 115)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hs0)
    ...
    iApply (wp_li4_s_sconf γ Φ (mword_of_int (PK + 0x30e)) a5_idx (mword_of_int 37 : mword 12)
              (mword_of_int 37 : mword 64) C2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x312)) (mword_of_int 7988 : mword 13)
                a5_idx (mword_of_int 21 : mword 5) C3 (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite HC3s5 HC3a5 (pk_eq_ascii c0 "%"%char (mword_of_int 37)
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x312)) (mword_of_int 7988 : mword 13)
              a5_idx (mword_of_int 21 : mword 5) C3 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite HC3s5 HC3a5 (pk_eq_ascii c0 "%"%char (mword_of_int 37)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hm0)
    ...
    - iApply (wp_beqz_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x316)) (mword_of_int 8032 : mword 13)
                (mword_of_int 21 : mword 5) C3 (K - 24)%nat
                ltac:(vm_compute; discriminate)
                ltac:(rewrite HC3s5 (pk_eq_ascii c0 pk_nul (zero_reg : mword 64)
      ...
      iEval (rewrite Ht) in "Hpc".
      iApply ("Hcont" $! C3 with "[%] Hcg Hpc HR"). exact HC3k.
    - iApply (wp_beqz_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x316)) (mword_of_int 8032 : mword 13)
                (mword_of_int 21 : mword 5) C3 (K - 24)%nat
                ltac:(vm_compute; discriminate)
                ltac:(rewrite HC3s5 (pk_eq_ascii c0 pk_nul (zero_reg : mword 64)
                        ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hn0)
  ...
  Lemma wp_printk_chain_2f0 (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    Ascii.eqb c0 "d"%char = false ->
    (Ascii.eqb c0 "l"%char && Ascii.eqb c1 "d"%char)%bool = false ->
    (Ascii.eqb c0 "l"%char && (Ascii.eqb c1 "l"%char && Ascii.eqb c2 "d"%char))%bool = false ->
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2f0)) (mword_of_int 13 : mword 5)
              (mword_of_int 13 : mword 5) (mword_of_int 3976 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - (* c2 = 'x': fall through to the ll test *)
      iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0x2f4)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 5)) (mword_of_int 13 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a3 Hx2; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      + iApply (wp_bnez_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x2f6)) (mword_of_int 7842 : mword 13)
                  a5_idx D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a5 pk_bit_nz; exact Hll)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc [] [-]").
      ...
      + iApply (wp_bnez_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x2f6)) (mword_of_int 7842 : mword 13)
                  a5_idx D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a5 pk_bit_nz; exact Hll)
                  with "Hcg Hpc [] [-]").
        { iApply (pki_2f6 with "Htext"). }
  ...
  Lemma wp_printk_chain_2e2 (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    Ascii.eqb c0 "d"%char = false ->
    (Ascii.eqb c0 "l"%char && Ascii.eqb c1 "d"%char)%bool = false ->
    (Ascii.eqb c0 "l"%char && (Ascii.eqb c1 "l"%char && Ascii.eqb c2 "d"%char))%bool = false ->
  ...
  Proof.
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x2e2)) (mword_of_int 7810 : mword 13)
                (mword_of_int 26 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hs5 Hs10 (pk_eq_ascii c0 "x"%char (mword_of_int 120)
      ...
      iEval (rewrite Ht) in "Hpc".
      iApply ("Hcont" $! mq with "[%] Hcg Hpc HR"). exact Hid. }
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x2e2)) (mword_of_int 7810 : mword 13)
              (mword_of_int 26 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs5 Hs10 (pk_eq_ascii c0 "x"%char (mword_of_int 120)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hx0)
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2e6)) (mword_of_int 12 : mword 5)
              (mword_of_int 12 : mword 5) (mword_of_int 3976 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0x2ea)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 4)) (mword_of_int 12 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a2 Hx1; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      + iApply (wp_bnez_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x2ec)) (mword_of_int 7826 : mword 13)
                  (mword_of_int 14 : mword 5) D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a4 pk_bit_nz; exact Hl0)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc [] [-]").
        ...
        iEval (rewrite Ht) in "Hpc".
        iApply ("Hcont" $! D1 with "[%] Hcg Hpc HR"). exact HD1k.
      + iApply (wp_bnez_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x2ec)) (mword_of_int 7826 : mword 13)
                  (mword_of_int 14 : mword 5) D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a4 pk_bit_nz; exact Hl0)
                  with "Hcg Hpc [] [-]").
        { iApply (pki_2ec with "Htext"). }
        ...
        iApply (wp_printk_chain_2f0 γ Φ D1 K c0 c1 c2 Rest E1 E2 E3 E4 E5 E6 Hx0
                  ltac:(rewrite Hl0; reflexivity) HD1s5 HD1s11 HD1a3 HD1a5
                  with "Hcg Htext Hpc HR [-]").
        iIntros (mf) "%Hk Hcg Hpc HR".
        iApply ("Hcont" $! mf with "[%] Hcg Hpc HR").
        exact (pk_chain_kept_trans mf D1 mq Hk HD1k).
    - iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (PK + 0x2ea)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 4)) (mword_of_int 12 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a2 Hx1; reflexivity)
                ltac:(vm_compute; reflexivity)
  ...
  Lemma wp_printk_chain_2d8 (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    Ascii.eqb c0 "d"%char = false ->
    (Ascii.eqb c0 "l"%char && Ascii.eqb c1 "d"%char)%bool = false ->
    (Ascii.eqb c0 "l"%char && (Ascii.eqb c1 "l"%char && Ascii.eqb c2 "d"%char))%bool = false ->
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2d8)) (mword_of_int 11 : mword 5)
              (mword_of_int 13 : mword 5) (mword_of_int 3979 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0x2dc)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 3)) (mword_of_int 11 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a1 Hu2; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      case_eq (Ascii.eqb c1 "l"%char && Ascii.eqb c0 "l"%char)%bool; intro Hll.
      + iApply (wp_bnez_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x2de)) (mword_of_int 7786 : mword 13)
                  a5_idx D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a5 pk_bit_nz; exact Hll)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc [] [-]").
        ...
        iEval (rewrite Ht) in "Hpc".
        iApply ("Hcont" $! D1 with "[%] Hcg Hpc HR"). exact HD1k.
      + iApply (wp_bnez_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x2de)) (mword_of_int 7786 : mword 13)
                  a5_idx D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a5 pk_bit_nz; exact Hll)
                  with "Hcg Hpc [] [-]").
        { iApply (pki_2de with "Htext"). }
        ...
        iApply (wp_printk_chain_2e2 γ Φ D1 K c0 c1 c2 Rest E1 E2 E3 E4 E5
        ...
        iApply ("Hcont" $! mf with "[%] Hcg Hpc HR").
        exact (pk_chain_kept_trans mf D1 mq Hk HD1k).
    - iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (PK + 0x2dc)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 3)) (mword_of_int 11 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a1 Hu2; reflexivity)
                ltac:(vm_compute; reflexivity)
  ...
  Lemma wp_printk_chain_2ca (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    Ascii.eqb c0 "d"%char = false ->
    (Ascii.eqb c0 "l"%char && Ascii.eqb c1 "d"%char)%bool = false ->
    (Ascii.eqb c0 "l"%char && (Ascii.eqb c1 "l"%char && Ascii.eqb c2 "d"%char))%bool = false ->
  ...
  Proof.
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x2ca)) (mword_of_int 7752 : mword 13)
                (mword_of_int 24 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hs5 Hs8 (pk_eq_ascii c0 "u"%char (mword_of_int 117)
      ...
      iEval (rewrite Ht) in "Hpc".
      iApply ("Hcont" $! mq with "[%] Hcg Hpc HR"). exact Hid. }
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x2ca)) (mword_of_int 7752 : mword 13)
              (mword_of_int 24 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs5 Hs8 (pk_eq_ascii c0 "u"%char (mword_of_int 117)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hu0)
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2ce)) (mword_of_int 11 : mword 5)
              (mword_of_int 12 : mword 5) (mword_of_int 3979 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0x2d2)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 3)) (mword_of_int 11 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a1 Hu1; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      case_eq (Ascii.eqb c0 "l"%char); intro Hl0.
      + iApply (wp_bnez_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x2d4)) (mword_of_int 7768 : mword 13)
                  (mword_of_int 14 : mword 5) D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a4 pk_bit_nz; exact Hl0)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc [] [-]").
        ...
        iEval (rewrite Ht) in "Hpc".
        iApply ("Hcont" $! D1 with "[%] Hcg Hpc HR"). exact HD1k.
      + iApply (wp_bnez_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x2d4)) (mword_of_int 7768 : mword 13)
                  (mword_of_int 14 : mword 5) D1 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD1a4 pk_bit_nz; exact Hl0)
                  with "Hcg Hpc [] [-]").
        { iApply (pki_2d4 with "Htext"). }
        ...
        iApply (wp_printk_chain_2d8 γ Φ D1 K c0 c1 c2 Rest E1 E2 E3 Hu0
        ...
        iApply ("Hcont" $! mf with "[%] Hcg Hpc HR").
        exact (pk_chain_kept_trans mf D1 mq Hk HD1k).
    - iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (PK + 0x2d2)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 3)) (mword_of_int 11 : mword 5) D1 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD1a1 Hu1; reflexivity)
                ltac:(vm_compute; reflexivity)
  ...
  Lemma wp_printk_chain_2b6 (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    Ascii.eqb c0 "d"%char = false ->
    (Ascii.eqb c0 "l"%char && Ascii.eqb c1 "d"%char)%bool = false ->
    mq !!! Regidx (mword_of_int 21 : mword 5) = zero_extend' 64 (pk_byte c0) ->
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2b6)) a5_idx
              (mword_of_int 12 : mword 5) (mword_of_int 3988 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_sltiu_s_sconf γ Φ (mword_of_int (PK + 0x2ba)) a5_idx a5_idx
              (mword_of_int 1 : mword 12) (pk_bit (Ascii.eqb c1 "l"%char)) D1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite /pk_bit (ltu1_eqz (D1 !!! Regidx a5_idx)
    ...
    iApply (wp_cand_s_sconf γ Φ (mword_of_int (PK + 0x2be)) a5_idx (mword_of_int 14 : mword 5)
              D2 (K - 24)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2c0)) (mword_of_int 11 : mword 5)
              (mword_of_int 13 : mword 5) (mword_of_int 3996 : mword 12) D3 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0x2c4)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 3)) (mword_of_int 11 : mword 5) D4 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD4a1 Hd2; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      case_eq (Ascii.eqb c1 "l"%char && Ascii.eqb c0 "l"%char)%bool; intro Hll.
      + iApply (wp_bnez_x0_taken_s_sconf γ Φ (mword_of_int (PK + 0x2c6)) (mword_of_int 7728 : mword 13)
                  a5_idx D4 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD4a5 pk_bit_nz; exact Hll)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc [] [-]").
      ...
      + iApply (wp_bnez_x0_fall_s_sconf γ Φ (mword_of_int (PK + 0x2c6)) (mword_of_int 7728 : mword 13)
                  a5_idx D4 (K - 24)%nat ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD4a5 pk_bit_nz; exact Hll)
                  with "Hcg Hpc [] [-]").
        { iApply (pki_2c6 with "Htext"). }
        ...
        iApply (wp_printk_chain_2ca γ Φ D4 K c0 c1 c2 Rest E1 E2
    ...
    - iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (PK + 0x2c4)) (mword_of_int 3 : mword 8)
                (Cregidx (mword_of_int 3)) (mword_of_int 11 : mword 5) D4 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD4a1 Hd2; reflexivity)
                ltac:(vm_compute; reflexivity)
  ...
  Lemma wp_printk_chain_2aa (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x2aa)) (mword_of_int 14 : mword 5)
              (mword_of_int 21 : mword 5) (mword_of_int 3988 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_sltiu_s_sconf γ Φ (mword_of_int (PK + 0x2ae)) (mword_of_int 14 : mword 5)
              (mword_of_int 14 : mword 5) (mword_of_int 1 : mword 12)
              (pk_bit (Ascii.eqb c0 "l"%char)) D1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite /pk_bit (ltu1_eqz (D1 !!! Regidx (mword_of_int 14 : mword 5))
                      (sign_extend' 64 (mword_of_int 1 : mword 12))
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PK + 0x2b2)) (mword_of_int 12 : mword 5)
              (mword_of_int 21 : mword 5) D2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PK + 0x2b4)) (mword_of_int 13 : mword 5)
              (mword_of_int 21 : mword 5) D3 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_printk_chain_2b6 γ Φ D4 K c0 c1 c2 Rest
  ...
  Lemma wp_printk_chain_298 (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    c1 = pk_nul -> c2 = pk_nul ->
    mq !!! Regidx (mword_of_int 21 : mword 5) = zero_extend' 64 (pk_byte c0) ->
  ...
  Proof.
    ...
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0x298)) (mword_of_int 7740 : mword 13)
                (mword_of_int 23 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hs5 Hs7 (pk_eq_ascii c0 "d"%char (mword_of_int 100)
      ...
      iEval (rewrite Ht) in "Hpc".
      iApply ("Hcont" $! mq with "[%] Hcg Hpc HR"). exact Hid. }
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0x298)) (mword_of_int 7740 : mword 13)
              (mword_of_int 23 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs5 Hs7 (pk_eq_ascii c0 "d"%char (mword_of_int 100)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hd0)
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0x29c)) (mword_of_int 14 : mword 5)
              (mword_of_int 21 : mword 5) (mword_of_int 3988 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_sltiu_s_sconf γ Φ (mword_of_int (PK + 0x2a0)) (mword_of_int 14 : mword 5)
              (mword_of_int 14 : mword 5) (mword_of_int 1 : mword 12)
              (pk_bit (Ascii.eqb c0 "l"%char)) D1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite /pk_bit (ltu1_eqz (D1 !!! Regidx (mword_of_int 14 : mword 5))
    ...
    (* +0x2a4 mv a2,a3 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PK + 0x2a4)) (mword_of_int 12 : mword 5)
              (mword_of_int 13 : mword 5) D2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cli_s_sconf γ Φ (mword_of_int (PK + 0x2a6)) a5_idx (mword_of_int 0 : mword 6)
              (pk_bit (Ascii.eqb c1 "l"%char && Ascii.eqb c0 "l"%char)) D3 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (PK + 0x2a8)) (sign_extend' 21 (concat_vec (mword_of_int 17 : mword 11) ('b"0")))
              D4 (K - 24)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iEval (rewrite Ht) in "Hpc".
    iApply (wp_printk_chain_2ca γ Φ D4 K c0 c1 c2 Rest Hd0
              ltac:(rewrite Hn1; repeat rewrite andb_false_r; reflexivity)
              ltac:(rewrite Hn1; repeat rewrite andb_false_r; reflexivity)
              HD4s5 HD4s8 HD4s10 HD4s11 HD4a2 HD4a3 HD4a4 HD4a5
              with "Hcg Htext Hpc HR [-]").
  ...
  Lemma wp_printk_chain_ec (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (fmt : mword 64) (dqf : dfrac) (f : string) (i : nat)
      (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
  ...
  Proof.
    ...
    iApply (wp_cadd_s_sconf γ Φ (mword_of_int (PK + 0xec)) a5_idx s2_idx mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (PK + 0xee)) (mword_of_int 12 : mword 5)
              (mword_of_int 13 : mword 5) J1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    assert (Hla2 : add_vec (J2 !!! Regidx a5_idx) (sign_extend' 64 (mword_of_int 2 : mword 12))
                   = pa_add fmt (S (S (S i)))).
    { rewrite HJ2a5.
    ...
    iApply (wp_lbu_s_sconf γ Φ (mword_of_int (PK + 0xf0)) (mword_of_int 13 : mword 5)
              a5_idx (mword_of_int 2 : mword 12) J2 (K - 24)%nat (pk_fbyte f (S (S (S i))))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] Hb2 [-]").
    { iApply (pki_f0 with "Htext"). }
    iIntros "Hcg Hpc Hb2". iEval (rewrite Hla2) in "Hb2".
    ...
    iApply (wp_cj_s_sconf γ Φ (mword_of_int (PK + 0xf4)) (sign_extend' 21 (concat_vec (mword_of_int 225 : mword 11) ('b"0")))
              J3 (K - 24)%nat ltac:(vm_compute; reflexivity)
              with "Hcg Hpc [] [-]").
    ...
    iEval (rewrite Ht) in "Hpc".
    iApply (wp_printk_chain_2b6 γ Φ J3 K c0 c1 c2 (fmt ↦ₛ{ dqf } f ∗ Rest)%I E1 E2
              HJ3s5 HJ3s8 HJ3s10 HJ3s11 HJ3a2 HJ3a3 HJ3a4
              with "Hcg Htext Hpc [$Hfmt $HR] [-]").
    iIntros (mf) "%Hkk Hcg Hpc (Hfmt & HR)".
  ...
  Lemma wp_printk_chain_a4 (γ : gname) (Φ : mval -> iProp Σ)
      (mq : regfile) (K : nat) (fmt : mword 64) (dqf : dfrac) (f : string) (i : nat)
      (c0 c1 c2 : Ascii.ascii) (Rest : iProp Σ) :
    (S (S (S i)) < length (cstring_bytes f))%nat ->
    (Z.of_nat i + 1 < 2^31) ->
  ...
  Proof.
    ...
    (* +0xa4 beq s5,s7 : '%d' *)
    case_eq (Ascii.eqb c0 "d"%char); intro Hd0.
    { iApply (wp_beq_taken_s_sconf γ Φ (mword_of_int (PK + 0xa4)) (mword_of_int 48 : mword 13)
                (mword_of_int 23 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                ltac:(rewrite Hs5 Hs7 (pk_eq_ascii c0 "d"%char (mword_of_int 100)
                        ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hd0)
    ...
    iApply (wp_beq_fall_s_sconf γ Φ (mword_of_int (PK + 0xa4)) (mword_of_int 48 : mword 13)
              (mword_of_int 23 : mword 5) (mword_of_int 21 : mword 5) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite Hs5 Hs7 (pk_eq_ascii c0 "d"%char (mword_of_int 100)
                      ltac:(apply bv_eq; vm_compute; reflexivity)); exact Hd0)
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0xa8)) (mword_of_int 14 : mword 5)
              (mword_of_int 21 : mword 5) (mword_of_int 3988 : mword 12) mq (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    iApply (wp_sltiu_s_sconf γ Φ (mword_of_int (PK + 0xac)) (mword_of_int 14 : mword 5)
              (mword_of_int 14 : mword 5) (mword_of_int 1 : mword 12)
              (pk_bit (Ascii.eqb c0 "l"%char)) D1 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              ltac:(rewrite /pk_bit (ltu1_eqz (D1 !!! Regidx (mword_of_int 14 : mword 5))
    ...
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (PK + 0xb0)) (mword_of_int 12 : mword 5)
              (mword_of_int 13 : mword 5) (mword_of_int 3996 : mword 12) D2 (K - 24)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc [] [-]").
    ...
    - iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (PK + 0xb4)) (mword_of_int 28 : mword 8)
                (Cregidx (mword_of_int 4)) (mword_of_int 12 : mword 5) D3 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD3a2 Hd1; reflexivity)
                with "Hcg Hpc [] [-]").
      ...
      case_eq (Ascii.eqb c0 "l"%char); intro Hl0.
      + iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (PK + 0xb6)) (mword_of_int 27 : mword 8)
                  (Cregidx (mword_of_int 6)) (mword_of_int 14 : mword 5) D3 (K - 24)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD3a4 Hl0; vm_compute; reflexivity)
                  with "Hcg Hpc [] [-]").
      ...
      + iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (PK + 0xb6)) (mword_of_int 27 : mword 8)
                  (Cregidx (mword_of_int 6)) (mword_of_int 14 : mword 5) D3 (K - 24)%nat
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite HD3a4 Hl0; vm_compute; reflexivity)
                  ltac:(vm_compute; reflexivity)
        ...
        iEval (rewrite Ht) in "Hpc".
        iApply (wp_printk_chain_ec γ Φ D3 K fmt dqf f i c0 c1 c2 Rest Hlen Hi31 Hc2 Hd0
                  ltac:(rewrite Hl0; reflexivity)
    ...
    - iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (PK + 0xb4)) (mword_of_int 28 : mword 8)
                (Cregidx (mword_of_int 4)) (mword_of_int 12 : mword 5) D3 (K - 24)%nat
                ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                ltac:(unfold neq_vec; rewrite HD3a2 Hd1; reflexivity)
                ltac:(vm_compute; reflexivity)
  ...
  Lemma wp_printk_arm_num (γ : gname) (γd : uart_names) (γv : disk_names) (Φ : mval -> iProp Σ)
      (m mc : regfile) (K : nat) (k i : nat) (l : list (bv 8)) (pv pkv : mword 32)
  ...
  Proof.
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0xd4) by (unfold pk_entry; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      ...
      iApply (wp_printk_arm_d γ γd γv Φ m mc K k l pv pkv dqm dqm2
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I HK Hk Hpv Hpkv Hs0 Hs6
    ...
    { (* the long forms: one more character, maybe two.  [pk_dir] tests c0
      ...
      { assert (Hent : pk_entry c0 c1 c2 = 0xb8)
        ...
        iEval (rewrite Hent) in "Hpc".
        iApply (wp_printk_arm_ld γ γd γv Φ m mc K k i l pv pkv dqm dqm2
      ...
      { assert (Hu1 : Ascii.eqb c1 "u"%char = false)
        ...
        { assert (Hent : pk_entry c0 c1 c2 = 0xf6)
          ...
          assert (Hsnd : snd (pk_dir c0 c1 c2) = 2%nat)
            by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
          iEval (rewrite Hent) in "Hpc".
          iApply (wp_printk_arm_lld γ γd γv Φ m mc K k i l pv pkv dqm dqm2
                    ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I
                    HK Hk ltac:(lia) Hpv Hpkv Hs0 Hs6 Hs4
                    with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
          iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
        ...
        { assert (Hent : pk_entry c0 c1 c2 = 0x148)
          ...
          assert (Hsnd : snd (pk_dir c0 c1 c2) = 2%nat)
            by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
          iEval (rewrite Hent) in "Hpc".
          iApply (wp_printk_arm_llu γ γd γv Φ m mc K k i l pv pkv dqm dqm2
                    ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I
                    HK Hk ltac:(lia) Hpv Hpkv Hs0 Hs6 Hs4
                    with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
          iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
        ...
        { assert (Hent : pk_entry c0 c1 c2 = 0x198)
          ...
          assert (Hsnd : snd (pk_dir c0 c1 c2) = 2%nat)
            by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
          iEval (rewrite Hent) in "Hpc".
          iApply (wp_printk_arm_llx γ γd γv Φ m mc K k i l pv pkv dqm dqm2
                    ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I
                    HK Hk ltac:(lia) Hpv Hpkv Hs0 Hs6 Hs4
                    with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
          iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
      ...
      { assert (Hent : pk_entry c0 c1 c2 = 0x12c)
        ...
        assert (Hsnd : snd (pk_dir c0 c1 c2) = 1%nat)
          by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
        iEval (rewrite Hent) in "Hpc".
        iApply (wp_printk_arm_lu γ γd γv Φ m mc K k i l pv pkv dqm dqm2
                  ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I
                  HK Hk ltac:(lia) Hpv Hpkv Hs0 Hs6 Hs4
                  with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
        iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
      ...
      { assert (Hent : pk_entry c0 c1 c2 = 0x17e)
        ...
        assert (Hsnd : snd (pk_dir c0 c1 c2) = 1%nat)
          by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
        iEval (rewrite Hent) in "Hpc".
        iApply (wp_printk_arm_lx γ γd γv Φ m mc K k i l pv pkv dqm dqm2
                  ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I
                  HK Hk ltac:(lia) Hpv Hpkv Hs0 Hs6 Hs4
                  with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
        iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x112)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_u γ γd γv Φ m mc K k l pv pkv dqm dqm2
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I HK Hk Hpv Hpkv Hs0 Hs6
                with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
      iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
      iApply ("Hcont" $! mf bs with "[%] Hcg Hpc S19 Hap Hva Hpanicking Hpanicked Htx Hsent HR").
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x164)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_x γ γd γv Φ m mc K k l pv pkv dqm dqm2
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I HK Hk Hpv Hpkv Hs0 Hs6
                with "Hcg Htext Hkdata Hpc Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab [$S19 $HR] [-]").
      iIntros (mf bs) "%Hcs Hcg Hpc Hap Hva Hpanicking Hpanicked Htx Hsent (S19 & HR)".
      iApply ("Hcont" $! mf bs with "[%] Hcg Hpc S19 Hap Hva Hpanicking Hpanicked Htx Hsent HR").
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x1b4)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_p γ γd γv Φ m mc K k l pv pkv dqm dqm2 Rest
                HK30 Hk Hpv Hpkv Hsp Hs0
                with "Hcg Htext Hkdata Hpc S19 Hap Hva Hpanicking Hpanicked Hdev Htx Hdlab HR [-]").
      iIntros (mf bs) "%Hcs Hcg Hpc S19 Hap Hva Hpanicking Hpanicked Htx Hsent HR".
      iApply ("Hcont" $! mf bs with "[%] Hcg Hpc S19 Hap Hva Hpanicking Hpanicked Htx Hsent HR").
    ...
    { assert (Hent : pk_entry c0 c1 c2 = 0x1fa)
      ...
      assert (Hsnd : snd (pk_dir c0 c1 c2) = 0%nat)
        by (unfold pk_dir; rewrite ?Hd0 ?Hu0 ?Hx0 ?Hp0 ?Hc0 ?Hs0c ?Hl0 ?Hd1 ?Hu1 ?Hx1 ?Hl1 ?Hd2 ?Hu2 ?Hx2; reflexivity).
      iEval (rewrite Hent) in "Hpc".
      iApply (wp_printk_arm_c γ γd γv Φ m mc K k l pv pkv dqm dqm2
                ((∃ w : mword 64, (pa_stk sp0 19) ↦₈ w) ∗ Rest)%I HK30 Hk Hpv Hpkv Hs0
  ...
  Section PrintkLoop.
    Variables (γ : gname) (γd : uart_names) (γv : disk_names) (Φ : mval -> iProp Σ).
    ...
    Definition pk_loop_post (l : list (bv 8)) : iProp Σ :=
      (∀ (mf : regfile) (bs : list (bv 8)),
        sie_cap_gpr γ mf K -∗
        pc_is (ret_pc (m !!! Regidx ra_idx)) -∗
        ⌜ callee_saved m mf /\ mf !!! Regidx ra_idx = m !!! Regidx ra_idx
    ...
    Definition pk_loop_head (i : nat) (l : list (bv 8)) : iProp Σ :=
      (∀ (mk : regfile) (k' p' : nat) (bs : list (bv 8)),
        ⌜ (i <= p')%nat /\ (p' < String.length f)%nat
          ...
          /\ mk !!! Regidx (mword_of_int 4 : mword 5) = m !!! Regidx (mword_of_int 4 : mword 5)
          /\ mk !!! Regidx (mword_of_int 25 : mword 5) = m !!! Regidx (mword_of_int 25 : mword 5)
          /\ pk_consts mk ⌝ -∗
        sie_cap_gpr γ mk (K - 24)%nat -∗
        pc_is (mword_of_int (PK + 0x78) : mword 64) -∗
        fmtv ↦ₛ{ dqf } f -∗
        ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) -∗
        (mword_of_int KernelSyms.panicking : mword 64) ↦₄{ dqm } pv -∗
    ...
    Lemma pk_head_regs (mq mg : regfile)
        ...
        (Htp : mq !!! Regidx (mword_of_int 4 : mword 5) = m !!! Regidx (mword_of_int 4 : mword 5))
      ...
      /\ mg !!! Regidx (mword_of_int 4 : mword 5) = m !!! Regidx (mword_of_int 4 : mword 5)
    ...
    Proof.
      ...
      - rewrite (Hgq (mword_of_int 4 : mword 5) ltac:(vm_compute; reflexivity) ltac:(mw_neq) ltac:(mw_neq) ltac:(mw_neq)). exact Htp.
    ...
    Lemma wp_printk_body86 (mq : regfile) (k i : nat) (l : list (bv 8)) :
      ...
      mq !!! Regidx (mword_of_int 4 : mword 5) = m !!! Regidx (mword_of_int 4 : mword 5) ->
      ...
      WP (Loop : expr riscv_lang) {{ Φ }}.
    Proof using All.
      intros Hilen Hinv Hsp Hs0 Hs2 Hs4 Ha0 Htp4 Hs9r Hconsts.
      ...
      - (* '%': the bne falls through into the dispatch *)
        ...
        iPoseProof (pki_86 with "Htext") as "Hi86".
        iApply (wp_bne_fall_s_sconf γ Φ (mword_of_int (PK + 0x86)) (mword_of_int 8172 : mword 13)
                  (mword_of_int 19 : mword 5) a0_idx mq (K - 24)%nat
                  ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) Hne
                  with "Hcg Hpc Hi86 [-]").
        iIntros "Hcg Hpc".
        ...
        iApply (wp_printk_dispatch γ Φ mq K fmtv dqf f i
                  (([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   (mword_of_int KernelSyms.panicking : mword 64) ↦₄{ dqm } pv ∗
                   (mword_of_int KernelSyms.panicked : mword 64) ↦₄{ dqm2 } pkv ∗
                   uart_tx_own γd l ∗ pk_loop_frame k ∗ (pk_loop_head i l ∧ pk_loop_post l))%I
                  Hlen1 Hi31 Hnn Hs4 Hs2 Hconsts
                  with "Hcg Htext Hpc Hfmt [$Hdescs $Hpanicking $Hpanicked $Htx $Hfr $Hcont] [-]").
        iIntros (mf) "%Hd Hcg Hpc Hfmt (Hdescs & Hpanicking & Hpanicked & Htx & Hfr & Hcont)".
        destruct Hd as [Hkept Hs1f].
        set (c0 := pk_ch f (S i)) in *.
        set (c1 := pk_ch f (S (S i))) in *.
        set (c2 := pk_ch f (S (S (S i)))) in *.
        pose proof (pk_head_regs mq mf (pk_disp_regs mq mf Hkept) Hsp Hs0 Hs2 Htp4 Hs9r Hconsts)
          as (Hfsp & Hfs0 & Hfs2 & Hftp & Hfs9 & Hfconsts).
        ...
        + (* c0 = NUL: the format string is over -- leave through 0x276 *)
          ...
          iApply (wp_printk_exit276 γ Φ m mf K pv dqm
                    (fmtv ↦ₛ{ dqf } f ∗
                     ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                     (mword_of_int KernelSyms.panicked : mword 64) ↦₄{ dqm2 } pkv ∗
                     uart_tx_own γd l)%I
                    HK24 Hpv Hfsp Hftp Hfs9
                    with "Hcg Htext Hpc H9 H10 H12 Hsv Hrest Hpanicking [$Hfmt $Hdescs $Hpanicked $Htx] [-]").
          iIntros (mz) "Hcg Hpc %Hfin2 Hpanicking (Hfmt & Hdescs & Hpanicked & Htx)".
        ...
        + (* a real directive *)
          ...
          * (* a NUMBER directive *)
            rewrite Hfst in Hstep. cbn [pk_cons] in Hstep.
               ...
               iApply (wp_printk_arm_num γ γd γv Φ m mf K k i l pv pkv dqm dqm2 c0 c1 c2
                         (fmtv ↦ₛ{ dqf } f ∗
                          ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                          (pa_stk sp0 9) ↦₈ (m !!! Regidx ra_idx) ∗
                          (pa_stk sp0 10) ↦₈ (m !!! Regidx s0_idx) ∗
               ...
               iIntros (mg bs) "%Hcs2 Hcg Hpc S19 Hap Hva Hpanicking Hpanicked Htx #Hsent2 (Hfmt & Hdescs & H9 & H10 & H12 & Hsv & S8 & S22 & S24 & Hhead)".
               destruct Hcs2 as [Hcs2 Hs1g].
               pose proof (pk_head_regs mf mg Hcs2 Hfsp Hfs0 Hfs2 Hftp Hfs9 Hfconsts)
                 as (Hgsp & Hgs0 & Hgs2 & Hgtp & Hgs9 & Hgconsts).
          ...
          * (* the STRING directive *)
            rewrite Hfst in Hstep. cbn [pk_cons] in Hstep.
               ...
               iApply (wp_printk_arm_str γ γd γv Φ m mf K k i l pv pkv dqm dqm2 c0 c1 c2 d0
                         (fmtv ↦ₛ{ dqf } f ∗
               ...
               iIntros (mg bs) "%Hcs2 Hcg Hpc S19 Hap Hva Hdk0 Hpanicking Hpanicked Htx #Hsent2 (Hfmt & Hdcl & H9 & H10 & H12 & Hsv & S8 & S22 & S24 & Hhead)".
               destruct Hcs2 as [Hcs2 Hs1g].
          ...
          * (* '%%' or an unknown directive: no vararg *)
            ...
            iDestruct "Hcont" as "[Hhead _]".
            iApply (wp_printk_arm_none γ γd γv Φ mf K i l pv pkv dqm dqm2 c0 c1 c2
                      (fmtv ↦ₛ{ dqf } f ∗
                       ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                       pk_loop_frame k ∗ pk_loop_head i l)%I
                      HK30 Hpv Hpkv Hfst Hc0f Hs1f
                      with "Hcg Htext Hpc Hpanicking Hpanicked Hdev Htx Hdlab [$Hfmt $Hdescs $Hfr $Hhead] [-]").
            iIntros (mg bs) "%Hcs2 Hcg Hpc Hpanicking Hpanicked Htx #Hsent2 (Hfmt & Hdescs & Hfr & Hhead)".
            destruct Hcs2 as [Hcs2 Hs1g].
            pose proof (pk_head_regs mf mg Hcs2 Hfsp Hfs0 Hfs2 Hftp Hfs9 Hfconsts)
              as (Hgsp & Hgs0 & Hgs2 & Hgtp & Hgs9 & Hgconsts).
            iEval (rewrite /pk_loop_head) in "Hhead".
      ...
      - (* an ordinary character: print it and continue at i *)
        ...
        { rewrite Ha0 Hc19 Hfch. unfold neq_vec.
          ...
          rewrite Hpct. reflexivity. }
        iDestruct "Hcont" as "[Hhead _]".
        iApply (wp_printk_char γ γd γv Φ mq K l pv pkv dqm dqm2
                  (fmtv ↦ₛ{ dqf } f ∗
                   ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   pk_loop_frame k ∗ pk_loop_head i l)%I
                  HK30 Hpv Hpkv Hne
                  with "Hcg Htext Hpc Hpanicking Hpanicked Hdev Htx Hdlab [$Hfmt $Hdescs $Hfr $Hhead] [-]").
        iIntros (mk bs) "%Hcs2 Hcg Hpc Hpanicking Hpanicked Htx #Hsent2 (Hfmt & Hdescs & Hfr & Hhead)".
        destruct Hcs2 as [Hcs2 Hs1k].
        pose proof (pk_head_regs mq mk (fun c Hc N9 _ _ => Hcs2 c Hc N9) Hsp Hs0 Hs2 Htp4 Hs9r Hconsts)
          as (Hgsp & Hgs0 & Hgs2 & Hgtp & Hgs9 & Hgconsts).
    ...
    Lemma wp_printk_loop78 (n : nat) (mq : regfile) (k p : nat) (l : list (bv 8)) :
    ...
    Proof using All.
      revert mq k p l.
      induction n as [|n IH]; intros mq k p l Hfuel Hplen Hinv Hsp Hs0 Hs2 Hs1 Htp4 Hs9r Hconsts.
      { exfalso. lia. }
      assert (HK24 : (24 <= K)%nat) by lia.
      ...
      - (* the string ends here: 0x24e, restore, epilogue *)
        iApply (wp_printk_advance γ Φ mq K fmtv dqf f p
                  (([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   (mword_of_int KernelSyms.panicking : mword 64) ↦₄{ dqm } pv ∗
                   (mword_of_int KernelSyms.panicked : mword 64) ↦₄{ dqm2 } pkv ∗
                   uart_tx_own γd l ∗ pk_loop_frame k ∗ pk_loop_post l)%I
                  Hlen1 Hp31 Hs1 Hs2
                  with "Hcg Htext Hpc Hfmt [$Hdescs $Hpanicking $Hpanicked $Htx $Hfr $Hfin] [-] []").
        2: { iIntros (mfx) "%Hv Hcg Hpc Hfmt HR". exfalso.
             destruct Hv as (_ & _ & _ & Hnzx). exact (Hnzx Hz). }
        iIntros (mfe) "%Hv Hcg Hpc Hfmt (Hdescs & Hpanicking & Hpanicked & Htx & Hfr & Hfin)".
        destruct Hv as [Hkept _].
        pose proof (pk_head_regs mq mfe (pk_adv_regs mq mfe Hkept) Hsp Hs0 Hs2 Htp4 Hs9r Hconsts)
          as (Hesp & _ & _ & Hetp & Hes9 & _).
        iEval (rewrite /pk_loop_frame) in "Hfr".
        iDestruct "Hfr" as "(H9 & H10 & H12 & Hva & Hsv & S8 & S19 & S22 & Hap & S24)".
        iDestruct (pk_slots_rest_of (pk_ap s0v k) with "Hva S8 S19 S22 Hap S24") as "Hrest".
        ...
        assert (Hnext : mword_of_int (PK + 0x24e + 18) = (mword_of_int (PK + 0x260) : mword 64))
          by (apply bv_eq; vm_compute; reflexivity).
        iApply (wp_printk_exit γ Φ m mfe K 0x24e pv dqm
                  (fmtv ↦ₛ{ dqf } f ∗
                   ([∗ list] j ↦ d ∈ descs, pk_desc_res (pk_vararg m j) d) ∗
                   (mword_of_int KernelSyms.panicked : mword 64) ↦₄{ dqm2 } pkv ∗
                   uart_tx_own γd l)%I
                  HK24 Hpv Hesp Hetp Hes9 Hnext
      ...
      - (* another character: one turn of the body, then round again by IH *)
        iApply (wp_printk_advance γ Φ mq K fmtv dqf f p
                  ...
                  Hlen1 Hp31 Hs1 Hs2
                  with "Hcg Htext Hpc Hfmt [$Hdescs $Hpanicking $Hpanicked $Htx $Hfr $Hfin] [] [-]").
        { iIntros (mfx) "%Hv Hcg Hpc Hfmt HR". exfalso.
          destruct Hv as (_ & Hzx). exact (Hnz Hzx). }
        iIntros (mfg) "%Hv Hcg Hpc Hfmt (Hdescs & Hpanicking & Hpanicked & Htx & Hfr & Hfin)".
        destruct Hv as (Hkept & Hs4g & Ha0g & Hnzg).
        assert (Hilen' : (S p < String.length f)%nat) by (exact (pk_fbyte_nz_lt f (S p) Hlen1 Hnzg)).
        pose proof (pk_head_regs mq mfg (pk_adv_regs mq mfg Hkept) Hsp Hs0 Hs2 Htp4 Hs9r Hconsts)
          as (Hgsp & Hgs0 & Hgs2 & Hgtp & Hgs9 & Hgconsts).
        iApply (wp_printk_body86 mfg k (S p) l Hilen' Hinv Hgsp Hgs0 Hgs2 Hs4g Ha0g Hgtp Hgs9 Hgconsts
        ...
        + (* go round again: the induction hypothesis *)
          ...
          iIntros (mk k' p' bs) "%Hh Hcg Hpc Hfmt Hdescs Hpanicking Hpanicked Htx #Hsent2 Hfr".
          destruct Hh as (Hip & Hplen' & Hinv' & Hksp & Hks0 & Hks2 & Hks1 & Hktp & Hks9 & Hkconsts).
          iApply (IH mk k' p' ((l ++ bs)%list) ltac:(lia) Hplen' Hinv' Hksp Hks0 Hks2 Hks1 Hktp Hks9 Hkconsts
                    with "Hcg Htext Hkdata Hpc Hfmt Hdescs Hpanicking Hpanicked Hdev Htx Hsent2 Hdlab Hfr [Hfin]").
          rewrite /pk_loop_post.
          iIntros (mz bs') "Hcg Hpc %Hfin2 Hfmt Hdescs Hpanicking Hpanicked Htx #Hsent3".
          iEval (rewrite /pk_loop_post) in "Hfin".
  ...
  Lemma wp_printk_sconf_gen (γ : gname) (γd : uart_names) (γv : disk_names) (Φ : mval -> iProp Σ)
  ...
  Proof using All.
    ...
    iApply (wp_printk_prologue γ Φ m0 K HK24 with "Hcg Htext Hpc [-]").
    iIntros (mp) "%Hpro Hcg Hpc H9 H10 H12 Hva Hrest".
    ...
    - (* the empty format string: no loop at all, and nothing was printed *)
      iApply (wp_printk_setup γ Φ m0 mp K pv dqm dqf f
      ...
      2: { iIntros (mq) "%Hb Hcg Hpc Hpanicking Hfmt H9b H10b H12b Hvab Hsvb S8b S19b S22b Hapb S24b HR".
           exfalso. destruct Hb as (_ & _ & _ & _ & _ & Hnzb & _). exact (Hnzb Hf0z). }
      iIntros (mf) "Hcg Hpc %Hz0 %Hfin Hpanicking Hfmt (Hdescs & Hpanicked & Htx)".
    ...
    - (* a nonempty one: setup, then the loop with the string length as fuel *)
      iApply (wp_printk_setup γ Φ m0 mp K pv dqm dqf f
                ...
                HK24 Hpv0 Hnn Hpsp Hps0 Hps2 Hpkept
                with "Hcg Htext Hpc Hpanicking Hfmt H9 H10 H12 Hva Hrest [$Hdescs $Hpanicked $Htx] [] [-]").
      { iIntros (mf) "Hcg Hpc %Hz0 %Hfin Hpanicking Hfmt HR". exfalso. exact (Hf0nz Hz0). }
      iIntros (mq) "%Hb Hcg Hpc Hpanicking Hfmt H9 H10 H12 Hva Hsv S8 S19 S22 Hap S24 (Hdescs & Hpanicked & Htx)".
      ...
      assert (Hqtp : mq !!! Regidx (mword_of_int 4 : mword 5) = m0 !!! Regidx (mword_of_int 4 : mword 5))
      ...
      iApply (wp_printk_body86 γ γd γv Φ m0 K pv pkv dqm dqm2 dqf f descs
                HK Hflen Hnn Hdlen Hpv0 Hpkv0
                mq 0%nat 0%nat l Hilen0 Hinv0 Hqsp Hqs0 Hqs2 Hqs4' Hqa0 Hqtp Hqs9 Hqconsts
      ...
      + (* go round: the loop, with the whole string's length as fuel *)
        rewrite /pk_loop_head.
        iIntros (mk k' p' bs) "%Hh Hcg Hpc Hfmt Hdescs Hpanicking Hpanicked Htx #Hsent2 Hfr".
        destruct Hh as (_ & Hplen' & Hinv' & Hksp & Hks0 & Hks2 & Hks1 & Hktp & Hks9 & Hkconsts).
        iApply (wp_printk_loop78 γ γd γv Φ m0 K pv pkv dqm dqm2 dqf f descs
                  HK Hflen Hnn Hdlen Hpv0 Hpkv0
                  (String.length f) mk k' p' ((l ++ bs)%list)
                  ltac:(lia) Hplen' Hinv' Hksp Hks0 Hks2 Hks1 Hktp Hks9 Hkconsts
...
(* ===================================================================== *)
  Definition wp_printk_sconf `{!riscvGS Σ, !sieG Σ} `{!uartGhostG Σ, !diskGhostG Σ} `{CID : CpuId}
    ...
    wp_printk_sconf_gen
      ...
      (fun γ' γd' γv' Φ' m' K' l' pv' pkv' dqm' dqm2' =>
         Printint.wp_printint_sconf γ' γd' γv' Φ' m' K' l' pv' pkv' (dqm:=dqm') (dqm2:=dqm2'))
      γ γd γv Φ m0 K l pv pkv dqm dqm2 dqf f descs.

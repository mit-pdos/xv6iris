...
Section ProofPrintk.
  ...
  Proof.
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.printk + 0x264)) a5_idx a5_idx (mword_of_int 2760 : mword 12)
  ...
  Proof.
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.printk + 0x22)) a5_idx a5_idx (mword_of_int 3338 : mword 12)

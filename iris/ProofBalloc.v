...
Section BallocOut.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.balloc + 0xfa)) Ra0 Ra0
              (mword_of_int 1424 : mword 12) Q8 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) with "Hcg Hpc []").
    { iApply (bai_0fa with "Htext"). }
    iIntros (CID9 Hq9) "Hcg Hpc".
    set (Q9 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (rget Q8 Ra0)
                     (sign_extend' 64 (mword_of_int 1424 : mword 12)))]> Q8).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.balloc + 0xfe)) Rra
              (mword_of_int 2086562 : mword 21) Q9 (K - 10)%nat b
    ...
    assert (Htgtpk : add_vec (mword_of_int (KernelSyms.balloc + 0xfe) : mword 64)
                       (sign_extend' 64 (mword_of_int 2086562 : mword 21))
...
Section BallocExhaust.
  ...
  Proof.
    ...
    iApply (ba_out (CID0 := CID6)  j γfs bn γ γpr γu γd cov logstart bmapstart
              size u cr Sb pidv dq dqb dqs m E3 K eb b lks Upr HK Hpk HE3sp HE3thr
...
Section BallocBzero.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.balloc + 0x60)) Rra
              (mword_of_int 2088632 : mword 21) Z6 (K - 10)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Htgtms : add_vec (mword_of_int (KernelSyms.balloc + 0x60) : mword 64)
                       (sign_extend' 64 (mword_of_int 2088632 : mword 21))
  ...
  Proof.
    ...
    - (* ---- FUEL 0: the scan is at BPB, so [bgeu] is taken ---- *)
      ...
      iApply (ba_exhaust (CID0 := CID1)  γs j γfs γd bn γ γpr γu cov logstart
                ...
                pidv dq dqb dqs m M K eb b lks Upr HK Hpk Hsize Hsp Hthr Hs2 Hs5 Hs6 Hs8 Hkk Hbelow
        ...
        * (* the bit is SET: fall through and keep scanning *)
          ...
          -- (* bi + 1 = BPB: fall through to the +0xe6 jump *)
             ...
             iApply (ba_exhaust (CID0 := CID15)  γs j γfs γd bn γ γpr γu cov logstart
                       bmapstart size dev u cr Sb kk bnoB (bitmap_bytes used) bsdX dX
                       pidv dq dqb dqs m SA K eb b lks Upr HK Hpk Hsize HSAsp HSAthr HSAs2
...
Section BallocMain.
  ...
  Proof.
    ...
    iApply (ba_main γs j γl γu γd γk pd pav pu bn γ γfs
              ...
              Upr HK Hgeom Hpk Hsize Hbm0 Hbmcov Hbmlog ltac:(discriminate)
              Hj Hgl Ha0 Hbelow

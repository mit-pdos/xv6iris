(* LinkPiperead.v -- piperead()'s contract, TEMPORARILY ASSUMED.
   ...
   register postcondition weakens to [callee_saved_notp] + the tp pin.  piperead()'s
   restated contract (SpecPiperead.v) is CORRECT AND INTENDED; its proof tower has to
...
Module Piperead : PIPEREAD.
  Axiom wp_piperead_sconf :

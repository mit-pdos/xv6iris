(* WpKvmmakeInstr.v -- decode catalog for xv6's kvmmake() AND kvminit()
   (kernel/vm.c).  Per-instruction decode facts + [instr] constructors,
   consumed by the wp_kvmmake / wp_kvminit proofs; same architecture as
   WpMappagesInstr.v.

   kvmmake body = KernelInstrs.v bytes at KernelSyms.kvmmake
   ...
   proc_mapstacks jal.  kvminit body = bytes at KernelSyms.kvminit
   (0x800011bc .. 0x800011d8, 11 instrs): the 2-slot frame, the kvmmake
   jal, and the sd into kernel_pagetable @ 0x8000a238 via auipc a5,0x9 /
   sd a0,112(a5).  JAL residues = (target - pc) mod 2^21; immediates/ASTs
   are the exact vm_compute-on-decode outputs. *)
...
Section KvmmakeInstrs.
  ...
  Lemma kmkdec_0e s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x84aa : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 9), Regidx (mword_of_int 10)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_10 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x6605 : mword 16)) s
    = Some (C_LUI (mword_of_int 1, Regidx (mword_of_int 12)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_12 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_22 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_28 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x4719 : mword 16)) s
    = Some (C_LI (mword_of_int 6, Regidx (mword_of_int 14)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_2a s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x6685 : mword 16)) s
    = Some (C_LUI (mword_of_int 1, Regidx (mword_of_int 13)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_30 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x85b2 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 11), Regidx (mword_of_int 12)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_32 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_38 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x4719 : mword 16)) s
    = Some (C_LI (mword_of_int 6, Regidx (mword_of_int 14)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_42 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x85b2 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 11), Regidx (mword_of_int 12)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_44 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_58 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x85b2 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 11), Regidx (mword_of_int 12)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_5a s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_60 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x4719 : mword 16)) s
    = Some (C_LI (mword_of_int 6, Regidx (mword_of_int 14)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_6a s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x47c5 : mword 16)) s
    = Some (C_LI (mword_of_int 17, Regidx (mword_of_int 15)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_6c s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_7a s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x85b2 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 11), Regidx (mword_of_int 12)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_7c s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_82 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x4729 : mword 16)) s
    = Some (C_LI (mword_of_int 10, Regidx (mword_of_int 14)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_84 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x6685 : mword 16)) s
    = Some (C_LUI (mword_of_int 1, Regidx (mword_of_int 13)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_96 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_9c s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kmkdec_a2 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x8526 : mword 16)) s
    = Some (C_MV (Regidx (mword_of_int 10), Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_a4 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x60e2 : mword 16)) s
    = Some (C_LDSP (mword_of_int 3, Regidx (mword_of_int 1)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_a6 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x6442 : mword 16)) s
    = Some (C_LDSP (mword_of_int 2, Regidx (mword_of_int 8)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_a8 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x64a2 : mword 16)) s
    = Some (C_LDSP (mword_of_int 1, Regidx (mword_of_int 9)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_aa s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x6105 : mword 16)) s
    = Some (C_ADDI16SP (mword_of_int 2 : mword 6), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kmkdec_ac s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x00)%Z (mword_of_int 0x1101 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx (mword_of_int 2), Regidx (mword_of_int 2), ADDI)) kmkdec_00 exec_execute_C_ADDI. Qed.
  Lemma kmki_02 : KMK 0x02 true (STORE (csdsp_imm 3, Regidx (mword_of_int 1), sp, 8)).  (* sd ra,24(sp) *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x02)%Z (mword_of_int 0xec06 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x02) : mword 64) (STORE (csdsp_imm 3, Regidx (mword_of_int 1), sp, 8)) kmkdec_02 exec_execute_C_SDSP. Qed.
  Lemma kmki_04 : KMK 0x04 true (STORE (csdsp_imm 2, Regidx (mword_of_int 8), sp, 8)).  (* sd s0,16(sp) *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x04)%Z (mword_of_int 0xe822 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x04) : mword 64) (STORE (csdsp_imm 2, Regidx (mword_of_int 8), sp, 8)) kmkdec_04 exec_execute_C_SDSP. Qed.
  Lemma kmki_06 : KMK 0x06 true (STORE (csdsp_imm 1, Regidx (mword_of_int 9), sp, 8)).  (* sd s1,8(sp) *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x06)%Z (mword_of_int 0xe426 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x06) : mword 64) (STORE (csdsp_imm 1, Regidx (mword_of_int 9), sp, 8)) kmkdec_06 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x08)%Z (mword_of_int 0x1000 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x08) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) kmkdec_08 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x0e)%Z (mword_of_int 0x84aa : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x0e) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) kmkdec_0e exec_execute_C_MV. Qed.
  Lemma kmki_10 : KMK 0x10 true (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 12), LUI)).  (* lui a2,0x1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x10)%Z (mword_of_int 0x6605 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x10) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 12), LUI)) kmkdec_10 exec_execute_C_LUI. Qed.
  Lemma kmki_12 : KMK 0x12 true (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 11), ADDI)).  (* li a1,0 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x12)%Z (mword_of_int 0x4581 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x12) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 11), ADDI)) kmkdec_12 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x22)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x22) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_22 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x28)%Z (mword_of_int 0x4719 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x28) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 6 : mword 6), zreg, Regidx (mword_of_int 14), ADDI)) kmkdec_28 exec_execute_C_LI. Qed.
  Lemma kmki_2a : KMK 0x2a true (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 13), LUI)).  (* lui a3,0x1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x2a)%Z (mword_of_int 0x6685 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x2a) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 13), LUI)) kmkdec_2a exec_execute_C_LUI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x30)%Z (mword_of_int 0x85b2 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x30) : mword 64) (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 11), ADD)) kmkdec_30 exec_execute_C_MV. Qed.
  Lemma kmki_32 : KMK 0x32 true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)).  (* mv a0,s1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x32)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x32) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_32 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x38)%Z (mword_of_int 0x4719 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x38) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 6 : mword 6), zreg, Regidx (mword_of_int 14), ADDI)) kmkdec_38 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x42)%Z (mword_of_int 0x85b2 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x42) : mword 64) (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 11), ADD)) kmkdec_42 exec_execute_C_MV. Qed.
  Lemma kmki_44 : KMK 0x44 true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)).  (* mv a0,s1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x44)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x44) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_44 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x58)%Z (mword_of_int 0x85b2 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x58) : mword 64) (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 11), ADD)) kmkdec_58 exec_execute_C_MV. Qed.
  Lemma kmki_5a : KMK 0x5a true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)).  (* mv a0,s1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x5a)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x5a) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_5a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x60)%Z (mword_of_int 0x4719 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x60) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 6 : mword 6), zreg, Regidx (mword_of_int 14), ADDI)) kmkdec_60 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x6a)%Z (mword_of_int 0x47c5 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x6a) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 17 : mword 6), zreg, Regidx (mword_of_int 15), ADDI)) kmkdec_6a exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x6c)%Z (mword_of_int 0x07ee : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x6c) : mword 64) (SHIFTIOP (mword_of_int 27 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) kmkdec_6c exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x7a)%Z (mword_of_int 0x85b2 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x7a) : mword 64) (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 11), ADD)) kmkdec_7a exec_execute_C_MV. Qed.
  Lemma kmki_7c : KMK 0x7c true (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)).  (* mv a0,s1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x7c)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x7c) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_7c exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x82)%Z (mword_of_int 0x4729 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x82) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 10 : mword 6), zreg, Regidx (mword_of_int 14), ADDI)) kmkdec_82 exec_execute_C_LI. Qed.
  Lemma kmki_84 : KMK 0x84 true (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 13), LUI)).  (* lui a3,0x1 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0x84)%Z (mword_of_int 0x6685 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x84) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 13), LUI)) kmkdec_84 exec_execute_C_LUI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x96)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x96) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_96 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0x9c)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0x9c) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_9c exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvmmake + 0xa2)%Z (mword_of_int 0x8526 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0xa2) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) kmkdec_a2 exec_execute_C_MV. Qed.
  Lemma kmki_a4 : KMK 0xa4 true (LOAD (csdsp_imm 3, sp, Regidx (mword_of_int 1), false, 8)).  (* ld ra,24(sp) *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0xa4)%Z (mword_of_int 0x60e2 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0xa4) : mword 64) (LOAD (csdsp_imm 3, sp, Regidx (mword_of_int 1), false, 8)) kmkdec_a4 exec_execute_C_LDSP. Qed.
  Lemma kmki_a6 : KMK 0xa6 true (LOAD (csdsp_imm 2, sp, Regidx (mword_of_int 8), false, 8)).  (* ld s0,16(sp) *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0xa6)%Z (mword_of_int 0x6442 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0xa6) : mword 64) (LOAD (csdsp_imm 2, sp, Regidx (mword_of_int 8), false, 8)) kmkdec_a6 exec_execute_C_LDSP. Qed.
  Lemma kmki_a8 : KMK 0xa8 true (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 9), false, 8)).  (* ld s1,8(sp) *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0xa8)%Z (mword_of_int 0x64a2 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0xa8) : mword 64) (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 9), false, 8)) kmkdec_a8 exec_execute_C_LDSP. Qed.
  Lemma kmki_aa : KMK 0xaa true (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)).  (* addi sp,sp,32 *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0xaa)%Z (mword_of_int 0x6105 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0xaa) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) kmkdec_aa exec_execute_C_ADDI16SP. Qed.
  Lemma kmki_ac : KMK 0xac true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).  (* ret *)
  Proof. mk_rvc (KernelSyms.kvmmake + 0xac)%Z (mword_of_int 0x8082 : mword 16) (mword_of_int (KernelSyms.kvmmake + 0xac) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) kmkdec_ac exec_execute_C_JR. Qed.

  (* ---- kvminit decode facts ---- *)
  Lemma kidec_00 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0x1141 : mword 16)) s
    = Some (C_ADDI (mword_of_int 48, Regidx (mword_of_int 2)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kidec_02 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0xe406 : mword 16)) s
    = Some (C_SDSP (mword_of_int 1, Regidx (mword_of_int 1)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kidec_04 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
    exec (ext_decode_compressed (mword_of_int 0xe022 : mword 16)) s
    = Some (C_SDSP (mword_of_int 0, Regidx (mword_of_int 8)), s).
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kidec_06 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. mk_rvc (KernelSyms.kvminit + 0x00)%Z (mword_of_int 0x1141 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx (mword_of_int 2), Regidx (mword_of_int 2), ADDI)) kidec_00 exec_execute_C_ADDI. Qed.
  Lemma kii_02 : KIN 0x02 true (STORE (csdsp_imm 1, Regidx (mword_of_int 1), sp, 8)).  (* sd ra,8(sp) *)
  Proof. mk_rvc (KernelSyms.kvminit + 0x02)%Z (mword_of_int 0xe406 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x02) : mword 64) (STORE (csdsp_imm 1, Regidx (mword_of_int 1), sp, 8)) kidec_02 exec_execute_C_SDSP. Qed.
  Lemma kii_04 : KIN 0x04 true (STORE (csdsp_imm 0, Regidx (mword_of_int 8), sp, 8)).  (* sd s0,0(sp) *)
  Proof. mk_rvc (KernelSyms.kvminit + 0x04)%Z (mword_of_int 0xe022 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x04) : mword 64) (STORE (csdsp_imm 0, Regidx (mword_of_int 8), sp, 8)) kidec_04 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminit + 0x06)%Z (mword_of_int 0x0800 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x06) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) kidec_06 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminit + 0x14)%Z (mword_of_int 0x60a2 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x14) : mword 64) (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 1), false, 8)) kidec_14 exec_execute_C_LDSP. Qed.
  Lemma kii_16 : KIN 0x16 true (LOAD (csdsp_imm 0, sp, Regidx (mword_of_int 8), false, 8)).  (* ld s0,0(sp) *)
  Proof. mk_rvc (KernelSyms.kvminit + 0x16)%Z (mword_of_int 0x6402 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x16) : mword 64) (LOAD (csdsp_imm 0, sp, Regidx (mword_of_int 8), false, 8)) kidec_16 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminit + 0x18)%Z (mword_of_int 0x0141 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x18) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx (mword_of_int 2), Regidx (mword_of_int 2), ADDI)) kidec_18 exec_execute_C_ADDI. Qed.
  Lemma kii_1a : KIN 0x1a true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).  (* ret *)
  Proof. mk_rvc (KernelSyms.kvminit + 0x1a)%Z (mword_of_int 0x8082 : mword 16) (mword_of_int (KernelSyms.kvminit + 0x1a) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) kidec_1a exec_execute_C_JR. Qed.

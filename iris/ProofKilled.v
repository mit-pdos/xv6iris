...
Section ProofKilled.
  ...
  Proof.
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (KL + 0x02)) (mword_of_int 3 : mword 6) kl_ra M1 (av - 4)%nat v1 b
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (KL + 0x04)) (mword_of_int 2 : mword 6) kl_s0 M1 (av - 4)%nat v2 b
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (KL + 0x06)) (mword_of_int 1 : mword 6) kl_s1 M1 (av - 4)%nat v3 b
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (KL + 0x08)) (mword_of_int 0 : mword 6) kl_s2 M1 (av - 4)%nat v4 b
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (KL + 0x0a)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) kl_s0
              M1 (av - 4)%nat b
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (KL + 0x0c)) kl_s1 kl_a0 A1 (av - 4)%nat b
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (KL + 0x0e)) kl_ra (mword_of_int 2091704 : mword 21)
              A2 (av - 4)%nat b
    ...
    iApply (wp_clw_s_sconf Φ (mword_of_int (KL + 0x12)) kl_a5 kl_s1
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (KL + 0x1c)) kl_a0 kl_s2 mrel (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1c [-]").
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (KL + 0x1e)) (mword_of_int 3 : mword 6) kl_ra
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (KL + 0x20)) (mword_of_int 2 : mword 6) kl_s0
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (KL + 0x22)) (mword_of_int 1 : mword 6) kl_s1
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (KL + 0x24)) (mword_of_int 0 : mword 6) kl_s2
    ...
    iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (KL + 0x26)) (mword_of_int 2 : mword 6) E4 (av - 4)%nat 4 b Hpop
    ...
    iApply (wp_cret_s_sconf Φ (mword_of_int (KL + 0x28)) kl_ra E5 av b

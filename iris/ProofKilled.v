...
Section ProofKilled.
  ...
  Proof. mk_rvc (KL + 0x00)%Z (mword_of_int 0x1101 : mword 16)
    (mword_of_int (KL + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_1101 exec_execute_C_ADDI. Qed.

  Lemma kli_02 : KLI 0x02 true (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)).
  Proof. mk_rvc (KL + 0x02)%Z (mword_of_int 0xec06 : mword 16)
    (mword_of_int (KL + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) cdec_ec06 exec_execute_C_SDSP. Qed.

  Lemma kli_04 : KLI 0x04 true (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)).
  Proof. mk_rvc (KL + 0x04)%Z (mword_of_int 0xe822 : mword 16)
    (mword_of_int (KL + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) cdec_e822 exec_execute_C_SDSP. Qed.

  Lemma kli_06 : KLI 0x06 true (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)).
  Proof. mk_rvc (KL + 0x06)%Z (mword_of_int 0xe426 : mword 16)
    (mword_of_int (KL + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) cdec_e426 exec_execute_C_SDSP. Qed.

  Lemma kli_08 : KLI 0x08 true (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)).
  Proof. mk_rvc (KL + 0x08)%Z (mword_of_int 0xe04a : mword 16)
    (mword_of_int (KL + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) cdec_e04a exec_execute_C_SDSP. Qed.

  Lemma kli_0a : KLI 0x0a true (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)).
  Proof. mk_rvc (KL + 0x0a)%Z (mword_of_int 0x1000 : mword 16)
    (mword_of_int (KL + 0x0a) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_1000 exec_execute_C_ADDI4SPN. Qed.

  Lemma kli_0c : KLI 0x0c true (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)).
  Proof. mk_rvc (KL + 0x0c)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (KL + 0x0c) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) cdec_84aa exec_execute_C_MV. Qed.

  Lemma kli_0e : KLI 0x0e false (JAL (mword_of_int 2091704 : mword 21, Regidx kl_ra)).
  Proof. mk_base (KL + 0x0e)%Z (mword_of_int 0xab9fe0ef : mword 32)
    (mword_of_int (KL + 0x0e) : mword 64) (JAL (mword_of_int 2091704 : mword 21, Regidx kl_ra)) kldec_jal_acq. Qed.
  ...
  Proof. mk_rvc (KL + 0x12)%Z (mword_of_int 0x549c : mword 16)
    (mword_of_int (KL + 0x12) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 10 : mword 5) ('b"00")), creg2reg_idx (Cregidx (mword_of_int 1)), creg2reg_idx (Cregidx (mword_of_int 7)), false, 4)) kldec_lw_killed exec_execute_C_LW. Qed.
  ...
  Proof. mk_rvc (KL + 0x16)%Z (mword_of_int 0x8526 : mword 16)
    (mword_of_int (KL + 0x16) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) cdec_8526 exec_execute_C_MV. Qed.

  Lemma kli_18 : KLI 0x18 false (JAL (mword_of_int 2091830 : mword 21, Regidx kl_ra)).
  Proof. mk_base (KL + 0x18)%Z (mword_of_int 0xb37fe0ef : mword 32)
    (mword_of_int (KL + 0x18) : mword 64) (JAL (mword_of_int 2091830 : mword 21, Regidx kl_ra)) kldec_jal_rel. Qed.

  Lemma kli_1c : KLI 0x1c true (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)).
  Proof. mk_rvc (KL + 0x1c)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (KL + 0x1c) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) cdec_854a exec_execute_C_MV. Qed.

  Lemma kli_1e : KLI 0x1e true (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)).
  Proof. mk_rvc (KL + 0x1e)%Z (mword_of_int 0x60e2 : mword 16)
    (mword_of_int (KL + 0x1e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_60e2 exec_execute_C_LDSP. Qed.

  Lemma kli_20 : KLI 0x20 true (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)).
  Proof. mk_rvc (KL + 0x20)%Z (mword_of_int 0x6442 : mword 16)
    (mword_of_int (KL + 0x20) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_6442 exec_execute_C_LDSP. Qed.

  Lemma kli_22 : KLI 0x22 true (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)).
  Proof. mk_rvc (KL + 0x22)%Z (mword_of_int 0x64a2 : mword 16)
    (mword_of_int (KL + 0x22) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) cdec_64a2 exec_execute_C_LDSP. Qed.

  Lemma kli_24 : KLI 0x24 true (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)).
  Proof. mk_rvc (KL + 0x24)%Z (mword_of_int 0x6902 : mword 16)
    (mword_of_int (KL + 0x24) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) cdec_6902 exec_execute_C_LDSP. Qed.

  Lemma kli_26 : KLI 0x26 true (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)).
  Proof. mk_rvc (KL + 0x26)%Z (mword_of_int 0x6105 : mword 16)
    (mword_of_int (KL + 0x26) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) cdec_6105 exec_execute_C_ADDI16SP. Qed.
  ...
  Lemma wp_killed_sconf (γ : gname) (Φ : mval -> iProp Σ) (γs : list gname) (j : nat) (γl : gname)
  ...
  Proof.
    ...
    assert (Hp02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (KL + 0x02)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KL + 0x02)) (mword_of_int 3 : mword 6) kl_ra M1 (av - 4)%nat v1
              with "Hcg Hpc Hi02 [Hb1] [-]").
    { iEval (rewrite HcspM1 -Hb1a). iExact "Hb1". }
    iIntros "Hcg Hpc Hb1".
    assert (Hp04 : add_vec_int (mword_of_int (KL + 0x02) : mword 64) 2 = mword_of_int (KL + 0x04)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp04) in "Hpc".
    iPoseProof (kli_04 with "Htext") as "Hi04".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KL + 0x04)) (mword_of_int 2 : mword 6) kl_s0 M1 (av - 4)%nat v2
              with "Hcg Hpc Hi04 [Hb2] [-]").
    { iEval (rewrite HcspM1 -Hb2a). iExact "Hb2". }
    iIntros "Hcg Hpc Hb2".
    assert (Hp06 : add_vec_int (mword_of_int (KL + 0x04) : mword 64) 2 = mword_of_int (KL + 0x06)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp06) in "Hpc".
    iPoseProof (kli_06 with "Htext") as "Hi06".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KL + 0x06)) (mword_of_int 1 : mword 6) kl_s1 M1 (av - 4)%nat v3
              with "Hcg Hpc Hi06 [Hb3] [-]").
    { iEval (rewrite HcspM1 -Hb3a). iExact "Hb3". }
    iIntros "Hcg Hpc Hb3".
    assert (Hp08 : add_vec_int (mword_of_int (KL + 0x06) : mword 64) 2 = mword_of_int (KL + 0x08)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp08) in "Hpc".
    iPoseProof (kli_08 with "Htext") as "Hi08".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KL + 0x08)) (mword_of_int 0 : mword 6) kl_s2 M1 (av - 4)%nat v4
              with "Hcg Hpc Hi08 [Hb4] [-]").
    { iEval (rewrite HcspM1 -Hb4a). iExact "Hb4". }
    iIntros "Hcg Hpc Hb4".
    assert (Hp0a : add_vec_int (mword_of_int (KL + 0x08) : mword 64) 2 = mword_of_int (KL + 0x0a)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (KL + 0x0a)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) kl_s0
              M1 (av - 4)%nat
    ...
    assert (Hp0c : add_vec_int (mword_of_int (KL + 0x0a) : mword 64) 2 = mword_of_int (KL + 0x0c)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp0c) in "Hpc".
    (* +0x0c: c.mv s1,a0 -- park [p] in a callee-saved register *)
    iPoseProof (kli_0c with "Htext") as "Hi0c".
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KL + 0x0c)) kl_s1 kl_a0 A1 (av - 4)%nat
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (KL + 0x0e)) kl_ra (mword_of_int 2091704 : mword 21)
              A2 (av - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi0e [-]").
    iIntros "Hcg Hpc".
    set (B1 := <[Regidx kl_ra := regval_into_reg (add_vec_int (mword_of_int (KL + 0x0e) : mword 64) 4)]> A2).
    change (<[Regidx kl_ra := regval_into_reg (add_vec_int (mword_of_int (KL + 0x0e) : mword 64) 4)]> A2) with B1.
    assert (Hjacq : add_vec (mword_of_int (KL + 0x0e) : mword 64) (sign_extend' 64 (mword_of_int 2091704 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjacq) in "Hpc".
    assert (HB1ra : B1 !!! Regidx kl_ra = add_vec_int (mword_of_int (KL + 0x0e) : mword 64) 4) by (rewrite /B1 upd_eq; reflexivity).
    assert (HB1tp : B1 !!! Regidx (mword_of_int 4 : mword 5) = cid_word).
    { rewrite /B1 upd_ne; [| vm_compute; discriminate].
      rewrite /A2 upd_ne; [| vm_compute; discriminate].
      rewrite /A1 upd_ne; [| vm_compute; discriminate].
      rewrite /M1 upd_ne; [| vm_compute; discriminate]. exact Htp. }
    ...
    iIntros (ms macq) "%Hmsf Hcg Hpc %Hcs_acq Hlocked HR Hcpu Hpay".
    assert (Hp12 : ret_pc (B1 !!! Regidx kl_ra) = mword_of_int (KL + 0x12))
    ...
    iApply (wp_clw_s_sconf γ Φ (mword_of_int (KL + 0x12)) kl_a5 kl_s1
              (zero_extend' 12 (concat_vec (mword_of_int 10 : mword 5) ('b"00"))) macq (av - 4)%nat kl
              (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi12 [Hkilled] [-]").
    { iEval (rewrite Haddr). iExact "Hkilled". }
    iIntros "Hcg Hpc Hkilled". iEval (rewrite Haddr) in "Hkilled".
    ...
    assert (Hp14 : add_vec_int (mword_of_int (KL + 0x12) : mword 64) 2 = mword_of_int (KL + 0x14)) by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hp14) in "Hpc".
    (* +0x14: c.mv s2,a5 -- park the value across release *)
    iPoseProof (kli_14 with "Htext") as "Hi14".
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KL + 0x14)) kl_s2 kl_a5 C1 (av - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi14 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KL + 0x16)) kl_a0 kl_s1 C2 (av - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi16 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp18 : add_vec_int (mword_of_int (KL + 0x16) : mword 64) 2 = mword_of_int (KL + 0x18)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (KL + 0x18)) kl_ra (mword_of_int 2091830 : mword 21)
              C3 (av - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi18 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hjrel : add_vec (mword_of_int (KL + 0x18) : mword 64) (sign_extend' 64 (mword_of_int 2091830 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjrel) in "Hpc".
    assert (HC4ra : C4 !!! Regidx kl_ra = add_vec_int (mword_of_int (KL + 0x18) : mword 64) 4) by (rewrite /C4 upd_eq; reflexivity).
    assert (HC4a0 : C4 !!! Regidx kl_a0 = proc_addr j)
      by (rewrite /C4 upd_ne; [exact HC3a0 | vm_compute; discriminate]).
    assert (HC4tp : C4 !!! Regidx (mword_of_int 4 : mword 5) = cid_word).
    { rewrite /C4 upd_ne; [| vm_compute; discriminate].
      ...
      rewrite (callee_saved_lookup Hcs_acq (mword_of_int 4 : mword 5) ltac:(vm_compute; reflexivity)).
      exact HB1tp. }
    ...
    assert (Hp1c : ret_pc (C4 !!! Regidx kl_ra) = mword_of_int (KL + 0x1c))
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KL + 0x1c)) kl_a0 kl_s2 mrel (av - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1c [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hp1e : add_vec_int (mword_of_int (KL + 0x1c) : mword 64) 2 = mword_of_int (KL + 0x1e)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KL + 0x1e)) (mword_of_int 3 : mword 6) kl_ra
              E0 (av - 4)%nat (m !!! Regidx kl_ra) (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hp20 : add_vec_int (mword_of_int (KL + 0x1e) : mword 64) 2 = mword_of_int (KL + 0x20)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KL + 0x20)) (mword_of_int 2 : mword 6) kl_s0
              E1 (av - 4)%nat (m !!! Regidx kl_s0) (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hp22 : add_vec_int (mword_of_int (KL + 0x20) : mword 64) 2 = mword_of_int (KL + 0x22)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KL + 0x22)) (mword_of_int 1 : mword 6) kl_s1
              E2 (av - 4)%nat (m !!! Regidx kl_s1) (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hp24 : add_vec_int (mword_of_int (KL + 0x22) : mword 64) 2 = mword_of_int (KL + 0x24)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KL + 0x24)) (mword_of_int 0 : mword 6) kl_s2
              E3 (av - 4)%nat (m !!! Regidx kl_s2) (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    assert (Hp26 : add_vec_int (mword_of_int (KL + 0x24) : mword 64) 2 = mword_of_int (KL + 0x26)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (KL + 0x26)) (mword_of_int 2 : mword 6) E4 (av - 4)%nat 4 Hpop
    ...
    assert (Hp28 : add_vec_int (mword_of_int (KL + 0x26) : mword 64) 2 = mword_of_int (KL + 0x28)) by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (KL + 0x28)) kl_ra E5 av

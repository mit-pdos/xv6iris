...
Section ForwardAddiGpr.
  ...
  Proof using All.
    ...
    assert (LmidA : register_lookup (R_bitvector_64 mideleg) sAi.(sregs) = zeros' 64).
    { unfold sAi, set_reg; cbn [sregs]. rewrite irrelevant_register_set;
    ...
    { apply exec_dispatchInterrupt_none.
      apply (exec_getPendingSet_machine_none sAi _ (exec_currentlyEnabled_S sAi) LmidA LmIEA). }
...
Section WpAddiGprDemo.
  ...
  Definition wp_addi_x5_x6 (pc : mword 64) (w : mword 32) (imm : mword 12) :=
    wp_addi_gpr pc w (mword_of_int 6) (mword_of_int 5) imm.   (* addi x5, x6, imm *)
  Definition wp_addi_x28_x1 (pc : mword 64) (w : mword 32) (imm : mword 12) :=
    wp_addi_gpr pc w (mword_of_int 1) (mword_of_int 28) imm.  (* addi x28, x1, imm *)

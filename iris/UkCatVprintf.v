...
Section UkCatVprintf.
  ...
  (* --------------------------------------------------------------------- *)
  (* vprintf's FULL EPILOGUE @0x73e: restore s2..s8, then fall into the      *)
  ...
  Lemma wp_kcat_vprintf_epi (h : CpuId) (m m0 : regfile) (sp0 : mword 64)
    ...
    (∃ w : mword 64, uword γd (uint sp0 - 88) w) -∗
    (∃ w : mword 64, uword γd (uint sp0 - 96) w) -∗
    urun N h m (mword_of_int 0x73e) n -∗
    (∀ (h' : CpuId) (m' : regfile),
       ⌜ ucallee_saved m0 m' ⌝ -∗
  ...
  Proof using .
    ...
    assert (Ho16 : uoff_sdsp (mword_of_int 2 : mword 6) = 16)
      by (vm_compute; reflexivity).
    (* ---- 0x73e  c.ldsp s2,64(sp) ---- *)
    iApply (wp_uk_cldsp N h m (mword_of_int 0x73e)
    ...
    iIntros "Hw2".
    assert (E6fc : add_vec_int (mword_of_int 0x73e : mword 64) 2
                 = mword_of_int 0x740)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E6fc.
    iIntros (h1) "Hrun".
    ...
    { rewrite <- Hsp.
      exact (upd_ne m (Regidx s2_idx) (Regidx csp_rs1)
               ...
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x740  c.ldsp s3,56(sp) ---- *)
    iApply (wp_uk_cldsp N h1 me1 (mword_of_int 0x740)
    ...
    iIntros "Hw3".
    assert (E6fe : add_vec_int (mword_of_int 0x740 : mword 64) 2
                 = mword_of_int 0x742)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E6fe.
    iIntros (h2) "Hrun".
    ...
    { rewrite <- Hsp1.
      exact (upd_ne me1 (Regidx s3_idx) (Regidx csp_rs1)
               ...
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x742  c.ldsp s4,48(sp) ---- *)
    iApply (wp_uk_cldsp N h2 me2 (mword_of_int 0x742)
    ...
    iIntros "Hw4".
    assert (E700 : add_vec_int (mword_of_int 0x742 : mword 64) 2
                 = mword_of_int 0x744)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E700.
    iIntros (h3) "Hrun".
    ...
    { rewrite <- Hsp2.
      exact (upd_ne me2 (Regidx s4_idx) (Regidx csp_rs1)
               ...
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x744  c.ldsp s5,40(sp) ---- *)
    iApply (wp_uk_cldsp N h3 me3 (mword_of_int 0x744)
    ...
    iIntros "Hw5".
    assert (E702 : add_vec_int (mword_of_int 0x744 : mword 64) 2
                 = mword_of_int 0x746)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E702.
    iIntros (h4) "Hrun".
    ...
    { rewrite <- Hsp3.
      exact (upd_ne me3 (Regidx s5_idx) (Regidx csp_rs1)
               ...
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x746  c.ldsp s6,32(sp) ---- *)
    iApply (wp_uk_cldsp N h4 me4 (mword_of_int 0x746)
    ...
    iIntros "Hw6".
    assert (E704 : add_vec_int (mword_of_int 0x746 : mword 64) 2
                 = mword_of_int 0x748)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E704.
    iIntros (h5) "Hrun".
    ...
    { rewrite <- Hsp4.
      exact (upd_ne me4 (Regidx s6_idx) (Regidx csp_rs1)
               ...
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x748  c.ldsp s7,24(sp) ---- *)
    iApply (wp_uk_cldsp N h5 me5 (mword_of_int 0x748)
    ...
    iIntros "Hw7".
    assert (E706 : add_vec_int (mword_of_int 0x748 : mword 64) 2
                 = mword_of_int 0x74a)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E706.
    iIntros (h6) "Hrun".
    ...
    { rewrite <- Hsp5.
      exact (upd_ne me5 (Regidx s7_idx) (Regidx csp_rs1)
               ...
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x74a  c.ldsp s8,16(sp) ---- *)
    iApply (wp_uk_cldsp N h6 me6 (mword_of_int 0x74a)
    ...
    iIntros "Hw8".
    assert (E708 : add_vec_int (mword_of_int 0x74a : mword 64) 2
                 = mword_of_int 0x74c)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E708.
    iIntros (h7) "Hrun".
  ...
  (*                                                                        *)
  (*   0x56e  sext.w a5,s1        ; a5 := the current character             *)
  (*   0x572  bnez  s3,0x558      ; NOT taken: s3 is the pending-% state    *)
  (*   0x576  bne   a5,s5,0x54e   ; taken: the character is not '%'          *)
  (*   0x54e  mv a1,s1 ; mv a0,s6 ; jal putc ; j 0x55c                       *)
  (*   0x55c  addiw a5,s2,1 ; mv s2,a5 ; mv a4,a5 ; add a5,a5,s4             *)
  (*   0x566  lbu   s1,0(a5)      ; the NEXT character                       *)
  (*   0x56a  beqz  s1,0x73e      ; taken at the terminator                  *)
  (*                                                                        *)
  ...
  (* --------------------------------------------------------------------- *)
  (* ONE ROUND, 0x56e -> 0x56a.  It owns no frame word: putc's four are     *)
  ...
  (* ...AND ITS ONE PAYMENT (lane CAT-WALK, W1): the round's character,
     ...
     deposit -- see [UkCat.wp_kcat_write_chain]'s header. *)
  ...
  Proof using .
    ...
    assert (E52c : add_vec_int (mword_of_int 0x56e : mword 64) 4
                   = mword_of_int 0x572)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E52c.
    iIntros (h1) "Hrun".
    ...
    assert (E530 : add_vec_int (mword_of_int 0x572 : mword 64) 4
                   = mword_of_int 0x576)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E530.
    iIntros (h2) "Hrun".
    ...
    assert (Etgt534 : add_vec (mword_of_int 0x576 : mword 64)
    ...
    iApply (wp_uk_btype N h2 m1 (mword_of_int 0x576)
              ...
              (mword_of_int 0x54e) (4 + n) Ht (eq_sym Etgt534)
              ltac:(intros _; vm_compute; reflexivity)
              with "[] Hrun").
    { iApply (uis_cat_576 with "Hcode"). }
    iIntros (h3) "Hrun".
    (* ---- 0x54e  c.mv a1,s1 ---- *)
    iApply (wp_uk_cmv N h3 m1 (mword_of_int 0x54e) a1_idx s1_idx
              (add_vec zero_reg (m1 !!! Regidx s1_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_54e with "Hcode"). }
    assert (E50c : add_vec_int (mword_of_int 0x54e : mword 64) 2
                   = mword_of_int 0x550)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E50c.
    iIntros (h4) "Hrun".
    ...
    (* ---- 0x550  c.mv a0,s6 ---- *)
    iApply (wp_uk_cmv N h4 m2 (mword_of_int 0x550) a0_idx s6_idx
              (add_vec zero_reg (m2 !!! Regidx s6_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_550 with "Hcode"). }
    assert (E50e : add_vec_int (mword_of_int 0x550 : mword 64) 2
                   = mword_of_int 0x552)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E50e.
    iIntros (h5) "Hrun".
    ...
    (* ---- 0x552  jal ra,0x45c <putc> ---- *)
    destruct cat_syms_pins
      as (_ & _ & _ & _ & _ & Hputc & _ & _ & _ & _ & _).
    iApply (wp_uk_jal N h5 m3 (mword_of_int 0x552)
              (mword_of_int 2096906 : mword 21) ra_idx
              (mword_of_int CatSyms.putc) (mword_of_int 0x556) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ...
              with "[] Hrun").
    { iApply (uis_cat_552 with "Hcode"). }
    iIntros (h6) "Hrun".
    set (m4 := <[Regidx ra_idx
                 := regval_into_reg (mword_of_int 0x556 : mword 64)]> m3).
    assert (Hra4 : m4 !!! Regidx ra_idx = (mword_of_int 0x556 : mword 64))
    ...
    { rewrite /m4 (upd_ne m3 (Regidx ra_idx) (Regidx a1_idx) _
      ...
      rewrite Hs1_1 add_vec_zero_l. apply UkCat.nth_byte0_moi. }
    iApply (wp_kcat_putc N h6 m4 n Ci Co with "[Hw] Hcode HCi Hrun").
    { rewrite Ha0m4 Hb0m4. iExact "Hw". }
    iIntros (h7 m5) "%Hcs HCo Hrun".
    assert (Eret : ret_pc (m4 !!! Regidx ra_idx) = (mword_of_int 0x556 : mword 64))
    ...
    (* ---- 0x556  c.j 0x55c ---- *)
    assert (Etgt514 : (mword_of_int 0x55c : mword 64)
                      = add_vec (mword_of_int 0x556 : mword 64)
                          (sign_extend' 64
                             (sign_extend' 21
                                (concat_vec (mword_of_int 3 : mword 11) ('b"0")))))
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_uk_cj N h7 m5 (mword_of_int 0x556)
              (mword_of_int 3 : mword 11) (mword_of_int 0x55c) (4 + n)
              Etgt514 ltac:(vm_compute; reflexivity)
              with "[] Hrun").
    { iApply (uis_cat_556 with "Hcode"). }
    iIntros (h8) "Hrun".
    (* ---- 0x55c  addiw a5,s2,1 ---- *)
    ...
    { rewrite Hs25 Es1_12.
      ...
      f_equal. lia. }
    iApply (wp_uk_addiw N h8 m5 (mword_of_int 0x55c)
    ...
    assert (E51a : add_vec_int (mword_of_int 0x55c : mword 64) 4
                   = mword_of_int 0x560)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E51a.
    iIntros (h9) "Hrun".
    ...
    iApply (wp_uk_cmv N h9 m6 (mword_of_int 0x560) s2_idx a5_idx
              (add_vec zero_reg (m6 !!! Regidx a5_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_560 with "Hcode"). }
    assert (E51e : add_vec_int (mword_of_int 0x560 : mword 64) 2
                   = mword_of_int 0x562)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E51e.
    iIntros (h10) "Hrun".
    ...
    { rewrite <- Ha56.
      exact (upd_ne m6 (Regidx s2_idx) (Regidx a5_idx) _
               ltac:(vm_compute; discriminate)). }
    (* ---- 0x562  c.mv a4,a5 ---- *)
    iApply (wp_uk_cmv N h10 m7 (mword_of_int 0x562) a4_idx a5_idx
              (add_vec zero_reg (m7 !!! Regidx a5_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_562 with "Hcode"). }
    assert (E520 : add_vec_int (mword_of_int 0x562 : mword 64) 2
                   = mword_of_int 0x564)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E520.
    iIntros (h11) "Hrun".
    ...
    iApply (wp_uk_cadd N h11 m8 (mword_of_int 0x564) a5_idx s4_idx
              (add_vec (m8 !!! Regidx a5_idx) (m8 !!! Regidx s4_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_564 with "Hcode"). }
    assert (E522 : add_vec_int (mword_of_int 0x564 : mword 64) 2
                   = mword_of_int 0x566)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E522.
    iIntros (h12) "Hrun".
    ...
    (* ---- 0x566  lbu s1,0(a5) -- the NEXT character, out of .rodata ---- *)
    ...
    { rewrite Ha59.
      ...
      replace (uoff_i12 (mword_of_int 0 : mword 12)) with 0
        by (vm_compute; reflexivity).
      lia. }
    iApply (wp_uk_lbu_text N h12 m9 (mword_of_int 0x566)
    ...
    assert (E524 : add_vec_int (mword_of_int 0x566 : mword 64) 4
                   = mword_of_int 0x56a)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E524.
    iIntros (h13) "Hrun".
  ...
  (* the current one is [f i], and the round's own [beqz s1] at 0x56a is     *)
  ...
  (* is a body byte, the branch is not taken, and the head at 0x56e comes    *)
  ...
  Lemma wp_kcat_vprintf_loop (m0 : regfile) (sp0 fd ap : mword 64) (a : Z)
    ...
    forall (i : nat) (h : CpuId) (m : regfile) (n : nat)
      ...
      UkCat.kcat_pay_seq N fd f i (S k) Ci Co -∗
      cat_code γt -∗
  ...
  Proof using .
    ...
    - (* the LAST character: the byte after it is the terminator *)
      ...
      (* ---- 0x56a  beqz s1,0x73e -- TAKEN: this was the terminator ---- *)
      ...
      assert (Etgt : add_vec (mword_of_int 0x56a : mword 64)
      ...
      iApply (wp_uk_btype0 N h1 m1 (mword_of_int 0x56a)
                ...
                (mword_of_int 0x73e) (4 + n) Ht (eq_sym Etgt)
                ltac:(intros _; vm_compute; reflexivity)
                with "[] Hrun").
    ...
    - (* a BODY character: the byte after it is one too *)
      ...
      iApply (wp_uk_btype0 N h1 m1 (mword_of_int 0x56a)
                ...
                with "[] Hrun").
      { iApply (uis_cat_56a with "Hcode"). }
      assert (E528 : add_vec_int (mword_of_int 0x56a : mword 64) 4
                     = mword_of_int 0x56e)
        by (apply bv_eq; vm_compute; reflexivity).
      rewrite E528.
      iIntros (h2) "Hrun".
  ...
  (* --------------------------------------------------------------------- *)
  (* THE PROLOGUE, 0x518 -> 0x56e.  Forty instructions that say nothing     *)
  ...
  (* 0x526 arm -- the one that jumps straight to the shared tail with s2..s8 *)
  ...
  Proof using .
    ...
    assert (Ho16 : uoff_sdsp (mword_of_int 2 : mword 6) = 16)
      by (vm_compute; reflexivity).
    (* ---- 0x518  c.addi16sp sp,sp,-96 -- THE PUSH ---- *)
    iApply (wp_uk_caddi16sp_dn N h m (mword_of_int 0x518)
              (mword_of_int 58 : mword 6) 12 (4 + n)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
    { iApply (uis_cat_518 with "Hcode"). }
    iIntros "Hframe".
    assert (E4d6 : add_vec_int (mword_of_int 0x518 : mword 64) 2
                   = mword_of_int 0x51a)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite Hsp E4d6.
    iIntros (h0) "Hrun".
    ...
    assert (E4dc : add_vec_int (mword_of_int 0x51e : mword 64) 2
                 = mword_of_int 0x520)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4dc.
    iIntros (h3) "Hrun".
    (* ---- 0x520  c.addi4spn s0,sp,96 -- s0 := the ENTRY sp ---- *)
    assert (Hlt12 : bv_unsigned (add_vec_int sp0 (- (8 * Z.of_nat 12)))
                    + 8 * Z.of_nat 12 < Z64).
    { assert (HR : 0 <= bv_unsigned sp0 < 18446744073709551616).
      { pose proof (bv_unsigned_in_range 64 sp0) as H0.
    ...
    assert (Ec4 : (sign_extend' 64 (caddi4spn_imm (mword_of_int 24 : mword 8))
      ...
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_uk_caddi4spn N h3 mp1 (mword_of_int 0x520)
              ...
              with "[] Hrun").
    { iApply (uis_cat_520 with "Hcode"). }
    assert (E4de : add_vec_int (mword_of_int 0x520 : mword 64) 2
                   = mword_of_int 0x522)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4de.
    iIntros (h4) "Hrun".
    set (mp2 := <[Regidx s0_idx := regval_into_reg sp0]> mp1).
    (* ---- 0x522  lbu s1,0(a1) -- the FIRST character, out of .rodata ---- *)
    ...
    (* ---- 0x526  beqz s1,0x74c -- NOT taken: the string is non-empty ---- *)
    ...
    iApply (wp_uk_btype0 N h5 mp3 (mword_of_int 0x526)
    ...
    assert (E4e4 : add_vec_int (mword_of_int 0x526 : mword 64) 4
                   = mword_of_int 0x52a)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4e4.
    iIntros (h6) "Hrun".
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s2_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s2_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h6 mp3 (mword_of_int 0x52a)
    ...
    assert (E4e8 : add_vec_int (mword_of_int 0x52a : mword 64) 2
                 = mword_of_int 0x52c)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4e8.
    iIntros (h7) "Hrun".
    (* ---- 0x52c  c.sdsp s3,56(sp) ---- *)
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s3_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s3_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h7 mp3 (mword_of_int 0x52c)
    ...
    assert (E4ea : add_vec_int (mword_of_int 0x52c : mword 64) 2
                 = mword_of_int 0x52e)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4ea.
    iIntros (h8) "Hrun".
    (* ---- 0x52e  c.sdsp s4,48(sp) ---- *)
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s4_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s4_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h8 mp3 (mword_of_int 0x52e)
    ...
    assert (E4ec : add_vec_int (mword_of_int 0x52e : mword 64) 2
                 = mword_of_int 0x530)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4ec.
    iIntros (h9) "Hrun".
    (* ---- 0x530  c.sdsp s5,40(sp) ---- *)
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s5_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s5_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h9 mp3 (mword_of_int 0x530)
    ...
    assert (E4ee : add_vec_int (mword_of_int 0x530 : mword 64) 2
                 = mword_of_int 0x532)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4ee.
    iIntros (h10) "Hrun".
    (* ---- 0x532  c.sdsp s6,32(sp) ---- *)
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s6_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s6_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h10 mp3 (mword_of_int 0x532)
    ...
    assert (E4f0 : add_vec_int (mword_of_int 0x532 : mword 64) 2
                 = mword_of_int 0x534)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4f0.
    iIntros (h11) "Hrun".
    (* ---- 0x534  c.sdsp s7,24(sp) ---- *)
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s7_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s7_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h11 mp3 (mword_of_int 0x534)
    ...
    assert (E4f2 : add_vec_int (mword_of_int 0x534 : mword 64) 2
                 = mword_of_int 0x536)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4f2.
    iIntros (h12) "Hrun".
    (* ---- 0x536  c.sdsp s8,16(sp) ---- *)
    ...
    { rewrite /mp3 (upd_ne mp2 (Regidx s1_idx) (Regidx s8_idx) _
      ...
      rewrite /mp1. exact (upd_ne m (Regidx csp_rs1) (Regidx s8_idx) _
               ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_csdsp N h12 mp3 (mword_of_int 0x536)
    ...
    assert (E4f4 : add_vec_int (mword_of_int 0x536 : mword 64) 2
                 = mword_of_int 0x538)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4f4.
    iIntros (h13) "Hrun".
    (* ---- 0x538  c.mv s6,a0 ---- *)
    iApply (wp_uk_cmv N h13 mp3 (mword_of_int 0x538) s6_idx a0_idx
              (add_vec zero_reg (mp3 !!! Regidx a0_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_538 with "Hcode"). }
    assert (E4f6 : add_vec_int (mword_of_int 0x538 : mword 64) 2
                 = mword_of_int 0x53a)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4f6.
    iIntros (h14) "Hrun".
    ...
    (* ---- 0x53a  c.mv s4,a1 ---- *)
    iApply (wp_uk_cmv N h14 mp4 (mword_of_int 0x53a) s4_idx a1_idx
              (add_vec zero_reg (mp4 !!! Regidx a1_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_53a with "Hcode"). }
    assert (E4f8 : add_vec_int (mword_of_int 0x53a : mword 64) 2
                 = mword_of_int 0x53c)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4f8.
    iIntros (h15) "Hrun".
    ...
    (* ---- 0x53c  c.mv s7,a2 ---- *)
    iApply (wp_uk_cmv N h15 mp5 (mword_of_int 0x53c) s7_idx a2_idx
              (add_vec zero_reg (mp5 !!! Regidx a2_idx)) (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) eq_refl
              with "[] Hrun").
    { iApply (uis_cat_53c with "Hcode"). }
    assert (E4fa : add_vec_int (mword_of_int 0x53c : mword 64) 2
                 = mword_of_int 0x53e)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4fa.
    iIntros (h16) "Hrun".
    ...
    (* ---- 0x53e  c.li s3,0 ---- *)
    iApply (wp_uk_cli N h16 mp6 (mword_of_int 0x53e)
              (mword_of_int 0 : mword 6) s3_idx (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "[] Hrun").
    { iApply (uis_cat_53e with "Hcode"). }
    assert (E4fc : add_vec_int (mword_of_int 0x53e : mword 64) 2
                 = mword_of_int 0x540)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4fc.
    iIntros (h17) "Hrun".
    ...
    (* ---- 0x540  c.li s2,0 ---- *)
    iApply (wp_uk_cli N h17 mp7 (mword_of_int 0x540)
              (mword_of_int 0 : mword 6) s2_idx (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "[] Hrun").
    { iApply (uis_cat_540 with "Hcode"). }
    assert (E4fe : add_vec_int (mword_of_int 0x540 : mword 64) 2
                 = mword_of_int 0x542)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E4fe.
    iIntros (h18) "Hrun".
    ...
    (* ---- 0x542  c.li a4,0 ---- *)
    iApply (wp_uk_cli N h18 mp8 (mword_of_int 0x542)
              (mword_of_int 0 : mword 6) a4_idx (4 + n)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate) with "[] Hrun").
    { iApply (uis_cat_542 with "Hcode"). }
    assert (E500 : add_vec_int (mword_of_int 0x542 : mword 64) 2
                 = mword_of_int 0x544)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E500.
    iIntros (h19) "Hrun".
    ...
    (* ---- 0x544  li s5,37 ---- *)
    iApply (wp_uk_li N h19 mp9 (mword_of_int 0x544)
    ...
    assert (E502 : add_vec_int (mword_of_int 0x544 : mword 64) 4
                 = mword_of_int 0x548)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E502.
    iIntros (h20) "Hrun".
    ...
    (* ---- 0x548  li s8,100 ---- *)
    iApply (wp_uk_li N h20 mp10 (mword_of_int 0x548)
    ...
    assert (E506 : add_vec_int (mword_of_int 0x548 : mword 64) 4
                 = mword_of_int 0x54c)
      by (apply bv_eq; vm_compute; reflexivity).
    rewrite E506.
    iIntros (h21) "Hrun".
    set (mp11 := <[Regidx s8_idx := regval_into_reg (add_vec zero_reg (sign_extend' 64 (mword_of_int 100 : mword 12)))]> mp10).
    (* ---- 0x54c  c.j 0x56e -- into the loop ---- *)
    assert (Etgt50a : (mword_of_int 0x56e : mword 64)
                      = add_vec (mword_of_int 0x54c : mword 64)
                          (sign_extend' 64
                             (sign_extend' 21
                                (concat_vec (mword_of_int 17 : mword 11) ('b"0")))))
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_uk_cj N h21 mp11 (mword_of_int 0x54c)
              (mword_of_int 17 : mword 11) (mword_of_int 0x56e) (4 + n)
              Etgt50a ltac:(vm_compute; reflexivity)
              with "[] Hrun").
    { iApply (uis_cat_54c with "Hcode"). }
    iIntros (h22) "Hrun".
  ...
  (* --------------------------------------------------------------------- *)
  (* vprintf(fd, fmt, ap) @0x518, for a format string with no '%'.           *)
  (*                                                                        *)
  (* The contract asks for a NON-EMPTY string.  cat prints four literals    *)
  (* and none of them is empty, and taking [0 < len] deletes the whole       *)
  (* 0x526 arm -- the one that jumps straight to the shared tail with s2..s8 *)

...
Section ProofUartPutc.
  ...
  Proof.
    ...
    iAssert (∀ m : regfile,
      ...
      sie_cap_gpr γ m n -∗ pc_is (mword_of_int (UPS + 0x26)) -∗ uart_tx_own γd l -∗
      ( ∀ b : bv 8, sie_cap_gpr γ (<[Regidx (mword_of_int 15) := regval_into_reg (lsr_masked b)]> mentry) n -∗
          pc_is (mword_of_int (UPS + 0x30)) -∗
    ...
    { iLöb as "IH". iIntros (m Ha4m Hagm) "Hcg Hpc Hown Hk".
      ...
      (* 0x2a  andi a5,a5,32 *)
      iApply (wp_andi_s_sconf γ Φ (mword_of_int (UPS + 0x2a)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 32 : mword 12)
      ...
      - iApply (wp_cbeqz_taken_s_sconf γ Φ (mword_of_int (UPS + 0x2e)) (mword_of_int 252 : mword 8)
      ...
      - iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (UPS + 0x2e)) (mword_of_int 252 : mword 8)
                  (Cregidx (mword_of_int 7)) (mword_of_int 15)
                  (<[Regidx (mword_of_int 15) := regval_into_reg (lsr_masked b)]> m) n
                  ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
                  ltac:(rewrite upd_eq; unfold regval_into_reg, lsr_masked; exact Hcase)
        ...
        iApply ("Hk" $! b with "Hcg Hpc Hown").
        by iApply "Hlb". }
    iApply ("Loop" $! mentry with "[%] [%] Hcg Hpc Hown Hcont").
    - exact Ha4e.
    - reflexivity.
  Qed.
  ...
  Proof.
    ...
    (* 0x20  lui a4,0x10000 *)
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (UPS + 0x20)) (mword_of_int 14) (mword_of_int 0x10000 : mword 20)
    ...
    (* 0x24  c.addi a4,a4,5 *)
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (UPS + 0x24)) (mword_of_int 14) (mword_of_int 5 : mword 6)
    ...
    iApply (wp_andi_s_sconf γ Φ (mword_of_int (UPS + 0x30)) (mword_of_int 10) (mword_of_int 9) (mword_of_int 255 : mword 12)
    ...
    (* 0x34  lui a5,0x10000 *)
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (UPS + 0x34)) (mword_of_int 15) (mword_of_int 0x10000 : mword 20)
    ...
    iApply ("Hcont" $! b with "Hcg Hpc Hown Hsent").
  Qed.
  ...
  Proof.
    ...
    (* ---- 0x0c auipc a5 ---- *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UPS + 0x0c)) (mword_of_int 15) (mword_of_int 0xa : mword 20)
    ...
    iApply (wp_lw_s_sconf γ Φ (mword_of_int (UPS + 0x10)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 0x8a8 : mword 12)
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (UPS + 0x14)) (mword_of_int 30 : mword 8)
              (Cregidx (mword_of_int 7)) (mword_of_int 15)
    ...
    (* ---- 0x16 auipc a5 ---- *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UPS + 0x16)) (mword_of_int 15) (mword_of_int 0xa : mword 20)
    ...
    iApply (wp_lw_s_sconf γ Φ (mword_of_int (UPS + 0x1a)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 0x89a : mword 12)
              g16 n pkv (dqm:=dqm2) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1a Hpkd").
    iIntros "Hcg Hpc Hpkd".
    iEval (rewrite Hea1) in "Hpkd".
    iEval (rewrite P1e) in "Hpc".
    (* ---- 0x1e c.bnez a5 : falls through (panicked == 0) ---- *)
    iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (UPS + 0x1e)) (mword_of_int 28 : mword 8)
              (Cregidx (mword_of_int 7)) (mword_of_int 15)
    ...
    (* ---- 0x3c auipc a5 ---- *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UPS + 0x3c)) (mword_of_int 15) (mword_of_int 0xa : mword 20)
    ...
    iApply (wp_lw_s_sconf γ Φ (mword_of_int (UPS + 0x40)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 0x878 : mword 12)
    ...
    iApply (wp_cbeqz_fall_s_sconf γ Φ (mword_of_int (UPS + 0x44)) (mword_of_int 10 : mword 8)
              (Cregidx (mword_of_int 7)) (mword_of_int 15)
  ...
  Proof.
    ...
    iApply (wp_caddi_sp_push_s_sconf γ Φ pcE (mword_of_int 32 : mword 6) m0 K 4 HK Hpush
              with "Hcg Hpc Hi00 [-]").
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UPS + 0x02)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UPS + 0x04)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    (* +0x06 c.sdsp s1,8(sp) *)
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UPS + 0x06)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
    ...
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (UPS + 0x08)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) (mword_of_int 8 : mword 5)
    ...
    (* +0x0a c.mv s1,a0 *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (UPS + 0x0a)) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UPS + 0x46)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UPS + 0x48)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    (* +0x4a c.ldsp s1,8(sp) *)
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UPS + 0x4a)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (UPS + 0x4c)) (mword_of_int 2 : mword 6) Q4a
              (K - 4)%nat 4 Hpop

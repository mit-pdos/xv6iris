...
Section ProofUartPutc.
  ...
  Proof.
    ...
    assert (Hea0 : add_vec (rget g0c (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x928 : mword 12))
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.uartputc_sync + 0x10)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 0x928 : mword 12)
    ...
    assert (Hea1 : add_vec (rget g16 (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x91a : mword 12))
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.uartputc_sync + 0x1a)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 0x91a : mword 12)
    ...
    assert (Hea2 : add_vec (rget h3c (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 0x8f8 : mword 12))
                   = (mword_of_int KernelSyms.panicking : mword 64)).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.uartputc_sync + 0x40)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 0x8f8 : mword 12)

...
Section ProofUartPutc.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.uartputc_sync + 0x10)) (mword_of_int 10) (mword_of_int 10) (mword_of_int 2542 : mword 12)
              G0c (K - 4)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (upi_10 with "Ht"). }
    iIntros (CIDp8 Hsp8) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (G10 := <[Regidx (mword_of_int 10) := regval_into_reg (add_vec (G0c !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2542 : mword 12)))]> G0c).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.uartputc_sync + 0x38)) (mword_of_int 10) (mword_of_int 10) (mword_of_int 2502 : mword 12)
    ...
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (H38 := <[Regidx (mword_of_int 10) := regval_into_reg (add_vec (H34 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 2502 : mword 12)))]> H34).

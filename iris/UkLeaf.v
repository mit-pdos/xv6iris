(* UkLeaf.v -- the PER-INSTRUCTION leaves of the user-mode-ON-KERNEL tier:
   ...
   read as [uvb C pt Rfd Rut sz π fdv cw M m pc] and the continuation
   [∀ CID0, uv_cap_gpr … M m' -∗ pc_is pc' -∗ WP] read as [ukc π M sz fdv cw m' pc'];
...
Section UkLeaf.
  ...
  Lemma wp_uk_alu0 (M : gmap Z (bv 8)) (m : regfile)
    ...
    ukc π M sz fdv cw (<[Regidx rd := regval_into_reg wval]> m) (add_vec_int pc (if is_rvc then 2 else 4)) -∗
    WP (Loop : expr riscv_lang).
  Proof.
    intros Hui Hred Hlpad Hrd Hg1 Hg2 Hop.
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw is_rvc i o None (Some (rd, wval))
              Hui Hred Hlpad Hrd
  ...
  Lemma wp_uk_cli (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 6) (rd : mword 5) (wval : mword 64) :
    uk_instr π M pc true (C_LI (imm, Regidx rd)) ->
    uint rd <> 0 ->
    wval = add_vec zero_reg (sign_extend' 64 (sign_extend' 12 imm)) ->
    uvb C pt Rfd Rut sz π fdv cw M m pc -∗
    ukc π M sz fdv cw (<[Regidx rd := regval_into_reg wval]> m) (add_vec_int pc 2) -∗
    WP (Loop : expr riscv_lang).
  Proof.
    intros Hui Hrd Hwval.
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw true (C_LI (imm, Regidx rd))
  ...
  Proof.
    intros Hui Hrd Hwval.
    exact (wp_uk_alu1 M m pc fdv cw true (C_ADDI (imm, Regidx rd))
  ...
  Lemma wp_uk_caddi4spn (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (cr : mword 3) (nzimm : mword 8) (rd : mword 5)
      (wval : mword 64) :
  ...
  Proof.
    ...
    exact (wp_uk_alu1 M m pc fdv cw true (C_ADDI4SPN (Cregidx cr, nzimm))
  ...
  Lemma wp_uk_jal (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 21) (rd : mword 5) (tgt wval : mword 64) :
    ...
    uvb C pt Rfd Rut sz π fdv cw M m pc -∗
    ukc π M sz fdv cw (<[Regidx rd := regval_into_reg wval]> m) tgt -∗
    WP (Loop : expr riscv_lang).
  Proof.
    intros Hui Hrd Htgt Hwval Hal0.
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw false (JAL (imm, Regidx rd)) None
  ...
  Lemma wp_uk_cjr (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (rs1 : mword 5) (tgt : mword 64) :
    uk_instr π M pc true (C_JR (Regidx rs1)) ->
    uint rs1 <> 0 ->
    tgt = ret_pc (m !!! Regidx rs1) ->
    uvb C pt Rfd Rut sz π fdv cw M m pc -∗
    ukc π M sz fdv cw m tgt -∗
    WP (Loop : expr riscv_lang).
  Proof.
    intros Hui Hrs1 Htgt.
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw true (C_JR (Regidx rs1))
  ...
  Lemma wp_uk_caddi16sp (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 6) (wval : mword 64) :
    uk_instr π M pc true (C_ADDI16SP imm) ->
    wval = add_vec (m !!! Regidx csp_rs1)
             (sign_extend' 64 (caddi16sp_imm imm)) ->
    uvb C pt Rfd Rut sz π fdv cw M m pc -∗
    ukc π M sz fdv cw (<[Regidx csp_rs1 := regval_into_reg wval]> m) (add_vec_int pc 2) -∗
    WP (Loop : expr riscv_lang).
  Proof.
    intros Hui Hwval.
    assert (Hsp : uint csp_rs1 <> 0) by (vm_compute; discriminate).
    exact (wp_uk_alu1 M m pc fdv cw true (C_ADDI16SP imm)
  ...
  Lemma wp_uk_cmv (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (rd rs2 : mword 5) (wval : mword 64) :
  ...
  Proof.
    intros Hui Hrd Hwval.
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw true (C_MV (Regidx rd, Regidx rs2))
  ...
  Proof.
    intros Hui Hrd Hwval.
    exact (wp_uk_alu1 M m pc fdv cw true (C_ADDIW (imm, Regidx rd))
  ...
  Lemma wp_uk_cj (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 11) (tgt : mword 64) :
  ...
  Proof.
    ...
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw true (C_J imm)
  ...
  Lemma wp_uk_addi (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 12) (rs1 rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    exact (wp_uk_alu1 M m pc fdv cw false (ITYPE (imm, Regidx rs1, Regidx rd, ADDI))
  ...
  Lemma wp_uk_add (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (rs1 rs2 rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    exact (wp_uk_alu2 M m pc fdv cw false (RTYPE (Regidx rs2, Regidx rs1, Regidx rd, ADD))
  ...
  Lemma wp_uk_slli (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (shamt : mword 6) (rs1 rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_SHIFTIOP_total Du_r Du_w shamt rs1 rd SLLI s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (SHIFTIOP (shamt, Regidx rs1, Regidx rd, SLLI))
             None rs1 rd
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_SHIFTIOP_total Du_r Du_w shamt rs1 rd SRLI s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (SHIFTIOP (shamt, Regidx rs1, Regidx rd, SRLI))
             None rs1 rd
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_RTYPEW_total Du_r Du_w rs2 rs1 rd SUBW s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (RTYPEW (Regidx rs2, Regidx rs1, Regidx rd, SUBW))
             None rs1 rs2 rd
  ...
  Lemma wp_uk_auipc (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 20) (rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    apply (wp_uk_alu0 M m pc fdv cw false (UTYPE (imm, Regidx rd, AUIPC)) None rd wval
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_RTYPE_total Du_r Du_w rs2 rs1 rd SUB s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (RTYPE (Regidx rs2, Regidx rs1, Regidx rd, SUB))
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_RTYPE_total Du_r Du_w rs2 rs1 rd AND s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (RTYPE (Regidx rs2, Regidx rs1, Regidx rd, AND))
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_RTYPE_total Du_r Du_w rs2 rs1 rd SLTU s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (RTYPE (Regidx rs2, Regidx rs1, Regidx rd, SLTU))
             None rs1 rs2 rd
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_RTYPEW_total Du_r Du_w rs2 rs1 rd ADDW s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (RTYPEW (Regidx rs2, Regidx rs1, Regidx rd, ADDW))
             None rs1 rs2 rd
             (fun a b => sign_extend' 64
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_ITYPE_total Du_r Du_w imm rs1 rd SLTIU s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (ITYPE (imm, Regidx rs1, Regidx rd, SLTIU))
             None rs1 rd
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_ITYPE_total Du_r Du_w imm rs1 rd ANDI s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (ITYPE (imm, Regidx rs1, Regidx rd, ANDI))
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_ITYPE_total Du_r Du_w imm rs1 rd XORI s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (ITYPE (imm, Regidx rs1, Regidx rd, XORI))
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_ADDIW_total Du_r Du_w imm rs1 rd s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (ADDIW (imm, Regidx rs1, Regidx rd))
             None rs1 rd
             (fun a => sign_extend' 64
  ...
  Lemma wp_uk_slliw (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (shamt : mword 5) (rs1 rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_SHIFTIWOP_total Du_r Du_w shamt rs1 rd SLLIW s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu1 M m pc fdv cw false (SHIFTIWOP (shamt, Regidx rs1, Regidx rd, SLLIW))
             None rs1 rd
             (fun a => sign_extend' 64
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_UTYPE_total Du_r Du_w imm rd LUI s
                            UserTotalU.Du_r_PC (Du_gpr_of_Z rd))).
    apply (wp_uk_alu0 M m pc fdv cw false (UTYPE (imm, Regidx rd, LUI)) None rd wval
             Hui (fun _ : mstate => I) eq_refl Hrd Hg Hg).
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_DIV_total Du_r Du_w rs2 rs1 rd true s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (DIV (Regidx rs2, Regidx rs1, Regidx rd, true))
             None rs1 rs2 rd
  ...
  Proof.
    ...
    assert (Hg : forall s : mstate,
      ...
      by (intro s; exact (goodmb_execute_REM_total Du_r Du_w rs2 rs1 rd true s
                            (Du_gpr_of_Z_r rs1) (Du_gpr_of_Z_r rs2) (Du_gpr_of_Z rd))).
    exact (wp_uk_alu2 M m pc fdv cw false (REM (Regidx rs2, Regidx rs1, Regidx rd, true))
             None rs1 rs2 rd
             (fun a b => to_bits_truncate 64
  ...
  Lemma wp_uk_jalr (M : gmap Z (bv 8)) (m : regfile)
    ...
    uvb C pt Rfd Rut sz π fdv cw M m pc -∗
    ukc π M sz fdv cw (uv_upd m wr) tgt -∗
    WP (Loop : expr riscv_lang).
  Proof.
    ...
    iIntros "Hb Hcont".
    iApply (wp_uk_retire C pt Rfd Rut π sz Hlo Hpm HRut M m pc fdv cw false (JALR (imm, Regidx rs1, Regidx rd))
  ...
  Lemma wp_uk_jr (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 12) (rs1 rd : mword 5) (tgt : mword 64) :
    uk_instr π M pc false (JALR (imm, Regidx rs1, Regidx rd)) ->
    uint rs1 <> 0 ->
    uint rd = 0 ->
    tgt = ret_pc (add_vec (m !!! Regidx rs1) (sign_extend' 64 imm)) ->
  ...
  Proof.
    ...
    exact (wp_uk_jalr M m pc fdv cw imm rs1 rd None tgt Hui Hrs1
  ...
  Proof.
    intros Hui Hrd Hwval.
    exact (wp_uk_alu2 M m pc fdv cw true (C_ADD (Regidx rd, Regidx rs2))
  ...
  Lemma wp_uk_cand (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (crd crs2 : mword 3) (rd rs2 : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    exact (wp_uk_alu2 M m pc fdv cw true (C_AND (Cregidx crd, Cregidx crs2))
             (Some (RTYPE (Regidx rs2, Regidx rd, Regidx rd, AND)))
  ...
  Proof.
    ...
    { intro s. rewrite (exec_execute_C_ADDW (Cregidx crd) (Cregidx crs2) s).
      rewrite Hcrd. rewrite Hcrs2. reflexivity. }
    exact (wp_uk_alu2 M m pc fdv cw true (C_ADDW (Cregidx crd, Cregidx crs2))
             (Some (RTYPEW (Regidx rs2, Regidx rd, Regidx rd, ADDW)))
             rd rs2 rd
             (fun a b => sign_extend' 64
                           (add_vec (subrange_vec_dec a 31 0 : mword 32)
  ...
  Proof.
    intros Hui Hrd Hwval.
    apply (wp_uk_alu0 M m pc fdv cw true (C_LUI (imm, Regidx rd))
  ...
  Lemma wp_uk_cslli (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (shamt : mword 6) (rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    intros Hui Hrd Hwval.
    exact (wp_uk_alu1 M m pc fdv cw true (C_SLLI (shamt, Regidx rd))
  ...
  Lemma wp_uk_csrli (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (shamt : mword 6) (crd : mword 3) (rd : mword 5)
      (wval : mword 64) :
  ...
  Proof.
    ...
    exact (wp_uk_alu1 M m pc fdv cw true (C_SRLI (shamt, Cregidx crd))
  ...
  Lemma wp_uk_li (M : gmap Z (bv 8)) (m : regfile)
      (pc : mword 64) (fdv : list fdstate) (cw : Z) (imm : mword 12) (rd : mword 5) (wval : mword 64) :
  ...
  Proof.
    ...
    iApply (wp_uk_addi M m pc fdv cw imm (mword_of_int 0 : mword 5) rd wval

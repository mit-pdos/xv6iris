...
Section WpAcquireLock.
  ...
  Lemma wp_acquire_lock_loop_r (Rg : s_regime) (Φ : mval -> iProp Σ)
      (γ : gname) (R : iProp Σ)
  ...
  Proof.
    ...
    (* ---- +0x1a: c.mv a5,a4 ---- *)
    iApply (wp_cmv_gpr_s_config_r Rg Φ (mword_of_int (AQ + 0x1a)) (mword_of_int 15 : mword 5) (mword_of_int 14 : mword 5)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_amoswap_lockinv_r Rg Φ γ lk R (mword_of_int (AQ + 0x1c)) (mword_of_int 15) (mword_of_int 15) (mword_of_int 9)
              (<[Regidx (mword_of_int 15 : mword 5) := regval_into_reg v1]> M0)
              mstatus0 mie_v mdv0 menvcfg0 (dq:=DfracOwn 1)
 HPAlk
              HSTZ
    ...
    (* ---- +0x20: sext.w a5 ---- *)
    iApply (wp_caddiw_s_r Rg Φ (mword_of_int (AQ + 0x20)) (mword_of_int 15 : mword 5) (mword_of_int 0 : mword 6)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 ltac:(vm_compute; discriminate)
    ...
    - (* ---- w = 0: ACQUIRED -- c.bnez falls through; hand over token + R ---- *)
      subst w.
      iApply (wp_cbnez_fall_s_r Rg Φ (mword_of_int (AQ + 0x22)) (mword_of_int 252) (Cregidx (mword_of_int 7)) (mword_of_int 15)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0
    ...
    - (* ---- w <> 0: c.bnez TAKEN back to +0x1a; loop via the Löb IH ----
      ...
      iApply (wp_cbnez_taken_s_zca_later_r Rg Φ (mword_of_int (AQ + 0x22)) (mword_of_int 252) (Cregidx (mword_of_int 7)) (mword_of_int 15)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0
  ...
  Lemma wp_acquire_lock_loop_scfg_r (Rg : s_regime) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iApply (wp_acquire_lock_loop_r Rg Φ γ R M0 a5v lk mstatus0 mie_v mdv0 menvcfg0
 HSIE HMPRV HSXL Hmm HMXR Hpmm HPBMTE Hmenvval0 HM0a4 HM0s1
  ...
  Lemma wp_acquire_lock_r (Rg : s_regime) (Φ : mval -> iProp Σ)
      (γ : gname) (R : iProp Σ)
  ...
  Proof.
    ...
    (* ---- 0x00: c.addi sp,-32 ---- *)
    iApply (wp_caddi_gpr_s_config_scfg_r Rg γc Φ (mword_of_int (AQ + 0x00)) csp_rs1 (mword_of_int 32 : mword 6) m (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_csdsp_gpr_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x02)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_csdsp_gpr_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x04)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    (* ---- 0x06: c.sdsp s1,8(sp) ---- *)
    iApply (wp_csdsp_gpr_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x06)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
    ...
    iApply (wp_caddi4spn_gpr_s_config_scfg_r Rg γc Φ (mword_of_int (AQ + 0x08)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) (mword_of_int 8 : mword 5)
              A0 (dq:=DfracOwn 1)
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    (* ---- 0x0a: c.mv s1,a0 ---- *)
    iApply (wp_cmv_gpr_s_config_scfg_r Rg γc Φ (mword_of_int (AQ + 0x0a)) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
              A1 (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
    ...
    assert (EQ0e : add_vec_int (mword_of_int (AQ + 0x0c) : mword 64) 2 = mword_of_int (AQ + 0x0e))
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_gpr_s_zca_r Rg γc Φ (mword_of_int (AQ + 0x0c)) (mword_of_int 1 : mword 5) (mword_of_int 0x1fffba : mword 21)
              A2 1%Qp
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_push_off_r Rg γc Φ P0 noff intena_old a0f 6
    ...
    (* ---- 0x10: c.mv a0,s1 ---- *)
    iApply (wp_cmv_gpr_s_config_scfg_r Rg γc Φ (mword_of_int (AQ + 0x10)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
              mfin (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)
    ...
    assert (EQ14 : add_vec_int (mword_of_int (AQ + 0x12) : mword 64) 2 = mword_of_int (AQ + 0x14))
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_gpr_s_zca_r Rg γc Φ (mword_of_int (AQ + 0x12)) (mword_of_int 1 : mword 5) (mword_of_int 0x1fff88 : mword 21)
              B1 1%Qp
 ltac:(vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
    ...
    iApply (wp_holding_lockinv_r Rg γc Φ γ lk R B2 cpuold
 ...
 HAlk
    ...
    (* ---- 0x16: c.li a4,1 ---- *)
    iApply (wp_cli_s_r Rg γc Φ (mword_of_int (AQ + 0x16)) (mword_of_int 14 : mword 5)
 ...
 ltac:(vm_compute; discriminate)
    ...
    { rewrite /B5. rewrite lookup_total_insert_ne; [| vm_compute; discriminate].
      exact Hma0. }
    iApply (wp_cbnez_fall_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x18)) (mword_of_int 14) (Cregidx (mword_of_int 2)) (mword_of_int 10)
              B5 (dq:=DfracOwn 1)
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_acquire_lock_loop_scfg_r Rg Φ γc γ R B5 (B5 !!! Regidx (mword_of_int 15 : mword 5)) lk
 HB5a4L HB5s1
    ...
    iApply (wp_call_mycpu_scfg_cs_r Rg γc Φ (mword_of_int (AQ + 0x24)) (mword_of_int 0xcb8 : mword 21) B8
 ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_csd_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x28)) (mword_of_int 10) (mword_of_int 9)
    ...
    iApply (wp_cldsp_gpr_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x2a)) (mword_of_int 3) (mword_of_int 1 : mword 5)
 ...
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_gpr_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x2c)) (mword_of_int 2) (mword_of_int 8 : mword 5)
 ...
 ltac:(vm_compute; discriminate)
    ...
    (* ---- 0x2e: c.ldsp s1,8(sp) ---- *)
    iApply (wp_cldsp_gpr_s_scfg_r Rg γc Φ (mword_of_int (AQ + 0x2e)) (mword_of_int 1) (mword_of_int 9 : mword 5)
 ...
 ltac:(vm_compute; discriminate)
    ...
    iApply (wp_caddi16sp_gpr_s_r Rg γc Φ (mword_of_int (AQ + 0x30)) (mword_of_int 2 : mword 6) D3
              1%Qp
    ...
    iApply (wp_cret_s_zca_scfg_r Rg γc Φ (mword_of_int (AQ + 0x32)) (mword_of_int 1 : mword 5) D4
              (dq:=DfracOwn 1)
 ltac:(vm_compute; discriminate)

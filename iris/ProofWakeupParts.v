...
Section ProofWakeupPartsPro.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.wakeup + 0x18)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 2058 : mword 12)
    ...
    set (R5 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg (add_vec (R4 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 2058 : mword 12)))]> R4).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.wakeup + 0x24)) (mword_of_int 19 : mword 5) (mword_of_int 19 : mword 5) (mword_of_int 510 : mword 12)
    ...
    set (R9 := <[Regidx (mword_of_int 19 : mword 5) := regval_into_reg (add_vec (R8 !!! Regidx (mword_of_int 19 : mword 5)) (sign_extend' 64 (mword_of_int 510 : mword 12)))]> R8).

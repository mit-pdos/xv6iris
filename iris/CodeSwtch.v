...
Lemma swi_00 : kernel_text -∗ instr (mword_of_int (KernelSyms.swtch + 0x00) : mword 64) false (STORE (mword_of_int 0 : mword 12, Regidx (mword_of_int 1), Regidx (mword_of_int 10), 8)).
Proof. mk_base (KernelSyms.swtch + 0x00)%Z (mword_of_int 0x00153023 : mword 32) (mword_of_int (KernelSyms.swtch + 0x00) : mword 64) (STORE (mword_of_int 0 : mword 12, Regidx (mword_of_int 1), Regidx (mword_of_int 10), 8)) swb_00153023. Qed.
Lemma swi_04 : kernel_text -∗ instr (mword_of_int (KernelSyms.swtch + 0x04) : mword 64) false (STORE (mword_of_int 8 : mword 12, Regidx (mword_of_int 2), Regidx (mword_of_int 10), 8)).
Proof. mk_base (KernelSyms.swtch + 0x04)%Z (mword_of_int 0x00253423 : mword 32) (mword_of_int (KernelSyms.swtch + 0x04) : mword 64) (STORE (mword_of_int 8 : mword 12, Regidx (mword_of_int 2), Regidx (mword_of_int 10), 8)) swb_00253423. Qed.
Lemma swi_08 : kernel_text -∗ instr (mword_of_int (KernelSyms.swtch + 0x08) : mword 64) true (STORE (mword_of_int 16 : mword 12, Regidx (mword_of_int 8), Regidx (mword_of_int 10), 8)).
Proof. mk_rvc (KernelSyms.swtch + 0x08)%Z (mword_of_int 0xe900 : mword 16) (mword_of_int (KernelSyms.swtch + 0x08) : mword 64) (STORE (mword_of_int 16 : mword 12, Regidx (mword_of_int 8), Regidx (mword_of_int 10), 8)) swdc_e900 swx_csd_s0. Qed.
Lemma swi_0a : kernel_text -∗ instr (mword_of_int (KernelSyms.swtch + 0x0a) : mword 64) true (STORE (mword_of_int 24 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 10), 8)).
Proof. mk_rvc (KernelSyms.swtch + 0x0a)%Z (mword_of_int 0xed04 : mword 16) (mword_of_int (KernelSyms.swtch + 0x0a) : mword 64) (STORE (mword_of_int 24 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 10), 8)) swdc_ed04 swx_csd_s1. Qed.
Lemma swi_0c : kernel_text -∗ instr (mword_of_int (KernelSyms.swtch + 0x0c) : mword 64) false (STORE (mword_of_int 32 : mword 12, Regidx (mword_of_int 18), Regidx (mword_of_int 10), 8)).
Proof. mk_base (KernelSyms.swtch + 0x0c)%Z (mword_of_int 0x03253023 : mword 32) (mword_of_int (KernelSyms.swtch + 0x0c) : mword 64) (STORE (mword_of_int 32 : mword 12, Regidx (mword_of_int 18), Regidx (mword_of_int 10), 8)) swb_03253023. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x10)%Z (mword_of_int 0x03353423 : mword 32) (mword_of_int (KernelSyms.swtch + 0x10) : mword 64) (STORE (mword_of_int 40 : mword 12, Regidx (mword_of_int 19), Regidx (mword_of_int 10), 8)) swb_03353423. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x14)%Z (mword_of_int 0x03453823 : mword 32) (mword_of_int (KernelSyms.swtch + 0x14) : mword 64) (STORE (mword_of_int 48 : mword 12, Regidx (mword_of_int 20), Regidx (mword_of_int 10), 8)) swb_03453823. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x18)%Z (mword_of_int 0x03553c23 : mword 32) (mword_of_int (KernelSyms.swtch + 0x18) : mword 64) (STORE (mword_of_int 56 : mword 12, Regidx (mword_of_int 21), Regidx (mword_of_int 10), 8)) swb_03553c23. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x1c)%Z (mword_of_int 0x05653023 : mword 32) (mword_of_int (KernelSyms.swtch + 0x1c) : mword 64) (STORE (mword_of_int 64 : mword 12, Regidx (mword_of_int 22), Regidx (mword_of_int 10), 8)) swb_05653023. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x20)%Z (mword_of_int 0x05753423 : mword 32) (mword_of_int (KernelSyms.swtch + 0x20) : mword 64) (STORE (mword_of_int 72 : mword 12, Regidx (mword_of_int 23), Regidx (mword_of_int 10), 8)) swb_05753423. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x24)%Z (mword_of_int 0x05853823 : mword 32) (mword_of_int (KernelSyms.swtch + 0x24) : mword 64) (STORE (mword_of_int 80 : mword 12, Regidx (mword_of_int 24), Regidx (mword_of_int 10), 8)) swb_05853823. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x28)%Z (mword_of_int 0x05953c23 : mword 32) (mword_of_int (KernelSyms.swtch + 0x28) : mword 64) (STORE (mword_of_int 88 : mword 12, Regidx (mword_of_int 25), Regidx (mword_of_int 10), 8)) swb_05953c23. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x2c)%Z (mword_of_int 0x07a53023 : mword 32) (mword_of_int (KernelSyms.swtch + 0x2c) : mword 64) (STORE (mword_of_int 96 : mword 12, Regidx (mword_of_int 26), Regidx (mword_of_int 10), 8)) swb_07a53023. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x30)%Z (mword_of_int 0x07b53423 : mword 32) (mword_of_int (KernelSyms.swtch + 0x30) : mword 64) (STORE (mword_of_int 104 : mword 12, Regidx (mword_of_int 27), Regidx (mword_of_int 10), 8)) swb_07b53423. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x34)%Z (mword_of_int 0x0005b083 : mword 32) (mword_of_int (KernelSyms.swtch + 0x34) : mword 64) (LOAD (mword_of_int 0 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 1), false, 8)) swb_0005b083. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x38)%Z (mword_of_int 0x0085b103 : mword 32) (mword_of_int (KernelSyms.swtch + 0x38) : mword 64) (LOAD (mword_of_int 8 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 2), false, 8)) swb_0085b103. Qed.
...
Proof. mk_rvc (KernelSyms.swtch + 0x3c)%Z (mword_of_int 0x6980 : mword 16) (mword_of_int (KernelSyms.swtch + 0x3c) : mword 64) (LOAD (mword_of_int 16 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 8), false, 8)) swdc_6980 swx_cld_s0. Qed.
...
Proof. mk_rvc (KernelSyms.swtch + 0x3e)%Z (mword_of_int 0x6d84 : mword 16) (mword_of_int (KernelSyms.swtch + 0x3e) : mword 64) (LOAD (mword_of_int 24 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 9), false, 8)) swdc_6d84 swx_cld_s1. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x40)%Z (mword_of_int 0x0205b903 : mword 32) (mword_of_int (KernelSyms.swtch + 0x40) : mword 64) (LOAD (mword_of_int 32 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 18), false, 8)) swb_0205b903. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x44)%Z (mword_of_int 0x0285b983 : mword 32) (mword_of_int (KernelSyms.swtch + 0x44) : mword 64) (LOAD (mword_of_int 40 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 19), false, 8)) swb_0285b983. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x48)%Z (mword_of_int 0x0305ba03 : mword 32) (mword_of_int (KernelSyms.swtch + 0x48) : mword 64) (LOAD (mword_of_int 48 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 20), false, 8)) swb_0305ba03. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x4c)%Z (mword_of_int 0x0385ba83 : mword 32) (mword_of_int (KernelSyms.swtch + 0x4c) : mword 64) (LOAD (mword_of_int 56 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 21), false, 8)) swb_0385ba83. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x50)%Z (mword_of_int 0x0405bb03 : mword 32) (mword_of_int (KernelSyms.swtch + 0x50) : mword 64) (LOAD (mword_of_int 64 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 22), false, 8)) swb_0405bb03. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x54)%Z (mword_of_int 0x0485bb83 : mword 32) (mword_of_int (KernelSyms.swtch + 0x54) : mword 64) (LOAD (mword_of_int 72 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 23), false, 8)) swb_0485bb83. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x58)%Z (mword_of_int 0x0505bc03 : mword 32) (mword_of_int (KernelSyms.swtch + 0x58) : mword 64) (LOAD (mword_of_int 80 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 24), false, 8)) swb_0505bc03. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x5c)%Z (mword_of_int 0x0585bc83 : mword 32) (mword_of_int (KernelSyms.swtch + 0x5c) : mword 64) (LOAD (mword_of_int 88 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 25), false, 8)) swb_0585bc83. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x60)%Z (mword_of_int 0x0605bd03 : mword 32) (mword_of_int (KernelSyms.swtch + 0x60) : mword 64) (LOAD (mword_of_int 96 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 26), false, 8)) swb_0605bd03. Qed.
...
Proof. mk_base (KernelSyms.swtch + 0x64)%Z (mword_of_int 0x0685bd83 : mword 32) (mword_of_int (KernelSyms.swtch + 0x64) : mword 64) (LOAD (mword_of_int 104 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 27), false, 8)) swb_0685bd83. Qed.

(* CodeMemsetAux.v -- the machine code of xv6's memset(): the decodings of all 16
   instructions (0x80000ccc .. 0x80000cf0), discharged from [kernel_text].

...
Section perm.
  ...
  Definition perm_inv (γP : gname) : iProp Σ := inv permN (perm_inv_body γP).

  Global Instance perm_inv_persistent γP : Persistent (perm_inv γP).
  ...
  Lemma perm_inv_alloc E γP : perm_inv_body γP ={E}=∗ perm_inv γP.

...
Section ProofKwait.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0xfe)) Ra0 Ra0 (mword_of_int 246 : mword 12)
    ...
    set (T1 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (T0 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 246 : mword 12)))]> T0).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (T0 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 246 : mword 12)))]> T0) with T1.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x102)) Rra
              (mword_of_int 2091398 : mword 21) T1 (trap_res eb + (K - 10))%nat false
    ...
    assert (Hjrel : add_vec (mword_of_int (KW + 0x102) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091398 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x96)) Rra
              (mword_of_int 2091506 : mword 21) U0 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr1 : add_vec (mword_of_int (KW + 0x96) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091506 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x9e)) Ra0 Ra0 (mword_of_int 342 : mword 12)
    ...
    set (U3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (U2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 342 : mword 12)))]> U2).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (U2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 342 : mword 12)))]> U2) with U3.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0xa2)) Rra
              (mword_of_int 2091494 : mword 21) U3 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr2 : add_vec (mword_of_int (KW + 0xa2) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091494 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
  ...
  Local Lemma kw_reap `{GEN : GenId} `{CIDp : CpuId} `{XI : CurCtx}
    ...
    wp_next eb pme (fun (CID : CpuId) =>
      ...
      ∀ (mf : regfile) (cs' : gset gname),
        ...
        wait_ans pidc (xstate_val xsw) cs cs' -∗
        sie_cap_gpr KT1 mf K eb pme -∗
        cpu_own 0 eb pme eb lks -∗
        pc_is (ret_pc (mm !!! Regidx Rra)) -∗
        ch_frag γrow pme cs' -∗
  ...
  Proof.
    ...
    iIntros "Hcg Hown Hpay1 Hpay0 #Htext Hpc #Henv #Hplk #Hlkk Htokk Hstate Hpsg Hchan
             Hkilled Hxstate Hpidq Hdorm Hpark #Hmk #Hlk Htok Hcols Hmyrow Hframe Hcont".
    ...
    { iExists kl, xsw, pidc. iFrame "Hkilled Hxstate Hpidq". }
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x6c)) Rra
              (mword_of_int 2091548 : mword 21) R2 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr1 : add_vec (mword_of_int (KW + 0x6c) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091548 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjr1) in "Hpc".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x74)) Ra0 Ra0 (mword_of_int 384 : mword 12)
    ...
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 384 : mword 12)))]> R4).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 384 : mword 12)))]> R4) with R5.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x78)) Rra
              (mword_of_int 2091536 : mword 21) R5 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr2 : add_vec (mword_of_int (KW + 0x78) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091536 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjr2) in "Hpc".
    ...
    - (* ===== addr == 0: no copyout, straight to the reaping tail ===== *)
      ...
      iApply (kw_reap γs γa γp γw γk mm F0 pme k K eb pidc kl xs ch ps γrow cs lks
                ...
                with "Hcg Hown Hpay1 Hpay0 Htext Hpc Henv Hplk Hlkk Htokk Hstate Hpsg Hchan
                      Hkilled Hxstate Hpidhalf Hdorm Hpark Hmk Hlk Htok Hcols Hmyrow Hframe
                      [Hcont Hpriv]").
    ...
    - (* ===== addr != 0: copyout(p->pagetable, addr, &pp->xstate, 4) ===== *)
      ...
      + (* ===== copyout failed: unwind both locks, return -1 ===== *)
        ...
        (* a copyout that could not place the status reaps nothing: the row
           is untouched and there is no escrow to hand over. *)
        { iApply wait_ans_neg. }
    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      + (* ===== our child: take its lock and look at its state ===== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xba)) Rra
                  (mword_of_int 2091334 : mword 21) S1 (trap_res eb + (K - 10))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjacq : add_vec (mword_of_int (KW + 0xba) : mword 64)
                          (sign_extend' 64 (mword_of_int 2091334 : mword 21))
        ...
        * (* ===== not a ZOMBIE: release, set havekids, continue ===== *)
          ...
          iApply (wp_jal_s_sconf (mword_of_int (KW + 0xc6)) Rra
                    (mword_of_int 2091458 : mword 21) S4 (trap_res eb + (K - 10))%nat false
                    ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc []").
          ...
          assert (Hjrel : add_vec (mword_of_int (KW + 0xc6) : mword 64)
                            (sign_extend' 64 (mword_of_int 2091458 : mword 21))
                          = mword_of_int KernelSyms.release)
            by (apply bv_eq; vm_compute; reflexivity).
          iEval (rewrite Hjrel) in "Hpc".
    ...
    - (* ===== there are kids: ask whether we were killed ===== *)
      ...
      + (* ===== still alive: sleep on p, then scan again ===== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xe0)) Rra
                  (mword_of_int 2091432 : mword 21) T4 (trap_res eb + (K - 10))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjrl : add_vec (mword_of_int (KW + 0xe0) : mword 64)
                         (sign_extend' 64 (mword_of_int 2091432 : mword 21))
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xea)) Rra
                  (mword_of_int 2091286 : mword 21) T7 (K - 10)%nat eb
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjaq : add_vec (mword_of_int (KW + 0xea) : mword 64)
                         (sign_extend' 64 (mword_of_int 2091286 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0xf4)) Rs1 Rs1
              (mword_of_int 1304 : mword 12) D1 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (D2 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (D1 !!! Regidx Rs1)
                     (sign_extend' 64 (mword_of_int 1304 : mword 12)))]> D1).
    change (<[Regidx Rs1 := regval_into_reg
                  (add_vec (D1 !!! Regidx Rs1)
                     (sign_extend' 64 (mword_of_int 1304 : mword 12)))]> D1) with D2.
...
Section ProofKwaitMain.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x22)) Ra0 Ra0 (mword_of_int 466 : mword 12)
    ...
    set (P6 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (P5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 466 : mword 12)))]> P5).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (P5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 466 : mword 12)))]> P5) with P6.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x26)) Rra
              (mword_of_int 2091482 : mword 21) P6 (av - 10)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x32)) Rs3 Rs3 (mword_of_int 4058 : mword 12)
    ...
    set (Q3 := <[Regidx Rs3 := regval_into_reg
                  (add_vec (Q2 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 4058 : mword 12)))]> Q2).
    change (<[Regidx Rs3 := regval_into_reg
                  (add_vec (Q2 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 4058 : mword 12)))]> Q2) with Q3.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x3a)) Rs6 Rs6 (mword_of_int 442 : mword 12)
    ...
    set (Q5 := <[Regidx Rs6 := regval_into_reg
                  (add_vec (Q4 !!! Regidx Rs6) (sign_extend' 64 (mword_of_int 442 : mword 12)))]> Q4).
    change (<[Regidx Rs6 := regval_into_reg
                  (add_vec (Q4 !!! Regidx Rs6) (sign_extend' 64 (mword_of_int 442 : mword 12)))]> Q4) with Q5.

...
Section ProofKwait.
  ...
  Definition kw_exit_fn `{GEN : GenId} (CID0 : CPU)
    ...
    (wp_next (CID0 := CID0) eb pme (fun (CID : CpuId) =>
      (* the image moves: kwait's copyout writes the status word into user
         memory (milestone J item 1's ∃-weakened staging) *)
      ∀ (mf : regfile) (P' : uptd) (rv : mword 32) (Mx : gmap Z (bv 8)),
        ⌜ callee_saved mm mf ⌝ -∗
        ...
        proc_priv γf pme pid (upd_usM (us_upt U P') Mx) -∗
  ...
  Definition kw_round `{GEN : GenId} (CID0 : CPU)
    ...
    (wp_next (CID0 := CID0) true pme (fun (CID : CpuId) =>
      ∀ (M : regfile),
        ...
        kw_exit_fn CID γf mm pme K eb pid U lks -∗
        WP (Loop : expr riscv_lang)))%I.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x102)) Rra
              (mword_of_int 2091466 : mword 21) T1 (trap_res eb + (K - 10))%nat false
    ...
    assert (Hjrel : add_vec (mword_of_int (KW + 0x102) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091466 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x96)) Rra
              (mword_of_int 2091574 : mword 21) U0 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr1 : add_vec (mword_of_int (KW + 0x96) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091574 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0xa2)) Rra
              (mword_of_int 2091562 : mword 21) U3 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x66)) Rra
              (mword_of_int 2095326 : mword 21) R0 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjfp : add_vec (mword_of_int (KW + 0x66) : mword 64)
                     (sign_extend' 64 (mword_of_int 2095326 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x6c)) Rra
              (mword_of_int 2091616 : mword 21) R2 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x78)) Rra
              (mword_of_int 2091604 : mword 21) R5 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjr2 : add_vec (mword_of_int (KW + 0x78) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091604 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjr2) in "Hpc".
  ...
  Local Lemma kw_found `{GEN : GenId} `{CIDf : CpuId}
    ...
    kw_frame sp0 mm -∗
    wp_next eb pme (fun (CID : CpuId) =>
      (* the image moves: kwait's copyout writes the status word *)
      ∀ (mf : regfile) (P' : uptd) (rv : mword 32) (Mx : gmap Z (bv 8)),
        ⌜ callee_saved mm mf ⌝ -∗
        ⌜ mf !!! Regidx Ra0 = sign_extend' 64 rv ⌝ -∗
        ⌜ uptd_ext_sz (pv_sz (us_V U)) (pv_upt (us_V U)) P' ⌝ -∗
  ...
  Proof.
    ...
    - (* ===== addr == 0: no copyout, straight to the reaping tail ===== *)
      ...
      iApply ("Hcont" $! mf (pv_upt (us_V U)) pidc (us_M U) with "[%] [%] [%] Hcg Hown Hpc [Hpriv]").
      { exact Hcsf. }
      { exact Ha0. }
    ...
    - (* ===== addr != 0: copyout(p->pagetable, addr, &pp->xstate, 4) ===== *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KW + 0x58)) Rra
                (mword_of_int 2093894 : mword 21) F5 (trap_res eb + (K - 10))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      assert (Hjco : add_vec (mword_of_int (KW + 0x58) : mword 64)
                       (sign_extend' 64 (mword_of_int 2093894 : mword 21))
      ...
      iApply (Copyout.wp_copyout_sconf KT0 γa F6 (pv_upt (us_V U)) (pv_sz (us_V U)) 4%nat
      ...
      iDestruct ("Hback" $! P' Mo with "[%] Hsz Hpg Hpt") as "Hpriv"; [exact Hext |].
      iAssert (proc_pub (proc_addr k)) with "[Hkilled Hxstate Hpidhalf]" as "Hpub".
      { iExists kl, xs, pidc. iFrame "Hkilled Hxstate Hpidhalf". }
      ...
      + (* ===== copyout failed: unwind both locks, return -1 ===== *)
        ...
        iIntros (CIDz) "%Hsz". iIntros (mf) "%Hcsf %Ha0 Hcg Hown Hpc".
        iSpecialize ("Hcont" $! CIDz with "[%]"); [wp_next_chain |].
        iApply ("Hcont" $! mf P' (mword_of_int (-1) : mword 32) Mo
      ...
      + (* ===== copyout succeeded: fall through to the reaping tail ===== *)
        ...
        iIntros (CIDz) "%Hsz". iIntros (mf) "%Hcsf %Ha0 Hcg Hown Hpc".
        iSpecialize ("Hcont" $! CIDz with "[%]"); [wp_next_chain |].
        iApply ("Hcont" $! mf P' pidc Mo with "[%] [%] [%] Hcg Hown Hpc Hpriv").
        { exact Hcsf. }
        { exact Ha0. }
        { exact Hext. }
  Qed.
  ...
  Local Lemma kw_scan `{GEN : GenId} `{CID0 : CpuId}
    ...
    ∀ (kk : nat) (M : regfile) (hv : mword 64) (ps : list (mword 64)),
      ...
      kw_exit_fn CID0 γf mm pme K eb pid U lks -∗
    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      + (* ===== our child: take its lock and look at its state ===== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xba)) Rra
                  (mword_of_int 2091402 : mword 21) S1 (trap_res eb + (K - 10))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        * (* ===== ZOMBIE: reap it (the function EXITS here) ===== *)
          ...
          iApply (kw_found γs γa γf γw γk mm S3 pme kk K eb pid U ch ps
                    ({["proc"]} ∪ ({["wait_lock"]} ∪ lks))
        ...
        * (* ===== not a ZOMBIE: release, set havekids, continue ===== *)
          ...
          iApply (wp_jal_s_sconf (mword_of_int (KW + 0xc6)) Rra
                    (mword_of_int 2091526 : mword 21) S4 (trap_res eb + (K - 10))%nat false
                    ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                    with "Hcg Hpc []").
          ...
          assert (Hjrel : add_vec (mword_of_int (KW + 0xc6) : mword 64)
                            (sign_extend' 64 (mword_of_int 2091526 : mword 21))
                          = mword_of_int KernelSyms.release)
            by (apply bv_eq; vm_compute; reflexivity).
          iEval (rewrite Hjrel) in "Hpc".
  ...
  Local Lemma kw_exit_neg `{GEN : GenId} `{CIDt : CpuId}
    ...
    kernel_text -∗
    is_lock γw wait_lock_addr "wait_lock"%string wait_res -∗
    kw_exit_fn CIDt γf mm pme K eb pid U lks -∗
    sie_cap_gpr KT1 Mt (trap_res eb + (K - 10))%nat false pme -∗
    cpu_own 1 eb pme false ({["wait_lock"]} ∪ lks) -∗
    arm_pay KT1 0 eb pme -∗
    pc_is (mword_of_int (KW + 0xfa)) -∗
  ...
  Proof.
    ...
    iApply ("Hqfn" $! mf (pv_upt (us_V U)) (mword_of_int (-1) : mword 32) (us_M U)
  ...
  Proof.
    ...
    - (* ===== no kids at all: return -1 ===== *)
      ...
      iApply (kw_exit_neg γf γw jj mm Mx (proc_addr jj) K eb pid U px lks HK Hsp Hcs Hbelow
    ...
    - (* ===== there are kids: ask whether we were killed ===== *)
      ...
      + (* ===== killed: return -1 ===== *)
        ...
        assert (Htgec' : add_vec (mword_of_int (KW + 0xd6) : mword 64)
                         ...
                         = mword_of_int (KW + 0xfa)) by pcstep.
        iEval (rewrite Htgec') in "Hpc".
        iApply (kw_exit_neg γf γw jj mm mfk (proc_addr jj) K eb pid U px lks HK Hksp Hkcsr Hbelow
                  with "Htext Hlk Hqfn Hcg Hown Hpay Hpc Htok Hps Hpriv Hframe").
      + (* ===== still alive: sleep on p, then scan again ===== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xe0)) Rra
                  (mword_of_int 2091500 : mword 21) T4 (trap_res eb + (K - 10))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KW + 0xea)) Rra
                  (mword_of_int 2091354 : mword 21) T7 (K - 10)%nat eb
                  ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjaq : add_vec (mword_of_int (KW + 0xea) : mword 64)
                         (sign_extend' 64 (mword_of_int 2091354 : mword 21))
  ...
  Local Lemma kw_round_body `{GEN : GenId} `{CIDy : CpuId} (CID0 : CPU)
    ...
    is_lock γw wait_lock_addr "wait_lock"%string wait_res -∗
    ▷ kw_round CID0 γf γw jj mm pme addr K eb pid U lks -∗
    kw_exit_fn CIDy γf mm pme K eb pid U lks -∗
    sie_cap_gpr KT1 M (trap_res eb + (K - 10))%nat false pme -∗
    cpu_own 1 eb pme false ({["wait_lock"]} ∪ lks) -∗
    arm_pay KT1 0 eb pme -∗
    pc_is (mword_of_int (KW + 0xee)) -∗
  ...
  Proof.
    ...
    iDestruct (kw_scan (CID0 := CIDy)  γs γa γf γw mm pme addr K eb pid U lks
...
Section ProofKwaitMain.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x18)) Rra
              (mword_of_int 2094924 : mword 21) P2 (av - 10)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjmy : add_vec (mword_of_int (KW + 0x18) : mword 64)
                     (sign_extend' 64 (mword_of_int 2094924 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KW + 0x26)) Rra
              (mword_of_int 2091550 : mword 21) P6 (av - 10)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjacq : add_vec (mword_of_int (KW + 0x26) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091550 : mword 21))
                    = mword_of_int KernelSyms.acquire) by pcstep.
    iEval (rewrite Hjacq) in "Hpc".
    ...
    iAssert (kw_exit_fn CID19 γf m pj av eb pid U lks)
      with "[Hcont]" as "Hqfn".
    { rewrite /kw_exit_fn.
      iIntros (CIDx Hsx mf P' rv Mx) "%Hcsx %Ha0x %Hextx Hcgx Hownx Hpcx Hprivx".
      iSpecialize ("Hcont" $! CIDx with "[%]"); [wp_next_chain |].
      iApply ("Hcont" $! mf P' rv Mx with "[%] [%] Hcgx Hownx Hpcx Hprivx").
    ...
    { iLöb as "IH". rewrite /kw_round.
      ...
      iApply (kw_round_body (CIDy := CIDz) CID γs γa γf γw γl j m N pj adr av eb pid U lks

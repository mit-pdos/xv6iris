...
Section ProofKwait.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0xfe)) Ra0 Ra0 (mword_of_int 266 : mword 12)
    ...
    set (T1 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (T0 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 266 : mword 12)))]> T0).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (T0 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 266 : mword 12)))]> T0) with T1.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x9e)) Ra0 Ra0 (mword_of_int 362 : mword 12)
    ...
    set (U3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (U2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 362 : mword 12)))]> U2).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (U2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 362 : mword 12)))]> U2) with U3.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x74)) Ra0 Ra0 (mword_of_int 404 : mword 12)
    ...
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 404 : mword 12)))]> R4).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 404 : mword 12)))]> R4) with R5.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0xf4)) Rs1 Rs1
              (mword_of_int 1324 : mword 12) D1 (trap_res eb + (K - 10))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (D2 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (D1 !!! Regidx Rs1)
                     (sign_extend' 64 (mword_of_int 1324 : mword 12)))]> D1).
    change (<[Regidx Rs1 := regval_into_reg
                  (add_vec (D1 !!! Regidx Rs1)
                     (sign_extend' 64 (mword_of_int 1324 : mword 12)))]> D1) with D2.
...
Section ProofKwaitMain.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x22)) Ra0 Ra0 (mword_of_int 486 : mword 12)
    ...
    set (P6 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (P5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 486 : mword 12)))]> P5).
    change (<[Regidx Ra0 := regval_into_reg
                  (add_vec (P5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 486 : mword 12)))]> P5) with P6.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x32)) Rs3 Rs3 (mword_of_int 4078 : mword 12)
    ...
    set (Q3 := <[Regidx Rs3 := regval_into_reg
                  (add_vec (Q2 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 4078 : mword 12)))]> Q2).
    change (<[Regidx Rs3 := regval_into_reg
                  (add_vec (Q2 !!! Regidx Rs3) (sign_extend' 64 (mword_of_int 4078 : mword 12)))]> Q2) with Q3.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KW + 0x3a)) Rs6 Rs6 (mword_of_int 462 : mword 12)
    ...
    set (Q5 := <[Regidx Rs6 := regval_into_reg
                  (add_vec (Q4 !!! Regidx Rs6) (sign_extend' 64 (mword_of_int 462 : mword 12)))]> Q4).
    change (<[Regidx Rs6 := regval_into_reg
                  (add_vec (Q4 !!! Regidx Rs6) (sign_extend' 64 (mword_of_int 462 : mword 12)))]> Q4) with Q5.

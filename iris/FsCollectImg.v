...
(* THE SUPERBLOCK'S BLOCK IS A HOME BLOCK, which is the half of
   ...
   value.  WHAT IS NOT PURE, and what the era does not supply today, is
   [sk_parse] and [SB_BNO ∈ used] -- see the gap note in FsCollect.v's
   header: nobody OWNS block 1's byte run after [fsinit] returns it. *)

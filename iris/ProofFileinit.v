...
Section CodeFileinitBundle.
  ...
  Lemma fii_code :
    kernel_text -∗ ilw_code KernelSyms.fileinit (mword_of_int 3) (mword_of_int 30)
                            (mword_of_int 1294) (mword_of_int 1118) (mword_of_int 2083520).
  Proof.
...
Section ProofFileinit.
  ...
  Proof.
    ...
    iApply (ILW.wp_initlock_wrapper_sconf KT1 m K KernelSyms.fileinit
              (mword_of_int 3) (mword_of_int 30) (mword_of_int 1294) (mword_of_int 1118)
              (mword_of_int 2083520) lk name "ftable"%string vlock vname vcpu b p HK

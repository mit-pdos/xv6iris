(* ProofSysUnlinkW3.v -- the unlink AU walk's BLOCKS W4 and W3: the
   ...
   [ProofSysUnlinkPure.su_w4_loop] / [su_w4] / [su_w3]'s copy-adapt, at
   [SysUnlinkDefs]'s contract.  W4 comes first because W3's T_DIR arm
...
Module SysUnlinkW3 (Ilock : ILOCK) (Readi : READI)
...
Section ProofSysUnlinkW3.
 ...
 gf ki inumi dni bmi dati pidv dq dpv ipv
  ...
  (* W3'S SEAM, NAMED.  claude-notes/optimization.md, "Fold block
     continuations into named definitions" and the ProofSysUnlinkPure case study

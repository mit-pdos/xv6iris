...
Section CodeKalloc.
  ...
  Proof. mk_rvc (KA + 0x00)%Z (mword_of_int 0x1101 : mword 16)
    (mword_of_int (KA + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_1101 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (KA + 0x02)%Z (mword_of_int 0xec06 : mword 16)
    (mword_of_int (KA + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) cdec_ec06 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KA + 0x04)%Z (mword_of_int 0xe822 : mword 16)
    (mword_of_int (KA + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) cdec_e822 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KA + 0x06)%Z (mword_of_int 0xe426 : mword 16)
    (mword_of_int (KA + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) cdec_e426 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KA + 0x08)%Z (mword_of_int 0x1000 : mword 16)
    (mword_of_int (KA + 0x08) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_1000 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_base (KA + 0x0a)%Z (mword_of_int 0x00011517 : mword 32)
    (mword_of_int (KA + 0x0a) : mword 64) (UTYPE (mword_of_int 0x11 : mword 20, Regidx (mword_of_int 10), AUIPC)) bdec_00011517. Qed.

  Lemma kai_0e : kernel_text -∗ instr (mword_of_int (KA + 0x0e) : mword 64) false (ITYPE (mword_of_int 0x7f0 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KA + 0x0e)%Z (mword_of_int 0x7f050513 : mword 32)
    (mword_of_int (KA + 0x0e) : mword 64) (ITYPE (mword_of_int 0x7f0 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kdb_7f050513. Qed.
  ...
  Lemma kai_16 : kernel_text -∗ instr (mword_of_int (KA + 0x16) : mword 64) false (UTYPE (mword_of_int 0x11 : mword 20, Regidx (mword_of_int 9), AUIPC)).
  Proof. mk_base (KA + 0x16)%Z (mword_of_int 0x00011497 : mword 32)
    (mword_of_int (KA + 0x16) : mword 64) (UTYPE (mword_of_int 0x11 : mword 20, Regidx (mword_of_int 9), AUIPC)) bdec_00011497. Qed.

  Lemma kai_1a : kernel_text -∗ instr (mword_of_int (KA + 0x1a) : mword 64) false (LOAD (mword_of_int 0x7fc : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), false, 8)).
  Proof. mk_base (KA + 0x1a)%Z (mword_of_int 0x7fc4b483 : mword 32)
    (mword_of_int (KA + 0x1a) : mword 64) (LOAD (mword_of_int 0x7fc : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), false, 8)) kdb_7fc4b483. Qed.
  ...
  Proof. mk_rvc (KA + 0x1e)%Z (mword_of_int 0xc49d : mword 16)
  ...
  Proof. mk_base (KA + 0x26)%Z (mword_of_int 0x7ef73823 : mword 32)
    (mword_of_int (KA + 0x26) : mword 64) (STORE (mword_of_int 0x7f0 : mword 12, Regidx (mword_of_int 15), Regidx (mword_of_int 14), 8)) kdb_7ef73823. Qed.
  ...
  Proof. mk_base (KA + 0x2a)%Z (mword_of_int 0x00011517 : mword 32)
    (mword_of_int (KA + 0x2a) : mword 64) (UTYPE (mword_of_int 0x11 : mword 20, Regidx (mword_of_int 10), AUIPC)) bdec_00011517. Qed.

  Lemma kai_2e : kernel_text -∗ instr (mword_of_int (KA + 0x2e) : mword 64) false (ITYPE (mword_of_int 0x7d0 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KA + 0x2e)%Z (mword_of_int 0x7d050513 : mword 32)
    (mword_of_int (KA + 0x2e) : mword 64) (ITYPE (mword_of_int 0x7d0 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kdb_7d050513. Qed.
  ...
  Proof. mk_rvc (KA + 0x36)%Z (mword_of_int 0x6605 : mword 16)
    (mword_of_int (KA + 0x36) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 12), LUI)) cdec_6605 exec_execute_C_LUI. Qed.
  ...
  Proof. mk_rvc (KA + 0x38)%Z (mword_of_int 0x4595 : mword 16)
  ...
  Proof. mk_rvc (KA + 0x3a)%Z (mword_of_int 0x8526 : mword 16)
    (mword_of_int (KA + 0x3a) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) cdec_8526 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KA + 0x40)%Z (mword_of_int 0x8526 : mword 16)
    (mword_of_int (KA + 0x40) : mword 64) (RTYPE (Regidx (mword_of_int 9), zreg, Regidx (mword_of_int 10), ADD)) cdec_8526 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KA + 0x42)%Z (mword_of_int 0x60e2 : mword 16)
    (mword_of_int (KA + 0x42) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_60e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KA + 0x44)%Z (mword_of_int 0x6442 : mword 16)
    (mword_of_int (KA + 0x44) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_6442 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KA + 0x46)%Z (mword_of_int 0x64a2 : mword 16)
    (mword_of_int (KA + 0x46) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) cdec_64a2 exec_execute_C_LDSP. Qed.

  Lemma kai_48 : kernel_text -∗ instr (mword_of_int (KA + 0x48) : mword 64) true (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)).
  Proof. mk_rvc (KA + 0x48)%Z (mword_of_int 0x6105 : mword 16)
    (mword_of_int (KA + 0x48) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) cdec_6105 exec_execute_C_ADDI16SP. Qed.

  Lemma kai_4a : kernel_text -∗ instr (mword_of_int (KA + 0x4a) : mword 64) true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).
  Proof. mk_rvc (KA + 0x4a)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (KA + 0x4a) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.
  ...
  Proof. mk_base (KA + 0x4c)%Z (mword_of_int 0x00011517 : mword 32)
    (mword_of_int (KA + 0x4c) : mword 64) (UTYPE (mword_of_int 0x11 : mword 20, Regidx (mword_of_int 10), AUIPC)) bdec_00011517. Qed.
  ...
  Proof. mk_rvc (KA + 0x58)%Z (mword_of_int 0xb7e5 : mword 16)
    (mword_of_int (KA + 0x58) : mword 64) (JAL (sign_extend' 21 (concat_vec (mword_of_int 2036 : mword 11) ('b"0")), zreg)) cdec_b7e5 exec_execute_C_J. Qed.
  ...
  Proof. mk_rvc (KF + 0x00)%Z (mword_of_int 0x1101 : mword 16)
    (mword_of_int (KF + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 32 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_1101 exec_execute_C_ADDI. Qed.
  ...
  Proof. mk_rvc (KF + 0x02)%Z (mword_of_int 0xec06 : mword 16)
    (mword_of_int (KF + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) cdec_ec06 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x04)%Z (mword_of_int 0xe822 : mword 16)
    (mword_of_int (KF + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) cdec_e822 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x06)%Z (mword_of_int 0xe426 : mword 16)
    (mword_of_int (KF + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) cdec_e426 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x08)%Z (mword_of_int 0xe04a : mword 16)
    (mword_of_int (KF + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) cdec_e04a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x0a)%Z (mword_of_int 0x1000 : mword 16)
    (mword_of_int (KF + 0x0a) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 8 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_1000 exec_execute_C_ADDI4SPN. Qed.
  ...
  Lemma kfi_10 : kernel_text -∗ instr (mword_of_int (KF + 0x10) : mword 64) false (ITYPE (mword_of_int 0xb06 : mword 12, Regidx (mword_of_int 15), Regidx (mword_of_int 15), ADDI)).
  Proof. mk_base (KF + 0x10)%Z (mword_of_int 0xb0678793 : mword 32)
    (mword_of_int (KF + 0x10) : mword 64) (ITYPE (mword_of_int 0xb06 : mword 12, Regidx (mword_of_int 15), Regidx (mword_of_int 15), ADDI)) kdb_b0678793. Qed.
  ...
  Proof. mk_rvc (KF + 0x18)%Z (mword_of_int 0x47c5 : mword 16)
    (mword_of_int (KF + 0x18) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 17 : mword 6), zreg, Regidx (mword_of_int 15), ADDI)) cdec_47c5 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (KF + 0x1a)%Z (mword_of_int 0x07ee : mword 16)
    (mword_of_int (KF + 0x1a) : mword 64) (SHIFTIOP (mword_of_int 27 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) cdec_07ee exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (KF + 0x22)%Z (mword_of_int 0x8fd9 : mword 16)
    (mword_of_int (KF + 0x22) : mword 64) (RTYPE (creg2reg_idx (Cregidx (mword_of_int 6)), creg2reg_idx (Cregidx (mword_of_int 7)), creg2reg_idx (Cregidx (mword_of_int 7)), OR)) cdec_8fd9 exec_execute_C_OR. Qed.
  ...
  Proof. mk_rvc (KF + 0x24)%Z (mword_of_int 0xef95 : mword 16)
  ...
  Proof. mk_rvc (KF + 0x26)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (KF + 0x26) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) cdec_84aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KF + 0x2c)%Z (mword_of_int 0xeb95 : mword 16)
  ...
  Proof. mk_rvc (KF + 0x2e)%Z (mword_of_int 0x6605 : mword 16)
    (mword_of_int (KF + 0x2e) : mword 64) (UTYPE (sign_extend' 20 (mword_of_int 1 : mword 6), Regidx (mword_of_int 12), LUI)) cdec_6605 exec_execute_C_LUI. Qed.
  ...
  Proof. mk_rvc (KF + 0x30)%Z (mword_of_int 0x4585 : mword 16)
    (mword_of_int (KF + 0x30) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 1 : mword 6), zreg, Regidx (mword_of_int 11), ADDI)) cdec_4585 exec_execute_C_LI. Qed.
  ...
  Lemma kfi_3a : kernel_text -∗ instr (mword_of_int (KF + 0x3a) : mword 64) false (ITYPE (mword_of_int 0x8ac : mword 12, Regidx (mword_of_int 18), Regidx (mword_of_int 18), ADDI)).
  Proof. mk_base (KF + 0x3a)%Z (mword_of_int 0x8ac90913 : mword 32)
    (mword_of_int (KF + 0x3a) : mword 64) (ITYPE (mword_of_int 0x8ac : mword 12, Regidx (mword_of_int 18), Regidx (mword_of_int 18), ADDI)) kdb_8ac90913. Qed.
  ...
  Proof. mk_rvc (KF + 0x3e)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (KF + 0x3e) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) cdec_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KF + 0x4e)%Z (mword_of_int 0x854a : mword 16)
    (mword_of_int (KF + 0x4e) : mword 64) (RTYPE (Regidx (mword_of_int 18), zreg, Regidx (mword_of_int 10), ADD)) cdec_854a exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (KF + 0x54)%Z (mword_of_int 0x60e2 : mword 16)
    (mword_of_int (KF + 0x54) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_60e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x56)%Z (mword_of_int 0x6442 : mword 16)
    (mword_of_int (KF + 0x56) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_6442 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x58)%Z (mword_of_int 0x64a2 : mword 16)
    (mword_of_int (KF + 0x58) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) cdec_64a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KF + 0x5a)%Z (mword_of_int 0x6902 : mword 16)
    (mword_of_int (KF + 0x5a) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) cdec_6902 exec_execute_C_LDSP. Qed.

  Lemma kfi_5c : kernel_text -∗ instr (mword_of_int (KF + 0x5c) : mword 64) true (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)).
  Proof. mk_rvc (KF + 0x5c)%Z (mword_of_int 0x6105 : mword 16)
    (mword_of_int (KF + 0x5c) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 2 : mword 6), sp, sp, ADDI)) cdec_6105 exec_execute_C_ADDI16SP. Qed.

  Lemma kfi_5e : kernel_text -∗ instr (mword_of_int (KF + 0x5e) : mword 64) true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).
  Proof. mk_rvc (KF + 0x5e)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (KF + 0x5e) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.

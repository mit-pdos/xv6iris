...
Section WpUserTrapish.
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 4)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 4))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 8)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 8))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 2)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 2))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 1)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 1))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 8)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 8))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 4)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 4))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 2)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 2))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Proof.
    ...
    assert (Hnlpad : is_lpad_instruction (STORE (imm, Regidx rs2, Regidx rs1, 1)) = false)
      by reflexivity.
    iApply (wp_exec_trapish_u va vpn ie w (STORE (imm, Regidx rs2, Regidx rs1, 1))
              ms_v sc_v stval_v sepc_v g tlbvec E Φ
              HN Hok Hsome Hchk0 HupdN Hpbmt0 Hcw HSXL Hval Hcanon Hvpn_def Hpaal
              HnotRVC Hdec Hnlpad
              with "Hhw Hinv Hhs Hpriv Hms Hsc Hstv Hsepc Htlbc Hpc Hgpr Hupt
  ...
  Lemma ustep_load_pf_4_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_load_pf_8_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_load_pf_2_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_load_pf_1_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs1 rd : mword 5) (imm : mword 12) (is_unsigned : bool)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_store_pf_8_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_store_pf_4_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_store_pf_2_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)
  ...
  Lemma ustep_store_pf_1_noperm_u
      (va : mword 64) (vpn : mword 27) (ie : uwalk_info) (w : mword 32)
      (vpnD : mword 27) (ieD : uwalk_info)
      (rs2 rs1 : mword 5) (imm : mword 12)
      (ms_v sc_v stval_v sepc_v : mword 64)

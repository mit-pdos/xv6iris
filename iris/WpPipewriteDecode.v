(* WpPipewriteDecode.v -- the instruction-DECODE layer for xv6's pipewrite().
...
(* 0x8a32  mv s4,a2 *)
Lemma pwdc_8a32 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
(* 0x4b85  li s7,1 *)
Lemma pwdc_4b85 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
...
Section PipewriteInstrs.
  ...
  Proof. mk_rvc (PW + 0x16)%Z (mword_of_int 0x8a32 : mword 16)
    (mword_of_int (PW + 0x16) : mword 64) (RTYPE (Regidx (mword_of_int 12), zreg, Regidx (mword_of_int 20), ADD)) pwdc_8a32 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (PW + 0x38)%Z (mword_of_int 0x4b85 : mword 16)
    (mword_of_int (PW + 0x38) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 1 : mword 6), zreg, Regidx (mword_of_int 23), ADDI)) pwdc_4b85 exec_execute_C_LI. Qed.

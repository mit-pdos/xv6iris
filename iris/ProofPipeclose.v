...
Section ProofPipeclose.
  ...
  Proof.
    ...
    (* ---- 0x10: jal ra,acquire ---- *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipeclose + 0x10)) (mword_of_int 1 : mword 5) (mword_of_int 2082436 : mword 21)
    ...
    assert (Hpcaq : add_vec (mword_of_int (KernelSyms.pipeclose + 0x10) : mword 64) (sign_extend' 64 (mword_of_int 2082436 : mword 21))
    ...
    iDestruct (cpu_own_transport CID CID9 n eb pme b ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Acquire.wp_acquire_gen_sconf KT1 γl "pipe" (λ ξ : CtxId, pipe_res (XI := ξ) γp pi)
    ...
    { iIntros (M) "%Hcs Hcg Hpc Hown Hpay Hlocked Hres".
      ...
      { iSplit.
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipeclose + 0x32)) (mword_of_int 1 : mword 5) (mword_of_int 2082538 : mword 21)
        ...
        assert (Hpcrl : add_vec (mword_of_int (KernelSyms.pipeclose + 0x32) : mword 64) (sign_extend' 64 (mword_of_int 2082538 : mword 21))
        ...
        iApply (Release.wp_release_gen_sconf KT1 γl pi "pipe" (λ ξ : CtxId, pipe_res (XI := ξ) γp pi) (pipe_dead γl γp) emp%I
      ...
      (* 0x52: jal release *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipeclose + 0x52)) (mword_of_int 1 : mword 5) (mword_of_int 2082506 : mword 21)
      ...
      assert (Hpcrl2 : add_vec (mword_of_int (KernelSyms.pipeclose + 0x52) : mword 64) (sign_extend' 64 (mword_of_int 2082506 : mword 21))
                       = mword_of_int KernelSyms.release) by (apply bv_eq; vm_compute; reflexivity).
      ...
      iEval (rewrite Houtb) in "Hcg".
      iApply (ReleaseCancel.wp_release_cancel_sconf KT1 γl pi "pipe" (λ ξ : CtxId, pipe_res (XI := ξ) γp pi)
      ...
      (* 0x58: jal kfree *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipeclose + 0x58)) (mword_of_int 1 : mword 5) (mword_of_int 2081914 : mword 21)
      ...
      assert (Hpckf : add_vec (mword_of_int (KernelSyms.pipeclose + 0x58) : mword 64) (sign_extend' 64 (mword_of_int 2081914 : mword 21))
    ...
    - (* ===== writable: the branch falls through, the WRITE end closes ===== *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipeclose + 0x20)) (mword_of_int 1 : mword 5) (mword_of_int 2087450 : mword 21)
      ...
      assert (Hpcwk : add_vec (mword_of_int (KernelSyms.pipeclose + 0x20) : mword 64) (sign_extend' 64 (mword_of_int 2087450 : mword 21))
    ...
    - (* ===== not writable: the branch is TAKEN, the READ end closes ===== *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.pipeclose + 0x4a)) (mword_of_int 1 : mword 5) (mword_of_int 2087408 : mword 21)
                W1 (trap_res b + (av - 4))%nat false ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      assert (Hpcwk : add_vec (mword_of_int (KernelSyms.pipeclose + 0x4a) : mword 64) (sign_extend' 64 (mword_of_int 2087408 : mword 21))
                      = mword_of_int KernelSyms.wakeup) by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hpcwk) in "Hpc".

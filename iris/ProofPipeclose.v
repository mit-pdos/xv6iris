...
Section ProofPipeclose.
  ...
  Proof.
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PC + 0x02)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PC + 0x04)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PC + 0x06)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PC + 0x08)) (mword_of_int 0 : mword 6) (mword_of_int 18 : mword 5)
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (PC + 0x0a)) (Cregidx (mword_of_int 0)) (mword_of_int 8 : mword 8) (mword_of_int 8 : mword 5)
    ...
    (* ---- 0x0c: c.mv s1,a0 ---- *)
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PC + 0x0c)) (mword_of_int 9 : mword 5) (mword_of_int 10 : mword 5)
    ...
    (* ---- 0x0e: c.mv s2,a1 ---- *)
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PC + 0x0e)) (mword_of_int 18 : mword 5) (mword_of_int 11 : mword 5)
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (PC + 0x10)) (mword_of_int 1 : mword 5) (mword_of_int 2082744 : mword 21)
    ...
    { iIntros (CID0 M) "%Hch %Hcs Hcg Hpc Hown Hav".
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PC + 0x36)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PC + 0x38)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PC + 0x3a)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PC + 0x3c)) (mword_of_int 0 : mword 6) (mword_of_int 18 : mword 5)
      ...
      iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (PC + 0x3e)) (mword_of_int 2 : mword 6) E4 (av - 4)%nat 4 b Hpop
      ...
      iApply (wp_cret_s_sconf Φ (mword_of_int (PC + 0x40)) (mword_of_int 1 : mword 5) E5 av b
    ...
    { iIntros (M) "%Hcs Hcg Hpc Hown Hpay Hlocked Hres".
      ...
      { iSplit.
        ...
        iApply (wp_cmv_s_sconf Φ (mword_of_int (PC + 0x30)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (PC + 0x32)) (mword_of_int 1 : mword 5) (mword_of_int 2082846 : mword 21)
      ...
      iApply (wp_lw_s_sconf Φ (mword_of_int (PC + 0x24)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
                (mword_of_int 544 : mword 12) M (av - 4)%nat ro false ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi24 [Hro] [-]").
      { iEval (rewrite Hroaddr). iExact "Hro". }
      rewrite wp_next_off. iIntros "Hcg Hpc Hro".
      ...
      { (* ===== the read end is still OPEN: c.bnez taken, plain release ===== *)
        iApply (wp_cbnez_taken_s_sconf Φ (mword_of_int (PC + 0x28)) (mword_of_int 4 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
      ...
      iApply (wp_cbnez_fall_s_sconf Φ (mword_of_int (PC + 0x28)) (mword_of_int 4 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
                J1 (av - 4)%nat false ltac:(vm_compute; reflexivity) ltac:(nz)
      ...
      iApply (wp_lw_s_sconf Φ (mword_of_int (PC + 0x2a)) (mword_of_int 15 : mword 5) (mword_of_int 9 : mword 5)
                (mword_of_int 548 : mword 12) J1 (av - 4)%nat wo false ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi2a [Hwo] [-]").
      { iEval (rewrite Hwoaddr1). iExact "Hwo". }
      rewrite wp_next_off. iIntros "Hcg Hpc Hwo".
      ...
      2:{ (* the write end is still open: fall through to the plain release *)
        iApply (wp_cbeqz_fall_s_sconf Φ (mword_of_int (PC + 0x2e)) (mword_of_int 17 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
      ...
      iApply (wp_cbeqz_taken_s_sconf Φ (mword_of_int (PC + 0x2e)) (mword_of_int 17 : mword 8) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5)
                J2 (av - 4)%nat false ltac:(vm_compute; reflexivity) ltac:(nz)
      ...
      iApply (wp_cmv_s_sconf Φ (mword_of_int (PC + 0x50)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (PC + 0x52)) (mword_of_int 1 : mword 5) (mword_of_int 2082814 : mword 21)
      ...
      iApply (wp_cmv_s_sconf Φ (mword_of_int (PC + 0x56)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (PC + 0x58)) (mword_of_int 1 : mword 5) (mword_of_int 2082222 : mword 21)
      ...
      iApply (wp_cj_s_sconf Φ (mword_of_int (PC + 0x5c))
    ...
    - (* ===== writable: the branch falls through, the WRITE end closes ===== *)
      ...
      iApply (wp_beqz_x0_fall_s_sconf Φ (mword_of_int (PC + 0x14)) (mword_of_int 46 : mword 13)
      ...
      iApply (wp_sw_zero_s_sconf Φ (mword_of_int (PC + 0x18)) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (PC + 0x1c)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (PC + 0x20)) (mword_of_int 1 : mword 5) (mword_of_int 2087666 : mword 21)
      ...
      assert (Hwa0f : mycpu_ret (rget W2 Rtp) = mycpu_ret cid_word)
    ...
    - (* ===== not writable: the branch is TAKEN, the READ end closes ===== *)
      assert (Hbz : eq_vec (rget M0 (mword_of_int 18 : mword 5)) (zero_reg : mword 64) = true)
        by (rgne; rewrite Hs2M0; exact Hw).
      iApply (wp_beqz_x0_taken_s_sconf Φ (mword_of_int (PC + 0x14)) (mword_of_int 46 : mword 13)
      ...
      iApply (wp_sw_zero_s_sconf Φ (mword_of_int (PC + 0x42)) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (PC + 0x46)) (mword_of_int 10 : mword 5) (mword_of_int 9 : mword 5)
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (PC + 0x4a)) (mword_of_int 1 : mword 5) (mword_of_int 2087624 : mword 21)
                W1 (av - 4)%nat false ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi4a [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc".
      ...
      iApply (wp_cj_s_sconf Φ (mword_of_int (PC + 0x4e))

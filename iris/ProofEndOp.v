...
Lemma eo_reloc_log_0c :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0x0c) : mword 64)
          ...
          (sign_extend' 64 (mword_of_int 1752 : mword 12)) = log_addr.
...
Lemma eo_reloc_log_2a :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0x2a) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1722 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma eo_reloc_log_42 :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0x42) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1698 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.
...
Lemma eo_reloc_log_86 :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0x86) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1630 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma eo_reloc_blk0 :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0xa4) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1648 : mword 12)) = lh_block 0.
Proof.
...
Lemma eo_reloc_log_ac :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0xac) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1592 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma eo_reloc_lhn :
  add_vec (add_vec (mword_of_int (KernelSyms.end_op + 0x10e) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1538 : mword 12)) = lh_n_pa.
Proof.
  rewrite /lh_n_pa /log_pa /log_addr /pa_add /add_vec_int.
  apply bv_eq; vm_compute; reflexivity.
Qed.
...
Section EndOpBlocks.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.end_op + 0x46)) Rs1 Rs1
              (mword_of_int 1698 : mword 12) E1 (K - 8)%nat eb
    ...
    pose (E2 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (E1 !!! Regidx Rs1 : mword 64)
                     (sign_extend' 64 (mword_of_int 1698 : mword 12)))]> E1).
  ...
  Proof.
    ...
    pose proof Hregs as (Hsp & Hthr).
    iIntros "Hcg Hcnt Hextc Hextm #Htext #Hkd Hpc #Hpanic #Hpenv #Hbio #Hlctx #Hseam #Hregc Hppid #Hprocs #Hdevi #Hdgeom #Hdlock Hframe HframeS Hmirc
              Hopen Hcont".
    ...
    iApply (WH.wp_write_head_sconf γs j γl γu γd γk pd pav pu bn γfs
              ...
              with "Hcg Hcnt Hextc Hextm Htext Hkd Hpc Hpanic Hpenv Hbio Hlfz Hppid Hprocs Hdevi Hdgeom Hdlock Hncell HW HauthL Hhdr Hu1
                    [Hmirc]").
    all: try lkbelow.
    ...
    iApply (IT.wp_install_trans_sconf γs j γl γu γd γk pd pav pu bn γfs
              ...
              with "Hcg Hcnt Hextc Hextm Htext Hkd Hpc Hpanic Hpenv Hbio Hlfz Hppid Hprocs Hdevi Hdgeom Hdlock Hncell HW HauthL HauthD Hent Hu2
                    [] [Hmirc]").
    all: try lkbelow.
    ...
    assert (Hlhna : add_vec (rget A4 Ra5) (sign_extend' 64 (mword_of_int 1538 : mword 12))
                    = lh_n_pa).
    ...
    iApply (wp_sw_zero_s_sconf (mword_of_int (KernelSyms.end_op + 0x112)) Ra5
              (mword_of_int 1538 : mword 12) A4 (K - 8)%nat
    ...
    iApply (WH.wp_write_head_sconf γs j γl γu γd γk pd pav pu bn γfs
              ...
              with "Hcg Hcnt Hextc Hextm Htext Hkd Hpc Hpanic Hpenv Hbio Hlfz Hppid Hprocs Hdevi Hdgeom Hdlock Hncell [] HauthL [Hhdr] Hu3
                    [Hmirc]").
    all: try lkbelow.
  ...
  Proof.
    ...
    - (* the back edge is TAKEN *)
      ...
      iApply (IH CIDa25 (S t) J3 (<[uint bnol := bs2]> L) Lw' Hlt
                ...
                with "Hcg Hcnt Hextc Hextm Htext Hkd Hpc Hpanic Hpenv Hbio Hlctx Hseam Hregc Hppid Hprocs Hdevi Hdgeom Hdlock Hframe HframeS Hmirc
                      Hopen Hcont").
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.end_op + 0x7e)) Ra0 Ra0
              (mword_of_int 1642 : mword 12) E1 (trap_res eb + (K - 8))%nat false
...
Section ProofEndOp.
  ...
  Proof.
    ...
    iIntros "Hcg Hcnt Hextc Hextm #Htext #Hkd Hpc #Hpanic #Hpenv #Hbio #Hlctx #Hseam #Hcert Hppid #Hprocs #Hdevi #Hdgeom #Hdlock Hop Hcont".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.end_op + 0x10)) Rs1 Rs1
              (mword_of_int 1752 : mword 12) R3 (K - 8)%nat eb
    ...
    pose (R4 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (R3 !!! Regidx Rs1 : mword 64)
                     (sign_extend' 64 (mword_of_int 1752 : mword 12)))]> R3).
    ...
    - (* ---- THE COMMIT ARM: outstanding hit zero ---- *)
      ...
      + (* n > 0: save s3/s4/s5, set up the cursors, and run the copy loop *)
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.end_op + 0xa8)) Rs5 Rs5
                  (mword_of_int 1648 : mword 12) Y1 (K - 8)%nat eb
        ...
        pose (Y2 := <[Regidx Rs5 := regval_into_reg
                      (add_vec (Y1 !!! Regidx Rs5 : mword 64)
                         (sign_extend' 64 (mword_of_int 1648 : mword 12)))]> Y1).
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.end_op + 0xb0)) Rs4 Rs4
                  (mword_of_int 1592 : mword 12) Y3 (K - 8)%nat eb
        ...
        pose (Y4 := <[Regidx Rs4 := regval_into_reg
                      (add_vec (Y3 !!! Regidx Rs4 : mword 64)
                         (sign_extend' 64 (mword_of_int 1592 : mword 12)))]> Y3).

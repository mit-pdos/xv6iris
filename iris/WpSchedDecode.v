...
Section WpSchedDecode.
  ...
  Proof. mk_rvc (SD + 0x06)%Z (mword_of_int 0xec26 : mword 16)
    (mword_of_int (SD + 0x06) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), Regidx (mword_of_int 9), sp, 8)) cdec_ec26 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x08)%Z (mword_of_int 0xe84a : mword 16)
    (mword_of_int (SD + 0x08) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), Regidx (mword_of_int 18), sp, 8)) cdec_e84a exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x0a)%Z (mword_of_int 0xe44e : mword 16)
    (mword_of_int (SD + 0x0a) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 19), sp, 8)) cdec_e44e exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x0c)%Z (mword_of_int 0x1800 : mword 16)
    (mword_of_int (SD + 0x0c) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 12 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_1800 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (SD + 0x12)%Z (mword_of_int 0x84aa : mword 16)
    (mword_of_int (SD + 0x12) : mword 64) (RTYPE (Regidx (mword_of_int 10), zreg, Regidx (mword_of_int 9), ADD)) cdec_84aa exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (SD + 0x1a)%Z (mword_of_int 0x8792 : mword 16)
    (mword_of_int (SD + 0x1a) : mword 64) (RTYPE (Regidx (mword_of_int 4), zreg, Regidx (mword_of_int 15), ADD)) cdec_8792 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (SD + 0x1c)%Z (mword_of_int 0x2781 : mword 16)
    (mword_of_int (SD + 0x1c) : mword 64) (ADDIW (sign_extend' 12 (mword_of_int 0 : mword 6), Regidx (mword_of_int 15), Regidx (mword_of_int 15))) cdec_2781 exec_execute_C_ADDIW. Qed.
  ...
  Proof. mk_rvc (SD + 0x1e)%Z (mword_of_int 0x079e : mword 16)
    (mword_of_int (SD + 0x1e) : mword 64) (SHIFTIOP (mword_of_int 7 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) cdec_079e exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (SD + 0x2e)%Z (mword_of_int 0x4785 : mword 16)
    (mword_of_int (SD + 0x2e) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 1 : mword 6), zreg, Regidx (mword_of_int 15), ADDI)) cdec_4785 exec_execute_C_LI. Qed.
  ...
  Proof. mk_rvc (SD + 0x44)%Z (mword_of_int 0x8792 : mword 16)
    (mword_of_int (SD + 0x44) : mword 64) (RTYPE (Regidx (mword_of_int 4), zreg, Regidx (mword_of_int 15), ADD)) cdec_8792 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (SD + 0x4e)%Z (mword_of_int 0x2781 : mword 16)
    (mword_of_int (SD + 0x4e) : mword 64) (ADDIW (sign_extend' 12 (mword_of_int 0 : mword 6), Regidx (mword_of_int 15), Regidx (mword_of_int 15))) cdec_2781 exec_execute_C_ADDIW. Qed.
  ...
  Proof. mk_rvc (SD + 0x50)%Z (mword_of_int 0x079e : mword 16)
    (mword_of_int (SD + 0x50) : mword 64) (SHIFTIOP (mword_of_int 7 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) cdec_079e exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (SD + 0x58)%Z (mword_of_int 0x8792 : mword 16)
    (mword_of_int (SD + 0x58) : mword 64) (RTYPE (Regidx (mword_of_int 4), zreg, Regidx (mword_of_int 15), ADD)) cdec_8792 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (SD + 0x5a)%Z (mword_of_int 0x2781 : mword 16)
    (mword_of_int (SD + 0x5a) : mword 64) (ADDIW (sign_extend' 12 (mword_of_int 0 : mword 6), Regidx (mword_of_int 15), Regidx (mword_of_int 15))) cdec_2781 exec_execute_C_ADDIW. Qed.
  ...
  Proof. mk_rvc (SD + 0x5c)%Z (mword_of_int 0x079e : mword 16)
    (mword_of_int (SD + 0x5c) : mword 64) (SHIFTIOP (mword_of_int 7 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) cdec_079e exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (SD + 0x72)%Z (mword_of_int 0x8792 : mword 16)
    (mword_of_int (SD + 0x72) : mword 64) (RTYPE (Regidx (mword_of_int 4), zreg, Regidx (mword_of_int 15), ADD)) cdec_8792 exec_execute_C_MV. Qed.
  ...
  Proof. mk_rvc (SD + 0x74)%Z (mword_of_int 0x2781 : mword 16)
    (mword_of_int (SD + 0x74) : mword 64) (ADDIW (sign_extend' 12 (mword_of_int 0 : mword 6), Regidx (mword_of_int 15), Regidx (mword_of_int 15))) cdec_2781 exec_execute_C_ADDIW. Qed.
  ...
  Proof. mk_rvc (SD + 0x76)%Z (mword_of_int 0x079e : mword 16)
    (mword_of_int (SD + 0x76) : mword 64) (SHIFTIOP (mword_of_int 7 : mword 6, Regidx (mword_of_int 15), Regidx (mword_of_int 15), SLLI)) cdec_079e exec_execute_C_SLLI. Qed.
  ...
  Proof. mk_rvc (SD + 0x78)%Z (mword_of_int 0x993e : mword 16)
    (mword_of_int (SD + 0x78) : mword 64) (RTYPE (Regidx (mword_of_int 15), Regidx (mword_of_int 18), Regidx (mword_of_int 18), ADD)) cdec_993e exec_execute_C_ADD. Qed.
  ...
  Proof. mk_rvc (SD + 0x7e)%Z (mword_of_int 0x70a2 : mword 16)
    (mword_of_int (SD + 0x7e) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 5 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_70a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x80)%Z (mword_of_int 0x7402 : mword 16)
    (mword_of_int (SD + 0x80) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 4 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_7402 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x82)%Z (mword_of_int 0x64e2 : mword 16)
    (mword_of_int (SD + 0x82) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 3 : mword 6) ('b"000")), sp, Regidx (mword_of_int 9), false, 8)) cdec_64e2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x84)%Z (mword_of_int 0x6942 : mword 16)
    (mword_of_int (SD + 0x84) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 2 : mword 6) ('b"000")), sp, Regidx (mword_of_int 18), false, 8)) cdec_6942 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x86)%Z (mword_of_int 0x69a2 : mword 16)
    (mword_of_int (SD + 0x86) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 19), false, 8)) cdec_69a2 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (SD + 0x88)%Z (mword_of_int 0x6145 : mword 16)
    (mword_of_int (SD + 0x88) : mword 64) (ITYPE (caddi16sp_imm (mword_of_int 3 : mword 6), sp, sp, ADDI)) cdec_6145 exec_execute_C_ADDI16SP. Qed.
  ...
  Proof. mk_rvc (SD + 0x8a)%Z (mword_of_int 0x8082 : mword 16)
    (mword_of_int (SD + 0x8a) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.

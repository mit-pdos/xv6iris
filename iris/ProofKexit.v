    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      - (* FALL: this descriptor names a file -- close it and null the cell *)
        ...
        iApply (wp_jal_s_sconf (CID := CIDm) (mword_of_int (KX + 0x42))
                  (mword_of_int 1 : mword 5) (mword_of_int 8282 : mword 21) M3e av b
        ...
        assert (Hjfc : add_vec (mword_of_int (KX + 0x42) : mword 64)
                         (sign_extend' 64 (mword_of_int 8282 : mword 21)) = mword_of_int KernelSyms.fileclose)
          by (apply bv_eq; vm_compute; reflexivity).
...
Section KexitPark.
  ...
  Proof.
    ...
    (* +0x60 auipc a0,0x10 ; +0x64 addi a0,a0,852 : a0 := &wait_lock *)
    ...
    (* +0x8a auipc a0,0x10 ; +0x8e addi a0,a0,810 : a0 := &wait_lock again *)
...
Section KexitRest.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID0) (mword_of_int (KX + 0x4c))
              (mword_of_int 1 : mword 5) (mword_of_int 7076 : mword 21) M av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi4c [-]").
    ...
    assert (Hjbo : add_vec (mword_of_int (KX + 0x4c) : mword 64)
                     (sign_extend' 64 (mword_of_int 7076 : mword 21)) = mword_of_int KernelSyms.begin_op)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (CID := CID5) (mword_of_int (KX + 0x58))
              (mword_of_int 1 : mword 5) (mword_of_int 7204 : mword 21) mip av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi58 [-]").
    ...
    assert (Hjeo : add_vec (mword_of_int (KX + 0x58) : mword 64)
                     (sign_extend' 64 (mword_of_int 7204 : mword 21)) = mword_of_int KernelSyms.end_op)
      by (apply bv_eq; vm_compute; reflexivity).
...
Section ProofKexit.
  ...
  Proof.
    ...
    (* +0x18 auipc a5,0x8 ; +0x1c ld a5,604(a5) : a5 := initproc *)

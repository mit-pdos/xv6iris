    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      - (* FALL: this descriptor names a file -- close it and null the cell *)
        ...
        iApply (wp_jal_s_sconf (CID := CIDm) (mword_of_int (KX + 0x42))
                  (mword_of_int 1 : mword 5) (mword_of_int 8298 : mword 21) M3e av b
        ...
        assert (Hjfc : add_vec (mword_of_int (KX + 0x42) : mword 64)
                         (sign_extend' 64 (mword_of_int 8298 : mword 21)) = mword_of_int KernelSyms.fileclose)
          by (apply bv_eq; vm_compute; reflexivity).
...
Section KexitPark.
  ...
  Proof.
    ...
    (* +0x60 auipc a0,0x10 ; +0x64 addi a0,a0,868 : a0 := &wait_lock *)
    ...
    iApply (wp_jal_s_sconf (CID := CIDv) (mword_of_int (KX + 0x68))
              (mword_of_int 1 : mword 5) (mword_of_int 2091880 : mword 21) P1 av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi68 [-]").
    ...
    assert (Hjaq : add_vec (mword_of_int (KX + 0x68) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091880 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (CID := CIDa) (mword_of_int (KX + 0x7c))
              (mword_of_int 1 : mword 5) (mword_of_int 2091860 : mword 21) P7 (trap_res b + av)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi7c [-]").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    ...
    assert (Hjaq2 : add_vec (mword_of_int (KX + 0x7c) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091860 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* +0x8a auipc a0,0x10 ; +0x8e addi a0,a0,826 : a0 := &wait_lock again *)
    ...
    iApply (wp_jal_s_sconf (CID := CIDa) (mword_of_int (KX + 0x92))
              (mword_of_int 1 : mword 5) (mword_of_int 2091974 : mword 21) PB (trap_res b + av)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi92 [-]").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    ...
    assert (Hjrl : add_vec (mword_of_int (KX + 0x92) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091974 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    (* +0x9a auipc a0,5 ; +0x9e addi a0,a0,362 ; +0xa2 jal panic *)
    ...
    iApply (wp_jal_s_sconf (CID := CIDz) (mword_of_int (KX + 0xa2))
              (mword_of_int 1 : mword 5) (mword_of_int 2090894 : mword 21) PZ2 (trap_res b + av)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hia2 [-]").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    assert (Hjpn : add_vec (mword_of_int (KX + 0xa2) : mword 64)
                     (sign_extend' 64 (mword_of_int 2090894 : mword 21)) = mword_of_int KernelSyms.panic)
      by (apply bv_eq; vm_compute; reflexivity).
...
Section KexitRest.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID0) (mword_of_int (KX + 0x4c))
              (mword_of_int 1 : mword 5) (mword_of_int 7092 : mword 21) M av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi4c [-]").
    ...
    assert (Hjbo : add_vec (mword_of_int (KX + 0x4c) : mword 64)
                     (sign_extend' 64 (mword_of_int 7092 : mword 21)) = mword_of_int KernelSyms.begin_op)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (CID := CID3) (mword_of_int (KX + 0x54))
              (mword_of_int 1 : mword 5) (mword_of_int 4876 : mword 21) Q1 av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi54 [-]").
    ...
    assert (Hjip : add_vec (mword_of_int (KX + 0x54) : mword 64)
                     (sign_extend' 64 (mword_of_int 4876 : mword 21)) = mword_of_int KernelSyms.iput)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (CID := CID5) (mword_of_int (KX + 0x58))
              (mword_of_int 1 : mword 5) (mword_of_int 7220 : mword 21) mip av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi58 [-]").
    ...
    assert (Hjeo : add_vec (mword_of_int (KX + 0x58) : mword 64)
                     (sign_extend' 64 (mword_of_int 7220 : mword 21)) = mword_of_int KernelSyms.end_op)
      by (apply bv_eq; vm_compute; reflexivity).
...
Section ProofKexit.
  ...
  Proof.
    ...
    (* +0x18 auipc a5,0x8 ; +0x1c ld a5,620(a5) : a5 := initproc *)
    ...
    assert (Hipa : add_vec (rget (CID := CID4) A2 (mword_of_int 15 : mword 5))
                     (sign_extend' 64 (mword_of_int 620 : mword 12))
    ...
    iApply (wp_ld_s_sconf (CID := CID4) (mword_of_int (KX + 0x1c))
              (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 620 : mword 12)
    ...
    - (* p IS initproc: panic("init exiting").  NOT ruled out -- see
      ...
      iApply (wp_jal_s_sconf (CID := CIDA) (mword_of_int (KX + 0x34))
                (mword_of_int 1 : mword 5) (mword_of_int 2091004 : mword 21) B1 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi34 [-]").
      iIntros (CIDB HsB) "Hcg Hpc".
      assert (Hjpn : add_vec (mword_of_int (KX + 0x34) : mword 64)
                       (sign_extend' 64 (mword_of_int 2091004 : mword 21)) = mword_of_int KernelSyms.panic)
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hjpn) in "Hpc".

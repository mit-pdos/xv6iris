    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      - (* FALL: this descriptor names a file -- close it and null the cell *)
        ...
        iApply (wp_jal_s_sconf (CID := CIDm) (mword_of_int (KX + 0x42))
                  (mword_of_int 1 : mword 5) (mword_of_int 8396 : mword 21) M3e av b
        ...
        assert (Hjfc : add_vec (mword_of_int (KX + 0x42) : mword 64)
                         (sign_extend' 64 (mword_of_int 8396 : mword 21)) = mword_of_int KernelSyms.fileclose)
          by (apply bv_eq; vm_compute; reflexivity).
...
Section KexitPark.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CIDv) (mword_of_int (KX + 0x68))
              (mword_of_int 1 : mword 5) (mword_of_int 2091830 : mword 21) P1 av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjaq : add_vec (mword_of_int (KX + 0x68) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091830 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (CID := CIDa) (mword_of_int (KX + 0x7c))
              (mword_of_int 1 : mword 5) (mword_of_int 2091810 : mword 21) P7 (trap_res b + av)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjaq2 : add_vec (mword_of_int (KX + 0x7c) : mword 64)
                      (sign_extend' 64 (mword_of_int 2091810 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (CID := CIDa) (mword_of_int (KX + 0x92))
              (mword_of_int 1 : mword 5) (mword_of_int 2091924 : mword 21) PB (trap_res b + av)%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjrl : add_vec (mword_of_int (KX + 0x92) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091924 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
...
Section KexitRest.
  ...
  Lemma kx_rest `{GEN : GenId} `{CID0 : CpuId}
    ...
    is_itable2 γtl fsc_ic fsc_fs γi cov logstart nib dev -∗
    itable_inv -∗
  ...
  Proof.
    ...
    iDestruct (ic_escrows_acc _ _ _ kk Hkk with "Hescrows") as "#Hescrow".
    ...
    iApply (wp_jal_s_sconf (CID := CID0) (mword_of_int (KX + 0x4c))
              (mword_of_int 1 : mword 5) (mword_of_int 7176 : mword 21) M av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjbo : add_vec (mword_of_int (KX + 0x4c) : mword 64)
                     (sign_extend' 64 (mword_of_int 7176 : mword 21)) = mword_of_int KernelSyms.begin_op)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iDestruct (cpu_claim_ext_transport CID0 CID1 eb pj
                 ltac:(rewrite Hb; wp_next_chain) with "Hcce") as "Hcce".
    iApply (BeginOp.wp_begin_op_sconf (CID := CID1)  γs j γl bn γ fsc_fs cov logstart dev
    ...
    iApply (Iput.wp_iput_sconf (CID := CID4) γs j γl γu γd γk pd pav pu bn γ
              γi γtl gil gisl cov logstart bmapstart inodestart nib size
    ...
    iApply (wp_jal_s_sconf (CID := CID5) (mword_of_int (KX + 0x58))
              (mword_of_int 1 : mword 5) (mword_of_int 7304 : mword 21) mip av b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjeo : add_vec (mword_of_int (KX + 0x58) : mword 64)
                     (sign_extend' 64 (mword_of_int 7304 : mword 21)) = mword_of_int KernelSyms.end_op)
      by (apply bv_eq; vm_compute; reflexivity).
...
Section ProofKexit.
  ...
  Proof.
    ...
    destruct Hties' as [Ht_uart Ht_disk Ht_dlock Ht_kmem Ht_kalloc Ht_bio Ht_log Ht_cov Ht_logst Ht_dev Ht_ireg Ht_tlock Ht_bms Ht_ist Ht_nib Ht_size].
    cbn [fcn_uart fcn_disk fcn_dlock fcn_kmem fcn_kalloc fcn_bio fcn_log fcn_cov fcn_logstart fcn_dev fcn_ireg fcn_tlock
         fcn_bmapstart fcn_inodestart fcn_nib fcn_size]
      in Ht_uart, Ht_disk, Ht_dlock, Ht_kmem, Ht_kalloc, Ht_bio, Ht_log, Ht_cov, Ht_logst, Ht_dev, Ht_ireg, Ht_tlock, Ht_bms, Ht_ist, Ht_nib, Ht_size.
    subst γu γd γk γkl γka bn γ cov logstart dev
          γi γtl bmapstart inodestart nib size.
    ...
    iApply (wp_jal_s_sconf (CID := CIDp) (mword_of_int (KX + 0x12))
              (mword_of_int 1 : mword 5) (mword_of_int 2095276 : mword 21) M (av - 6)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjmp : add_vec (mword_of_int (KX + 0x12) : mword 64)
                     (sign_extend' 64 (mword_of_int 2095276 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* p IS initproc: panic("init exiting").  NOT ruled out -- see
      ...
      iApply (wp_addi4_s_sconf (CID := CID9) (mword_of_int (KX + 0x30))
                (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 440 : mword 12)
      ...
      set (B1 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
           (add_vec (rget (CID := CID9) B0 (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 440 : mword 12)))]> B0).
      ...
      iApply (wp_jal_s_sconf (CID := CIDA) (mword_of_int (KX + 0x34))
                (mword_of_int 1 : mword 5) (mword_of_int 2090948 : mword 21) B1 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      { iApply (kxi_34 with "Htext"). }
      iIntros (CIDB HsB) "Hcg Hpc".
      assert (Hjpn : add_vec (mword_of_int (KX + 0x34) : mword 64)
                       (sign_extend' 64 (mword_of_int 2090948 : mword 21)) = mword_of_int KernelSyms.panic)
        by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* the ordinary path: into the fd loop at +0x3e *)
      ...
      { iIntros (CIDx Hsx Mx Vx) "%Hxregs %Hxof %Hxcwd Hcg Hown Htce Hcce Hpc Hpriv Hpenv Hfenv Hiru".
        ...
        iApply (kx_rest (CID0 := CIDx)  γf γw γs j γl fsc_uart fsc_disk fsc_dlock
                  ...
                  fsc_cov fsc_logst icfg_dev fsc_ireg fsc_itlock

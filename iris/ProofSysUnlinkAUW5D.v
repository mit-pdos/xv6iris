(* ProofSysUnlinkAUW5D.v -- the unlink AU walk's BLOCK W5-DIR: the same
   ...
   [ProofSysUnlink.su_w5_dir]'s copy-adapt, at [SpecSysUnlinkAU]'s
...
Module SysUnlinkAUW5D (Memset : MEMSET) (Writei : WRITEI) (Iupdate : IUPDATE)
                      (Iunlockput : IUNLOCKPUT) (EndOp : END_OP) (PN : PANIC).

Module Tails := SysUnlinkTails Iunlockput EndOp PN.

Section ProofSysUnlinkAUW5D.

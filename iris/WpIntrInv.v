...
Section WpIntrInv.
  ...
  Lemma kernelvec_handler_spec (root_ppn : mword 44) (svpn : mword 27)
    ...
    ⊢ intr_handler_spec (mword_of_int KernelSyms.kernelvec : mword 64)
        (F_kv root_ppn svpn m satp0 menvcfg0 pmpcfg0 pmpaddr00 tlbvec).
  Proof.
    intros Hmode Hasid HPBMTE Hpmm Hhit5 Hhith Hpmpf HW HR Hmask Hlpe0
    ...
    iDestruct "HF" as "(#Hhw & #Hinv & #Htext & Hsatp & Hmenv & Hpmpc & Hpmpa & Htlb & Hfile & Hwins)".
    ...
    iFrame "Hhw Hinv Htext Hsatp Hmenv Hpmpc Hpmpa Htlb Hfile".

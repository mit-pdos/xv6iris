...
Lemma ss_reloc_a0_08 :
  add_vec (add_vec (mword_of_int (SS + 0x08) : mword 64)
          ...
          (sign_extend' 64 (mword_of_int 1060 : mword 12)) = log_addr.
...
Lemma ss_reloc_cmt_14 :
  add_vec (add_vec (mword_of_int (SS + 0x14) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1080 : mword 12)) = l_cmt.
Proof.
...
Lemma ss_reloc_out_1e :
  add_vec (add_vec (mword_of_int (SS + 0x1e) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1066 : mword 12)) = l_out.
Proof.
...
Lemma ss_reloc_nc_2e :
  add_vec (add_vec (mword_of_int (SS + 0x2e) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1062 : mword 12)) = l_ncommit.
Proof.
...
Lemma ss_reloc_s1_36 :
  add_vec (add_vec (mword_of_int (SS + 0x36) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 1014 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.

Lemma ss_reloc_a0_5e :
  add_vec (add_vec (mword_of_int (SS + 0x5e) : mword 64)
                   (auipc_off (mword_of_int 30 : mword 20)))
          (sign_extend' 64 (mword_of_int 974 : mword 12)) = log_addr.
Proof. rewrite /log_addr. apply bv_eq; vm_compute; reflexivity. Qed.
...
Section SsBodies.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (SS + 0x62)) Ra0 Ra0
              (mword_of_int 974 : mword 12) X1 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (X2 := <[Regidx Ra0 := regval_into_reg
        (add_vec (X1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 974 : mword 12)))]> X1).
    change (<[Regidx Ra0 := regval_into_reg
        (add_vec (X1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 974 : mword 12)))]> X1) with X2.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (SS + 0x66)) Rra
              (mword_of_int 2084006 : mword 21) X2 (trap_res eb + (K - 4))%nat false
    ...
    assert (Hjrel : add_vec (mword_of_int (SS + 0x66) : mword 64)
                      (sign_extend' 64 (mword_of_int 2084006 : mword 21))
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (SS + 0x40)) Rra
              (mword_of_int 2088898 : mword 21) A0 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjsp : add_vec (mword_of_int (SS + 0x40) : mword 64)
                     (sign_extend' 64 (mword_of_int 2088898 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (SS + 0x46)) Rra
              (mword_of_int 2084038 : mword 21) A2 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjrl : add_vec (mword_of_int (SS + 0x46) : mword 64)
                     (sign_extend' 64 (mword_of_int 2084038 : mword 21))
                   = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (SS + 0x4a)) Rra
              (mword_of_int 2088948 : mword 21) mfr (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjsl : add_vec (mword_of_int (SS + 0x4a) : mword 64)
                     (sign_extend' 64 (mword_of_int 2088948 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (SS + 0x50)) Rra
              (mword_of_int 2083892 : mword 21) A5 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjaq : add_vec (mword_of_int (SS + 0x50) : mword 64)
                     (sign_extend' 64 (mword_of_int 2083892 : mword 21))
    ...
    iApply (wp_clw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (SS + 0x54)) Ra5 Rs1
  ...
  Proof.
    ...
    iApply (wp_csdsp_s_sconf (mword_of_int (SS + 0x2a)) (mword_of_int 1 : mword 6) Rs1
              M (trap_res eb + (K - 4))%nat v3 false with "Hcg Hpc [] Hr8").
    ...
    iApply (wp_csdsp_s_sconf (mword_of_int (SS + 0x2c)) (mword_of_int 0 : mword 6) Rs2
              M (trap_res eb + (K - 4))%nat v4 false with "Hcg Hpc [] Hr0").
    { iApply (ssi_2c with "Htext"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc Hr0".
    ...
    assert (Hnca : add_vec (rget Y1 Rs2) (sign_extend' 64 (mword_of_int 1062 : mword 12)) = l_ncommit).
    { rgne. rewrite HY1s2. exact ss_reloc_nc_2e. }
    iEval (rewrite -Hnca) in "Hnc".
    iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (SS + 0x32)) Rs2 Rs2
              (mword_of_int 1062 : mword 12) Y1 (trap_res eb + (K - 4))%nat nc false
              (dqm := DfracOwn 1)
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] Hnc").
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (SS + 0x3a)) Rs1 Rs1
              (mword_of_int 1014 : mword 12) Y3 (trap_res eb + (K - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (Y4 := <[Regidx Rs1 := regval_into_reg
        (add_vec (Y3 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 1014 : mword 12)))]> Y3).
    change (<[Regidx Rs1 := regval_into_reg
        (add_vec (Y3 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 1014 : mword 12)))]> Y3) with Y4.
...
Section ProofSysSync.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (SS + 0x0c)) Ra0 Ra0
              (mword_of_int 1060 : mword 12) R3 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (R4 := <[Regidx Ra0 := regval_into_reg
        (add_vec (R3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1060 : mword 12)))]> R3).
    change (<[Regidx Ra0 := regval_into_reg
        (add_vec (R3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1060 : mword 12)))]> R3) with R4.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (SS + 0x10)) Rra
              (mword_of_int 2083956 : mword 21) R4 (K - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjaq : add_vec (mword_of_int (SS + 0x10) : mword 64)
                     (sign_extend' 64 (mword_of_int 2083956 : mword 21))
                   = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjaq) in "Hpc".
    ...
    (* +0x18 lw a5,1116(a5) : a5 := log.committing *)
    assert (Hcmta : add_vec (rget G1 Ra5) (sign_extend' 64 (mword_of_int 1080 : mword 12)) = l_cmt).
    ...
    iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (SS + 0x18)) Ra5 Ra5
              (mword_of_int 1080 : mword 12) G1 (trap_res eb + (K - 4))%nat
    ...
    - (* ============== NOT COMMITTING: test [outstanding] ================= *)
      ...
      (* +0x22 lw a5,1102(a5) : a5 := log.outstanding *)
      assert (Houta : add_vec (rget G3 Ra5) (sign_extend' 64 (mword_of_int 1066 : mword 12)) = l_out).
      ...
      iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (SS + 0x22)) Ra5 Ra5
                (mword_of_int 1066 : mword 12) G3 (trap_res eb + (K - 4))%nat

...
Section KexecB3Ph.
  ...
  Lemma kxc_ph8_of_stack (sp0 : mword 64) :
    ...
    ([∗ list] i ∈ seq 0 7,
       ∃ w : mword 64, word_pointsto (KTR := kt) (pa_stk sp0 (61 - i)) (DfracOwn 1) w) ∗
    (∃ w : mword 64, word_pointsto (KTR := kt) (pa_stk sp0 62) (DfracOwn 1) w).
  Proof.
  ...
  Lemma kxc_stack8_of_ph (sp0 : mword 64) (w62 : mword 64) :
    ([∗ list] i ∈ seq 0 7,
       ∃ w : mword 64, word_pointsto (KTR := kt) (pa_stk sp0 (61 - i)) (DfracOwn 1) w) -∗
    word_pointsto (KTR := kt) (pa_stk sp0 62) (DfracOwn 1) w62 -∗
    stack_own (KTR := kt) (pa_stk sp0 54) 8.
  Proof.
    iIntros "H A".
  ...
  Lemma kxc_pin_intro (sp0 ra0 s00 s10 s20 pv av : mword 64)
    ...
    stack_own (KTR := kt) (pa_stk sp0 54) 8 -∗
    word_pointsto (KTR := kt) (pa_stk sp0 63) (DfracOwn 1) w63 -∗
    ...
    - (* ================ THE HEADER ARRIVED ======================== *)
      ...
      + (* ---- NOT PT_LOAD: nothing to do, take the back edge ---- *)
        ...
        iDestruct (kxc_pin_intro sp0 ra0 s00 s10 s20 pv av
          ...
          as "Hframe".
        iDestruct (cpu_own_transport CIDrd CIDg4 0%nat true (proc_addr jp)
        ...
        * (* memsz < filesz -- malformed *)
          ...
          iDestruct (kxc_pin_intro sp0 ra0 s00 s10 s20 pv av
                       ...
                       with "Hf1 Hf2 Hf3 Hf4 Hf5 Hf6 Hf7 Hf8 Hf9 Hf10 Hf11 Hf12
                             Hf13 Hust Hph8 Hf63 Hf64 Hf65 Hf66 Hf67 Hf68")
            as "Hframe".
          iDestruct (cpu_own_transport CIDrd CIDy2 0%nat true (proc_addr jp) true
                       ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    - (* ================ A SHORT READ: [bad:] at +0x320 ============ *)
      ...
      iDestruct (kxc_pin_intro sp0 ra0 s00 s10 s20 pv av
                   ...
                   with "Hf1 Hf2 Hf3 Hf4 Hf5 Hf6 Hf7 Hf8 Hf9 Hf10 Hf11 Hf12
                         Hf13 Hust Hph8 Hf63 Hf64 Hf65 Hf66 Hf67 Hf68")
        as "Hframe".
      iDestruct (cpu_own_transport CIDrd CIDb2 0%nat true (proc_addr jp) true
                   ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
...
Section KexecB3Close.
  ...
  Proof.
    ...
    iDestruct (cpu_own_transport CIDe CIDe 0%nat true (proc_addr jp) true
                 ltac:(wp_next_chain) with "Hcnt") as "Hcnt".

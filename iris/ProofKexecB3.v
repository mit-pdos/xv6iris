...
Section KexecB3Seam.
  ...
  Definition kxc_at_11a
    ...
    (⌜ M !!! Regidx csp_rs1 = pa_stk sp0 68 /\
     ...
     kalloc_env ga None ∗
     kxc_res jp bn g gi gf bmapstart inodestart size dev
...
Section KexecB3Incr.
  ...
  Lemma kxc_incr `{CID0 : CpuId}
    ...
    kernel_text -∗
    kxc_at_11a jp bn g gi ga gf bmapstart inodestart nib
    ...
    wp_next true (proc_addr jp) (fun (CID : CpuId) =>
      ∀ (M' : regfile),
        ( kxc_at_12c jp bn g gi ga gf bmapstart inodestart
          ...
          ∨ kxc_at_1a4 jp bn g gi ga gf bmapstart inodestart
                       nib size dev kf qf sf gyf inumf dnf bmf
                       gilf gislf n2 plen pfun na avf aslen afun pidv V eb
...
Section KexecB3Body.
  ...
  Lemma kxc_ph_step `{CID0 : CpuId}
    ...
    fs_fabric gs gu gd gk pd pav pu bn g gi gtl
              inodestart nib dev -∗
    kxc_at_12c jp bn g gi ga gf bmapstart inodestart nib
               size dev kf qf sf gyf inumf dnf bmf gilf gislf n2
  ...
  Proof.
    ...
    iApply (Readi.wp_readi_sconf KT1 gs jp gl gu gd gk pd pav pu bn ga gf
              dev (ientry kf) bmf datl dnf false offn 56%nat phb V
    ...
    iDestruct (kxc_load_seal gi kf inumf dnf bmf datl
    ...
    iDestruct (kxc_open_intro gi dev pidv kf qf sf gyf
    ...
    - (* ================ THE HEADER ARRIVED ======================== *)
      ...
      + (* ---- NOT PT_LOAD: nothing to do, take the back edge ---- *)
        ...
        iDestruct (cpu_claim_ext_transport CIDrd CIDg4 eb (proc_addr jp)
                     ltac:(try rewrite Hebb; wp_next_chain) with "Hclmc") as "Hclmc".
        iApply (kxc_incr (CID0 := CIDg4) jp bn g gi ga gf
      ...
      + (* ================ PT_LOAD: load the segment ================ *)
        ...
        * (* memsz < filesz -- malformed *)
          ...
          iApply (B2.kxc_bad324 (CID0 := CIDy2) Q gs jp gl gu gd gk pd pav pu bn g
                    gi gtl gilf gislf ga gf bmapstart
  ...
  Proof.
    ...
    induction W as [| W IH]; intros CID0 M P i szv Hfuel;
      ...
      iApply (kxc_ph_step (CID0 := CID0) Q gs jp gl gu gd gk pd pav pu bn g
                gi gtl gilf gislf ga gf bmapstart inodestart
...
Section KexecB3Close.
  ...
  Lemma kxc_seam1a2 `{CID0 : CpuId}
      ...
      (ef : nat -> bv 8) (P : uptd) :
    kernel_text -∗
    kxc_at_1a2 jp bn g gi ga gf bmapstart inodestart nib
               size dev kf qf sf gyf inumf dnf bmf gilf gislf n2
               plen pfun na avf aslen afun pidv V eb dqb dqs dqa dqpv dqas m M K
               sp0 ra0 s00 s10 s20 pv av
  ...
  Lemma kxc_close `{CID0 : CpuId}
    ...
    fs_fabric gs gu gd gk pd pav pu bn g gi gtl
              inodestart nib dev -∗
    kxc_at_1a4 jp bn g gi ga gf bmapstart inodestart nib
               size dev kf qf sf gyf inumf dnf bmf gilf gislf n2
               plen pfun na avf aslen afun pidv V eb dqb dqs dqa dqpv dqas M K
               sp0 ra0 s00 s10 s20 pv av
    ...
    wp_next true (proc_addr jp) (fun (CID : CpuId) =>
      ∀ (M' : regfile),
        kxc_at_1ae jp bn ga gf bmapstart inodestart size
  ...
  Proof.
    ...
    iDestruct (proc_priv_bare_acc gf (proc_addr jp) pidv V with "Hpriv")
      as "[Hppid Hpvbk]".
    iDestruct (A.kxa_esc_acc gi kf Hk with "Hesc")
      as "#Hesck".
    (* ---- +0x1a4: c.mv a0,s4 ---- *)
    ...
    iApply (Iunlockput.wp_iunlockput_tx_sconf gs jp gl gu gd gk pd pav pu bn g
              gi gtl gilf gislf bmapstart inodestart nib size
...
Section KexecB3Main.
  ...
  Proof.
    ...
    iApply (kxc_seam1a2 (CID0 := CID0) jp bn g gi ga gf

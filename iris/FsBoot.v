...
(* ====================================================================== *)
  ...
  (* A6.68: [BioInv.bio_init]'s honest creator deposit (A6.66) wants the
     running token; borrowed here and handed straight back. *)
  ...
  Proof.
    ...
    iModIntro. iSplitL "Hrun"; [iExact "Hrun" |]. iExists bn, γfs.
    iSplitR; [done |]. iSplitR; [done |].

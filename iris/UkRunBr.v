...
Section UkRunBr.
  ...
  Lemma wp_uk_btype0 (N : uk_names Σ) (h : CpuId) (m : regfile) (pc : mword 64)
  ...
  Proof.
    ...
    iApply (UkBranch.wp_uk_btype0 C pt Rfd Rut pm sz Hlo Hpm HRut M m pc fdv cw gn cs pidv imm rs1 op taken tgt
              Hui H1 H2 H3
  ...
  Lemma wp_uk_btype0_later (N : uk_names Σ) (h : CpuId) (m : regfile)
  ...
  Proof.
    ...
    iDestruct "Hrun" as (xi C pt Rfd Rut sz M pm fdv cw gn cs pidv) "(%Hlo & %Hpm & %HRut & Hheap & Hstk & Hufd & Hcwda & Hcha & #Hmy & Hpayv & #Hdep & Hb)".
    iDestruct (uinstr_is_uk_instr with "Hheap Hi") as %Hui.
    iApply (UkBranch.wp_uk_btype0_later C pt Rfd Rut pm sz Hlo Hpm HRut M m pc fdv cw gn cs pidv imm rs1 op
              taken tgt Hui H1 H2 H3
              with "Hb [Hheap Hstk Hufd Hcwda Hcha Hpayv Hcont]").
    iNext. iApply (urun_close with "Hheap Hstk Hufd Hcwda Hcha Hmy Hpayv Hdep Hcont").
  Qed.
  ...
  Lemma wp_uk_btype0l (N : uk_names Σ) (h : CpuId) (m : regfile) (pc : mword 64)
  ...
  Proof.
    ...
    iApply (UkBranch.wp_uk_btype C pt Rfd Rut pm sz Hlo Hpm HRut M m pc fdv cw gn cs pidv imm rs2

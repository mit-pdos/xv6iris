...
Section WpSmodeShiftiop.
  ...
  Lemma wp_cslli_gpr_s_config (root_ppn : mword 44) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    unshelve iApply (wp_gpr_write_s_config root_ppn Φ pc rd rd rd
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrsd Hrd
  ...
  Lemma wp_csrli_gpr_s_config (root_ppn : mword 44) (Φ : mval -> iProp Σ)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd _
  ...
  Lemma wp_csrli_gpr_s_config_scfg (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (pc : mword 64) (crsd : cregidx) (rd : mword 5) (shamt : mword 6)
      (m : gmap regidx (mword 64)) {dq : dfrac} :
    creg2reg_idx crsd = Regidx rd ->
    uint rd <> 0 ->
  ...
  Proof.
    ...
    iDestruct "Hmieb" as (mie_v mdv0) "(Hmie & Hmdl & %Hmm)".
    iDestruct "Hmenvb" as (menvcfg0) "(Hmenv & %HPBMTE & %Hpmm & %Hlpe & %Hfiom & %Hmenvval0)".
    iApply (wp_csrli_gpr_s_config root_ppn Φ pc crsd rd shamt m mstatus0 mie_v mdv0 menvcfg0 (dq:=dq)
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hcrsd Hrd
  ...
  Lemma wp_srli4_s (root_ppn : mword 44) (Φ : mval -> iProp Σ)
  ...
  Proof.
    iIntros (HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd)
      "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile Hinstr Hcont".
    unshelve iApply (wp_gpr_write_s_config_base root_ppn Φ pc rd rs1 rs1
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
  ...
  Lemma wp_srli4_s_scfg (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rd rs1 : mword 5) (shamt : mword 6)
      (m : gmap regidx (mword 64)) {dq : dfrac} :
    uint rd <> 0 ->
    smode_config γ dq -∗ tlb_inv root_ppn -∗
  ...
  Proof.
    ...
    iDestruct "Hmieb" as (mie_v mdv0) "(Hmie & Hmdl & %Hmm)".
    iDestruct "Hmenvb" as (menvcfg0) "(Hmenv & %HPBMTE & %Hpmm & %Hlpe & %Hfiom & %Hmenvval0)".
    iApply (wp_srli4_s root_ppn Φ pc rd rs1 shamt m mstatus0 mie_v mdv0 menvcfg0 (dq:=dq)
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile Hinstr").
    iIntros "Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile".
    iDestruct (smode_config_rebuild γ dq mstatus0 mie_v mdv0 menvcfg0
  ...
  Lemma wp_slli_s (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)

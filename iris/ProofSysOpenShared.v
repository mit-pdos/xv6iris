(* ProofSysOpenShared.v -- the AU walk's parts layer: the exit
   ...
   THE OBSERVED-ROW TIE IS A DATA TIE.  [SysOpenDefs]'s FILE arm shares
...
Section ProofSysOpenShared.
  ...
  Definition so_obs (Fo : pfam Σ (aview -> Z -> anode -> iProp Σ)) (i : Z)
      (n : fs_node) : iProp Σ :=
    (∃ av : aview, ⌜arow_at av i (abs_row n)⌝ ∗ Fo.(pf_recv) av i (abs_row n))%I.

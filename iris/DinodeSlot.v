...
Local Lemma iu_align_arith (kk qq off dv : Z) :
  ...
  (2147582424 + 1112 * kk + (88 + (64 * qq + off))) `mod` dv = 0
  /\ 0 <= 2147582424 + 1112 * kk + (88 + (64 * qq + off))
  /\ 2147582424 + 1112 * kk + (88 + (64 * qq + off)) < 18446744073709551616.
Proof.
  intros H1 H2 H3 H4 H5 H6 Hd Hoff. split_and!; [| lia | lia].
  assert (Hz : 2147582424 + 1112 * kk + (88 + (64 * qq + off))
...
Proof.
  ...
  replace (0x800181c0 + 24 + 1112 * Z.of_nat k + Z.of_nat (88 + (64 * q + off)))
    with (2147582424 + 1112 * Z.of_nat k

...
Section ProofSysGetpid.
  ...
  Proof.
    ...
    (* ---- +0x08: jal ra,myproc ---- *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sys_getpid + 0x08)) (mword_of_int 1 : mword 5) (mword_of_int 2092990 : mword 21)
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.sys_getpid + 0x08) : mword 64) (sign_extend' 64 (mword_of_int 2092990 : mword 21)) = mword_of_int KernelSyms.myproc)

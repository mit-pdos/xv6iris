...
Section ProofFdalloc.
  ...
  Proof.
    ...
    (* +0x0c: jal ra,myproc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.fdalloc + 0x0c)) Rra (mword_of_int 2084182 : mword 21)
              A2 (av - 4)%nat b
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.fdalloc + 0x0c) : mword 64) (sign_extend' 64 (mword_of_int 2084182 : mword 21)) = mword_of_int KernelSyms.myproc)

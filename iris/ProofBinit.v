...
Section ProofBinit.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.binit + 0x1c)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 1824 : mword 12)
              R5 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1c").
    iIntros (CID12 Hs12) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (R6 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg (add_vec (R5 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 1824 : mword 12)))]> R5).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.binit + 0x28)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 1812 : mword 12)
              T1 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi28").
    iIntros (CID16 Hs16) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (T2 := <[Regidx (mword_of_int 15 : mword 5) := regval_into_reg (add_vec (T1 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 1812 : mword 12)))]> T1).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.binit + 0x30)) (mword_of_int 14 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 2420 : mword 12)
              T3 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi30").
    iIntros (CID18 Hs18) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (T4 := <[Regidx (mword_of_int 14 : mword 5) := regval_into_reg (add_vec (T3 !!! Regidx (mword_of_int 14 : mword 5)) (sign_extend' 64 (mword_of_int 2420 : mword 12)))]> T3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.binit + 0x40)) (mword_of_int 9 : mword 5) (mword_of_int 9 : mword 5) (mword_of_int 1812 : mword 12)
              T5 (K - 6)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi40").
    iIntros (CID22 Hs22) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (T6 := <[Regidx (mword_of_int 9 : mword 5) := regval_into_reg (add_vec (T5 !!! Regidx (mword_of_int 9 : mword 5)) (sign_extend' 64 (mword_of_int 1812 : mword 12)))]> T5).

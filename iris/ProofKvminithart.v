...
Section KvminithartBody.
  ...
  Proof using .
    ...
    assert (Haddr : add_vec (A0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 986 : mword 12)) = mword_of_int KernelSyms.kernel_pagetable).
    { rewrite /A0 upd_eq. apply bv_eq; vm_compute; reflexivity. }
    iApply (wp_ld_s_sconf (kt := KT0) (ktd := KT0) (mword_of_int (KernelSyms.kvminithart + 0x10)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 986 : mword 12)

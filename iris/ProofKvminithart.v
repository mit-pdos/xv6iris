...
Section KvminithartBody.
  ...
  Proof.
    ...
    iApply (wp_sfence_vma_s_sconf KT0 pcur
              ...
              W2 (K - 2)%nat tlbvec0 with "Hcg Htlb Hpc []").
    { iApply (kvi_08 with "Htext"). }
    iApply wp_next_off_intro.
    ...
    assert (Haddr : add_vec (A0 !!! Regidx (mword_of_int 15 : mword 5)) (sign_extend' 64 (mword_of_int 952 : mword 12)) = mword_of_int KernelSyms.kernel_pagetable).
    { rewrite /A0 upd_eq. apply bv_eq; vm_compute; reflexivity. }
    iApply (wp_ld_s_sconf (kt := KT0) (ktd := KT0) (mword_of_int (KernelSyms.kvminithart + 0x10)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 952 : mword 12)
              A0 (K - 2)%nat (zero_extend' 64 (concat_vec root (zeros' 12 : mword 12))) false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc [] []").
    { iApply (kvi_10 with "Htext"). }
    ...
    iApply (wp_csrli_s_sconf (mword_of_int (KernelSyms.kvminithart + 0x14)) (Cregidx (mword_of_int 7)) (mword_of_int 15 : mword 5) (mword_of_int 12 : mword 6)
              ...
              with "Hcg Hpc []").
    { iEval (rewrite <- Hc7). iApply (kvi_14 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cor_s_sconf (mword_of_int (KernelSyms.kvminithart + 0x1a)) (mword_of_int 15 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 14 : mword 5)
              ...
              with "Hcg Hpc []").
    { iEval (rewrite <- Hc6, <- Hc7). iApply (kvi_1a with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    iApply (wp_sfence_vma_kpt_s_sconf KT0 pcur
              ...
              S4 (K - 2)%nat with "Hcg Hbitkpt Hpc []").
    { iApply (kvi_20 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg _ Hpc".

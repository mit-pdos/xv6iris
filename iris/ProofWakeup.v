  ...
  Proof.
    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      iApply (wp_jal_s_sconf (CID := CIDd) (mword_of_int (KernelSyms.wakeup + 0x3a))
                (mword_of_int 1 : mword 5) (mword_of_int 2091996 : mword 21) M38 av b
      ...
      assert (Hjtgt_aq : add_vec (mword_of_int (KernelSyms.wakeup + 0x3a) : mword 64)
                          (sign_extend' 64 (mword_of_int 2091996 : mword 21)) = mword_of_int KernelSyms.acquire)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      { iIntros (Mr) "%Hmr Hcg Hpc Htok HR".
        ...
        iApply (wp_jal_s_sconf (CID := CIDf) (mword_of_int (KernelSyms.wakeup + 0x2c))
                  (mword_of_int 1 : mword 5) (mword_of_int 2092146 : mword 21) Mr2a (trap_res b + av)%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjtgt_rl : add_vec (mword_of_int (KernelSyms.wakeup + 0x2c) : mword 64)
                            (sign_extend' 64 (mword_of_int 2092146 : mword 21)) = mword_of_int KernelSyms.release)
          by (apply bv_eq; vm_compute; reflexivity).

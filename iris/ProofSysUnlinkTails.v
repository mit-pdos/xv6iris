...
(* ===================================================================== *)
Definition su_nlink_a : Z := 0x800075e0.
...
Definition su_readi_a : Z := 0x800075f8.
...
Definition su_writei_a : Z := 0x80007610.
...
Section ProofSysUnlinkTails.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (CID := CID1) (mword_of_int (SU + 0x132)) Ra0 Ra0
              (mword_of_int 1306 : mword 12) P1 K b
              ltac:(nz) ltac:(rdok) with "Hcg Hpc []").
    { iApply (suli_132 with "Htext"). }
    iIntros (CID2 Hq2) "Hcg Hpc".
    pose (P2 := <[Regidx Ra0 := regval_into_reg
                   (add_vec (rget P1 Ra0)
                      (sign_extend' 64 (mword_of_int 1306 : mword 12)))]> P1).
    ...
    iApply (wp_jal_s_sconf (CID := CID2) (mword_of_int (SU + 0x136)) Rra
              (mword_of_int 2078510 : mword 21) P2 K b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    { iApply (suli_136 with "Htext"). }
    iIntros (CID3 Hq3) "Hcg Hpc".
    assert (Htgt : add_vec (mword_of_int (SU + 0x136) : mword 64)
                     (sign_extend' 64 (mword_of_int 2078510 : mword 21))
                   = mword_of_int KernelSyms.panic) by pcw.
    iEval (rewrite Htgt) in "Hpc".
    (* the regfile the spec wants is the POST-JAL one: [wp_jal_s_sconf] wrote
       [ra].  a0 is untouched, but prove it on P3 directly -- deriving it
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (CID := CID1) (mword_of_int (SU + 0x13e)) Ra0 Ra0
              (mword_of_int 1318 : mword 12) P1 K b
              ltac:(nz) ltac:(rdok) with "Hcg Hpc []").
    { iApply (suli_13e with "Htext"). }
    iIntros (CID2 Hq2) "Hcg Hpc".
    pose (P2 := <[Regidx Ra0 := regval_into_reg
                   (add_vec (rget P1 Ra0)
                      (sign_extend' 64 (mword_of_int 1318 : mword 12)))]> P1).
    ...
    iApply (wp_jal_s_sconf (CID := CID2) (mword_of_int (SU + 0x142)) Rra
              (mword_of_int 2078498 : mword 21) P2 K b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    { iApply (suli_142 with "Htext"). }
    iIntros (CID3 Hq3) "Hcg Hpc".
    assert (Htgt : add_vec (mword_of_int (SU + 0x142) : mword 64)
                     (sign_extend' 64 (mword_of_int 2078498 : mword 21))
                   = mword_of_int KernelSyms.panic) by pcw.
    iEval (rewrite Htgt) in "Hpc".
    (* the regfile the spec wants is the POST-JAL one: [wp_jal_s_sconf] wrote
       [ra].  a0 is untouched, but prove it on P3 directly -- deriving it
  ...
  Lemma su_tail_b `{GEN : GenId} `{CID0 : CpuId}
      ...
      (w4 w5 w6 w27 w30 : mword 64) (bd bnm bp be : nat -> bv 8) (Upr : ustate) :
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID0) (mword_of_int (SU + 0xe2)) Rra
              (mword_of_int 2092160 : mword 21) M (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    iApply (EndOp.wp_end_op_sconf (CID := CID1) gs jx gl fsc_uart fsc_disk fsc_dlock pd pav pu fsc_bio
              icfg_log fsc_fs fsc_cov fsc_logst icfg_dev u pidv dq M1 (K - 30)%nat eb b lks
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID1) (mword_of_int (SU + 0x15c)) Rra
              (mword_of_int 2089828 : mword 21) M1 (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjup : add_vec (mword_of_int (SU + 0x15c) : mword 64)
                     (sign_extend' 64 (mword_of_int 2089828 : mword 21))
 ...
 kk qi s gy loy tly inum dn bm u pidv dq
    ...
    iApply (wp_jal_s_sconf (CID := CID3) (mword_of_int (SU + 0x160)) Rra
              (mword_of_int 2092034 : mword 21) mup (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjeo : add_vec (mword_of_int (SU + 0x160) : mword 64)
                     (sign_extend' 64 (mword_of_int 2092034 : mword 21))
                   = mword_of_int KernelSyms.end_op) by pcw.
    iEval (rewrite Hjeo) in "Hpc".
    ...
    iApply (EndOp.wp_end_op_sconf (CID := CID4) gs jx gl fsc_uart fsc_disk fsc_dlock pd pav pu fsc_bio
              icfg_log fsc_fs fsc_cov fsc_logst icfg_dev n2 pidv dq Q1 (K - 30)%nat eb b lks
              Upr HKeo Hgeom Hj Hgl ltac:(rewrite Hlkempty; apply locks_below_empty)
              with "Hcg Hown Htce Hcce Htext Hkd Hpc Hpenv Hbio Hlog Hseam Hgen
                    Hpid Hprocs Hdev Hgeo Hdlk Hop").
  ...
  Lemma su_tail_d `{GEN : GenId} `{CID0 : CpuId}
      ...
      (m M : regfile) (sp0 : mword 64) (K : nat) (eb : bool)
      (b : bool) (lks : gset string)
      (w5 w6 w27 w30 : mword 64) (bd bnm bp be : nat -> bv 8) (Upr : ustate) :
    (K_iunlockput <= K - 30)%nat -> (K_end_op <= K - 30)%nat ->
    (30 <= K)%nat -> ((K - 30) + 30 = K)%nat ->
    (kk < NINODE)%nat ->
    log_geom_ok fsc_cov fsc_logst ->
  ...
  Lemma su_tail_e `{GEN : GenId} `{CID0 : CpuId}
      ...
      (m M : regfile) (sp0 : mword 64) (K : nat) (eb : bool)
      (b : bool) (lks : gset string)
      (w6 w27 w30 : mword 64) (bd bnm bp be : nat -> bv 8) (Upr : ustate) (t : nat) :
    (K_iunlockput <= K - 30)%nat -> (K_end_op <= K - 30)%nat ->
    (30 <= K)%nat -> ((K - 30) + 30 = K)%nat ->
    ...
    ~ (IBLOCK inum icfg_ist ∈ log_region_set fsc_logst) ->
    bv_unsigned inum < 16 * Z.of_nat icfg_nib ->
    IBLOCK inumi icfg_ist ∈ fsc_cov ->
    ~ (IBLOCK inumi icfg_ist ∈ log_region_set fsc_logst) ->
    bv_unsigned inumi < 16 * Z.of_nat icfg_nib ->
    cov_below fsc_cov fsc_size ->
    (2 * iput_units <= u)%nat ->
    (jx < NPROC)%nat -> gs !! jx = Some gl ->
    lks = ∅ ->
    ...
    ic_loaded fsc_fs fsc_ireg fsc_cov fsc_logst ki inumi dni bmi -∗
    ity_shot gyi (di_type dni) -∗
    (* ...AND THE INUM'S FREEZE TOKEN, [SpecIunlockput]'s new premise since
       iclaim-ledger.md §3.9 (RULING A-prime): the payload's A-custody
       conjunct, relayed from the caller's own ilock. *)
    ifreeze_off (bv_unsigned inumi) -∗
    inode_ref_short ki (qip + si)%Qp qip icfg_dev inumi -∗
    (* its PROVENANCE UNIT (item 7a-wire): iunlockput's iput spends it. *)
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (CID := CID1) (mword_of_int (SU + 0x176)) Rra
              (mword_of_int 2089802 : mword 21) M1 (K - 30)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjup : add_vec (mword_of_int (SU + 0x176) : mword 64)
                     (sign_extend' 64 (mword_of_int 2089802 : mword 21))
                   = mword_of_int KernelSyms.iunlockput) by pcw.
    iEval (rewrite Hjup) in "Hpc".
    assert (HM2ra : (M2 !!! Regidx Rra : mword 64)

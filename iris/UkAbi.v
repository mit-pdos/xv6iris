...
(* which is the move UkSync.v §1's [uk_stack] already made from            *)
...
(* keeps the whole bundle decidable.  UkSync.v's [uk_stack_bytes_dec] is   *)
...
(*                                                                         *)
(* [uk_rpage] is UkSync.v's [uk_xpage] / [uk_wpage] with NO bit demanded   *)
...
(* the argument area's counterpart of UkSync.v's [uk_stack_slot].          *)
(* ===================================================================== *)

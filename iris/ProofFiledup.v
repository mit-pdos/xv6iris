...
Section ProofFiledup.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filedup + 0x10)) Ra0 Ra0 (mword_of_int 0x366 : mword 12)
    ...
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 870 : mword 12)))]> R4).
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filedup + 0x14)) Rra (mword_of_int 0x1fca6e : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.filedup + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x1fca6e : mword 21))
    ...
    iDestruct (cpu_own_transport CID CID9 n eb p b ltac:(wp_next_chain)
                 with "Hcnt") as "Hcnt".
    iApply (Acquire.wp_acquire_sconf KT1 γl "ftable"%string (ftable_res_at γf) mA
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filedup + 0x26)) Ra0 Ra0 (mword_of_int 0x350 : mword 12)
    ...
    set (D4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (D3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 848 : mword 12)))]> D3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filedup + 0x2a)) Rra (mword_of_int 0x1fcae0 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.filedup + 0x2a) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x1fcae0 : mword 21))
    ...
    iApply (Release.wp_release_sconf KT1 γl ftable_addr "ftable"%string (ftable_res_at γf) D5
              n eb p (K - 4)%nat
              ({["ftable"]} ∪ lks)

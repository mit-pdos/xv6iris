...
Section ProofFiledup.
  ...
  Proof using .
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filedup + 0x10)) Ra0 Ra0 (mword_of_int 0x550 : mword 12)
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filedup + 0x14)) Rra (mword_of_int 0x1fca28 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.filedup + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x1fca28 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filedup + 0x26)) Ra0 Ra0 (mword_of_int 0x53a : mword 12)
    ...
    set (D4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (D3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1338 : mword 12)))]> D3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filedup + 0x2a)) Rra (mword_of_int 0x1fca9a : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.filedup + 0x2a) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x1fca9a : mword 21))

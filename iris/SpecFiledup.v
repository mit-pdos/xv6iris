...
Definition wp_filedup_sconf_body `{!riscvGS Σ, !lockG Σ, !sieG Σ, !fileG Σ, !fdslotG Σ, !irefNameG Σ} `{GEN : GenId} `{CID : CpuId} (γl γf : gname)
...
Module Type FILEDUP.
  Parameter wp_filedup_sconf :
    forall `{!riscvGS Σ, !lockG Σ, !sieG Σ, !fileG Σ, !fdslotG Σ, !irefNameG Σ} `{GEN : GenId} `{CID : CpuId} (γl γf : gname)
      (k : nat) (q : Qp) (Cf : fcontent)
      (m : regfile) (n : nat) (eb : bool) (p : mword 64) (C : iProp Σ) (K : nat) (b : bool),

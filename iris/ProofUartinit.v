...
Section ProofUartinit.
  ...
  Lemma wp_uartinit_sconf (γ : gname) (γd : uart_names) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 1 Φ (mword_of_int (UI + 0x0c)) false (mword_of_int 0 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 1 : mword 12)
              R3 (K - 2)%nat
    ...
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 3 Φ (mword_of_int (UI + 0x18)) false (mword_of_int 13 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 3 : mword 12)
              R5 (K - 2)%nat
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) b0)%I
    ...
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 0 Φ (mword_of_int (UI + 0x22)) false (mword_of_int 13 : mword 5) (mword_of_int 12 : mword 5) (mword_of_int 0 : mword 12)
              R7 (K - 2)%nat
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) true)%I
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) true)%I
              ltac:(unfold uart_size; lia)
    ...
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 1 Φ (mword_of_int (UI + 0x26)) false (mword_of_int 0 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 1 : mword 12)
              R7 (K - 2)%nat
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) true)%I
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) true)%I
              ltac:(unfold uart_size; lia)
    ...
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 3 Φ (mword_of_int (UI + 0x2a)) false (mword_of_int 13 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 3 : mword 12)
              R7 (K - 2)%nat
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) true)%I
    ...
    (* +0x32 sb a2,2(a4) : FCR <- 0x07 -- enable + CLEAR BOTH FIFOS.  The tx
       ...
       nothing. *)
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 2 Φ (mword_of_int (UI + 0x32)) false (mword_of_int 12 : mword 5) (mword_of_int 14 : mword 5) (mword_of_int 2 : mword 12)
              R9 (K - 2)%nat
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) false)%I
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) false)%I
              ltac:(unfold uart_size; lia)
    ...
    (* +0x36 sb a3,1(a5) : IER <- 3 -- enable tx/rx interrupts.  Offset 1
       again, stable. *)
    iApply (Uart.wp_sb_uart_uinv_s_sconf γ γd 1 Φ (mword_of_int (UI + 0x36)) false (mword_of_int 13 : mword 5) (mword_of_int 15 : mword 5) (mword_of_int 1 : mword 12)
              R9 (K - 2)%nat
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) false)%I
              (uart_tx_own γd l ∗ uart_dlab_is γd (DfracOwn (1/2)) false)%I
              ltac:(unfold uart_size; lia)

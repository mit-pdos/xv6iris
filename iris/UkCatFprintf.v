...
Section UkCatFprintf.
  ...
  Proof.
    ...
    iApply (wp_uk_caddi16sp_dn γt γd γs h m (mword_of_int 0x7d0)
    ...
    assert (Hs0q1 : mq1 !!! Regidx s0_idx = m !!! Regidx s0_idx)
      by exact (upd_ne m (Regidx csp_rs1) (Regidx s0_idx) _
                  ltac:(vm_compute; discriminate)).
    iApply (wp_uk_csdsp γt γd γs h0 mq1 (mword_of_int 0x7d2)
    ...
    iApply (wp_uk_csdsp γt γd γs h1 mq1 (mword_of_int 0x7d4)
    ...
    iApply (wp_uk_caddi4spn γt γd γs h2 mq1 (mword_of_int 0x7d6)
    ...
    assert (Hoc0 : uoff_c8 (mword_of_int 0 : mword 5) = 0)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd γt γd γs h3 mq2 (mword_of_int 0x7d8)
    ...
    assert (Hoc8 : uoff_c8 (mword_of_int 1 : mword 5) = 8)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd γt γd γs h4 mq2 (mword_of_int 0x7da)
    ...
    assert (Hoc16 : uoff_c8 (mword_of_int 2 : mword 5) = 16)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd γt γd γs h5 mq2 (mword_of_int 0x7dc)
    ...
    assert (Hoc24 : uoff_c8 (mword_of_int 3 : mword 5) = 24)
      by (vm_compute; reflexivity).
    iApply (wp_uk_csd γt γd γs h6 mq2 (mword_of_int 0x7de)
    ...
    assert (Hoi32 : uoff_i12 (mword_of_int 32 : mword 12) = 32)
      by (vm_compute; reflexivity).
    iApply (wp_uk_sd γt γd γs h7 mq2 (mword_of_int 0x7e0)
    ...
    assert (Hoi40 : uoff_i12 (mword_of_int 40 : mword 12) = 40)
      by (vm_compute; reflexivity).
    iApply (wp_uk_sd γt γd γs h8 mq2 (mword_of_int 0x7e4)
    ...
    iApply (wp_uk_cmv γt γd γs h9 mq2 (mword_of_int 0x7e8) a2_idx s0_idx
    ...
    assert (Hoim24 : uoff_i12 (mword_of_int 4072 : mword 12) = -24)
      by (vm_compute; reflexivity).
    iApply (wp_uk_sd γt γd γs h10 mq3 (mword_of_int 0x7ea)
    ...
    { rewrite <- Ha1r.
      ...
      rewrite /mq1. exact (upd_ne m (Regidx csp_rs1) (Regidx a1_idx) _
                             ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_jal γt γd γs h11 mq3 (mword_of_int 0x7ee)
    ...
    { rewrite (Hcs csp_rs1 ltac:(vm_compute; reflexivity)).
      ...
      rewrite /mq3. exact (upd_ne mq2 (Regidx a2_idx) (Regidx csp_rs1) _
                             ltac:(vm_compute; discriminate)). }
    iApply (wp_uk_cldsp γt γd γs h13 mq5 (mword_of_int 0x7f2)
    ...
    iApply (wp_uk_cldsp γt γd γs h14 mq6 (mword_of_int 0x7f4)
    ...
    iApply (wp_uk_caddi16sp_up γt γd γs h15 mq7 (mword_of_int 0x7f6)
    ...
    (* ---- 0x7f8  c.jr ra ---- *)
    iApply (wp_uk_cjr γt γd γs h16 mq8 (mword_of_int 0x7f8) ra_idx

...
Section ProofIdup.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.idup + 0x10)) Ra0 Ra0 (mword_of_int 1796 : mword 12)
    ...
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1796 : mword 12)))]> R4).
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.idup + 0x14)) Rra (mword_of_int 2087382 : mword 21)
    ...
    iDestruct (cpu_own_transport CID CID9 n eb p b ltac:(wp_next_chain)
                 with "Hcnt") as "Hcnt".
    iApply (Acquire.wp_acquire_sconf KT1 γl "itable"%string (itable_res2 fsc_ic fsc_fs γi fsc_cov logstart nib dev) mA
    ...
    iApply (wp_sw_au_s_sconf true (mword_of_int (KernelSyms.idup + 0x1c)) Ra5 Rs1
              ...
              ltac:(solve_ndisj)
              with "Hcg Hpc [] [] [Hhalf Hrlive Hisl Hmir Hru Hicnt]").
    ...
    iAssert (itable_res2 fsc_ic fsc_fs γi fsc_cov logstart nib dev) with "[Hhalf Hiauth Hipool Hslots Hpool]" as "HRres".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.idup + 0x22)) Ra0 Ra0 (mword_of_int 1778 : mword 12)
    ...
    set (D4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (D3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1778 : mword 12)))]> D3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.idup + 0x26)) Rra (mword_of_int 2087500 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.idup + 0x26) : mword 64)
                        (sign_extend' 64 (mword_of_int 2087500 : mword 21))
    ...
    iApply (Release.wp_release_sconf KT1 γl itable_lock "itable"%string (itable_res2 fsc_ic fsc_fs γi fsc_cov logstart nib dev) D5
  ...
  Lemma wp_idup_sconf
      ...
      (m : regfile) (n : nat) (eb : bool) (p : mword 64)
      (K : nat) (b : bool) (lks : gset string)
    : wp_idup_sconf_body γl γi logstart inodestart nib k dev
                         m n eb p K b lks.
  Proof.
    ...
    iApply (wp_idup_core γl γi logstart inodestart nib

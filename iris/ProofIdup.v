...
Section ProofIdup.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.idup + 0x10)) Ra0 Ra0 (mword_of_int 1710 : mword 12)
    ...
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1710 : mword 12)))]> R4).
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.idup + 0x14)) Rra (mword_of_int 2087330 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.idup + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 2087330 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.idup + 0x22)) Ra0 Ra0 (mword_of_int 1692 : mword 12)
    ...
    set (D4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (D3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1692 : mword 12)))]> D3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.idup + 0x26)) Rra (mword_of_int 2087448 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.idup + 0x26) : mword 64)
                        (sign_extend' 64 (mword_of_int 2087448 : mword 21))

...
Section ProofIdup.
  ...
  Proof.
    ...
    iDestruct (cpu_own_transport CID CID9 n eb p b ltac:(wp_next_chain)
                 with "Hcnt") as "Hcnt".
    iApply (Acquire.wp_acquire_sconf KT1 γl "itable"%string (itable_res2 fsc_ic fsc_fs γi cov logstart nib dev) mA
    ...
    iAssert (itable_res2 fsc_ic fsc_fs γi cov logstart nib dev) with "[Hhalf Hiauth Hipool Hslots Hpool]" as "HRres".
    ...
    iApply (Release.wp_release_sconf KT1 γl itable_lock "itable"%string (itable_res2 fsc_ic fsc_fs γi cov logstart nib dev) D5
  ...
  Proof.
    ...
    iApply (wp_idup_core γl γi cov logstart inodestart nib

...
Section UkLbuTextPostFetch.
  ...
  Lemma uk_lbu_text_post_fetch (R : iProp Σ) (Rut : uptd -> iProp Σ) (sz : Z)
    ...
    (R -∗ (TsoCtx.own_context XI -∗ Rut pt) ∗ Rfd fdv ∗ ukb C pt Rfd Rut sz π fdv cw gn cs ∗
          (uvb C pt Rfd Rut sz π fdv cw gn cs M
...
Section UkLbuTextObl.
  ...
  Proof.
    ...
    iApply (uk_lbu_text_post_fetch C pt Rfd R Rut sz π M Mp m pc imm lr1 lrd
              w_ld va bb (zero_extend' 32 w) t' usatp pcfg paddr rs1 rs2 fdv cw gn cs
...
Section UkLbuText.
  ...
  Proof.
    ...
    iApply (uk_lbu_text_obl_base C' pt' Rfd' R Rut' sz π M Mp' m pc w imm rs1 rd
              w_ld va bb t usatp pcfg paddr rs1s rsA fdv cw gn cs Hpre Hpure
  ...
  Proof.
    ...
    iIntros "Hb Hcont".
    iApply (wp_uk_lbu_text_later M m pc fdv cw gn cs imm rs1 rd va wval bb

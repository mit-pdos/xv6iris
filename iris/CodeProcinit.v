...
Section CodeProcinit.
  ...
  Lemma pii_18 : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x18) : mword 64) false (ITYPE (mword_of_int 2414 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x18) (mword_of_int 0x96e58593 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x18) : mword 64) (ITYPE (mword_of_int 2414 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)) kd_96e58593. Qed.
  ...
  Lemma pii_20 : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x20) : mword 64) false (ITYPE (mword_of_int 2958 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x20) (mword_of_int 0xb8e50513 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x20) : mword 64) (ITYPE (mword_of_int 2958 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_b8e50513. Qed.
  ...
  Lemma pii_2c : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x2c) : mword 64) false (ITYPE (mword_of_int 2402 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x2c) (mword_of_int 0x96258593 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x2c) : mword 64) (ITYPE (mword_of_int 2402 : mword 12, Regidx (mword_of_int 11), Regidx (mword_of_int 11), ADDI)) kd_96258593. Qed.
  ...
  Lemma pii_34 : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x34) : mword 64) false (ITYPE (mword_of_int 2962 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x34) (mword_of_int 0xb9250513 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x34) : mword 64) (ITYPE (mword_of_int 2962 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), ADDI)) kd_b9250513. Qed.
  ...
  Lemma pii_40 : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x40) : mword 64) false (ITYPE (mword_of_int 3998 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x40) (mword_of_int 0xf9e48493 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x40) : mword 64) (ITYPE (mword_of_int 3998 : mword 12, Regidx (mword_of_int 9), Regidx (mword_of_int 9), ADDI)) kd_f9e48493. Qed.
  ...
  Lemma pii_48 : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x48) : mword 64) false (ITYPE (mword_of_int 2390 : mword 12, Regidx (mword_of_int 22), Regidx (mword_of_int 22), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x48) (mword_of_int 0x956b0b13 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x48) : mword 64) (ITYPE (mword_of_int 2390 : mword 12, Regidx (mword_of_int 22), Regidx (mword_of_int 22), ADDI)) kd_956b0b13. Qed.
  ...
  Lemma pii_74 : kernel_text -∗ instr (mword_of_int (KernelSyms.procinit + 0x74) : mword 64) false (ITYPE (mword_of_int 2410 : mword 12, Regidx (mword_of_int 20), Regidx (mword_of_int 20), ADDI)).
  Proof. mk_base (KernelSyms.procinit + 0x74) (mword_of_int 0x96aa0a13 : mword 32)
    (mword_of_int (KernelSyms.procinit + 0x74) : mword 64) (ITYPE (mword_of_int 2410 : mword 12, Regidx (mword_of_int 20), Regidx (mword_of_int 20), ADDI)) kd_96aa0a13. Qed.

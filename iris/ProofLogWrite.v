...
Section LogWriteBlocks.
  ...
  Local Lemma lw_rel `{GEN : GenId} `{CID0 : CpuId}
    ...
    lw_cont (CID0 := CID0) bn γ γfs γd cov dev k pidv bno bs bsd Fb Bud m K n eb p C b lks -∗
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0xb2)) Ra0 Ra0 (mword_of_int 1284 : mword 12)
    ...
    set (E2 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (E1 !!! Regidx Ra0 : mword 64)
                     (sign_extend' 64 (mword_of_int 1284 : mword 12)))]> E1).
    ...
    (* ===== +0xb6 jal ra,release ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.log_write + 0xb6)) Rra (mword_of_int 2084294 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.log_write + 0xb6) : mword 64)
                        (sign_extend' 64 (mword_of_int 2084294 : mword 21))
    ...
    iDestruct (lw_cont_shift (CIDa := CID0) (CIDb := CID6) bn γ γfs γd cov dev k pidv bno
                 bs bsd Fb Bud m K n eb p C b lks ltac:(wp_next_chain) with "Hcont") as "Hcont".
    rewrite /lw_cont.
  ...
  Proof.
    ...
    (* ===== +0x68 jal ra,bpin ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.log_write + 0x68)) Rra (mword_of_int 2092732 : mword 21)
    ...
    assert (Htgtbp : add_vec (mword_of_int (KernelSyms.log_write + 0x68) : mword 64)
                       (sign_extend' 64 (mword_of_int 2092732 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x70)) Ra4 Ra4 (mword_of_int 1350 : mword 12)
    ...
    set (A4 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (A3 !!! Regidx Ra4 : mword 64)
                     (sign_extend' 64 (mword_of_int 1350 : mword 12)))]> A3).
    ...
    iApply (lw_rel (CID0 := cpu_id) bn γ γfs γd cov logstart dev k pidv bno bs bsd Fb Bud
              m A6 K n eb p C b lks HK Hbeq HA6regs
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0xa0)) Ra4 Ra4 (mword_of_int 1302 : mword 12)
    ...
    set (B4 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (B3 !!! Regidx Ra4 : mword 64)
                     (sign_extend' 64 (mword_of_int 1302 : mword 12)))]> B3).
    ...
    - (* i == n: rejoin the bpin block at +0x66 *)
      ...
      iApply (lw_pin (CID0 := cpu_id) bn γ γfs γd cov logstart dev k pidv bno bs bsd Fb Bud nl
                m B6 K n eb p C b lks HK Hnoff Hbeq Hk Hnl Ha0 HB6regs
    ...
    - (* i < n: fall through to the release *)
      ...
      iDestruct (lw_cont_shift (CIDa := CID0) (CIDb := cpu_id) bn γ γfs γd cov dev k pidv bno
                   bs bsd Fb Bud m K n eb p C b lks ltac:(wp_next_chain) with "Hcont") as "Hcont".
      iApply (lw_rel (CID0 := cpu_id) bn γ γfs γd cov logstart dev k pidv bno bs bsd Fb Bud
                m B6 K n eb p C b lks HK Hbeq HB6regs
                with "Hcg Htext Hpc Hlctx Hcnt Hpay Htok HRres Hframe Hout Hcont").
  Qed.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x5c)) Ra5 Ra5 (mword_of_int 1370 : mword 12)
    ...
    set (G4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (G3 !!! Regidx Ra5 : mword 64)
                     (sign_extend' 64 (mword_of_int 1370 : mword 12)))]> G3).
    ...
    iApply (lw_pin (CID0 := CID0) bn γ γfs γd cov logstart dev k pidv bno bs bsd Fb Bud nl
              m G6 K n eb p C b lks HK Hnoff Hbeq Hk Hnl Ha0 HG6regs
              with "Hcg Htext Hpc Hpanic Hbio Hlctx Hcnt Hpay Htok Hframe Hslot Hbnoc
                    Hncell Hclose Hcont").
  Qed.
  ...
  Proof.
    ...
    - (* ---- ABSORPTION HIT at index i ---- *)
      ...
      iApply (lw_blk94 (CID0 := cpu_id) bn γ γfs γd cov logstart dev k pidv bno bs bsd Fb Bud
                nl i bno m S1 K n eb p C b lks HK Hnoff Hbeq Hk Hnl ltac:(lia) Ha0
                HS1regs HS1a5 HS1a2
                with "Hcg Htext Hpc Hpanic Hbio Hlctx Hcnt Hpay Htok Hframe Hslot Hbnoc
    ...
    - (* ---- no hit here: bump and loop ---- *)
      ...
      + (* the scan ran off the end: i == n, the APPEND path *)
        ...
        iApply (lw_app52 (CID0 := CID0) bn γ γfs γd cov logstart dev k pidv bno bs bsd Fb Bud
                  nl jk m S3 K n eb p C b lks HK Hnoff Hbeq Hk Hnl Ha0 HS3regs HS3a2
                  with "Hcg Htext Hpc Hpanic Hbio Hlctx Hcnt Hpay Htok Hframe Hslot Hbnoc
...
Section ProofLogWrite.
  ...
  Proof.
    ...
    iAssert (lw_cont (CID0 := CID) bn γ γfs γd cov dev k pidv bno bs bsd Φfsb Bud
                     m K n eb p C b lks)%I with "[Hcont]" as "Hcont";
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x10)) Ra0 Ra0 (mword_of_int 1446 : mword 12)
              R4 (K - 4)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi10").
    iIntros (CID8 Hs8) "Hcg Hpc".
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0 : mword 64)
                     (sign_extend' 64 (mword_of_int 1446 : mword 12)))]> R4).
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.log_write + 0x14)) Rra (mword_of_int 2084320 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.log_write + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 2084320 : mword 21))
    ...
    iDestruct (lw_cont_shift (CIDa := CID) (CIDb := CID9) bn γ γfs γd cov dev k pidv bno
                 bs bsd Φfsb Bud m K n eb p C b lks ltac:(wp_next_chain) with "Hcont") as "Hcont".
    ...
    assert (Hna : add_vec (rget T1 Ra2) (sign_extend' 64 (mword_of_int 1478 : mword 12))
                  = lh_n_pa).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.log_write + 0x1c)) Ra2 Ra2
              (mword_of_int 1478 : mword 12) T1 (trap_res b + (K - 4))%nat
    ...
    assert (Hoa : add_vec (rget T4 Ra5) (sign_extend' 64 (mword_of_int 1448 : mword 12))
                  = l_out).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.log_write + 0x2a)) Ra5 Ra5
              (mword_of_int 1448 : mword 12) T4 (trap_res b + (K - 4))%nat
    ...
    - (* ---- lh.n == 0: the loop is skipped; the +0x94 block appends ---- *)
      ...
      iApply (lw_blk94 bn γ γfs γd cov logstart dev k pidv bno bs bsd Φfsb Bud
                0%nat 0%nat jk m T6 K n eb p C b lks
    ...
    - (* ---- lh.n >= 1: set up and run the scan ---- *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x3e)) Ra4 Ra4
                (mword_of_int 1448 : mword 12) T8 (trap_res b + (K - 4))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi3e").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      set (T9 := <[Regidx Ra4 := regval_into_reg
                    (add_vec (T8 !!! Regidx Ra4 : mword 64)
                       (sign_extend' 64 (mword_of_int 1448 : mword 12)))]> T8).
      ...
      iApply (lw_scan bn γ γfs γd cov logstart dev k pidv bno bs bsd Φfsb Bud
                (S nlp) W m K n eb p C b lks (S nlp)
                ltac:(exact HK) ltac:(exact Hnoff) ltac:(exact Hbeq) Hk

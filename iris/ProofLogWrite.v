...
Section LogWriteBlocks.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0xb2)) Ra0 Ra0 (mword_of_int 1314 : mword 12)
    ...
    set (E2 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (E1 !!! Regidx Ra0 : mword 64)
                     (sign_extend' 64 (mword_of_int 1314 : mword 12)))]> E1).
    ...
    (* ===== +0xb6 jal ra,release ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.log_write + 0xb6)) Rra (mword_of_int 2084310 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.log_write + 0xb6) : mword 64)
                        (sign_extend' 64 (mword_of_int 2084310 : mword 21))
  ...
  Proof.
    ...
    (* ===== +0x68 jal ra,bpin ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.log_write + 0x68)) Rra (mword_of_int 2092748 : mword 21)
    ...
    assert (Htgtbp : add_vec (mword_of_int (KernelSyms.log_write + 0x68) : mword 64)
                       (sign_extend' 64 (mword_of_int 2092748 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x70)) Ra4 Ra4 (mword_of_int 1380 : mword 12)
    ...
    set (A4 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (A3 !!! Regidx Ra4 : mword 64)
                     (sign_extend' 64 (mword_of_int 1380 : mword 12)))]> A3).
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0xa0)) Ra4 Ra4 (mword_of_int 1332 : mword 12)
    ...
    set (B4 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (B3 !!! Regidx Ra4 : mword 64)
                     (sign_extend' 64 (mword_of_int 1332 : mword 12)))]> B3).
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x5c)) Ra5 Ra5 (mword_of_int 1400 : mword 12)
    ...
    set (G4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (G3 !!! Regidx Ra5 : mword 64)
                     (sign_extend' 64 (mword_of_int 1400 : mword 12)))]> G3).
...
Section ProofLogWrite.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x10)) Ra0 Ra0 (mword_of_int 1476 : mword 12)
              R4 (K - 4)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi10 [-]").
    iIntros (CID8 Hs8) "Hcg Hpc".
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0 : mword 64)
                     (sign_extend' 64 (mword_of_int 1476 : mword 12)))]> R4).
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.log_write + 0x14)) Rra (mword_of_int 2084336 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.log_write + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 2084336 : mword 21))
    ...
    assert (Hna : add_vec (rget T1 Ra2) (sign_extend' 64 (mword_of_int 1508 : mword 12))
                  = lh_n_pa).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.log_write + 0x1c)) Ra2 Ra2
              (mword_of_int 1508 : mword 12) T1 (trap_res b + (K - 4))%nat
    ...
    assert (Hoa : add_vec (rget T4 Ra5) (sign_extend' 64 (mword_of_int 1478 : mword 12))
                  = l_out).
    ...
    iApply (wp_lw_s_sconf (mword_of_int (KernelSyms.log_write + 0x2a)) Ra5 Ra5
              (mword_of_int 1478 : mword 12) T4 (trap_res b + (K - 4))%nat
    ...
    - (* ---- lh.n >= 1: set up and run the scan ---- *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.log_write + 0x3e)) Ra4 Ra4
                (mword_of_int 1478 : mword 12) T8 (trap_res b + (K - 4))%nat false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi3e [-]").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      set (T9 := <[Regidx Ra4 := regval_into_reg
                    (add_vec (T8 !!! Regidx Ra4 : mword 64)
                       (sign_extend' 64 (mword_of_int 1478 : mword 12)))]> T8).

...
Section UwBodies.
  ...
  Proof.
    ...
    iIntros "#Ht #Htxl Hcg Hcnt Hpay Hpc Htok HR #Hsub Hsv Hgap Hs10 Hbuf Hctx Hpark Hcont".
    iDestruct (is_txlock_lock with "Htxl") as "#Hlk".
    set (spd := pa_stk sp0 10).
    (* +0x7c  auipc a0,0x12 *)
    iPoseProof (uwi_7c with "Ht") as "Hi7c".
    iApply (wp_auipc_s_sconf Φ (mword_of_int (UW + 0x7c)) Ra0 (mword_of_int 18 : mword 20)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (UW + 0x80)) Ra0 Ra0 (mword_of_int 0x9b8 : mword 12)
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (UW + 0x84)) Rra (mword_of_int 816 : mword 21)
    ...
    iApply (Release.wp_release_sconf Φ γl a_tx_lock "uart"%string (tx_res γu) T2
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x88)) (mword_of_int 9 : mword 6) Rra
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x8a)) (mword_of_int 8 : mword 6) Rs0
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x8c)) (mword_of_int 7 : mword 6) Rs1
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x8e)) (mword_of_int 3 : mword 6) Rs5
    ...
    iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (UW + 0x90)) (mword_of_int 5 : mword 6)
    ...
    iApply (wp_cret_s_sconf Φ (mword_of_int (UW + 0x92)) Rra E5 av true ltac:(nz)
              with "Hcg Hpc Hi92 [-]").
    ...
    iApply ("Hcont" $! E5 with "[%] Hcg Hcnt Hpc Hbuf Hsub Hctx Hpark").
    unfold callee_saved.
    split; [exact HE5sp|].
    split; [exact HE5s0|].
    split; [exact HE5s1|].
  ...
  Proof.
    ...
    iIntros "Hcg Hcnt Hpay Hpc Htok Hres #Hsub Hfull Hbuf Hctx Hpark Hcont".
    iDestruct (is_txlock_lock with "Htxl") as "#Hlk".
    ...
    { iIntros (CIDb Hsbd M2 l2 b2) "%Hregs2 Hcg Hcnt Hpay Hpc Htok Hcell Hown #Hlb Hfull Hbuf Hctx Hpark Hcont".
      ...
      iApply (wp_lbu_s_sconf Φ (mword_of_int (UW + 0x5a)) Ra5 Rs4 (mword_of_int 0 : mword 12)
                M2 (av - 10)%nat (f i : mword 8) false (dqm := dq) ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi5a [Hbyte] [-]").
      { iEval (rewrite Haddrb). iExact "Hbyte". }
      rewrite wp_next_off. iIntros "Hcg Hpc Hbyte".
      ...
      iApply (UAcc.wp_uart_thr_write_s_sconf γu γv Φ (mword_of_int (UW + 0x5e)) Ra5 Rs7
                B1 (av - 10)%nat l2 false HB1s7 with "Hcg Hpc Hi5e Hdinv Hown Hlb Hdlab").
      rewrite wp_next_off. iIntros "Hcg Hpc Hown #Hsent".
      ...
      iApply (wp_sw_s_sconf Φ (mword_of_int (UW + 0x62)) Rs6 Rs1 (mword_of_int 0 : mword 12)
      ...
      (* --- +0x66  c.addi s4,s4,1 --- *)
      iApply (wp_caddi_s_sconf Φ (mword_of_int (UW + 0x66)) Rs4 (mword_of_int 1 : mword 6)
      ...
      - (* the last byte: leave the loop *)
        ...
        iApply (wp_beq_taken_s_sconf Φ (mword_of_int (UW + 0x68)) (mword_of_int 10 : mword 13)
        ...
        iApply ("Hexit" $! B2 with "[%] Hcg Hcnt Hpay Hpc Htok Hres Hsub' Hfull Hbuf Hctx Hpark").
        exact HB2regs.
      - (* more bytes: back to the head *)
        assert (Hendn : S i <> n) by (intro Hc; rewrite Hc Nat.eqb_refl in Hend; discriminate).
        iApply (wp_beq_fall_s_sconf Φ (mword_of_int (UW + 0x68)) (mword_of_int 10 : mword 13)
                  Rs5 Rs4 B2 (av - 10)%nat false ltac:(nz) ltac:(nz) Hcmp with "Hcg Hpc Hi68 [-]").
        rewrite wp_next_off. iIntros "Hcg Hpc". iEval (rewrite P6c) in "Hpc".
        iDestruct "Hcont" as "[Hnext _]".
        rewrite /uw_next_cont.
        iSpecialize ("Hnext" $! CIDb with "[%]"); [wp_next_chain|].
        iApply ("Hnext" $! B2 with "[%] [%] Hcg Hcnt Hpay Hpc Htok Hres Hsub' Hfull Hbuf Hctx Hpark").
        + lia.
        + exact HB2regs. }
    (* ================================================================= *)
    ...
    { iLöb as "IH".
      iIntros (CIDs0 Hss0 M1) "%Hregs1 Hcg Hcnt Hpay Hpc Htok Hres Hfull Hbuf Hctx Hpark Hcont".
      pose proof Hregs1 as Hregs1'.
      destruct Hregs1' as (Hsp & Hs1 & Hs2 & Hs3 & Hs4 & Hs5 & Hs6 & Hs7 & H24 & H25 & H26 & H27).
      (* --- +0x4e  c.mv a1,s3 --- *)
      iApply (wp_cmv_s_sconf Φ (mword_of_int (UW + 0x4e)) Ra1 Rs3 M1 (av - 10)%nat false
                ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi4e [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc". iEval (rgne) in "Hcg".
      ...
      (* --- +0x50  c.mv a0,s2 --- *)
      iApply (wp_cmv_s_sconf Φ (mword_of_int (UW + 0x50)) Ra0 Rs2 S1 (av - 10)%nat false
      ...
      (* --- +0x52  jal ra,sleep --- *)
      iApply (wp_jal_s_sconf Φ (mword_of_int (UW + 0x52)) Rra (mword_of_int 5592 : mword 21)
      ...
      iApply (Sleep.wp_sleep_sconf Φ γs j γlp γl a_tx_lock "uart"%string (tx_res γu)
                ...
                ltac:(unfold uartwrite_stack in Hav; lia)
                with "Hcg Hcnt Hpay Ht Hpc Hpinv Hscheds [Hlk] Htok Hres Hpanic Hctx Hpark [-]").
      { iExact "Hlk". }
      iIntros (CIDs Hss Ms) "%Hscs Hcg Hcnt Hpay Hpc Htok Hres Hctx Hpark".
      ...
      iApply (wp_clw_s_sconf Φ (mword_of_int (UW + 0x56)) Ra5 Rs1
      ...
      rewrite wp_next_off. iIntros "Hcg Hpc Hcell". iEval (rewrite Haddrc) in "Hcell".
      ...
      + (* tx_busy == 0: fall through into the body *)
        ...
        iApply (wp_cbnez_fall_s_sconf Φ (mword_of_int (UW + 0x58)) (mword_of_int 251 : mword 8)
                  ...
                  with "Hcg Hpc Hi58 [-]").
        rewrite wp_next_off. iIntros "Hcg Hpc". iEval (rewrite P5a) in "Hpc".
        iDestruct ("Hwand" with "[%]") as "#Hlb"; [exact Hb0|].
        iSpecialize ("Body" $! CIDs with "[%]"); [wp_next_chain|].
        iApply ("Body" $! S4 l b with "[%] Hcg Hcnt Hpay Hpc Htok Hcell Hown Hlb Hfull Hbuf Hctx Hpark Hcont").
        exact HS4regs.
      + (* still busy: sleep again *)
        ...
        iApply (wp_cbnez_taken_s_sconf Φ (mword_of_int (UW + 0x58)) (mword_of_int 251 : mword 8)
                  (Cregidx (mword_of_int 7)) Ra5 S4 (av - 10)%nat false uw_cr7 ltac:(nz)
                  ltac:(rgne; rewrite HS4a5; unfold neq_vec; rewrite Hbz; reflexivity)
        ...
        iApply ("IH" $! S4 with "[%] Hcg Hcnt Hpay Hpc Htok Hres Hfull Hbuf Hctx Hpark Hcont").
        exact HS4regs. }
    (* ================================================================= *)
    (*  THE HEAD: +0x6c .. +0x70.                                         *)
    (* ================================================================= *)
    ...
    iApply (wp_clw_s_sconf Φ (mword_of_int (UW + 0x6c)) Ra5 Rs1
              (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 5) ('b"00")))
    ...
    - (* tx_busy == 0: straight to the body via the +0x70 jump *)
      assert (Hb0 : b = (mword_of_int 0 : mword 32)) by (apply uw_sext_zero; exact Hbz).
      iApply (wp_cbnez_fall_s_sconf Φ (mword_of_int (UW + 0x6e)) (mword_of_int 240 : mword 8)
                ...
                with "Hcg Hpc Hi6e [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc". iEval (rewrite P70) in "Hpc".
      iApply (wp_cj_s_sconf Φ (mword_of_int (UW + 0x70))
                (sign_extend' 21 (concat_vec (mword_of_int 2037 : mword 11) ('b"0")))
                H1 (av - 10)%nat false ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi70 [-]").
      rewrite wp_next_off. iNext. iIntros "Hcg Hpc".
      iEval (rewrite Jbody) in "Hpc".
      iDestruct ("Hwand" with "[%]") as "#Hlb"; [exact Hb0|].
      iSpecialize ("Body" $! CID with "[%]"); [wp_next_chain|].
      iApply ("Body" $! H1 l b with "[%] Hcg Hcnt Hpay Hpc Htok Hcell Hown Hlb Hfull Hbuf Hctx Hpark Hcont").
      exact HH1regs.
    - (* busy: into the sleep loop *)
      assert (Hbne : b <> (mword_of_int 0 : mword 32)) by (apply uw_sext_nonzero; exact Hbz).
      iDestruct (tx_res_busy γu b l Hbne with "Hcell Hown") as "Hres".
      iApply (wp_cbnez_taken_s_sconf Φ (mword_of_int (UW + 0x6e)) (mword_of_int 240 : mword 8)
                (Cregidx (mword_of_int 7)) Ra5 H1 (av - 10)%nat false uw_cr7 ltac:(nz)
                ltac:(rgne; rewrite HH1a5; unfold neq_vec; rewrite Hbz; reflexivity)
                ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi6e [-]").
      ...
      iApply ("Sleep" $! H1 with "[%] Hcg Hcnt Hpay Hpc Htok Hres Hfull Hbuf Hctx Hpark Hcont").
      exact HH1regs.
  Qed.
  ...
  Proof.
    ...
    - intros i Hik. iIntros "#Ht #Hdinv #Htxl #Hpinv #Hscheds #Hpanic".
      rewrite /uw_head.
      iIntros (CIDh Hsh M) "%Hregs Hcg Hcnt Hpay Hpc Htok Hres #Hsub Hfull Hbuf Hctx Hpark Hexit".
      iApply (uw_one (CID := CIDh) CID0 γl γu γv Φ γs j γlp m0 M av eb C sp0 buf n f dq i
                ltac:(lia) Hn31 Hj Hjlp Hav Heb Hsh Hregs
                with "Ht Hdinv Htxl Hpinv Hscheds Hpanic Hcg Hcnt Hpay Hpc Htok Hres Hsub Hfull Hbuf Hctx Hpark [Hexit]").
      iSplit.
    ...
    - intros i Hik. iIntros "#Ht #Hdinv #Htxl #Hpinv #Hscheds #Hpanic".
      ...
      iSplit.
      + rewrite /uw_next_cont.
        iIntros (CIDx Hsx M') "%Hlt %Hregs' Hcg Hcnt Hpay Hpc Htok Hres #Hsub' Hfull Hbuf Hctx Hpark".
        iPoseProof (IH (S i) ltac:(lia) with "Ht Hdinv Htxl Hpinv Hscheds Hpanic") as "Next".
        rewrite /uw_head.
        iSpecialize ("Next" $! CIDx with "[%]"); [wp_next_chain|].
        iApply ("Next" $! M' with "[%] Hcg Hcnt Hpay Hpc Htok Hres Hsub' Hfull Hbuf Hctx Hpark Hexit").
        exact Hregs'.
      + iExact "Hexit".
  Qed.
...
Section ProofUartwrite.
  ...
  Proof.
    ...
    iIntros "Hcg Hcnt #Ht Hpc #Hdinv #Htxl Hbuf #Hpinv #Hscheds #Hpanic Hctx Hpark Hcont".
    iDestruct (is_txlock_lock with "Htxl") as "#Hlk".
    ...
    iApply (wp_caddi16sp_push_s_sconf Φ pcE (mword_of_int 59 : mword 6) m av 10%nat true
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UW + 0x02)) (mword_of_int 9 : mword 6) Rra
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UW + 0x04)) (mword_of_int 8 : mword 6) Rs0
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UW + 0x06)) (mword_of_int 7 : mword 6) Rs1
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UW + 0x08)) (mword_of_int 3 : mword 6) Rs5
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (UW + 0x0a)) (Cregidx (mword_of_int 0))
    ...
    (* +0x0c c.mv s5,a0 *)
    iApply (wp_cmv_s_sconf Φ (mword_of_int (UW + 0x0c)) Rs5 Ra0 A1 (av - 10)%nat true
    ...
    (* +0x0e c.mv s1,a1 *)
    iApply (wp_cmv_s_sconf Φ (mword_of_int (UW + 0x0e)) Rs1 Ra1 A2 (av - 10)%nat true
    ...
    iApply (wp_auipc_s_sconf Φ (mword_of_int (UW + 0x10)) Ra0 (mword_of_int 18 : mword 20)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (UW + 0x14)) Ra0 Ra0 (mword_of_int 0xa24 : mword 12)
    ...
    (* +0x18 jal ra,acquire *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (UW + 0x18)) Rra (mword_of_int 788 : mword 21)
    ...
    - (* ======== n = 0: straight to the epilogue ======== *)
      ...
      assert (Hal : eq_vec (access_vec_dec (add_vec (mword_of_int (UW + 0x1c) : mword 64)
        ...
        by (vm_compute; reflexivity).
      iApply (wp_bge_x0_taken_s_sconf Φ (mword_of_int (UW + 0x1c)) (mword_of_int 96 : mword 13)
      ...
      iApply (uw_tail (CID := CIDa) CID γl γu Φ j m MA av eb C sp0 ([] : list (bv 8))
                ...
                ltac:(wp_next_chain)
                with "Ht Htxl Hcg Hcnt Hpay Hpc Htok HR Hsub0 Hsv Hgap Hs10 Hbuf Hctx Hpark [Hcont]").
      rewrite /uw_ret.
      iIntros (CIDz Hsz mf) "%Hcs Hcg Hcnt Hpc Hbuf #Hout Hctx Hpark".
      iSpecialize ("Hcont" $! CIDz with "[%]"); [wp_next_chain|].
      iApply ("Hcont" $! mf with "[%] Hcg Hcnt Hpc [Hbuf] [Hout] Hctx Hpark").
      + exact Hcs.
    ...
    - (* ======== n > 0: the byte loop ======== *)
      ...
      iApply (wp_bge_x0_fall_s_sconf Φ (mword_of_int (UW + 0x1c)) (mword_of_int 96 : mword 13)
      ...
      (* +0x2a c.mv s4,s5 *)
      iApply (wp_cmv_s_sconf Φ (mword_of_int (UW + 0x2a)) Rs4 Rs5 MA (av - 10)%nat false
      ...
      (* +0x2c c.add s5,s5,s1 *)
      iApply (wp_cadd_s_sconf Φ (mword_of_int (UW + 0x2c)) Rs5 Rs1 B0 (av - 10)%nat false
                ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi2c [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc". iEval (rgne; rgne) in "Hcg".
      ...
      iApply (wp_auipc_s_sconf Φ (mword_of_int (UW + 0x2e)) Rs1 (mword_of_int 10 : mword 20)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (UW + 0x32)) Rs1 Rs1 (mword_of_int 0x922 : mword 12)
      ...
      iApply (wp_auipc_s_sconf Φ (mword_of_int (UW + 0x36)) Rs3 (mword_of_int 18 : mword 20)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (UW + 0x3a)) Rs3 Rs3 (mword_of_int 0x9fe : mword 12)
      ...
      iApply (wp_auipc_s_sconf Φ (mword_of_int (UW + 0x3e)) Rs2 (mword_of_int 10 : mword 20)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (UW + 0x42)) Rs2 Rs2 (mword_of_int 0x90e : mword 12)
      ...
      iApply (wp_lui_s_sconf Φ (mword_of_int (UW + 0x46)) Rs7 (mword_of_int 0x10000 : mword 20)
      ...
      (* +0x4a c.li s6,1 *)
      iApply (wp_cli_s_sconf Φ (mword_of_int (UW + 0x4a)) Rs6 (mword_of_int 1 : mword 6)
      ...
      iApply (wp_cj_s_sconf Φ (mword_of_int (UW + 0x4c))
      ...
      iApply ("Iter" $! B9 with "[%] Hcg Hcnt Hpay Hpc Htok HR Hsub0 Hfull Hbuf Hctx Hpark [Hcont]").
      { exact HB9regs. }
      (* ============ the loop's exit: +0x72 -> the epilogue ============ *)
      rewrite /uw_exit_cont.
      iIntros (CIDx Hsx M') "%Hregs' Hcg Hcnt Hpay Hpc Htok HR #Hout Hfull Hbuf Hctx Hpark".
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x72)) (mword_of_int 6 : mword 6) Rs2
                M' (av - 10)%nat (m !!! Regidx Rs2) false (dqm := DfracOwn 1) ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi72 [G4] [-]").
      { iEval (rewrite Wsp Hb4). iExact "G4". }
      rewrite wp_next_off. iIntros "Hcg Hpc G4". iEval (rewrite Wsp Hb4) in "G4".
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x74)) (mword_of_int 5 : mword 6) Rs3
                R1 (av - 10)%nat (m !!! Regidx Rs3) false (dqm := DfracOwn 1) ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi74 [G5] [-]").
      { iEval (rewrite HR1sp Hb5). iExact "G5". }
      rewrite wp_next_off. iIntros "Hcg Hpc G5". iEval (rewrite HR1sp Hb5) in "G5".
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x76)) (mword_of_int 4 : mword 6) Rs4
                R2 (av - 10)%nat (m !!! Regidx Rs4) false (dqm := DfracOwn 1) ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi76 [G6] [-]").
      { iEval (rewrite HR2sp Hb6). iExact "G6". }
      rewrite wp_next_off. iIntros "Hcg Hpc G6". iEval (rewrite HR2sp Hb6) in "G6".
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x78)) (mword_of_int 2 : mword 6) Rs6
                R3 (av - 10)%nat (m !!! Regidx Rs6) false (dqm := DfracOwn 1) ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi78 [G8] [-]").
      { iEval (rewrite HR3sp Hb8). iExact "G8". }
      rewrite wp_next_off. iIntros "Hcg Hpc G8". iEval (rewrite HR3sp Hb8) in "G8".
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (UW + 0x7a)) (mword_of_int 1 : mword 6) Rs7
                R4 (av - 10)%nat (m !!! Regidx Rs7) false (dqm := DfracOwn 1) ltac:(nz) ltac:(rdok)
                with "Hcg Hpc Hi7a [G9] [-]").
      { iEval (rewrite HR4sp Hb9). iExact "G9". }
      rewrite wp_next_off. iIntros "Hcg Hpc G9". iEval (rewrite HR4sp Hb9) in "G9".
      ...
      iApply (uw_tail (CID := CIDx) CID γl γu Φ j m R5 av eb C sp0 (uw_bytes f n)
                ...
                with "Ht Htxl Hcg Hcnt Hpay Hpc Htok HR Hout Hsv Hgap Hs10 Hbuf Hctx Hpark [Hcont]").
      rewrite /uw_ret.
      iIntros (CIDz Hsz mf) "%Hcs Hcg Hcnt Hpc Hbuf #Hout2 Hctx Hpark".
      iSpecialize ("Hcont" $! CIDz with "[%]"); [wp_next_chain|].
      iApply ("Hcont" $! mf with "[%] Hcg Hcnt Hpc [Hbuf] [Hout2] Hctx Hpark").
      + exact Hcs.
      + rewrite /uw_buf. iExact "Hbuf".
      + iExact "Hout2".
  Qed.

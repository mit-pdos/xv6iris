  ...
  Proof.
    ...
    - intros i Hik. iIntros "#Ht #Hdinv #Htxl #Hpinv #Hpanic".
      ...
      iApply (uw_one (CID := CIDh) CID0 γl γu γv γs j γlp m0 M av eb C sp0 buf n f dq
                pidv dqp i lks ltac:(lia) Hn31 Hj Hjlp Hav Heb Hsh Hregs
...
Section ProofUartwrite.
  ...
  Proof.
    ...
    - (* ======== n > 0: the prologue, the setup and the loop ======== *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.uartwrite + 0x24)) Rs5 Rs5 (mword_of_int 2472 : mword 12)
      ...
      set (A6 := <[Regidx Rs5 := regval_into_reg
          (add_vec (A5 !!! Regidx Rs5) (sign_extend' 64 (mword_of_int 2472 : mword 12)))]> A5).
      change (<[Regidx Rs5 := regval_into_reg
          (add_vec (A5 !!! Regidx Rs5) (sign_extend' 64 (mword_of_int 2472 : mword 12)))]> A5) with A6.
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.uartwrite + 0x2c)) Rs2 Rs2 (mword_of_int 2688 : mword 12)
      ...
      set (A8 := <[Regidx Rs2 := regval_into_reg
          (add_vec (A7 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 2688 : mword 12)))]> A7).
      change (<[Regidx Rs2 := regval_into_reg
          (add_vec (A7 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 2688 : mword 12)))]> A7) with A8.
      ...
      iPoseProof (uw_iter CID γl γu γv γs j γlp m av eb C sp0 buf n f dq
                    pidv dqp (n - 1)%nat lks ltac:(lia) Hj Hjlp Hav Heb 0%nat ltac:(lia)

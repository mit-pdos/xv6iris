...
Section ProofUartwrite.
  ...
  Proof.
    ...
    - (* ======== n > 0: the prologue, the setup and the loop ======== *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.uartwrite + 0x24)) Rs5 Rs5 (mword_of_int 2458 : mword 12)
      ...
      set (A6 := <[Regidx Rs5 := regval_into_reg
          (add_vec (A5 !!! Regidx Rs5) (sign_extend' 64 (mword_of_int 2458 : mword 12)))]> A5).
      change (<[Regidx Rs5 := regval_into_reg
          (add_vec (A5 !!! Regidx Rs5) (sign_extend' 64 (mword_of_int 2458 : mword 12)))]> A5) with A6.
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.uartwrite + 0x2c)) Rs2 Rs2 (mword_of_int 2674 : mword 12)
      ...
      set (A8 := <[Regidx Rs2 := regval_into_reg
          (add_vec (A7 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 2674 : mword 12)))]> A7).
      change (<[Regidx Rs2 := regval_into_reg
          (add_vec (A7 !!! Regidx Rs2) (sign_extend' 64 (mword_of_int 2674 : mword 12)))]> A7) with A8.

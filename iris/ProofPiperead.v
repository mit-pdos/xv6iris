...
Section ProofPiperead.
  ...
  Definition pr_epi_body
      ...
      (n : Z) (CIDe : CpuId) (lks : gset nat) : iProp Σ :=
  ...
  Definition pr_cphase_body
      ...
      (pid : mword 32) (V : pprivate) (CIDc : CpuId) (lks : gset nat) : iProp Σ :=
    (∀ M : regfile,
     ⌜ M !!! Regidx csp_rs1 = spr
       /\ M !!! Regidx Rs0 = s0v
       /\ M !!! Regidx Rs1 = pi
     ...
     cpu_own 1%nat true pj C false ({[lock_rank "pipe"]} ∪ lks) -∗
     arm_pay 0 true pj -∗
     locked γl cpu_id -∗
     pipe_res γp pi -∗
     pipe_ref γp w q -∗
  ...
  Definition pr_epic_body
      ...
      (m : regfile) (av : nat) (pj : mword 64) (C : iProp Σ)
      (γp : pipe_names) (w : bool) (q : Qp) (pid : mword 32) (V : pprivate)
      (n : Z) (CIDx : CpuId) (lks : gset nat) : iProp Σ :=
    (∀ (M : regfile) (P' : uptd) (rv : mword 64),
     ⌜ M !!! Regidx csp_rs1 = spr
       /\ M !!! Regidx Rs4 = rv
       /\ M !!! Regidx Rs6 = vs6
  ...
  Definition pr_wloop_body
      ...
      (EX CP : iProp Σ) (CIDl : CpuId) (lks : gset nat) : iProp Σ :=
    (∀ M : regfile,
     ⌜ callee_saved W0 M ⌝ -∗
     (EX ∧ CP) -∗
     sie_cap_gpr M (trap_res true + (av - 12))%nat false pj -∗
  ...
  Proof.
    ...
    assert (Hbelow_proc : locks_below lks (lock_rank "proc")).
    { lkbelow. }
    ...
    pose (EPIP := (wp_next (CID0 := CID) true pj (fun (CIDe : CpuId) =>
               pr_epi_body sp0 spr vra vs0 vs1 vs2 vs3 vs4 vs5 vs6 vs7 vs8
                 m av pj C γp w q pid V n CIDe lks) : iProp Σ)).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x18)) Rra (mword_of_int 2085518 : mword 21)
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.piperead + 0x18) : mword 64)
                     (sign_extend' 64 (mword_of_int 2085518 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x20)) Rra (mword_of_int 2082150 : mword 21)
    ...
    assert (Hjaq : add_vec (mword_of_int (KernelSyms.piperead + 0x20) : mword 64)
                     (sign_extend' 64 (mword_of_int 2082150 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iDestruct (cpu_own_transport CIDmp CIDp26 0 true pj C true ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (AcquireGen.wp_acquire_gen_sconf γl "pipe" (pipe_res γp pi)
    ...
    pose (CPP := (wp_next (CID0 := CID) true pj (fun (CIDc : CpuId) =>
        pr_cphase_body spr s0v pi addrv pj sp0 vs6 vs7 vs8
          n m av C γl γp w q pid V CIDc lks) : iProp Σ)).
    pose (EPIC := (wp_next (CID0 := CID) true pj (fun (CIDx : CpuId) =>
               pr_epic_body sp0 spr vs6 vs7 vs8 m av pj C γp w q pid V n CIDx lks) : iProp Σ)).
    ...
    { iSplit.
      ...
      { rewrite /WXP. iEval (rewrite /EPIP) in "EPI".
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0xd8)) Rra (mword_of_int 2086980 : mword 21)
        ...
        assert (Hjwk : add_vec (mword_of_int (KernelSyms.piperead + 0xd8) : mword 64)
                         (sign_extend' 64 (mword_of_int 2086980 : mword 21)) = mword_of_int KernelSyms.wakeup)
          by (apply bv_eq; vm_compute; reflexivity).
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0xde)) Rra (mword_of_int 2082096 : mword 21)
        ...
        assert (Hjrl : add_vec (mword_of_int (KernelSyms.piperead + 0xde) : mword 64)
                         (sign_extend' 64 (mword_of_int 2082096 : mword 21)) = mword_of_int KernelSyms.release)
          by (apply bv_eq; vm_compute; reflexivity).
        ...
        iApply (ReleaseGen.wp_release_gen_sconf γl pi "pipe" (pipe_res γp pi) (pipe_dead γl γp) emp%I
                  X4 0%nat true pj C (av - 12)%nat ({[lock_rank "pipe"]} ∪ lks) HX4lka ltac:(lia)
      ...
      { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0xba)) Rra (mword_of_int 2084390 : mword 21)
        ...
        assert (Hjco : add_vec (mword_of_int (KernelSyms.piperead + 0xba) : mword 64)
                         (sign_extend' 64 (mword_of_int 2084390 : mword 21)) = mword_of_int KernelSyms.copyout)
          by (apply bv_eq; vm_compute; reflexivity).
        ...
        { (* copyout SUCCEEDED: fall through and bump nread / i / the cursor *)
          ...
          iApply (wp_sw_s_sconf (mword_of_int (KernelSyms.piperead + 0xc8)) Ra5 Rs1 (mword_of_int 536 : mword 12)
    ...
    iAssert (wp_next (CID0 := CID) true pj (fun (CIDl : CpuId) =>
      pr_wloop_body W0 av pj C γl pi γp w q pid V sp0 EPIC CPP CIDl lks))%I
      with "[]" as "WLOOP".
    { iLöb as "IH".
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x3c)) Rra (mword_of_int 2087628 : mword 21)
      ...
      assert (Hjkl : add_vec (mword_of_int (KernelSyms.piperead + 0x3c) : mword 64)
                       (sign_extend' 64 (mword_of_int 2087628 : mword 21)) = mword_of_int KernelSyms.killed)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      { (* ==== KILLED: c.bnez taken -> +0x74, release and return -1 ==== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x76)) Rra (mword_of_int 2082200 : mword 21)
        ...
        assert (Hjrl1 : add_vec (mword_of_int (KernelSyms.piperead + 0x76) : mword 64)
                          (sign_extend' 64 (mword_of_int 2082200 : mword 21)) = mword_of_int KernelSyms.release)
          by (apply bv_eq; vm_compute; reflexivity).
        ...
        iApply (ReleaseGen.wp_release_gen_sconf γl pi "pipe" (pipe_res γp pi) (pipe_dead γl γp) emp%I
                  N2 0%nat true pj C (av - 12)%nat ({[lock_rank "pipe"]} ∪ lks) HN2lka ltac:(lia)
                  ltac:(iApply locked_dead) ltac:(iApply locked_pre_dead)
                  with "Hcg Htext Hpc Hopen Hlocked Hres [] Hown Hpay").
        { iApply lock_finisher_close. }
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x44)) Rra (mword_of_int 2087020 : mword 21)
      ...
      assert (Hjsp : add_vec (mword_of_int (KernelSyms.piperead + 0x44) : mword 64)
                       (sign_extend' 64 (mword_of_int 2087020 : mword 21)) = mword_of_int KernelSyms.sleep_prepare)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x4a)) Rra (mword_of_int 2082244 : mword 21)
      ...
      assert (Hjrl0 : add_vec (mword_of_int (KernelSyms.piperead + 0x4a) : mword 64)
                        (sign_extend' 64 (mword_of_int 2082244 : mword 21)) = mword_of_int KernelSyms.release)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (ReleaseGen.wp_release_gen_sconf γl pi "pipe" (pipe_res γp pi) (pipe_dead γl γp) emp%I
                Sl4 0%nat true pj C (av - 12)%nat ({[lock_rank "pipe"]} ∪ lks) HSl4lka ltac:(lia)
                ltac:(iApply locked_dead) ltac:(iApply locked_pre_dead)
                with "Hcg Htext Hpc Hopen Hlocked Hres [] Hown Hpay").
      { iApply lock_finisher_close. }
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x4e)) Rra (mword_of_int 2087070 : mword 21)
      ...
      assert (Hjsl : add_vec (mword_of_int (KernelSyms.piperead + 0x4e) : mword 64)
                       (sign_extend' 64 (mword_of_int 2087070 : mword 21)) = mword_of_int KernelSyms.sleep)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x54)) Rra (mword_of_int 2082098 : mword 21)
      ...
      assert (Hjaq2 : add_vec (mword_of_int (KernelSyms.piperead + 0x54) : mword 64)
                        (sign_extend' 64 (mword_of_int 2082098 : mword 21)) = mword_of_int KernelSyms.acquire)
        by (apply bv_eq; vm_compute; reflexivity).
...
End PipereadProof.lkbelow : add_vec a b = add_vec b a.
Proof. apply bv_eq. rewrite !add_vec64_unsigned. f_equal. ring. Qed.

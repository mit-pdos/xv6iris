...
Section ProofPiperead.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0x18)) Rra (mword_of_int 2085718 : mword 21)
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0x20)) Rra (mword_of_int 2082386 : mword 21)
    ...
    { iSplit.
      ...
      { rewrite /WXP. iEval (rewrite /EPIP) in "EPI".
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0xc6)) Rra (mword_of_int 2087158 : mword 21)
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0xcc)) Rra (mword_of_int 2082350 : mword 21)
      ...
      { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0xa8)) Rra (mword_of_int 2084838 : mword 21)
    ...
    { iLöb as "IH".
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0x3c)) Rra (mword_of_int 2087792 : mword 21)
      ...
      { (* ==== KILLED: c.bnez taken -> +0x66, release and return -1 ==== *)
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0x68)) Rra (mword_of_int 2082450 : mword 21)
      ...
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.piperead + 0x46)) Rra (mword_of_int 2087210 : mword 21)

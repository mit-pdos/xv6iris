...
Section ProofPiperead.
  ...
  Proof.
    ...
    pose (P5 := <[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (PR + 0x18) : mword 64) 4)]> P4).
    ...
    pose (A3 := <[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (PR + 0x20) : mword 64) 4)]> A2).

...
Section ProofPiperead.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x18)) Rra (mword_of_int 2085570 : mword 21)
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.piperead + 0x18) : mword 64)
                     (sign_extend' 64 (mword_of_int 2085570 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x20)) Rra (mword_of_int 2082236 : mword 21)
    ...
    assert (Hjaq : add_vec (mword_of_int (KernelSyms.piperead + 0x20) : mword 64)
                     (sign_extend' 64 (mword_of_int 2082236 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    { iSplit.
      ...
      { rewrite /WXP. iEval (rewrite /EPIP) in "EPI".
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0xd4)) Rra (mword_of_int 2087036 : mword 21)
        ...
        assert (Hjwk : add_vec (mword_of_int (KernelSyms.piperead + 0xd4) : mword 64)
                         (sign_extend' 64 (mword_of_int 2087036 : mword 21)) = mword_of_int KernelSyms.wakeup)
          by (apply bv_eq; vm_compute; reflexivity).
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0xda)) Rra (mword_of_int 2082186 : mword 21)
        ...
        assert (Hjrl : add_vec (mword_of_int (KernelSyms.piperead + 0xda) : mword 64)
                         (sign_extend' 64 (mword_of_int 2082186 : mword 21)) = mword_of_int KernelSyms.release)
          by (apply bv_eq; vm_compute; reflexivity).
      ...
      { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0xb6)) Rra (mword_of_int 2084676 : mword 21)
        ...
        assert (Hjco : add_vec (mword_of_int (KernelSyms.piperead + 0xb6) : mword 64)
                         (sign_extend' 64 (mword_of_int 2084676 : mword 21)) = mword_of_int KernelSyms.copyout)
          by (apply bv_eq; vm_compute; reflexivity).
    ...
    { iLöb as "IH".
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x3c)) Rra (mword_of_int 2087680 : mword 21)
      ...
      assert (Hjkl : add_vec (mword_of_int (KernelSyms.piperead + 0x3c) : mword 64)
                       (sign_extend' 64 (mword_of_int 2087680 : mword 21)) = mword_of_int KernelSyms.killed)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      { (* ==== KILLED: c.bnez taken -> +0x74, release and return -1 ==== *)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x76)) Rra (mword_of_int 2082286 : mword 21)
        ...
        assert (Hjrl1 : add_vec (mword_of_int (KernelSyms.piperead + 0x76) : mword 64)
                          (sign_extend' 64 (mword_of_int 2082286 : mword 21)) = mword_of_int KernelSyms.release)
          by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x44)) Rra (mword_of_int 2087072 : mword 21)
      ...
      assert (Hjsp : add_vec (mword_of_int (KernelSyms.piperead + 0x44) : mword 64)
                       (sign_extend' 64 (mword_of_int 2087072 : mword 21)) = mword_of_int KernelSyms.sleep_prepare)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x4a)) Rra (mword_of_int 2082330 : mword 21)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x4e)) Rra (mword_of_int 2087122 : mword 21)
      ...
      assert (Hjsl : add_vec (mword_of_int (KernelSyms.piperead + 0x4e) : mword 64)
                       (sign_extend' 64 (mword_of_int 2087122 : mword 21)) = mword_of_int KernelSyms.sleep)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.piperead + 0x54)) Rra (mword_of_int 2082184 : mword 21)
      ...
      assert (Hjaq2 : add_vec (mword_of_int (KernelSyms.piperead + 0x54) : mword 64)
                        (sign_extend' 64 (mword_of_int 2082184 : mword 21)) = mword_of_int KernelSyms.acquire)
        by (apply bv_eq; vm_compute; reflexivity).

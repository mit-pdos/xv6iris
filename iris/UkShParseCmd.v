...
(*                                                                        *)
(*   parsepipe    @0x65e  one [parseexec] and a [peek] for '|'             *)
(*   parseline    @0x6be  one [parsepipe] and a [peek] for '&' / ';'       *)
...
(*   parsecmd     @0x84a  the front door: [strlen] the line, run the       *)
...
(*ALIASES-END*)
  ...
  (* ===================================================================== *)
  (* §12 parsepipe @0x65e and parseline @0x6be -- the two one-line bodies.  *)
  (*                                                                       *)
  ...
  Proof using .
    ...
    (* ---- 0x7dc  bltu a5,a4 -- NOT taken: EXEC is in range ---- *)
    ...
    iApply (wp_uk_clw_text N h13 m10 (mword_of_int 0x7f0)
              ...
              (mword_of_int 4294964294 : mword 32) nn
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; reflexivity)
              ltac:(vm_compute; reflexivity)
              ltac:(rewrite Ha5_10;
    ...
    set (m11 := <[Regidx a5_idx
                  := regval_into_reg
                       (sign_extend' 64
                          (mword_of_int 4294964294 : mword 32)
                        : mword 64)]> m10).
    ...
    set (m12 := <[Regidx a5_idx
                  := regval_into_reg (mword_of_int 0x7f6 : mword 64)]> m11).
    ...
    iApply (wp_uk_cjr N h15 m12 (mword_of_int 0x7f4) a5_idx
              (mword_of_int 0x7f6) nn
              ltac:(vm_compute; discriminate)
              ltac:(rewrite (upd_eq m11 (Regidx a5_idx)
                               (regval_into_reg
                                  (mword_of_int 0x7f6 : mword 64)));
                    apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
  ...
  (* ===================================================================== *)
  (* §14 parsecmd @0x84a -- the parser's front door, and the THEOREM.       *)
  (*                                                                       *)

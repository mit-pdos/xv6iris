...
Section KforkB4Proof.
  ...
  Proof.
    ...
    assert (Hjidup : add_vec (mword_of_int (KF + 0xa8) : mword 64)
                       (sign_extend' 64 (mword_of_int 5358 : mword 21))
                     = mword_of_int KernelSyms.idup)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xa8)) Rra (mword_of_int 5358 : mword 21)
 ...
 Hfresh
    ...
    assert (Hjss : add_vec (mword_of_int (KF + 0xba) : mword 64)
                     (sign_extend' 64 (mword_of_int 2093190 : mword 21))
                   = mword_of_int KernelSyms.safestrcpy)
      by (apply bv_eq; vm_compute; reflexivity).
    iApply (wp_jal_s_sconf (mword_of_int (KF + 0xba)) Rra (mword_of_int 2093190 : mword 21)

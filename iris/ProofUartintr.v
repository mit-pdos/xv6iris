...
Section ProofUartintr.
  ...
  Proof.
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UI + 0x6c)) (mword_of_int 3 : mword 6) Rra
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UI + 0x6e)) (mword_of_int 2 : mword 6) Rs0
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UI + 0x70)) (mword_of_int 1 : mword 6) Rs1
    ...
    iApply (wp_cldsp_s_sconf Φ (mword_of_int (UI + 0x72)) (mword_of_int 0 : mword 6) Rs2
    ...
    iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (UI + 0x74)) (mword_of_int 2 : mword 6)
    ...
    iApply (wp_cret_s_sconf Φ (mword_of_int (UI + 0x76)) Rra E5 av b ltac:(nz)
              with "Hcg Hpc Hi76 [-]").
  ...
  Proof.
    ...
    { iLöb as "IH".
      ...
      iApply (UG.wp_uartgetc_inline γu γv Φ M1 (av - 4)%nat Rs1 Rs2
                ...
                (mword_of_int (UI + 0x50)) (mword_of_int (UI + 0x6c)) b
      ...
      - (* a byte: hand it to consoleintr and go round again *)
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (UI + 0x50)) Rra (mword_of_int 2095248 : mword 21)
        ...
        iApply (wp_cj_s_sconf Φ (mword_of_int (UI + 0x54))
  ...
  Proof.
    ...
    iApply (wp_auipc_s_sconf Φ (mword_of_int (UI + 0x2e)) Ra0 (mword_of_int 18 : mword 20)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (UI + 0x32)) Ra0 Ra0 (mword_of_int 0x914 : mword 12)
    ...
    (* +0x36 jal ra,release *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (UI + 0x36)) Rra (mword_of_int 652 : mword 21)
    ...
    iApply (wp_lui_s_sconf Φ (mword_of_int (UI + 0x3a)) Rs1 (mword_of_int 0x10000 : mword 20)
    ...
    assert (HS0rg : forall (CID' : CpuId), rget (CID := CID') S0 Rs1 = S0 !!! Regidx Rs1)
      by (intros CID'; rgne; reflexivity).
    iApply (wp_caddi_s_sconf Φ (mword_of_int (UI + 0x3e)) Rs1 (mword_of_int 5 : mword 6)
    ...
    iApply (wp_lui_s_sconf Φ (mword_of_int (UI + 0x40)) Rs2 (mword_of_int 0x10000 : mword 20)
  ...
  Proof.
    ...
    { intros CID'; rgne. rewrite /A0 upd_ne; [reflexivity | reg_neq]. }
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UI + 0x02)) (mword_of_int 3 : mword 6) Rra
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UI + 0x04)) (mword_of_int 2 : mword 6) Rs0
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UI + 0x06)) (mword_of_int 1 : mword 6) Rs1
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (UI + 0x08)) (mword_of_int 0 : mword 6) Rs2
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (UI + 0x0a)) (Cregidx (mword_of_int 0))
    ...
    (* ============ the ISR acknowledge ============ *)
    iApply (wp_lui_s_sconf Φ (mword_of_int (UI + 0x0c)) Ra5 (mword_of_int 0x10000 : mword 20)
    ...
    iApply (UAcc.wp_uart_read_free_s_sconf γu γv 2 Φ (mword_of_int (UI + 0x10)) Ra5 Ra5
    ...
    (* ============ acquire(&tx_lock) ============ *)
    iApply (wp_auipc_s_sconf Φ (mword_of_int (UI + 0x14)) Ra0 (mword_of_int 18 : mword 20)
    ...
    assert (HA4rg : forall (CID' : CpuId), rget (CID := CID') A4 Ra0 = A4 !!! Regidx Ra0)
      by (intros CID'; rgne; reflexivity).
    iApply (wp_addi4_s_sconf Φ (mword_of_int (UI + 0x18)) Ra0 Ra0 (mword_of_int 0x92e : mword 12)
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (UI + 0x1c)) Rra (mword_of_int 542 : mword 21)
    ...
    iApply (wp_lui_s_sconf Φ (mword_of_int (UI + 0x20)) Ra5 (mword_of_int 0x10000 : mword 20)
    ...
    iApply (UAcc.wp_uart_lsr_read_ea_s_sconf γu γv Φ (mword_of_int (UI + 0x24)) Ra5 Ra5
    ...
    iApply (wp_andi_s_sconf Φ (mword_of_int (UI + 0x28)) Ra5 Ra5 (mword_of_int 32 : mword 12)
    ...
    - (* the FIFO is still busy: fall through to the release *)
      iApply (wp_cbnez_fall_s_sconf Φ (mword_of_int (UI + 0x2c)) (mword_of_int 21 : mword 8)
    ...
    - (* THRE: clear tx_busy and wake the writers *)
      ...
      iApply (wp_cbnez_taken_s_sconf Φ (mword_of_int (UI + 0x2c)) (mword_of_int 21 : mword 8)
                (Cregidx (mword_of_int 7)) Ra5 B2 (av - 4)%nat false UG.ug_cr7 ltac:(nz)
                ltac:(rewrite HB2a5; unfold neq_vec; rewrite -/(lsr_thre_clear blsr) Hthre; reflexivity)
                ltac:(rewrite Jtx; vm_compute; reflexivity)
                with "Hcg Hpc Hi2c [-]").
      iNext. rewrite wp_next_off.
      ...
      iApply (wp_auipc_s_sconf Φ (mword_of_int (UI + 0x56)) Ra5 (mword_of_int 10 : mword 20)
      ...
      iApply (wp_sw_zero_s_sconf Φ (mword_of_int (UI + 0x5a)) Ra5 (mword_of_int 0x808 : mword 12)
      ...
      iApply (wp_auipc_s_sconf Φ (mword_of_int (UI + 0x5e)) Ra0 (mword_of_int 9 : mword 20)
      ...
      assert (HT1rg : forall (CID' : CpuId), rget (CID := CID') T1 Ra0 = T1 !!! Regidx Ra0)
        by (intros CID'; rgne; reflexivity).
      iApply (wp_addi4_s_sconf Φ (mword_of_int (UI + 0x62)) Ra0 Ra0 (mword_of_int 0x7fc : mword 12)
      ...
      (* +0x66 jal ra,wakeup *)
      iApply (wp_jal_s_sconf Φ (mword_of_int (UI + 0x66)) Rra (mword_of_int 5406 : mword 21)
      ...
      iApply (wp_cj_s_sconf Φ (mword_of_int (UI + 0x6a))

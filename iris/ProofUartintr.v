...
Section ProofUartintr.
  ...
  (* ------------------------------------------------------------------ *)
  (*  The frame, and the two register shapes.                             *)
  (* ------------------------------------------------------------------ *)
  ...
  (* every callee-saved register uartintr never touches *)
  ...
  Proof.
    intros Hcs (H2 & H4 & H19 & H20 & H21 & H22 & H23 & H24 & H25 & H26 & H27).
    unfold ui_regs.
    repeat first
      [ split
  ...
  Definition ui_ret_cont (γ : gname) (Φ : mval -> iProp Σ) (m0 : regfile)
      (av lvl : nat) (eb : bool) (pme : mword 64) (C : iProp Σ) : iProp Σ :=
    (∀ mf : regfile,
  ...
  (* ------------------------------------------------------------------ *)
  Lemma ui_tail (γ : gname) (Φ : mval -> iProp Σ)
    ...
    cpu_own γ lvl eb pme C -∗
    pc_is (mword_of_int (UI + 0x6c)) -∗
    ui_frame sp0 m0 -∗
    ui_ret_cont γ Φ m0 av lvl eb pme C -∗
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros Hregs Hsp0 Hm0tp Hav.
    destruct Hregs as (Hsp & Htp & H19 & H20 & H21 & H22 & H23 & H24 & H25 & H26 & H27).
    ...
    assert (Hb4 : add_vec spd (zero_extend' 64 (concat_vec (mword_of_int 0 : mword 6) ('b"000"))) = pa_stk sp0 4)
      by (apply ui_slot_bridge; pcw).
    assert (P6e : add_vec_int (mword_of_int (UI + 0x6c) : mword 64) 2 = mword_of_int (UI + 0x6e)) by pcw.
    assert (P70 : add_vec_int (mword_of_int (UI + 0x6e) : mword 64) 2 = mword_of_int (UI + 0x70)) by pcw.
    assert (P72 : add_vec_int (mword_of_int (UI + 0x70) : mword 64) 2 = mword_of_int (UI + 0x72)) by pcw.
    assert (P74 : add_vec_int (mword_of_int (UI + 0x72) : mword 64) 2 = mword_of_int (UI + 0x74)) by pcw.
    assert (P76 : add_vec_int (mword_of_int (UI + 0x74) : mword 64) 2 = mword_of_int (UI + 0x76)) by pcw.
    (* +0x6c c.ldsp ra,24(sp) *)
    iPoseProof (uii2_6c with "Ht") as "Hi6c".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UI + 0x6c)) (mword_of_int 3 : mword 6) Rra
              M (av - 4)%nat (m0 !!! Regidx Rra) (dqm := DfracOwn 1) ltac:(nz) ltac:(nz)
              with "Hcg Hpc Hi6c [H1] [-]").
    { iEval (rewrite Hsp Hb1). iExact "H1". }
    iIntros "Hcg Hpc H1". iEval (rewrite Hsp Hb1) in "H1".
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UI + 0x6e)) (mword_of_int 2 : mword 6) Rs0
              E1 (av - 4)%nat (m0 !!! Regidx Rs0) (dqm := DfracOwn 1) ltac:(nz) ltac:(nz)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UI + 0x70)) (mword_of_int 1 : mword 6) Rs1
              E2 (av - 4)%nat (m0 !!! Regidx Rs1) (dqm := DfracOwn 1) ltac:(nz) ltac:(nz)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (UI + 0x72)) (mword_of_int 0 : mword 6) Rs2
              E3 (av - 4)%nat (m0 !!! Regidx Rs2) (dqm := DfracOwn 1) ltac:(nz) ltac:(nz)
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (UI + 0x74)) (mword_of_int 2 : mword 6)
              E4 (av - 4)%nat 4%nat Hpop with "Hcg Hpc Hi74 Hframe [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (UI + 0x76)) Rra E5 av ltac:(nz)
              with "Hcg Hpc Hi76 [-]").
    ...
    split; [rewrite (Hpeel (mword_of_int 4) ltac:(reg_neq) ltac:(reg_neq) ltac:(reg_neq) ltac:(reg_neq) ltac:(reg_neq));
            rewrite Hm0tp; exact Htp|].
  ...
  Lemma ui_rx (γ : gname) (γu : uart_names) (γv : disk_names) (Φ : mval -> iProp Σ)
      (γs : list gname) (m0 : regfile) (av lvl : nat) (eb : bool)
      (pme : mword 64) (C : iProp Σ) (sp0 : mword 64) :
    m0 !!! Regidx csp_rs1 = sp0 ->
    m0 !!! Regidx Rtp = cid_word ->
    length γs = NPROC ->
    ...
    ⊢ ∀ M : regfile,
      ...
      WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros Hsp0 Hm0tp Hlen Hlvl Hav.
    iIntros (M) "%Hregs %Hs1 %Hs2 #Ht #Hdinv #Hpinv #Hpanic".
    ...
    { iLöb as "IH".
      iIntros (M1) "%Hregs1 %Hls1 %Hls2 Hcg Hcnt Hpc Hfr Hcont".
      iApply (UG.wp_uartgetc_inline γ γu γv Φ M1 (av - 4)%nat Rs1 Rs2
                (mword_of_int 17 : mword 8)
                (mword_of_int (UI + 0x44)) (mword_of_int (UI + 0x48))
                (mword_of_int (UI + 0x4a)) (mword_of_int (UI + 0x4c))
                (mword_of_int (UI + 0x50)) (mword_of_int (UI + 0x6c))
                Hls1 Hls2 ltac:(reg_neq)
      ...
      - (* the FIFO was empty: leave the loop *)
        iIntros (b) "_ Hcg Hpc".
        assert (Hrx : ui_regs m0 (<[Regidx Ra5 := regval_into_reg (UG.rx_masked b)]> M1)
                        (pa_stk sp0 4)).
        { destruct Hregs1 as (A2 & A4 & A19 & A20 & A21 & A22 & A23 & A24 & A25 & A26 & A27).
          unfold ui_regs. split_and!; (rewrite upd_ne; [| reg_neq]); assumption. }
        iApply (ui_tail γ Φ m0 (<[Regidx Ra5 := regval_into_reg (UG.rx_masked b)]> M1)
                  av lvl eb pme C sp0 Hrx Hsp0 Hm0tp Hav
                  with "Ht Hcg Hcnt Hpc Hfr Hcont").
      - (* a byte: hand it to consoleintr and go round again *)
        iIntros (b c) "_ Hcg Hpc".
        set (G0 := <[Regidx Ra0 := regval_into_reg (lsr_ldval_of c)]>
                   (<[Regidx Ra5 := regval_into_reg (UG.rx_masked b)]> M1)).
        change (<[Regidx Ra0 := regval_into_reg (lsr_ldval_of c)]>
                (<[Regidx Ra5 := regval_into_reg (UG.rx_masked b)]> M1)) with G0.
        (* +0x50 jal ra,consoleintr *)
        iApply (wp_jal_s_sconf γ Φ (mword_of_int (UI + 0x50)) Rra (mword_of_int 2095248 : mword 21)
                  G0 (av - 4)%nat ltac:(nz) ltac:(nz) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi50 [-]").
        iIntros "Hcg Hpc".
        set (G1 := <[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x50) : mword 64) 4)]> G0).
        change (<[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x50) : mword 64) 4)]> G0) with G1.
        iEval (rewrite Jcall) in "Hpc".
        pose proof Hregs1 as Hregs1'.
        destruct Hregs1' as (A2 & A4 & A19 & A20 & A21 & A22 & A23 & A24 & A25 & A26 & A27).
        assert (HG1tp : G1 !!! Regidx Rtp = cid_word).
        { rewrite /G1 upd_ne; [| reg_neq]. rewrite /G0 upd_ne; [| reg_neq].
          rewrite upd_ne; [| reg_neq]. exact A4. }
        assert (HG1ra : G1 !!! Regidx Rra = add_vec_int (mword_of_int (UI + 0x50) : mword 64) 4)
        ...
        iApply (Consoleintr.wp_consoleintr_sconf γ Φ G1 γs pme lvl (av - 4)%nat eb C
                  ltac:(unfold consoleintr_stack, uartintr_stack in *; lia)
                  ltac:(intro r; apply rf_to_gmap_dom)
                  Hlen HG1tp
                  ltac:(rewrite HG1tp; exact (mycpu_ret_nonzero cid_word tp_ok_cid))
                  ltac:(lia)
                  with "Hcg Hcnt Ht Hpc Hpanic Hpinv [-]").
        iIntros (Mf) "[%Hcsf %Hdomf] Hcg Hcnt Ht2 Hpc".
        iEval (rewrite HG1ra) in "Hpc".
        assert (P54 : ret_pc (add_vec_int (mword_of_int (UI + 0x50) : mword 64) 4)
                      = mword_of_int (UI + 0x54)) by pcw.
        ...
        iApply (wp_cj_s_sconf γ Φ (mword_of_int (UI + 0x54))
                  (sign_extend' 21 (concat_vec (mword_of_int 2040 : mword 11) ('b"0")))
                  Mf (av - 4)%nat ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi54 [-]").
        iNext. iIntros "Hcg Hpc". iEval (rewrite Jback) in "Hpc".
        iApply ("IH" $! Mf with "[%] [%] [%] Hcg Hcnt Hpc Hfr Hcont").
    ...
    iApply ("Loop" $! M with "[%] [%] [%] Hcg Hcnt Hpc Hfr Hcont");
  ...
  (* Both arms of the THRE test arrive here: the arm that found the FIFO
     ...
     and woke the writers jumps back from +0x6a. *)
  Lemma ui_after_tx (γ γl : gname) (γu : uart_names) (γv : disk_names)
    ...
    WP (Loop : expr riscv_lang) {{ Φ }}.
  Proof.
    intros Hregs Hsp0 Hm0tp Hlen Hlvl Hav.
    ...
    assert (P32 : add_vec_int (mword_of_int (UI + 0x2e) : mword 64) 4 = mword_of_int (UI + 0x32)) by pcw.
    assert (P36 : add_vec_int (mword_of_int (UI + 0x32) : mword 64) 4 = mword_of_int (UI + 0x36)) by pcw.
    assert (P3a : ret_pc (add_vec_int (mword_of_int (UI + 0x36) : mword 64) 4) = mword_of_int (UI + 0x3a)) by pcw.
    assert (P3e : add_vec_int (mword_of_int (UI + 0x3a) : mword 64) 4 = mword_of_int (UI + 0x3e)) by pcw.
    assert (P40 : add_vec_int (mword_of_int (UI + 0x3e) : mword 64) 2 = mword_of_int (UI + 0x40)) by pcw.
    assert (P44 : add_vec_int (mword_of_int (UI + 0x40) : mword 64) 4 = mword_of_int (UI + 0x44)) by pcw.
    (* +0x2e auipc a0,0x12 / +0x32 addi a0,a0,-1772 *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UI + 0x2e)) Ra0 (mword_of_int 18 : mword 20)
              M (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi2e [-]").
    iIntros "Hcg Hpc".
    set (R0 := <[Regidx Ra0 := regval_into_reg
        (add_vec (mword_of_int (UI + 0x2e) : mword 64) (auipc_off (mword_of_int 18 : mword 20)))]> M).
    change (<[Regidx Ra0 := regval_into_reg
        (add_vec (mword_of_int (UI + 0x2e) : mword 64) (auipc_off (mword_of_int 18 : mword 20)))]> M) with R0.
    iEval (rewrite P32) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (UI + 0x32)) Ra0 Ra0 (mword_of_int 0x914 : mword 12)
              R0 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi32 [-]").
    iIntros "Hcg Hpc".
    ...
    (* +0x36 jal ra,release *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UI + 0x36)) Rra (mword_of_int 652 : mword 21)
              R1 (av - 4)%nat ltac:(nz) ltac:(nz) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi36 [-]").
    iIntros "Hcg Hpc".
    set (R2 := <[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x36) : mword 64) 4)]> R1).
    change (<[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x36) : mword 64) 4)]> R1) with R2.
    assert (Hjrel : add_vec (mword_of_int (UI + 0x36) : mword 64)
    ...
    { rewrite /R2 upd_ne; [| reg_neq]. rewrite /R1 upd_ne; [| reg_neq].
      rewrite /R0 upd_ne; [| reg_neq]. exact Htp. }
    assert (HR2ra : R2 !!! Regidx Rra = add_vec_int (mword_of_int (UI + 0x36) : mword 64) 4)
    ...
    { rewrite /R2 /R1 /R0.
      ...
      apply callee_saved_insert_r; [vm_compute; reflexivity|].
      apply callee_saved_refl. }
    iApply (Release.wp_release_sconf γ Φ γl a_tx_lock "uart"%string (tx_res γu) R2
              lvl eb pme C (av - 4)%nat
              ltac:(rewrite HR2a0; apply bv_add_0_r; vm_compute; reflexivity)
              HR2tp ltac:(unfold uartintr_stack in Hav; lia)
    ...
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (UI + 0x3a)) Rs1 (mword_of_int 0x10000 : mword 20)
              (uart_pa 0) MR (av - 4)%nat ltac:(nz) ltac:(nz)
    ...
    iApply (wp_caddi_s_sconf γ Φ (mword_of_int (UI + 0x3e)) Rs1 (mword_of_int 5 : mword 6)
              S0 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi3e [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (UI + 0x40)) Rs2 (mword_of_int 0x10000 : mword 20)
              (uart_pa 0) S1 (av - 4)%nat ltac:(nz) ltac:(nz)
    ...
    { destruct HregsR as (B2 & B4 & B19 & B20 & B21 & B22 & B23 & B24 & B25 & B26 & B27).
      unfold ui_regs. split_and!;
        (rewrite /S2 upd_ne; [| reg_neq]); (rewrite /S1 upd_ne; [| reg_neq]);
        (rewrite /S0 upd_ne; [| reg_neq]); assumption. }
    iPoseProof (ui_rx γ γu γv Φ γs m0 av lvl eb pme C sp0 Hsp0 Hm0tp Hlen Hlvl Hav) as "Rx".
    iApply ("Rx" $! S2 with "[%] [%] [%] Ht Hdinv Hpinv Hpanic Hcg Hcnt Hpc Hfr Hcont");
  ...
  (*  THE WHOLE FUNCTION.                                                 *)
  (* ------------------------------------------------------------------ *)
  Lemma wp_uartintr_sconf (γ : gname) (γu : uart_names) (γv : disk_names) (γl : gname)
      (Φ : mval -> iProp Σ) (γs : list gname)
  ...
  Proof.
    ...
    intros pcE ret_tgt Htp Hlen Hlvl Hav.
    ...
    assert (P02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (UI + 0x02)) by pcw.
    assert (P04 : add_vec_int (mword_of_int (UI + 0x02) : mword 64) 2 = mword_of_int (UI + 0x04)) by pcw.
    assert (P06 : add_vec_int (mword_of_int (UI + 0x04) : mword 64) 2 = mword_of_int (UI + 0x06)) by pcw.
    assert (P08 : add_vec_int (mword_of_int (UI + 0x06) : mword 64) 2 = mword_of_int (UI + 0x08)) by pcw.
    assert (P0a : add_vec_int (mword_of_int (UI + 0x08) : mword 64) 2 = mword_of_int (UI + 0x0a)) by pcw.
    assert (P0c : add_vec_int (mword_of_int (UI + 0x0a) : mword 64) 2 = mword_of_int (UI + 0x0c)) by pcw.
    assert (P10 : add_vec_int (mword_of_int (UI + 0x0c) : mword 64) 4 = mword_of_int (UI + 0x10)) by pcw.
    assert (P14 : add_vec_int (mword_of_int (UI + 0x10) : mword 64) 4 = mword_of_int (UI + 0x14)) by pcw.
    assert (P18 : add_vec_int (mword_of_int (UI + 0x14) : mword 64) 4 = mword_of_int (UI + 0x18)) by pcw.
    assert (P1c : add_vec_int (mword_of_int (UI + 0x18) : mword 64) 4 = mword_of_int (UI + 0x1c)) by pcw.
    assert (P20 : ret_pc (add_vec_int (mword_of_int (UI + 0x1c) : mword 64) 4) = mword_of_int (UI + 0x20)) by pcw.
    assert (P24 : add_vec_int (mword_of_int (UI + 0x20) : mword 64) 4 = mword_of_int (UI + 0x24)) by pcw.
    assert (P28 : add_vec_int (mword_of_int (UI + 0x24) : mword 64) 4 = mword_of_int (UI + 0x28)) by pcw.
    assert (P2c : add_vec_int (mword_of_int (UI + 0x28) : mword 64) 4 = mword_of_int (UI + 0x2c)) by pcw.
    assert (P2e : add_vec_int (mword_of_int (UI + 0x2c) : mword 64) 2 = mword_of_int (UI + 0x2e)) by pcw.
    (* ============ PROLOGUE ============ *)
    assert (Hpush : add_vec (m !!! Regidx csp_rs1)
                      (sign_extend' 64 (sign_extend' 12 (mword_of_int 32 : mword 6)))
                    = pa_stk (m !!! Regidx csp_rs1) 4%nat).
    { unfold pa_stk, add_vec_int. apply f_equal. apply bv_eq; vm_compute; reflexivity. }
    iApply (wp_caddi_sp_push_s_sconf γ Φ pcE (mword_of_int 32 : mword 6) m av 4%nat
    ...
    assert (Hb4 : add_vec spd (zero_extend' 64 (concat_vec (mword_of_int 0 : mword 6) ('b"000"))) = pa_stk sp0 4)
      by (apply ui_slot_bridge; pcw).
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UI + 0x02)) (mword_of_int 3 : mword 6) Rra
              A0 (av - 4)%nat v1 with "Hcg Hpc Hi02 [H1] [-]").
    { iEval (rewrite HcspA0 Hb1). iExact "H1". }
    iIntros "Hcg Hpc H1". iEval (rewrite HcspA0 Hb1) in "H1".
    iEval (rewrite P04) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UI + 0x04)) (mword_of_int 2 : mword 6) Rs0
              A0 (av - 4)%nat v2 with "Hcg Hpc Hi04 [H2] [-]").
    { iEval (rewrite HcspA0 Hb2). iExact "H2". }
    iIntros "Hcg Hpc H2". iEval (rewrite HcspA0 Hb2) in "H2".
    iEval (rewrite P06) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UI + 0x06)) (mword_of_int 1 : mword 6) Rs1
              A0 (av - 4)%nat v3 with "Hcg Hpc Hi06 [H3] [-]").
    { iEval (rewrite HcspA0 Hb3). iExact "H3". }
    iIntros "Hcg Hpc H3". iEval (rewrite HcspA0 Hb3) in "H3".
    iEval (rewrite P08) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (UI + 0x08)) (mword_of_int 0 : mword 6) Rs2
              A0 (av - 4)%nat v4 with "Hcg Hpc Hi08 [H4] [-]").
    { iEval (rewrite HcspA0 Hb4). iExact "H4". }
    iIntros "Hcg Hpc H4". iEval (rewrite HcspA0 Hb4) in "H4".
    ...
    iEval (rewrite HA0s1) in "H3". iEval (rewrite HA0s2) in "H4".
    iAssert (ui_frame sp0 m) with "[H1 H2 H3 H4]" as "Hfr".
    { rewrite /ui_frame. iFrame "H1 H2 H3 H4". }
    (* +0x0a c.addi4spn s0,sp,32 *)
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (UI + 0x0a)) (Cregidx (mword_of_int 0))
              (mword_of_int 8 : mword 8) Rs0 A0 (av - 4)%nat
              ltac:(vm_compute; reflexivity) ltac:(nz) ltac:(nz) with "Hcg Hpc Hi0a [-]").
    iIntros "Hcg Hpc".
    ...
    (* ============ the ISR acknowledge ============ *)
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (UI + 0x0c)) Ra5 (mword_of_int 0x10000 : mword 20)
              (uart_pa 0) A1 (av - 4)%nat ltac:(nz) ltac:(nz)
    ...
    iApply (UAcc.wp_uart_read_free_s_sconf γ γu γv 2 Φ (mword_of_int (UI + 0x10)) Ra5 Ra5
              (mword_of_int 2 : mword 12) A2 (av - 4)%nat
              ltac:(unfold uart_size; lia) ltac:(nz) ltac:(nz)
              ltac:(rewrite HA2a5; apply bv_eq; vm_compute; reflexivity)
              with "Hcg Hpc Hi10 Hdinv [-]").
    iIntros (bisr) "Hcg Hpc". iEval (rewrite P14) in "Hpc".
    set (A3 := <[Regidx Ra5 := regval_into_reg (lsr_ldval_of bisr)]> A2).
    change (<[Regidx Ra5 := regval_into_reg (lsr_ldval_of bisr)]> A2) with A3.
    (* ============ acquire(&tx_lock) ============ *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UI + 0x14)) Ra0 (mword_of_int 18 : mword 20)
              A3 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi14 [-]").
    iIntros "Hcg Hpc".
    set (A4 := <[Regidx Ra0 := regval_into_reg
        (add_vec (mword_of_int (UI + 0x14) : mword 64) (auipc_off (mword_of_int 18 : mword 20)))]> A3).
    change (<[Regidx Ra0 := regval_into_reg
        (add_vec (mword_of_int (UI + 0x14) : mword 64) (auipc_off (mword_of_int 18 : mword 20)))]> A3) with A4.
    iEval (rewrite P18) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (UI + 0x18)) Ra0 Ra0 (mword_of_int 0x92e : mword 12)
              A4 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi18 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (UI + 0x1c)) Rra (mword_of_int 542 : mword 21)
              A5 (av - 4)%nat ltac:(nz) ltac:(nz) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi1c [-]").
    iIntros "Hcg Hpc".
    set (A6 := <[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x1c) : mword 64) 4)]> A5).
    change (<[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x1c) : mword 64) 4)]> A5) with A6.
    assert (Hjacq : add_vec (mword_of_int (UI + 0x1c) : mword 64)
    ...
    assert (HA6ra : A6 !!! Regidx Rra = add_vec_int (mword_of_int (UI + 0x1c) : mword 64) 4)
    ...
    { unfold ui_regs. split_and!;
      ...
      - exact (eq_trans (eq_sym (eq_refl _)) HcspA0) || idtac.
      - exact HA6tp. }
    iApply (Acquire.wp_acquire_sconf γ Φ γl "uart"%string (tx_res γu) A6
              lvl eb pme C (av - 4)%nat HA6tp ltac:(lia)
    ...
    destruct HregsA' as (Wsp & Wtp & W19 & W20 & W21 & W22 & W23 & W24 & W25 & W26 & W27).
    (* ============ the LSR read, under the lock ============ *)
    iDestruct "HR" as (bcell l) "(Hcell & Hown & Hwand)".
    iApply (wp_lui_s_sconf γ Φ (mword_of_int (UI + 0x20)) Ra5 (mword_of_int 0x10000 : mword 20)
              (uart_pa 0) MA (av - 4)%nat ltac:(nz) ltac:(nz)
    ...
    iApply (UAcc.wp_uart_lsr_read_ea_s_sconf γ γu γv Φ (mword_of_int (UI + 0x24)) Ra5 Ra5
              (mword_of_int 5 : mword 12) B0 (av - 4)%nat l ltac:(nz) ltac:(nz)
              ltac:(rewrite HB0a5; apply bv_eq; vm_compute; reflexivity)
    ...
    (* +0x28 andi a5,a5,32 *)
    iApply (wp_andi_s_sconf γ Φ (mword_of_int (UI + 0x28)) Ra5 Ra5 (mword_of_int 32 : mword 12)
              _ B1 (av - 4)%nat ltac:(nz) ltac:(nz) eq_refl with "Hcg Hpc Hi28 [-]").
    iIntros "Hcg Hpc".
    ...
    - (* the FIFO is still busy: fall through to the release *)
      iApply (wp_cbnez_fall_s_sconf γ Φ (mword_of_int (UI + 0x2c)) (mword_of_int 21 : mword 8)
                (Cregidx (mword_of_int 7)) Ra5 B2 (av - 4)%nat UG.ug_cr7 ltac:(nz)
                ltac:(rewrite HB2a5; unfold neq_vec; rewrite -/(lsr_thre_clear blsr) Hthre; reflexivity)
                with "Hcg Hpc Hi2c [-]").
      iIntros "Hcg Hpc". iEval (rewrite P2e) in "Hpc".
      iApply (ui_after_tx γ γl γu γv Φ γs m B2 av lvl eb pme C sp0
                HB2regs Hspm Htp Hlen Hlvl Hav
    ...
    - (* THRE: clear tx_busy and wake the writers *)
      ...
      assert (Jtx : add_vec (mword_of_int (UI + 0x2c) : mword 64)
                      (sign_extend' 64 (sign_extend' 13 (concat_vec (mword_of_int 21 : mword 8) ('b"0"))))
                    = mword_of_int (UI + 0x56)) by pcw.
      iApply (wp_cbnez_taken_s_sconf γ Φ (mword_of_int (UI + 0x2c)) (mword_of_int 21 : mword 8)
                (Cregidx (mword_of_int 7)) Ra5 B2 (av - 4)%nat UG.ug_cr7 ltac:(nz)
                ltac:(rewrite HB2a5; unfold neq_vec; rewrite -/(lsr_thre_clear blsr) Hthre; reflexivity)
                ltac:(rewrite Jtx; vm_compute; reflexivity)
                with "Hcg Hpc Hi2c [-]").
      iNext. iIntros "Hcg Hpc". iEval (rewrite Jtx) in "Hpc".
      ...
      assert (P5a : add_vec_int (mword_of_int (UI + 0x56) : mword 64) 4 = mword_of_int (UI + 0x5a)) by pcw.
      assert (P5e : add_vec_int (mword_of_int (UI + 0x5a) : mword 64) 4 = mword_of_int (UI + 0x5e)) by pcw.
      assert (P62 : add_vec_int (mword_of_int (UI + 0x5e) : mword 64) 4 = mword_of_int (UI + 0x62)) by pcw.
      assert (P66 : add_vec_int (mword_of_int (UI + 0x62) : mword 64) 4 = mword_of_int (UI + 0x66)) by pcw.
      assert (P6a : ret_pc (add_vec_int (mword_of_int (UI + 0x66) : mword 64) 4) = mword_of_int (UI + 0x6a)) by pcw.
      (* +0x56 auipc a5,0xa / +0x5a sw zero,-2040(a5) : tx_busy = 0 *)
      iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UI + 0x56)) Ra5 (mword_of_int 10 : mword 20)
                B2 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi56 [-]").
      iIntros "Hcg Hpc".
      set (T0 := <[Regidx Ra5 := regval_into_reg
          (add_vec (mword_of_int (UI + 0x56) : mword 64) (auipc_off (mword_of_int 10 : mword 20)))]> B2).
      change (<[Regidx Ra5 := regval_into_reg
          (add_vec (mword_of_int (UI + 0x56) : mword 64) (auipc_off (mword_of_int 10 : mword 20)))]> B2) with T0.
      iEval (rewrite P5a) in "Hpc".
      assert (Hbusya : add_vec (T0 !!! Regidx Ra5) (sign_extend' 64 (mword_of_int 0x808 : mword 12)) = a_tx_busy).
      { rewrite /T0 upd_eq. rewrite /a_tx_busy. pcw. }
      iApply (wp_sw_zero_s_sconf γ Φ (mword_of_int (UI + 0x5a)) Ra5 (mword_of_int 0x808 : mword 12)
                T0 (av - 4)%nat bcell with "Hcg Hpc Hi5a [Hcell] [-]").
      ...
      iApply (wp_auipc_s_sconf γ Φ (mword_of_int (UI + 0x5e)) Ra0 (mword_of_int 9 : mword 20)
                T0 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi5e [-]").
      iIntros "Hcg Hpc".
      set (T1 := <[Regidx Ra0 := regval_into_reg
          (add_vec (mword_of_int (UI + 0x5e) : mword 64) (auipc_off (mword_of_int 9 : mword 20)))]> T0).
      change (<[Regidx Ra0 := regval_into_reg
          (add_vec (mword_of_int (UI + 0x5e) : mword 64) (auipc_off (mword_of_int 9 : mword 20)))]> T0) with T1.
      iEval (rewrite P62) in "Hpc".
      iApply (wp_addi4_s_sconf γ Φ (mword_of_int (UI + 0x62)) Ra0 Ra0 (mword_of_int 0x7fc : mword 12)
                T1 (av - 4)%nat ltac:(nz) ltac:(nz) with "Hcg Hpc Hi62 [-]").
      iIntros "Hcg Hpc".
      ...
      (* +0x66 jal ra,wakeup *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (UI + 0x66)) Rra (mword_of_int 5406 : mword 21)
                T2 (av - 4)%nat ltac:(nz) ltac:(nz) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi66 [-]").
      iIntros "Hcg Hpc".
      set (T3 := <[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x66) : mword 64) 4)]> T2).
      change (<[Regidx Rra := regval_into_reg (add_vec_int (mword_of_int (UI + 0x66) : mword 64) 4)]> T2) with T3.
      assert (Hjwk : add_vec (mword_of_int (UI + 0x66) : mword 64)
                       (sign_extend' 64 (mword_of_int 5406 : mword 21)) = mword_of_int KernelSyms.wakeup) by pcw.
      iEval (rewrite Hjwk) in "Hpc".
      assert (HT3tp : T3 !!! Regidx Rtp = cid_word).
      { rewrite /T3 upd_ne; [| reg_neq]. rewrite /T2 upd_ne; [| reg_neq].
        rewrite /T1 upd_ne; [| reg_neq]. rewrite /T0 upd_ne; [| reg_neq].
        rewrite /B2 upd_ne; [| reg_neq]. rewrite /B0 upd_ne; [| reg_neq]. exact Wtp. }
      assert (HT3ra : T3 !!! Regidx Rra = add_vec_int (mword_of_int (UI + 0x66) : mword 64) 4)
      ...
      { rewrite /T3 /T2 /T1 /T0.
        ...
        apply callee_saved_insert_r; [vm_compute; reflexivity|].
        apply callee_saved_refl. }
      iApply (Wakeup.wp_wakeup_sconf γ Φ T3 γs (mycpu_ret cid_word) pme (S lvl) (av - 4)%nat eb C
                ltac:(unfold uartintr_stack in Hav; lia)
                ltac:(intro r; apply rf_to_gmap_dom)
                Hlen HT3tp
                ltac:(rewrite HT3tp; reflexivity)
                ltac:(rewrite HT3tp; exact (mycpu_ret_nonzero cid_word tp_ok_cid))
                ltac:(lia)
                with "Hcg Hcnt Ht Hpc Hpanic Hpinv [-]").
      ...
      assert (Jrel : add_vec (mword_of_int (UI + 0x6a) : mword 64)
                       (sign_extend' 64 (sign_extend' 21 (concat_vec (mword_of_int 2018 : mword 11) ('b"0"))))
                     = mword_of_int (UI + 0x2e)) by pcw.
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (UI + 0x6a))
                (sign_extend' 21 (concat_vec (mword_of_int 2018 : mword 11) ('b"0")))
                Mw (av - 4)%nat ltac:(vm_compute; reflexivity) with "Hcg Hpc Hi6a [-]").
      iNext. iIntros "Hcg Hpc". iEval (rewrite Jrel) in "Hpc".
      iApply (ui_after_tx γ γl γu γv Φ γs m Mw av lvl eb pme C sp0
                HregsW Hspm Htp Hlen Hlvl Hav

...
End VRU4Walk.
  ...
  (* ============================================================ *)
  (* Colliding-slot (nomatch) twin of exec_execute_LOAD_4_U_walk.  *)
  (* ============================================================ *)
Section VRU4WalkNomatch.
  ...
  Lemma exec_execute_LOAD_4_U_walk_nomatch (is_unsigned : bool) :
    exec (execute (LOAD (imm, Regidx rs1, Regidx rd, is_unsigned, 4))) s
      = Some (RETIRE_SUCCESS,
              set_reg s' (R_bitvector_64 (gpr_of_Z (uint rd)))
                (regval_into_reg (extend_value is_unsigned data2))).
...
End VWU4Walk.
  ...
  (* Colliding-slot (nomatch) twin of exec_execute_STORE_4_U_walk. *)
Section VWU4WalkNomatch.
  ...
  Lemma exec_execute_STORE_4_U_walk_nomatch :
    exec (execute (STORE (imm, Regidx rs2, Regidx rs1, 4))) s
      = Some (RETIRE_SUCCESS,
              MState s'.(sregs) (write_bytes s'.(mem) pa 4
                (autocast (T := mword) (subrange_vec_dec vrs2 (Z.sub (Z.mul 4 8) 1) 0) : mword 32)) s'.(mdev)).

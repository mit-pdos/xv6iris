...
Section ProofBpin.
  ...
  Lemma wp_bpin_sconf (γ : gname) (Φ : mval -> iProp Σ) (bn : bio_names) (k : nat)
  ...
  Proof.
    ...
    assert (Hpp02 : add_vec_int (pcE : mword 64) 2 = mword_of_int (BP + 0x02))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp02) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (BP + 0x02)) (mword_of_int 3 : mword 6) Rra
              R1 (K - 4)%nat vr24 with "Hcg Hpc Hi02 Hr24 [-]").
    iIntros "Hcg Hpc Hr24".
    assert (Hpp04 : add_vec_int (mword_of_int (BP + 0x02) : mword 64) 2 = mword_of_int (BP + 0x04))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp04) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (BP + 0x04)) (mword_of_int 2 : mword 6) Rs0
              R1 (K - 4)%nat vr16 with "Hcg Hpc Hi04 Hr16 [-]").
    iIntros "Hcg Hpc Hr16".
    assert (Hpp06 : add_vec_int (mword_of_int (BP + 0x04) : mword 64) 2 = mword_of_int (BP + 0x06))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp06) in "Hpc".
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (BP + 0x06)) (mword_of_int 1 : mword 6) Rs1
              R1 (K - 4)%nat vr8 with "Hcg Hpc Hi06 Hr8 [-]").
    iIntros "Hcg Hpc Hr8".
    assert (Hpp08 : add_vec_int (mword_of_int (BP + 0x06) : mword 64) 2 = mword_of_int (BP + 0x08))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp08) in "Hpc".
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (BP + 0x08)) (Cregidx (mword_of_int 0))
    ...
    assert (Hpp0a : add_vec_int (mword_of_int (BP + 0x08) : mword 64) 2 = mword_of_int (BP + 0x0a))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp0a) in "Hpc".
    (* +0x0a c.mv s1,a0 : the cursor register takes the argument *)
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (BP + 0x0a)) Rs1 Ra0
    ...
    assert (Hpp0c : add_vec_int (mword_of_int (BP + 0x0a) : mword 64) 2 = mword_of_int (BP + 0x0c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp0c) in "Hpc".
    (* +0x0c/+0x10 a0 := &bcache *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (BP + 0x0c)) Ra0 (mword_of_int 0x15 : mword 20)
              R3 (K - 4)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi0c [-]").
    iIntros "Hcg Hpc".
    set (R4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (mword_of_int (BP + 0x0c) : mword 64)
                     (auipc_off (mword_of_int 0x15 : mword 20)))]> R3).
    assert (Hpp10 : add_vec_int (mword_of_int (BP + 0x0c) : mword 64) 4 = mword_of_int (BP + 0x10))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp10) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (BP + 0x10)) Ra0 Ra0 (mword_of_int 0x4c2 : mword 12)
              R4 (K - 4)%nat ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi10 [-]").
    iIntros "Hcg Hpc".
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 0x4c2 : mword 12)))]> R4).
    assert (HR5a0 : R5 !!! Regidx Ra0 = bcache_addr).
    { rewrite /R5 upd_eq /R4 upd_eq. rewrite /bcache_addr.
      apply bv_eq; vm_compute; reflexivity. }
    assert (Hpp14 : add_vec_int (mword_of_int (BP + 0x10) : mword 64) 4 = mword_of_int (BP + 0x14))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp14) in "Hpc".
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (BP + 0x14)) Rra (mword_of_int 0x1fdf32 : mword 21)
    ...
    set (mA := <[Regidx Rra := regval_into_reg
                  (add_vec_int (mword_of_int (BP + 0x14) : mword 64) 4)]> R5).
    assert (Htgtacq : add_vec (mword_of_int (BP + 0x14) : mword 64)
    ...
    assert (Hpc18 : ret_pc (mA !!! Regidx Rra) = mword_of_int (BP + 0x18)).
    ...
    iApply (wp_clw_s_sconf γ Φ (mword_of_int (BP + 0x18)) Ra5 Rs1 (mword_of_int 64 : mword 12)
    ...
    iApply (wp_caddiw_s_sconf γ Φ (mword_of_int (BP + 0x1a)) Ra5 (mword_of_int 1 : mword 6)
    ...
    assert (Hpp1c : add_vec_int (mword_of_int (BP + 0x1a) : mword 64) 2 = mword_of_int (BP + 0x1c))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_csw_s_sconf γ Φ (mword_of_int (BP + 0x1c)) Ra5 Rs1 (mword_of_int 64 : mword 12)
    ...
    assert (Hpp1e : add_vec_int (mword_of_int (BP + 0x1c) : mword 64) 2 = mword_of_int (BP + 0x1e))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp1e) in "Hpc".
    (* +0x1e/+0x22 a0 := &bcache ; +0x26 jal release *)
    iApply (wp_auipc_s_sconf γ Φ (mword_of_int (BP + 0x1e)) Ra0 (mword_of_int 0x15 : mword 20)
    ...
    assert (Hpp22 : add_vec_int (mword_of_int (BP + 0x1e) : mword 64) 4 = mword_of_int (BP + 0x22))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp22) in "Hpc".
    iApply (wp_addi4_s_sconf γ Φ (mword_of_int (BP + 0x22)) Ra0 Ra0 (mword_of_int 0x4b0 : mword 12)
    ...
    { rewrite /D4 upd_eq /D3 upd_eq. rewrite /bcache_addr.
      apply bv_eq; vm_compute; reflexivity. }
    assert (Hpp26 : add_vec_int (mword_of_int (BP + 0x22) : mword 64) 4 = mword_of_int (BP + 0x26))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp26) in "Hpc".
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (BP + 0x26)) Rra (mword_of_int 0x1fdfa8 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (BP + 0x26) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x1fdfa8 : mword 21))
    ...
    assert (Hpc2a : ret_pc (D5 !!! Regidx Rra) = mword_of_int (BP + 0x2a)).
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (BP + 0x2a)) (mword_of_int 3 : mword 6) Rra
    ...
    assert (Hpp2c : add_vec_int (mword_of_int (BP + 0x2a) : mword 64) 2 = mword_of_int (BP + 0x2c))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp2c) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (BP + 0x2c)) (mword_of_int 2 : mword 6) Rs0
    ...
    assert (Hpp2e : add_vec_int (mword_of_int (BP + 0x2c) : mword 64) 2 = mword_of_int (BP + 0x2e))
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hpp2e) in "Hpc".
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (BP + 0x2e)) (mword_of_int 1 : mword 6) Rs1
    ...
    assert (Hpp30 : add_vec_int (mword_of_int (BP + 0x2e) : mword 64) 2 = mword_of_int (BP + 0x30))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (BP + 0x30)) (mword_of_int 2 : mword 6)
    ...
    assert (Hpp32 : add_vec_int (mword_of_int (BP + 0x30) : mword 64) 2 = mword_of_int (BP + 0x32))
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    { rewrite /P4 upd_ne; [| vm_compute; discriminate].
      ...
      rewrite /P1 upd_eq.
      rewrite /R1 upd_ne; [reflexivity | vm_compute; discriminate]. }
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (BP + 0x32)) Rra P4 K

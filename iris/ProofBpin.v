...
Section ProofBpin.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bpin + 0x10)) Ra0 Ra0 (mword_of_int 0x496 : mword 12)
              R4 (K - 4)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (bpi_10 with "Htext"). }
    iIntros (CID8 Hs8) "Hcg Hpc".
    set (R5 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R4 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1174 : mword 12)))]> R4).
    ...
    (* ===== +0x14 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bpin + 0x14)) Rra (mword_of_int 0x1fde78 : mword 21)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bpin + 0x22)) Ra0 Ra0 (mword_of_int 0x484 : mword 12)
    ...
    set (D4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (D3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1156 : mword 12)))]> D3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bpin + 0x26)) Rra (mword_of_int 0x1fdeee : mword 21)

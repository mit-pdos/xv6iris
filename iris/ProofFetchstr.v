...
Section ProofFetchstr.
  ...
  (* =================================================================== *)
  Lemma fs_tail (γ : gname) (Φ : mval -> iProp Σ)
      (m Mt : regfile) (av : nat) (rv : mword 64)
      (sp0 ra0 s00 s10 s20 s30 gap : mword 64) :
    (6 <= av)%nat ->
  ...
  Proof.
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x2e))
              (mword_of_int 5 : mword 6) Rra Mt (av - 6)%nat ra0
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x30))
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x32))
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x34))
              (mword_of_int 2 : mword 6) Rs2 T3 (av - 6)%nat s20
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x36))
              (mword_of_int 1 : mword 6) Rs3 T4 (av - 6)%nat s30
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_caddi16sp_pop_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x38))
              (mword_of_int 3 : mword 6) T5 (av - 6)%nat 6 Hpop
    ...
    iApply (wp_cret_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x3a))
              Rra T6 av ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi3a [-]").
    iIntros "Hcg Hpc".
  ...
  (*  THE CAPSTONE.                                                       *)
  (* =================================================================== *)
  Lemma wp_fetchstr_sconf (γ : gname) (γf : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    ...
    intros pcE buf ret_tgt Htp Hn Hav Hmax Hmax31.
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x02))
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x04))
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x06))
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x08))
              (mword_of_int 2 : mword 6) Rs2 M1 (av - 6)%nat u4
    ...
    iApply (wp_csdsp_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x0a))
              (mword_of_int 1 : mword 6) Rs3 M1 (av - 6)%nat u5
    ...
    iEval (rewrite Hpa5 HM1s3) in "Hs5".
    (* ---- +0x0c: c.addi4spn s0,sp,48 (s0's VALUE is never read) ---- *)
    iApply (wp_caddi4spn_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x0c))
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x0e))
              Rs3 Ra0 M2 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi0e [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x10))
              Rs1 Ra1 M3 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi10 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x12))
              Rs2 Ra2 M4 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi12 [-]").
    iIntros "Hcg Hpc".
    ...
    (* ---- +0x14: jal ra,myproc ---- *)
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x14))
              Rra (mword_of_int 2093356 : mword 21) M5 (av - 6)%nat
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.fetchstr + 0x14) : mword 64)
                     (sign_extend' 64 (mword_of_int 2093356 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    assert (HM6tp : M6 !!! Regidx Rtp = cid_word)
      by (rewrite /M6 upd_ne; [exact HM5tp | reg_neq]).
    ...
    (* ---- myproc(): a0 = p ---- *)
    iApply (Myproc.wp_myproc_sconf γ Φ M6 (av - 6)%nat n eb p C
              HM6tp Hn ltac:(lia)
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x18))
              Ra3 Rs2 A (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi18 [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x1a))
              Ra2 Rs3 A1 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1a [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x1c))
              Ra1 Rs1 A2 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hcg Hpc Hi1c [-]").
    iIntros "Hcg Hpc".
    ...
    iApply (wp_cld_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x1e)) Ra0 Ra0
              (mword_of_int 80 : mword 12) A3 (av - 6)%nat (page_base (ud_root (pv_upt V)))
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_jal_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x20))
              Rra (mword_of_int 2092260 : mword 21) A4 (av - 6)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi20 [-]").
    iIntros "Hcg Hpc".
    ...
    assert (Hjcis : add_vec (mword_of_int (KernelSyms.fetchstr + 0x20) : mword 64)
                      (sign_extend' 64 (mword_of_int 2092260 : mword 21)) = mword_of_int KernelSyms.copyinstr)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (Copyinstr.wp_copyinstr_sconf γ Φ A5 (pv_upt V) maxn buf_olds (av - 6)%nat
              HK20 HA5a0 HA5a3 Hmax64
              with "Hcg Htext Hpc Hpt Hbuf [-]").
    iIntros (mr dst_new) "Hcg Hpc Hpt Hbuf %Hcsr %Hret".
    iEval (rewrite HA5a1) in "Hbuf".
    ...
    - (* ======= copyinstr returned 0: fall through to strlen ======= *)
      ...
      iApply (wp_blt_x0_fall_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x24))
                (mword_of_int 24 : mword 13) Ra0 mr (av - 6)%nat
      ...
      iApply (wp_cmv_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x28))
                Ra0 Rs1 mr (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hcg Hpc Hi28 [-]").
      iIntros "Hcg Hpc".
      ...
      (* ---- +0x2a: jal ra,strlen ---- *)
      iApply (wp_jal_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x2a))
                Rra (mword_of_int 2090596 : mword 21) B1 (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi2a [-]").
      iIntros "Hcg Hpc".
      ...
      assert (Hjsl : add_vec (mword_of_int (KernelSyms.fetchstr + 0x2a) : mword 64)
                       (sign_extend' 64 (mword_of_int 2090596 : mword 21)) = mword_of_int KernelSyms.strlen)
        by (apply bv_eq; vm_compute; reflexivity).
      ...
      (* ---- strlen(buf) ---- *)
      iApply (Strlen.wp_strlen_sconf γ Φ B2 maxn k dst_new (av - 6)%nat (DfracOwn 1)
                ltac:(lia) Hkmax Hcstr Hk31
                with "Hcg Htext Hpc Hbuf [-]").
      iIntros (msl) "Hcg Hpc Hbuf %Hcssl %Hsla0".
      iEval (rewrite HB2a0) in "Hbuf".
      ...
      iApply (fs_tail γ Φ m msl av (mword_of_int (Z.of_nat k) : mword 64)
                sp0 ra0 s00 s10 s20 s30 u6
    ...
    - (* ======= copyinstr returned -1: take the branch ======= *)
      ...
      iApply (wp_blt_x0_taken_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x24))
                (mword_of_int 24 : mword 13) Ra0 mr (av - 6)%nat
      ...
      (* ---- +0x3c: c.li a0,-1 ---- *)
      iApply (wp_cli_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x3c))
                Ra0 (mword_of_int 63 : mword 6) (mword_of_int (-1) : mword 64) mr (av - 6)%nat
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      (* ---- +0x3e: c.j -0x0c ---- *)
      iApply (wp_cj_s_sconf γ Φ (mword_of_int (KernelSyms.fetchstr + 0x3e))
                (sign_extend' 21 (concat_vec (mword_of_int 2040 : mword 11) ('b"0")))
                E1 (av - 6)%nat ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi3e [-]").
      iNext. iIntros "Hcg Hpc".
      ...
      iApply (fs_tail γ Φ m E1 av (mword_of_int (-1) : mword 64)
                sp0 ra0 s00 s10 s20 s30 u6
                ltac:(lia) eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl
                HE1sp HE1a0 HthrE1
                with "Hcg Htext Hpc Hs1 Hs2 Hs3 Hs4 Hs5 Hs6 [-]").

(* ProofSysOpenStores.v -- +0x88 .. +0xb4 AND THE +0x14e itrunc BLOCK, at
   ...
   [ProofSysOpenShared.so_flat], not [IcacheEscrow.ic_loaded]: the FILE
...
Module SysOpenStores (Iunlock : IUNLOCK) (Iunlockput : IUNLOCKPUT)
...
Section ProofSysOpenStores.
 ...
 kk qi s gy loy tly inum dn bm kf fd l C pn om voff nsj
    ...
    (* THE PEEL IS ALREADY DONE, and at THIS [data]: that is the whole
       reason the payload is threaded flat (ProofSysOpenShared' header). *)
 ...
 (ientry kk) inum dn dn bm data u2 Sb2 false false e2
    ...
    (* ---- THE TRUNC FIRE (SysOpenDefs item 3): the two phases FUSED

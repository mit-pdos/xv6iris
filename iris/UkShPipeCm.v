...
(* TURN, and the turn is THIRTEEN instructions -- 0x69e..0x6bc -- which    *)
(* rejoin the landed walk's own tail at 0x68c, so the prologue, the guard, *)
(* the tail and the epilogue are all the landed text.                     *)
(*                                                                        *)
(* WHAT IS DISCHARGED HERE, of the turn's three calls:                     *)
(*                                                                        *)
(*   0x6a6 [gettoken] -- [UkShPipeTok.wp_kshp_gettoken_syms] at the '|':   *)
...
(*   0x6ae [parsepipe] -- THE RECURSION, and it is the LANDED symbol-free  *)
...
(*                                                                        *)
(*   0x674 [parseexec] -- the LEFT command's parse.  It is a RE-STATEMENT  *)
...
(*   0x6b6 [pipecmd] -- its 48 instructions are in NO catalog              *)
...
(*ALIASES-BEGIN*)
  ...
  (* (ii) [pipecmd] (0x272).  Stated as [UkShRedirCmd.wp_kshp_redircmd_n] is:
  ...
  Definition ushq_pipecmd_call (Pex : iProp Σ) (av : nat) : iProp Σ :=
    (∀ (h : CpuId) (m : regfile) (pl pr : Z) (rpc : mword 64)
       ...
       Pex -∗
       Sub -∗
       urun N h m (mword_of_int 0x272) av -∗
  ...
  (* PREMISE (ii) IS DISCHARGED: [pipecmd]'s twenty-seven instructions are
     ...
     only thing to say: the walk asks for [4 + (4 + (10 + nn'))] and the
     turn's call site has [16 + (24 + (8 + nn))], so [nn' := 30 + nn] and
     the two are the same [48 + nn]. *)
  ...
  (* THIRTEEN instructions, 0x69e..0x6bc, rejoining the landed walk's own    *)
  (* tail at 0x68c:                                                         *)
  (*                                                                        *)
  (*   0x69e c.li a3,0 ; 0x6a0 c.li a2,0 ; 0x6a2 c.mv a1,s1                 *)
  (*   0x6a4 c.mv a0,s4 ; 0x6a6 jal gettoken   -- consumes the '|'          *)
  (*   0x6aa c.mv a1,s1 ; 0x6ac c.mv a0,s4                                  *)
  (*   0x6ae jal parsepipe                     -- THE RECURSION             *)
  (*   0x6b2 c.mv a1,a0 ; 0x6b4 c.mv a0,s3                                  *)
  (*   0x6b6 jal pipecmd                        -- the PIPE node            *)
  ...
  Proof using .
    ...
    iApply (wp_uk_jal N h4 m4 (mword_of_int 0x674)
              ...
              (mword_of_int 0x56c) (mword_of_int 0x678) (16 + (24 + (8 + nn)))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    (* ---- 0x674  jal 56c <parseexec> -- THE LEFT COMMAND, premise (i) -- *)
    iDestruct (UkShCmdalloc.ushp_oom_mono N Pex (20 + nn)
                 (16 + (24 + (8 + nn)) - 22) ltac:(lia) with "Hpx") as "#Hpxl".
    iApply ("Hleft" $! h5 m5 (mword_of_int 0x678)
              with "[] [] [] Hcode Hro Hcur Hstr Hws Hsy HM0 Hpxl Hpay Hrun").
    ...
    iApply (wp_uk_auipc N h7 m7 (mword_of_int 0x67a)
              ...
              (mword_of_int 0x167a) (16 + (24 + (8 + nn)))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
    ...
    iApply (wp_uk_jal N h11 m11 (mword_of_int 0x686)
              ...
              (mword_of_int 0x424) (mword_of_int 0x68a) (16 + (24 + (8 + nn)))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_cbnez N h13 m13 (mword_of_int 0x68a)
              ...
              a0_idx true (mword_of_int 0x69e) (16 + (24 + (8 + nn)))
              ltac:(vm_compute; reflexivity)
    ...
    iApply (wp_uk_jal N h18 q4 (mword_of_int 0x6a6)
              ...
              (mword_of_int 0x2ec) (mword_of_int 0x6aa) (16 + (24 + (8 + nn)))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_jal N h22 g3 (mword_of_int 0x6ae)
              ...
              (mword_of_int 0x65e) (mword_of_int 0x6b2) (16 + (24 + (8 + nn)))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    (* ---- 0x6b6  jal 272 <pipecmd> -- premise (ii) ---- *)
    iApply (wp_uk_jal N h26 r3 (mword_of_int 0x6b6)
              (mword_of_int 2096060 : mword 21) ra_idx
              (mword_of_int 0x272) (mword_of_int 0x6ba) (16 + (24 + (8 + nn)))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iDestruct (UkShCmdalloc.ushp_oom_mono N Pex (20 + nn)
                 (16 + (24 + (8 + nn)) - 8) ltac:(lia) with "Hpx") as "#Hpxc".
    iApply ("Hpipec" $! h27 r4 pl pr (mword_of_int 0x6ba)
              (ushp_exec_at s0 pl args ∗ Tr pr)%I
              with "[] [] [] Hcode HM2 Hpxc Hpay [Hnodel Hnoder] Hrun").
    ...
    (* ---- 0x6bc  c.j 6b0 -- into the landed walk's own tail ---- *)
    ...
    iIntros (h30) "Hrun".
    (* ---- 0x68c  c.mv a0,s3 -- the landed walk's own tail, unchanged ---- *)
    iApply (wp_uk_cmv N h30 q12 (mword_of_int 0x68c) a0_idx
  ...
  Proof using .
    ...
    iApply (wp_uk_auipc N h6 m6 (mword_of_int 0x6d8)
              ...
              (mword_of_int 0x16d8) (6 + (16 + (24 + (8 + nn))))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
    ...
    iApply (wp_uk_cbnez N h14 m13 (mword_of_int 0x700)
              ...
              a0_idx false (mword_of_int 0x6e2) (6 + (16 + (24 + (8 + nn))))
              ltac:(vm_compute; reflexivity)
              ltac:(rewrite Ha0_13; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(discriminate)
    ...
    iApply (wp_uk_auipc N h15 m13 (mword_of_int 0x702)
              (mword_of_int 1 : mword 20) a2_idx
              (mword_of_int 0x1702) (6 + (16 + (24 + (8 + nn))))
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              with "[] Hrun").
    ...
    iApply (wp_uk_cbnez N h21 m19 (mword_of_int 0x712)
              (mword_of_int 10 : mword 8) (mword_of_int 2 : mword 3)
              a0_idx false (mword_of_int 0x726) (6 + (16 + (24 + (8 + nn))))
              ltac:(vm_compute; reflexivity)
  ...
  Proof using .
    ...
    iApply (wp_uk_jal N h5 m3 (mword_of_int 0x85e)
              ...
              (mword_of_int 0xa0c) (mword_of_int 0x862) (60 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_jal N h13 m11 (mword_of_int 0x870)
              ...
              (mword_of_int 0x6be) (mword_of_int 0x874) (60 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_jal N h20 m18 (mword_of_int 0x882)
              ...
              (mword_of_int 0x424) (mword_of_int 0x886) (60 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)
    ...
    iApply (wp_uk_jal N h25 m22 (mword_of_int 0x890)
              ...
              (mword_of_int 0x7ca) (mword_of_int 0x894) (60 + nn)
              ltac:(unfold unot_sp; vm_compute; discriminate)
              ltac:(vm_compute; discriminate)
              ltac:(apply bv_eq; vm_compute; reflexivity)
              ltac:(apply bv_eq; vm_compute; reflexivity)

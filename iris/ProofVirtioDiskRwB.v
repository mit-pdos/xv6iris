  ...
  Proof.
    ...
    { iLöb as "IH". rewrite /vdrw_p2_loop.
      ...
      { (* ============ all three won: hand the seam to P3 ============ *)
        ...
        iApply ("Hexit" $! M1 np nr fl pk tr fr h m2 t with
                  "[%] [%] [%] [%] Hcg Hown Htc Hclm Hpc Htok
                   [Hpub Hlb Hcl Huidx Hflight Hparked Hbun Hring Havh] Hbh Hbm Hbt Hidx").
        - split;
        ...
        - exact Hal.
        - rewrite /vdrw_body. iFrame "Hpub Hlb Hcl Huidx Hflight Hparked Hbun Hring Havh".
      ...
      iAssert ( ∀ (Mz : regfile),
                  ...
                  vdrw_p2_exit CID γk γs j γd pd pav pu K eb sp0 b wr sector m0 lks -∗
                  WP (Loop : expr riscv_lang))%I
        with "[Hpub Hlb Hcl Huidx Hflight Hparked Hring Havh IH]" as "Hsleep".
      { iIntros (Mz) "%Hcsz Hcg Hown Htc Hclm Hpc Htok Hbun Hscr Hexit".
        ...
        iAssert (disk_res γd pd pav pu)
          with "[Hpub Hlb Hcl Huidx Hflight Hparked Hbun Hring Havh]" as "HR".
        { iApply (vdrw_body_close γd pd pav pu np nr fl pk tr fr).
          rewrite /vdrw_body.
          iFrame "Hpub Hlb Hcl Huidx Hflight Hparked Hbun Hring Havh".

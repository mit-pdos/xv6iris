...
Section VdrwbFreeAt.
 ...
 procs_inv γs -∗
    ...
    (* the slot comes back WITH its receipt: re-marking the descriptor free
       puts both back into the bundle *)
    (free_slot_res pd i ∗ i ↪[dn_head γd] HInactive) -∗
    ( ∀ Mf : regfile,
  ...
  Proof.
    ...
    iApply ("Hcont" $! Mf with "[%] Hcg Hown Hpc Hidx [Hcell Hrest Hops Hst Hib Hfrag Hd0 Hd8 Hd12 Hd14]").
    { intros r Hr.
    ...
    iFrame "Hrest Hcell Hfrag Hops Hst Hib".
  ...
  Definition vdrw_p2_exit (CID0 : CPU) (γk : gname)
    ...
    (wp_next (CID0 := CID0) true (proc_addr j) (fun (CID : CpuId) =>
     ∀ (M : regfile) (np nr : nat) (cm : gmap nat dclaim)
       ...
       (* each allocated slot with its receipt, as the allocator hands
          them out *)
 ...
 procs_inv γs -∗
  ...
  Proof.
    ...
    iApply (wp_cli_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x036) : mword 64) Rs1
              ...
              ltac:(vm_compute; discriminate) ltac:(rdok)
              vdrwb_li8 with "Hcg Hpc []").
    { iApply (rwi_036 with "Htext"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x03c) : mword 64) Rs5 Rs5
              (mword_of_int 2960 : mword 12) A2 (trap_res eb + (K - 12))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (rwi_03c with "Htext"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    set (A3 := <[Regidx Rs5 := regval_into_reg
                  (add_vec (A2 !!! Regidx Rs5)
                     (sign_extend' 64 (mword_of_int 2960 : mword 12)))]> A2).
    change (<[Regidx Rs5 := regval_into_reg
                  (add_vec (A2 !!! Regidx Rs5)
                     (sign_extend' 64 (mword_of_int 2960 : mword 12)))]> A2) with A3.
    ...
    iApply (wp_cli_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x040) : mword 64) Rs4
              ...
              ltac:(vm_compute; discriminate) ltac:(rdok)
              vdrwb_li3 with "Hcg Hpc []").
    { iApply (rwi_040 with "Htext"). }
    iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
    ...
    { iLöb as "IH". rewrite /vdrw_p2_loop.
      ...
      iDestruct "Hbody" as "(%Hcmok & Hpub & Hlb & Hrd & Hstg & Hcl & Huidx & Hbun)".
      (* ---- the three-descriptor allocator ---- *)
      iApply (P1.wp_vdrw_alloc3 γd (proc_addr j) pd sp0 fr (trap_res eb + (K - 12))%nat M
      ...
      { (* ============ all three won: hand the seam to P3 ============ *)
        ...
        iApply ("Hexit" $! M1 np nr cm fr h m2 t with
                  "[%] [%] [%] Hcg Hown Htc Hclm Hpc Htok
                   [Hpub Hlb Hrd Hstg Hcl Huidx Hbun] Hbh Hbm Hbt Hidx").
        - split;
        ...
        - exact Hal.
        - rewrite /vdrw_body. iFrame "Hpub Hlb Hrd Hstg Hcl Huidx Hbun".
          iPureIntro. exact Hcmok. }
      ...
      iAssert ( ∀ (Mz : regfile),
                  ...
                  vdrw_p2_exit CID γk γs j γd pd pav pu K eb sp0 b wr sector m0 lks -∗
                  WP (Loop : expr riscv_lang))%I
        with "[Hpub Hlb Hrd Hstg Hcl Huidx IH]" as "Hsleep".
      { iIntros (Mz) "%Hcsz Hcg Hown Htc Hclm Hpc Htok Hbun Hscr Hexit".
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x098) : mword 64) Ra0 Ra0
                  (mword_of_int 2892 : mword 12) B1 (trap_res eb + (K - 12))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc []").
        { iApply (rwi_098 with "Htext"). }
        iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
        set (B2 := <[Regidx Ra0 := regval_into_reg
                      (add_vec (B1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 2892 : mword 12)))]> B1).
        change (<[Regidx Ra0 := regval_into_reg
                      (add_vec (B1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 2892 : mword 12)))]> B1) with B2.
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x09c) : mword 64) Rra
                  (mword_of_int 2082200 : mword 21) B2 (trap_res eb + (K - 12))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        { iApply (rwi_09c with "Htext"). }
        iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
        ...
        assert (Hjsp : add_vec (mword_of_int (KernelSyms.virtio_disk_rw + 0x09c) : mword 64)
                         (sign_extend' 64 (mword_of_int 2082200 : mword 21))
        ...
        iAssert (disk_res γd pd pav pu)
          with "[Hpub Hlb Hrd Hstg Hcl Huidx Hbun]" as "HR".
        { iApply (vdrw_body_close γd pd pav pu np nr cm fr).
          rewrite /vdrw_body.
          iFrame "Hpub Hlb Hrd Hstg Hcl Huidx Hbun".
          iPureIntro. exact Hcmok. }
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x0a4) : mword 64) Ra0 Ra0
                  (mword_of_int 3152 : mword 12) C1 (trap_res eb + (K - 12))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc []").
        { iApply (rwi_0a4 with "Htext"). }
        iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
        set (C2 := <[Regidx Ra0 := regval_into_reg
                      (add_vec (C1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 3152 : mword 12)))]> C1).
        change (<[Regidx Ra0 := regval_into_reg
                      (add_vec (C1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 3152 : mword 12)))]> C1) with C2.
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x0a8) : mword 64) Rra
                  (mword_of_int 2077402 : mword 21) C2 (trap_res eb + (K - 12))%nat false
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        { iApply (rwi_0a8 with "Htext"). }
        iApply wp_next_off_intro. iIntros "Hcg Hpc". rgall.
        ...
        assert (Hjrl : add_vec (mword_of_int (KernelSyms.virtio_disk_rw + 0x0a8) : mword 64)
                         (sign_extend' 64 (mword_of_int 2077402 : mword 21))
        ...
        iApply (Release.wp_release_sconf KT1 γk d_lock "virtio_disk"%string
                  (disk_res_at γd pd pav pu) C3 0%nat eb (proc_addr j) (K - 12)%nat
                  ({["virtio_disk"]} ∪ lks)
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x0ac) : mword 64) Rra
                  (mword_of_int 2082244 : mword 21) mfr (K - 12)%nat eb
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjsl : add_vec (mword_of_int (KernelSyms.virtio_disk_rw + 0x0ac) : mword 64)
                         (sign_extend' 64 (mword_of_int 2082244 : mword 21))
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x0b4) : mword 64) Ra0 Ra0
                  (mword_of_int 3136 : mword 12) D1 (K - 12)%nat eb
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc []").
        ...
        set (D2 := <[Regidx Ra0 := regval_into_reg
                      (add_vec (D1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 3136 : mword 12)))]> D1).
        change (<[Regidx Ra0 := regval_into_reg
                      (add_vec (D1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 3136 : mword 12)))]> D1) with D2.
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_rw + 0x0b8) : mword 64) Rra
                  (mword_of_int 2077250 : mword 21) D2 (K - 12)%nat eb
                  ltac:(vm_compute; discriminate) ltac:(rdok)
                  ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        assert (Hjaq : add_vec (mword_of_int (KernelSyms.virtio_disk_rw + 0x0b8) : mword 64)
                         (sign_extend' 64 (mword_of_int 2077250 : mword 21))
        ...
        iApply (Acquire.wp_acquire_sconf KT1 γk "virtio_disk"%string
                  (disk_res_at γd pd pav pu) D3 0%nat eb (proc_addr j) (K - 12)%nat eb lks
      ...
      - (* ---------------- s2 = 1: one descriptor to give back ------------ *)
        ...
        iApply (wp_vdrw_free_at (CID := CIDlp) γd γs pd h (fr_upd fr h false) M1 (trap_res eb + (K - 12))%nat
                  ...
                  ltac:(apply bv_eq; vm_compute; reflexivity)
                  ltac:(lkbelow)
                  with "Hcg Hown Htext Hpc Hpinv Hdp [] [] Hx0 Hbun Hbh").
        { iApply (rwi_07e with "Htext"). }
        { iApply (rwi_082 with "Htext"). }
        ...
        { intros r Hr. rewrite /F1 upd_ne;
            [| apply not_eq_sym, is_cs_idx_true_neq;
               [vm_compute; reflexivity | exact Hr]].
          exact (Hcs2 r Hr). }
        { iApply (free_bundles_ext γd pd (fr_upd (fr_upd fr h false) h true) fr).
      ...
      - (* ---------------- s2 = 2: two descriptors to give back ----------- *)
        ...
        iApply (wp_vdrw_free_at (CID := CIDlp) γd γs pd h
        ...
        iApply (wp_vdrw_free_at (CID := CIDlp) γd γs pd m2
                  ...
                  ltac:(apply bv_eq; vm_compute; reflexivity)
                  ltac:(lkbelow)
                  with "Hcg Hown Htext Hpc Hpinv Hdp [] [] Hx1 Hbun Hbm").
        { iApply (rwi_08c with "Htext"). }
        { iApply (rwi_090 with "Htext"). }

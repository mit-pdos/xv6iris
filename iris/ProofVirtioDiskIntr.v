...
Section VtPrologue.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_intr + 0x0e)) s1_idx s1_idx
              (mword_of_int 0xa82 : mword 12) A2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi0e [-]").
    iIntros (CID7 Hs7) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (A3 := <[Regidx s1_idx := regval_into_reg
        (add_vec (A2 !!! Regidx s1_idx) (sign_extend' 64 (mword_of_int 2690 : mword 12)))]> A2).
    change (<[Regidx s1_idx := regval_into_reg
        (add_vec (A2 !!! Regidx s1_idx) (sign_extend' 64 (mword_of_int 2690 : mword 12)))]> A2) with A3.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_intr + 0x16)) a0_idx a0_idx
              (mword_of_int 0xba2 : mword 12) A4 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi16 [-]").
    iIntros (CID9 Hs9) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (A5 := <[Regidx a0_idx := regval_into_reg
        (add_vec (A4 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 2978 : mword 12)))]> A4).
    change (<[Regidx a0_idx := regval_into_reg
        (add_vec (A4 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 2978 : mword 12)))]> A4) with A5.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_intr + 0x1a)) ra_idx (mword_of_int 2077142 : mword 21)
              A5 (av - 4)%nat b
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.virtio_disk_intr + 0x1a) : mword 64) (sign_extend' 64 (mword_of_int 2077142 : mword 21))
...
Section VtEpilogue.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.virtio_disk_intr + 0x8e)) a0_idx a0_idx
              (mword_of_int 0xb2a : mword 12) E0 (trap_res b + (av - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi8e [-]").
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    set (E1 := <[Regidx a0_idx := regval_into_reg
        (add_vec (E0 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 2858 : mword 12)))]> E0).
    change (<[Regidx a0_idx := regval_into_reg
        (add_vec (E0 !!! Regidx a0_idx) (sign_extend' 64 (mword_of_int 2858 : mword 12)))]> E0) with E1.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_intr + 0x92)) ra_idx (mword_of_int 2077158 : mword 21)
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.virtio_disk_intr + 0x92) : mword 64) (sign_extend' 64 (mword_of_int 2077158 : mword 21))
...
Section VtLoopProof.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.virtio_disk_intr + 0x6e)) ra_idx
              (mword_of_int 2082038 : mword 21) M3 (trap_res (match lvl with O => eb | S _ => false end) + (av - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi6e [-]").
    iApply wp_next_off_intro.
    ...
    assert (Hjwk : add_vec (mword_of_int (KernelSyms.virtio_disk_intr + 0x6e) : mword 64)
                     (sign_extend' 64 (mword_of_int 2082038 : mword 21))

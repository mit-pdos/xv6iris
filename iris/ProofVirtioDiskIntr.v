...
Section VtPrologue.
  ...
  Proof.
    ...
    iApply (Acquire.wp_acquire_sconf KT1 γk "virtio_disk"%string (λ ξ : CtxId, disk_res (XI := ξ) γd pd pav pu) A6
...
Section VtEpilogue.
  ...
  Proof.
    ...
    iApply (Release.wp_release_sconf KT1 γk d_lock "virtio_disk"%string (λ ξ : CtxId, disk_res (XI := ξ) γd pd pav pu) E2
...
Section VtBody.
  ...
  Proof.
    ...
    iApply (wp_vt_lw_used_elem γu γd pd pav pu (mword_of_int (KernelSyms.virtio_disk_intr + 0x4e))
              ...
              with "Hcg Hpc [] Hdinv Hgeom Hpub Hrcpt Hlbc").

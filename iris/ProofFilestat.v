...
Section ProofFilestat.
 ...
 (γf : gname)
  ...
  Proof using .
    ...
    iApply (wp_jal_s_sconf (mword_of_int (FST + 0x10)) Rra
              (mword_of_int 2086484 : mword 21) R4 (K - 10)%nat b
    ...
    assert (Htgtmp : add_vec (mword_of_int (FST + 0x10) : mword 64)
                       (sign_extend' 64 (mword_of_int 2086484 : mword 21))
    ...
    - (* =============== FD_INODE or FD_DEVICE: fall through =========== *)
      ...
      { destruct Hin as [Ht | Ht];
          ...
          | destruct (fdstate_ok_device _ _ _ _ _ _ Hok Ht) as (? & ? & ->) ]; done. }
 ...
 inm
      ...
      iApply (wp_jal_s_sconf (mword_of_int (FST + 0x4a)) Rra
                (mword_of_int 2085460 : mword 21) U5 (K - 10)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok)
                ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
      ...
      assert (Htgtco : add_vec (mword_of_int (FST + 0x4a) : mword 64)
                         (sign_extend' 64 (mword_of_int 2085460 : mword 21))

...
Section ProofFilestat.
  ...
  Local Lemma fst_env_in (fn : fstat_names) (st : fdstate) :
    match st with
    | FdOpen _ _ (FdInode _ _) | FdOpen _ _ (FdDevice _) => True
    | _ => False
 ...
 (γf : gname)
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (FST + 0x10)) Rra
              (mword_of_int 2086570 : mword 21) R4 (K - 10)%nat b
    ...
    assert (Htgtmp : add_vec (mword_of_int (FST + 0x10) : mword 64)
                       (sign_extend' 64 (mword_of_int 2086570 : mword 21))
 ...
 inm
      ...
      iApply (wp_jal_s_sconf (mword_of_int (FST + 0x4a)) Rra
                (mword_of_int 2085546 : mword 21) U5 (K - 10)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok)
                ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
      ...
      assert (Htgtco : add_vec (mword_of_int (FST + 0x4a) : mword 64)
                         (sign_extend' 64 (mword_of_int 2085546 : mword 21))

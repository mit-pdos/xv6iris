...
Section YieldPostSched.
  ...
  Proof.
    ...
    (* +0x1e: jal release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.yield + 0x1e)) (mword_of_int 1 : mword 5) (mword_of_int 2092312 : mword 21)
    ...
    assert (Hpcrl : add_vec (mword_of_int (KernelSyms.yield + 0x1e) : mword 64) (sign_extend' 64 (mword_of_int 2092312 : mword 21))
...
Section ProofYield.
  ...
  Proof.
    ...
    (* ------------------------------------------------------------------ *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.yield + 0x0a)) (mword_of_int 1 : mword 5) (mword_of_int 2095572 : mword 21)
              A1 (av - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hpcmp : add_vec (mword_of_int (KernelSyms.yield + 0x0a) : mword 64) (sign_extend' 64 (mword_of_int 2095572 : mword 21))
    ...
    (* +0x10: jal acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.yield + 0x10)) (mword_of_int 1 : mword 5) (mword_of_int 2092190 : mword 21)
              B0 (av - 4)%nat eb
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hpcaq : add_vec (mword_of_int (KernelSyms.yield + 0x10) : mword 64) (sign_extend' 64 (mword_of_int 2092190 : mword 21))

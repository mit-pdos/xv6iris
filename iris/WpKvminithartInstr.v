...
Section KvminithartInstrs.
  ...
  Proof. first [ decode_bridge_ms | intros Hbm Hcfg; destruct Hcfg as [[Hpriv _]|[Hpriv _]]; decode_any s Hpriv ]. Qed.
  Lemma kvidec_14 s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. intro H. rvc_oneshot s H. Qed.
  Lemma kvidec_1a s : eq_vec (_get_Misa_C (register_lookup misa s.(sregs))) ('b"1") = true ->
  ...
  Proof. mk_rvc (KernelSyms.kvminithart + 0x00)%Z (mword_of_int 0x1141 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx (mword_of_int 2), Regidx (mword_of_int 2), ADDI)) kvidec_00 exec_execute_C_ADDI. Qed.
  Lemma kvi_02 : KVI 0x02 true (STORE (csdsp_imm 1, Regidx (mword_of_int 1), sp, 8)).  (* sd ra,8(sp) *)
  Proof. mk_rvc (KernelSyms.kvminithart + 0x02)%Z (mword_of_int 0xe406 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x02) : mword 64) (STORE (csdsp_imm 1, Regidx (mword_of_int 1), sp, 8)) kvidec_02 exec_execute_C_SDSP. Qed.
  Lemma kvi_04 : KVI 0x04 true (STORE (csdsp_imm 0, Regidx (mword_of_int 8), sp, 8)).  (* sd s0,0(sp) *)
  Proof. mk_rvc (KernelSyms.kvminithart + 0x04)%Z (mword_of_int 0xe022 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x04) : mword 64) (STORE (csdsp_imm 0, Regidx (mword_of_int 8), sp, 8)) kvidec_04 exec_execute_C_SDSP. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminithart + 0x06)%Z (mword_of_int 0x0800 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x06) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) kvidec_06 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminithart + 0x14)%Z (mword_of_int 0x83b1 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x14) : mword 64) (SHIFTIOP (mword_of_int 12 : mword 6, creg2reg_idx (Cregidx (mword_of_int 7)), creg2reg_idx (Cregidx (mword_of_int 7)), SRLI)) kvidec_14 exec_execute_C_SRLI. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminithart + 0x1a)%Z (mword_of_int 0x8fd9 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x1a) : mword 64) (RTYPE (creg2reg_idx (Cregidx (mword_of_int 6)), creg2reg_idx (Cregidx (mword_of_int 7)), creg2reg_idx (Cregidx (mword_of_int 7)), OR)) kvidec_1a exec_execute_C_OR. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminithart + 0x24)%Z (mword_of_int 0x60a2 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x24) : mword 64) (LOAD (csdsp_imm 1, sp, Regidx (mword_of_int 1), false, 8)) kvidec_24 exec_execute_C_LDSP. Qed.
  Lemma kvi_26 : KVI 0x26 true (LOAD (csdsp_imm 0, sp, Regidx (mword_of_int 8), false, 8)).  (* ld s0,0(sp) *)
  Proof. mk_rvc (KernelSyms.kvminithart + 0x26)%Z (mword_of_int 0x6402 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x26) : mword 64) (LOAD (csdsp_imm 0, sp, Regidx (mword_of_int 8), false, 8)) kvidec_26 exec_execute_C_LDSP. Qed.
  ...
  Proof. mk_rvc (KernelSyms.kvminithart + 0x28)%Z (mword_of_int 0x0141 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x28) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx (mword_of_int 2), Regidx (mword_of_int 2), ADDI)) kvidec_28 exec_execute_C_ADDI. Qed.
  Lemma kvi_2a : KVI 0x2a true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).  (* ret *)
  Proof. mk_rvc (KernelSyms.kvminithart + 0x2a)%Z (mword_of_int 0x8082 : mword 16) (mword_of_int (KernelSyms.kvminithart + 0x2a) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) kvidec_2a exec_execute_C_JR. Qed.

 ...
 gilk gislk
                     ...
                     * (* ---- NAMEIPARENT stops one level early: +0x84 ---- *)
                       ...
                       iDestruct (inode_ref_gather_gen ik (iq/2)%Qp (iq/2)%Qp
                                    icfg_dev iinum gsh with "Hkeep Hshr") as "Href".
                       ...
                       { rewrite /inode_held_ty_at. iExists ik, iq, iinum, gsh.

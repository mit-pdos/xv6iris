...
Section PwRestore.
  ...
  Lemma pw_restore5 (Φ : mval -> iProp Σ) (pme : mword 64) (b : bool)
  ...
  Proof.
    ...
    iApply (wp_cldsp_s_sconf Φ p0 (mword_of_int 6 : mword 6) Rs6 M K (m !!! Regidx Rs6) b
    ...
    iApply (wp_cldsp_s_sconf Φ p1 (mword_of_int 5 : mword 6) Rs7 N1 K (m !!! Regidx Rs7) b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1 F9 [-]").
    ...
    iApply (wp_cldsp_s_sconf Φ p2 (mword_of_int 4 : mword 6) Rs8 N2 K (m !!! Regidx Rs8) b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iApply (wp_cldsp_s_sconf Φ p3 (mword_of_int 3 : mword 6) Rs9 N3 K (m !!! Regidx Rs9) b
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iApply (wp_cldsp_s_sconf Φ p4 (mword_of_int 2 : mword 6) Rs10 N4 K (m !!! Regidx Rs10) b
              ltac:(vm_compute; discriminate) ltac:(rdok)
...
Section PwGuard.
  ...
  Proof.
    ...
    iIntros "#Htext HF7 HF5 HCH Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv #Henv Hctx Hpark HEX HLP".
    ...
    - (* ==== i >= n : the copy is done, restore s6..s10 and take the tail ==== *)
      ...
      assert (Hal : eq_vec (access_vec_dec (add_vec (mword_of_int (PW + 0x7a) : mword 64)
        ...
        by (vm_compute; reflexivity).
      iApply (wp_bge_taken_s_sconf Φ (mword_of_int (PW + 0x7a)) (mword_of_int 84 : mword 13)
      ...
      iApply (pw_restore5 Φ (proc_addr j) false (mword_of_int (PW + 0xce)) (mword_of_int (PW + 0xd0))
      ...
      rewrite wp_next_off. iIntros (M') "%Hrst Hcg Hpc HF5".
      ...
      iApply ("TAIL" $! M' Pc with "[%] [%] [%] [%] HF7 [HF5 HCH] Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv Hctx Hpark").
    ...
    - (* ==== i < n : fall through into the body ==== *)
      ...
      assert (Hgf : zopz0zKzJ_s (M !!! Regidx Rs2) (M !!! Regidx Rs4) = false)
        by exact Hcmp.
      iApply (wp_bge_fall_s_sconf Φ (mword_of_int (PW + 0x7a)) (mword_of_int 84 : mword 13)
                Rs4 Rs2 M (av - 14)%nat false ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      iApply ("HLP" $! i M Pc with "[%] [%] [%] HF7 HF5 HCH Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv Henv Hctx Hpark HEX").
      + lia.
      + exact Hext.
      + exact Hregs.
  Qed.
...
Section ProofPipewrite.
  ...
  Proof.
    ...
    iIntros "Hcg Hown #Htext Hpc #Hpipe Href Hpriv #Henv #Hpinv #Hscheds #Hpanic Hctx Hpark Hcont".
    ...
    { rewrite /pw_epi. iIntros (CIDep Hsep M P') "%Hbr %Hrw %Hext (Hc1 & Hc2 & Hc3 & Hc4 & Hc5 & Hc6 & Hc7) Hhi Hcg Hown Hpc Href Hpriv Hctx Hpark".
      ...
      iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x58)) Ra0 Rs2 M (av - 14)%nat true
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x5a)) (mword_of_int 13 : mword 6) Rra
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x5c)) (mword_of_int 12 : mword 6) Rs0
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x5e)) (mword_of_int 11 : mword 6) Rs1
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x60)) (mword_of_int 10 : mword 6) Rs2
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x62)) (mword_of_int 9 : mword 6) Rs3
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x64)) (mword_of_int 8 : mword 6) Rs4
      ...
      iApply (wp_cldsp_s_sconf Φ (mword_of_int (PW + 0x66)) (mword_of_int 7 : mword 6) Rs5
      ...
      iApply (wp_caddi16sp_pop_s_sconf Φ (mword_of_int (PW + 0x68)) (mword_of_int 7 : mword 6)
      ...
      iApply (wp_cret_s_sconf Φ (mword_of_int (PW + 0x6a)) Rra E9 av true ltac:(nz)
                with "Hcg Hpc Hi6a [-]").
      ...
      iApply ("Hcont" $! E9 P' with "[%] [%] [%] Hcg Hown Hpc Href Hpriv Hctx Hpark").
      - exact HcsE9.
      - exact Hext.
    ...
    { rewrite /pw_exits. iSplit.
      - (* ---------------- +0xd8: wakeup(&pi->nread); release ---------------- *)
        ...
        iIntros (M P') "%Hbr %Hs1M %Hrw %Hext HF7 Hhi Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv Hctx Hpark".
        iPoseProof (pwi_d8 with "Htext") as "Hid8".
        iApply (wp_addi4_s_sconf Φ (mword_of_int (PW + 0xd8)) Ra0 Rs1
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0xdc)) Rra (mword_of_int 2087384 : mword 21)
        ...
        rewrite wp_next_off. iIntros (Mw) "[%Hwcs %Hwdom] Hcg Hown Htext2 Hpc". rgall.
        ...
        iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0xe0)) Ra0 Rs1 Mw (av - 14)%nat false
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0xe2)) Rra (mword_of_int 2082576 : mword 21)
        ...
        iApply (wp_cj_s_sconf Φ (mword_of_int (PW + 0xe6))
        ...
        iApply ("EPI" $! mr P' with "[%] [%] [%] HF7 Hhi Hcg Hown Hpc Href Hpriv Hctx Hpark").
      ...
      - (* ---------------- +0x46: release; i := -1; reload s6..s10 ---------------- *)
        ...
        iIntros (M P') "%Hmr %Hext HF7 HF5 HCH Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv Hctx Hpark".
        destruct Hmr as (Hsp & Hs1M & Hs11M).
        iPoseProof (pwi_46 with "Htext") as "Hi46".
        iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x46)) Ra0 Rs1 M (av - 14)%nat false
        ...
        iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0x48)) Rra (mword_of_int 2082730 : mword 21)
        ...
        iApply (wp_cli_s_sconf Φ (mword_of_int (PW + 0x4c)) Rs2 (mword_of_int 63 : mword 6)
        ...
        iApply (pw_restore5 Φ (proc_addr j) true (mword_of_int (PW + 0x4e)) (mword_of_int (PW + 0x50))
        ...
        iApply ("EPI" $! M' P' with "[%] [%] [%] HF7 [HF5 HCH] Hcg Hown Hpc Href Hpriv Hctx Hpark").
        + unfold pw_base_regs. split_and!; assumption.
        + rewrite Hs2'. by left.
        + exact Hext.
        + iApply (pw_stack7_of m sp0 with "HF5 HCH"). }
    ...
    iApply (wp_caddi16sp_push_s_sconf Φ pcE (mword_of_int 57 : mword 6) m av 14%nat true ltac:(lia) Hpush
              with "Hcg Hpc Hi00 [-]").
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x02)) (mword_of_int 13 : mword 6) Rra
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x04)) (mword_of_int 12 : mword 6) Rs0
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x06)) (mword_of_int 11 : mword 6) Rs1
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x08)) (mword_of_int 10 : mword 6) Rs2
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x0a)) (mword_of_int 9 : mword 6) Rs3
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x0c)) (mword_of_int 8 : mword 6) Rs4
    ...
    iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x0e)) (mword_of_int 7 : mword 6) Rs5
    ...
    iApply (wp_caddi4spn_s_sconf Φ (mword_of_int (PW + 0x10)) (Cregidx (mword_of_int 0))
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x12)) Rs1 Ra0 A1 (av - 14)%nat true
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x14)) Rs5 Ra1 A2 (av - 14)%nat true
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x16)) Rs4 Ra2 A3 (av - 14)%nat true
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0x18)) Rra (mword_of_int 2085966 : mword 21)
    ...
    iDestruct (cpu_own_transport CID CIDp30 0 true pj C true ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (Myproc.wp_myproc_sconf Φ A5 (av - 14)%nat 0%nat true pj C true
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x1c)) Rs3 Ra0 M0 (av - 14)%nat true
    ...
    iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x1e)) Ra0 Rs1 B1 (av - 14)%nat true
    ...
    iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0x20)) Rra (mword_of_int 2082634 : mword 21)
    ...
    iDestruct (cpu_own_transport CIDmp CIDp33 0 true pj C true ltac:(wp_next_chain)
                 with "Hown") as "Hown".
    iApply (AcquireGen.wp_acquire_gen_sconf Φ γl (pipe_res γp pi) (pipe_ref γp w q)
    ...
    - (* ======= n <= 0: i := 0 and go straight to the +0xd8 tail ======= *)
      ...
      assert (Hal0 : eq_vec (access_vec_dec (add_vec (mword_of_int (PW + 0x24) : mword 64)
        ...
        by (vm_compute; reflexivity).
      iApply (wp_bge_x0_taken_s_sconf Φ (mword_of_int (PW + 0x24)) (mword_of_int 196 : mword 13)
      ...
      iApply (wp_cli_s_sconf Φ (mword_of_int (PW + 0xe8)) Rs2 (mword_of_int 0 : mword 6)
      ...
      iApply ("TAIL" $! Z1 (pv_upt V) with "[%] [%] [%] [%] HF7 Hhi Hcg Hown Hpay Hlocked Hres Hpc Href [Hpriv] Hctx Hpark").
    ...
    - (* ======= n > 0: save s6..s10, set up the loop registers ======= *)
      ...
      iApply (wp_bge_x0_fall_s_sconf Φ (mword_of_int (PW + 0x24)) (mword_of_int 196 : mword 13)
      ...
      iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x28)) (mword_of_int 6 : mword 6) Rs6
                M1 (av - 14)%nat u8 false with "Hcg Hpc Hi28 G8 [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc G8". rgall.
      ...
      iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x2a)) (mword_of_int 5 : mword 6) Rs7
                M1 (av - 14)%nat u9 false with "Hcg Hpc Hi2a G9 [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc G9". rgall.
      ...
      iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x2c)) (mword_of_int 4 : mword 6) Rs8
                M1 (av - 14)%nat u10 false with "Hcg Hpc Hi2c G10 [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc G10". rgall.
      ...
      iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x2e)) (mword_of_int 3 : mword 6) Rs9
                M1 (av - 14)%nat u11 false with "Hcg Hpc Hi2e G11 [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc G11". rgall.
      ...
      iApply (wp_csdsp_s_sconf Φ (mword_of_int (PW + 0x30)) (mword_of_int 2 : mword 6) Rs10
                M1 (av - 14)%nat u12 false with "Hcg Hpc Hi30 G12 [-]").
      rewrite wp_next_off. iIntros "Hcg Hpc G12". rgall.
      ...
      iApply (wp_cli_s_sconf Φ (mword_of_int (PW + 0x32)) Rs2 (mword_of_int 0 : mword 6)
                (mword_of_int 0 : mword 64) M1 (av - 14)%nat false ltac:(nz) ltac:(rdok)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (PW + 0x34)) Rs8 Rs0
      ...
      iApply (wp_cli_s_sconf Φ (mword_of_int (PW + 0x38)) Rs7 (mword_of_int 1 : mword 6)
      ...
      iApply (wp_cli_s_sconf Φ (mword_of_int (PW + 0x3a)) Rs6 (mword_of_int 63 : mword 6)
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (PW + 0x3c)) Rs10 Rs1
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (PW + 0x40)) Rs9 Rs1
      ...
      { iLöb as "IH". rewrite /pw_loop.
        iIntros (CIDlp Hslp i M Pc) "%Hi %Hext %Hregs HF7 HF5 HCH Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv _ Hctx Hpark HEX".
        ...
        iApply (wp_lw_s_sconf Φ (mword_of_int (PW + 0x7e)) Ra5 Rs1 (mword_of_int 544 : mword 12)
                  M (av - 14)%nat ro false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi7e [Hro] [-]").
        { rgall. iEval (rewrite Hroaddr). iExact "Hro". }
        rewrite wp_next_off. iIntros "Hcg Hpc Hro". rgall.
        ...
        - (* ==== readopen == 0 : the -1 arm ==== *)
          ...
          assert (Halz : eq_vec (access_vec_dec (add_vec (mword_of_int (PW + 0x82) : mword 64)
            ...
            by (vm_compute; reflexivity).
          iApply (wp_cbeqz_taken_s_sconf Φ (mword_of_int (PW + 0x82)) (mword_of_int 226 : mword 8)
          ...
          iApply ("MIN" $! L1 Pc with "[%] [%] HF7 HF5 HCH Hcg Hown Hpay Hlocked [Hnm Hnr Hnw Hro Hwo Hst0 Hst1 Hdat Hslack] Hpc Href Hpriv Hctx Hpark").
        ...
        - (* ==== readopen /= 0 : ask killed() ==== *)
          iApply (wp_cbeqz_fall_s_sconf Φ (mword_of_int (PW + 0x82)) (mword_of_int 226 : mword 8)
                    (Cregidx (mword_of_int 7)) Ra5 L1 (av - 14)%nat false
          ...
          iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x84)) Ra0 Rs3 L1 (av - 14)%nat false
          ...
          iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0x86)) Rra (mword_of_int 2087966 : mword 21)
          ...
          rewrite wp_next_off. iIntros (K0 kl) "%Hkfacts Hcg Hown Hpc". rgall.
          ...
          + (* ==== killed: the -1 arm ==== *)
            ...
            assert (Halz : eq_vec (access_vec_dec (add_vec (mword_of_int (PW + 0x8a) : mword 64)
              ...
              by (vm_compute; reflexivity).
            iApply (wp_cbnez_taken_s_sconf Φ (mword_of_int (PW + 0x8a)) (mword_of_int 222 : mword 8)
            ...
            iDestruct "HEX" as "[_ MIN]". rewrite /pw_minus1.
            iSpecialize ("MIN" $! CIDlp with "[%]"); [wp_next_chain|].
            iApply ("MIN" $! K0 Pc with "[%] [%] HF7 HF5 HCH Hcg Hown Hpay Hlocked [Hnm Hnr Hnw Hro Hwo Hst0 Hst1 Hdat Hslack] Hpc Href Hpriv Hctx Hpark").
            * unfold pw_min_regs. split_and!; assumption.
            * exact Hext.
            * iApply (pw_res_intro γp pi nr nw ro wo vname bs Hcnt Hbslen
                        with "Hnm Hnr Hnw Hro Hwo Hst0 Hst1 Hdat Hslack").
          + (* ==== alive: read the counters ==== *)
            iApply (wp_cbnez_fall_s_sconf Φ (mword_of_int (PW + 0x8a)) (mword_of_int 222 : mword 8)
                      (Cregidx (mword_of_int 2)) Ra0 K0 (av - 14)%nat false
                      ltac:(vm_compute; reflexivity) ltac:(nz)
            ...
            iApply (wp_lw_s_sconf Φ (mword_of_int (PW + 0x8c)) Ra5 Rs1 (mword_of_int 536 : mword 12)
                      K0 (av - 14)%nat nr false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi8c [Hnr] [-]").
            { rgall. iEval (rewrite Hnraddr). iExact "Hnr". }
            rewrite wp_next_off. iIntros "Hcg Hpc Hnr". rgall.
            ...
            iApply (wp_lw_s_sconf Φ (mword_of_int (PW + 0x90)) Ra4 Rs1 (mword_of_int 540 : mword 12)
                      K1 (av - 14)%nat nw false ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi90 [Hnw] [-]").
            { rgall. iEval (rewrite Hnwaddr). iExact "Hnw". }
            rewrite wp_next_off. iIntros "Hcg Hpc Hnw". rgall.
            ...
            iApply (wp_addiw_s_sconf Φ (mword_of_int (PW + 0x94)) Ra5 Ra5
            ...
            * (* ======== FULL: wakeup(&nread); sleep(&nwrite, &lock) ======== *)
              assert (Half : eq_vec (access_vec_dec (add_vec (mword_of_int (PW + 0x98) : mword 64)
                ...
                by (vm_compute; reflexivity).
              iApply (wp_beq_taken_s_sconf Φ (mword_of_int (PW + 0x98)) (mword_of_int 8148 : mword 13)
              ...
              iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x6c)) Ra0 Rs10 K3 (av - 14)%nat false
              ...
              iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0x6e)) Rra (mword_of_int 2087494 : mword 21)
          ...
          by (rewrite rget_tp; apply mycpu_ret_nonzero; apply tp_ok_cid).
              ...
              iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x72)) Ra1 Rs1 Mw (av - 14)%nat false
              ...
              iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x74)) Ra0 Rs9 G1 (av - 14)%nat false
              ...
              iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0x76)) Rra (mword_of_int 2087410 : mword 21)
              ...
              iApply (SleepGen.wp_sleep_gen_sconf Φ γs j γlp γl pi (pipe_res γp pi)
                        ...
                        with "Hcg Hown Hpay Htext Hpc Hpinv Hscheds Hopen Href Hlocked Hres Hpanic Hctx Hpark [-]").
              iIntros (CIDsl Hssl Ms) "%Hscs Hcg Hown Hpay Hpc Href Hlocked Hres Hctx Hpark". rgall.
              ...
              iApply (pw_guard_step (CID := CIDsl) CID γa γf Φ γs j γl γp w q m av true C pid V n sp0 pi addr i Ms Pc
                        ...
                        with "Htext HF7 HF5 HCH Hcg Hown Hpay Hlocked Hres Hpc Href Hpriv Henv Hctx Hpark HEX IH").
            * (* ======== NOT full: copy one byte in ======== *)
              ...
              iApply (wp_beq_fall_s_sconf Φ (mword_of_int (PW + 0x98)) (mword_of_int 8148 : mword 13)
              ...
              iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0x9c)) Ra3 Rs7 K3 (av - 14)%nat false
              ...
              iApply (wp_add_s_sconf Φ (mword_of_int (PW + 0x9e)) Ra2 Rs2 Rs5
              ...
              iApply (wp_cmv_s_sconf Φ (mword_of_int (PW + 0xa2)) Ra1 Rs8 N2 (av - 14)%nat false
              ...
              iApply (wp_jal_s_sconf Φ (mword_of_int (PW + 0xa8)) Rra (mword_of_int 2085276 : mword 21)
              ...
              iApply (Copyin.wp_copyin_sconf γa Φ N5 Pc (pv_sz V) 1%nat (fun _ : nat => b0)
              ...
              rewrite wp_next_off. iIntros (mr P' dst_new) "Hcg Hown Hpc Hszc Hptc Hpt Hbuf %Hcsr %Hextr %Hret". rgall.
              ...
              ** (* ==== copyin failed: break, returning the current i ==== *)
                 assert (Half : eq_vec (access_vec_dec (add_vec (mword_of_int (PW + 0xac) : mword 64)
                   ...
                   by (vm_compute; reflexivity).
                 iApply (wp_beq_taken_s_sconf Φ (mword_of_int (PW + 0xac)) (mword_of_int 64 : mword 13)
                 ...
                 iApply (pw_restore5 Φ (proc_addr j) false (mword_of_int (PW + 0xec)) (mword_of_int (PW + 0xee))
                 ...
                 iApply ("TAIL" $! M' P' with "[%] [%] [%] [%] HF7 [HF5 HCH] Hcg Hown Hpay Hlocked [Hnm Hnr Hnw Hro Hwo Hst0 Hst1 Hdat Hslack] Hpc Href Hpriv Hctx Hpark").
                 --- unfold pw_base_regs. split_and!; assumption.
                 --- exact Hs1'.
                 --- rewrite Hs2'. right. exists i. split; [reflexivity | lia].
                 --- exact Hext'.
              ...
              ** (* ==== copyin succeeded: nwrite++, store the byte, i++ ==== *)
                 iApply (wp_beq_fall_s_sconf Φ (mword_of_int (PW + 0xac)) (mword_of_int 64 : mword 13)
                 ...
                 iApply (wp_lw_s_sconf Φ (mword_of_int (PW + 0xb0)) Ra5 Rs1 (mword_of_int 540 : mword 12)
                 ...
                 iApply (wp_addiw_s_sconf Φ (mword_of_int (PW + 0xb4)) Ra4 Ra5
                 ...
                 iApply (wp_sw_s_sconf Φ (mword_of_int (PW + 0xb8)) Ra4 Rs1
                 ...
                 iApply (wp_andi_s_sconf Φ (mword_of_int (PW + 0xbc)) Ra5 Ra5
                 ...
                 iApply (wp_cadd_s_sconf Φ (mword_of_int (PW + 0xc0)) Ra5 Rs1 P3 (av - 14)%nat false
                 ...
                 iApply (wp_sb_s_sconf Φ (mword_of_int (PW + 0xc6)) Ra4 Ra5
                 ...
                 iApply (wp_caddiw_s_sconf Φ (mword_of_int (PW + 0xca)) Rs2 (mword_of_int 1 : mword 6)
                 ...
                 iApply (wp_cj_s_sconf Φ (mword_of_int (PW + 0xcc))
      ...
      iApply (wp_cj_s_sconf Φ (mword_of_int (PW + 0x44))
      ...
      iApply ("LOOP" $! 0%Z C6 (pv_upt V) with "[%] [%] [%] HF7 HF5 HCH Hcg Hown Hpay Hlocked Hres Hpc Href [Hpriv] Henv Hctx Hpark EXITS").
      + lia.
      + apply uptd_ext_refl.
      + exact HregsC6.
      + rewrite pw_upd_upt_id. iExact "Hpriv".

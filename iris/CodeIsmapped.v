(* CodeIsmapped.v -- decode templates + [instr] facts for ismapped()'s
...
Section CodeIsmapped.
  ...
  Local Notation IMP off rvc ast :=
    (kernel_text -∗ instr (mword_of_int (KernelSyms.ismapped + off) : mword 64) rvc ast).
  ...
  Proof. mk_rvc (KernelSyms.ismapped + 0x00)%Z (mword_of_int 0x1141 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x00) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 48 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_1141 exec_execute_C_ADDI. Qed.

  Lemma imi_02 : IMP 0x02 true (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)).
  Proof. mk_rvc (KernelSyms.ismapped + 0x02)%Z (mword_of_int 0xe406 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x02) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), Regidx (mword_of_int 1), sp, 8)) cdec_e406 exec_execute_C_SDSP. Qed.

  Lemma imi_04 : IMP 0x04 true (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)).
  Proof. mk_rvc (KernelSyms.ismapped + 0x04)%Z (mword_of_int 0xe022 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x04) : mword 64) (STORE (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), Regidx (mword_of_int 8), sp, 8)) cdec_e022 exec_execute_C_SDSP. Qed.

  Lemma imi_06 : IMP 0x06 true (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)).
  Proof. mk_rvc (KernelSyms.ismapped + 0x06)%Z (mword_of_int 0x0800 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x06) : mword 64) (ITYPE (caddi4spn_imm (mword_of_int 4 : mword 8), sp, creg2reg_idx (Cregidx (mword_of_int 0)), ADDI)) cdec_0800 exec_execute_C_ADDI4SPN. Qed.
  ...
  Proof. mk_rvc (KernelSyms.ismapped + 0x08)%Z (mword_of_int 0x4601 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x08) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 0 : mword 6), zreg, Regidx (mword_of_int 12), ADDI)) cdec_4601 exec_execute_C_LI. Qed.

  (* ---- +0x0a: jal walk ---- *)
  Lemma imi_0a : IMP 0x0a false (JAL (mword_of_int 2095566 : mword 21, Regidx (mword_of_int 1))).
  Proof. mk_base (KernelSyms.ismapped + 0x0a)%Z (mword_of_int 0x9cfff0ef : mword 32) (mword_of_int (KernelSyms.ismapped + 0x0a) : mword 64) (JAL (mword_of_int 2095566 : mword 21, Regidx (mword_of_int 1))) imdb_jal_walk. Qed.
  ...
  Proof. mk_rvc (KernelSyms.ismapped + 0x0e)%Z (mword_of_int 0xc119 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x0e) : mword 64) (BTYPE (sign_extend' 13 (concat_vec (mword_of_int 3 : mword 8) ('b"0")), zreg, creg2reg_idx (Cregidx (mword_of_int 2)), BEQ)) cdec_c119 exec_execute_C_BEQZ. Qed.
  ...
  Proof. mk_rvc (KernelSyms.ismapped + 0x10)%Z (mword_of_int 0x6108 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x10) : mword 64) (LOAD (mword_of_int 0 : mword 12, Regidx (mword_of_int 10), Regidx (mword_of_int 10), false, 8)) imdc_6108 imexec_ld0_a0a0. Qed.
  ...
  Proof. mk_rvc (KernelSyms.ismapped + 0x12)%Z (mword_of_int 0x8905 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x12) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 1 : mword 6), Regidx (mword_of_int 10), Regidx (mword_of_int 10), ANDI)) imdc_8905 imexec_andi1_a0. Qed.
  ...
  Proof. mk_rvc (KernelSyms.ismapped + 0x14)%Z (mword_of_int 0x60a2 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x14) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 1 : mword 6) ('b"000")), sp, Regidx (mword_of_int 1), false, 8)) cdec_60a2 exec_execute_C_LDSP. Qed.

  Lemma imi_16 : IMP 0x16 true (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)).
  Proof. mk_rvc (KernelSyms.ismapped + 0x16)%Z (mword_of_int 0x6402 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x16) : mword 64) (LOAD (zero_extend' 12 (concat_vec (mword_of_int 0 : mword 6) ('b"000")), sp, Regidx (mword_of_int 8), false, 8)) cdec_6402 exec_execute_C_LDSP. Qed.

  Lemma imi_18 : IMP 0x18 true (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)).
  Proof. mk_rvc (KernelSyms.ismapped + 0x18)%Z (mword_of_int 0x0141 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x18) : mword 64) (ITYPE (sign_extend' 12 (mword_of_int 16 : mword 6), Regidx csp_rs1, Regidx csp_rs1, ADDI)) cdec_0141 exec_execute_C_ADDI. Qed.

  Lemma imi_1a : IMP 0x1a true (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)).
  Proof. mk_rvc (KernelSyms.ismapped + 0x1a)%Z (mword_of_int 0x8082 : mword 16) (mword_of_int (KernelSyms.ismapped + 0x1a) : mword 64) (JALR (zeros' 12, Regidx (mword_of_int 1), zreg)) cdec_8082 exec_execute_C_JR. Qed.

(* UCodeSync.v -- the CODE CATALOG of the user program [sync].
   ...
   regenerates and then FAILS if anything moved.  This file alone is
     ...
     tools/gen_ucode.py --module Sync --spec tools/ucode_sync.txt --out \
         iris/UCodeSync.v
   ...
   Two premises carry every [uinstr] lemma:
     ...
     [sync_text_layout pt]
                       -- the pure page-table fact: each of the 1 page(s) of
                          ...
                          (USync*.v / UkSync*.v), which is also where a predicate
...
(* [UserHeap.uinstr_is] is the SEPARATION-LOGIC instruction resource: the
   ...
   each byte of the window is a concrete [sync_bytes] lookup transported by
   [sync_text_sub]; and the X-and-not-W verdict for the window's addresses

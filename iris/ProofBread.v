...
Section BreadBlocks.
    ...
    - (* ======== refcnt <> 0: advance to b->prev ======== *)
      ...
      + (* ---- the prefix is exhausted: fall through to panic ---- *)
        ...
        assert (Ha0msg : Q3 !!! Regidx Ra0 = (mword_of_int bd_msg_a : mword 64))
          by (apply bv_eq; vm_compute; reflexivity).
        iApply (PN.wp_panic_sconf Q3 (trap_res eb + (K - 6))%nat
  ...
  Proof.
    ...
    iApply (wp_ld_s_sconf (mword_of_int (KernelSyms.bread + 0x68)) Rs1 Rs1 (mword_of_int 2302 : mword 12)
...
Section ProofBread.
  ...
  Proof.
    ...
    iAssert (bd_cont (CID0 := CID)  j bn V pidv dev bno dq m K eb pj lks)
      with "[Hcont]" as "Hcont".
    ...
    iApply (wp_ld_s_sconf (mword_of_int (KernelSyms.bread + 0x22)) Rs1 Rs1 (mword_of_int 2380 : mword 12)

...
Section BreadDefs.
  ...
  Definition bd_cont `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (m : regfile) (K : nat) (eb : bool) (pj : mword 64) (lks : gset string) (Vpr : pprivate)
      : iProp Σ :=
  ...
  Lemma bd_cont_shift `{GEN : GenId} `{CIDa : CpuId} `{CIDb : CpuId} `{XI : CurCtx}
    ...
    bd_cont (CID0 := CIDa)  j bn V pidv dev bno dq m K eb pj lks Vpr -∗
    bd_cont (CID0 := CIDb)  j bn V pidv dev bno dq m K eb pj lks Vpr.
  Proof.
...
Section BreadBlocks.
  ...
  Local Lemma bread_epi `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (bs_out bsd : list (bv 8)) (d : bool) (lks : gset string) (Vpr : pprivate) :
    (K_bread <= K)%nat ->
    bd_regs m M ->
  ...
  Local Lemma bread_tail `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (pd pav pu : mword 64)
      (bn : bio_names) (V : bio_view Σ) (k : nat) (t Kt : nat)
      (pidv dev bno : mword 32) (dq : dfrac)
  ...
  Proof.
    ...
    iIntros "#Hdev #Hgeom #Hdlock Hstok Hslp #Hflt Hbr0 Href Hcont".
    ...
    iApply fupd_wp.
    iDestruct (bslp_unfold with "Hslp") as "[Hbown Hs]".
    ...
    iApply (wp_lw_au_s_sconf (dqm := DfracOwn 1) true
              ...
              ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(solve_ndisj)
              with "Hcg Hpc [] [] [Hvld Hbdev Hbuf Hpay]").
    { iApply (bdi_b4 with "Htext"). }
    ...
    - (* ============ b->valid = 1: straight to the epilogue ============ *)
      ...
      iDestruct (bd_cont_shift (CIDa := CID0) (CIDb := CIDv2)  j bn V pidv dev bno dq
                   m K eb (proc_addr j) lks Vpr ltac:(wp_next_chain) with "Hcont") as "Hcont".
      iApply (bread_epi (CID0 := CIDv2)  j bn V k pidv dev bno dq m T1 K eb
                bs bsd d lks Vpr HK HT1regs HT1s1
    ...
    - (* ============ b->valid = 0: the disk read ============ *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0xcc)) Rra (mword_of_int 11398 : mword 21)
      ...
      assert (Htgtrw : add_vec (mword_of_int (KernelSyms.bread + 0xcc) : mword 64)
                         (sign_extend' 64 (mword_of_int 11398 : mword 21))
      ...
      iApply (bread_epi (CID0 := CIDt8)  j bn V k pidv dev bno dq m T5 K eb
                bsl bsl false lks Vpr HK HT5regs HT5s1
                with "Hcg Htext Hpc Hframe Hcnt Hextc Hextm Hppid
                      [Hstok Hvld Hbdev Hbuf Hdb Hpy] Hcont").
      rewrite /bio_locked /bio_held /bpa.
      iSplitR; [by iPureIntro|].
  ...
  Local Lemma bread_hit `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (Mg : gmap nat (option Qp * positive)) (ord : list nat) (devs bnos : nat -> mword 32) (tl : nat)
      (pidv dev bno : mword 32) (dq : dfrac)
      (m M : regfile) (K : nat) (eb : bool) (lks : gset string) (Vpr : pprivate) :
    (K_bread <= K)%nat ->
    (uint bno < 2147483648)%Z ->
  ...
  Proof.
    ...
    iIntros "Hcg #Htext Hpc #Hbio Hframe Hcnt Hpay Hextc Hextm Htok #Hfl #Hllbtl Hscan Hbslot".
    ...
    iDestruct (bcache_scan2_incr0 bn V Mg ord devs bnos tl k ⊤ ltac:(solve_ndisj) Hk
                 with "Hbox Hfl Hllbtl Hscan Hbslot")
      as (cw) "[Hcell Hclose]".
    (* ---- +0x48 c.lw a5,64(s1) ---- *)
    ...
    iApply fupd_wp.
    iMod ("Hclose" with "Hcell") as "[HRres Hch]".
    iEval (rewrite Hdevs Hbnos) in "Hch".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x52)) Ra0 Ra0 (mword_of_int 1604 : mword 12)
              H3 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (bdi_52 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (H4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (H3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1604 : mword 12)))]> H3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x56)) Rra (mword_of_int 2089086 : mword 21)
              H4 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
    { iApply (bdi_56 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.bread + 0x56) : mword 64)
                        (sign_extend' 64 (mword_of_int 2089086 : mword 21))
    ...
    iApply (R.wp_release_sconf KT1 (bn_lk bn) bcache_addr "bcache"%string (fun ξ => bcache_res2 bn V ξ) H5
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x5e)) Rra (mword_of_int 5056 : mword 21)
    ...
    assert (Htgtasl : add_vec (mword_of_int (KernelSyms.bread + 0x5e) : mword 64)
                        (sign_extend' 64 (mword_of_int 5056 : mword 21))
    ...
    (* ENDGAME R1 at the checkout's acquire: [Tl := t], the chain's stamp *)
    iApply (ASL.wp_acquiresleep_genl_llb_sconf γs j (fst (bn_slk bn k)) (snd (bn_slk bn k))
              "buffer"%string (bslp bn k) SleepLock.sl_untracked 1%Qp H7 pidv Vpr (K - 6)%nat eb eb lks t
              Hj ltac:(lia)
              ltac:(lkbelow)
              with "Hcg Hcnt Hextc Hextm Htext Hpc [] Hllbt [] Hppid Hprocs").
    all: try lkbelow.
    ...
    iDestruct (bd_cont_shift (CIDa := CID0) (CIDb := CIDh3)  j bn V pidv dev bno dq
                 m K eb (proc_addr j) lks Vpr ltac:(wp_next_chain) with "Hcont") as "Hcont".
    iApply (bread_tail (CID0 := CIDh3)  γs j γl γu γd γk pd pav pu bn V k t Kt pidv dev bno dq
              m mf K eb lks Vpr HK Hbno Hk Hgd Hcov Hdv Hj Hgl Hmfregs Hmfs1 HKt
              with "Hcg Htext Hpc Hbox Hframe Hcnt Hextc Hextm Hprocs Hppid
                    Hdev Hgeom Hdlock Hstok Hslp Hflt Hbr0 Href Hcont").
  Qed.
  ...
  Proof.
    ...
    (* the recycle ghost step (box lemma (a) under L1): the header comes out
       of the box FULL at the slot's identity; the three stores below are
       plain stores on cells in hand; the closing wand re-deposits at the new
    ...
    iMod (bcache_scan2_recycle bn V Mg ord devs bnos tl k dev bno ⊤ ltac:(solve_ndisj)
      ...
      as "(Hrun & Hcell & Hvld & Hdev & Hbno & Hclose)".
    iDestruct ("Hcgb" with "Hrun") as "Hcg".
    iDestruct "Hvld" as (vld0) "Hvld".
    iModIntro.
    (* ---- +0x90 sw s2,8(s1) : b->dev = dev ---- *)
    iEval (rewrite -Hadev) in "Hdev".
    iApply (wp_sw_s_sconf (mword_of_int (KernelSyms.bread + 0x90)) Rs2 Rs1
              (mword_of_int 8 : mword 12) M (trap_res eb + (K - 6))%nat (devs k) false
              with "Hcg Hpc [] Hdev").
    { iApply (bdi_90 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc Hdev".
    iEval (rewrite Hadev Hsvdev) in "Hdev".
    ...
    iEval (rewrite -Habno) in "Hbno".
    iApply (wp_sw_s_sconf (mword_of_int (KernelSyms.bread + 0x94)) Rs3 Rs1
              (mword_of_int 12 : mword 12) M (trap_res eb + (K - 6))%nat (bnos k) false
              with "Hcg Hpc [] Hbno").
    { iApply (bdi_94 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc Hbno".
    iEval (rewrite Habno Hsvbno) in "Hbno".
    ...
    iEval (rewrite -Hava) in "Hvld".
    iApply (wp_sw_s_sconf (mword_of_int (KernelSyms.bread + 0x98)) Rz Rs1
              (mword_of_int 0 : mword 12) M (trap_res eb + (K - 6))%nat vld0 false
              with "Hcg Hpc [] Hvld").
    { iApply (bdi_98 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc Hvld".
    iEval (rewrite Hava Hsvz) in "Hvld".
    ...
    iApply fupd_wp.
    iDestruct (SieCapCtx.sie_cap_gpr_own_ctx_acc with "Hcg") as "[Hrun Hcgb]".
    iMod ("Hclose" with "Hrun Hcell Hvld Hdev Hbno") as "(Hrun & Hafter & Hch)".
    iDestruct ("Hcgb" with "Hrun") as "Hcg".
    iDestruct "Hch" as "[Hbr0 Hgh]". iDestruct "Hgh" as (t) "Href".
    iDestruct (bd_ref_llb with "Href") as "[Href #Hllbt]".
    iModIntro.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0xa4)) Ra0 Ra0 (mword_of_int 1522 : mword 12)
              C2 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (bdi_a4 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (C3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (C2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1522 : mword 12)))]> C2).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0xa8)) Rra (mword_of_int 2089004 : mword 21)
              C3 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
    { iApply (bdi_a8 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.bread + 0xa8) : mword 64)
                        (sign_extend' 64 (mword_of_int 2089004 : mword 21))
                      = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtrel) in "Hpc".
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0xb0)) Rra (mword_of_int 4974 : mword 21)
    ...
    assert (Htgtasl : add_vec (mword_of_int (KernelSyms.bread + 0xb0) : mword 64)
                        (sign_extend' 64 (mword_of_int 4974 : mword 21))
                      = mword_of_int KernelSyms.acquiresleep)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtasl) in "Hpc".
    ...
    (* ENDGAME R1 at the checkout's acquire: [Tl := t], the chain's stamp *)
    iApply (ASL.wp_acquiresleep_genl_llb_sconf γs j (fst (bn_slk bn k)) (snd (bn_slk bn k))
              "buffer"%string (bslp bn k) SleepLock.sl_untracked 1%Qp C6 pidv Vpr (K - 6)%nat eb eb lks t
              Hj ltac:(lia)
              ltac:(lkbelow)
              with "Hcg Hcnt Hextc Hextm Htext Hpc [] Hllbt [] Hppid Hprocs").
    all: try lkbelow.
    ...
    iDestruct (bd_cont_shift (CIDa := CID0) (CIDb := CIDs)  j bn V pidv dev bno dq
                 m K eb (proc_addr j) lks Vpr ltac:(wp_next_chain) with "Hcont") as "Hcont".
    iApply (bread_tail (CID0 := CIDs)  γs j γl γu γd γk pd pav pu bn V k t Kt pidv dev bno dq
              m mf K eb lks Vpr HK Hbno Hk Hgd Hcov Hdv Hj Hgl Hmfregs Hmfs1 HKt
              with "Hcg Htext Hpc Hbox Hframe Hcnt Hextc Hextm Hprocs Hppid
                    Hdev Hgeom Hdlock Hstok Hslp Hflt Hbr0 Href Hcont").
  Qed.
  ...
  Local Lemma bread_bloop `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (n : nat) (lks : gset string) (Vpr : pprivate) :
    (K_bread <= K)%nat ->
    (uint bno < 2147483648)%Z ->
    m !!! Regidx Ra0 = sign_extend' 64 dev ->
    m !!! Regidx Ra1 = sign_extend' 64 bno ->
  ...
  Proof.
    ...
    iIntros "Hcg #Htext #Hkd Hpc #Hpenv #Hbio Hframe Hcnt Hpay Hextc Hextm Htok #Hfl #Hllbtl Hscan Hbslot".
    iIntros "#Hprocs Hppid #Hdev #Hgeom #Hdlock Hcont".
    ...
    iDestruct (bio_slots_acc2 bn V Mg devs bnos tl kk Hkk with "Hslots") as "[Hslot Hback]".
    iDestruct (bio_slot_refcnt_acc2 bn V Mg kk (devs kk) (bnos kk) tl with "Hslot")
    ...
    - (* ======== refcnt == 0: this buffer is free, RECYCLE it ======== *)
      ...
      iAssert (bcache_scan2 bn V Mg ord devs bnos tl cur_ctx)
      ...
      iApply (bread_recyc (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V kk Mg ord devs bnos tl
                pidv dev bno dq m B1 K eb lks Vpr
                HK Hbno Hkk HMkNone Hgd Hcov Hdv Htie Ha0 Ha1 Hj Hgl HB1regs HB1s1 Hbelow
                with "Hcg Htext Hpc Hbio Hframe Hcnt Hpay Hextc Hextm Htok Hfl Hllbtl Hscan Hbslot
    ...
    - (* ======== refcnt <> 0: advance to b->prev ======== *)
      ...
      + (* ---- the prefix is exhausted: fall through to panic ---- *)
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x88)) Ra0 Ra0 (mword_of_int 1998 : mword 12)
                  Q1 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                  with "Hcg Hpc []").
        { iApply (bdi_88 with "Htext"). }
        iApply wp_next_off_intro.
        iIntros "Hcg Hpc".
        iEval (rgne) in "Hcg".
        set (Q2 := <[Regidx Ra0 := regval_into_reg
                      (add_vec (Q1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 1998 : mword 12)))]> Q1).
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x8c)) Rra (mword_of_int 2087962 : mword 21)
                  Q2 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                  ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
        { iApply (bdi_8c with "Htext"). }
        iApply wp_next_off_intro.
        iIntros "Hcg Hpc".
        assert (Htgtpanic : add_vec (mword_of_int (KernelSyms.bread + 0x8c) : mword 64)
                              (sign_extend' 64 (mword_of_int 2087962 : mword 21))
      ...
      + (* ---- the prefix still has a node: take the back edge ---- *)
        ...
        iApply (IH d (kk :: post) B2 Hlen' Hord2 Hdne HB2regs HB2s1 HB2a4
                  with "Hcg Htext Hkd Hpc Hpenv Hbio Hframe Hcnt Hpay Hextc Hextm Htok Hfl Hllbtl Hscan Hbslot
                        Hprocs Hppid Hdev Hgeom Hdlock Hcont").
  Qed.
  ...
  Proof.
    ...
    assert (Hhp : add_vec (rget Q1 Rs1) (sign_extend' 64 (mword_of_int 2270 : mword 12))
                  = bprev bhead).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x70)) Ra5 Ra5 (mword_of_int 2190 : mword 12)
              Q3 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (bdi_70 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (Q4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (Q3 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2190 : mword 12)))]> Q3).
    ...
    iApply (bread_bloop (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V Mg ord devs bnos tl
              pidv dev bno dq m K eb (length ord) lks Vpr
  ...
  Proof.
    ...
    { iIntros (Mx (Hxregs & Hxs1 & Hxa4 & Hxne)).
      iIntros "Hcg Hpc Hframe Hcnt Hpay Hextc Hextm Htok #Hfl #Hllbtl Hscan Hbslot Hppid Hcont".
      ...
      + (* the scan has wrapped: on to the backward scan *)
        ...
        iApply (bread_miss (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V Mg ord devs bnos tl
                  pidv dev bno dq m G1 K eb lks Vpr
    ...
    iDestruct "Hscan" as
      "(Hauth & Hsauth & %Hdom & %Hordp2 & %Hinj & %Hdevpin & Hlru & Hpool & Hslots)".
    iDestruct (bio_slots_acc2 bn V Mg devs bnos tl kk Hkk with "Hslots") as "[Hslot Hback]".
    iDestruct (bio_slot_devbno_acc2 bn V Mg kk (devs kk) (bnos kk) tl with "Hslot")
    ...
    - (* ---- dev matches: test the block number ---- *)
      ...
      + (* ======== THE HIT ======== *)
        ...
        iApply (wp_bne_fall_s_sconf (mword_of_int (KernelSyms.bread + 0x44)) (mword_of_int 8178 : mword 13)
                  ...
                  with "Hcg Hpc []").
        { iApply (bdi_44 with "Htext"). }
        iApply wp_next_off_intro.
        iIntros "Hcg Hpc".
        assert (Hpp48 : add_vec_int (mword_of_int (KernelSyms.bread + 0x44) : mword 64) 4 = mword_of_int (KernelSyms.bread + 0x48))
          by (apply bv_eq; vm_compute; reflexivity).
        iEval (rewrite Hpp48) in "Hpc".
        iApply (bread_hit (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V kk Mg ord devs bnos tl
                  pidv dev bno dq m F2 K eb lks Vpr
      ...
      + (* blockno mismatch: advance *)
        ...
        iApply ("HADV" $! F2 with "[%] Hcg Hpc Hframe Hcnt Hpay Hextc Hextm Htok Hfl Hllbtl Hscan Hbslot Hppid Hcont").
    ...
    - (* ---- dev mismatch: advance ---- *)
      ...
      { rewrite /bcache_scan2. iFrame "Hauth Hsauth".
        ...
        iSplitR; [iPureIntro; exact Hdevpin|].
        iFrame "Hlru Hpool Hslots". }
      iApply ("HADV" $! F1 with "[%] Hcg Hpc Hframe Hcnt Hpay Hextc Hextm Htok Hfl Hllbtl Hscan Hbslot Hppid Hcont").
...
Section ProofBread.
  ...
  Proof.
    ...
    iAssert (bd_cont (CID0 := CID)  j bn V pidv dev bno dq m K eb pj lks Vpr)
      with "[Hcont]" as "Hcont".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x16)) Ra0 Ra0 (mword_of_int 1664 : mword 12)
    ...
    set (R6 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1664 : mword 12)))]> R5).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x1a)) Rra (mword_of_int 2089010 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.bread + 0x1a) : mword 64)
                        (sign_extend' 64 (mword_of_int 2089010 : mword 21))
    ...
    iDestruct (cpu_own_transport CID CID12 0%nat eb pj eb ltac:(wp_next_chain)
                 with "Hcnt") as "Hcnt".
    iApply (A.wp_acquire_sconf KT1 (bn_lk bn) "bcache"%string (fun ξ => bcache_res2 bn V ξ) R7
    ...
    iDestruct (bd_cont_shift (CIDa := CID) (CIDb := CIDq)  j bn V pidv dev bno dq
                 m K eb pj lks Vpr ltac:(wp_next_chain) with "Hcont") as "Hcont".
    ...
    assert (Hhn : add_vec (rget W1 Rs1) (sign_extend' 64 (mword_of_int 2348 : mword 12))
                  = bnext bhead).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x2a)) Ra5 Ra5 (mword_of_int 2260 : mword 12)
              W3 (trap_res eb + (K - 6))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (bdi_2a with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (W4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (W3 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2260 : mword 12)))]> W3).
    ...
    iApply (bread_floop (CID0 := CIDq)  γs j γl γu γd γk pd pav pu bn V Mg ord devs bnos tl
              pidv dev bno dq m K eb (length ord) lks
              Vpr HK Hbno Ha0 Ha1 Hj Hgl Hgd Hcov Hdv Hordp Hbelow [] ord W5

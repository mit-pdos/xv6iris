...
(* ===================================================================== *)
Definition bd_msg_a : Z := 0x800073b0.
...
Section BreadBlocks.
  ...
  Local Lemma bread_epi `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (bs_out bsd : list (bv 8)) (d : bool) (lks : gset string) (Upr : ustate) :
    (K_bread <= K)%nat ->
    bd_regs m M ->
  ...
  Proof.
    ...
    - (* ============ b->valid = 1: straight to the epilogue ============ *)
      ...
      iDestruct (bd_cont_shift (CIDa := CID0) (CIDb := CIDv2)  j bn V pidv dev bno dq
                   m K eb (proc_addr j) lks Upr ltac:(wp_next_chain) with "Hcont") as "Hcont".
      iApply (bread_epi (CID0 := CIDv2)  j bn V k pidv dev bno dq m T1 K eb
                bs bsd d lks Upr HK HT1regs HT1s1
    ...
    - (* ============ b->valid = 0: the disk read ============ *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0xcc)) Rra (mword_of_int 11392 : mword 21)
      ...
      assert (Htgtrw : add_vec (mword_of_int (KernelSyms.bread + 0xcc) : mword 64)
                         (sign_extend' 64 (mword_of_int 11392 : mword 21))
      ...
      iApply (bread_epi (CID0 := CIDt8)  j bn V k pidv dev bno dq m T5 K eb
                bsl bsl false lks Upr HK HT5regs HT5s1
                with "Hcg Htext Hpc Hframe Hcnt Hextc Hextm Hppid
                      [Hstok Hvld Hbdev Hbuf Hdb Hpy] Hcont").
      rewrite /bio_locked /bio_held /bpa.
      iSplitR; [by iPureIntro|].
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x52)) Ra0 Ra0 (mword_of_int 1518 : mword 12)
    ...
    set (H4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (H3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1518 : mword 12)))]> H3).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x56)) Rra (mword_of_int 2089034 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.bread + 0x56) : mword 64)
                        (sign_extend' 64 (mword_of_int 2089034 : mword 21))
    ...
    iApply (ASL.wp_acquiresleep_genl_llb_sconf γs j (fst (bn_slk bn k)) (snd (bn_slk bn k))
              "buffer"%string (bslp bn k) SleepLock.sl_untracked 1%Qp H7 pidv Upr (K - 6)%nat eb eb lks t
              Hj ltac:(lia)
              ltac:(lkbelow)
    ...
    iApply (bread_tail (CID0 := CIDh3)  γs j γl γu γd γk pd pav pu bn V k t Kt pidv dev bno dq
              m mf K eb lks Upr HK Hbno Hk Hgd Hcov Hdv Hj Hgl Hmfregs Hmfs1 HKt
  ...
  Proof.
    ...
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc Hdevw".
    iEval (rewrite Hadev Hsvdev) in "Hdevw".
    ...
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc Hbnow".
    iEval (rewrite Habno Hsvbno) in "Hbnow".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0xa4)) Ra0 Ra0 (mword_of_int 1436 : mword 12)
    ...
    set (C3 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (C2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1436 : mword 12)))]> C2).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0xa8)) Rra (mword_of_int 2088952 : mword 21)
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.bread + 0xa8) : mword 64)
                        (sign_extend' 64 (mword_of_int 2088952 : mword 21))
                      = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Htgtrel) in "Hpc".
    ...
    (* ENDGAME R1 at the checkout's acquire: [Tl := t], the chain's stamp *)
    iApply (ASL.wp_acquiresleep_genl_llb_sconf γs j (fst (bn_slk bn k)) (snd (bn_slk bn k))
              "buffer"%string (bslp bn k) SleepLock.sl_untracked 1%Qp C6 pidv Upr (K - 6)%nat eb eb lks t
              Hj ltac:(lia)
              ltac:(lkbelow)
              with "Hcg Hcnt Hextc Hextm Htext Hpc [] Hllbt [] Hppid Hprocs").
    all: try lkbelow.
  ...
  Local Lemma bread_bloop `{GEN : GenId} `{CID0 : CpuId} `{XI : CurCtx}
      ...
      (n : nat) (lks : gset string) (Upr : ustate) :
    (K_bread <= K)%nat ->
    (uint bno < 2147483648)%Z ->
    m !!! Regidx Ra0 = sign_extend' 64 dev ->
    m !!! Regidx Ra1 = sign_extend' 64 bno ->
  ...
  Proof.
    ...
    iDestruct ("Hback" $! Mg devs bnos tl with "[%] [%] Hslot") as "Hslots".
    ...
    - (* ======== refcnt == 0: this buffer is free, RECYCLE it ======== *)
      ...
      iApply (bread_recyc (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V kk Mg ord devs bnos tl
                pidv dev bno dq m B1 K eb lks Upr
    ...
    - (* ======== refcnt <> 0: advance to b->prev ======== *)
      ...
      + (* ---- the prefix is exhausted: fall through to panic ---- *)
        ...
        iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x88)) Ra0 Ra0 (mword_of_int 1960 : mword 12)
        ...
        set (Q2 := <[Regidx Ra0 := regval_into_reg
                      (add_vec (Q1 !!! Regidx Ra0)
                         (sign_extend' 64 (mword_of_int 1960 : mword 12)))]> Q1).
        ...
        iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x8c)) Rra (mword_of_int 2087940 : mword 21)
        ...
        assert (Htgtpanic : add_vec (mword_of_int (KernelSyms.bread + 0x8c) : mword 64)
                              (sign_extend' 64 (mword_of_int 2087940 : mword 21))
  ...
  Proof.
    ...
    assert (Hhp : add_vec (rget Q1 Rs1) (sign_extend' 64 (mword_of_int 2184 : mword 12))
                  = bprev bhead).
    ...
    iApply (wp_ld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.bread + 0x68)) Rs1 Rs1 (mword_of_int 2184 : mword 12)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x70)) Ra5 Ra5 (mword_of_int 2104 : mword 12)
    ...
    set (Q4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (Q3 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2104 : mword 12)))]> Q3).
    ...
    iApply (bread_bloop (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V Mg ord devs bnos tl
              pidv dev bno dq m K eb (length ord) lks Upr
    ...
    { iIntros (Mx (Hxregs & Hxs1 & Hxa4 & Hxne)).
      ...
      + (* the scan has wrapped: on to the backward scan *)
        ...
        iApply (bread_miss (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V Mg ord devs bnos tl
                  pidv dev bno dq m G1 K eb lks Upr
    ...
    - (* ---- dev matches: test the block number ---- *)
      ...
      + (* ======== THE HIT ======== *)
        ...
        iApply (bread_hit (CID0 := CID0)  γs j γl γu γd γk pd pav pu bn V kk Mg ord devs bnos tl
                  pidv dev bno dq m F2 K eb lks Upr
...
Section ProofBread.
  ...
  Proof.
    ...
    iAssert (bd_cont (CID0 := CID)  j bn V pidv dev bno dq m K eb pj lks Upr)
      with "[Hcont]" as "Hcont".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x16)) Ra0 Ra0 (mword_of_int 1578 : mword 12)
    ...
    set (R6 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R5 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1578 : mword 12)))]> R5).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.bread + 0x1a)) Rra (mword_of_int 2088958 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.bread + 0x1a) : mword 64)
                        (sign_extend' 64 (mword_of_int 2088958 : mword 21))
    ...
    iDestruct (bd_cont_shift (CIDa := CID) (CIDb := CIDq)  j bn V pidv dev bno dq
                 m K eb pj lks Upr ltac:(wp_next_chain) with "Hcont") as "Hcont".
    ...
    assert (Hhn : add_vec (rget W1 Rs1) (sign_extend' 64 (mword_of_int 2262 : mword 12))
                  = bnext bhead).
    ...
    iApply (wp_ld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.bread + 0x22)) Rs1 Rs1 (mword_of_int 2262 : mword 12)
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.bread + 0x2a)) Ra5 Ra5 (mword_of_int 2174 : mword 12)
    ...
    set (W4 := <[Regidx Ra5 := regval_into_reg
                  (add_vec (W3 !!! Regidx Ra5)
                     (sign_extend' 64 (mword_of_int 2174 : mword 12)))]> W3).
    ...
    iApply (bread_floop (CID0 := CIDq)  γs j γl γu γd γk pd pav pu bn V Mg ord devs bnos tl
              ...
              Upr HK Hbno Ha0 Ha1 Hj Hgl Hgd Hcov Hdv Hordp Hbelow [] ord W5

...
(* ==================================================================== *)
(*  ProofSysUnlinkW5File.v -- sys_unlink's W5File block. *)
(*                                                                      *)
...
Module SysUnlinkW5File (Iunlockput : IUNLOCKPUT) (EndOp : END_OP) (PN : PANIC) (Memset : MEMSET) (Writei : WRITEI) (Iupdate : IUPDATE).

Module Tails := SysUnlinkTails Iunlockput EndOp PN.

Section ProofSysUnlinkW5File.

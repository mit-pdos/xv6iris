...
Section ProofEitherCopyout.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.either_copyout + 0x18))
              Rra (mword_of_int 2094678 : mword 21) R6 (av - 6)%nat b
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.either_copyout + 0x18) : mword 64)
                     (sign_extend' 64 (mword_of_int 2094678 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* ================= user_dst != 0: copyout ================= *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.either_copyout + 0x26))
                Rra (mword_of_int 2093928 : mword 21) U4 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi26 [-]").
      ...
      assert (Hjco : add_vec (mword_of_int (KernelSyms.either_copyout + 0x26) : mword 64)
                       (sign_extend' 64 (mword_of_int 2093928 : mword 21)) = mword_of_int KernelSyms.copyout)
        by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* ================= user_dst == 0: memmove ================= *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.either_copyout + 0x42))
                Rra (mword_of_int 2091598 : mword 21) K3 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi42 [-]").
      ...
      assert (Hjmm : add_vec (mword_of_int (KernelSyms.either_copyout + 0x42) : mword 64)
                       (sign_extend' 64 (mword_of_int 2091598 : mword 21)) = mword_of_int KernelSyms.memmove)
        by (apply bv_eq; vm_compute; reflexivity).
...
Section ProofEitherCopyin.
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.either_copyin + 0x18))
              Rra (mword_of_int 2094604 : mword 21) R6 (av - 6)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi18 [-]").
    iIntros (CID13 Hs13) "Hcg Hpc".
    set (R7 := <[Regidx Rra := regval_into_reg
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.either_copyin + 0x18) : mword 64)
                     (sign_extend' 64 (mword_of_int 2094604 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    iEval (rewrite Hjmp) in "Hpc".
    assert (HR7ra : R7 !!! Regidx Rra
    ...
    - (* ================= user_src != 0: copyin ================= *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.either_copyin + 0x26))
                Rra (mword_of_int 2094044 : mword 21) U4 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi26 [-]").
      iIntros (CID20 Hs20) "Hcg Hpc".
      set (U5 := <[Regidx Rra := regval_into_reg
      ...
      assert (Hjci : add_vec (mword_of_int (KernelSyms.either_copyin + 0x26) : mword 64)
                       (sign_extend' 64 (mword_of_int 2094044 : mword 21)) = mword_of_int KernelSyms.copyin)
        by (apply bv_eq; vm_compute; reflexivity).
    ...
    - (* ================= user_src == 0: memmove ================= *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.either_copyin + 0x42))
                Rra (mword_of_int 2091524 : mword 21) K3 (av - 6)%nat b
                ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi42 [-]").
      iIntros (CID19 Hs19) "Hcg Hpc".
      set (K4 := <[Regidx Rra := regval_into_reg
      ...
      assert (Hjmm : add_vec (mword_of_int (KernelSyms.either_copyin + 0x42) : mword 64)
                       (sign_extend' 64 (mword_of_int 2091524 : mword 21)) = mword_of_int KernelSyms.memmove)
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Hjmm) in "Hpc".
      assert (HK4ra : K4 !!! Regidx Rra

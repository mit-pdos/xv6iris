...
Lemma it_reloc_lhn :
  add_vec (add_vec (mword_of_int (KernelSyms.install_trans + 0x00) : mword 64)
          ...
          (sign_extend' 64 (mword_of_int 2282 : mword 12)) = lh_n_pa.
Proof.
  rewrite /lh_n_pa /log_pa /log_addr /pa_add /add_vec_int.
  apply bv_eq; vm_compute; reflexivity.
Qed.
...
Lemma it_reloc_blk0 :
  add_vec (add_vec (mword_of_int (KernelSyms.install_trans + 0x26) : mword 64)
                   (auipc_off (mword_of_int 31 : mword 20)))
          (sign_extend' 64 (mword_of_int 2248 : mword 12)) = lh_block 0.
Proof.
...
Lemma it_reloc_log :
  add_vec (add_vec (mword_of_int (KernelSyms.install_trans + 0x38) : mword 64)
                   (auipc_off (mword_of_int 31 : mword 20)))
          (sign_extend' 64 (mword_of_int 2182 : mword 12)) = log_addr.
...
Section InstallTransBlocks.
  ...
  Local Lemma it_epi `{GEN : GenId} `{CID0 : CpuId} 
      ...
      (L : gmap Z (list (bv 8))) (D : gmap Z bool)
      (pidv : mword 32) (dq : dfrac)
      (m M : regfile) (K : nat) (eb : bool) (R : iProp Σ) (lks : gset string) :
    ...
    ▷ R -∗
    it_cont (kt := kt) (CID0 := CID0)  j bn γfs logstart n W Lw L D pidv dq m K eb eb R lks -∗
  ...
  Proof.
    ...
    iDestruct (it_cont_shift (CIDa := CID0) (CIDb := CID12)  j bn γfs logstart n W Lw L D
                 pidv dq m K eb eb R lks ltac:(wp_next_chain) with "Hcont") as "Hcont".
    rewrite /it_cont.
  ...
  Local Lemma it_loop `{GEN : GenId} (fuel : nat) 
      ...
      (L : gmap Z (list (bv 8))) (D : gmap Z bool)
      (pidv : mword 32) (dq : dfrac)
      (m : regfile) (K : nat) (eb : bool) (R : iProp Σ) (lks : gset string) :
    (K_install_trans <= K)%nat ->
  ...
  Proof.
    ...
    iApply (wp_lw_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.install_trans + 0x70)) Ra1 Rs4 (mword_of_int 24 : mword 12)
    ...
    iApply (wp_lw_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.install_trans + 0x7a)) Ra0 Rs4 (mword_of_int 36 : mword 12)
              A3 (K - 10)%nat dev eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iDestruct (cpu_own_transport CID0 CIDa6 0%nat eb (proc_addr j) eb
                 ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    ...
    iApply (Bread.wp_bread_sconf kt γs j γl γu γd γk pd pav pu bn
              (fs_view γfs γd dev cov) pidv dev bnol dq A5 (K - 10)%nat eb eb lks
              (it_Kbread K HK)
    ...
    iApply (wp_lw_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.install_trans + 0x84)) Ra1 Rs5 (mword_of_int 0 : mword 12)
              A6 (K - 10)%nat w eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iApply (wp_lw_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.install_trans + 0x88)) Ra0 Rs4 (mword_of_int 36 : mword 12)
              A7 (K - 10)%nat dev eb
              ltac:(vm_compute; discriminate) ltac:(rdok)
    ...
    iApply (Bread.wp_bread_sconf kt γs j γl γu γd γk pd pav pu bn
              (fs_view γfs γd dev cov) pidv dev w dq A9 (K - 10)%nat eb eb lks
              (it_Kbread K HK)
    ...
    iApply (Bwrite.wp_bwrite_sconf kt γs j γl γu γd γk pd pav pu bn
    ...
    iDestruct (cpu_own_transport CIDb3 CIDa21 0%nat eb (proc_addr j) eb
                 ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (Bunpin.wp_bunpin_sconf kt bn (fs_view γfs γd dev cov) k2 qref dev w
    ...
    iDestruct (cpu_own_transport CIDb4 CIDa24 0%nat eb (proc_addr j) eb
                 ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (Brelse.wp_brelse_sconf kt γs bn (fs_view γfs γd dev cov) k1 pidv dev bnol dq
    ...
    iDestruct (cpu_own_transport CIDb5 CIDa26 0%nat eb (proc_addr j) eb
                 ltac:(wp_next_chain) with "Hcnt") as "Hcnt".
    iApply (Brelse.wp_brelse_sconf kt γs bn (fs_view γfs γd dev cov) k2 pidv dev w dq
    ...
    iApply (wp_lw_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.install_trans + 0x64)) Ra5 Rs4 (mword_of_int 44 : mword 12)
    ...
    + (* ---- the last entry: take the exit into the epilogue ---- *)
      ...
      iApply (it_epi (CID0 := CIDa30)  j bn γfs logstart n W Lw L D pidv dq m B16 K eb R lks
...
Section ProofInstallTrans.
  ...
  Proof.
    ...
    iAssert (it_cont (kt := kt) (CID0 := CID)  j bn γfs logstart n W Lw L D pidv dq m K eb eb R lks)
      with "[Hcont]" as "Hcont".
    ...
    assert (Hna : add_vec (rget R1 Ra5) (sign_extend' 64 (mword_of_int 2282 : mword 12))
                  = lh_n_pa).
    { rgne. rewrite /R1 upd_eq. exact it_reloc_lhn. }
    iEval (rewrite -Hna) in "Hncell".
    iApply (wp_lw_s_sconf (kt := kt) (ktd := KT0) (mword_of_int (KernelSyms.install_trans + 0x04)) Ra5 Ra5
    ...
    - (* ---- n > 0: recovering = false, and the whole loop runs ---- *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.install_trans + 0x2a)) Rs5 Rs5
                (mword_of_int 2248 : mword 12) Q4 (K - 10)%nat eb
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi2a").
      ...
      set (Q5 := <[Regidx Rs5 := regval_into_reg
                    (add_vec (Q4 !!! Regidx Rs5 : mword 64)
                       (sign_extend' 64 (mword_of_int 2248 : mword 12)))]> Q4).
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.install_trans + 0x34)) Rs8 Rs8
                (mword_of_int 2558 : mword 12) Q7 (K - 10)%nat eb
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi34").
      ...
      set (Q8 := <[Regidx Rs8 := regval_into_reg
                    (add_vec (Q7 !!! Regidx Rs8 : mword 64)
                       (sign_extend' 64 (mword_of_int 2558 : mword 12)))]> Q7).
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.install_trans + 0x3c)) Rs4 Rs4
                (mword_of_int 2182 : mword 12) Q9 (K - 10)%nat eb
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi3c").
      ...
      set (Q10 := <[Regidx Rs4 := regval_into_reg
                     (add_vec (Q9 !!! Regidx Rs4 : mword 64)
                        (sign_extend' 64 (mword_of_int 2182 : mword 12)))]> Q9).

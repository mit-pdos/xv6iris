...
Section WpSconfPushOff.
  ...
  Lemma wp_pop_off_epi_sconf (γ : gname) (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (M : gmap regidx (mword 64)) (av : nat) (ra0e s00e : mword 64) :
    ...
    sie_cap γ root_ppn M av -∗ tlb_inv_pt root_ppn -∗
    ...
    ( ∀ mf,
      ...
      sie_cap γ root_ppn mf (av + 2) -∗ tlb_inv_pt root_ppn -∗
  ...
  Proof.
    ...
    iApply (wp_caddi_sp_pop_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x2c)) (mword_of_int 16 : mword 6) M5 av 2 Hpop
              with "Hsc Hhs Hcap Htlbinv Hpc Hfile Hi2c Hframe [-]").
    ...
    iApply (wp_cret_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x2e)) (mword_of_int 1 : mword 5) M6 (av + 2)%nat
  ...
  Lemma wp_push_off_suffix_sconf (γ : gname) (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (ms : gmap regidx (mword 64)) (av : nat)
    ...
    ( hart_state ↦ᵣ HART_ACTIVE tt -∗
      ...
      tlb_inv_pt root_ppn -∗
      pc_is cret_tgt -∗
      (∃ mfin, gpr_file mfin ∗ sie_cap γ root_ppn mfin (av + 4) ∗ ⌜ mfin !!! Regidx (mword_of_int 1 : mword 5) = ra0e /\
  ...
  Proof.
    ...
    iIntros "Hsc Hhs Hcap Htlbinv #Htext Hpc Hfile Hnoff Hpp24 Hpp16 Hpp8 Hgap Hcont".
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
              ...
              with "Hsc Hhs Hcap Htlbinv Htext Hpc Hfile Hi18 [-]").
 ...
 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cret_s_sconf γ root_ppn Φ (mword_of_int (PO + 0x2a)) (mword_of_int 1 : mword 5) M7 (av + 4)%nat
    ...
    iApply ("Hcont" with "Hhs Hsc Htlbinv Hpc [Hfile Hcap] Hnoff").
  ...
  Proof.
    ...
    iIntros "Hsc Hhs Hcap Hcnt Htlbinv #Htext Hpc Hfile Hnoff Hintena Hcont".
    ...
    iApply (wp_caddi_sp_push_s_sconf γ root_ppn Φ (mword_of_int (PO + 0x00)) (mword_of_int 32 : mword 6) m av 4
              ltac:(lia) Hpush
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
              ltac:(rewrite lookup_total_insert; vm_compute; reflexivity) ltac:(lia)
              with "Hsc Hhs Hcap Htlbinv Htext Hpc Hfile Hi10 [-]").
    iIntros (mo1) "Hhs Hsc Hcap Htlbinv Hpc Hfile %Hmo4".
    set (N4 := mo1).
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
                ltac:(rewrite lookup_total_insert; vm_compute; reflexivity) ltac:(lia)
                with "Hsc Hhs Hcap Htlbinv Htext Hpc Hfile Hi2c [-]").
      iIntros (mo2) "Hhs Hsc Hcap Htlbinv Hpc Hfile %Hmo6".
      set (N6 := mo2).
 ...
 Hcret0 ltac:(lia)
                with "Hsc Hhs Hcap Htlbinv Htext Hpc Hfile [Hnoff] [Hr24] [Hr16] [Hr8] [Hgap] [-]").
      ...
      iIntros "Hhs Hsc Htlbinv Hpc Hmfin Hnoff".
      ...
      iEval (rewrite Hav4) in "Hcap".
      iApply ("Hcont" $! mstatus0 mfin with "[%] Hhs Hsc Hcap Htlbinv Hpc Hmf [%] Hnoff [Hintena] [Hpayload]").
      { exact Hmsf. }
 ...
 Hcret0 ltac:(lia)
  ...
  Proof.
    ...
    iIntros "Hsc Hhs Hcap Hcnt Htlbinv #Htext Hpc Hfile Hnoff Hint Hcont".
    ...
    iApply (wp_caddi_sp_push_s_sconf γ root_ppn Φ pcE (mword_of_int 48) m av 2
              ltac:(lia) Hpush
              with "Hsc Hhs Hcap Htlbinv Hpc Hfile Hi00 [-]").
    iIntros "Hhs Hsc Hcap Hframe Htlbinv Hpc Hfile".
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
              ltac:(rewrite lookup_total_insert; vm_compute; reflexivity) ltac:(lia)
              with "Hsc Hhs Hcap Htlbinv Htext Hpc Hfile Hi08 [-]").
    iIntros (mo) "Hhs Hsc Hcap Htlbinv Hpc Hfile %Hmo".
    set (C := mo).
    ...
    iApply (wp_csrr_sstatus_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x0c)) (mword_of_int 15 : mword 5) C (av - 2)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iAssert (sie_cap γ root_ppn P3 (av - 2)%nat) with "[Hstk Hq0]" as "Hcap".
    ...
    - (* noff-1 <> 0: TAKEN to the epilogue at 0x28; no restore *)
      ...
      iIntros (mf) "Hhs Hsc Hcap Htlbinv Hpc Hfile %Hmf".
      assert (Hav2 : (av - 2 + 2)%nat = av) by lia.
      iEval (rewrite Hav2) in "Hcap".
      subst mf.
      ...
      iApply ("Hcont" $! _ with "Hhs Hsc Hcap [Htok HsepA HscaA HstvA HsA] Htlbinv Hpc Hfile [%] Hnoff Hint").
    ...
    - (* noff-1 = 0: FALL to the intena check at 0x20 *)
      ...
      iApply (wp_clw_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x20)) (mword_of_int 15 : mword 5) (mword_of_int 10 : mword 5)
                (mword_of_int 124 : mword 12) P6 (av - 2)%nat intenav (dqm := dqi)
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
      ...
      + (* intena = 0: TAKEN to the epilogue; no restore *)
        ...
        iApply ("Hcont" $! _ with "Hhs Hsc Hcap [Htok HsepB HscaB HstvB HsB] Htlbinv Hpc Hfile [%] Hnoff Hint").
        { iRight. iFrame "Htok".
      ...
      + (* intena <> 0: FALL into the restore *)
        ...
        iApply (wp_csrsi_sstatus_x0_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x24)) P7 (av - 2)%nat
        ...
        iEval (rewrite Hav2) in "Hcap".
        subst mf.
        iApply ("Hcont" $! _ with "Hhs Hsc Hcap Hcnt0 Htlbinv Hpc Hfile [%] Hnoff Hint").
        unfold callee_saved. repeat split.
        * rewrite lookup_total_insert HcspP7 Hsp0up. reflexivity.
        * do 3 (rewrite lookup_total_insert_ne; [| vm_compute; discriminate]).
          rewrite /P7 lookup_total_insert_ne; [| vm_compute; discriminate].

...
Section WpSconfPushOff.
  ...
  Lemma wp_pop_off_epi_sconf (γ : gname) (root_ppn : mword 44) (Φ : mval -> iProp Σ)
    ...
    ( ∀ mf,
      ...
      sie_cap_gpr γ root_ppn mf (av + 2) -∗ tlb_inv_pt root_ppn -∗
      pc_is ret_tgt -∗
  ...
  Proof.
    ...
    iIntros "Hsc Hhs Hcg Htlbinv #Htext Hpc Hp8 Hp0 Hcont".
  ...
  Lemma wp_push_off_suffix_sconf (γ : gname) (root_ppn : mword 44) (Φ : mval -> iProp Σ)
    ...
    ( hart_state ↦ᵣ HART_ACTIVE tt -∗
      ...
      tlb_inv_pt root_ppn -∗
      pc_is cret_tgt -∗
      (∃ mfin, sie_cap_gpr γ root_ppn mfin (av + 4) ∗ ⌜ mfin !!! Regidx (mword_of_int 1 : mword 5) = ra0e /\
 ...
 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PO + 0x22)) (mword_of_int 3 : mword 6) (mword_of_int 1 : mword 5)
              M3 av ra0e
 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi22 [Hpp24] [-]").
    { iEval (rewrite Hcsp3). iExact "Hpp24". }
    iIntros "Hhs Hsc Hcg Htlbinv Hpc Hpp24".
    ...
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PO + 0x24)) (mword_of_int 2 : mword 6) (mword_of_int 8 : mword 5)
              M4 av s00e
 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi24 [Hpp16] [-]").
    { iEval (rewrite Hcsp4). iExact "Hpp16". }
    iIntros "Hhs Hsc Hcg Htlbinv Hpc Hpp16".
    ...
    iApply (wp_cldsp_s_sconf γ root_ppn Φ (mword_of_int (PO + 0x26)) (mword_of_int 1 : mword 6) (mword_of_int 9 : mword 5)
              M5 av s10e
 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi26 [Hpp8] [-]").
    { iEval (rewrite Hcsp5). iExact "Hpp8". }
    iIntros "Hhs Hsc Hcg Htlbinv Hpc Hpp8".
    ...
    iApply ("Hcont" with "Hhs Hsc Htlbinv Hpc [Hcg] Hnoff").
 ...
 ltac:(vm_compute; reflexivity) ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
    ...
    iApply (wp_csrci_sstatus_s_sconf γ root_ppn Φ (mword_of_int (PO + 0x0a)) (mword_of_int 15 : mword 5) n
              N1 (av - 4)%nat
              ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Hcnt Htlbinv Hpc Hi0a [-]").
    iIntros (mstatus0) "%Hmsf Hhs Hsc Hcg Hpayload Htlbinv Hpc".
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
    ...
    iIntros (mo1) "Hhs Hsc Hcg Htlbinv Hpc %Hmo4".
    set (N4 := mo1).
 ...
 ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
              with "Hsc Hhs Hcg Htlbinv Hpc Hi14 [Hnoff] [-]").
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
      ...
      iIntros (mo2) "Hhs Hsc Hcg Htlbinv Hpc %Hmo6".
      set (N6 := mo2).
 ...
 Hcret0 ltac:(lia)
      ...
      iApply ("Hcont" $! mstatus0 mfin with "[%] Hhs Hsc Hcg Htlbinv Hpc [%] Hnoff [Hintena] [Hpayload]").
      { exact Hmsf. }
 ...
 ltac:(apply bv_eq; vm_compute; reflexivity) ltac:(vm_compute; reflexivity)
    ...
    - (* noff-1 <> 0: TAKEN to the epilogue at 0x28; no restore *)
      ...
      iIntros (mf) "Hhs Hsc Hcg Htlbinv Hpc %Hmf".
      ...
      iApply ("Hcont" $! _ with "Hhs Hsc Hcg [Htok HsepA HscaA HstvA HsA] Htlbinv Hpc [%] Hnoff Hint").
    ...
    - (* noff-1 = 0: FALL to the intena check at 0x20 *)
      ...
      iApply (wp_clw_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x20)) (mword_of_int 15 : mword 5) (mword_of_int 10 : mword 5)
                ...
                ltac:(vm_compute; discriminate) ltac:(vm_compute; discriminate)
                with "Hsc Hhs Hcg Htlbinv Hpc Hi20 [Hint] [-]").
      { iEval (rewrite Ha0P6). iExact "Hint". }
      iIntros "Hhs Hsc Hcg Htlbinv Hpc Hint".
      ...
      + (* intena = 0: TAKEN to the epilogue; no restore *)
        ...
        iApply ("Hcont" $! _ with "Hhs Hsc Hcg [Htok HsepB HscaB HstvB HsB] Htlbinv Hpc [%] Hnoff Hint").
        { iRight. iFrame "Htok".
      ...
      + (* intena <> 0: FALL into the restore *)
        ...
        iApply (wp_csrsi_sstatus_x0_s_sconf γ root_ppn Φ (mword_of_int (PP + 0x24)) P7 (av - 2)%nat
                  with "Hsc Hhs Hcg [Htok Hres] Htlbinv Hpc Hi24 [-]").
        { iApply (intr_count_pack_S γ root_ppn 0 with "Htok Hres"). }
        iIntros (msi) "%Hmsfi Hhs Hsc Hcg Hcnt0 Htlbinv Hpc".
        ...
        iEval (rewrite Hav2) in "Hcg".
        subst mf.
        iApply ("Hcont" $! _ with "Hhs Hsc Hcg Hcnt0 Htlbinv Hpc [%] Hnoff Hint").
        unfold callee_saved. repeat split.
        * rewrite upd_eq HcspP7 Hsp0up. reflexivity.
        * do 3 (rewrite upd_ne; [| vm_compute; discriminate]).
          rewrite /P7 upd_ne; [| vm_compute; discriminate].

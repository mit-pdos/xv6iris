...
Section ProofDirlinkMain.
  ...
  Proof.
    ...
    { iModIntro.
      ...
      iClear "Hi9c Hi9e Hia0 Hia2 Hia4 Hia6 Hia8".
      iEval (rgne) in "Hpc".
   ...
   iDestruct (cpu_own_transport CID CID12 0%nat eb (proc_addr j) b 
    ...
    - (* =============== THE FOUND ARM: iput, a0 := -1 =============== *)
      ...
      iApply (IP.wp_iput_gen gs j gl gu gd gk pd pav pu bn g gfs gi cn gtl
                ...
                ncount Sb false false false edl pidv dq dqb dqs E1 (K - 10)%nat eb b lks Vpr true
      ...
      iClear "Hi00 Hi02 Hi04 Hi06 Hi08 Hi0a Hi0c Hi0e Hi10 Hi12 Hi14 Hi16 Hi1a Hi58 Hi5c Hi5e".
    ...
    - (* ============ THE NOT-FOUND ARM: the free-slot scan ============ *)
      ...
      iAssert (□ wp_next (CID0 := CID) true (proc_addr j) (fun CIDa : CpuId =>
                 dl_after_body j m sp0 ip nb dqd dev dqf dinum dn dn0 gfs bm
                   ...
                   logstart gi dq pidv bn g ncount Sb K b eb k0 inum
      ...
      { iModIntro.
        ...
        assert (Htgtsn : add_vec (mword_of_int (DK + 0x78) : mword 64)
                  (sign_extend' 64 (mword_of_int 2085688 : mword 21))
                  = mword_of_int KernelSyms.strncpy) by pcw.
        iApply (wp_jal_s_sconf (mword_of_int (DK + 0x78)) Rra
                  (mword_of_int 2085688 : mword 21) W3 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi78").
        ...
        iClear "Hi70 Hi72 Hi74 Hi78 Hi7c Hi80 Hi82 Hi84 Hi88 Hi8a Hi8c Hi90 Hi92 Hi96 Hi9a".
        iEval (rewrite HfT3) in "Hb3".
      ...
      + (* ---------- the directory is EMPTY: s1 = 0 is already [off] ------ *)
        ...
        iClear "Hi00 Hi02 Hi04 Hi06 Hi08 Hi0a Hi0c Hi0e Hi10 Hi12 Hi14 Hi16 Hi1a Hi1c Hi1e Hi22".
      ...
      + (* ---------- the directory is NON-EMPTY: the scan ---------------- *)
        ...
        iClear "Hi24 Hi26 Hi28 Hi2a Hi2e".
        ...
        iAssert (∀ fuel : nat,
          wp_next (CID0 := CID) true (proc_addr j) (fun CIDl : CpuId =>
            dl_scan_body j nrec dn data m sp0 ip nb inum K b eb dev dqf
              ...
              logstart gi dn0 dq pidv bn g ncount Sb k0 s ret_tgt dqd
              fuel CIDl lks Vpr))%I
          with "[]" as "Hloop".
        { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
          { iIntros (CIDl Hsl i Ml dol)
              "%Hfuel %Hilt16 %Hffn %Hregs Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6
               ...
               Hdat Hppid Hbs1 Hbs2 Hislot Hop Hlinks Hqc".
            exfalso.
          ...
          { (* -------------- THE SHORT READ: dirlink DIVERGES ---------- *)
            ...
            iApply (wp_jal_s_sconf (mword_of_int (DK + 0x68)) Rra
                      (mword_of_int 2084308 : mword 21) PB2 (K - 10)%nat b
                      ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                      with "Hcg Hpc Hj68").
            iIntros (CIDpa4 Hqpa4) "Hcg Hpc".
            assert (Htgtpn : add_vec (mword_of_int (DK + 0x68) : mword 64)
                               (sign_extend' 64 (mword_of_int 2084308 : mword 21))
          ...
          * (* ---- the record is FREE: break to +0x6c ---- *)
            ...
            iApply ("Ha" $! _ (fun jj => file_byte data (16 * i + jj)%nat)
                      ...
                      "[%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8 Hde
                       ...
                       Hdat Hppid Hbsl Hislot Hop Hlinks Hqc").
            { exact HN3p. }
            ...
            -- (* ---- another record: back to +0x30 with i+1 ---- *)
               ...
               iApply ("IHf" $! (S i) N3 (fun jj => file_byte data (16 * i + jj)%nat)
                         ...
                         "[%] [%] [%] [%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6
                          ...
                          Hsbs Hsbb Hdat Hppid Hbs1 Hbs2 Hislot Hop Hlinks Hqc").
        ...
        iApply ("Hloop" $! 0%nat Q4 dolds0 with
                  "[%] [%] [%] [%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8
                   ...
                   Hdat Hppid Hbs1 Hbs2 Hislot Hop Hlinks Hcont").
  ...
  Proof.
    ...
    iIntros (mf found bm' data' dn' dn0' n' Sb' tot)
      "%E1 Hcg Hcnt Hpc Hidev Hiinum Hmeta Hmap Hblocks Hnm Hsbi Hsbs Hsbb
       Hdat Hppid Hbsl Hislot Hlinks %E2 %Esb %Ewi %Efd Hop %E3 %E4 %E5".

...
Section ProofDirlinkMain.
  ...
  (* [dl_dummyV] USED TO BE HERE: readi's and writei's [V] slot was dead on
     the kernel arm, which took a bare quarter of [p->pid] rather than a
     process block.  Both take [proc_priv_bare pj pidv V] now, so the slot is
     live and dirlink passes its OWN [Vpr] straight through. *)
  ...
  Definition dl_after_exit
      (j : nat) (m : regfile) (ip : mword 64) (nb : mword 64) (dqd : dfrac) (dqf : dfrac) (dinum : mword 32) (dn : dinode) (dn0 : dinode) (bm : blkmap) (data : nat -> list (bv 8)) (dqn : dfrac) (fn : nat -> bv 8) (dqs : dfrac) (dqbs : dfrac) (size : Z) (dqb : dfrac) (bmapstart : Z) (pidv : mword 32) (ncount : nat) (Sb : gset Z) (tid : nat) (qtx : Qp) (K : nat) (b : bool) (eb : bool) (k0 : nat) (inum : mword 16) (nrec : nat) (s : list (bv 8)) (ret_tgt : mword 64) (lks : gset string) (Vpr : pprivate) (CIDc : CpuId) : iProp Σ :=
    (∀ (mf : regfile) (found : bool)
           ...
           (tot : nat),
             ...
             (* the share, back (durable-disk B''-tx5) *)
  ...
  Definition dl_after_body
    ...
    (∀ (Mp : regfile) (dolz : nat -> bv 8) (w5 w6 : mword 64),
       ...
       IcacheEscrow.dlinks fsc_fs (bv_unsigned dinum) dn bm data -∗
       wp_next (CID0 := CID) true (proc_addr j) (fun CIDc : CpuId => dl_after_exit j m ip nb dqd dqf dinum dn dn0 bm data dqn fn dqs dqbs size dqb bmapstart pidv ncount Sb tid qtx K b eb k0 inum nrec s ret_tgt lks Vpr CIDc) -∗
       WP (Loop : expr riscv_lang))%I.
  ...
  Definition dl_scan_exit
      (j : nat) (nrec : nat) (dn : dinode) (data : nat -> list (bv 8)) (m : regfile) (ip : mword 64) (nb : mword 64) (inum : mword 16) (K : nat) (b : bool) (eb : bool) (dqf : dfrac) (dinum : mword 32) (bm : blkmap) (dqn : dfrac) (fn : nat -> bv 8) (dqs : dfrac) (dqbs : dfrac) (size : Z) (dqb : dfrac) (bmapstart : Z) (dn0 : dinode) (pidv : mword 32) (ncount : nat) (Sb : gset Z) (tid : nat) (qtx : Qp) (k0 : nat) (s : list (bv 8)) (ret_tgt : mword 64) (dqd : dfrac) (lks : gset string) (Vpr : pprivate) (CIDc : CpuId) : iProp Σ :=
    (∀ (mf : regfile) (found : bool)
           (bm' : blkmap) (data' : nat -> list (bv 8))
           (dn' dn0' : dinode) (n' : nat) (Sb' : gset Z)
           (tot : nat),
  ...
  Definition dl_scan_body
      ...
      (fn : nat -> bv 8) (dqs : dfrac) (dqbs : dfrac)
      (size : Z) (dqb : dfrac) (bmapstart : Z)
      (dn0 : dinode) (dq : dfrac)
      (pidv : mword 32) (bn : bio_names) (ncount : nat)
    ...
    (∀ (i : nat) (Ml : regfile) (dol : nat -> bv 8),
       ...
       (* the borrowed ticket list, riding to the continuation (§7.1) *)
       IcacheEscrow.dlinks fsc_fs (bv_unsigned dinum) dn bm data -∗
       wp_next (CID0 := CID) true (proc_addr j) (fun CIDc : CpuId => dl_scan_exit j nrec dn data m ip nb inum K b eb dqf dinum bm dqn fn dqs dqbs size dqb bmapstart dn0 pidv ncount Sb tid qtx k0 s ret_tgt dqd lks Vpr CIDc) -∗
       WP (Loop : expr riscv_lang))%I.
  ...
  Lemma wp_dirlink_gen
    ...
    : wp_dirlink_gen_body gs j gl gu gd gk pd pav pu bn
                          ga gf gpr bmapstart
  ...
  Proof.
    ...
    (* THE REGION RECORD IS ALLOCATED, which is all licence (c) needs of it
       ...
       T_DIR and [di_type_stable] carries that to the region's [dn0].  No
       new premise -- see SpecDirlink.v's header. *)
    assert (Hdn0nz : bv_unsigned (di_type dn0) <> 0).
    { intro Hc. destruct Hstab as [Hz | Heq].
      - rewrite Htype in Hz. vm_compute in Hz. discriminate Hz.
      - rewrite -Heq Htype in Hc. vm_compute in Hc. discriminate Hc. }
    ...
    iIntros "Hcg Hcnt #Htext Hpc #Hkd #Hpk #Hbio #Hlog #Hkenv
              ...
              #Hitb2 #Hitbl #Hesc #Hslks Hislot Hlinks Hop Htx Hcont".
   ...
   iDestruct (cpu_own_transport CID CID12 0%nat eb (proc_addr j) b 
    ...
    iApply (DL.wp_dirlookup_sconf gs j gl gu gd gk pd pav pu bn
              ga gf ip dinum bm data dn dn0 fn
    ...
    - (* =============== THE FOUND ARM: iput, a0 := -1 =============== *)
      ...
      iApply (wp_jal_s_sconf (mword_of_int (DK + 0x58)) Rra
                (mword_of_int 2095432 : mword 21) mdl (K - 10)%nat b
                ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc []").
      ...
      iDestruct (dl_esc_acc kslot Hkslot with "Hesc")
        as "#Hesck".
    ...
    - (* ============ THE NOT-FOUND ARM: the free-slot scan ============ *)
      ...
      iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (DK + 0x1e)) Rs1 Rs2
      ...
      iAssert (□ wp_next (CID0 := CID) true (proc_addr j) (fun CIDa : CpuId =>
                 dl_after_body j m sp0 ip nb dqd dqf dinum dn dn0 bm
                   data dqn fn dqs dqbs size dqb bmapstart
                   dq pidv bn ncount Sb tid qtx K b eb k0 inum
      ...
      { iModIntro.
        ...
        assert (Htgtsn : add_vec (mword_of_int (DK + 0x78) : mword 64)
                  (sign_extend' 64 (mword_of_int 2085672 : mword 21))
                  = mword_of_int KernelSyms.strncpy) by pcw.
        iApply (wp_jal_s_sconf (mword_of_int (DK + 0x78)) Rra
                  (mword_of_int 2085672 : mword 21) W3 (K - 10)%nat b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc []").
        ...
        { rewrite (dlk_de_split (KTR := KT1) (pa_stk sp0 10)
          ...
          - rewrite (bb_ext (KTR := KT1) (pa_stk sp0 10) 2
            ...
            iExact "Hdehi".
          - rewrite (bb_ext (KTR := KT1) (pa_add (pa_stk sp0 10) 2) 14 hh
        ...
        iDestruct (cpu_own_transport CIDa CIDA11 0%nat eb (proc_addr j) b
                     ltac:(rewrite Hb; wp_next_chain) with "Hcnt") as "Hcnt".
        ...
        iApply (WI.wp_writei_gen KT1 gs j gl gu gd gk pd pav pu bn ga gf
 bmapstart size gpr
                  ip dinum bm data dn dn0
                  false (16 * k0)%nat 16%nat
                  (fun jj => dirent_bytes (de_of_name inum s) !!! jj)
                  Vpr ncount Sb
                  pidv dq dqd dqf dqs dqb dqbs V6 (K - 10)%nat eb b lks
                  ltac:(exact HKwi)
      ...
      + (* ---------- the directory is EMPTY: s1 = 0 is already [off] ------ *)
        ...
        iApply ("Ha" $! Q1 dolds0 u5 u6 with
                  "[%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8 Hde Hidev
                   ...
                   Hbsl Hislot Hop Htx Hlinks Hcont").
        { exact HQ1v. }
      + (* ---------- the directory is NON-EMPTY: the scan ---------------- *)
        ...
        iAssert (∀ fuel : nat,
          wp_next (CID0 := CID) true (proc_addr j) (fun CIDl : CpuId =>
            dl_scan_body j nrec dn data m sp0 ip nb inum K b eb dqf
              dinum bm dqn fn dqs dqbs size dqb bmapstart
              dn0 dq pidv bn ncount Sb tid qtx k0 s ret_tgt dqd
              fuel CIDl lks Vpr))%I
          with "[]" as "Hloop".
        { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
          ...
          (* readi takes its two uints in the ABI's sign-extended form; both
             of these are far below 2^31, where that is the identity *)
          assert (HL6a3' : L6 !!! Regidx Ra3
                           = sign_extend' 64
                               (mword_of_int (Z.of_nat (16 * i)%nat) : mword 32))
          ...
          iAssert (([∗ list] ii ∈ seq 0 16,
                   ...
                   ∗ proc_priv_bare (proc_addr j) pidv Vpr)%I
 ...
 ip bm data dn
          ...
          { (* -------------- THE SHORT READ: dirlink DIVERGES ---------- *)
            ...
            assert (Ha0msg3 : PB3 !!! Regidx Ra0 = (mword_of_int dl_msg_a : mword 64))
              by pcw.
            iApply (PN.wp_panic_sconf KT1 (CID := CIDpa4) PB3 (K - 10)%nat
          ...
          iEval (rewrite HL6a2 Htot
                   (bb_ext (KTR := KT1) (pa_stk sp0 10) 16
          ...
          * (* ---- the record is FREE: break to +0x6c ---- *)
            ...
            iApply ("Ha" $! _ (fun jj => file_byte data (16 * i + jj)%nat)
                      ...
                      "[%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8 Hde
                       Hidev Hiinum Hmeta Hmap Hblocks Hnm Hsbi Hsbs Hsbb
                       Hdat Hppid Hbsl Hislot Hop Htx Hlinks Hqc").
            { exact HN3p. }
            ...
            -- (* ---- another record: back to +0x30 with i+1 ---- *)
               ...
               iApply ("IHf" $! (S i) N3 (fun jj => file_byte data (16 * i + jj)%nat)
                         ...
                         "[%] [%] [%] [%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6
                          ...
                          Hsbs Hsbb Hdat Hppid Hbs1 Hbs2 Hislot Hop Htx Hlinks Hqc").
        ...
        iApply ("Hloop" $! 0%nat Q4 dolds0 with
                  "[%] [%] [%] [%] Hcg Hcnt Hpc Hb1 Hb2 Hb3 Hb4 Hb5 Hb6 Hb7 Hb8
                   ...
                   Hdat Hppid Hbs1 Hbs2 Hislot Hop Htx Hlinks Hcont").
  ...
  Lemma wp_dirlink_sconf
      ...
      (m : regfile) (K : nat) (eb : bool)
      (b : bool) (lks : gset string) (Vpr : pprivate)
    : wp_dirlink_sconf_body gs j gl gu gd gk pd pav pu bn
                            ga gf gpr bmapstart
                            size ip dinum bm data dn dn0 fn inum
  ...
  Proof.
    ...
    iApply (wp_dirlink_gen gs j gl gu gd gk pd pav pu bn
              ga gf gpr bmapstart size

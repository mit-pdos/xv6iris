(* S-mode Itype leaf lemmas (smode_config/Supervisor, decode family Itype).
...
Section WpSmodeItype.
  Context `{!riscvGS Σ, !sieG Σ}.
  Context `{CID : CpuId}.

  Lemma wp_addi4_s (root_ppn : mword 44) (Φ : mval -> iProp Σ)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
  ...
  Lemma wp_caddi4spn_gpr_s_config (root_ppn : mword 44) (Φ : mval -> iProp Σ)
  ...
  Proof.
    iIntros (HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrdc Hrd)
      "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile Hinstr Hcont".
    unshelve iApply (wp_gpr_write_s_config root_ppn Φ pc rd csp_rs1 csp_rs1
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrdc Hrd
  ...
  Lemma wp_caddi_gpr_s_config (root_ppn : mword 44) (Φ : mval -> iProp Σ)
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
  ...
  Lemma wp_candi_s (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rd : mword 5) (imm : mword 6)
      (m : gmap regidx (mword 64))
      (mstatus0 mie_v mdv0 menvcfg0 : mword 64)
      {dq : dfrac} :
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
  ...
  Lemma wp_cli_gpr_s_config (root_ppn : mword 44) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rd : mword 5) (imm : mword 6)
      (m : gmap regidx (mword 64))
      (mstatus0 mie_v mdv0 menvcfg0 : mword 64)
      {dq : dfrac} :
  ...
  Proof.
    iIntros (HSIE HMPRV HSXL Hmm HPBMTE Hmenvval Hrd)
      "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile Hinstr Hcont".
    unshelve iApply (wp_gpr_write_s_config root_ppn Φ pc rd
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval Hrd
  ...
  Lemma wp_cli_gpr_s_config_scfg (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rd : mword 5) (imm : mword 6)
      (m : gmap regidx (mword 64)) {dq : dfrac} :
    uint rd <> 0 ->
    smode_config γ dq -∗ tlb_inv root_ppn -∗
  ...
  Proof.
    ...
    iDestruct "Hmieb" as (mie_v mdv0) "(Hmie & Hmdl & %Hmm)".
    iDestruct "Hmenvb" as (menvcfg0) "(Hmenv & %HPBMTE & %Hpmm & %Hlpe & %Hfiom & %Hmenvval0)".
    iApply (wp_cli_gpr_s_config root_ppn Φ pc rd imm m mstatus0 mie_v mdv0 menvcfg0 (dq:=dq)
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
              with "Hhw Hinv Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile Hinstr").
    iIntros "Hhs Hpriv Hms Hmie Hmdl Hmenv Htlbinv Hpc Hfile".
    iDestruct (smode_config_rebuild γ dq mstatus0 mie_v mdv0 menvcfg0
  ...
  Lemma wp_caddi4spn_gpr_s (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rdc : cregidx) (nzimm : mword 8) (rd : mword 5)
      (m : gmap regidx (mword 64)) {dq : dfrac} :
    creg2reg_idx rdc = Regidx rd ->
    uint rd <> 0 ->
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrdc Hrd
  ...
  Lemma wp_caddi_gpr_s (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rd : mword 5) (imm : mword 6)
      (m : gmap regidx (mword 64)) {dq : dfrac} :
    uint rd <> 0 ->
    smode_config γ dq -∗
 ...
 HSIE HMPRV HSXL Hmm HPBMTE Hmenvval0 Hrd
  ...
  Lemma wp_sltiu_s (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
 ...
 Hrd _
  ...
  Lemma wp_addi_s (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
      (pc : mword 64) (rd rs1 : mword 5) (imm : mword 12) (wval : mword 64)
      (m : gmap regidx (mword 64)) {dq : dfrac} :
    uint rd <> 0 ->
 ...
 Hrd _
  ...
  Lemma wp_cli_s (root_ppn : mword 44) (γ : gname) (Φ : mval -> iProp Σ)
  ...
  Proof.
    iIntros (Hrd Hwval) "Hsm Htlbinv Hpc Hfile Hinstr Hcont".
    unshelve iApply (wp_gpr_write_s_config_scfg root_ppn γ Φ pc rd
              (zero_extend' 5 ('b"00")) (zero_extend' 5 ('b"00"))

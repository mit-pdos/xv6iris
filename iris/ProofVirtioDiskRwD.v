...
Section VdrwdP4.
  ...
  Proof.
    ...
    iApply (wp_cld_s_sconf Φ (mword_of_int (VRW + 0x162) : mword 64) Ra3 Ra5
    ...
    iApply (wp_candi_s_sconf Φ (mword_of_int (VRW + 0x168) : mword 64) Ra4
    ...
    iApply (wp_cslli_s_sconf Φ (mword_of_int (VRW + 0x16a) : mword 64)
    ...
    (* ---- +0x172  fence rw,rw ---- *)
    iApply (wp_fence_gen_s_sconf Φ (mword_of_int (VRW + 0x172) : mword 64)
    ...
    iApply (wp_cld_s_sconf Φ (mword_of_int (VRW + 0x176) : mword 64) Ra4 Ra5
    ...
    (* ---- +0x17c  c.addiw a5,a5,1 ---- *)
    iApply (wp_caddiw_s_sconf Φ (mword_of_int (VRW + 0x17c) : mword 64) Ra5
    ...
    (* ---- +0x182  fence rw,rw ---- *)
    iApply (wp_fence_gen_s_sconf Φ (mword_of_int (VRW + 0x182) : mword 64)
              (mword_of_int 0) (mword_of_int 3) (mword_of_int 3)

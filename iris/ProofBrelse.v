...
Section ProofBrelse.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x64)) Ra0 Ra0 (mword_of_int 1334 : mword 12)
    ...
    set (T2 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (T1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1334 : mword 12)))]> T1).
    ...
    (* +0x68 jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x68)) Rra (mword_of_int 2088866 : mword 21)
  ...
  Proof.
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x14)) Rra (mword_of_int 4904 : mword 21)
    ...
    assert (Htgthsl : add_vec (mword_of_int (KernelSyms.brelse + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 4904 : mword 21))
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x1c)) Rra (mword_of_int 4840 : mword 21)
    ...
    assert (Htgtrsl : add_vec (mword_of_int (KernelSyms.brelse + 0x1c) : mword 64)
                        (sign_extend' 64 (mword_of_int 4840 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x24)) Ra0 Ra0 (mword_of_int 1398 : mword 12)
              U1 (K - 4)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi24 [-]").
    iIntros (CID17 Hs17) "Hcg Hpc".
    iEval (rgpeel) in "Hcg".
    set (U2 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (U1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1398 : mword 12)))]> U1).
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x28)) Rra (mword_of_int 2088794 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.brelse + 0x28) : mword 64)
                        (sign_extend' 64 (mword_of_int 2088794 : mword 21))
    ...
    - assert (Hq : q = qt) by (apply Hsole; reflexivity). subst qt.
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x42)) Ra5 Ra5 (mword_of_int 1368 : mword 12)
      ...
      set (E5 := <[Regidx Ra5 := regval_into_reg
                    (add_vec (E4 !!! Regidx Ra5) (sign_extend' 64 (mword_of_int 1368 : mword 12)))]> E4).
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x50)) Ra4 Ra4 (mword_of_int 1970 : mword 12)
      ...
      set (E8 := <[Regidx Ra4 := regval_into_reg
                    (add_vec (E7 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1970 : mword 12)))]> E7).

...
Section ProofBrelse.
  ...
  Local Lemma wp_csdsp_au_s_sconf `{CID0 : CpuId} 
    ...
    (|={⊤ ∖ ↑minstretN, Em}=> ∃ vold : mword 64,
       ...
       (add_vec (m0 !!! Regidx csp_rs1) (zero_extend' 64 (concat_vec uimm ('b"000")))
          ↦₈[KT1] (rget m0 rs2) ={Em, ⊤ ∖ ↑minstretN}=∗ Ψ)) -∗
  ...
  Local Lemma brelse_tail `{CID0 : CpuId}  (bn : bio_names)
    ...
    is_lock (bn_lk bn) bcache_addr "bcache"%string (fun ξ => bcache_res2 bn V ξ) -∗
    locked (bn_lk bn) cpu_id -∗
    bd_scan2_after bn V tl -∗
    cpu_own 1%nat eb p false ({["bcache"]} ∪ lks) -∗
    arm_pay KT1 0%nat eb p -∗
  ...
  Proof using .
    ...
    set (spr := add_vec (m !!! Regidx csp_rs1 : mword 64)
                  (sign_extend' 64 (sign_extend' 12 (mword_of_int 32 : mword 6)))).
    iIntros "Hcg #Htext Hpc #Hlock Htok Hafter Hcnt Hpay Hr24 Hr16 Hr8 Hg4 Hcont".
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x64)) Ra0 Ra0 (mword_of_int 1690 : mword 12)
              T1 (trap_res eb + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    { iApply (bri_64 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (T2 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (T1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1690 : mword 12)))]> T1).
    ...
    (* +0x68 jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x68)) Rra (mword_of_int 2088650 : mword 21)
              T2 (trap_res eb + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              ltac:(vm_compute; reflexivity) with "Hcg Hpc []").
    { iApply (bri_68 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Htgtrel : add_vec (mword_of_int (KernelSyms.brelse + 0x68) : mword 64)
                        (sign_extend' 64 (mword_of_int 2088650 : mword 21))
  ...
  Proof using .
    ...
    iEval (rewrite (wordw8_ctx (KTR2 := KT1))) in "Hr24".
    (* ===== THE PARK (box v2, lemma (f)): a deposit of the whole bundle
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x14)) Rra (mword_of_int 5006 : mword 21)
    ...
    assert (Htgthsl : add_vec (mword_of_int (KernelSyms.brelse + 0x14) : mword 64)
                        (sign_extend' 64 (mword_of_int 5006 : mword 21))
 ...
 Upr ltac:(lia) Hbelow_sl
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x1c)) Rra (mword_of_int 4942 : mword 21)
    ...
    assert (Htgtrsl : add_vec (mword_of_int (KernelSyms.brelse + 0x1c) : mword 64)
                        (sign_extend' 64 (mword_of_int 4942 : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x24)) Ra0 Ra0 (mword_of_int 1754 : mword 12)
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.brelse + 0x28)) Rra (mword_of_int 2088578 : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.brelse + 0x28) : mword 64)
                        (sign_extend' 64 (mword_of_int 2088578 : mword 21))
    ...
    iDestruct (cpu_own_transport CID15 CID18 0%nat b p b ltac:(wp_next_chain)
                 with "Hcnt") as "Hcnt".
    iApply (Aq.wp_acquire_sconf KT1 (bn_lk bn) "bcache"%string (fun ξ => bcache_res2 bn V ξ) U3
    ...
    assert (Hs64 : sign_extend' 64 (mword_of_int 64 : mword 12) = (mword_of_int 64 : mword 64))
      by (apply bv_eq; vm_compute; reflexivity).
    (* BOX v2: the decrement is lemma (d) through [bcache_scan2_decr0]; the
       count word comes out, the wand takes the decremented word back *)
    iDestruct (bcache_res2_to_scan bn V with "HRres") as (Mg ord devs bnos tl) "(#Hfl & #Hllbtl & Hscan)".
    iDestruct (bcache_scan2_decr0 bn V Mg ord devs bnos tl k dev bno ⊤ ltac:(solve_ndisj) Hk
                 with "Hbox Hfl Hllbtl Hscan [Hbr0 Hgh]") as (cnt) "(%Hcnt & Hcell & Hclose)".
    { rewrite /bchain. iFrame "Hbr0 Hgh". }
    ...
    - 
      ...
      iApply (wp_clw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x2c)) Ra5 Rs1 (mword_of_int 64 : mword 12)
                mQ (trap_res b + (K - 4))%nat (mword_of_int (Z.pos 1) : mword 32) false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc [] Hcell").
      { iApply (bri_2c with "Htext"). }
      iApply wp_next_off_intro.
      ...
      (* the ghost step: lemma (d) at count 1 -- the content stays in the
         box; the scan comes back at the synced floor slot *)
      ...
      iApply (wp_cld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x36)) Ra5 Rs1 (mword_of_int 72 : mword 12)
                E1 (trap_res b + (K - 4))%nat (List.last (map bnode o1) bhead) false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc [] [Hbp]").
      { iApply (bri_36 with "Htext"). }
      ...
      iApply (wp_csd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x38)) Ra5 Ra4 (mword_of_int 72 : mword 12)
                E2 (trap_res b + (K - 4))%nat (bnode k) false with "Hcg Hpc [] [Hsp]").
      { iApply (bri_38 with "Htext"). }
      ...
      iApply (wp_cld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x3a)) Ra4 Rs1 (mword_of_int 80 : mword 12)
                E2 (trap_res b + (K - 4))%nat (List.hd bhead (map bnode o2)) false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc [] [Hbn]").
      { iApply (bri_3a with "Htext"). }
      ...
      iApply (wp_csd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x3c)) Ra4 Ra5 (mword_of_int 80 : mword 12)
                E3 (trap_res b + (K - 4))%nat (bnode k) false with "Hcg Hpc [] [Hpn]").
      { iApply (bri_3c with "Htext"). }
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x42)) Ra5 Ra5 (mword_of_int 1724 : mword 12)
                E4 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      { iApply (bri_42 with "Htext"). }
      iApply wp_next_off_intro.
      iIntros "Hcg Hpc".
      iEval (rgpeel) in "Hcg".
      set (E5 := <[Regidx Ra5 := regval_into_reg
                    (add_vec (E4 !!! Regidx Ra5) (sign_extend' 64 (mword_of_int 1724 : mword 12)))]> E4).
      ...
      iApply (wp_ld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x46)) Ra4 Ra5 (mword_of_int 696 : mword 12)
                E5 (trap_res b + (K - 4))%nat (List.hd bhead (map bnode o1 ++ map bnode o2)%list) false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc [] [Hhn]").
      { iApply (bri_46 with "Htext"). }
      ...
      iApply (wp_csd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x4a)) Ra4 Rs1 (mword_of_int 80 : mword 12)
                E6 (trap_res b + (K - 4))%nat (List.hd bhead (map bnode o2)) false
                with "Hcg Hpc [] [Hbn]").
      { iApply (bri_4a with "Htext"). }
      ...
      iApply (wp_auipc_s_sconf (mword_of_int (KernelSyms.brelse + 0x4c)) Ra4 (mword_of_int 30 : mword 20)
                E6 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      { iApply (bri_4c with "Htext"). }
      iApply wp_next_off_intro.
      iIntros "Hcg Hpc".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.brelse + 0x50)) Ra4 Ra4 (mword_of_int 2326 : mword 12)
                E7 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc []").
      { iApply (bri_50 with "Htext"). }
      iApply wp_next_off_intro.
      iIntros "Hcg Hpc".
      iEval (rgpeel) in "Hcg".
      set (E8 := <[Regidx Ra4 := regval_into_reg
                    (add_vec (E7 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 2326 : mword 12)))]> E7).
      ...
      iApply (wp_csd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x54)) Ra4 Rs1 (mword_of_int 72 : mword 12)
                E8 (trap_res b + (K - 4))%nat (List.last (map bnode o1) bhead) false
                with "Hcg Hpc [] [Hbp]").
      { iApply (bri_54 with "Htext"). }
      ...
      iApply (wp_ld_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x56)) Ra4 Ra5 (mword_of_int 696 : mword 12)
                E8 (trap_res b + (K - 4))%nat (List.hd bhead (map bnode o1 ++ map bnode o2)%list) false
                ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc [] [Hhn]").
      { iApply (bri_56 with "Htext"). }
      ...
      iApply (wp_csd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x5a)) Rs1 Ra4 (mword_of_int 72 : mword 12)
                E9 (trap_res b + (K - 4))%nat bhead false with "Hcg Hpc [] [Hhp]").
      { iApply (bri_5a with "Htext"). }
      ...
      iApply (wp_sd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.brelse + 0x5c)) Rs1 Ra5 (mword_of_int 696 : mword 12)
                E9 (trap_res b + (K - 4))%nat (List.hd bhead (map bnode o1 ++ map bnode o2)%list) false
                with "Hcg Hpc [] [Hhn]").
      { iApply (bri_5c with "Htext"). }
      ...
      iAssert (bd_scan2_after bn V tl) with "[Hauth Hsauth Hlru Hpool Hslots]" as "Hafter".
      { iExists Mg, (k :: (o1 ++ o2))%list, devs, bnos, tl'.
        iSplitR; [iPureIntro; exact Htl'|].
        iSplitR; [iExact "Hllbtl'"|].
    ...
    - assert (Hex : exists c', cnt = Pos.succ c').
      ...
      { rewrite HD2a5. apply trunc32_sext. }
      iEval (rewrite Hstv) in "Hcell".
      (* the ghost step: lemma (d); the scan comes back at the synced slot *)
      iEval (rewrite -Hzp) in "Hcell".
      iApply fupd_wp.
      iMod ("Hclose" with "Hcell") as "[Hafter Hout]".
      iModIntro.

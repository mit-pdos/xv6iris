...
Module Type NAMEIPARENT.
  Parameter wp_nameiparent_sconf :
    forall `{!riscvGS Σ, !xv6G Σ, !bioslotG Σ, !fdslotG Σ, !fileG Σ,
      ...
      (m : regfile) (K : nat) (eb : bool)
      (b : bool) (lks : gset string) (Vpr : pprivate),
      wp_nameiparent_sconf_body gs j gl gu gd gk pd pav pu bn
                                ga gf bmapstart
                                size plen pfun nfun n
  ...
  Parameter wp_nameiparent_gen :
    forall `{!riscvGS Σ, !xv6G Σ, !bioslotG Σ, !fdslotG Σ, !fileG Σ,
      ...
      (m : regfile) (K : nat) (eb : bool)
      (b : bool) (lks : gset string) (Vpr : pprivate),
      wp_nameiparent_gen_body gs j gl gu gd gk pd pav pu bn
                                ga gf bmapstart
                                size plen pfun nfun n Sb
                                pidv dq dqb dqs dqpv m K eb b lks Vpr.
End NAMEIPARENT.

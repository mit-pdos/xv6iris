...
Section FsinitMain.
 ...
 v_magic v_size v_nblocks v_nlog
    ...
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.fsinit + 0x26)) Rra
              (mword_of_int 2086718 : mword 21) N5 (K - 4)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Htgtmm : add_vec (mword_of_int (KernelSyms.fsinit + 0x26) : mword 64)
                       (sign_extend' 64 (mword_of_int 2086718 : mword 21))
    ...
    assert (Hmgadr : add_vec (rget Q2 Ra4)
                       (sign_extend' 64 (mword_of_int 746 : mword 12))
                     = sb_magic).
    ...
    iApply (wp_lw_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.fsinit + 0x34)) Ra4 Ra4
              (mword_of_int 746 : mword 12) Q2 (K - 4)%nat v_magic b
    ...
    iApply (IL.wp_initlog_sconf γs j γl fsc_uart fsc_disk fsc_dlock pd pav pu fsc_bio icfg_log fsc_fs fsc_printk
              ...
              pidv dq (DfracOwn 1) Q9 (K - 4)%nat eb b lks Upr
              bs_sb sbrec
 ...
 v_magic v_size v_nblocks
              v_nlog pidv dq m mf K eb b lks Upr HK Hmfsp Hmfthr

...
Section ProofFilealloc.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x0e)) Ra0 Ra0 (mword_of_int 0x460 : mword 12)
              R3 (K - 4)%nat b ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi0e").
    iIntros (CID7 Hs7) "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (R4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1120 : mword 12)))]> R3).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x1a)) Rs1 Rs1 (mword_of_int 0x46c : mword 12)
              R6 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi1a").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (R7 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (R6 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 1132 : mword 12)))]> R6).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x22)) Ra4 Ra4 (mword_of_int 0x404 : mword 12)
              R8 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc Hi22").
    iApply wp_next_off_intro. iIntros "Hcg Hpc".
    iEval (rgne) in "Hcg".
    set (R9 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (R8 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 1028 : mword 12)))]> R8).
    ...
    { iIntros (i Mi) "(%Hi & %HMgi & %Mis1 & %Mithr) Hcg Hpc Hslots".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x4a)) Ra0 Ra0 (mword_of_int 0x424 : mword 12)
                F2 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi4a").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      iEval (rgne) in "Hcg".
      set (F3 := <[Regidx Ra0 := regval_into_reg
                    (add_vec (F2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1060 : mword 12)))]> F2).
    ...
    { iIntros (Mf) "%Mfthr Hcg Hpc Hslots".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x36)) Ra0 Ra0 (mword_of_int 0x438 : mword 12)
                G1 (trap_res b + (K - 4))%nat false ltac:(vm_compute; discriminate) ltac:(rdok)
                with "Hcg Hpc Hi36").
      iApply wp_next_off_intro. iIntros "Hcg Hpc".
      iEval (rgne) in "Hcg".
      set (G2 := <[Regidx Ra0 := regval_into_reg
                    (add_vec (G1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 1080 : mword 12)))]> G1).

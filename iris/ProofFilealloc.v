...
Section ProofFilealloc.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x0e)) Ra0 Ra0 (mword_of_int 0x49e : mword 12)
    ...
    (* ===== +0x12 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x12)) Rra (mword_of_int 0x1fcc3e : mword 21)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x1a)) Rs1 Rs1 (mword_of_int 0x4aa : mword 12)
    ...
    iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x22)) Ra4 Ra4 (mword_of_int 0x442 : mword 12)
    ...
    { iIntros (i Mi) "(%Hi & %HMgi & %Mis1 & %Mithr) Hcg Hpc Hslots".
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x4a)) Ra0 Ra0 (mword_of_int 0x462 : mword 12)
      ...
      (* +0x4e jal ra,release *)
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x4e)) Rra (mword_of_int 0x1fcc8a : mword 21)
    ...
    { iIntros (Mf) "%Mfthr Hcg Hpc Hslots".
      ...
      iApply (wp_addi4_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x36)) Ra0 Ra0 (mword_of_int 0x476 : mword 12)
      ...
      (* +0x3a jal ra,release *)
      iApply (wp_jal_s_sconf Φ (mword_of_int (KernelSyms.filealloc + 0x3a)) Rra (mword_of_int 0x1fcc9e : mword 21)

...
Section ProofFilealloc.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x0e)) Ra0 Ra0 (mword_of_int 0x3c6 : mword 12)
    ...
    set (R4 := <[Regidx Ra0 := regval_into_reg
                  (add_vec (R3 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 966 : mword 12)))]> R3).
    ...
    (* ===== +0x12 jal ra,acquire ===== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filealloc + 0x12)) Rra (mword_of_int 0x1fcace : mword 21)
    ...
    assert (Htgtacq : add_vec (mword_of_int (KernelSyms.filealloc + 0x12) : mword 64)
                        (sign_extend' 64 (mword_of_int 0x1fcace : mword 21))
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x1a)) Rs1 Rs1 (mword_of_int 0x3d2 : mword 12)
    ...
    set (R7 := <[Regidx Rs1 := regval_into_reg
                  (add_vec (R6 !!! Regidx Rs1) (sign_extend' 64 (mword_of_int 978 : mword 12)))]> R6).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x22)) Ra4 Ra4 (mword_of_int 0x36a : mword 12)
    ...
    set (R9 := <[Regidx Ra4 := regval_into_reg
                  (add_vec (R8 !!! Regidx Ra4) (sign_extend' 64 (mword_of_int 874 : mword 12)))]> R8).
    ...
    { iIntros (i Mi) "(%Hi & %HMgi & %Mis1 & %Mithr) Hcg Hpc Hslots".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x4a)) Ra0 Ra0 (mword_of_int 0x38a : mword 12)
      ...
      set (F3 := <[Regidx Ra0 := regval_into_reg
                    (add_vec (F2 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 906 : mword 12)))]> F2).
      ...
      (* +0x4e jal ra,release *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filealloc + 0x4e)) Rra (mword_of_int 0x1fcb1a : mword 21)
    ...
    { iIntros (Mf) "%Mfthr Hcg Hpc Hslots".
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.filealloc + 0x36)) Ra0 Ra0 (mword_of_int 0x39e : mword 12)
      ...
      set (G2 := <[Regidx Ra0 := regval_into_reg
                    (add_vec (G1 !!! Regidx Ra0) (sign_extend' 64 (mword_of_int 926 : mword 12)))]> G1).
      ...
      (* +0x3a jal ra,release *)
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.filealloc + 0x3a)) Rra (mword_of_int 0x1fcb2e : mword 21)
      ...
      assert (Htgtrel : add_vec (mword_of_int (KernelSyms.filealloc + 0x3a) : mword 64)
                          (sign_extend' 64 (mword_of_int 0x1fcb2e : mword 21))
                        = mword_of_int KernelSyms.release)
        by (apply bv_eq; vm_compute; reflexivity).
      iEval (rewrite Htgtrel) in "Hpc".

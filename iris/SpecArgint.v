...
Definition wp_argint_sconf_body `{!riscvGS Σ, !sieG Σ, !lockG Σ, !fdslotG Σ, !fileG Σ} `{GEN : GenId} `{CID : CpuId}
    (Φ : mval -> iProp Σ)
...
Module Type ARGINT.
  Parameter wp_argint_sconf :
    forall `{!riscvGS Σ, !sieG Σ, !lockG Σ, !fdslotG Σ, !fileG Σ} `{GEN : GenId} `{CID : CpuId}
      ...
      (i : nat) (tfp : mword 44) (ws : list (mword 64)) (v : mword 64)
      (old : mword 32) (dqt : dfrac) (b : bool),
      wp_argint_sconf_body Φ m av n eb p C i tfp ws v old dqt b.
End ARGINT.

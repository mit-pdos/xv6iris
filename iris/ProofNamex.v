...
Section ProofNamexMain.
  ...
  Lemma wp_namex_gen
    ...
    : wp_namex_gen_body gs j gl gu gd gk pd pav pu bn g gi gtl
  ...
  Proof.
    ...
    iIntros "Hcg Hcnt Hextc Hclmc #Htext #Hkd Hpc #Hpenv #Hbio #Hlogc #Hkenv #Hitb2 #Hitbl
              ...
              #Hbits Hppid Hcwdr Hpath Hname Hbslot Hislot [Hlog Htx] Hcont".
        ...
        + (* ================= EXIT A: nothing but separators left ======= *)
          ...
          * (* ---- the +0x140 tail ---- *)
            ...
            -- (* nameiparent of a path with no elements left: iput, a0 = 0 *)
               ...
               iDestruct (nx_esc_acc gi logstart pk Hpk with "Hesc")
                 as "#Hescp".
               ...
               iApply (IP.wp_iput_gen gs j gl gu gd gk pd pav pu bn g gi
                         gtl gilp gislp logstart bmapstart inodestart
               ...
               iAssert (wp_next (CID0 := CIDl) true (proc_addr j)
                          (fun CIDt : CpuId =>
                             nx_rest_body j b K m sp0 pv nb plen a e pfun ipv ncur
                                          Scur eb g bn logstart bmapstart
                   ...
                   + (* ============ IT IS A DIRECTORY ============ *)
                     ...
                     * (* ---- NAMEIPARENT stops one level early: +0x84 ---- *)
                       ...
                       iDestruct (cpu_claim_ext_transport CIDil CIDP5 eb (proc_addr j)
                                    ltac:(try rewrite Hebb; wp_next_chain) with "Hclmc") as "Hclmc".
                       iApply (IU.wp_iunlock_tx_sconf gs gi gilk gislk
                                 logstart ik (iq/2)%Qp gsh dev iinum dnl bml
...
"[%] [%] Hcg Hcnt Hextc Hclmc Hpc
    ...
    + (* ---------------- THE RELATIVE ARM: idup(myproc()->cwd) ---------- *)
      ...
      (* idup's contract widened in increment IVe (iclaim-ledger.md §3.19):
         ...
         above was given. *)
      iApply (ID.wp_idup_sconf gtl gi logstart inodestart nib
  ...
  Lemma wp_namex_sconf
      ...
      (m : regfile) (K : nat) (eb : bool)
      (b : bool) (lks : gset string) (Vpr : pprivate)
    : wp_namex_sconf_body gs j gl gu gd gk pd pav pu bn g gi gtl
                          ga gf logstart bmapstart inodestart nib
  ...
  Proof.
    ...
    (* THE WITNESS: the set the counted reservation was hiding.  The walk
    ...
    iApply (wp_namex_gen gs j gl gu gd gk pd pav pu bn g gi gtl

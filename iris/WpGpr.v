...
Section WpAddGpr.
  ...
  Proof.
    ...
    iExists (sFcg s pc b1 rs2 rs1 rd mst0). iSplitR.
    { iPureIntro.
      rewrite <- (sFg_eq s pc b1 rs2 rs1 rd mst0 Lpc Lmst).
...
Section WpAddGprDemo.
  ...
  Definition wp_add_x5_x6_x7 (pc : mword 64) (w : mword 32) :=
    wp_add_gpr pc w (mword_of_int 7) (mword_of_int 6) (mword_of_int 5).
  (* `add x28, x1, x2` : rd=x28, rs1=x1, rs2=x2.  SAME lemma, different regs. *)
  Definition wp_add_x28_x1_x2 (pc : mword 64) (w : mword 32) :=
    wp_add_gpr pc w (mword_of_int 2) (mword_of_int 1) (mword_of_int 28).

...
Section ProofSleepPrepare.
  ...
  Proof.
    ...
    (* ===================== p = myproc() ===================== *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sleep_prepare + 0x0e)) spr_ra (mword_of_int 2095524 : mword 21)
              A2 (av - 4)%nat b
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.sleep_prepare + 0x0e) : mword 64) (sign_extend' 64 (mword_of_int 2095524 : mword 21)) = mword_of_int KernelSyms.myproc)
    ...
    (* +0x14: jal ra,acquire *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sleep_prepare + 0x14)) spr_ra (mword_of_int 2092158 : mword 21)
              B1 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    ...
    assert (Hjacq : add_vec (mword_of_int (KernelSyms.sleep_prepare + 0x14) : mword 64) (sign_extend' 64 (mword_of_int 2092158 : mword 21)) = mword_of_int KernelSyms.acquire)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iDestruct (cpu_own_transport CID9 CID11 n eb pj b ltac:(wp_next_chain)
                 with "Hcpu") as "Hcpu".
    iApply (Acquire.wp_acquire_sconf KT1 γl "proc"%string (proc_lock_pay γs γl (proc_addr j)) B2 n eb pj (av - 4)%nat b lks
              Hn ltac:(lia) Hno
    ...
    iApply (wp_sd_s_sconf (kt := KT1) (ktd := KT0) (mword_of_int (KernelSyms.sleep_prepare + 0x1a)) spr_s1 spr_s2
              ...
              with "Hcg Hpc [] [Hchcell]").
    { iApply (spri_1a with "Htext"). }
    ...
    (* +0x20: jal ra,release *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.sleep_prepare + 0x20)) spr_ra (mword_of_int 2092282 : mword 21)
              C1 (trap_res b + (av - 4))%nat false
              ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc []").
    { iApply (spri_20 with "Htext"). }
    iApply wp_next_off_intro.
    iIntros "Hcg Hpc".
    ...
    assert (Hjrel : add_vec (mword_of_int (KernelSyms.sleep_prepare + 0x20) : mword 64) (sign_extend' 64 (mword_of_int 2092282 : mword 21)) = mword_of_int KernelSyms.release)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (Release.wp_release_sconf KT1 γl (proc_addr j) "proc"%string (proc_lock_pay γs γl (proc_addr j)) C2 n eb pj (av - 4)%nat
              ({["proc"]} ∪ lks)
              Hlka ltac:(lia)

    ...
    { iIntros (fuel). iInduction fuel as [|fuel IHf] "IHf".
      ...
      { iModIntro.
        ...
        iApply (wp_jal_s_sconf (CID := CIDq2)
                  ...
                  (mword_of_int 2089306 : mword 21) P5a K' b
        ...
        assert (Htgtpk1 : add_vec
                            ...
                            (sign_extend' 64 (mword_of_int 2089306 : mword 21))
        ...
        iApply (wp_jal_s_sconf (CID := CIDq5)
                  ...
                  (mword_of_int 2089300 : mword 21) P60 K' b
                  ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
                  with "Hcg Hpc Hi62").
        ...
        assert (Htgtpk2 : add_vec
                            ...
                            (sign_extend' 64 (mword_of_int 2089300 : mword 21))
                          = mword_of_int KernelSyms.printk) by pcw.

(* ProofArgraw.v -- whole-function WP for argraw(), the first proof in the
   ...
   table in .rodata at 0x80007768: six self-relative 4-byte offsets, indexed
...
Section ProofArgraw.
  ...
  Proof.
    ...
    (* +0x0c: jal ra,myproc *)
    iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.argraw + 0x0c)) ar_ra (mword_of_int 2093386 : mword 21)
              A2 (av - 4)%nat b
    ...
    assert (Hjmp : add_vec (mword_of_int (KernelSyms.argraw + 0x0c) : mword 64) (sign_extend' 64 (mword_of_int 2093386 : mword 21)) = mword_of_int KernelSyms.myproc)
      by (apply bv_eq; vm_compute; reflexivity).
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.argraw + 0x1c)) ar_a4 ar_a4 (mword_of_int 3894 : mword 12)
              B2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (B3 := <[Regidx ar_a4 := regval_into_reg
        (add_vec (B2 !!! Regidx ar_a4) (sign_extend' 64 (mword_of_int 3894 : mword 12)))]> B2).
    change (<[Regidx ar_a4 := regval_into_reg
        (add_vec (B2 !!! Regidx ar_a4) (sign_extend' 64 (mword_of_int 3894 : mword 12)))]> B2) with B3.

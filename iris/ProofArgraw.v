...
Section ProofArgraw.
  ...
  Proof.
    ...
    iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.argraw + 0x1c)) ar_a4 ar_a4 (mword_of_int 4090 : mword 12)
              B2 (av - 4)%nat b
              ltac:(vm_compute; discriminate) ltac:(rdok)
              with "Hcg Hpc []").
    ...
    set (B3 := <[Regidx ar_a4 := regval_into_reg
        (add_vec (B2 !!! Regidx ar_a4) (sign_extend' 64 (mword_of_int 4090 : mword 12)))]> B2).
    change (<[Regidx ar_a4 := regval_into_reg
        (add_vec (B2 !!! Regidx ar_a4) (sign_extend' 64 (mword_of_int 4090 : mword 12)))]> B2) with B3.

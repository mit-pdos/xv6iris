...
Section ProofSysOpenBody.
  ...
  Proof.
    ...
    iIntros "Hcg Hown Htce Hcce #Htext #Hkd Hpc #Hpenv #Hbio #Hlog Hseam Hgen
              ...
              Hload #Hshot Hfrz Hkeep Hfref Hflive Hflds Hfpn Hfip Hfoff
    ...
    iApply (Tails.so_tail_s (CID0 := CID0) gs jx gl gu gd gk pd pav pu bn g gfs
              ...
              with "Hcg Hown Htce Hcce Htext Hkd Hpc Hpenv Hbio Hlog Hseam Hgen
                    Hitinv Hesck Hslkk Hslkd Hslpid Hdep Hidev Hiinum Hivalid
                    Hload Hshot Hfrz Hpidq Hprocs Hdev Hgeo Hdlk Hop Hf1 Hf2 Hf3
                    Hf4
                    Hf5 Hf6 HbP H23 H24
  ...
  Proof.
    ...
    iIntros "Hcg Hown Htce Hcce #Htext #Hkd Hpc #Hpenv #Hbio #Hlog Hseam Hgen
              ...
              Hivalid Hload #Hshot Hfrz Hkeep Hfref Hflive Hfpn Hfty Hfrd Hfwr
    ...
    { (* ---- no O_TRUNC: straight to ARM S ---- *)
      ...
      iApply (so_tail_pub (CID0 := CID10) gf gs jx gl gu gd gk pd pav pu bn g
                ...
                with "Hcg Hown Htce Hcce Htext Hkd Hpc Hpenv Hbio Hlog Hseam Hgen
                      Hitinv Hesck Hslkk Hslkd Hslpid Hdep Hidev Hiinum Hivalid
                      Hload Hshot Hfrz Hkeep Hfref Hflive Hflds Hfpn Hfip2 Hfoff
    ...
    iApply (wp_jal_s_sconf (CID := CID14) (mword_of_int (SO + 0x150)) Rra
              (mword_of_int 2089112 : mword 21) P1 (K - 24)%nat b
    ...
    assert (Hjit : add_vec (mword_of_int (SO + 0x150) : mword 64)
                     (sign_extend' 64 (mword_of_int 2089112 : mword 21))
  ...
  Proof.
    ...
    iIntros "Hcg Hown Htce Hcce #Htext #Hdata Hpc #Hpe #Hftab #Hbio #Hlog
              ...
              Hidev Hiinum Hivalid Hload #Hshot Hfrz Hkeep Hpriv #Hprocs #Hdev #Hgeo
    ...
    iPoseProof (soi_066 with "Htext") as "Hi66".
    iPoseProof (soi_068 with "Htext") as "Hi68".
    iPoseProof (soi_06a with "Htext") as "Hi6a".
    iPoseProof (soi_06e with "Htext") as "Hi6e".
    iPoseProof (soi_070 with "Htext") as "Hi70".
    iPoseProof (soi_074 with "Htext") as "Hi74".
    iPoseProof (soi_078 with "Htext") as "Hi78".
    iPoseProof (soi_07a with "Htext") as "Hi7a".
    iPoseProof (soi_07e with "Htext") as "Hi7e".
    iPoseProof (soi_080 with "Htext") as "Hi80".
    iPoseProof (soi_084 with "Htext") as "Hi84".
    ...
    iApply (wp_jal_s_sconf (CID := CID1) (mword_of_int (SO + 0x60)) Rra
              (mword_of_int 2092826 : mword 21) N (K - 24)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi60").
    ...
    assert (Hjfa : add_vec (mword_of_int (SO + 0x60) : mword 64)
                     (sign_extend' 64 (mword_of_int 2092826 : mword 21))
    ...
    iApply (wp_cmv_s_sconf (CID := CID3) (mword_of_int (SO + 0x64)) Rs2 Ra0
              mfa (K - 24)%nat b ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi64").
    iIntros (CID4 Hq4) "Hcg Hpc".
    ...
    { (* ---- filealloc refused ---- *)
      ...
      iDestruct (so_omode_join sp0 lo om Hal23 with "H23lo H23hi") as "H23".
      iDestruct (proc_priv_pid with "Hpriv") as "[Hpidq Hpback]".
      ...
      iApply (Tails.so_tail_e (CID0 := CID5) gs jx gl gu gd gk pd pav pu bn g
                ...
                icfg_nib size icfg_dev used kk qi s gy inum dn bm u pidv
                ...
                with "Hcg Hown Htce Hcce Htext Hdata Hpc Hpe Hbio Hlog Hseam Hgen
                      ...
                      Hiinum Hivalid Hload Hshot Hfrz Hkeep Hsbb Hsbi Hbmres Hpidq
      ...
      iIntros (CIDy) "%Hqy". iIntros (mf used2)
        "%Hcsf %Ha0f %Hused2 Hcg Hown Htce Hcce Hpc Hpidq Hsbb Hsbi Hbmres
         Hbsl Hislot".
    ...
    iApply (wp_cmv_s_sconf (CID := CID8) (mword_of_int (SO + 0x6e)) Rs3 Ra0
              mfd (K - 24)%nat b ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi6e").
    iIntros (CID9 Hq9) "Hcg Hpc".
    ...
    { (* ---- fdalloc refused ---- *)
      ...
      iApply (Tails.so_tail_f (CID0 := CID10) gfl gf gs jx gl gu gd gk pd pav
                ...
                inodestart icfg_nib size icfg_dev used kk qi s gy inum dn bm
    ...
    { (* ---- T_DEVICE: the +0x140 block ---- *)
      iPoseProof (soi_140 with "Htext") as "Hi140".
      iPoseProof (soi_144 with "Htext") as "Hi144".
      iPoseProof (soi_148 with "Htext") as "Hi148".
      iPoseProof (soi_14c with "Htext") as "Hi14c".
      ...
      iApply (so_stores (CID0 := CID17) gf gs jx gl gu gd gk pd pav pu bn g
                ...
                size icfg_dev used kk qi s gy inum dn bm kf fd ll pn FD_DEVICE
                ...
                with "Hcg Hown Htce Hcce Htext Hdata Hpc Hpe Hbio Hlog Hseam Hgen
                      Hitinv Hesck Hireg Hslkk Hslkd Hslpid Hdep Hidev Hiinum
                      Hivalid Hload Hshot Hfrz Hkeep Hfref Hflive Hfpn Hfty Hfrd
    ...
    iApply (so_stores (CID0 := CID16) gf gs jx gl gu gd gk pd pav pu bn g
              gfs gi cn gil gisl cov logstart bmapstart inodestart icfg_nib
              size icfg_dev used kk qi s gy inum dn bm kf fd ll pn FD_INODE
              (fc_readable Cf) (fc_writable Cf) (fc_pipe Cf) (fc_ip Cf)
  ...
  Proof.
    ...
    iPoseProof (soi_04e with "Htext") as "Hi4e".
    iPoseProof (soi_050 with "Htext") as "Hi50".
    iPoseProof (soi_054 with "Htext") as "Hi54".
    iPoseProof (soi_058 with "Htext") as "Hi58".
    iPoseProof (soi_05a with "Htext") as "Hi5a".
    (* ===== +0x4a lh a4,68(s1) ===== *)
    iDestruct (so_meta_acc with "Hload") as "[Hmeta Hlback]".
    iDestruct (so_type_acc with "Hmeta") as "[Hity Hmback]".
    iEval (rewrite /i_type) in "Hity".
    ...
    2:{ (* ---- not a device: the [major] test is skipped ---- *)
      ...
      iApply (so_alloc (CID0 := CID3) gfl gf gs jx gl gu gd gk pd pav pu bn g
                gfs gi cn gtl gil gisl cov logstart bmapstart inodestart
                icfg_nib size icfg_dev used kk qi s gy inum dn bm om lo nsj u
                ...
                with "Hcg Hown Htce Hcce Htext Hdata Hpc Hpe Hftab Hbio Hlog
                      ...
                      Hdep Hidev Hiinum Hivalid Hload Hshot Hfrz Hkeep Hpriv Hprocs
  ...
  Proof.
    ...
    iPoseProof (soi_03c with "Htext") as "Hi3c".
    iPoseProof (soi_03e with "Htext") as "Hi3e".
    iPoseProof (soi_042 with "Htext") as "Hi42".
    iPoseProof (soi_046 with "Htext") as "Hi46".
    iPoseProof (soi_048 with "Htext") as "Hi48".
    ...
    iApply (wp_cli_s_sconf (CID := CID0) (mword_of_int (SO + 0x38)) Ra3
              ...
              ltac:(nz) ltac:(rdok) ltac:(pcw) with "Hcg Hpc Hi38").
    ...
    iApply (wp_cli_s_sconf (CID := CID1) (mword_of_int (SO + 0x3a)) Ra2
              ...
              ltac:(nz) ltac:(rdok) ltac:(pcw) with "Hcg Hpc Hi3a").
    iIntros (CID2 Hq2) "Hcg Hpc".
    ...
    iApply (wp_cli_s_sconf (CID := CID2) (mword_of_int (SO + 0x3c)) Ra1
              ...
              ltac:(nz) ltac:(rdok) ltac:(pcw) with "Hcg Hpc Hi3c").
    iIntros (CID3 Hq3) "Hcg Hpc".
    ...
    iApply (Create.wp_create_sconf (CID := CID5) gs jx gl gu gd gk pd pav pu bn
              ...
              with "Hcg Hown Htext Hpc Hdata Hpre Hbio Hlog Hkenv Hitab
                    Hitinv Hescrows Hslks Hireg Hiopen Hsbn Hsbi Hsbs Hsbb
                    Hbmres
                    Hpriv [Hbufk] Hprocs Hdev Hgeo Hdlk Hbsl Hisl HopS").
    { iEval (rewrite HN5a0). iExact "Hbufk". }
    iIntros (CID6 Hq6 mcr ok made kk qi ss gy inum dn bm u1 Sb1 ns1 used1)
    ...
    iApply (wp_cmv_s_sconf (CID := CID6) (mword_of_int (SO + 0x46)) Rs1 Ra0
              mcr (K - 24)%nat b ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi46").
    iIntros (CID7 Hq7) "Hcg Hpc".
    ...
    { iEval (rewrite /wp_next). iIntros (CIDz) "%Hqz".
      ...
      iIntros "Hcg Hown Htce Hcce Hpc Hsbb Hsbi Hbmres Hbsl Hisl Hpost".
    ...
    iApply (so_join (CID0 := CID8) gfl gf gs jx gl gu gd gk pd pav pu bn g
              ...
              with "Hcg Hown [] [] Htext Hdata Hpc Hpe Hftab Hbio Hlog
                    ...
                    Hidev Hiinum Hivalid Hload Hshot Hfrz Href Hpriv Hprocs
                    Hdev
  ...
  Proof.
    ...
    iPoseProof (soi_0e4 with "Htext") as "Hie4".
    iPoseProof (soi_0e6 with "Htext") as "Hie6".
    iPoseProof (soi_0e8 with "Htext") as "Hie8".
    iPoseProof (soi_0ec with "Htext") as "Hiec".
    iPoseProof (soi_0f0 with "Htext") as "Hif0".
    iPoseProof (soi_0f2 with "Htext") as "Hif2".
    iPoseProof (soi_0f6 with "Htext") as "Hif6".
    iPoseProof (soi_0fa with "Htext") as "Hifa".
    ...
    iApply (wp_jal_s_sconf (CID := CID1) (mword_of_int (SO + 0xe0)) Rra
              (mword_of_int 2091174 : mword 21) N1 (K - 24)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hie0").
    iIntros (CID2 Hq2) "Hcg Hpc".
    ...
    assert (Hjna : add_vec (mword_of_int (SO + 0xe0) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091174 : mword 21))
    ...
    { intros c Hc N2b N8 N9 N18 N19. rewrite /N2 upd_ne; [| regne].
      exact (HN1thr c Hc N2b N8 N9 N18 N19). }
    (* ---- the process, carved for namei: the cwd REFERENCE and the pid
       quarter, and the two-slot allowance the walk takes EXACTLY. ---- *)
    iDestruct (proc_priv_split_cwd gf (proc_addr jx) pidv V with "Hpriv")
      as "[Hpnc Href]".
    iDestruct (proc_priv_nocwd_cwd_pid gf (proc_addr jx) pidv V with "Hpnc")
    ...
    iIntros (CID3 Hq3 mna n1 used1 Sb1 ok ipv w1)
    ...
    iApply (wp_cmv_s_sconf (CID := CID3) (mword_of_int (SO + 0xe4)) Rs1 Ra0
              mna (K - 24)%nat b ltac:(nz) ltac:(rdok) with "Hcg Hpc Hie4").
    iIntros (CID4 Hq4) "Hcg Hpc".
    set (P1 := <[Regidx Rs1 := regval_into_reg
    ...
    2:{ (* ---- namei refused: nothing is locked and the two slots come back ---- *)
      ...
      iIntros (CIDy) "%Hqy". iIntros (mf) "%Hcsf %Ha0f Hcg Hown Htce Hcce Hpc
                                           Hpidq".
      iDestruct ("Hpback2" with "Hpidq") as "Hpriv".
      iSpecialize ("Hcont" $! CIDy with "[%]"); [wp_next_chain |].
    ...
    iApply (wp_jal_s_sconf (CID := CID5) (mword_of_int (SO + 0xe8)) Rra
              (mword_of_int 2088978 : mword 21) P1 (K - 24)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hie8").
    iIntros (CID6 Hq6) "Hcg Hpc".
    set (P2 := <[Regidx Rra := regval_into_reg
    ...
    iApply (wp_lw_s_sconf (CID := CID10) (mword_of_int (SO + 0xf6)) Ra5 Rs0
              ...
              ltac:(nz) ltac:(rdok) with "Hcg Hpc Hif6 [H23hi]").
    ...
    iApply (Tails.so_tail_c (CID0 := CID12) gs jx gl gu gd gk pd pav pu bn g
              gfs gi cn gtl gil gisl cov logstart bmapstart inodestart nib
              size dev used1 kk (qq/2)%Qp (qq/2)%Qp gy inum dn bm n1 pidv
              (DfracOwn (1/4)) dqb dqs m Q3 sp0 K eb b lks w4 w5 w6
              (word_of_words lo om) w24 bp1
              HKup HKeo HK24 Kpop Hkk Hgeom Hsize Hbm0 Hbmcov Hbmlog Hist0
              ...
              with "Hcg Hown [] [] Htext Hdata Hpc Hpe Hbio Hlog Hseam Hgen Hitab
                    Hitinv Hesck Hireg Hslkk Hslkd Hslpid Hdep Hidev Hiinum
                    Hivalid Hload Hshot Hfrz Hkeepe Hsbb Hsbi Hbmres Hpidq Hprocs
    ...
    iEval (rewrite /wp_next).
    iIntros (CIDy) "%Hqy". iIntros (mf used2)
      "%Hcsf %Ha0f %Huse2 Hcg Hown Htce Hcce Hpc Hpidq Hsbb Hsbi Hbmres Hbsl
       Hislot".
    iDestruct ("Hpback2" with "Hpidq") as "Hpriv".
  ...
  Proof.
    ...
    iIntros "Hcg Hown _ _ #Htext #Hdata Hpc #Hpre #Hftab #Hbio #Hlog
             ...
             #Hireg #Hiopen Hsbn Hsbi Hsbs Hsbb Hbmres #Hkenv #Hprocs Hisl
             Hfds Hpriv Hcont".
    iPoseProof (printk_env_panic with "Hpre") as "#Hpe".
    ...
    iDestruct (cpu_own_eb_agree with "Hcg Hown") as %Hb. cbn in Hb.
    iPoseProof (soi_000 with "Htext") as "Hi00".
    iPoseProof (soi_002 with "Htext") as "Hi02".
    iPoseProof (soi_004 with "Htext") as "Hi04".
    iPoseProof (soi_006 with "Htext") as "Hi06".
    iPoseProof (soi_008 with "Htext") as "Hi08".
    iPoseProof (soi_00c with "Htext") as "Hi0c".
    iPoseProof (soi_00e with "Htext") as "Hi0e".
    iPoseProof (soi_012 with "Htext") as "Hi12".
    iPoseProof (soi_016 with "Htext") as "Hi16".
    iPoseProof (soi_01a with "Htext") as "Hi1a".
    iPoseProof (soi_01c with "Htext") as "Hi1c".
    iPoseProof (soi_020 with "Htext") as "Hi20".
    iPoseProof (soi_022 with "Htext") as "Hi22".
    iPoseProof (soi_024 with "Htext") as "Hi24".
    iPoseProof (soi_028 with "Htext") as "Hi28".
    iPoseProof (soi_02a with "Htext") as "Hi2a".
    iPoseProof (soi_02e with "Htext") as "Hi2e".
    iPoseProof (soi_032 with "Htext") as "Hi32".
    iPoseProof (soi_036 with "Htext") as "Hi36".
    (* ===== +0x00 c.addi16sp sp,-192 ===== *)
    iApply (wp_caddi16sp_push_s_sconf (mword_of_int SO : mword 64)
              (mword_of_int 52 : mword 6) m K 24 b
              ltac:(lia) (so_push sp0) with "Hcg Hpc Hi00").
    ...
    iApply (wp_jal_s_sconf (CID := CID6) (mword_of_int (SO + 0x0e)) Rra
              (mword_of_int 2086674 : mword 21) M4 (K - 24)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi0e").
    iIntros (CID7 Hq7) "Hcg Hpc".
    ...
    assert (Hjai : add_vec (mword_of_int (SO + 0x0e) : mword 64)
                     (sign_extend' 64 (mword_of_int 2086674 : mword 21))
    ...
    iApply (wp_li4_s_sconf (CID := CID8) (mword_of_int (SO + 0x12)) Ra2
              ...
              ltac:(nz) ltac:(rdok) ltac:(pcw) with "Hcg Hpc Hi12").
    iIntros (CID9 Hq9) "Hcg Hpc".
    ...
    iApply (wp_jal_s_sconf (CID := CID11) (mword_of_int (SO + 0x1c)) Rra
              (mword_of_int 2086716 : mword 21) M8 (K - 24)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi1c").
    iIntros (CID12 Hq12) "Hcg Hpc".
    ...
    assert (Hjas : add_vec (mword_of_int (SO + 0x1c) : mword 64)
                     (sign_extend' 64 (mword_of_int 2086716 : mword 21))
    ...
    iApply (wp_cmv_s_sconf (CID := CID13) (mword_of_int (SO + 0x20)) Ra5 Ra0
              mas (K - 24)%nat b ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi20").
    iIntros (CID14 Hq14) "Hcg Hpc".
    ...
    2:{ (* ---- ARM 0: the string did not fetch.  No begin_op, no s1 save ---- *)
      ...
      iApply (so_epilogue (CID0 := CID16) m R2 sp0 K b (proc_addr j) u3 u4 u5 u6
                ...
                with "Hcg Htext Hpc Hf1 Hf2 Hf3 Hf4 Hf5 Hf6 Hbuf H23 H24
                      [Hown Hpriv Hisl Hfds Hbsl Hsbn Hsbi Hsbs Hsbb Hbmres
                       Hcont]").
      iEval (rewrite /wp_next).
      ...
      iDestruct (cpu_own_transport CID16 CIDy 0 eb (proc_addr j) b
                   ltac:(wp_next_chain) with "Hown") as "Hown".
      iSpecialize ("Hcont" $! CIDy with "[%]"); [wp_next_chain |].
      iApply ("Hcont" $! mf used ns P' with "[%] [%] Hcg Hown [] [] Hpc Hbsl
                Hsbn Hsbi Hsbs Hsbb Hbmres [%] Hisl [Hpriv Hfds]").
      { exact Hcsf. }
      { exact Hupt. }
      { rewrite Heb /trap_csrs_ext. done. }
      { rewrite Heb /cpu_claim_ext. done. }
    ...
    iApply (wp_jal_s_sconf (CID := CID17) (mword_of_int (SO + 0x2a)) Rra
              (mword_of_int 2091834 : mword 21) R2 (K - 24)%nat b
              ltac:(nz) ltac:(rdok) ltac:(vm_compute; reflexivity)
              with "Hcg Hpc Hi2a").
    ...
    assert (Hjbo : add_vec (mword_of_int (SO + 0x2a) : mword 64)
                     (sign_extend' 64 (mword_of_int 2091834 : mword 21))
    ...
    iDestruct (proc_priv_pid gf (proc_addr j) pid (upd_upt V P') with "Hpriv")
      as "[Hpidq Hpback0]".
    ...
    iApply (wp_lw_s_sconf (CID := CID19) (mword_of_int (SO + 0x2e)) Ra5 Rs0
              ...
              ltac:(nz) ltac:(rdok) with "Hcg Hpc Hi2e [H23hi]").
    ...
    iApply (wp_andi_s_sconf (CID := CID20) (mword_of_int (SO + 0x32)) Ra5 Ra5
              ...
              ltac:(rgne; rewrite HS1a5; reflexivity) with "Hcg Hpc Hi32").
    ...
    { iEval (rewrite /wp_next). iIntros (CIDz) "%Hqz".
      iEval (rewrite /so_cont0). iIntros (mf used2 ns2) "%Hcsf %Hns2".
      iIntros "Hcg Hown Htce Hcce Hpc Hsbn Hsbi Hsbs Hsbb Hbmres Hbsl Hisl
               Hpost".
      iSpecialize ("Hcont" $! CIDz with "[%]"); [wp_next_chain |].
      iApply ("Hcont" $! mf used2 ns2 P' with "[%] [%] Hcg Hown Htce Hcce Hpc
                Hbsl Hsbn Hsbi Hsbs Hsbb Hbmres [%] Hisl Hpost").
      { exact Hcsf. }
      { exact Hupt. }
      { exact Hns2. } }
    ...
    { (* ---- no O_CREATE: the else arm at +0xdc ---- *)
      ...
      iApply (so_entry_n (CID0 := CID22) gfl gf ga gpr gs j gl gu gd gk pd pav
                ...
                ninodes size dev used pk bf (arg_int32 vom) (word_lo u23) ns Sb0

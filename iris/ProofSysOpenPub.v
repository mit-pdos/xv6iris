(* ProofSysOpenPub.v -- ARM S (+0xb8) AND THE PUBLICATION, at the ARMED
   ...
   EXISTENTIAL state list.  [SysOpenDefs.open_fd_ok] asks for it at an
   ...
   THE MODE BITS come from [ProofSysOpenBits]: the two cells the stores
...
Section ProofSysOpenPub.
  ...
  Proof.
    ...
    (* AT THE CALLER'S OWN BUNDLE (the landed row since 34375379c): the
       ...
       ([SysOpenDefs.open_fd_ok]'s [⌜sts !! fd = Some FdClosed⌝] and its

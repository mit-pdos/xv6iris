...
Section ProofKvmmap.
  ...
  Proof.
    ...
    2:{ (* ---- mappages FAILED (a0 = -1) ---- *)
      ...
      iApply (wp_addi4_s_sconf (mword_of_int (KernelSyms.kvmmap + 0x20)) (mword_of_int 10 : mword 5) (mword_of_int 10 : mword 5) (mword_of_int 0x40 : mword 12)
      ...
      set (Q2 := <[Regidx (mword_of_int 10 : mword 5) := regval_into_reg
          (add_vec (Q1 !!! Regidx (mword_of_int 10 : mword 5)) (sign_extend' 64 (mword_of_int 64 : mword 12)))]> Q1).
      ...
      iApply (wp_jal_s_sconf (mword_of_int (KernelSyms.kvmmap + 0x24)) (mword_of_int 1 : mword 5) (mword_of_int 2094940 : mword 21)
                Q2 (K - 2)%nat b ltac:(vm_compute; discriminate) ltac:(rdok) ltac:(vm_compute; reflexivity)
                with "Hcg Hpc Hi24 [-]").
      iIntros (CIDd Hsd) "Hcg Hpc".
      assert (Hpcpn : add_vec (mword_of_int (KernelSyms.kvmmap + 0x24) : mword 64) (sign_extend' 64 (mword_of_int 2094940 : mword 21)) = mword_of_int KernelSyms.panic) by (apply bv_eq; vm_compute; reflexivity).

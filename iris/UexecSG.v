...
(* It EXCHANGES the application's parked license: [Happ_auto] promised     *)
(* that the claim SURVIVES every one-row move of the map, which no         *)
(* constraining application can promise about an arbitrary mover even with *)
(* every one of its programs verified -- an unpayable premise, i.e. a gap. *)

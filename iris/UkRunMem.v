...
Section UkRunMem.
  ...
  Proof.
    ...
    iApply (UkStore.wp_uk_sd C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rs2
  ...
  Proof.
    ...
    iMod (uheap_store_run γt γd γs M pm a 4 (nth_byte v0)
            (nth_byte (m !!! Regidx rs2)) with "Hheap Hw") as "(Hheap & Hw)".
    iApply (UkStore.wp_uk_sw C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rs2
              (mword_of_int a) (m !!! Regidx rs2) Hui Htgt eq_refl Hok Hcan
              Hpg Hal8
              ltac:(intros j Hj; exists (nth_byte v0 j);
                    rewrite Hua; exact (Hmap j Hj))
  ...
  Proof.
    ...
    iMod (uheap_store_run γt γd γs M pm a 8 (nth_byte v0)
            (nth_byte (m !!! Regidx rs2)) with "Hheap Hw") as "(Hheap & Hw)".
    iApply (UkStore.wp_uk_csdsp C pt Rut pm sz Hlo Hpm M m pc fdv uimm rs2
              (mword_of_int a) (m !!! Regidx rs2) Hui Htgt eq_refl Hok Hcan
              Hpg Hal8
              ltac:(intros j Hj; exists (nth_byte v0 j);
                    rewrite Hua; exact (Hmap j Hj))
  ...
  Proof.
    ...
    iMod (uheap_store_run γt γd γs M pm a 8 (nth_byte v0)
            (nth_byte (m !!! Regidx rs2)) with "Hheap Hw") as "(Hheap & Hw)".
    iApply (UkStore.wp_uk_csd C pt Rut pm sz Hlo Hpm M m pc fdv uimm cr1 cr2 rs1 rs2
  ...
  Proof.
    ...
    iMod (uheap_store_run γt γd γs M pm a 4 (nth_byte v0)
            (nth_byte (m !!! Regidx rs2)) with "Hheap Hw") as "(Hheap & Hw)".
    iApply (UkStore.wp_uk_csw C pt Rut pm sz Hlo Hpm M m pc fdv uimm cr1 cr2 rs1 rs2
              (mword_of_int a) (m !!! Regidx rs2) Hui He1 He2 Htgt eq_refl Hok Hcan
              Hpg Hal8
              ltac:(intros j Hj; exists (nth_byte v0 j);
                    rewrite Hua; exact (Hmap j Hj))
  ...
  Proof.
    ...
    iApply (UkStore.wp_uk_sb C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rs2
  ...
  Proof.
    ...
    assert (Htgt : (mword_of_int a : mword 64)
                   = add_vec (m !!! Regidx rs1) (sign_extend' 64 imm)).
    { exact (umoi_add_i12 _ imm a Ha). }
    iApply (UkLoad.wp_uk_ld C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd
              ...
              with "Hb [Hheap Hstk Hw Hcont]").
    iApply (urun_close_upd _ _ _ _ _ m rd _ _ _ _ _ Hns with "Hheap Hstk"). iApply ("Hcont" with "Hw").
  Qed.
  ...
  Proof.
    ...
    { rewrite Ha /uoff_sdsp. rewrite <- moi_add. rewrite !moi_of_uint.
      reflexivity. }
    iApply (UkLoad.wp_uk_cldsp C pt Rut pm sz Hlo Hpm M m pc fdv uimm rd
              (mword_of_int a) w Hui Hrd Htgt
              ltac:(destruct Hok as (q & Hq & _); exists q; exact Hq) Hcan Hpg Hal8
              ltac:(intros j Hj; exists (nth_byte w j);
                    rewrite Hua; exact (Hmap j Hj))
  ...
  Proof.
    ...
    { rewrite Ha /uoff_c8. rewrite <- moi_add. rewrite !moi_of_uint.
      reflexivity. }
    iApply (UkLoad.wp_uk_cld C pt Rut pm sz Hlo Hpm M m pc fdv uimm crs1 crd rs1 rd
  ...
  Proof.
    ...
    assert (Htgt : (mword_of_int a : mword 64)
                   = add_vec (m !!! Regidx rs1) (sign_extend' 64 imm)).
    { exact (umoi_add_i12 _ imm a Ha). }
    iApply (UkLoad.wp_uk_lw C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd
  ...
  Proof.
    ...
    assert (Htgt : (mword_of_int a : mword 64)
                   = add_vec (m !!! Regidx rs1) (sign_extend' 64 imm)).
    { exact (umoi_add_i12 _ imm a Ha). }
    iApply (UkLoad.wp_uk_lwu C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd
  ...
  Proof.
    ...
    { rewrite Ha /uoff_c4. rewrite <- moi_add. rewrite !moi_of_uint.
      reflexivity. }
    iApply (UkLoad.wp_uk_clw C pt Rut pm sz Hlo Hpm M m pc fdv uimm crs1 crd rs1 rd
  ...
  Proof.
    ...
    assert (Htgt : (mword_of_int a : mword 64)
                   = add_vec (m !!! Regidx rs1) (sign_extend' 64 imm)).
    { exact (umoi_add_i12 _ imm a Ha). }
    iApply (UkLoad.wp_uk_lbu C pt Rut pm sz Hlo Hpm M m pc fdv imm rs1 rd

...
Require Import VTest CoreRegsScsrGen CoreRegsScsrHart1Gen.
...
(*                                                                        *)
(*    Capture: CoreRegsScsrHart1Gen.v -- the same source built with PRIMARY_HART=1
    ...
    reproduces the machine on hart 1, and the whole S-mode CSR file is
...
Definition scsr_h1_run : option mstate :=
  run_until 600 (start_hart core_regs_scsr_hart1_primary_hart core_regs_scsr_hart1_text).

Lemma core_regs_scsr_hart1_result :
  result_of scsr_h1_run = core_regs_scsr_hart1_qemu_result.
Proof. solve_vtest core_regs_scsr_hart1_qemu_result. Qed.

Lemma core_regs_scsr_hart1_is_hart0 :
  core_regs_scsr_hart1_qemu_result = core_regs_scsr_qemu_result.
Proof. reflexivity. Qed.

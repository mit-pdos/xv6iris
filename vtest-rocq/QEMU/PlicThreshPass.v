(* QEMU/PlicThreshPass.v -- GENERATED by tools/vtest.  Do not edit.
   ...
   The proof for the run of case [plic_thresh] on platform [qemu].  What is proved
...
Module PlicThreshPass <: TEST_PASSES_AGREE PlicThresh PlicThreshRun.
  Lemma agrees :
    run_agrees PlicThresh.hart PlicThresh.text PlicThresh.regions

(* QEMU/ClintMsipPass.v -- GENERATED by tools/vtest.  Do not edit.
   ...
   The proof for the run of case [clint_msip] on platform [qemu].  What is proved
...
Module ClintMsipPass <: TEST_PASSES_AGREE ClintMsip ClintMsipRun.
  Lemma agrees :
    run_agrees ClintMsip.hart ClintMsip.text ClintMsip.regions

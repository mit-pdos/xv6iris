...
theorem urc_round (UT : USERTRAP) (UV : USERVEC) (UR : USERRET)
  ...
  have HUT := UT.wp_usertrap (hlc := hlc) (GF := GF) PT Γ γ0 γ1 γc γl0 γl1 γd γdl γt h
  ...
  iapply wpNext_intro
  iintro %cpu'
  iapply (urc_exit UR PT Γ j W V Mp k pt ksp gn cs pid sc f cpu' hl hlw hM' hpi' (hsz.trans hVsz.symm)

...
theorem wpLoop_k_gen [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
...
theorem wpLoop_k_mem [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
    (htier : k.tier = KTier.bare) (pc npc : BitVec 64) (is_rvc : Bool) (i : instruction)
    (R' : RegMap) (hsp : R' 2#5 = k.regs 2#5) (P Q : IProp GF)
    (hexec : ∀ c : MConf, SConfBare (GF := GF) c false → c.menvcfg = menvcfgS →
      execSpecPP (GF := GF) cpu (DFrac.own 1) Privilege.Supervisor c Privilege.Supervisor c i pc
...
theorem wpLoop_k_keep_mem [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
...
theorem wpLoop_k_keep [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
    (htier : k.tier = KTier.bare) (pc npc : BitVec 64) (is_rvc : Bool) (i : instruction) (P Q : IProp GF)
    (hexec : ∀ c : MConf, SConfBare (GF := GF) c false → c.menvcfg = menvcfgS →
      execSpecPP (GF := GF) cpu (DFrac.own 1) Privilege.Supervisor c Privilege.Supervisor c i pc
        (pc + instrLen is_rvc) npc
...
leaves it alone). -/
theorem wpLoop_k_keep0 [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
    (htier : k.tier = KTier.bare) (pc npc : BitVec 64) (is_rvc : Bool) (i : instruction)
    (hexec : ∀ c : MConf, SConfBare (GF := GF) c false → c.menvcfg = menvcfgS →
      execSpecPP (GF := GF) cpu (DFrac.own 1) Privilege.Supervisor c Privilege.Supervisor c i pc
...
theorem wpLoop_k_setReg_mem' [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
    (htier : k.tier = KTier.bare) (pc npc : BitVec 64) (is_rvc : Bool) (i : instruction)
    (rd : BitVec 5) (hrd : rdOk rd) (v : BitVec 64) (P Q : IProp GF)
    (hexec : ∀ c : MConf, SConfBare (GF := GF) c false → c.menvcfg = menvcfgS →
      execSpecPP (GF := GF) cpu (DFrac.own 1) Privilege.Supervisor c Privilege.Supervisor c i pc
...
/-- `ld rd, imm(rs1)`: the word at `rs1 + imm` (8-aligned). -/
theorem wp_s_ld [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rd rs1 : BitVec 5) (hrd : rdOk rd)
...
/-- `sd rs2, imm(rs1)`: `rs2` to `rs1 + imm` (8-aligned). -/
theorem wp_s_sd [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rs1 rs2 : BitVec 5)
...
theorem wp_s_branch [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
/-- `j off`. -/
theorem wp_s_j [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
theorem wp_s_jal [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
theorem wp_s_ret [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
/-- `subw rd, rs1, rs2`. -/
theorem wp_s_subw [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
/-- `addw rd, rs1, rs2`. -/
theorem wp_s_addw [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (rd rs1 rs2 : BitVec 5) (hrd : rdOk rd) :
...
theorem wp_s_push [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
the `avail`. -/
theorem wp_s_pop [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
theorem wpLoop_k_genv [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
    (htier : k.tier = KTier.bare) (pc npc : BitVec 64) (is_rvc : Bool) (i : instruction)
...
theorem wp_s_csrr_sstatus [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
theorem wp_s_csrrci_sstatus [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (rd : BitVec 5) (hrd : rdOk rd) :
...
/-- `lw rd, imm(rs1)`: the sign-extended word at `rs1 + imm` (4-aligned). -/
theorem wp_s_lw [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rd rs1 : BitVec 5) (hrd : rdOk rd)
...
/-- `sw rs2, imm(rs1)`: the low word of `rs2` to `rs1 + imm` (4-aligned). -/
theorem wp_s_sw [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rs1 rs2 : BitVec 5)
...
theorem wp_s_branch0 [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
...
keep it well formed). -/
theorem wpLoop_k_cpu [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false)
    (htier : k.tier = KTier.bare) (pc npc : BitVec 64) (is_rvc : Bool) (i : instruction)
...
theorem wp_s_lw_noff [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rd rs1 : BitVec 5) (hrd : rdOk rd)
...
theorem wp_s_lw_intena [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rd rs1 : BitVec 5) (hrd : rdOk rd)
...
theorem wp_s_sw_noff [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rs1 rs2 : BitVec 5)
...
theorem wp_s_sw_intena [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rs1 rs2 : BitVec 5)
...
theorem wp_s_ld_proc [CurCtx] [KernelGeom] (cpu : CPU) (k : KCtx) (hsie : k.sie = false) (htier : k.tier = KTier.bare)
    (pc : BitVec 64) (is_rvc : Bool) (imm : BitVec 12) (rd rs1 : BitVec 5) (hrd : rdOk rd)
